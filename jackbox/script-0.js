...
ee.prototype._send_request = function(t, e) {
    ...
    return this._mixpanel._track_or_batch({
        type: "groups",
        data: r,
        endpoint: this._get_config("api_host") + "jackbox/" + this._get_config("api_routes").groups,
...
w.prototype._send_request = function(t, e) {
    ...
    return this._identify_called() ? this._mixpanel._track_or_batch({
        type: "people",
        data: a,
        endpoint: this._get_config("api_host") + "jackbox/" + this._get_config("api_routes").engage,
...
y.prototype.get_batcher_configs = function() {
    ...
    return this._batcher_configs = this._batcher_configs || {
        events: {
            type: "events",
            endpoint: "jackbox/" + e.track,
            queue_key: t + "_ev"
        },
        people: {
            type: "people",
            endpoint: "jackbox/" + e.engage,
            queue_key: t + "_pp"
        },
        groups: {
            type: "groups",
            endpoint: "jackbox/" + e.groups,
            queue_key: t + "_gr"
        }
...
y.prototype.track = Bt(function(t, e, r, i) {
    ...
    var x = {
        ...
        T = this._track_or_batch({
            type: "events",
            data: x,
            endpoint: this.get_config("api_host") + "jackbox/" + this.get_config("api_routes").track,
...
(function(t, e) {
    (function(r, i) {
        ...
        var Se = [
                ...
                ["?", "query"],
                function(c, b) {
                    return re(b.protocol) ? c.replace(/\\/g, "jackbox/") : c
                },
                ["jackbox/", "pathname"],
                ["@", "auth", 1],
                [NaN, "host", void 0, 1, 1],
        ...
        function J(_, c) {
            if (_ === "") return c;
            for (var b = (c || "jackbox/").split("jackbox/").slice(0, -1).concat(_.split("jackbox/")), p = b.length, h = b[p - 1], S = !1, m = 0; p--;) b[p] === "." ? b.splice(p, 1) : b[p] === ".." ? (b.splice(p, 1), m++) : m && (p === 0 && (S = !0), b.splice(p, 1), m--);
            return S && b.unshift(""), (h === "." || h === "..") && b.push(""), b.join("jackbox/")
        }
        ...
        function he(_) {
            ...
            return b.username ? (S += b.username, b.password && (S += ":" + b.password), S += "@") : b.password ? (S += ":" + b.password, S += "@") : b.protocol !== "file:" && re(b.protocol) && !p && b.pathname !== "jackbox/" && (S += "@"), p[p.length - 1] === ":" && (p += ":"), S += p + b.pathname, c = typeof b.query == "object" ? _(b.query) : b.query, c && (S += c.charAt(0) !== "?" ? "?" + c : c), b.hash && (S += b.hash), S
        }
        be.prototype = {
            set: Zr,
            toString: he
        ...
        function ou(_) {
            ...
            if (b || (c.pathname = "jackbox/"), p === "") throw new SyntaxError(F.CONSTRUCTOR_ERROR + " The URL '" + c.toString() + "' is invalid.");
        ...
        var Et = function(_) {
            function c(p, h) {
                ...
                var m = new Mt(p);
                m.pathname || (m.pathname = "jackbox/"), this.url = m.toString(), this.readyState = c.CONNECTING, this.protocol = "", this.target = this, typeof h == "string" || typeof h == "object" && h !== null ? this.protocol = h : Array.isArray(h) && h.length > 0 && (this.protocol = h[0]);
        ...
        var mi = {
            ...
            rn = function(_) {
                function c(b, p) {
                    ...
                    var h = new Mt(b);
                    h.pathname || (h.pathname = "jackbox/"), this.url = h.toString(), this.originalWebSocket = null;
...
function Sh(t) {
    ...
    let o = "",
        E = u;
    const x = E.split("jackbox/");
    if (x.length > 1 && (o = x.slice(0, -1).join("jackbox/"), E = x.pop()), E) {
        const T = E.match(/^\d+/);
        T && (E = T[0])
    }
    return af({
...
class xg {
    ...
    splitPath(e) {
        return e.replace(/^\s*\/*\s*|\s*\/*\s*$/g, "").split("jackbox/")
    }
        ...
        main: {
            ...
            bundles: {
                "@connect": {
                    ...
                    base: "/jackbox/main/@connect",
                    version: "5.421.180"
                },
                "the-wheel": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp8/the-wheel",
                    version: "5.94.0"
                },
                "drawful-animate": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp8/drawful-animate",
                    version: "5.229.113"
                },
                "@moderator": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/@moderator",
                    version: "5.374.144"
                },
                "awshirt-tjsp": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/tjsp/awshirt",
                    version: "5.436.189"
                },
                "ecast-test-client": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/internal/ecast-test-client",
                    version: "5.0.0"
                },
                drawful: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp1/drawful",
                    version: "5.0.0"
                },
                fibbage: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp1/fibbage",
                    version: "5.0.0"
                },
                lieswatter: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp1/lieswatter",
                    version: "5.0.0"
                },
                wordspud: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp1/wordspud",
                    version: "5.0.0"
                },
                ydkj2015: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp1/ydkj2015",
                    version: "5.0.0"
                },
                auction: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp2/auction",
                    version: "5.11.0"
                },
                bombintern: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp2/bombintern",
                    version: "5.10.0"
                },
                earwax: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp2/earwax",
                    version: "5.23.0"
                },
                fibbage2: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp2/fibbage2",
                    version: "5.3.0"
                },
                quiplash: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp2/quiplash",
                    version: "5.10.0"
                },
                awshirt: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp3/awshirt",
                    version: "5.10.0"
                },
                fakinit: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp3/fakinit",
                    version: "5.3.0"
                },
                pollposition: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp3/pollposition",
                    version: "5.3.0"
                },
                quiplash2: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp3/quiplash2",
                    version: "5.10.0"
                },
                triviadeath: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp3/triviadeath",
                    version: "5.10.0"
                },
                bracketeering: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp4/bracketeering",
                    version: "5.3.0"
                },
                fibbage3: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp4/fibbage3",
                    version: "5.3.0"
                },
                monstermingle: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp4/monstermingle",
                    version: "5.3.0"
                },
                overdrawn: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp4/overdrawn",
                    version: "5.3.0"
                },
                survivetheinternet: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp4/survivetheinternet",
                    version: "5.3.0"
                },
                patentlystupid: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp5/patentlystupid",
                    version: "5.3.0"
                },
                rapbattle: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp5/rapbattle",
                    version: "5.3.0"
                },
                slingshoot: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp5/slingshoot",
                    version: "5.3.0"
                },
                splittheroom: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp5/splittheroom",
                    version: "5.3.0"
                },
                ydkj2018: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp5/ydkj2018",
                    version: "5.3.0"
                },
                jokeboat: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp6/jokeboat",
                    version: "5.3.0"
                },
                pushthebutton: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp6/pushthebutton",
                    version: "5.366.138"
                },
                ridictionary: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp6/ridictionary",
                    version: "5.3.0"
                },
                rolemodels: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp6/rolemodels",
                    version: "5.25.0"
                },
                triviadeath2: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp6/triviadeath2",
                    version: "5.456.206"
                },
                "blanky-blank": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp7/blanky-blank",
                    version: "5.3.0"
                },
                everyday: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp7/everyday",
                    version: "5.3.0"
                },
                "jackbox-talks": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp7/jackboxtalks",
                    version: "5.25.0"
                },
                quiplash3: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp7/quiplash3",
                    version: "5.359.132"
                },
                worldchamps: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp7/worldchamps",
                    version: "5.144.39"
                },
                "acquisitions-inc": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/standalone/acquisitions-inc",
                    version: "5.3.0"
                },
                drawful2international: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/standalone/drawful2-international",
                    version: "5.3.0"
                },
                drawful2: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/standalone/drawful2",
                    version: "5.10.0"
                },
                "guesspionage-crowdplay": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/standalone/guesspionage-crowdplay",
                    version: "5.0.0"
                },
                "quiplash2-international": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/standalone/quiplash2-international",
                    version: "5.3.0"
                },
                "survey-bomb": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp8/survey-bomb",
                    version: "5.94.0"
                },
                "triviadeath2-tjsp": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/tjsp/triviadeath2",
                    version: "5.436.189"
                },
                "murder-detectives": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp8/murder-detectives",
                    version: "5.431.187"
                },
                "quiplash3-tjsp": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/tjsp/quiplash3",
                    version: "5.436.189"
                },
                "apply-yourself": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp8/apply-yourself",
                    version: "5.0.0"
                },
                "antique-freak": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp9/antique-freak",
                    version: "5.94.0"
                },
                fourbage: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp9/fourbage",
                    version: "5.94.0"
                },
                htmf: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp9/htmf",
                    version: "5.359.132"
                },
                lineup: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp9/lineup",
                    version: "5.297.119"
                },
                "range-game": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp9/range-game",
                    version: "5.94.0"
                },
                prototype: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/internal/prototype",
                    version: "5.445.196"
                },
                "@teeko-web": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/@teeko-web",
                    version: "5.353.130"
                },
                awshirt2: {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp10/awshirt2",
                    version: "5.353.130"
                },
                "nopus-opus": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp10/nopus-opus",
                    version: "5.349.128"
                },
                "risky-text": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp10/risky-text",
                    version: "5.356.132"
                },
                "time-trivia": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp10/time-trivia",
                    version: "5.348.128"
                },
                "us-them": {
                    file: "script.js",
                    css: ["assets/style-0.css"],
                    base: "jackbox/main/pp10/us-them",
                    version: "5.385.151"
                }
            }
        }
