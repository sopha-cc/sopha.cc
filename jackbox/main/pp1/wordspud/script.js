...
(function(t, e) {
    (function() {
        ...
        m.reduce = m.foldl = m.inject = Pe(1), m.reduceRight = m.foldr = Pe(-1), m.find = m.detect = function(l, g, _) {
            ...
            var O = [];
            return g = W(g, _), m.each(l, function(L, V, te) {
                g(L, V, te) && O.push(L)
            }), O
        }, m.reject = function(l, g, _) {
            return m.filter(l, m.negate(W(g)), _)
            ...
            } else g = W(g, _), m.each(l, function(De, Me, nt) {
                te = g(De, Me, nt), (te > L || te === -1 / 0 && O === -1 / 0) && (O = De, L = te)
            });
            return O
            ...
            return g = W(g, _), m.pluck(m.map(l, function(O, L, V) {
                return {
                    value: O,
                    index: L,
                    criteria: g(O, L, V)
        ...
        var lt = function(l) {
            return function(g, _, O) {
                var L = {};
                return _ = W(_, O), m.each(g, function(V, te) {
                    var Se = _(V, te, g);
                    l(L, V, Se)
                }), L
            }
        ...
        var Be = function(l, g, _, O) {
            for (var L = [], V = 0, te = O || 0, Se = Ee(l); te < Se; te++) {
                ...
                if (Ae(he) && (m.isArray(he) || m.isArguments(he))) {
                    ...
                    var De = 0,
                        Me = he.length;
                    for (L.length += Me; De < Me;) L[V++] = he[De++]
                } else _ || (L[V++] = he)
            }
            return L
        };
        m.flatten = function(l, g) {
            ...
            m.isBoolean(g) || (O = _, _ = g, g = !1), _ != null && (_ = W(_, O));
            for (var L = [], V = [], te = 0, Se = Ee(l); te < Se; te++) {
                var he = l[te],
                    De = _ ? _(he, te, l) : he;
                g ? ((!te || V !== De) && L.push(he), V = De) : _ ? m.contains(V, De) || (V.push(De), L.push(he)) : m.contains(L, he) || L.push(he)
            }
            return L
        }, m.union = function() {
        ...
        m.bind = function(l, g) {
            ...
            return function() {
                var De = m.now();
                !Se && _.leading === !1 && (Se = De);
                var Me = g - (De - Se);
                return O = this, L = arguments, Me <= 0 || Me > g ? (te && (clearTimeout(te), te = null), Se = De, V = l.apply(O, L), te || (O = L = null)) : !te && _.trailing !== !1 && (te = setTimeout(he, Me)), V
            }
        }, m.debounce = function(l, g, _) {
            var O, L, V, te, Se, he = function() {
                var De = m.now() - te;
                De < g && De >= 0 ? O = setTimeout(he, g - De) : (O = null, _ || (Se = l.apply(V, L), O || (V = L = null)))
            };
            return function() {
                V = this, L = arguments, te = m.now();
                var De = _ && !O;
                return O || (O = setTimeout(he, g)), De && (Se = l.apply(V, L), V = L = null), Se
            }
        }, m.wrap = function(l, g) {
        ...
        var ye = function(l, g, _, O) {
            ...
            if (_.push(l), O.push(g), V) {
                ...
                for (; he--;)
                    if (Me = De[he], !(m.has(g, Me) && ye(l[Me], g[Me], _, O))) return !1
            }
        ...
        m.template = function(l, g, _) {
            ...
            var O = RegExp([(g.escape || Ke).source, (g.interpolate || Ke).source, (g.evaluate || Ke).source].join("|") + "|$", "g"),
                L = 0,
                V = "__p+='";
            l.replace(O, function(De, Me, nt, Ct, rn) {
                return V += l.slice(L, rn).replace(Bt, Wt), L = rn + De.length, Me ? V += `'+
    ...
    (function(e, n) {
        ...
        var Ae = function(r) {
            ...
            function St(R, F, X, de) {
                var ee, me, xe, Re, Le, ze, Ue, Xe = F && F.ownerDocument,
                    ht = F ? F.nodeType : 9;
                ...
                if (!de && (ne(F), F = F || ce, rt)) {
                    if (ht !== 11 && (Le = Go.exec(R)))
                        ...
                        if (Ue = R, Xe = F, ht === 1 && ($o.test(R) || As.test(R))) {
                            for (Xe = Hr.test(R) && Gr(F.parentNode) || F, (Xe !== F || !u.scope) && ((Re = F.getAttribute("id")) ? Re = Re.replace(Ur, Os) : F.setAttribute("id", Re = _t)), ze = T(R), me = ze.length; me--;) ze[me] = (Re ? "#" + Re : ":scope") + " " + Qi(ze[me]);
                            Ue = ze.join(",")
                        }
                        try {
                ...
                filter: {
                    ...
                    CHILD: function(R, F, X, de, ee) {
                        ...
                        return de === 1 && ee === 0 ? function(Le) {
                            ...
                            var Xe, ht, Tt, qe, Ht, Qt, fn = me !== xe ? "nextSibling" : "previousSibling",
                                At = Le.parentNode,
                            ...
                            if (At) {
                                ...
                                if (Qt = [xe ? At.firstChild : At.lastChild], xe && h) {
                                    for (qe = At, Tt = qe[_t] || (qe[_t] = {}), ht = Tt[qe.uniqueID] || (Tt[qe.uniqueID] = {}), Xe = ht[R] || [], Ht = Xe[0] === on && Xe[1], b = Ht && Xe[2], qe = Ht && At.childNodes[Ht]; qe = ++Ht && qe && qe[fn] || (b = Ht = 0) || Qt.pop();)
                                        if (qe.nodeType === 1 && ++b && qe === Le) {
                                            ht[R] = [on, Ht, b];
                                            break
                                        }
                                } else if (h && (qe = Le, Tt = qe[_t] || (qe[_t] = {}), ht = Tt[qe.uniqueID] || (Tt[qe.uniqueID] = {}), Xe = ht[R] || [], Ht = Xe[0] === on && Xe[1], b = Ht), b === !1)
                                    for (;
                                        (qe = ++Ht && qe && qe[fn] || (b = Ht = 0) || Qt.pop()) && !((Re ? qe.nodeName.toLowerCase() === c : qe.nodeType === 1) && ++b && (h && (Tt = qe[_t] || (qe[_t] = {}), ht = Tt[qe.uniqueID] || (Tt[qe.uniqueID] = {}), ht[R] = [on, b]), qe === Le)););
                ...
                pseudos: {
                    not: dn(function(R) {
                        ...
                        return de[_t] ? dn(function(ee, me, xe, Re) {
                            for (var Le, ze = de(ee, null, Re, []), Ue = ee.length; Ue--;)(Le = ze[Ue]) && (ee[Ue] = !(me[Ue] = Le))
                        }) : function(ee, me, xe) {
            ...
            Ds.prototype = p.filters = p.pseudos, p.setFilters = new Ds, T = St.tokenize = function(R, F) {
                var X, de, ee, me, xe, Re, Le, ze = _i[R + " "];
                if (ze) return F ? 0 : ze.slice(0);
                for (xe = R, Re = [], Le = p.preFilter; xe;) {
                ...
                return F ? xe.length : xe ? St.error(R) : _i(R, Re).slice(0)
            };
                        ...
                        for (; Le = Le[de];)
                            if (Le.nodeType === 1 || xe)
                                if (Tt = Le[_t] || (Le[_t] = {}), ht = Tt[Le.uniqueID] || (Tt[Le.uniqueID] = {}), ee && ee === Le.nodeName.toLowerCase()) Le = Le[de] || Le;
                                    ...
                                    if (ht[me] = qe, qe[2] = R(Le, ze, Ue)) return !0
                                } return !1
                }
            }
            ...
            function tr(R, F, X, de, ee) {
                for (var me, xe = [], Re = 0, Le = R.length, ze = F != null; Re < Le; Re++)(me = R[Re]) && (!X || X(me, de, ee)) && (xe.push(me), ze && F.push(Re));
                return xe
            }

            function Wr(R, F, X, de, ee, me) {
                return de && !de[_t] && (de = Wr(de)), ee && !ee[_t] && (ee = Wr(ee, me)), dn(function(xe, Re, Le, ze) {
                    var Ue, Xe, ht, Tt = [],
                        qe = [],
                        Ht = Re.length,
                        Qt = xe || Yo(F || "*", Le.nodeType ? [Le] : Le, []),
                        fn = R && (xe || !F) ? tr(Qt, Tt, R, Le, ze) : Qt,
                        At = X ? ee || (xe ? R : Ht || de) ? [] : Re : fn;
                    if (X && X(fn, At, Le, ze), de)
                        for (Ue = tr(At, qe), de(Ue, [], Le, ze), Xe = Ue.length; Xe--;)(ht = Ue[Xe]) && (At[qe[Xe]] = !(fn[qe[Xe]] = ht));
                    if (xe) {
                        if (ee || R) {
                            if (ee) {
                            ...
                            for (Xe = At.length; Xe--;)(ht = At[Xe]) && (Ue = ee ? Qn(xe, ht) : Tt[Xe]) > -1 && (xe[Ue] = !(Re[Ue] = ht))
                        }
            ...
            function qr(R) {
                for (var F, X, de, ee = R.length, me = p.relative[R[0].type], xe = me || p.relative[" "], Re = me ? 1 : 0, Le = Zi(function(Xe) {
                        return Xe === F
                    ...
                    if (X = p.relative[R[Re].type]) Ue = [Zi(er(Ue), X)];
                        ...
                        if (X = p.filter[R[Re].type].apply(null, R[Re].matches), X[_t]) {
                            ...
                            return Wr(Re > 1 && er(Ue), Re > 1 && Qi(R.slice(0, Re - 1).concat({
                                value: R[Re - 2].type === " " ? "*" : ""
                            })).replace(Si, "$1"), X, Re < de && qr(R.slice(Re, de)), de < ee && qr(R = R.slice(de)), de < ee && Qi(R))
                        }
                        Ue.push(X)
                    } return er(Ue)
            }
                ...
                var X = F.length > 0,
                    ...
                    ee = function(me, xe, Re, Le, ze) {
                        var Ue, Xe, ht, Tt = 0,
                            ...
                            h = At.length;
                        for (ze && (Z = xe == ce || xe || ze); qe !== h && (Ue = At[qe]) != null; qe++) {
                            if (de && Ue) {
                                for (Xe = 0, !xe && Ue.ownerDocument != ce && (ne(Ue), Re = !rt); ht = R[Xe++];)
                                    if (ht(Ue, xe || ce, Re)) {
                                        Le.push(Ue);
                                        break
                                    } ze && (on = c)
                        ...
                        if (Tt += qe, X && qe !== Tt) {
                            for (Xe = 0; ht = F[Xe++];) ht(Ht, Qt, xe, Re);
                            if (me) {
                                if (Tt > 0)
                                    for (; qe--;) Ht[qe] || Qt[qe] || (Qt[qe] = Mn.call(Le));
                                Qt = tr(Qt)
                            }
                            Cn.apply(Le, Qt), ze && !me && Qt.length > 0 && Tt + F.length > 1 && St.uniqueSort(Le)
                        }
            ...
            return z = St.compile = function(R, F) {
                ...
                var ee, me, xe, Re, Le, ze = typeof R == "function" && R,
                ...
                if (X = X || [], Ue.length === 1) {
                    ...
                    for (ee = Xi.needsContext.test(R) ? 0 : me.length; ee-- && (xe = me[ee], !p.relative[Re = xe.type]);)
                        if ((Le = p.find[Re]) && (de = Le(xe.matches[0].replace(Tn, xn), Hr.test(me[0].type) && Gr(F.parentNode) || F))) {
        ...
        d.Deferred.exceptionHook = function(r, s) {
            e.console && e.console.warn && r && Wt.test(r.name) && e.console.warn("jQuery.Deferred exception: " + r.message, r.stack, s)
        ...
        d.extend({
            ...
            d.cssHooks[s] = {
                get: function(u, p, w) {
                    if (p) return We.test(d.css(u, "display")) && (!u.getClientRects().length || !u.getBoundingClientRect().width) ? Hi(u, Xt, function() {
                        return Ar(u, s, w)
                    }) : Ar(u, s, w)
                },
                set: function(u, p, w) {
...
`)
        ...
        d.extend({
            ...
            ajax: function(r, s) {
                ...
                Z = d.event && ne.global, Z && d.active++ === 0 && d.event.trigger("ajaxStart"), ne.type = ne.type.toUpperCase(), ne.hasContent = !Do.test(ne.type), p = ne.url.replace(Ro, ""), ne.hasContent ? ne.data && ne.processData && (ne.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (ne.data = ne.data.replace(Oo, "+")) : (be = ne.url.slice(p.length), ne.data && (ne.processData || typeof ne.data == "string") && (p += (Wi.test(p) ? "&" : "?") + ne.data, delete ne.data), ne.cache === !1 && (p = p.replace(Io, "$1"), be = (Wi.test(p) ? "&" : "?") + "_=" + Lr.guid++ + be), ne.url = p + be), ne.ifModified && (d.lastModified[p] && et.setRequestHeader("If-Modified-Since", d.lastModified[p]), d.etag[p] && et.setRequestHeader("If-None-Match", d.etag[p])), (ne.data && ne.hasContent && ne.contentType !== !1 || s.contentType) && et.setRequestHeader("Content-Type", ne.contentType), et.setRequestHeader("Accept", ne.dataTypes[0] && ne.accepts[ne.dataTypes[0]] ? ne.accepts[ne.dataTypes[0]] + (ne.dataTypes[0] !== "*" ? ", " + bs + "; q=0.01" : "") : ne.accepts["*"]);
                ...
                function on(ft, Dt, _i, qi) {
                    ...
                    H || (H = !0, T && e.clearTimeout(T), u = void 0, w = qi || "", et.readyState = ft > 0 ? 4 : 0, hn = ft >= 200 && ft < 300 || ft === 304, _i && (an = Lo(ne, et, _i)), !hn && d.inArray("script", ne.dataTypes) > -1 && d.inArray("json", ne.dataTypes) < 0 && (ne.converters["text script"] = function() {}), an = Po(ne, an, et, hn), hn ? (ne.ifModified && (Mn = et.getResponseHeader("Last-Modified"), Mn && (d.lastModified[p] = Mn), Mn = et.getResponseHeader("etag"), Mn && (d.etag[p] = Mn)), ft === 204 || ne.type === "HEAD" ? vn = "nocontent" : ft === 304 ? vn = "notmodified" : (vn = an.state, Kn = an.data, Jn = an.error, hn = !Jn)) : (Jn = vn, (ft || !vn) && (vn = "error", ft < 0 && (ft = 0))), et.status = ft, et.statusText = (Dt || vn) + "", hn ? rt.resolveWith(ce, [Kn, vn, et]) : rt.rejectWith(ce, [et, vn, Jn]), et.statusCode(zt), zt = void 0, Z && Ge.trigger(hn ? "ajaxSuccess" : "ajaxError", [et, ne, hn ? Kn : Jn]), je.fireWith(ce, [et, vn]), Z && (Ge.trigger("ajaxComplete", [et, ne]), --d.active || d.event.trigger("ajaxStop")))
                }
                return et
            },
    ...
    (function(e) {
        ...
        i.extend(se.prototype, $, {
            ...
            set: function(E, l, g) {
                ...
                for (var Me in _) l = _[Me], i.isEqual(Se[Me], l) || V.push(Me), i.isEqual(De[Me], l) ? delete he[Me] : he[Me] = l, O ? delete Se[Me] : Se[Me] = l;
            ...
            save: function(E, l, g) {
                ...
                }, Wt(this, g), _ && O && (this.attributes = i.extend({}, te, _));
            ...
            destroy: function(E) {
                ...
                var L = !1;
                return this.isNew() ? i.defer(E.success) : (Wt(this, E), L = this.sync("delete", this, E)), _ || O(), L
            },
            url: function() {
            ...
            set: function(E, l) {
                if (E != null) {
                    ...
                    if (O.length && Lt ? (Je = this.length !== O.length || i.some(this.models, function(j, N) {
                            return j !== O[N]
                        }), this.models.length = 0, Pe(this.models, O, 0), this.length = this.models.length) : L.length && (Ct && (nt = !0), Pe(this.models, L, _ == null ? this.length : _), this.length = this.models.length), nt && this.sort({
                            silent: !0
                        }), !l.silent) {
        ...
        i.extend(Be.prototype, $, {
            ...
            g.error = function(Se, he, De) {
                g.textStatus = he, g.errorThrown = De, V && V.call(g.context, Se, he, De)
            };
    ...
    return pl || (pl = 1, function(t, e) {
        (function(n, i) {
            ...
            v._eventsApi = function(m, P, W, ae) {
                ...
                if (S.test(W)) {
                    for (var Ee = W.split(S), Ae = 0, Pe = Ee.length; Ae < Pe; Ae++) se[Ee[Ae]] = m[P].apply(m, [Ee[Ae]].concat(ae));
                    return se
                }
                return !1
            ...
            function I(m, P, W, ae) {
                m || (m = {});
                for (var se = P ? [P] : n.keys(m), ve = !1, d = 0, Ee = se.length; d < Ee; d++) P = se[d], !!m[P] && k(m, P, W, ae) && (ve = !0);
                return ve
            }
            var D = {};
                    ...
                    if (Q) this.render();
                        ...
                        var Ce = [],
                            We = i.reduce(this.children._views, function(Xt, Un) {
                                ...
                                return Nn === -1 ? (Ce.push(Un.model), Xt) : (Un._index = Nn, Xt[Nn] = Un.el, Xt)
                            }, new Array(A.length));
...
function Gp(t) {
    return typeof t.constructor == "function" && !Up(t) ? zp(Hp(t)) : {}
}
var Wp = Gp;
...
var _g = Eg,
    ...
    Mt = {};
Mt[Hg] = Mt[Ug] = Mt[Gg] = Mt[Wg] = Mt[qg] = Mt[Xg] = Mt[Yg] = Mt[Kg] = Mt[Jg] = !0;
Mt[Ag] = Mt[Og] = Mt[Fg] = Mt[Rg] = Mt[zg] = Mt[Ig] = Mt[Dg] = Mt[Mg] = Mt[Lg] = Mt[Pg] = Mt[Ng] = Mt[Vg] = Mt[Bg] = Mt[$g] = Mt[jg] = !1;
...
let Gt = fl;
st(Gt, "queryParams", new URLSearchParams(window.location.search)), st(Gt, "getQueryParam", e => fl.queryParams.get(e)), st(Gt, "sleep", e => new Promise(n => {
...
class en {
    ...
    static setup(e, n) {
        ...
        delete window.tv.storage, window.tv.storage = {
            namespace: (a = (i = Gt.getQueryParam("namespace")) != null ? i : Gt.getQueryParam("ns")) != null ? a : this.defaultNamespace,
            isDisabled: Gt.queryParams.has("incognito") || Gt.queryParams.has("nc")
...
var ka = Sy,
    ...
    Vy = function t(e, n, i, a) {
        ...
        if (Qy(e)) {
            for (var m = "<" + Vl.call(String(e.nodeName)), P = e.attributes || [], W = 0; W < P.length; W++) m += " " + P[W].name + "=" + Uc(By(P[W].value), "double", f);
            return m += ">", e.childNodes && e.childNodes.length && (m += "..."), m += "</" + Vl.call(String(e.nodeName)) + ">", m
        }
        if (Ta(e)) {
            if (e.length === 0) return "[]";
            var ae = Ls(e, J);
            return $ && !ew(ae) ? "[" + Aa(ae, $) + "]" : "[ " + jn.call(ae, ", ") + " ]"
        }
        if (jy(e)) {
            var se = Ls(e, J);
            return !("cause" in Error.prototype) && "cause" in e && !Hc.call(e, "cause") ? "{ [" + String(e) + "] " + jn.call(Bl.call("[cause]: " + J(e.cause), se), ", ") + " }" : se.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + jn.call(se, ", ") + " }"
        }
        ...
        if (Uy(e)) return Yr(J(_a.call(e)));
        if (Hy(e)) return Yr(Iy.call(e));
        if (Fy(e)) return Yr(J(String(e)));
        if (!$y(e) && !Ul(e)) {
            var Ee = Ls(e, J),
                Ae = jl ? jl(e) === Object.prototype : e instanceof Object || e.constructor === Object,
                Pe = e instanceof Object ? "" : "null prototype",
                lt = !Ae && cn && Object(e) === e && cn in e ? Ga.call(pi(e), 8, -1) : Pe ? "Object" : "",
                Be = Ae || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "",
                K = Be + (lt || Pe ? "[" + jn.call(Bl.call([], lt || [], Pe || []), ": ") + "] " : "");
            return Ee.length === 0 ? K + "{}" : $ ? K + "{" + Aa(Ee, $) + "}" : K + "{ " + jn.call(Ee, ", ") + " }"
        }
        return String(e)
    };
...
function qc(t, e) {
    if (t.length > e.maxStringLength) {
        ...
        return qc(Ga.call(t, 0, e.maxStringLength), e) + i
    }
    var a = hi.call(hi.call(t, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, Zy);
    return Uc(a, "single", e)
}
...
function Ls(t, e) {
    ...
    if (typeof ra == "function")
        for (var I = 0; I < f.length; I++) Hc.call(t, f[I]) && i.push("[" + e(f[I]) + "]: " + e(t[f[I]], t));
    return i
}
var Wa = za,
    _r = xy,
    ...
    Dw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        ...
        if (Iw(P) || Oa.isBuffer(P)) {
            if (S) {
                ...
                if (i === "comma" && Y) {
                    for (var Ee = Aw.call(String(P), ","), Ae = "", Pe = 0; Pe < Ee.length; ++Pe) Ae += (Pe === 0 ? "" : ",") + ie(S(Ee[Pe], nn.encoder, re, "value", J));
        ...
        for (var Fe = a && ei(P) && P.length === 1 ? n + "[]" : n, U = 0; U < Be.length; ++U) {
            ...
            if (!(v && Te === null)) {
                ...
                m.set(e, ae);
                var ye = Kc();
                ye.set(la, m), Jc(lt, t(Te, we, i, a, f, v, S, k, I, D, $, J, ie, Y, re, ye))
            }
        }
        return lt
    },
    ...
    (function(n, i) {
        ...
        function Pe(j, N, q) {
            ...
            for (jt !== "object" && jt !== "string" && (q = N, N = null), q && typeof q != "function" && (q = ie.parse), N = ve(N), G = Ee(j || "", N), M = !G.protocol && !G.slashes, Ye.slashes = G.slashes || M && N.slashes, Ye.protocol = G.protocol || N.protocol || "", j = G.rest, (Ye.protocol === "file:" || !G.slashes && (G.protocol || G.slashesCount < 2 || !d(Ye.protocol))) && (pt[3] = [/(.*)/, "pathname"]); In < pt.length; In++) {
                ...
                fe = pe[0], Ve = pe[1], fe !== fe ? Ye[Ve] = j : typeof fe == "string" ? ~(Ne = j.indexOf(fe)) && (typeof pe[2] == "number" ? (Ye[Ve] = j.slice(0, Ne), j = j.slice(Ne + pe[2])) : (Ye[Ve] = j.slice(Ne), j = j.slice(0, Ne))) : (Ne = fe.exec(j)) && (Ye[Ve] = Ne[1], j = j.slice(0, Ne.index)), Ye[Ve] = Ye[Ve] || M && pe[3] && N[Ve] || "", pe[4] && (Ye[Ve] = Ye[Ve].toLowerCase())
            }
            q && (Ye.query = q(Ye.query)), M && N.slashes && Ye.pathname.charAt(0) !== "/" && (Ye.pathname !== "" || N.pathname !== "") && (Ye.pathname = Ae(Ye.pathname, N.pathname)), Ye.pathname.charAt(0) !== "/" && d(Ye.protocol) && (Ye.pathname = "/" + Ye.pathname), a(Ye.port, Ye.protocol) || (Ye.host = Ye.hostname, Ye.port = ""), Ye.username = Ye.password = "", Ye.auth && (pe = Ye.auth.split(":"), Ye.username = pe[0] || "", Ye.password = pe[1] || ""), Ye.origin = Ye.protocol !== "file:" && d(Ye.protocol) && Ye.host ? Ye.protocol + "//" + Ye.host : "null", Ye.href = Ye.toString()
        }
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/pp1-wordspud/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
    ...
    (function(e) {
        ...
        var a = [].slice,
            ...
            I = function(m, P, W, ae, se) {
                var ve = {},
                    d = se.view;
                se.onSet && (W = v.call(d, se.onSet, W, se)), se.set ? v.call(d, se.set, P, W, ae, se) : (ve[P] = W, e.isArray(P) && e.isArray(W) && (ve = e.reduce(P, function(Ee, Ae, Pe) {
                    ...
                    var se = P.view,
                        ve = function() {
                            var d = P.visible,
                                ...
                                Ae = D(W, ae, P),
                                Pe = !!Ae;
                            (e.isFunction(d) || e.isString(d)) && (Pe = !!v.call(se, d, Ae, P)), Ee ? v.call(se, Ee, m, Pe, P) : m.toggle(Pe)
                        };
            ...
            re = function(m, P, W, ae, se) {
                var ve = P.view;
                !S(P.updateView, W, P) || (v.call(ve, P.update, m, W, ae, P), se || v.call(ve, P.afterUpdate, m, W, P))
            };
        return i.addHandler([{
            ...
            update: function(m, P, W, ae) {
                ...
                var Pe = function(ue, _e, ke) {
                    e.each(ue, function($e) {
                        var Ke = n.$("<option/>"),
                            ...
                            Wt, E, l;
                        $e === "__default__" ? (Wt = ke.label, E = ke.value, l = ke.disabled) : (Wt = f($e, ve.labelPath), E = f($e, ve.valuePath), l = f($e, ve.disabledPath)), Bt(Wt, E, l);
                        var g = function() {
                ...
                if (se instanceof n.Collection) {
                    var Be = se,
                        ...
                        U = function() {
                            Fe(), Be.off("stickit:selectRefresh"), W.off("stickit:selectRefresh")
                        };
                    Be.trigger("stickit:selectRefresh"), Be.once("stickit:selectRefresh", Fe, this), Be.on("add remove reset sort", K, this), W.trigger("stickit:selectRefresh"), W.once("stickit:selectRefresh", function() {
    ...
    Wu = Et.View.extend({
        ...
        bindings: {
            ...
            "button:first": {
                ...
                updateMethod: "html",
                onGet([t, e, n]) {
                    return n ? this.$el.find("button:first").attr("aria-label", n) : this.$el.find("button:first").removeAttr("aria-label"), e || Oe("<div />").text(t).html()
                },
                attributes: [{
                    name: "disabled",
                    observe: "disabled"
        ...
        onClick(t) {
            const e = Oe(t.target).data("action");
    ...
    to = Et.View.extend({
        ...
        bindings: {
            ...
            ".errorText": {
                ...
                updateView: !0,
                onGet(t) {
                    return t ? typeof t == "object" ? t.html ? t.html : Oe("<div />").text(t.text).html() : t : null
                }
            },
        ...
        onAttach() {
            this.getOption("preventAutosize") || rc(Oe("textarea"))
        },
        onSubmitClick() {
            return Oe("textarea").blur(), this.triggerMethod("input:submit", this), !1
        },
        onKeypress(t) {
            return this.model.set("error", ""), t.keyCode === 13 ? (Oe("textarea").blur(), this.triggerMethod("input:submit", this), !1) : !0
        },
        onInputChange() {
        ...
        focus() {
            Oe(this.$el).find("textarea").focus()
        },
        clearInput() {
            const t = Oe(this.$el).find("textarea");
            Oe(t).val(""), this.getOption("preventAutosize") || rc.update(t), this.onInputChange()
        },
        setValue(t) {
            const e = Oe(this.$el).find("textarea");
        ...
        getSanitizedValue() {
            return Gt.sanitize(this.getValue())
        },
        sanitize(t) {
            return Gt.sanitize(t)
        },
        sanitizeInput(t) {
            return Gt.sanitizeInput(t)
        }
    }),
    ...
    Bi = Et.View.extend({
        ...
        bindings: {
            ".text": {
                ...
                updateMethod: "html",
                onGet([t, e]) {
                    return e !== void 0 ? e : Oe("<div />").text(t).html()
                }
            },
            ":el": {
                attributes: [{
...
function hC(t) {
    ...
    return Us = Jr.getContext("2d"), Us.imageSmoothingEnabled = !1, Xu("init"), {
        canvas: Jr,
        context: Us
    }
}
...
`).replace(/(^|\n)\s*/g, ""),
            ...
            wi = (c, h) => {
                const b = g(),
                    B = E();
                !h.showConfirmButton && !h.showDenyButton && !h.showCancelButton ? M(b) : q(b), ct(b, h, "actions"), Hn(b, B, h), nt(B, h.loaderHtml), ct(B, h, "loader")
            };
        ...
        const Q = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
            Ce = (c, h) => {
                ...
                Q.forEach(He => {
                    const Ut = j(b, K[He]);
                    Xt(He, h.inputAttributes), Ut.className = K[He], ge && M(Ut)
            ...
            Ft = {};
        Ft.text = Ft.email = Ft.password = Ft.number = Ft.tel = Ft.url = (c, h) => (Yt(c, h.inputValue), Gn(c, c, h), Nn(c, h), c.type = h.input, c), Ft.file = (c, h) => (Gn(c, c, h), Nn(c, h), c), Ft.range = (c, h) => {
            const b = c.querySelector("input"),
                B = c.querySelector("output");
            return Yt(b, h.inputValue), b.type = h.input, Yt(B, h.inputValue), Gn(b, c, h), c
        }, Ft.select = (c, h) => {
            ...
            Yt(c, h.inputValue), Nn(c, h), Gn(c, c, h);
        ...
        const Ui = (c, h) => {
                const b = _e();
                ct(b, h, "htmlContainer"), h.html ? (yi(h.html, b), q(b, "block")) : h.text ? (b.textContent = h.text, q(b, "block")) : M(b), Ce(c, h)
            },
            bo = (c, h) => {
                const b = _();
...
`,
            ...
            Eo = (c, h) => {
                ...
                q(b), b.textContent = "", h.currentProgressStep >= h.progressSteps.length && f("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), h.progressSteps.forEach((B, ge) => {
                    const He = _o(B);
            ...
            Dr = (c, h) => {
                const b = U(),
                    B = we();
                h.toast ? (N(b, "width", h.width), B.style.width = "100%", B.insertBefore(E(), ye())) : N(B, "width", h.width), N(B, "padding", h.padding), h.color && (B.style.color = h.color), h.background && (B.style.background = h.background), M(Ke()), So(B, h)
            },
            So = (c, h) => {
            ...
            Mr = (c, h) => {
                Dr(c, h), Ze(c, h), Eo(c, h), Or(c, h), Ci(c, h), qn(c, h), Co(c, h), Ui(c, h), wi(c, h), bo(c, h), typeof h.didRender == "function" && h.didRender(we())
            },
            Xn = Object.freeze({
                cancel: "cancel",
                backdrop: "backdrop",
...
`).join("<br />")), vi(c)
        ...
        const bs = () => {
            ...
            jr = c => {
                ...
                r(h, b, c), setTimeout(() => {
                    Vo(h, b)
                }, $r), Se() && (Bo(h, c.scrollbarPadding, ge), xi()), !he() && !it.previousActiveElement && (it.previousActiveElement = document.activeElement), typeof c.didOpen == "function" && setTimeout(() => c.didOpen(b)), Lt(h, K["no-transition"])
            },
            Es = c => {
                const h = we();
            ...
            s = c => {
                ...
                h || new At, h = we();
                const b = E();
                he() ? M(ye()) : u(h, c), q(b), h.setAttribute("data-loading", "true"), h.setAttribute("aria-busy", "true"), h.focus()
            },
            u = (c, h) => {
                const b = g(),
                    B = E();
                !h && pe(dt()) && (h = dt()), q(b), h && (M(h), B.setAttribute("data-button-to-replace", h.className)), B.parentNode.insertBefore(B, h), Je([c, b], K.loading)
            },
            p = (c, h) => {
        ...
        function Xi(c) {
            ...
            nt(h.validationMessage, c), h.validationMessage.className = K["validation-message"], b.customClass && b.customClass.validationMessage && Je(h.validationMessage, b.customClass.validationMessage), q(h.validationMessage);
        ...
        class Ue {
            ...
            _main(h) {
                ...
                Pe(Object.assign({}, b, h)), it.currentInstance && (it.currentInstance._destroy(), Se() && Lr()), it.currentInstance = ze;
                const B = ht(h, b);
        ...
        const Xe = (c, h, b) => new Promise((B, ge) => {
                ...
                je.swalPromiseResolve.set(c, B), je.swalPromiseReject.set(c, ge), h.confirmButton.onclick = () => Os(c), h.denyButton.onclick = () => Rs(c), h.cancelButton.onclick = () => Wo(c, He), h.closeButton.onclick = () => He(Xn.close), qo(c, h, He), on(c, it, b, He), p(c, b), jr(b), qe(it, b, He), Ht(h, b), setTimeout(() => {
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp1/wordspud/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    bC = Et.View.extend({
        ...
        onResize() {
            ...
            const n = document.getElementById("cameraCanvas"),
                i = Oe(".canvasContainer");
            if (!n || !i) return;
            const a = i.width(),
                f = Math.max(Oe(window).innerHeight(), 250),
                v = Math.min(a / t, f / e),
                S = t * v,
                k = e * v;
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp1/wordspud/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
class AC {
    constructor(e, n = {}) {
        ...
        this.canvasSelector = e, this.canvas = Oe(this.canvasSelector)[0], this.ctx = this.canvas.getContext("2d"), this.options = Object.assign(ac, n), this.history = [], this.layerNames.forEach(i => {
    ...
    MC = Et.View.extend({
        ...
        bindings: {
            ...
            ".footer": {
                ...
                updateMethod: "html",
                onGet(t) {
                    return t ? t.html ? t.html : Oe("<div />").text(t.text).html() : null
                }
            },
            ".submitDrawing": {
        ...
        onResize() {
            const t = Oe("#sketchpad"),
                e = Oe("#sketchpad canvas")[0];
            if (!e) return;
            const n = parseInt(Oe(".controller-content").css("border-top-width"), 10) * 2 + Oe(".playerTopBar").innerHeight() + Oe("#prompt").innerHeight() + Oe("#toolbar").innerHeight() + parseInt(Oe(".canvasContainer").css("border-top-width"), 10) * 2 + Oe("#buttons").innerHeight() + Oe("#post-sketchpad").innerHeight() + 10,
                i = parseInt(parseInt(Oe(".canvasContainer").css("border-left-width"), 10) * 2 || 0 + parseInt(Oe(".canvasContainer").css("padding-left"), 10) * 2 || 0 + parseInt(Oe(".Draw").css("padding-left"), 10) * 2 || 0, 10),
                a = e.width,
                f = e.height,
                v = 2,
                S = Math.min(t.width() - i, a * v),
                k = Math.max(Oe("#controller-container").innerHeight() - n, 250),
                I = Math.min(S / a, k / f),
                D = a * I,
                $ = f * I;
    ...
    NC = Et.View.extend({
        ...
        bindings: {
            ...
            ".doneText": {
                ...
                updateMethod: "html",
                onGet(t) {
                    return t ? t.html ? t.html : Oe("<div />").text(t.text).html() : ""
                }
            },
            ":el": {
                attributes: [{
...
const VC = Et.View.extend({
        ...
        render() {
            this.model.set("username", Gt.safeText(this.client.name), {
                silent: !0
        ...
        onAttach() {
            this.update().catch(this.caughtError), Oe(".gallery-link").click(this.artifactClicked.bind(this)), this.client.isRole("broadcaster") && this.showTwitchBroadcasterDialog(20 * 1e3)
        },
        ...
        showScreen(t, e) {
            const n = Oe(t);
            return this.activeScreen && t === this.activeScreen || (this.activeScreen && (Oe(this.activeScreen).fadeOut("fast", () => {}), Oe(this.activeScreen).show(), Oe(this.activeScreen).addClass("pt-page-off")), n.hide(), n.removeClass("pt-page-off"), n.removeClass("pt-page-moveToLeft"), n.fadeIn("fast", () => {
                e && e()
        ...
        onResize() {
            const t = Oe("#player").outerHeight(!0) || 0,
                e = ni.isVisible ? Oe("#slide-in-banner").outerHeight(!0) : 0,
                n = Oe(window).width(),
                i = Oe(window).height() - t;
            Oe(`.${this.getOption("appTag")}-page`).css("height", i - e), Oe(`.${this.getOption("appTag")}-page`).attr("height", i - e), Oe(`.${this.getOption("appTag")}-page`).css("top", t), Oe(`.${this.getOption("appTag")}-page`).css("width", n), Oe(`.${this.getOption("appTag")}-page`).attr("width", n)
        }
    }),
    ...
    FC = Et.View.extend({
            ...
            if (this.strings = this.model.get("strings"), this.choicesListView.collection.reset(), this.titleComponent.model.set("html", this.getOption("strings").wait), this.model.get("playerIsVIP") && (this.model.get("gameCanStart") ? this.model.get("playerCanStartGame") && (this.model.get("gameIsStarting") ? (this.titleComponent.model.set("html", this.getOption("strings").vip_cancel), this.choicesListView.collection.add({
                ...
                if (this.model.get("activeContentId")) {
                    const n = this.model.get("activeContentId"),
                        ...
                        a = i && i.metadata ? Gt.htmlUnescape(i.metadata.title) : null;
        ...
        async onButtonClick(t) {
            const e = this;
            t.preventDefault();
            const i = Oe(t.currentTarget).data("action");
            if (i !== "back" && i !== "censorConfirm" && i !== "activateContentId")
                ...
                didOpen: () => {
                    ...
                    })))), a.render(), Oe(".lobbyUgcInput").mask("aaa-aaaa", {
                        placeholder: "???-????"
    ...
    UC = Et.View.extend({
        ...
        bindings: {
            ...
            ".messageText": {
                ...
                updateMethod: "html",
                onGet(t) {
                    return !t || !t.html && !t.text ? null : t.html ? t.html : Oe("<div />").text(t.text).html()
                }
            },
            "#action": "action",
            ".artifactContainer": {
...
var Ie, $t, ut, Pt, Ii, Ws, Vt, ui, cr, _n, as, ci, $s, tn, lr = !1,
    io = !1,
    ro = [],
    Ai, Ln, fa, pa, fc, pc, Qr, sr, ls, cs = !1,
    js = !1,
    qs, ln, ga = [],
    Da = !1,
    so = [],
...
Qe.prototype = {
    ...
    _onTapStart: function(e) {
        if (!!e.cancelable) {
            var n = this,
                ...
                D = a.filter;
            if (bx(i), !Ie && !(/mousedown|pointerdown/.test(v) && e.button !== 0 || a.disabled) && !I.isContentEditable && !(!this.nativeDraggable && ss && k && k.tagName.toUpperCase() === "SELECT") && (k = $n(k, a.draggable, i, !1), !(k && k.animated) && Ws !== k)) {
    ...
    _onDragOver: function(e) {
        ...
        function m(ye, ue) {
            wn(ye, Y, zn({
                ...
                onMove: function(ke, $e) {
                    return zs(Pt, n, Ie, a, ke, Kt(ke), e, $e)
                },
                changed: ae
            }, ue))
        }
        ...
        if (io = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : tn === this || (this.lastPutMode = $s.checkPull(this, I, Ie, e)) && k.checkPut(this, I, Ie, e))) {
            ...
            if (!se || mx(e, ie, this) && !se.animated) {
                ...
                var ve = yr(n, 0, S, !0);
                if (ve === Ie) return W(!1);
                if (i = ve, f = Kt(i), zs(Pt, n, Ie, a, i, f, e, !1) !== !1) return P(), n.insertBefore(Ie, ve), $t = n, ae(), W(!0)
                ...
                sr !== i && (Ee = f[lt], cs = !1, js = !Pe && S.invertSwap || Ae), d = vx(e, i, f, ie, Pe ? 1 : S.swapThreshold, S.invertedSwapThreshold == null ? S.swapThreshold : S.invertedSwapThreshold, js, sr === i);
                var Fe;
                if (d !== 0) {
                    var U = On(Ie);
                ...
                var oe = i.nextElementSibling,
                    Te = !1;
                Te = d === 1;
                var we = zs(Pt, n, Ie, a, i, f, e, Te);
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Da = !0, setTimeout(px, 30), P(), Te && !oe ? n.appendChild(Ie) : i.parentNode.insertBefore(Ie, Te ? oe : i), Be && nh(Be, 0, K - Be.scrollTop), $t = Ie.parentNode, Ee !== void 0 && !js && (qs = Math.abs(Ee - Kt(i)[lt])), ae(), W(!0)
            }
    ...
    _nulling: function() {
        wn("nulling", this), Pt = Ie = $t = ut = Ii = Vt = Ws = ui = Ai = Ln = Qr = _n = ci = cr = as = sr = ls = tn = $s = Qe.dragged = Qe.ghost = Qe.clone = Qe.active = null, so.forEach(function(e) {
            e.checked = !0
        }), so.length = fa = pa = 0
    },
...
function vx(t, e, n, i, a, f, v, S) {
    ...
    if (!v) {
        if (S && qs < I * a) {
            ...
            else if (ls === 1 ? k < D + qs : k > $ - qs) return -ls
        ...
        if (!!e.scroll) {
            ...
            do {
                var ie = J,
                    ...
                    lt = ie.scrollLeft,
                    Be = ie.scrollTop;
                ie === k ? (ve = ae < Ee && (Pe.overflowX === "auto" || Pe.overflowX === "scroll" || Pe.overflowX === "visible"), d = se < Ae && (Pe.overflowY === "auto" || Pe.overflowY === "scroll" || Pe.overflowY === "visible")) : (ve = ae < Ee && (Pe.overflowX === "auto" || Pe.overflowX === "scroll"), d = se < Ae && (Pe.overflowY === "auto" || Pe.overflowY === "scroll"));
                ...
                (qt[$].vx != K || qt[$].vy != Fe || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = Fe, clearInterval(qt[$].pid), (K != 0 || Fe != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    ...
                    typeof D == "function" && D.call(Qe.dragged.parentNode[Sn], Te, oe, t, oo, qt[this.layer].el) !== "continue" || nh(qt[this.layer].el, Te, oe)
                }.bind({
                    layer: $
                }), 24))), $++
    ...
    Ox = Et.View.extend({
        ...
        update() {
            ...
            const e = this.model.get("episodes").map(n => {
                const i = Gt.htmlUnescape(n.metadata.title);
                let a = Gt.safeText(i);
        ...
        onActionButtonClicked(t) {
            const e = Oe(t.currentTarget).data("action");
            if (e === "submit") {
...
<div id="control-panel" class="control-panel">\r
    ...
    Lx = Et.View.extend({
        ...
        initialize(t) {
            ...
            }), this.throttledUpdate = at.throttle(this.updateVector, this.model.get("throttle")), this.listenTo(this.model, "change", this.update, this), this.onResizeWithContext = this.onResize.bind(this), window.addEventListener("resize", this.onResizeWithContext), Oe(window).on("mousemove", this.move.bind(this)), Oe(window).on("mouseup", this.end.bind(this))
        },
        onBeforeDestroy() {
            window.removeEventListener("resize", this.onResizeWithContext), Oe(window).off("mousemove"), Oe(window).off("mouseup")
        },
        update() {
        ...
        onResize() {
            const t = Oe(".radial"),
                e = Oe("#status-bar").outerHeight() + Oe(".playerTopBar").outerHeight() + Oe("#control-panel").outerHeight() + 10,
                n = Oe(".controller-page").width(),
...
Et.View.extend({
    ...
    setTextDescriptions(t) {
        t && t.length && (this.textDescriptions = this.textDescriptions || [], t.forEach(e => {
            (e.id === void 0 || !this.textDescriptions.slice(-10).find(n => n.id === e.id)) && (this.textDescriptions.push(e), Oe("#textDescriptions").append(Oe("<p />").text(e.text)))
        }))
    },
    parseBlob(t) {
        return t
    ...
    onResize() {
        const t = Oe(window).width(),
            e = Oe(window).height();
        Oe(".content,.controller-page").css({
            height: e,
            width: t
        })
    },
    ...
    t.mask = {
        ...
        mask: function(v, S) {
            ...
            return S = t.extend({
                ...
                completed: null
            }, S), I = t.mask.definitions, D = [], $ = Y = v.length, J = null, t.each(v.split(""), function(P, W) {
...
const zx = VC.extend({
    ...
    async update() {
        const t = this.model.get("player") || {},
            e = this.model.get("room") || {};
        if (this.typeInterval && (clearInterval(this.typeInterval), this.typeInterval = null), t && t.color !== void 0 && t.color !== null && Oe("#player").css("background-color", t.color), !!e) {
            if (e.state === "Lobby_WaitingForMore") this.showScreen(".state-waiting");
            else if (e.state === "Lobby_CanStart") this.showScreen(".state-startbutton");
            else if (e.state === "Gameplay") t.state === "Gameplay" ? (Oe("input.comment").val(""), !e.currentWord !== void 0 && Oe("#wordspud-nothing-root").html(`${this.getLastWord(e.currentWord)}_`), this.showScreen(".state-nothing")) : t.state === "Gameplay_Enter" && (Oe("input.spud").val(""), this.currentSpud = "", this.typeInterval = setInterval(() => {
                this.lastSpud !== this.currentSpud && this.sendSpud(this.currentSpud)
            }, this.typeDelayTime), e.currentWord !== void 0 && Oe("#wordspud-writing-root").html(`${this.getLastWord(e.currentWord)}_`), window.navigator && window.navigator.vibrate && window.navigator.vibrate(250), this.showScreen(".state-writing"));
            else if (e.state === "Vote") {
                const n = this.getLastWord(e.currentWord);
                t.state === "Gameplay_Enter" ? (Oe("#wordspud-vote-wait-spud").html(`${n} <font color='${e.color}'>${Gt.safeText(e.spud)}</font>`), this.showScreen(".state-vote-wait")) : t.state === "Voted" ? (Oe("#wordspud-voted-spud").html(`${n} <font color='${e.color}'>${Gt.safeText(e.spud)}</font>`), this.showScreen(".state-voted")) : (Oe("#wordspud-vote-spud").html(`${n} <font color='${e.color}'>${Gt.safeText(e.spud)}</font>`), this.showScreen(".state-vote"))
            } else e.state === "GameOver" && this.showScreen(".state-gameover");
            this.onResize()
        }
    },
    startGame() {
        return this.activeScreen !== ".state-startbutton" || this.client.send("SendMessageToRoomOwner", {
            startGame: !0
        }), !1
    },
    submitWord() {
        return this.activeScreen !== ".state-writing" || Oe.trim(Oe("input.spud").val()) === "" || (this.typeInterval && (clearTimeout(this.typeInterval), this.typeInterval = null), this.client.send("SendMessageToRoomOwner", {
            spud: Oe("input.spud").val().toUpperCase(),
            submitted: !0
        })), !1
    },
    submitComment() {
        return this.activeScreen !== ".state-nothing" || Oe.trim(Oe("input.comment").val()) === "" || (this.client.send("SendMessageToRoomOwner", {
            comment: Oe("input.comment").val()
        }), Oe("input.comment").val("")), !1
    },
    editWord(t) {
        this.activeScreen === ".state-writing" && (this.currentSpud = t.target.value.toUpperCase())
    },
    sendSpud(t) {
        this.lastSpud = t, this.client.send("SendMessageToRoomOwner", {
            spud: t,
            submitted: !1
        })
    },
    vote(t) {
        const e = Oe(t.currentTarget).data("vote");
    ...
    getLastWord(t) {
        ...
        const e = t.split(" ");
        let n;
        return e.length > 0 && (n = e[e.length - 1]), n ? Gt.safeText(n) : ""
    }
});
jx({
    MainView: zx
});
//# sourceMappingURL=af18ff28.js.map