    ...
    (function() {
        ...
        var ae = function(l, g) {
                return function(_) {
                    ...
                    for (var L = 1; L < O; L++)
                        for (var V = arguments[L], te = l(V), ke = te.length, he = 0; he < ke; he++) {
                            var De = te[he];
        ...
        function Pe(l) {
            ...
            return function(_, O, L, V) {
                ...
                var te = !Oe(_) && m.keys(_),
                    ke = (te || _).length,
                    he = l > 0 ? 0 : ke - 1;
                return arguments.length < 3 && (L = _[te ? te[he] : he], he += l), g(_, O, L, te, he, ke)
            }
        }
        m.reduce = m.foldl = m.inject = Pe(1), m.reduceRight = m.foldr = Pe(-1), m.find = m.detect = function(l, g, _) {
            ...
            } else g = q(g, _), m.each(l, function(De, Me, nt) {
            ...
            for (var g = Oe(l) ? l : m.values(l), _ = g.length, O = Array(_), L = 0, V; L < _; L++) V = m.random(0, L), V !== L && (O[L] = O[V]), O[V] = g[L];
            return O
        ...
        var Be = function(l, g, _, O) {
            for (var L = [], V = 0, te = O || 0, ke = _e(l); te < ke; te++) {
                var he = l[te];
        ...
        m.flatten = function(l, g) {
            ...
            for (var L = [], V = [], te = 0, ke = _e(l); te < ke; te++) {
                var he = l[te],
                    De = _ ? _(he, te, l) : he;
            ...
            for (var g = [], _ = arguments.length, O = 0, L = _e(l); O < L; O++) {
                var V = l[O];
                if (!m.contains(g, V)) {
            ...
            for (var _ = {}, O = 0, L = _e(l); O < L; O++) g ? _[l[O]] = g[O] : _[l[O][0]] = l[O][1];
            return _
        };
        ...
        function K(l) {
            return function(g, _, O) {
                _ = q(_, O);
                for (var L = _e(g), V = l > 0 ? 0 : L - 1; V >= 0 && V < L; V += l)
        ...
        m.findIndex = K(1), m.findLastIndex = K(-1), m.sortedIndex = function(l, g, _, O) {
            _ = q(_, O, 1);
            for (var L = _(g), V = 0, te = _e(l); V < te;) {
                var ke = Math.floor((V + te) / 2);
                _(l[ke]) < L ? V = ke + 1 : te = ke
            }
            return V
        };
        ...
        function Fe(l, g, _) {
            return function(O, L, V) {
                ...
                else if (_ && V && ke) return V = _(O, L), O[V] === L ? V : -1;
                if (L !== L) return V = g(k.call(O, te, ke), m.isNaN), V >= 0 ? V + te : -1;
        ...
        m.bind = function(l, g) {
            ...
            _ || (_ = {});
            var he = function() {
                ke = _.leading === !1 ? 0 : m.now(), te = null, V = l.apply(O, L), te || (O = L = null)
            };
            return function() {
                var De = m.now();
                !ke && _.leading === !1 && (ke = De);
                var Me = g - (De - ke);
                return O = this, L = arguments, Me <= 0 || Me > g ? (te && (clearTimeout(te), te = null), ke = De, V = l.apply(O, L), te || (O = L = null)) : !te && _.trailing !== !1 && (te = setTimeout(he, Me)), V
            }
        }, m.debounce = function(l, g, _) {
            var O, L, V, te, ke, he = function() {
                var De = m.now() - te;
                De < g && De >= 0 ? O = setTimeout(he, g - De) : (O = null, _ || (ke = l.apply(V, L), O || (V = L = null)))
            };
            return function() {
                V = this, L = arguments, te = m.now();
                var De = _ && !O;
                return O || (O = setTimeout(he, g)), De && (ke = l.apply(V, L), V = L = null), ke
            }
        }, m.wrap = function(l, g) {
        ...
        function be(l, g) {
            var _ = Ae.length,
                ...
                V = "constructor";
            for (m.has(l, V) && !m.contains(g, V) && g.push(V); _--;) V = Ae[_], V in l && l[V] !== L[V] && !m.contains(g, V) && g.push(V)
        }
        m.keys = function(l) {
            if (!m.isObject(l)) return [];
            if (J) return J(l);
            ...
            g = q(g, _);
            for (var O = m.keys(l), L = O.length, V = {}, te, ke = 0; ke < L; ke++) te = O[ke], V[te] = g(l[te], te, l);
            return V
        }, m.pairs = function(l) {
        ...
        var we = function(l, g, _, O) {
            ...
            if (_.push(l), O.push(g), V) {
                ...
                for (; he--;)
                    if (!we(l[he], g[he], _, O)) return !1
            } else {
                var De = m.keys(l),
                    Me;
                if (he = De.length, m.keys(g).length !== he) return !1;
                for (; he--;)
                    if (Me = De[he], !(m.has(g, Me) && we(l[Me], g[Me], _, O))) return !1
            }
        ...
        m.template = function(l, g, _) {
            ...
            l.replace(O, function(De, Me, nt, Ct, rn) {
                return V += l.slice(L, rn).replace(Bt, Gt), L = rn + De.length, Me ? V += `'+
...
(function(t) {
    (function(e, n) {
        ...
        var Oe = function(r) {
            var s, u, p, w, x, T, z, H, Z, le, Ce, ne, ce, Ge, rt, je, zt, Nt, un, _t = "sizzle" + 1 * new Date,
                et = r.document,
                on = 0,
                ft = 0,
                Dt = Yi(),
            ...
            function St(R, F, X, de) {
                var ee, me, Ee, Re, Le, ze, Ue, Xe = F && F.ownerDocument,
                    ht = F ? F.nodeType : 9;
            ...
            u = St.support = {}, x = St.isXML = function(R) {
                ...
                return de == ce || de.nodeType !== 9 || !de.documentElement || (ce = de, Ge = ce.documentElement, rt = !x(ce), et != ce && (X = ce.defaultView) && X.top !== X && (X.addEventListener ? X.addEventListener("unload", Rs, !1) : X.attachEvent && X.attachEvent("onunload", Rs)), u.scope = yn(function(ee) {
                    ...
                    if (typeof me.getElementById < "u" && rt) {
                        var Ee, Re, Le, ze = me.getElementById(ee);
                        if (ze) {
                ...
                filter: {
                    ...
                    CHILD: function(R, F, X, de, ee) {
                        ...
                        return de === 1 && ee === 0 ? function(Le) {
                            ...
                            var Xe, ht, Tt, We, Ht, Jt, fn = me !== Ee ? "nextSibling" : "previousSibling",
                                At = Le.parentNode,
                            ...
                            if (At) {
                                ...
                                if (Jt = [Ee ? At.firstChild : At.lastChild], Ee && h) {
                                    ...
                                    for (;
                                        (We = ++Ht && We && We[fn] || (b = Ht = 0) || Jt.pop()) && !((Re ? We.nodeName.toLowerCase() === c : We.nodeType === 1) && ++b && (h && (Tt = We[_t] || (We[_t] = {}), ht = Tt[We.uniqueID] || (Tt[We.uniqueID] = {}), ht[R] = [on, b]), We === Le)););
                    ...
                    PSEUDO: function(R, F) {
                        ...
                        return de[_t] ? de(F) : de.length > 1 ? (X = [R, R, "", F], p.setFilters.hasOwnProperty(R.toLowerCase()) ? dn(function(ee, me) {
                            for (var Ee, Re = de(ee, F), Le = Re.length; Le--;) Ee = Qn(ee, Re[Le]), ee[Ee] = !(me[Ee] = Re[Le])
                        }) : function(ee) {
                            return de(ee, 0, X)
                        }) : de
                    }
            ...
            Ds.prototype = p.filters = p.pseudos, p.setFilters = new Ds, T = St.tokenize = function(R, F) {
                var X, de, ee, me, Ee, Re, Le, ze = _i[R + " "];
                ...
                for (Ee = R, Re = [], Le = p.preFilter; Ee;) {
                    ...
                    for (me in p.filter)(de = Xi[me].exec(Ee)) && (!Le[me] || (de = Le[me](de))) && (X = de.shift(), ee.push({
                        value: X,
                        type: me,
                        matches: de
                    }), Ee = Ee.slice(X.length));
            ...
            function tr(R, F, X, de, ee) {
                for (var me, Ee = [], Re = 0, Le = R.length, ze = F != null; Re < Le; Re++)(me = R[Re]) && (!X || X(me, de, ee)) && (Ee.push(me), ze && F.push(Re));
                return Ee
            }

            function qr(R, F, X, de, ee, me) {
                return de && !de[_t] && (de = qr(de)), ee && !ee[_t] && (ee = qr(ee, me)), dn(function(Ee, Re, Le, ze) {
                    var Ue, Xe, ht, Tt = [],
                        We = [],
                        Ht = Re.length,
                        Jt = Ee || Yo(F || "*", Le.nodeType ? [Le] : Le, []),
                        fn = R && (Ee || !F) ? tr(Jt, Tt, R, Le, ze) : Jt,
                        At = X ? ee || (Ee ? R : Ht || de) ? [] : Re : fn;
            ...
            function Wr(R) {
                for (var F, X, de, ee = R.length, me = p.relative[R[0].type], Ee = me || p.relative[" "], Re = me ? 1 : 0, Le = Zi(function(Xe) {
                        return Xe === F
                ...
                var X = F.length > 0,
                    ...
                    ee = function(me, Ee, Re, Le, ze) {
                        ...
                        for (ze && (Z = Ee == ce || Ee || ze); We !== h && (Ue = At[We]) != null; We++) {
                            if (de && Ue) {
                                for (Xe = 0, !Ee && Ue.ownerDocument != ce && (ne(Ue), Re = !rt); ht = R[Xe++];)
                                    if (ht(Ue, Ee || ce, Re)) {
                                        Le.push(Ue);
                                        break
                                    } ze && (on = c)
                        ...
                        if (Tt += We, X && We !== Tt) {
                            ...
                            if (me) {
                                if (Tt > 0)
                                    for (; We--;) Ht[We] || Jt[We] || (Jt[We] = Mn.call(Le));
                                Jt = tr(Jt)
                            }
            ...
            return z = St.compile = function(R, F) {
                ...
                var ee, me, Ee, Re, Le, ze = typeof R == "function" && R,
                ...
                if (X = X || [], Ue.length === 1) {
                    ...
                    for (ee = Xi.needsContext.test(R) ? 0 : me.length; ee-- && (Ee = me[ee], !p.relative[Re = Ee.type]);)
                        if ((Le = p.find[Re]) && (de = Le(Ee.matches[0].replace(Tn, xn), Hr.test(me[0].type) && Gr(F.parentNode) || F))) {
                                ...
                                return function() {
                                    var Ge = this,
                                        ...
                                        je = function() {
                                            var Nt, un;
                                            if (!(le < H)) {
                                                if (Nt = ne.apply(Ge, rt), Nt === Ce.promise()) throw new TypeError("Thenable self-resolution");
                                                un = Nt && (typeof Nt == "object" || typeof Nt == "function") && Nt.then, re(un) ? ce ? un.call(Nt, Z(H, Ce, Ke, ce), Z(H, Ce, dt, ce)) : (H++, un.call(Nt, Z(H, Ce, Ke, ce), Z(H, Ce, dt, ce), Z(H, Ce, Ke, Ce.notifyWith))) : (ne !== Ke && (Ge = void 0, rt = [Nt]), (ce || Ce.resolveWith)(Ge, rt))
                                            }
                                        },
                                        zt = ce ? je : function() {
                                            try {
                                                ...
                                                d.Deferred.exceptionHook && d.Deferred.exceptionHook(Nt, zt.stackTrace), le + 1 >= H && (ne !== dt && (Ge = void 0, rt = [Nt]), Ce.rejectWith(Ge, rt))
                                            }
                                        };
        ...
        function In(r, s, u, p, w) {
            for (var x, T, z, H, Z, le, Ce = s.createDocumentFragment(), ne = [], ce = 0, Ge = r.length; ce < Ge; ce++)
                if (x = r[ce], x || x === 0)
                    if (se(x) === "object") d.merge(ne, x.nodeType ? [x] : x);
                    else if (!Ye.test(x)) ne.push(s.createTextNode(x));
            else {
                for (T = T || Ce.appendChild(s.createElement("div")), z = (pe.exec(x) || ["", ""])[1].toLowerCase(), H = Ve[z] || Ve._default, T.innerHTML = H[1] + d.htmlPrefilter(x) + H[2], le = H[0]; le--;) T = T.lastChild;
        ...
        d.event = {
            ...
            add: function(r, s, u, p, w) {
                var x, T, z, H, Z, le, Ce, ne, ce, Ge, rt, je = he.get(r);
                if (!!te(r))
                    for (u.handler && (x = u, u = x.handler, w = x.selector), w && d.find.matchesSelector(Kt, w), u.guid || (u.guid = d.guid++), (H = je.events) || (H = je.events = Object.create(null)), (T = je.handle) || (T = je.handle = function(zt) {
                        ...
                        }), s = (s || "").match(Te) || [""], Z = s.length; Z--;) z = Pn.exec(s[Z]) || [], ce = rt = z[1], Ge = (z[2] || "").split(".").sort(), ce && (Ce = d.event.special[ce] || {}, ce = (w ? Ce.delegateType : Ce.bindType) || ce, Ce = d.event.special[ce] || {}, le = d.extend({
                        type: ce,
                        origType: rt,
                        data: p,
                        handler: u,
                        ...
                        namespace: Ge.join(".")
                    }, x), (ne = H[ce]) || (ne = H[ce] = [], ne.delegateCount = 0, (!Ce.setup || Ce.setup.call(r, p, Ge, T) === !1) && r.addEventListener && r.addEventListener(ce, T)), Ce.add && (Ce.add.call(r, le), le.handler.guid || (le.handler.guid = u.guid)), w ? ne.splice(ne.delegateCount++, 0, le) : ne.push(le), d.event.global[ce] = !0)
            },
            remove: function(r, s, u, p, w) {
                var x, T, z, H, Z, le, Ce, ne, ce, Ge, rt, je = he.hasData(r) && he.get(r);
                if (!(!je || !(H = je.events))) {
                    for (s = (s || "").match(Te) || [""], Z = s.length; Z--;) {
                        ...
                        for (Ce = d.event.special[ce] || {}, ce = (p ? Ce.delegateType : Ce.bindType) || ce, ne = H[ce] || [], z = z[2] && new RegExp("(^|\\.)" + Ge.join("\\.(?:.*\\.|)") + "(\\.|$)"), T = x = ne.length; x--;) le = ne[x], (w || rt === le.origType) && (!u || u.guid === le.guid) && (!z || z.test(le.namespace)) && (!p || p === le.selector || p === "**" && le.selector) && (ne.splice(x, 1), le.selector && ne.delegateCount--, Ce.remove && Ce.remove.call(r, le));
                        T && !ne.length && ((!Ce.teardown || Ce.teardown.call(r, Ge, je.handle) === !1) && d.removeEvent(r, ce, je.handle), delete H[ce])
                    }
        ...
        function mn(r, s, u, p) {
            ...
            var w, x, T, z, H, Z, le = 0,
                ...
                ce = s[0],
                Ge = re(ce);
            if (Ge || Ce > 1 && typeof ce == "string" && !Y.checkClone && Tr.test(ce)) return r.each(function(rt) {
                var je = r.eq(rt);
        ...
        (function() {
            ...
            !Z.style || (Z.style.backgroundClip = "content-box", Z.cloneNode(!0).style.backgroundClip = "", Y.clearCloneStyle = Z.style.backgroundClip === "content-box", d.extend(Y, {
                ...
                reliableTrDimensions: function() {
                    var le, Ce, ne, ce;
                    return T == null && (le = P.createElement("table"), Ce = P.createElement("tr"), ne = P.createElement("div"), le.style.cssText = "position:absolute;left:-11111px;border-collapse:separate", Ce.style.cssText = "border:1px solid", Ce.style.height = "1px", ne.style.height = "9px", ne.style.display = "block", Kt.appendChild(le).appendChild(Ce).appendChild(ne), ce = e.getComputedStyle(Ce), T = parseInt(ce.height, 10) + parseInt(ce.borderTopWidth, 10) + parseInt(ce.borderBottomWidth, 10) === Ce.offsetHeight, Kt.removeChild(le)), T
                }
            }))
        })();
        ...
        function xo(r, s, u) {
            ...
            for (p in s)
                ...
                Ce && r.nodeType === 1 && (u.overflow = [Ge.overflow, Ge.overflowX, Ge.overflowY], Z = je && je.display, Z == null && (Z = he.get(r, "display")), le = d.css(r, "display"), le === "none" && (Z ? le = Z : (G([r], !0), Z = r.style.display || Z, le = d.css(r, "display"), G([r]))), (le === "inline" || le === "inline-block" && Z != null) && d.css(r, "float") === "none" && (H || (ne.done(function() {
                    Ge.display = Z
        ...
        function bn(r, s, u) {
            var p, w, x = 0,
                ...
                H = function() {
                    if (w) return !1;
                    for (var Ce = Ft || Rr(), ne = Math.max(0, Z.startTime + Z.duration - Ce), ce = ne / Z.duration || 0, Ge = 1 - ce, rt = 0, je = Z.tweens.length; rt < je; rt++) Z.tweens[rt].run(Ge);
        ...
        d.extend(d.event, {
            trigger: function(r, s, u, p) {
                ...
                if (x = Ce = T = u = u || P, !(u.nodeType === 3 || u.nodeType === 8) && !Mr.test(ce + d.event.triggered) && (ce.indexOf(".") > -1 && (Ge = ce.split("."), ce = Ge.shift(), Ge.sort()), H = ce.indexOf(":") < 0 && "on" + ce, r = r[d.expando] ? r : new d.Event(ce, typeof r == "object" && r), r.isTrigger = p ? 2 : 3, r.namespace = Ge.join("."), r.rnamespace = r.namespace ? new RegExp("(^|\\.)" + Ge.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, r.result = void 0, r.target || (r.target = u), s = s == null ? [r] : d.makeArray(s, [r]), le = d.event.special[ce] || {}, !(!p && le.trigger && le.trigger.apply(u, s) === !1))) {
                    ...
                    for (w = 0;
                        (x = ne[w++]) && !r.isPropagationStopped();) Ce = x, r.type = w > 1 ? z : le.bindType || ce, Z = (he.get(x, "events") || Object.create(null))[r.type] && he.get(x, "handle"), Z && Z.apply(x, s), Z = H && x[H], Z && Z.apply && te(x) && (r.result = Z.apply(x, s), r.result === !1 && r.preventDefault());
                    return r.type = ce, !p && !r.isDefaultPrevented() && (!le._default || le._default.apply(ne.pop(), s) === !1) && te(u) && H && re(u[ce]) && !m(u) && (T = u[H], T && (u[H] = null), d.event.triggered = ce, r.isPropagationStopped() && Ce.addEventListener(ce, Xn), u[ce](), r.isPropagationStopped() && Ce.removeEventListener(ce, Xn), d.event.triggered = void 0, T && (u[H] = T)), r.result
                }
            },
    ...
    (function(e) {
        ...
        var m = function(E, l, g, _) {
            if (!!E) {
                var O = 0,
                    ...
                    te = _.listeners;
                if (!l && !g && !V) {
                    for (var ke = i.keys(te); O < ke.length; O++) L = te[ke[O]], delete te[L.id], delete L.listeningTo[L.objId];
                    return
                }
        ...
        i.extend(se.prototype, $, {
            ...
            set: function(E, l, g) {
                ...
                for (var Me in _) l = _[Me], i.isEqual(ke[Me], l) || V.push(Me), i.isEqual(De[Me], l) ? delete he[Me] : he[Me] = l, O ? delete ke[Me] : ke[Me] = l;
            ...
            set: function(E, l) {
                if (E != null) {
                    ...
                    for (yt = 0; yt < E.length; yt++) {
                        ...
                        } else he && (ct = E[yt] = this._prepareModel(ct, l), ct && (L.push(ct), this._addReference(ct, l), ke[ct.cid] = !0, O.push(ct)))
                    }
                    if (Me) {
        ...
        i.extend(Be.prototype, $, {
            ...
            if (g.url || (O.url = i.result(l, "url") || Bt()), g.data == null && l && (E === "create" || E === "update" || E === "patch") && (O.contentType = "application/json", O.data = JSON.stringify(g.attrs || l.toJSON(g))), g.emulateJSON && (O.contentType = "application/x-www-form-urlencoded", O.data = O.data ? {
                ...
                g.beforeSend = function(ke) {
                    if (ke.setRequestHeader("X-HTTP-Method-Override", _), L) return L.apply(this, arguments)
                }
            }
        ...
        (function(v) {
            ...
            function Fe(U, oe) {
                return new Promise(function(Ae, be) {
                    ...
                    }, ue.open(we.method, we.url, !0), we.credentials === "include" ? ue.withCredentials = !0 : we.credentials === "omit" && (ue.withCredentials = !1), "responseType" in ue && S.blob && (ue.responseType = "blob"), we.headers.forEach(function(Te, $e) {
            ...
            return Fe.polyfill = !0, f.fetch || (f.fetch = Fe, f.Headers = Y, f.Request = Oe, f.Response = Be), v.Headers = Y, v.Request = Oe, v.Response = Be, v.fetch = Fe, Object.defineProperty(v, "__esModule", {
                value: !0
            }), v
        })({})
    ...
    Dw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        ...
        if (Iw(P) || Oa.isBuffer(P)) {
            if (S) {
                ...
                if (i === "comma" && Y) {
                    for (var _e = Aw.call(String(P), ","), Oe = "", Pe = 0; Pe < _e.length; ++Pe) Oe += (Pe === 0 ? "" : ",") + ie(S(_e[Pe], tn.encoder, re, "value", J));
        ...
        for (var Fe = a && ei(P) && P.length === 1 ? n + "[]" : n, U = 0; U < Be.length; ++U) {
            ...
            if (!(v && Ae === null)) {
                ...
                m.set(e, ae);
                var we = Kc();
                we.set(la, m), Jc(lt, t(Ae, be, i, a, f, v, S, k, I, D, $, J, ie, Y, re, we))
            }
        }
        return lt
    },
    ...
    (function(n, i) {
        ...
        function Pe(j, N, W) {
            ...
            var M, G, fe, pe, Ne, Ve, pt = ae.slice(),
                ...
                Ye = this,
                In = 0;
            for (jt !== "object" && jt !== "string" && (W = N, N = null), W && typeof W != "function" && (W = ie.parse), N = ve(N), G = _e(j || "", N), M = !G.protocol && !G.slashes, Ye.slashes = G.slashes || M && N.slashes, Ye.protocol = G.protocol || N.protocol || "", j = G.rest, (Ye.protocol === "file:" || !G.slashes && (G.protocol || G.slashesCount < 2 || !d(Ye.protocol))) && (pt[3] = [/(.*)/, "pathname"]); In < pt.length; In++) {
        ...
        function _(j, N, W) {
            ...
            Fe(function() {
                Se.removeWebSocket(j, j.url), j.readyState = Me.CLOSED, j.dispatchEvent(G), j.dispatchEvent(fe), M && M.dispatchEvent(G, M)
            }, j)
        }
        ...
        function O(j, N, W) {
            ...
            Fe(function() {
                Se.removeWebSocket(j, j.url), j.readyState = Me.CLOSED, j.dispatchEvent(pe), j.dispatchEvent(G), j.dispatchEvent(fe), M && M.dispatchEvent(G, M)
            }, j)
        }
        ...
        var Me = function(j) {
            ...
            return W.onopen.get = function() {
                ...
                if (!(this.readyState === N.CLOSING || this.readyState === N.CLOSED)) {
                    var Ne = te(this);
                    this.readyState === N.CONNECTING ? O(Ne, G || Te.CLOSE_ABNORMAL, fe) : _(Ne, G || Te.CLOSE_NO_STATUS, fe)
                }
        ...
        var rn = {
            ...
            ct = function(j) {
                ...
                return j && (N.__proto__ = j), N.prototype = Object.create(j && j.prototype), N.prototype.constructor = N, N.prototype.mockWebsocket = function() {
                    ...
                    Ne || (Ne = Se.websocketsLookup(this.url)), typeof fe != "object" || arguments.length > 3 ? (G = Array.prototype.slice.call(arguments, 1, arguments.length), G = G.map(function(Ve) {
                        return L(Ve)
                    ...
                    fe === void 0 && (fe = []);
                    var Ne = this,
                        Ve = nt(fe.concat(Se.websocketsLookup(this.url, M, G)));
                    return {
                        to: function(pt, jt) {
        ...
        return i.addHandler([{
            ...
            update: function(m, P, q, ae) {
                ...
                if (e.isArray(se)) Pe(se, m, P);
                    ...
                    var Ae = [],
                        be;
                    for (var we in se) be = {}, be[ve.valuePath] = we, be[ve.labelPath] = se[we], Ae.push(be);
...
const cC = `<form>\r
    ...
    to = Et.View.extend({
        ...
        onAttach() {
            this.getOption("preventAutosize") || rc(ye("textarea"))
        },
        onSubmitClick() {
        ...
        clearInput() {
            ...
            ye(t).val(""), this.getOption("preventAutosize") || rc.update(t), this.onInputChange()
        },
        setValue(t) {
...
`).replace(/(^|\n)\s*/g, ""),
        ...
        const Ui = (c, h) => {
                const b = Se();
                ct(b, h, "htmlContainer"), h.html ? (yi(h.html, b), W(b, "block")) : h.text ? (b.textContent = h.text, W(b, "block")) : M(b), xe(c, h)
            },
            bo = (c, h) => {
                const b = _();
...
`,
            ...
            Dr = (c, h) => {
                const b = U(),
                    B = be();
                h.toast ? (N(b, "width", h.width), B.style.width = "100%", B.insertBefore(E(), we())) : N(B, "width", h.width), N(B, "padding", h.padding), h.color && (B.style.color = h.color), h.background && (B.style.background = h.background), M(Ke()), So(B, h)
            },
            So = (c, h) => {
...
`).join("<br />")), vi(c)
        ...
        const bs = () => {
            ...
            jr = c => {
                ...
                r(h, b, c), setTimeout(() => {
                    Vo(h, b)
                }, $r), ke() && (Bo(h, c.scrollbarPadding, ge), xi()), !he() && !it.previousActiveElement && (it.previousActiveElement = document.activeElement), typeof c.didOpen == "function" && setTimeout(() => c.didOpen(b)), Lt(h, K["no-transition"])
            },
            Es = c => {
                const h = be();
            ...
            s = c => {
                ...
                h || new At, h = be();
                const b = E();
                he() ? M(we()) : u(h, c), W(b), h.setAttribute("data-loading", "true"), h.setAttribute("aria-busy", "true"), h.focus()
            },
            u = (c, h) => {
                const b = g(),
                    B = E();
        ...
        function ce() {
            ...
            M(h.loader), he() ? c.icon && W(we()) : Ge(h), Lt([h.popup, h.actions], K.loading), h.popup.removeAttribute("aria-busy"), h.popup.removeAttribute("data-loading"), h.confirmButton.disabled = !1, h.denyButton.disabled = !1, h.cancelButton.disabled = !1
        }
        const Ge = c => {
        ...
        function Mn(c, h, b, B) {
            he() ? ks(c, B) : (gi(b).then(() => ks(c, B)), et(it)), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (h.setAttribute("style", "display:none !important"), h.removeAttribute("class"), h.innerHTML = "") : h.remove(), ke() && (Vr(), Ei(), Lr()), vn()
        }
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp1/lieswatter/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    bC = Et.View.extend({
        ...
        onResize() {
            ...
            if (!n || !i) return;
            const a = i.width(),
                f = Math.max(ye(window).innerHeight(), 250),
                v = Math.min(a / t, f / e),
                S = t * v,
                k = e * v;
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp1/lieswatter/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
class AC {
    constructor(e, n = {}) {
        ...
        this.canvasSelector = e, this.canvas = ye(this.canvasSelector)[0], this.ctx = this.canvas.getContext("2d"), this.options = Object.assign(ac, n), this.history = [], this.layerNames.forEach(i => {
    ...
    MC = Et.View.extend({
        ...
        onResize() {
            ...
            const n = parseInt(ye(".controller-content").css("border-top-width"), 10) * 2 + ye(".playerTopBar").innerHeight() + ye("#prompt").innerHeight() + ye("#toolbar").innerHeight() + parseInt(ye(".canvasContainer").css("border-top-width"), 10) * 2 + ye("#buttons").innerHeight() + ye("#post-sketchpad").innerHeight() + 10,
                ...
                k = Math.max(ye("#controller-container").innerHeight() - n, 250),
                I = Math.min(S / a, k / f),
                D = a * I,
                $ = f * I;
...
const VC = Et.View.extend({
        ...
        onResize() {
            const t = ye("#player").outerHeight(!0) || 0,
                e = ni.isVisible ? ye("#slide-in-banner").outerHeight(!0) : 0,
                n = ye(window).width(),
        ...
        async onButtonClick(t) {
            ...
            if (i !== "back" && i !== "censorConfirm" && i !== "activateContentId")
                ...
                didOpen: () => {
                    ...
                    })))), a.render(), ye(".lobbyUgcInput").mask("aaa-aaaa", {
                        placeholder: "???-????"
    ...
    _onDragOver: function(e) {
        ...
        if (io = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : en === this || (this.lastPutMode = $s.checkPull(this, I, Ie, e)) && k.checkPut(this, I, Ie, e))) {
            ...
            if (!se || mx(e, ie, this) && !se.animated) {
                ...
                var ve = yr(n, 0, S, !0);
                if (ve === Ie) return q(!1);
                if (i = ve, f = Yt(i), zs(Pt, n, Ie, a, i, f, e, !1) !== !1) return P(), n.insertBefore(Ie, ve), $t = n, ae(), q(!0)
                ...
                if (be !== !1) return (be === 1 || be === -1) && (Ae = be === 1), Da = !0, setTimeout(px, 30), P(), Ae && !oe ? n.appendChild(Ie) : i.parentNode.insertBefore(Ie, Ae ? oe : i), Be && nh(Be, 0, K - Be.scrollTop), $t = Ie.parentNode, _e !== void 0 && !js && (Ws = Math.abs(_e - Yt(i)[lt])), ae(), q(!0)
            }
        ...
        if (!!e.scroll) {
            ...
            do {
                ...
                (qt[$].vx != K || qt[$].vy != Fe || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = Fe, clearInterval(qt[$].pid), (K != 0 || Fe != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    ...
                    typeof D == "function" && D.call(Qe.dragged.parentNode[Sn], Ae, oe, t, oo, qt[this.layer].el) !== "continue" || nh(qt[this.layer].el, Ae, oe)
                }.bind({
                    layer: $
                }), 24))), $++
...
<div id="control-panel" class="control-panel">\r
    ...
    Lx = Et.View.extend({
        ...
        initialize(t) {
            ...
            }), this.throttledUpdate = at.throttle(this.updateVector, this.model.get("throttle")), this.listenTo(this.model, "change", this.update, this), this.onResizeWithContext = this.onResize.bind(this), window.addEventListener("resize", this.onResizeWithContext), ye(window).on("mousemove", this.move.bind(this)), ye(window).on("mouseup", this.end.bind(this))
        },
        onBeforeDestroy() {
            ...
            return S = t.extend({
                ...
                function Pe(we) {
                    if (!U.prop("readonly")) {
                        ...
                        re = U.val(), $e === 8 || $e === 46 || i && $e === 127 ? (ue = U.caret(), Se = ue.begin, Te = ue.end, Te - Se === 0 && (Se = $e !== 46 ? se(Se) : Te = ae(Se - 1), Te = $e === 46 ? ae(Te) : Te), Be(Se, Te), ve(Se, Te - 1), we.preventDefault()) : $e === 13 ? Oe.call(this, we) : $e === 27 && (U.val(be), U.caret(0, Fe()), we.preventDefault())
                    }
                }
                ...
                function Be(we, ue) {
                    var Se;
                    for (Se = we; ue > Se && Y > Se; Se++) D[Se] && (oe[Se] = q(Se))
                }
                ...
                function Fe(we) {
                    ...
                    return we ? K() : $ > Ke + 1 ? S.autoclear || oe.join("") === Ae ? (U.val() && U.val(""), Be(0, Y)) : K() : (K(), U.val(U.val().substring(0, Ke + 1))), $ ? ue : J
                }
                var U = t(this),
                    oe = t.map(v.split(""), function(we, ue) {
...
const $x = Et.View.extend({
    ...
    Fx = `<div id="page-lieswatter" class="page gray">
	<div id="player" class="player-lieswatter">
		<h1><%=username%></h1>
	</div>

	<div id="ls-preload-1" class="ls-preload-1"></div>
	<div id="ls-preload-2" class="ls-preload-2"></div>
	<div id="ls-preload-3" class="ls-preload-3"></div>
	<div id="ls-preload-4" class="ls-preload-4"></div>

    <div id="game" class="game pt-pageholder">
    	<div class="pt-page-off state-lobby lieswatter-page" style="background-color: #2D93F6;">
			<div class="container gameplay centered">
		...
		<div class="pt-page-off state-answer lieswatter-page">

			<div style="padding:0px; margin:0px; width:100%;">

				<div id="lieswatter-stats" style="background:#515151; padding-bottom: 5px;">
				...
				<div id="lieswatter-true-container" class="centered">
					<button aria-label="truth" type="button" id="lieswatter-true" data-ans="1" class="ls-truth-button"></button>
				</div>

				<div id="lieswatter-false-container" class="centered">
					<button aria-label="lie" type="button" id="lieswatter-false" data-ans="0" class="ls-lie-button"></button>
				</div>
			</div>
		</div>
...
const zx = VC.extend({
    ...
    async update() {
        const t = this.model.get("player"),
            ...
            n = t ? t.state : "",
            i = e ? e.state : "";
        if (n === "RoomFull") Ot.show(Error("The room is full"), {
            willClose: () => {
                window.location.reload(!0)
            }
        });
    ...
    hideLobbyButtons() {
        ye("#lieswatter-startgame").hide(), ye(".lieswatter-endbuttons").hide()
    },
    sendAnswer(t) {
        if (!this.allowSendAnswer) return !1;
        const e = ye(t.target).data("ans");
        return this.client.send("SendMessageToRoomOwner", {
            MessageType: "Answer",
            Answer: e
        }), ye("#lieswatter-statement").html(""), this.allowSendAnswer = !1, !1
    },
    onResize() {
        const t = ye(window).width() - 20,
            e = ye(window).height() - ye("#lieswatter-stats").outerHeight(!0) - ye("#player").outerHeight(!0) - ye("#lieswatter-statement-container").outerHeight(!0) - 15;
        let n = 0,
            i = 0;
        ye(window).width() > ye(window).height() ? (ye("#lieswatter-true-container").css("float", "left"), ye("#lieswatter-false-container").css("float", "right"), Math.floor(Math.floor(t / 2) / 2.16) > e ? (i = e, n = Math.floor(i * 2.16)) : (n = Math.floor(t / 2), i = Math.floor(n / 2.16))) : (ye("#lieswatter-true-container").css("float", ""), ye("#lieswatter-false-container").css("float", ""), Math.floor(Math.floor(e / 2) * 2.16) > t ? (n = t, i = Math.floor(n / 2.16)) : (i = Math.floor(e / 2), n = Math.floor(i * 2.16))), ye("#lieswatter-true").css("width", n), ye("#lieswatter-true").attr("width", n), ye("#lieswatter-true").css("height", i), ye("#lieswatter-true").attr("height", i), ye("#lieswatter-false").css("width", n), ye("#lieswatter-false").attr("width", n), ye("#lieswatter-false").css("height", i), ye("#lieswatter-false").attr("height", i), ye("#lieswatter-rank").prop("disabled", !0), ye("#lieswatter-score").prop("disabled", !0), ye("#lieswatter-combo").prop("disabled", !0), ye(".lieswatter-page").css("height", ye(window).height() - ye("#player").outerHeight(!0)), ye(".lieswatter-page").attr("height", ye(window).height() - ye("#player").outerHeight(!0)), ye(".lieswatter-page").css("width", ye(window).width()), ye(".lieswatter-page").attr("width", ye(window).width())
    }
});
jx({
    MainView: zx
});
//# sourceMappingURL=09a27e0e.js.map