...
var _g = Eg,
    ...
    Mt = {};
Mt[Hg] = Mt[Ug] = Mt[Gg] = Mt[qg] = Mt[Wg] = Mt[Xg] = Mt[Yg] = Mt[Kg] = Mt[Jg] = !0;
...
var ka = Sy,
    ...
    Vy = function t(e, n, i, a) {
        ...
        if (Qy(e)) {
            for (var m = "<" + Vl.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + Uc(By(P[q].value), "double", f);
    ...
    Dw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        ...
        if (Iw(P) || Oa.isBuffer(P)) {
            if (S) {
                ...
                if (i === "comma" && Y) {
                    for (var Ee = Aw.call(String(P), ","), Ae = "", Le = 0; Le < Ee.length; ++Le) Ae += (Le === 0 ? "" : ",") + ie(S(Ee[Le], tn.encoder, re, "value", J));
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/standalone-acquisitions-inc/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/standalone/acquisitions-inc/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/standalone/acquisitions-inc/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
const VC = `<div id="controller" class="state-controller controller-content">
...
var Re, $t, ct, Pt, Ii, qs, Vt, ui, cr, _n, as, ci, $s, en, lr = !1,
    ...
    lx = wo && !Qu && !Ju && "draggable" in document.createElement("div"),
    rh = function() {
        if (!!wo) {
            if (oi) return !1;
...
Qe.prototype = {
    ...
    _onDragStart: function(e, n) {
        ...
        wn("setupClone", this), Qe.eventCanceled || (Vt = ih(Re), Vt.removeAttribute("id"), Vt.draggable = !1, Vt.style["will-change"] = "", this._hideClone(), En(Vt, this.options.chosenClass, !1), Qe.clone = Vt), i.cloneId = Xs(function() {
    ...
    _onDragOver: function(e) {
        ...
        if (io = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : en === this || (this.lastPutMode = $s.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            ...
            if (!se || gx(e, ie, this) && !se.animated) {
                ...
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Da = !0, setTimeout(fx, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), Be && nh(Be, 0, K - Be.scrollTop), $t = Re.parentNode, Ee !== void 0 && !js && (Ws = Math.abs(Ee - Yt(i)[at])), ae(), q(!0)
            }
...
const Fx = Px.extend({
    sessionModulePrefix: "Acquisitions Inc",
    parseBlob(t) {
        return t.state || (t.state = "Logo", t.message = "Prepare yourself for the next question!"), t
    }
});
jx({
    MainView: Fx
});
//# sourceMappingURL=864030f3.js.map