    ...
    (function() {
        ...
        m.reduce = m.foldl = m.inject = Le(1), m.reduceRight = m.foldr = Le(-1), m.find = m.detect = function(l, g, _) {
            ...
            if (g == null && l != null) {
                ...
                te = g(Ie, De, it), (te > L || te === -1 / 0 && O === -1 / 0) && (O = Ie, L = te)
            });
            return O
        ...
        m.keys = function(l) {
            ...
            var O = {},
                ...
                V, te;
            if (L == null) return O;
            m.isFunction(g) ? (te = m.allKeys(L), V = P(g, _)) : (te = Be(arguments, !1, !1, 1), V = function(it, xt, rn) {
                return xt in rn
            }, L = Object(L));
...
function Cc() {
    return ml || (ml = 1, function(t) {
        (function(e, n) {
            ...
            var Ae = function(r) {
                var s, u, p, w, x, T, z, H, Z, le, be, ne, ce, Ge, st, je, zt, Nt, un, _t = "sizzle" + 1 * new Date,
                    tt = r.document,
                    on = 0,
                    ft = 0,
                    Dt = Ki(),
                ...
                try {
                    Cn.apply(an = ks.call(tt.childNodes), tt.childNodes), an[tt.childNodes.length].nodeType
                } catch {
                    Cn = {
                        apply: an.length ? function(F, X) {
                            vn.apply(F, ks.call(X))
                        } : function(F, X) {
                ...
                function St(R, F, X, de) {
                    var ee, me, xe, Oe, Me, ze, Ue, Xe = F && F.ownerDocument,
                        ht = F ? F.nodeType : 9;
                    ...
                    if (!de && (ne(F), F = F || ce, st)) {
                        if (ht !== 11 && (Me = Wo.exec(R)))
                            ...
                            if (Ue = R, Xe = F, ht === 1 && (Fo.test(R) || Rs.test(R))) {
                                for (Xe = Ur.test(R) && qr(F.parentNode) || F, (Xe !== F || !u.scope) && ((Oe = F.getAttribute("id")) ? Oe = Oe.replace(Gr, Is) : F.setAttribute("id", Oe = _t)), ze = T(R), me = ze.length; me--;) ze[me] = (Oe ? "#" + Oe : ":scope") + " " + Zi(ze[me]);
                                Ue = ze.join(",")
                            }
                            try {
                ...
                u = St.support = {}, x = St.isXML = function(R) {
                    ...
                    return de == ce || de.nodeType !== 9 || !de.documentElement || (ce = de, Ge = ce.documentElement, st = !x(ce), tt != ce && (X = ce.defaultView) && X.top !== X && (X.addEventListener ? X.addEventListener("unload", Ds, !1) : X.attachEvent && X.attachEvent("onunload", Ds)), u.scope = yn(function(ee) {
                    ...
                    filter: {
                            ...
                            return de === 1 && ee === 0 ? function(Me) {
                                ...
                                if (At) {
                                    ...
                                    if (Jt = [xe ? At.firstChild : At.lastChild], xe && h) {
                                        ...
                                        for (;
                                            (We = ++Ht && We && We[fn] || (b = Ht = 0) || Jt.pop()) && !((Oe ? We.nodeName.toLowerCase() === c : We.nodeType === 1) && ++b && (h && (Tt = We[_t] || (We[_t] = {}), ht = Tt[We.uniqueID] || (Tt[We.uniqueID] = {}), ht[R] = [on, b]), We === Me)););
                        ...
                        PSEUDO: function(R, F) {
                            ...
                            return de[_t] ? de(F) : de.length > 1 ? (X = [R, R, "", F], p.setFilters.hasOwnProperty(R.toLowerCase()) ? dn(function(ee, me) {
                                for (var xe, Oe = de(ee, F), Me = Oe.length; Me--;) xe = Zn(ee, Oe[Me]), ee[xe] = !(me[xe] = Oe[Me])
                            }) : function(ee) {
                                return de(ee, 0, X)
                            }) : de
                        }
                ...
                Ls.prototype = p.filters = p.pseudos, p.setFilters = new Ls, T = St.tokenize = function(R, F) {
                    ...
                    for (xe = R, Oe = [], Me = p.preFilter; xe;) {
                        ...
                        for (me in p.filter)(de = Yi[me].exec(xe)) && (!Me[me] || (de = Me[me](de))) && (X = de.shift(), ee.push({
                            value: X,
                            type: me,
                            matches: de
                        }), xe = xe.slice(X.length));
                ...
                function Wr(R, F, X, de, ee, me) {
                    return de && !de[_t] && (de = Wr(de)), ee && !ee[_t] && (ee = Wr(ee, me)), dn(function(xe, Oe, Me, ze) {
                        var Ue, Xe, ht, Tt = [],
                            We = [],
                            Ht = Oe.length,
                            Jt = xe || Jo(F || "*", Me.nodeType ? [Me] : Me, []),
                            fn = R && (xe || !F) ? nr(Jt, Tt, R, Me, ze) : Jt,
                            At = X ? ee || (xe ? R : Ht || de) ? [] : Oe : fn;
                        if (X && X(fn, At, Me, ze), de)
                            for (Ue = nr(At, We), de(Ue, [], Me, ze), Xe = Ue.length; Xe--;)(ht = Ue[Xe]) && (At[We[Xe]] = !(fn[We[Xe]] = ht));
                        if (xe) {
                            if (ee || R) {
                                if (ee) {
                        ...
                        } else At = nr(At === Oe ? At.splice(Ht, At.length) : At), ee ? ee(null, Oe, At, ze) : Cn.apply(Oe, At)
                    })
                }

                function Xr(R) {
                    for (var F, X, de, ee = R.length, me = p.relative[R[0].type], xe = me || p.relative[" "], Oe = me ? 1 : 0, Me = er(function(Xe) {
                            return Xe === F
                        ...
                        if (X = p.relative[R[Oe].type]) Ue = [er(tr(Ue), X)];
                        else {
                            if (X = p.filter[R[Oe].type].apply(null, R[Oe].matches), X[_t]) {
                                for (de = ++Oe; de < ee && !p.relative[R[de].type]; de++);
                                return Wr(Oe > 1 && tr(Ue), Oe > 1 && Zi(R.slice(0, Oe - 1).concat({
                                    value: R[Oe - 2].type === " " ? "*" : ""
                                })).replace(Si, "$1"), X, Oe < de && Xr(R.slice(Oe, de)), de < ee && Xr(R = R.slice(de)), de < ee && Zi(R))
                            }
                            Ue.push(X)
                        } return tr(Ue)
                }
                    ...
                    var X = F.length > 0,
                        ...
                        ee = function(me, xe, Oe, Me, ze) {
                            ...
                            if (Tt += We, X && We !== Tt) {
                                ...
                                if (me) {
                                    if (Tt > 0)
                                        for (; We--;) Ht[We] || Jt[We] || (Jt[We] = Mn.call(Me));
                                    Jt = nr(Jt)
                                }
                ...
                return z = St.compile = function(R, F) {
                    ...
                    if (X = X || [], Ue.length === 1) {
                        if (me = Ue[0] = Ue[0].slice(0), me.length > 2 && (xe = me[0]).type === "ID" && F.nodeType === 9 && st && p.relative[me[1].type]) {
                        ...
                        for (ee = Yi.needsContext.test(R) ? 0 : me.length; ee-- && (xe = me[ee], !p.relative[Oe = xe.type]);)
                            if ((Me = p.find[Oe]) && (de = Me(xe.matches[0].replace(Tn, xn), Ur.test(me[0].type) && qr(F.parentNode) || F))) {
                                if (me.splice(ee, 1), R = de.length && Zi(me), !R) return Cn.apply(X, de), X;
                                break
                            }
                    }
                    return (ze || z(R, Ue))(de, F, !st, X, !F || Ur.test(R) && qr(F.parentNode) || F), X
                                        ...
                                        var Ge = this,
                                            ...
                                            je = function() {
                                                ...
                                                if (!(le < H)) {
                                                    ...
                                                    un = Nt && (typeof Nt == "object" || typeof Nt == "function") && Nt.then, re(un) ? ce ? un.call(Nt, Z(H, be, Ke, ce), Z(H, be, dt, ce)) : (H++, un.call(Nt, Z(H, be, Ke, ce), Z(H, be, dt, ce), Z(H, be, Ke, be.notifyWith))) : (ne !== Ke && (Ge = void 0, st = [Nt]), (ce || be.resolveWith)(Ge, st))
                                                }
                                            },
                                            zt = ce ? je : function() {
                                                try {
                                                    ...
                                                    d.Deferred.exceptionHook && d.Deferred.exceptionHook(Nt, zt.stackTrace), le + 1 >= H && (ne !== dt && (Ge = void 0, st = [Nt]), be.rejectWith(Ge, st))
                                                }
                                            };
            ...
            d.event = {
                ...
                add: function(r, s, u, p, w) {
                    var x, T, z, H, Z, le, be, ne, ce, Ge, st, je = he.get(r);
                    if (!!te(r))
                        for (u.handler && (x = u, u = x.handler, w = x.selector), w && d.find.matchesSelector(Kt, w), u.guid || (u.guid = d.guid++), (H = je.events) || (H = je.events = Object.create(null)), (T = je.handle) || (T = je.handle = function(zt) {
                            ...
                            }), s = (s || "").match(ke) || [""], Z = s.length; Z--;) z = Nn.exec(s[Z]) || [], ce = st = z[1], Ge = (z[2] || "").split(".").sort(), ce && (be = d.event.special[ce] || {}, ce = (w ? be.delegateType : be.bindType) || ce, be = d.event.special[ce] || {}, le = d.extend({
                            type: ce,
                            origType: st,
                            data: p,
                            handler: u,
                ...
                remove: function(r, s, u, p, w) {
                    var x, T, z, H, Z, le, be, ne, ce, Ge, st, je = he.hasData(r) && he.get(r);
                    if (!(!je || !(H = je.events))) {
                        for (s = (s || "").match(ke) || [""], Z = s.length; Z--;) {
                            if (z = Nn.exec(s[Z]) || [], ce = st = z[1], Ge = (z[2] || "").split(".").sort(), !ce) {
                                for (ce in H) d.event.remove(r, ce + s[Z], u, p, !0);
                                continue
                            }
                            for (be = d.event.special[ce] || {}, ce = (p ? be.delegateType : be.bindType) || ce, ne = H[ce] || [], z = z[2] && new RegExp("(^|\\.)" + Ge.join("\\.(?:.*\\.|)") + "(\\.|$)"), T = x = ne.length; x--;) le = ne[x], (w || st === le.origType) && (!u || u.guid === le.guid) && (!z || z.test(le.namespace)) && (!p || p === le.selector || p === "**" && le.selector) && (ne.splice(x, 1), le.selector && ne.delegateCount--, be.remove && be.remove.call(r, le));
            ...
            function mn(r, s, u, p) {
                ...
                var w, x, T, z, H, Z, le = 0,
                    ...
                    ce = s[0],
                    Ge = re(ce);
                if (Ge || be > 1 && typeof ce == "string" && !Y.checkClone && Ar.test(ce)) return r.each(function(st) {
                    var je = r.eq(st);
            ...
            d.extend({
                ...
                css: function(r, s, u, p) {
                    var w, x, T, z = V(s),
                        H = It.test(s);
                    return H || (s = Ce(z)), T = d.cssHooks[s] || d.cssHooks[z], T && "get" in T && (w = T.get(r, !0, u)), w === void 0 && (w = et(r, s, p)), w === "normal" && s in Gn && (w = Gn[s]), u === "" || u ? (x = parseFloat(w), u === !0 || isFinite(x) ? x || 0 : w) : w
                }
            }), d.each(["height", "width"], function(r, s) {
                d.cssHooks[s] = {
                    get: function(u, p, w) {
                        if (p) return qe.test(d.css(u, "display")) && (!u.getClientRects().length || !u.getBoundingClientRect().width) ? Ui(u, Wt, function() {
                            return Or(u, s, w)
                        }) : Or(u, s, w)
                    },
                    set: function(u, p, w) {
            ...
            function _o(r, s, u) {
                ...
                for (p in s)
                    ...
                    for (p in ce) H || (je ? "hidden" in je && (st = je.hidden) : je = he.access(r, "fxshow", {
                        display: Z
                    }), x && (je.hidden = !st), st && G([r], !0), ne.done(function() {
                        st || G([r]), he.remove(r, "fxshow");
                        for (p in ce) d.style(r, p, ce[p])
                    })), H = vs(st ? je[p] : 0, p, ne), p in je || (je[p] = H.start, st && (H.end = H.start, H.start = 0))
                }
            }
            ...
            function bn(r, s, u) {
                var p, w, x = 0,
                    ...
                    H = function() {
                        if (w) return !1;
                        for (var be = Ft || Ir(), ne = Math.max(0, Z.startTime + Z.duration - be), ce = ne / Z.duration || 0, Ge = 1 - ce, st = 0, je = Z.tweens.length; st < je; st++) Z.tweens[st].run(Ge);
                ...
                return d.map(le, vs, Z), re(Z.opts.start) && Z.opts.start.call(r, Z), Z.progress(Z.opts.progress).done(Z.opts.done, Z.opts.complete).fail(Z.opts.fail).always(Z.opts.always), d.fx.timer(d.extend(H, {
                    elem: r,
                    anim: Z,
                    queue: Z.opts.queue
                })), Z
            ...
            d.fn.extend({
                ...
                toggleClass: function(r, s) {
                    ...
                    return typeof s == "boolean" && p ? s ? this.addClass(r) : this.removeClass(r) : re(r) ? this.each(function(w) {
                        ...
                        var w, x, T, z;
                        if (p)
                            for (x = 0, T = d(this), z = Mr(r); w = z[x++];) T.hasClass(w) ? T.removeClass(w) : T.addClass(w);
...
`) : r)), s
            ...
            function Nr(r, s, u, p) {
                ...
                if (Array.isArray(s)) d.each(s, function(x, T) {
                    u || Ao.test(r) ? p(r, T) : Nr(r + "[" + (typeof T == "object" && T != null ? x : "") + "]", T, u, p)
                });
...
`)
            ...
            d.extend({
                ...
                ajax: function(r, s) {
                    ...
                    if (st.promise(tt), ne.url = ((r || ne.url || xi.href) + "").replace(Po, xi.protocol + "//"), ne.type = s.method || s.type || ne.method || ne.type, ne.dataTypes = (ne.dataType || "*").toLowerCase().match(ke) || [""], ne.crossDomain == null) {
                        z = P.createElement("a");
                        try {
                    ...
                    if (ne.data && ne.processData && typeof ne.data != "string" && (ne.data = d.param(ne.data, ne.traditional)), _s(Cs, ne, s, tt), H) return tt;
                    Z = d.event && ne.global, Z && d.active++ === 0 && d.event.trigger("ajaxStart"), ne.type = ne.type.toUpperCase(), ne.hasContent = !Lo.test(ne.type), p = ne.url.replace(Do, ""), ne.hasContent ? ne.data && ne.processData && (ne.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (ne.data = ne.data.replace(Io, "+")) : (be = ne.url.slice(p.length), ne.data && (ne.processData || typeof ne.data == "string") && (p += (Wi.test(p) ? "&" : "?") + ne.data, delete ne.data), ne.cache === !1 && (p = p.replace(Mo, "$1"), be = (Wi.test(p) ? "&" : "?") + "_=" + Pr.guid++ + be), ne.url = p + be), ne.ifModified && (d.lastModified[p] && tt.setRequestHeader("If-Modified-Since", d.lastModified[p]), d.etag[p] && tt.setRequestHeader("If-None-Match", d.etag[p])), (ne.data && ne.hasContent && ne.contentType !== !1 || s.contentType) && tt.setRequestHeader("Content-Type", ne.contentType), tt.setRequestHeader("Accept", ne.dataTypes[0] && ne.accepts[ne.dataTypes[0]] ? ne.accepts[ne.dataTypes[0]] + (ne.dataTypes[0] !== "*" ? ", " + xs + "; q=0.01" : "") : ne.accepts["*"]);
                    ...
                    if (_t = "abort", je.add(ne.complete), tt.done(ne.success), tt.fail(ne.error), u = _s(Vr, ne, s, tt), !u) on(-1, "No Transport");
                    else {
                    ...
                    function on(ft, Dt, _i, Xi) {
                        ...
                        H || (H = !0, T && e.clearTimeout(T), u = void 0, w = Xi || "", tt.readyState = ft > 0 ? 4 : 0, hn = ft >= 200 && ft < 300 || ft === 304, _i && (an = No(ne, tt, _i)), !hn && d.inArray("script", ne.dataTypes) > -1 && d.inArray("json", ne.dataTypes) < 0 && (ne.converters["text script"] = function() {}), an = Vo(ne, an, tt, hn), hn ? (ne.ifModified && (Mn = tt.getResponseHeader("Last-Modified"), Mn && (d.lastModified[p] = Mn), Mn = tt.getResponseHeader("etag"), Mn && (d.etag[p] = Mn)), ft === 204 || ne.type === "HEAD" ? vn = "nocontent" : ft === 304 ? vn = "notmodified" : (vn = an.state, Jn = an.data, Qn = an.error, hn = !Qn)) : (Qn = vn, (ft || !vn) && (vn = "error", ft < 0 && (ft = 0))), tt.status = ft, tt.statusText = (Dt || vn) + "", hn ? st.resolveWith(ce, [Jn, vn, tt]) : st.rejectWith(ce, [tt, vn, Qn]), tt.statusCode(zt), zt = void 0, Z && Ge.trigger(hn ? "ajaxSuccess" : "ajaxError", [tt, ne, hn ? Jn : Qn]), je.fireWith(ce, [tt, vn]), Z && (Ge.trigger("ajaxComplete", [tt, ne]), --d.active || d.event.trigger("ajaxStop")))
                    }
                    return tt
                },
            ...
            set: function(E, l) {
                if (E != null) {
                    ...
                    if (O.length && Lt ? (Je = this.length !== O.length || i.some(this.models, function(j, N) {
                            return j !== O[N]
                        }), this.models.length = 0, Le(this.models, O, 0), this.length = this.models.length) : L.length && (xt && (it = !0), Le(this.models, L, _ == null ? this.length : _), this.length = this.models.length), it && this.sort({
                            silent: !0
                        }), !l.silent) {
...
(function(t, e) {
    (function(n, i) {
        ...
        var ji = ["childViewContainer", "template", "templateContext"],
            ...
            yi = i.pick(Nn.prototype, "serializeModel", "getTemplate", "_renderTemplate", "_renderHtml", "mixinTemplateContext", "attachElContent");
        ...
        i.extend(zi.prototype, Se, ct, Je);
        ...
        }, et.bindEvents = v(_e), et.unbindEvents = v(ke), et.bindRequests = v(Ke), et.unbindRequests = v(dt), et.mergeOptions = v(D), et.getOption = v($), et.normalizeMethods = v(J), et.extend = S, et.isNodeAttached = I, et.deprecate = k, et.triggerMethod = v(m), et.triggerMethodOn = P, et.isEnabled = it, et.setEnabled = xt, et.monitorViewEvents = oe, et.Behaviors = {}, et.Behaviors.behaviorsLookup = Ui, et.Application = Hi, et.AppRouter = Un, et.Renderer = Ye, et.TemplateCache = _, et.View = Nn, et.CollectionView = kn, et.NextCollectionView = mi, et.CompositeView = vi, et.Behavior = zi, et.Region = pe, et.Error = we, et.Object = g, et.DEV_MODE = !1, et.FEATURES = De, et.VERSION = f, et.DomApi = N, et.setDomApi = function(y) {
            kn.setDomApi(y), vi.setDomApi(y), mi.setDomApi(y), pe.setDomApi(y), Nn.setDomApi(y)
        }, et
...
var Zh = Qh,
    ed = typeof vt == "object" && vt && vt.Object === Object && vt,
    Ec = ed,
    td = Ec,
    ...
    yl = _c,
    Sc = Object.prototype,
    od = Sc.hasOwnProperty,
    ad = Sc.toString,
    Yr = yl ? yl.toStringTag : void 0;
...
function yd(t) {
    return t == null ? t === void 0 ? vd : md : bl && bl in Object(t) ? pd(t) : gd(t)
}
var fo = yd;
...
var Pd = Ld,
    ...
    qd = RegExp("^" + Ud.call(Gd).replace(jd, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
...
Er.prototype.clear = Jf;
Er.prototype.delete = Qf;
Er.prototype.get = Zf;
Er.prototype.has = ep;
Er.prototype.set = tp;
var np = Er,
...
_r.prototype.clear = up;
_r.prototype.delete = hp;
_r.prototype.get = dp;
_r.prototype.has = fp;
_r.prototype.set = pp;
var gp = _r,
...
function Gp(t) {
    var e = t && t.constructor,
        n = typeof e == "function" && e.prototype || Up;
    return t === n
}
var Rc = Gp,
    qp = $p,
...
var ng = tg,
    ...
    ig = ds,
    Ic = Object.prototype,
    rg = Ic.hasOwnProperty,
    sg = Ic.propertyIsEnumerable,
    og = Tl(function() {
        return arguments
    }()) ? Tl : function(t) {
...
function Tg(t) {
    ...
    return typeof n == "function" && n instanceof n && Pc.call(n) == kg
}
var Ag = Tg,
    Og = fo,
    Rg = Lc,
    ...
    Mt = {};
Mt[Wg] = Mt[Xg] = Mt[Yg] = Mt[Kg] = Mt[Jg] = Mt[Qg] = Mt[Zg] = Mt[em] = Mt[tm] = !0;
Mt[Dg] = Mt[Mg] = Mt[Gg] = Mt[Lg] = Mt[qg] = Mt[Pg] = Mt[Ng] = Mt[Vg] = Mt[Bg] = Mt[$g] = Mt[jg] = Mt[Fg] = Mt[zg] = Mt[Hg] = Mt[Ug] = !1;

function nm(t) {
    return Ig(t) && Rg(t.length) && !!Mt[Og(t)]
}
var im = nm;
...
function Mm(t, e) {
    var n = Tm(t),
        ...
        k = S.length;
    for (var I in t)(e || Dm.call(t, I)) && !(v && (I == "length" || a && (I == "offset" || I == "parent") || f && (I == "buffer" || I == "byteLength" || I == "byteOffset") || Om(I, k))) && S.push(I);
    return S
}
var Lm = Mm;
...
function cv(t, e, n, i, a, f, v) {
    ...
    if ($) {
        var J = Dl(k),
            ie = !J && iv(k),
            Y = !J && !ie && av(k);
        D = k, J || ie || Y ? Dl(S) ? D = S : nv(S) ? D = ev(S) : ie ? ($ = !1, D = Qm(k, !0)) : Y ? ($ = !1, D = Zm(k, !0)) : D = [] : ov(k) || Il(k) ? (D = S, Il(S) ? D = lv(S) : (!sv(S) || rv(S)) && (D = tv(k))) : $ = !1
    }
    $ && (v.set(k, D), a(D, k, i, f, v), v.delete(k)), Rl(t, n, D)
}
var uv = cv,
    hv = gp,
    dv = Ac,
...
function jc(t, e, n, i, a) {
    t !== e && fv(e, function(f, v) {
        if (a || (a = new hv), gv(f)) pv(t, e, v, n, jc, i, a);
        else {
            var S = i ? i(vv(t, v), f, v + "", t, e, a) : void 0;
            S === void 0 && (S = f), dv(t, v, S)
        }
    }, mv)
}
var yv = jc;
...
function Zv(t) {
    return Jv(function(e, n) {
        var i = -1,
            ...
            f = a > 1 ? n[a - 1] : void 0,
            v = a > 2 ? n[2] : void 0;
        for (f = t.length > 3 && typeof f == "function" ? (a--, f) : void 0, v && Qv(n[0], n[1], v) && (f = a < 3 ? void 0 : f, a = 1), e = Object(e); ++i < a;) {
            var S = n[i];
            S && t(e, S, i, f)
        }
        return e
...
let en = gl;
ot(en, "queryParams", new URLSearchParams(window.location.search)), ot(en, "getQueryParam", e => gl.queryParams.get(e)), ot(en, "sleep", e => new Promise(n => {
...
var sy = function() {
    ...
    oy = sy,
    ay = function() {
        return typeof Nl != "function" || typeof Symbol != "function" || typeof Nl("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : oy()
    },
...
var ra = function() {
    ...
    ar = {},
    my = typeof Uint8Array > "u" ? mt : ai(Uint8Array),
    dr = {
    ...
    fs = Ha,
    Zs = py,
    yy = fs.call(Function.call, Array.prototype.concat),
    wy = fs.call(Function.apply, Array.prototype.splice),
    Bl = fs.call(Function.call, String.prototype.replace),
    eo = fs.call(Function.call, String.prototype.slice),
    by = fs.call(Function.call, RegExp.prototype.exec),
    Cy = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
    xy = /\\(\\)?/g,
    Ey = function(e) {
        var n = eo(e, 0, 1),
        ...
        var a = [];
        return Bl(e, Cy, function(f, v, S, k) {
            a[a.length] = S ? Bl(k, xy, "$1") : v || f
        }), a
    },
    _y = function(e, n) {
        var i = e,
            a;
        if (Zs(Vl, i) && (a = Vl[i], i = "%" + a[0] + "%"), Zs(dr, i)) {
            var f = dr[i];
            if (f === ar && (f = vy(i)), typeof f > "u" && !n) throw new hr("intrinsic " + e + " exists, but is not available. Please file an issue!");
            return {
                alias: a,
                name: i,
                value: f
    ...
    Ua = function(e, n) {
        ...
        if (by(/^%?[^%]*%?$/g, e) === null) throw new mr("`%` may not be present anywhere but at the beginning and end of the intrinsic name");
        var i = Ey(e),
            a = i.length > 0 ? i[0] : "",
            f = _y("%" + a + "%", n),
            v = f.name,
        ...
        for (var D = 1, $ = !0; D < i.length; D += 1) {
            ...
            if ((J === "constructor" || !$) && (k = !0), a += "." + J, v = "%" + a + "%", Zs(dr, v)) S = dr[v];
            else if (S != null) {
                if (!(J in S)) {
...
var Uc = Ua,
    Gc = Hc.exports,
    Sy = Gc(Uc("String.prototype.indexOf")),
    ky = function(e, n) {
        var i = Uc(e, !!n);
        return typeof i == "function" && Sy(e, ".prototype.") > -1 ? Gc(i) : i
    };
const Ty = {},
...
var Ga = typeof Map == "function" && Map.prototype,
    ...
    no = qa && oa && typeof oa.get == "function" ? oa.get : null,
    Iy = qa && Set.prototype.forEach,
    Dy = typeof WeakMap == "function" && WeakMap.prototype,
    ns = Dy ? WeakMap.prototype.has : null,
    My = typeof WeakSet == "function" && WeakSet.prototype,
    is = My ? WeakSet.prototype.has : null,
    Ly = typeof WeakRef == "function" && WeakRef.prototype,
    $l = Ly ? WeakRef.prototype.deref : null,
...
var Oa = Oy,
    ...
    Fy = function t(e, n, i, a) {
        ...
        if (typeof e == "string") return Jc(e, f);
        if (typeof e == "number") {
        ...
        var $ = sw(f, i);
        if (typeof a > "u") a = [];
        else if (Kc(a, e) >= 0) return "[Circular]";

        function J(Fe, U, oe) {
            if (U && (a = jy.call(a), a.push(U)), oe) {
                var Te = {
                    depth: f.depth
                };
        ...
        if (typeof e == "function" && !Wl(e)) {
            var ie = Ky(e),
                Y = Ns(e, J);
            return "[Function" + (ie ? ": " + ie : " (anonymous)") + "]" + (Y.length > 0 ? " { " + Fn.call(Y, ", ") + " }" : "")
        }
        if (Yc(e)) {
            var re = vr ? hi.call(String(e), /^(Symbol\(.*\))_[^)]*$/, "$1") : Aa.call(e);
            return typeof e == "object" && !vr ? Kr(re) : re
        }
        if (nw(e)) {
            for (var m = "<" + jl.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + Xc(zy(P[q].value), "double", f);
            return m += ">", e.childNodes && e.childNodes.length && (m += "..."), m += "</" + jl.call(String(e.nodeName)) + ">", m
        }
        if (Ra(e)) {
            if (e.length === 0) return "[]";
            var ae = Ns(e, J);
            return $ && !rw(ae) ? "[" + Ia(ae, $) + "]" : "[ " + Fn.call(ae, ", ") + " ]"
        }
        if (Uy(e)) {
            var se = Ns(e, J);
            return !("cause" in Error.prototype) && "cause" in e && !Wc.call(e, "cause") ? "{ [" + String(e) + "] " + Fn.call(Fl.call("[cause]: " + J(e.cause), se), ", ") + " }" : se.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + Fn.call(se, ", ") + " }"
        }
        if (typeof e == "object" && v) {
            if (ql && typeof e[ql] == "function" && Oa) return Oa(e, {
                depth: D - i
            });
        ...
        if (Jy(e)) {
            var ve = [];
            return Ry.call(e, function(Fe, U) {
        ...
        if (Qy(e)) return la("WeakMap");
        if (tw(e)) return la("WeakSet");
        if (Zy(e)) return la("WeakRef");
        if (qy(e)) return Kr(J(Number(e)));
        if (Xy(e)) return Kr(J(Ta.call(e)));
        if (Wy(e)) return Kr(Py.call(e));
        if (Gy(e)) return Kr(J(String(e)));
        if (!Hy(e) && !Wl(e)) {
            var Ee = Ns(e, J),
                Ae = Hl ? Hl(e) === Object.prototype : e instanceof Object || e.constructor === Object,
                Le = e instanceof Object ? "" : "null prototype",
                lt = !Ae && cn && Object(e) === e && cn in e ? Wa.call(pi(e), 8, -1) : Le ? "Object" : "",
                Be = Ae || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "",
                K = Be + (lt || Le ? "[" + Fn.call(Fl.call([], lt || [], Le || []), ": ") + "] " : "");
            return Ee.length === 0 ? K + "{}" : $ ? K + "{" + Ia(Ee, $) + "}" : K + "{ " + Fn.call(Ee, ", ") + " }"
        }
        return String(e)
    };
...
function Jc(t, e) {
    if (t.length > e.maxStringLength) {
        ...
        return Jc(Wa.call(t, 0, e.maxStringLength), e) + i
    }
    var a = hi.call(hi.call(t, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, iw);
    return Xc(a, "single", e)
}
...
function Ns(t, e) {
    ...
    for (var k in t) !li(t, k) || n && String(Number(k)) === k && k < t.length || vr && v["$" + k] instanceof Symbol || (qc.call(/[^\w$]/, k) ? i.push(e(k, t) + ": " + e(t[k], t)) : i.push(k + ": " + e(t[k], t)));
    if (typeof aa == "function")
        for (var I = 0; I < f.length; I++) Wc.call(t, f[I]) && i.push("[" + e(f[I]) + "]: " + e(t[f[I]], t));
    return i
}
var Xa = Ua,
    Sr = ky,
    ...
    Vs = Xa("%WeakMap%", !0),
    Bs = Xa("%Map%", !0),
    lw = Sr("WeakMap.prototype.get", !0),
    cw = Sr("WeakMap.prototype.set", !0),
    uw = Sr("WeakMap.prototype.has", !0),
    hw = Sr("Map.prototype.get", !0),
    dw = Sr("Map.prototype.set", !0),
    fw = Sr("Map.prototype.has", !0),
    Ya = function(t, e) {
        for (var n = t, i;
            (i = n.next) !== null; n = i)
    ...
    vw = function() {
        var e, n, i, a = {
            assert: function(f) {
                if (!a.has(f)) throw new aw("Side channel does not contain " + ow(f))
            },
            get: function(f) {
            ...
            set: function(f, v) {
                Vs && f && (typeof f == "object" || typeof f == "function") ? (e || (e = new Vs), cw(e, f, v)) : Bs ? (n || (n = new Bs), dw(n, f, v)) : (i || (i = {
                    key: {},
                    next: null
                }), gw(i, f, v))
            }
    ...
    xw = function t(e, n, i) {
        ...
        var a = e;
        return Di(e) && !Di(n) && (a = Qc(e, i)), Di(e) && Di(n) ? (n.forEach(function(f, v) {
            if (ua.call(e, v)) {
                var S = e[v];
    ...
    Sw = function(e, n, i, a, f) {
        ...
        for (var S = "", k = 0; k < v.length; ++k) {
            ...
            if (I === 45 || I === 46 || I === 95 || I === 126 || I >= 48 && I <= 57 || I >= 65 && I <= 90 || I >= 97 && I <= 122 || f === bw.RFC1738 && (I === 40 || I === 41)) {
                S += v.charAt(k);
                continue
            }
            if (I < 128) {
    ...
    ha = {},
    Nw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        ...
        if (typeof k == "function" ? P = k(n, P) : P instanceof Date ? P = $(P) : i === "comma" && ti(P) && (P = Da.maybeMap(P, function(ue) {
                return ue instanceof Date ? $(ue) : ue
            })), P === null) {
            if (f) return S && !Y ? S(n, nn.encoder, re, "key", J) : n;
            P = ""
        }
        if (Pw(P) || Da.isBuffer(P)) {
            if (S) {
                var d = Y ? n : S(n, nn.encoder, re, "key", J);
                if (i === "comma" && Y) {
                    for (var Ee = Dw.call(String(P), ","), Ae = "", Le = 0; Le < Ee.length; ++Le) Ae += (Le === 0 ? "" : ",") + ie(S(Ee[Le], nn.encoder, re, "value", J));
        ...
        for (var Fe = a && ti(P) && P.length === 1 ? n + "[]" : n, U = 0; U < Be.length; ++U) {
            ...
            if (!(v && Te === null)) {
                ...
                m.set(e, ae);
                var ye = eu();
                ye.set(ha, m), tu(lt, t(Te, we, i, a, f, v, S, k, I, D, $, J, ie, Y, re, ye))
            }
        }
        return lt
    },
    Vw = function(e) {
        ...
        if (typeof e.format < "u") {
            if (!Iw.call(rs.formatters, e.format)) throw new TypeError("Unknown format option provided.");
            i = e.format
        }
    ...
    Bw = function(t, e) {
        ...
        for (var D = eu(), $ = 0; $ < a.length; ++$) {
            var J = a[$];
            i.skipNulls && n[J] === null || tu(v, Nw(n[J], J, k, I, i.strictNullHandling, i.skipNulls, i.encode ? i.encoder : null, i.filter, i.sort, i.allowDots, i.serializeDate, i.format, i.formatter, i.encodeValuesOnly, i.charset, D))
        }
        ...
        for (k = 0; k < v.length; ++k)
            if (k !== S) {
                var D = v[k],
                    ...
                    J = $ === -1 ? D.indexOf("=") : $ + 1,
                    ie, Y;
                J === -1 ? (ie = n.decoder(D, Qt.decoder, I, "key"), Y = n.strictNullHandling ? null : "") : (ie = n.decoder(D.slice(0, J), Qt.decoder, I, "key"), Y = yr.maybeMap(nu(D.slice(J + 1), n), function(re) {
                    return n.decoder(re, Qt.decoder, I, "value")
                })), Y && n.interpretNumericEntities && I === "iso-8859-1" && (Y = jw(Y)), D.indexOf("[]=") > -1 && (Y = $w(Y) ? [Y] : Y), Ma.call(i, ie) ? i[ie] = yr.combine(i[ie], Y) : i[ie] = Y
            } return i
    },
    Uw = function(t, e, n, i) {
        for (var a = i ? e : nu(e, n), f = t.length - 1; f >= 0; --f) {
            var v, S = t[f];
    ...
    Gw = function(e, n, i, a) {
        if (!!e) {
            ...
            return k && D.push("[" + f.slice(k.index) + "]"), Uw(D, n, i, a)
        }
    },
    qw = function(e) {
        if (!e) return Qt;
    ...
    Ww = function(t, e) {
        ...
        for (var i = typeof t == "string" ? Hw(t, n) : t, a = n.plainObjects ? Object.create(null) : {}, f = Object.keys(i), v = 0; v < f.length; ++v) {
            var S = f[v],
...
var ab = lr,
    ...
    Ql = fr && typeof fr.apply == "function" ? fr.apply : function(e, n, i) {
        return Function.prototype.apply.call(e, n, i)
    },
    Gs;
fr && typeof fr.ownKeys == "function" ? Gs = fr.ownKeys : Object.getOwnPropertySymbols ? Gs = function(e) {
...
var ru = Number.isNaN || function(e) {
    return e !== e
};
...
Object.defineProperty(Rt, "defaultMaxListeners", {
    ...
    set: function(t) {
        if (typeof t != "number" || t < 0 || ru(t)) throw new RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' + t + ".");
        Zl = t
    }
});
Rt.init = function() {
...
Rt.prototype.setMaxListeners = function(e) {
    if (typeof e != "number" || e < 0 || ru(e)) throw new RangeError('The value of "n" is out of range. It must be a non-negative number. Received ' + e + ".");
...
Rt.prototype.emit = function(e) {
    ...
    if (typeof k == "function") Ql(k, this, n);
    else
        for (var I = k.length, D = uu(k, I), i = 0; i < I; ++i) Ql(D[i], this, n);
    return !0
};
...
function ou(t, e, n, i) {
    ...
    else if (typeof v == "function" ? v = f[e] = i ? [n, v] : [v, n] : i ? v.unshift(n) : v.push(n), a = su(t), a > 0 && v.length > a && !v.warned) {
        v.warned = !0;
...
Rt.prototype.once = function(e, n) {
    return vo(n), this.on(e, au(this, e, n)), this
};
Rt.prototype.prependOnceListener = function(e, n) {
    return vo(n), this.prependListener(e, au(this, e, n)), this
};
...
function lu(t, e, n) {
    ...
    if (i === void 0) return [];
    var a = i[e];
    return a === void 0 ? [] : typeof a == "function" ? n ? [a.listener || a] : [a] : n ? hb(a) : uu(a, a.length)
}
...
Rt.listenerCount = function(t, e) {
    return typeof t.listenerCount == "function" ? t.listenerCount(e) : cu.call(t, e)
};
Rt.prototype.listenerCount = cu;
...
function fb(t, e, n) {
    typeof t.on == "function" && hu(t, "error", e, n)
}
...
var ni = {
    ...
    EcastDialRoomFailed: fu,
    EcastServerIsShuttingDown: pu,
    EcastClientError: kt,
    EcastParseError: gu,
    EcastRequestIsMissingOpcode: mu,
    EcastRequestHasInvalidOpcode: vu,
    EcastRequestHasInvalidArguments: yu,
    EcastEntityNotFound: wu,
    EcastEntityAlreadyExists: bu,
    EcastEntityTypeError: Cu,
    EcastNoSuchClient: xu,
    EcastRoomIsLocked: Eu,
    EcastRoomIsFull: _u,
    EcastLicenseNotFound: Su,
    EcastLicenseCheckFailed: ku,
    EcastRoomNotFound: Tu,
    EcastInvalidRole: Au,
    EcastTwitchLoginRequired: Ou,
    EcastInvalidOption: Ru,
    EcastPasswordRequired: Iu,
    EcastInvalidPassword: Du,
    EcastNameRequired: Mu,
    EcastFilterError: Lu,
    EcastNoSuchFilter: Pu,
    EcastPermissionDenied: Nu,
    EcastNotConnected: Vu,
    EcastIllegalOperation: Bu,
    EcastACLChangeDenied: $u,
    ...
    (function(n, i) {
        ...
        function Le(j, N, W) {
            ...
            var M, G, fe, pe, Pe, Ve, pt = ae.slice(),
                ...
                Ye = this,
                In = 0;
            for (jt !== "object" && jt !== "string" && (W = N, N = null), W && typeof W != "function" && (W = ie.parse), N = ve(N), G = Ee(j || "", N), M = !G.protocol && !G.slashes, Ye.slashes = G.slashes || M && N.slashes, Ye.protocol = G.protocol || N.protocol || "", j = G.rest, (Ye.protocol === "file:" || !G.slashes && (G.protocol || G.slashesCount < 2 || !d(Ye.protocol))) && (pt[3] = [/(.*)/, "pathname"]); In < pt.length; In++) {
        ...
        function xt() {
            return typeof window < "u" ? window : typeof process == "object" && typeof oC == "function" && typeof vt == "object" ? vt : this
        }
        var rn = {
                mock: !0,
                verifyClient: null,
            ...
            ct = function(j) {
                ...
                return j && (N.__proto__ = j), N.prototype = Object.create(j && j.prototype), N.prototype.constructor = N, N.prototype.mockWebsocket = function() {
                    ...
                    fe === void 0 && (fe = []);
                    var Pe = this,
                        Ve = it(fe.concat(_e.websocketsLookup(this.url, M, G)));
                    return {
                        to: function(pt, jt) {
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/standalone-drawful2-international/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
...
var Ti, $s, ss = typeof Map == "function" ? new Map : (Ti = [], $s = [], {
        has: function(t) {
            return Ti.indexOf(t) > -1
        },
        get: function(t) {
            return $s[Ti.indexOf(t)]
        },
        set: function(t, e) {
            Ti.indexOf(t) === -1 && (Ti.push(t), $s.push(e))
        },
        delete: function(t) {
            var e = Ti.indexOf(t);
            e > -1 && (Ti.splice(e, 1), $s.splice(e, 1))
        }
    }),
    Ju = function(t) {
        return new Event(t, {
...
const fC = `<form>\r
    ...
    io = bt.View.extend({
        ...
        onAttach() {
            this.getOption("preventAutosize") || ac(Ne("textarea"))
        },
        onSubmitClick() {
        ...
        clearInput() {
            ...
            Ne(t).val(""), this.getOption("preventAutosize") || ac.update(t), this.onInputChange()
        },
        setValue(t) {
    ...
    fi = bt.CollectionView.extend({
        tagName: "div",
        className: "choices",
        childView(t) {
            return t.get("type") === "input" ? io : t.get("type") === "text" ? $i : Ku
        },
...
function gC(t) {
    ...
    return qs = Qr.getContext("2d"), qs.imageSmoothingEnabled = !1, Qu("init"), {
        canvas: Qr,
        context: qs
    }
}
...
function yC({
    ...
    function Y() {
        if (I = requestAnimationFrame(Y), D = ie.now(), $ = D - k, k = D, !($ > 1e3)) {
            for (Qu("tick"), a += $; a >= f;) J.update(v), a -= f;
            S(), J.render()
        }
    }
    return J = {
...
`).replace(/(^|\n)\s*/g, ""),
            ...
            Tr = () => {
                const c = we(),
                    ...
                    Bn = j(c, K.textarea);
                h.oninput = sn, b.onchange = sn, He.onchange = sn, Ut.onchange = sn, Bn.oninput = sn, B.oninput = () => {
                    sn(), ge.value = B.value
                }, B.onchange = () => {
                    sn(), ge.value = B.value
                }
            ...
            vi = c => {
                ...
                b.className = K.container, h && Je(b, K["no-transition"]), it(b, kr);
                const B = Ar(c.target);
                B.appendChild(b), mi(c), ji(B), Tr()
            },
            yi = (c, h) => {
                c instanceof HTMLElement ? h.appendChild(c) : typeof c == "object" ? Fi(c, h) : c && it(h, c)
            },
            Fi = (c, h) => {
                c.jquery ? zi(h, c) : it(h, c.toString())
            },
            zi = (c, h) => {
        ...
        function Un(c, h, b) {
            const B = dt(),
                ge = Bt(),
                He = l();
            bi(B, "confirm", b), bi(ge, "deny", b), bi(He, "cancel", b), Ui(B, ge, He, b), b.reverseButtons && (b.toast ? (c.insertBefore(He, B), c.insertBefore(ge, B)) : (c.insertBefore(He, h), c.insertBefore(ge, h), c.insertBefore(B, h)))
        }
        ...
        const Gi = (c, h) => {
            ...
            Rr = (c, h) => {
                ...
                W(B), ys(B, h), Ir(B, h), Je(B, h.showClass.icon)
            },
            Ir = (c, h) => {
                for (const b in Fe) h.icon !== b && Lt(c, Fe[b]);
                Je(c, Fe[h.icon]), bn(c, h), qi(), ct(c, h, "icon")
            },
            qi = () => {
                const c = we(),
...
`,
            ys = (c, h) => {
                let b = c.innerHTML,
                    B;
                h.iconHtml ? B = Dr(h.iconHtml) : h.icon === "success" ? (B = vs, b = b.replace(/ style=".*?"/g, "")) : h.icon === "error" ? B = _o : B = Dr({
                    question: "?",
                    warning: "!",
                    info: "i"
            ...
            Lr = (c, h) => {
                Mr(c, h), et(c, h), So(c, h), Rr(c, h), Ci(c, h), Xn(c, h), Eo(c, h), Gi(c, h), wi(c, h), xo(c, h), typeof h.didRender == "function" && h.didRender(we())
            },
            Yn = Object.freeze({
                cancel: "cancel",
                backdrop: "backdrop",
            ...
            Ao = c => {
                ...
                if (!h) return {};
                const b = h.content;
                return Mo(b), Object.assign(ws(b), Oo(b), Ro(b), Nr(b), Io(b), Do(b, Wi))
            },
            ws = c => {
                const h = {};
...
`).join("<br />")), vi(c)
        ...
        const xs = () => {
                De.previousBodyPadding === null && document.body.scrollHeight > window.innerHeight && (De.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")), document.body.style.paddingRight = "".concat(De.previousBodyPadding + Hi(), "px"))
            },
            Br = () => {
            ...
            Es = () => {
                if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1) && !xt(document.body, K.iosfix)) {
                    ...
                    document.body.style.top = "".concat(h * -1, "px"), Je(document.body, K.iosfix), $r(), _s()
                }
            },
            _s = () => {
            ...
            Fr = c => {
                ...
                r(h, b, c), setTimeout(() => {
                    $o(h, b)
                }, jr), Se() && (jo(h, c.scrollbarPadding, ge), xi()), !he() && !rt.previousActiveElement && (rt.previousActiveElement = document.activeElement), typeof c.didOpen == "function" && setTimeout(() => c.didOpen(b)), Lt(h, K["no-transition"])
            },
            Ss = c => {
                const h = we();
                if (c.target !== h) return;
                const b = U();
                h.removeEventListener(mn, Ss), b.style.overflowY = "auto"
            },
            $o = (c, h) => {
                mn && pt(h) ? (c.style.overflowY = "hidden", h.addEventListener(mn, Ss)) : c.style.overflowY = "auto"
            },
            jo = (c, h, b) => {
            ...
            r = (c, h, b) => {
                ...
                }, jr), Je([document.documentElement, document.body], K.shown), b.heightAuto && b.backdrop && !b.toast && Je([document.documentElement, document.body], K["height-auto"])
            },
            s = c => {
                let h = we();
                h || new At, h = we();
                ...
                select: (c, h, b) => {
                    const B = j(c, K.select),
                        ge = (He, Ut, Bn) => {
                            ...
                            pn.value = Bn, it(pn, Ut), pn.selected = ne(Bn, b.inputValue), He.appendChild(pn)
                        };
                    h.forEach(He => {
                        const Ut = He[0],
                            Bn = He[1];
                        if (Array.isArray(Bn)) {
                            ...
                            pn.label = Ut, pn.disabled = !1, B.appendChild(pn), Bn.forEach(ir => ge(pn, ir[1], ir[0]))
                        } else ge(B, Bn, Ut)
                    }), B.focus()
                },
                radio: (c, h, b) => {
                    ...
                    h.forEach(He => {
                        ...
                        it(Qo, Bn), Qo.className = K.label, ir.appendChild(pn), ir.appendChild(Qo), B.appendChild(ir)
                    });
        ...
        const zt = () => pe(we()),
            ...
            on = (c, h, b, B) => {
                tt(h), b.toast || (h.keydownHandler = ge => Xi(c, ge, B), h.keydownTarget = b.keydownListenerCapture ? window : we(), h.keydownListenerCapture = b.keydownListenerCapture, h.keydownTarget.addEventListener("keydown", h.keydownHandler, {
            ...
            Xi = (c, h, b) => {
                const B = A.innerParams.get(c);
                !B || h.isComposing || h.keyCode === 229 || (B.stopKeydownPropagation && h.stopPropagation(), h.key === "Enter" ? hn(c, h, B) : h.key === "Tab" ? Jn(h, B) : [...Dt, ..._i].includes(h.key) ? Qn(h.key) : h.key === "Escape" && an(h, B, b))
            },
            hn = (c, h, b) => {
        ...
        function Mn(c, h, b, B) {
            he() ? As(c, B) : (gi(b).then(() => As(c, B)), tt(rt)), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (h.setAttribute("style", "display:none !important"), h.removeAttribute("class"), h.innerHTML = "") : h.remove(), Se() && (Br(), Ei(), Pr()), vn()
        }
        ...
        const Zn = c => {
            ...
            const B = U();
            return Lt(B, b.showClass.backdrop), Je(B, b.hideClass.backdrop), Ts(c, h, b), !0
        };
        ...
        const gt = c => {
            ...
            Hr = (c, h, b, B, ge) => {
                rt.swalCloseEventFinishedCallback = Mn.bind(null, c, b, B, ge), h.addEventListener(mn, function(He) {
                    He.target === h && (rt.swalCloseEventFinishedCallback(), delete rt.swalCloseEventFinishedCallback)
                })
            },
            As = (c, h) => {
                setTimeout(() => {
        ...
        const Is = c => {
            ...
            Yo = (c, h, b) => {
                A.innerParams.get(c).toast ? Ko(c, h, b) : (qr(h), Ls(h), Zi(c, h, b))
            },
            Ko = (c, h, b) => {
                h.popup.onclick = () => {
                    const B = A.innerParams.get(c);
                    B && (Ms(B) || B.timer || B.input) || b(Yn.close)
                }
            },
        ...
        const Xr = () => rt.timeout && rt.timeout.getTimerLeft(),
            Ps = () => {
        ...
        class Ue {
            ...
            _main(h) {
                ...
                Le(Object.assign({}, b, h)), rt.currentInstance && (rt.currentInstance._destroy(), Se() && Pr()), rt.currentInstance = ze;
                const B = ht(h, b);
                Cs(B), Object.freeze(B), rt.timeout && (rt.timeout.stop(), delete rt.timeout), clearTimeout(rt.restoreFocusTimeout);
                const ge = Tt(ze);
        ...
        const Xe = (c, h, b) => new Promise((B, ge) => {
                ...
                je.swalPromiseResolve.set(c, B), je.swalPromiseReject.set(c, ge), h.confirmButton.onclick = () => Is(c), h.denyButton.onclick = () => Ds(c), h.cancelButton.onclick = () => Xo(c, He), h.closeButton.onclick = () => He(Yn.close), Yo(c, h, He), on(c, rt, b, He), p(c, b), Fr(b), We(rt, b, He), Ht(h, b), setTimeout(() => {
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/standalone/drawful2-international/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    _C = bt.View.extend({
        ...
        onAttach() {
            ...
            this.cameraSprite = hl(EC), this.cameraSprite.width = this.model.get("width"), this.cameraSprite.height = this.model.get("height"), this.cameraSprite.mask = this.model.get("mask"), t.sprites.push(this.cameraSprite), t.gameLoop.start(), this.facingMode = "user", this.startCamera(), this.onResize()
        },
        async startCamera() {
    ...
    kC = bt.View.extend({
        ...
        initialize(t) {
            this.cameraView = this.cameraView || new _C(t), this.listenTo(this.model, "change", this.update, this), this.update()
        },
        update() {
    ...
    TC = '<a class="change-color button-color btn"></a>',
    AC = bt.View.extend({
        tagName: "div",
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/standalone/drawful2-international/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
`,
    IC = bt.View.extend({
        ...
        initialize() {
            this.colorPaletteComponent = this.colorPaletteComponent || new OC({
                collection: new Ze.Collection
...
class DC {
    constructor(e, n = {}) {
        ...
        this.canvasSelector = e, this.canvas = Ne(this.canvasSelector)[0], this.ctx = this.canvas.getContext("2d"), this.options = Object.assign(uc, n), this.history = [], this.layerNames.forEach(i => {
...
const MC = `<canvas id="fullLayer" class="sketchpad fullLayer" width='480' height='600' style=''></canvas>`,
    ...
    PC = `<div class="controller-content">\r
...
`,
    ...
    Li = bt.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new $i({}), this.toolbarComponent = this.toolbarComponent || new IC({
                model: new Ze.Model({})
...
const jC = `<div id="controller" class="state-controller controller-content">
    ...
    hs = bt.View.extend({
        ...
        initialize() {
            this.titleComponent = new $i({
                model: new Ze.Model({})
            }), this.choicesListView = this.choicesListView || new fi, this.charactersListView = new bt.CollectionView({
                childView: zC,
...
var oi = ri(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
    gs = ri(/Edge/i),
    dc = ri(/firefox/i),
    os = ri(/safari/i) && !ri(/chrome/i) && !ri(/android/i),
...
function Et(t, e, n) {
    t.addEventListener(e, n, !oi && ih)
}

function wt(t, e, n) {
    t.removeEventListener(e, n, !oi && ih)
}
...
function Yt(t, e, n, i, a) {
    if (!(!t.getBoundingClientRect && t !== window)) {
        var f, v, S, k, I, D, $;
        if (t !== window && t.parentNode && t !== zn() ? (f = t.getBoundingClientRect(), v = f.top, S = f.left, k = f.bottom, I = f.right, D = f.height, $ = f.width) : (v = 0, S = 0, k = window.innerHeight, I = window.innerWidth, D = window.innerHeight, $ = window.innerWidth), (e || n) && t !== window && (a = a || t.parentNode, !oi))
            do
...
function wr(t, e, n, i) {
    for (var a = 0, f = 0, v = t.children; f < v.length;) {
        if (v[f].style.display !== "none" && v[f] !== Qe.ghost && (i || v[f] !== Qe.dragged) && jn(v[f], n.draggable, t, !1)) {
            if (a === e) return v[f];
            a++
        }
        f++
...
function di(t, e) {
    if (!t || !t.getBoundingClientRect) return zn();
    var n = t,
        i = !1;
    do
        if (n.clientWidth < n.scrollWidth || n.clientHeight < n.scrollHeight) {
            ...
            if (n.clientWidth < n.scrollWidth && (a.overflowX == "auto" || a.overflowX == "scroll") || n.clientHeight < n.scrollHeight && (a.overflowY == "auto" || a.overflowY == "scroll")) {
                if (!n.getBoundingClientRect || n === document.body) return zn();
                if (i || e) return n;
                i = !0
            }
        ...
        animateAll: function(i) {
            ...
            t.forEach(function(S) {
                var k = 0,
                    ...
                    Y = S.rect,
                    re = gr(I, !0);
                re && ($.top -= re.f, $.left -= re.e), I.toRect = $, I.thisAnimationDuration && pa(J, $) && !pa(D, $) && (Y.top - $.top) / (Y.left - $.left) === (D.top - $.top) / (D.left - $.left) && (k = ax(Y, J, ie, a.options)), pa($, D) || (I.prevFromRect = D, I.prevToRect = $, k || (k = a.options.animation), a.animate(I, Y, $, k)), k && (f = !0, v = Math.max(v, k), clearTimeout(I.animationResetTimer), I.animationResetTimer = setTimeout(function() {
...
function lx(t) {
    ...
    if (e = e || n && n[Sn], !!e) {
        ...
        window.CustomEvent && !oi && !gs ? re = new CustomEvent(i, {
            bubbles: !0,
            cancelable: !0
...
var Re, $t, ut, Pt, Ii, Xs, Vt, ui, ur, _n, ls, ci, Fs, tn, cr = !1,
    so = !1,
    oo = [],
    Ai, Ln, ma, va, mc, vc, Zr, or, cs, us = !1,
    zs = !1,
    Ys, ln, ya = [],
    Pa = !1,
    ao = [],
    ...
    Hs = th,
    yc = gs || oi ? "cssFloat" : "float",
    ux = Co && !nh && !th && "draggable" in document.createElement("div"),
    lh = function() {
        if (!!Co) {
            if (oi) return !1;
    ...
    ch = function(e, n) {
        ...
        return f && (S.display === "block" || S.display === "flex" || S.display === "table" || S.display === "grid" || I >= a && i[yc] === "none" || v && i[yc] === "none" && I + D > a) ? "vertical" : "horizontal"
    },
    hx = function(e, n, i) {
...
Co && !nh && document.addEventListener("click", function(t) {
...
Qe.prototype = {
    ...
    _onTapStart: function(e) {
        if (!!e.cancelable) {
            var n = this,
                ...
                D = a.filter;
            if (Cx(i), !Re && !(/mousedown|pointerdown/.test(v) && e.button !== 0 || a.disabled) && !I.isContentEditable && !(!this.nativeDraggable && os && k && k.tagName.toUpperCase() === "SELECT") && (k = jn(k, a.draggable, i, !1), !(k && k.animated) && Xs !== k)) {
    ...
    _prepareDragStart: function(e, n, i) {
        ...
        if (i && !Re && i.parentNode === f) {
            var I = Yt(i);
            if (Pt = f, Re = i, $t = Re.parentNode, Ii = Re.nextSibling, Xs = i, Fs = v.group, Qe.dragged = Re, Ai = {
                    target: Re,
                    clientX: (n || e).clientX,
                    clientY: (n || e).clientY
                }, mc = Ai.clientX - I.left, vc = Ai.clientY - I.top, this._lastX = (n || e).clientX, this._lastY = (n || e).clientY, Re.style["will-change"] = "all", k = function() {
                    if (wn("delayEnded", a, {
                            evt: e
                        }), Qe.eventCanceled) {
                        a._onDrop();
                    ...
                    a._disableDelayedDragEvents(), !dc && a.nativeDraggable && (Re.draggable = !0), a._triggerDragStart(e, n), gn({
                        sortable: a,
                        name: "choose",
                        originalEvent: e
                    ...
                    rh(Re, D.trim(), wa)
                }), Et(S, "dragover", Oi), Et(S, "mousemove", Oi), Et(S, "touchmove", Oi), Et(S, "mouseup", a._onDrop), Et(S, "touchend", a._onDrop), Et(S, "touchcancel", a._onDrop), dc && this.nativeDraggable && (this.options.touchStartThreshold = 4, Re.draggable = !0), wn("delayStart", this, {
                    evt: e
                }), v.delay && (!v.delayOnTouchOnly || n) && (!this.nativeDraggable || !(gs || oi))) {
                if (Qe.eventCanceled) {
                    this._onDrop();
                    return
                }
    ...
    _triggerDragStart: function(e, n) {
        ...
        try {
            document.selection ? Ks(function() {
    ...
    _emulateDragOver: function() {
        if (Ln) {
            this._lastX = Ln.clientX, this._lastY = Ln.clientY, hh();
    ...
    _appendGhost: function() {
        if (!ut) {
            ...
            if (Hs) {
                ...
                ln !== document.body && ln !== document.documentElement ? (ln === document && (ln = zn()), n.top += ln.scrollTop, n.left += ln.scrollLeft) : ln = zn(), ya = gc(ln)
            }
            ut = Re.cloneNode(!0), En(ut, i.ghostClass, !1), En(ut, i.fallbackClass, !0), En(ut, i.dragClass, !0), nt(ut, "transition", ""), nt(ut, "transform", ""), nt(ut, "box-sizing", "border-box"), nt(ut, "margin", 0), nt(ut, "top", n.top), nt(ut, "left", n.left), nt(ut, "width", n.width), nt(ut, "height", n.height), nt(ut, "opacity", "0.8"), nt(ut, "position", Hs ? "absolute" : "fixed"), nt(ut, "zIndex", "100000"), nt(ut, "pointerEvents", "none"), Qe.ghost = ut, e.appendChild(ut), nt(ut, "transform-origin", mc / parseInt(ut.style.width) * 100 + "% " + vc / parseInt(ut.style.height) * 100 + "%")
        }
    },
    _onDragStart: function(e, n) {
        ...
        wn("setupClone", this), Qe.eventCanceled || (Vt = ah(Re), Vt.removeAttribute("id"), Vt.draggable = !1, Vt.style["will-change"] = "", this._hideClone(), En(Vt, this.options.chosenClass, !1), Qe.clone = Vt), i.cloneId = Ks(function() {
            wn("clone", i), !Qe.eventCanceled && (i.options.removeCloneOnHide || Pt.insertBefore(Vt, Re), i._hideClone(), gn({
                sortable: i,
                name: "clone"
            }))
        }), !n && En(Re, f.dragClass, !0), n ? (so = !0, i._loopId = setInterval(i._emulateDragOver, 50)) : (wt(document, "mouseup", i._onDrop), wt(document, "touchend", i._onDrop), wt(document, "touchcancel", i._onDrop), a && (a.effectAllowed = "move", f.setData && f.setData.call(i, a, Re)), Et(document, "drop", i), nt(Re, "transform", "translateZ(0)")), cr = !0, i._dragStartId = Ks(i._dragStarted.bind(i, n, e)), Et(document, "selectstart", i), Zr = !0, os && nt(document.body, "user-select", "none")
    },
    _onDragOver: function(e) {
        ...
        function m(ye, ue) {
            wn(ye, Y, Hn({
                ...
                onMove: function(ke, $e) {
                    return Us(Pt, n, Re, a, ke, Yt(ke), e, $e)
                },
                changed: ae
            }, ue))
        }
        ...
        function q(ye) {
            return m("dragOverCompleted", {
                insertion: ye
            }), ye && (D ? I._hideClone() : I._showClone(Y), Y !== J && (En(Re, tn ? tn.options.ghostClass : I.options.ghostClass, !1), En(Re, S.ghostClass, !0)), tn !== Y && Y !== Qe.active ? tn = Y : Y === Qe.active && tn && (tn = null), J === Y && (Y._ignoreWhileAnimating = i), Y.animateAll(function() {
                m("dragOverAnimationComplete"), Y._ignoreWhileAnimating = null
            }), Y !== J && (J.animateAll(), J._ignoreWhileAnimating = null)), (i === Re && !Re.animated || i === n && !i.animated) && (or = null), !S.dragoverBubble && !e.rootEl && i !== document && (Re.parentNode[Sn]._isOutsideThisEl(e.target), !ye && Oi(e)), !S.dragoverBubble && e.stopPropagation && e.stopPropagation(), re = !0
        }
        ...
        if (e.preventDefault !== void 0 && e.cancelable && e.preventDefault(), i = jn(i, S.draggable, n, !0), m("dragOver"), Qe.eventCanceled) return re;
        if (Re.contains(e.target) || i.animated && i.animatingX && i.animatingY || Y._ignoreWhileAnimating === i) return q(!1);
        if (so = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : tn === this || (this.lastPutMode = Fs.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            ...
            if (!se || vx(e, ie, this) && !se.animated) {
                if (se === Re) return q(!1);
                if (se && n === e.target && (i = se), i && (f = Yt(i)), Us(Pt, n, Re, a, i, f, e, !!i) !== !1) return P(), se && se.nextSibling ? n.insertBefore(Re, se.nextSibling) : n.appendChild(Re), $t = n, ae(), q(!0)
            } else if (se && mx(e, ie, this)) {
                var ve = wr(n, 0, S, !0);
                if (ve === Re) return q(!1);
                if (i = ve, f = Yt(i), Us(Pt, n, Re, a, i, f, e, !1) !== !1) return P(), n.insertBefore(Re, ve), $t = n, ae(), q(!0)
            } else if (i.parentNode === n) {
                f = Yt(i);
                var d = 0,
                    Ee, Ae = Re.parentNode !== n,
                    Le = !hx(Re.animated && Re.toRect || a, i.animated && i.toRect || f, ie),
                    lt = ie ? "top" : "left",
                    Be = pc(i, "top", "top") || pc(Re, "top", "top"),
                    K = Be ? Be.scrollTop : void 0;
                or !== i && (Ee = f[lt], us = !1, zs = !Le && S.invertSwap || Ae), d = yx(e, i, f, ie, Le ? 1 : S.swapThreshold, S.invertedSwapThreshold == null ? S.swapThreshold : S.invertedSwapThreshold, zs, or === i);
                var Fe;
                if (d !== 0) {
                    var U = On(Re);
                    do U -= d, Fe = $t.children[U]; while (Fe && (nt(Fe, "display") === "none" || Fe === ut))
                }
                ...
                var oe = i.nextElementSibling,
                    Te = !1;
                Te = d === 1;
                var we = Us(Pt, n, Re, a, i, f, e, Te);
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Pa = !0, setTimeout(gx, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), Be && oh(Be, 0, K - Be.scrollTop), $t = Re.parentNode, Ee !== void 0 && !zs && (Ys = Math.abs(Ee - Yt(i)[lt])), ae(), q(!0)
            }
    ...
    _nulling: function() {
        wn("nulling", this), Pt = Re = $t = ut = Ii = Vt = Xs = ui = Ai = Ln = Zr = _n = ci = ur = ls = or = cs = tn = Fs = Qe.dragged = Qe.ghost = Qe.clone = Qe.active = null, ao.forEach(function(e) {
            e.checked = !0
        }), ao.length = ma = va = 0
    },
    ...
    toArray: function() {
        for (var e = [], n, i = this.el.children, a = 0, f = i.length, v = this.options; a < f; a++) n = i[a], jn(n, v.draggable, this.el, !1) && e.push(n.getAttribute(v.dataIdAttr) || bx(n));
        return e
    },
    sort: function(e, n) {
        var i = {},
...
function Us(t, e, n, i, a, f, v, S) {
    var k, I = t[Sn],
        D = I.options.onMove,
        $;
    return window.CustomEvent && !oi && !gs ? k = new CustomEvent("move", {
        bubbles: !0,
        cancelable: !0
...
function yx(t, e, n, i, a, f, v, S) {
    ...
    if (!v) {
        if (S && Ys < I * a) {
            ...
            else if (cs === 1 ? k < D + Ys : k > $ - Ys) return -cs
...
Qe.mount = function() {
    ...
    e[0].constructor === Array && (e = e[0]), e.forEach(function(i) {
        ...
        i.utils && (Qe.utils = Hn(Hn({}, Qe.utils), i.utils)), ms.mount(i)
    })
};
...
function xx() {
    ...
    return t.prototype = {
        ...
        drop: function() {
            this.sortable.nativeDraggable ? wt(document, "dragover", this._handleAutoScroll) : (wt(document, "pointermove", this._handleFallbackAutoScroll), wt(document, "touchmove", this._handleFallbackAutoScroll), wt(document, "mousemove", this._handleFallbackAutoScroll)), wc(), Js(), rx()
        },
        nulling: function() {
            lo = Va = es = Ba = ts = ba = Ca = null, qt.length = 0
        },
        ...
        _handleAutoScroll: function(n, i) {
            ...
            if (lo = n, i || this.options.forceAutoScrollFallback || gs || oi || os) {
                xa(n, this.options, S, i);
                var k = di(S, !0);
                Ba && (!ts || f !== ba || v !== Ca) && (ts && wc(), ts = setInterval(function() {
                    var I = di(document.elementFromPoint(f, v), !0);
                    I !== k && (k = I, Js()), xa(n, a.options, I, i)
                }, 10), ba = f, Ca = v)
            } else {
                if (!this.options.bubbleScroll || di(S, !0) === zn()) {
                    Js();
                    return
                }
...
var xa = sh(function(t, e, n, i) {
        if (!!e.scroll) {
            var a = (t.touches ? t.touches[0] : t).clientX,
                ...
                I = !1,
                D;
            Va !== n && (Va = n, Js(), es = e.scroll, D = e.scrollFn, es === !0 && (es = di(n, !0)));
            var $ = 0,
                J = es;
            do {
                var ie = J,
                ...
                (qt[$].vx != K || qt[$].vy != Fe || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = Fe, clearInterval(qt[$].pid), (K != 0 || Fe != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    ...
                    typeof D == "function" && D.call(Qe.dragged.parentNode[Sn], Te, oe, t, lo, qt[this.layer].el) !== "continue" || oh(qt[this.layer].el, Te, oe)
                }.bind({
                    layer: $
                }), 24))), $++
...
const Ex = `<div id="controller" class="state-controller controller-content">\r
    ...
    `),
        ...
        initialize() {
            this.rankedCollectionView = this.rankedCollectionView || new bc({
                collection: new Ze.Collection([])
            }), this.unrankedCollectionView = this.unrankedCollectionView || new bc({
                className: "sortable-collection unranked",
                collection: new Ze.Collection([])
            }), this.lockInView = this.lockInView || new Ku({
                block: !1,
                model: new Ze.Model({
                    action: "lock",
                    html: "Lock In"
...
const Fx = bt.View.extend({
	...
	<li class="pull-left button-pad">\r
		<button id="primaryColor" class="button block"></button>\r
	</li>\r
	<li class="pull-left button-pad">\r
    ...
    Gx = Pn.extend({
        defaults: at.extend({}, Li.prototype.model.defaults, {
            colors: ["#000000"],
            thicknesses: [1],
            defaultIndex: 0,
            hideSubmit: !0,
    ...
    qx = Li.extend({
        model: new Gx,
        bindings: at.extend({}, Li.prototype.bindings, {}),
        initialize(t) {
            this.postComponent = this.postComponent || new Ux({
                model: new Ze.Model({})
            }), this.toolbarComponent = this.toolbarComponent || new bt.View({
                template: at.template(""),
                model: new Ze.Model({})
            }), Li.prototype.initialize.apply(this, [t])
        },
        update() {
            ...
            }), Li.prototype.update.apply(this)
        },
        onRender() {
            Li.prototype.onRender.apply(this), this.showChildView("buttons", this.postComponent)
        },
        onChildviewChooseColor(t) {
            this.chooseColor(t, {})
        }
    ...
    Xx = hs.extend({
        ...
        async onButtonClick(t) {
            t.preventDefault();
            const n = Ne(t.currentTarget).data("action");
            return n === "start" && !this.model.get("allPlayersHavePortraits") ? ((await Ot.show("custom", {
                html: this.model.get("strings").vip_are_you_sure,
                confirmButtonText: this.model.get("strings").vip_are_you_sure_yes,
                cancelButtonText: this.model.get("strings").vip_are_you_sure_no,
                customClass: {
                ...
                showCancelButton: !0
            })).isConfirmed && this.triggerMethod("client:message", {
                action: n
            }), null) : hs.prototype.onButtonClick.apply(this, [t])
        }
    });
const Yx = Vx.extend({
    ...
    parseBlob(t) {
        ...
        return t.state === "MakeSingleChoice" && (e.choices = t.choices.map(n => ({
            ...n,
            text: en.htmlUnescape(n.text)
        })), e.countGroupName = "Drawful2 Vote"), t.state === "Lobby" && t.lobbyState && (this.hasUGC = !!t.activeContentId), this.prevState = t.state, this.prevState = t.state, e
    }
});
zx({
    MainView: Yx
});
//# sourceMappingURL=7f620ee6.js.map