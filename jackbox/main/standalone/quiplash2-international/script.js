    ...
    return gl || (gl = 1, function(t, e) {
        (function() {
            ...
            m.each = m.forEach = function(l, g, _) {
                ...
                g = q(g, _);
                for (var O = !Ae(l) && m.keys(l), L = (O || l).length, V = Array(L), te = 0; te < L; te++) {
                    var Se = O ? O[te] : te;
                    V[te] = g(l[Se], Se, l)
                }
                return V
            ...
            m.reduce = m.foldl = m.inject = Le(1), m.reduceRight = m.foldr = Le(-1), m.find = m.detect = function(l, g, _) {
                ...
                var O = [];
                return g = q(g, _), m.each(l, function(L, V, te) {
                    g(L, V, te) && O.push(L)
                }), O
                ...
                g = q(g, _);
                for (var O = !Ae(l) && m.keys(l), L = (O || l).length, V = 0; V < L; V++) {
                    var te = O ? O[V] : V;
                ...
                if (g == null && l != null) {
                    ...
                    te = g(Ie, De, nt), (te > L || te === -1 / 0 && O === -1 / 0) && (O = Ie, L = te)
                });
                return O
                ...
                for (var g = Ae(l) ? l : m.values(l), _ = g.length, O = Array(_), L = 0, V; L < _; L++) V = m.random(0, L), V !== L && (O[L] = O[V]), O[V] = g[L];
                return O
                ...
                return g = q(g, _), m.pluck(m.map(l, function(O, L, V) {
                    return {
                        value: O,
                        index: L,
                        criteria: g(O, L, V)
            ...
            m.groupBy = at(function(l, g, _) {
                m.has(l, _) ? l[_].push(g) : l[_] = [g]
            }), m.indexBy = at(function(l, g, _) {
                l[_] = g
            }), m.countBy = at(function(l, g, _) {
                m.has(l, _) ? l[_]++ : l[_] = 1
            ...
            var Be = function(l, g, _, O) {
                for (var L = [], V = 0, te = O || 0, Se = xe(l); te < Se; te++) {
                    var he = l[te];
            ...
            m.flatten = function(l, g) {
                ...
                for (var L = [], V = [], te = 0, Se = xe(l); te < Se; te++) {
                    var he = l[te],
                        Ie = _ ? _(he, te, l) : he;
                    g ? ((!te || V !== Ie) && L.push(he), V = Ie) : _ ? m.contains(V, Ie) || (V.push(Ie), L.push(he)) : m.contains(L, he) || L.push(he)
                }
                return L
            }, m.union = function() {
                return m.uniq(Be(arguments, !0, !0))
            }, m.intersection = function(l) {
                for (var g = [], _ = arguments.length, O = 0, L = xe(l); O < L; O++) {
                    var V = l[O];
                    if (!m.contains(g, V)) {
                ...
                for (var g = l && m.max(l, xe).length || 0, _ = Array(g), O = 0; O < g; O++) _[O] = m.pluck(l, O);
                return _
            }, m.object = function(l, g) {
                for (var _ = {}, O = 0, L = xe(l); O < L; O++) g ? _[l[O]] = g[O] : _[l[O][0]] = l[O][1];
                return _
            };
            ...
            function K(l) {
                return function(g, _, O) {
                    _ = q(_, O);
                    for (var L = xe(g), V = l > 0 ? 0 : L - 1; V >= 0 && V < L; V += l)
            ...
            m.findIndex = K(1), m.findLastIndex = K(-1), m.sortedIndex = function(l, g, _, O) {
                _ = q(_, O, 1);
                for (var L = _(g), V = 0, te = xe(l); V < te;) {
                    var Se = Math.floor((V + te) / 2);
                    _(l[Se]) < L ? V = Se + 1 : te = Se
                }
                return V
            };
            ...
            function Fe(l, g, _) {
                return function(O, L, V) {
                    ...
                    else if (_ && V && Se) return V = _(O, L), O[V] === L ? V : -1;
                    if (L !== L) return V = g(k.call(O, te, Se), m.isNaN), V >= 0 ? V + te : -1;
            ...
            m.indexOf = Fe(1, m.findIndex, m.sortedIndex), m.lastIndexOf = Fe(-1, m.findLastIndex), m.range = function(l, g, _) {
                ...
                for (var O = Math.max(Math.ceil((g - l) / _), 0), L = Array(O), V = 0; V < O; V++, l += _) L[V] = l;
                return L
            };
            var U = function(l, g, _, O, L) {
            ...
            m.bind = function(l, g) {
                ...
                _ || (_ = {});
                var he = function() {
                    Se = _.leading === !1 ? 0 : m.now(), te = null, V = l.apply(O, L), te || (O = L = null)
                };
                return function() {
                    var Ie = m.now();
                    !Se && _.leading === !1 && (Se = Ie);
                    var De = g - (Ie - Se);
                    return O = this, L = arguments, De <= 0 || De > g ? (te && (clearTimeout(te), te = null), Se = Ie, V = l.apply(O, L), te || (O = L = null)) : !te && _.trailing !== !1 && (te = setTimeout(he, De)), V
                }
            }, m.debounce = function(l, g, _) {
                var O, L, V, te, Se, he = function() {
                    var Ie = m.now() - te;
                    Ie < g && Ie >= 0 ? O = setTimeout(he, g - Ie) : (O = null, _ || (Se = l.apply(V, L), O || (V = L = null)))
                };
                return function() {
                    V = this, L = arguments, te = m.now();
                    var Ie = _ && !O;
                    return O || (O = setTimeout(he, g)), Ie && (Se = l.apply(V, L), V = L = null), Se
                }
            }, m.wrap = function(l, g) {
            ...
            function we(l, g) {
                var _ = Te.length,
                    ...
                    V = "constructor";
                for (m.has(l, V) && !m.contains(g, V) && g.push(V); _--;) V = Te[_], V in l && l[V] !== L[V] && !m.contains(g, V) && g.push(V)
            }
            m.keys = function(l) {
                if (!m.isObject(l)) return [];
                if (J) return J(l);
                ...
                var O = {},
                    ...
                    V, te;
                if (L == null) return O;
                m.isFunction(g) ? (te = m.allKeys(L), V = P(g, _)) : (te = Be(arguments, !1, !1, 1), V = function(nt, Ct, rn) {
                    return Ct in rn
                }, L = Object(L));
            ...
            m.template = function(l, g, _) {
                ...
                var O = RegExp([(g.escape || Ke).source, (g.interpolate || Ke).source, (g.evaluate || Ke).source].join("|") + "|$", "g"),
                    L = 0,
                    V = "__p+='";
                l.replace(O, function(Ie, De, nt, Ct, rn) {
                    return V += l.slice(L, rn).replace(Bt, Gt), L = rn + Ie.length, De ? V += `'+
            ...
            m.mixin = function(l) {
                m.each(m.functions(l), function(g) {
                    ...
                    m.prototype[g] = function() {
                        var O = [this._wrapped];
                        return S.apply(O, arguments), x(this, _.apply(m, O))
                    }
                })
                ...
                m.prototype[l] = function() {
                    var _ = this._wrapped;
                    return g.apply(_, arguments), (l === "shift" || l === "splice") && _.length === 0 && delete _[0], x(this, _)
                }
            }), m.each(["concat", "join", "slice"], function(l) {
                var g = a[l];
                m.prototype[l] = function() {
                    return x(this, g.apply(this._wrapped, arguments))
                }
    ...
    (function(e, n) {
        ...
        d.fn = d.prototype = {
            ...
            makeArray: function(r, s) {
                var u = s || [];
                return r != null && (xe(Object(r)) ? d.merge(u, typeof r == "string" ? [r] : r) : S.call(u, r)), u
            },
        ...
        var Ae = function(r) {
            var s, u, p, w, E, T, z, H, Z, le, be, ne, ce, Ge, rt, je, zt, Nt, un, _t = "sizzle" + 1 * new Date,
                et = r.document,
                on = 0,
                ft = 0,
                Dt = Xi(),
                ...
                if (!de && (ne(F), F = F || ce, rt)) {
                    if (ht !== 11 && (Me = qo.exec(R)))
                        ...
                        if (Ue = R, Xe = F, ht === 1 && (jo.test(R) || As.test(R))) {
                            for (Xe = zr.test(R) && Ur(F.parentNode) || F, (Xe !== F || !u.scope) && ((Oe = F.getAttribute("id")) ? Oe = Oe.replace(Hr, Os) : F.setAttribute("id", Oe = _t)), ze = T(R), me = ze.length; me--;) ze[me] = (Oe ? "#" + Oe : ":scope") + " " + Ji(ze[me]);
                            Ue = ze.join(",")
                        }
                        try {
            ...
            u = St.support = {}, E = St.isXML = function(R) {
                ...
                return de == ce || de.nodeType !== 9 || !de.documentElement || (ce = de, Ge = ce.documentElement, rt = !E(ce), et != ce && (X = ce.defaultView) && X.top !== X && (X.addEventListener ? X.addEventListener("unload", Rs, !1) : X.attachEvent && X.attachEvent("onunload", Rs)), u.scope = yn(function(ee) {
                    ...
                    var me = ee.replace(Tn, En);
                    return function(Ee) {
                        var Oe = typeof Ee.getAttributeNode < "u" && Ee.getAttributeNode("id");
                        return Oe && Oe.value === me
                    }
                }, p.find.ID = function(ee, me) {
                    if (typeof me.getElementById < "u" && rt) {
                        var Ee, Oe, Me, ze = me.getElementById(ee);
                        if (ze) {
                    ...
                    if (ee === "*") {
                        for (; Ee = ze[Me++];) Ee.nodeType === 1 && Oe.push(Ee);
                        return Oe
                    }
                    return ze
                    ...
                    var Ee = ee.nodeType === 9 ? ee.documentElement : ee,
                        Oe = me && me.parentNode;
                    return ee === Oe || !!(Oe && Oe.nodeType === 1 && (Ee.contains ? Ee.contains(Oe) : ee.compareDocumentPosition && ee.compareDocumentPosition(Oe) & 16))
                } : function(ee, me) {
                    if (me) {
                    ...
                    for (; Ue[Oe] === Xe[Oe];) Oe++;
                    return Oe ? Ki(Ue[Oe], Xe[Oe]) : Ue[Oe] == et ? -1 : Xe[Oe] == et ? 1 : 0
                }), ce
                ...
                preFilter: {
                    ATTR: function(R) {
                        return R[1] = R[1].replace(Tn, En), R[3] = (R[3] || R[4] || R[5] || "").replace(Tn, En), R[2] === "~=" && (R[3] = " " + R[3] + " "), R.slice(0, 4)
                    },
                    CHILD: function(R) {
                    ...
                    PSEUDO: function(R) {
                        var F, X = !R[6] && R[2];
                        return Wi.CHILD.test(R[0]) ? null : (R[3] ? R[2] = R[4] || R[5] || "" : X && Fo.test(X) && (F = T(X, !0)) && (F = X.indexOf(")", X.length - F) - X.length) && (R[0] = R[0].slice(0, F), R[2] = X.slice(0, F)), R.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(R) {
                        var F = R.replace(Tn, En).toLowerCase();
                        return R === "*" ? function() {
                            return !0
                        } : function(X) {
                    ...
                    CHILD: function(R, F, X, de, ee) {
                        ...
                        return de === 1 && ee === 0 ? function(Me) {
                            ...
                            var Xe, ht, Tt, We, Ht, Qt, fn = me !== Ee ? "nextSibling" : "previousSibling",
                                At = Me.parentNode,
                            ...
                            if (At) {
                                ...
                                if (Qt = [Ee ? At.firstChild : At.lastChild], Ee && h) {
                                    for (We = At, Tt = We[_t] || (We[_t] = {}), ht = Tt[We.uniqueID] || (Tt[We.uniqueID] = {}), Xe = ht[R] || [], Ht = Xe[0] === on && Xe[1], b = Ht && Xe[2], We = Ht && At.childNodes[Ht]; We = ++Ht && We && We[fn] || (b = Ht = 0) || Qt.pop();)
                                    ...
                                    for (;
                                        (We = ++Ht && We && We[fn] || (b = Ht = 0) || Qt.pop()) && !((Oe ? We.nodeName.toLowerCase() === c : We.nodeType === 1) && ++b && (h && (Tt = We[_t] || (We[_t] = {}), ht = Tt[We.uniqueID] || (Tt[We.uniqueID] = {}), ht[R] = [on, b]), We === Me)););
                    ...
                    PSEUDO: function(R, F) {
                        ...
                        return de[_t] ? de(F) : de.length > 1 ? (X = [R, R, "", F], p.setFilters.hasOwnProperty(R.toLowerCase()) ? dn(function(ee, me) {
                            for (var Ee, Oe = de(ee, F), Me = Oe.length; Me--;) Ee = Qn(ee, Oe[Me]), ee[Ee] = !(me[Ee] = Oe[Me])
                        }) : function(ee) {
                            return de(ee, 0, X)
                        }) : de
                    }
                ...
                pseudos: {
                    not: dn(function(R) {
                        var F = [],
                            X = [],
                            de = z(R.replace(Si, "$1"));
                        return de[_t] ? dn(function(ee, me, Ee, Oe) {
                    ...
                    contains: dn(function(R) {
                        return R = R.replace(Tn, En),
                            function(F) {
                                return (F.textContent || w(F)).indexOf(R) > -1
                            }
                    }),
                    lang: dn(function(R) {
                        return zo.test(R || "") || St.error("unsupported lang: " + R), R = R.replace(Tn, En).toLowerCase(),
                            function(F) {
                                var X;
                                do
            ...
            Ds.prototype = p.filters = p.pseudos, p.setFilters = new Ds, T = St.tokenize = function(R, F) {
                var X, de, ee, me, Ee, Oe, Me, ze = _i[R + " "];
                if (ze) return F ? 0 : ze.slice(0);
                for (Ee = R, Oe = [], Me = p.preFilter; Ee;) {
                    (!X || (de = Ts.exec(Ee))) && (de && (Ee = Ee.slice(de[0].length) || Ee), Oe.push(ee = [])), X = !1, (de = As.exec(Ee)) && (X = de.shift(), ee.push({
                        value: X,
                        type: de[0].replace(Si, " ")
                    }), Ee = Ee.slice(X.length));
                    for (me in p.filter)(de = Wi[me].exec(Ee)) && (!Me[me] || (de = Me[me](de))) && (X = de.shift(), ee.push({
                        value: X,
                        type: me,
                        matches: de
                    }), Ee = Ee.slice(X.length));
                ...
                return F ? Ee.length : Ee ? St.error(R) : _i(R, Oe).slice(0)
            };
            ...
            function er(R, F, X, de, ee) {
                for (var me, Ee = [], Oe = 0, Me = R.length, ze = F != null; Oe < Me; Oe++)(me = R[Oe]) && (!X || X(me, de, ee)) && (Ee.push(me), ze && F.push(Oe));
                return Ee
            }

            function Gr(R, F, X, de, ee, me) {
                return de && !de[_t] && (de = Gr(de)), ee && !ee[_t] && (ee = Gr(ee, me)), dn(function(Ee, Oe, Me, ze) {
                    var Ue, Xe, ht, Tt = [],
                        We = [],
                        Ht = Oe.length,
                        Qt = Ee || Ko(F || "*", Me.nodeType ? [Me] : Me, []),
                        fn = R && (Ee || !F) ? er(Qt, Tt, R, Me, ze) : Qt,
                        At = X ? ee || (Ee ? R : Ht || de) ? [] : Oe : fn;
                    if (X && X(fn, At, Me, ze), de)
                        for (Ue = er(At, We), de(Ue, [], Me, ze), Xe = Ue.length; Xe--;)(ht = Ue[Xe]) && (At[We[Xe]] = !(fn[We[Xe]] = ht));
                    if (Ee) {
                        if (ee || R) {
                            if (ee) {
                            ...
                            for (Xe = At.length; Xe--;)(ht = At[Xe]) && (Ue = ee ? Qn(Ee, ht) : Tt[Xe]) > -1 && (Ee[Ue] = !(Oe[Ue] = ht))
                        }
                    } else At = er(At === Oe ? At.splice(Ht, At.length) : At), ee ? ee(null, Oe, At, ze) : Cn.apply(Oe, At)
                })
            }

            function qr(R) {
                for (var F, X, de, ee = R.length, me = p.relative[R[0].type], Ee = me || p.relative[" "], Oe = me ? 1 : 0, Me = Qi(function(Xe) {
                        return Xe === F
                    }, Ee, !0), ze = Qi(function(Xe) {
                        return Qn(F, Xe) > -1
                    }, Ee, !0), Ue = [function(Xe, ht, Tt) {
                        var We = !me && (Tt || ht !== Z) || ((F = ht).nodeType ? Me(Xe, ht, Tt) : ze(Xe, ht, Tt));
                        return F = null, We
                    }]; Oe < ee; Oe++)
                    if (X = p.relative[R[Oe].type]) Ue = [Qi(Zi(Ue), X)];
                        ...
                        if (X = p.filter[R[Oe].type].apply(null, R[Oe].matches), X[_t]) {
                            ...
                            return Gr(Oe > 1 && Zi(Ue), Oe > 1 && Ji(R.slice(0, Oe - 1).concat({
                                value: R[Oe - 2].type === " " ? "*" : ""
                ...
                var X = F.length > 0,
                    ...
                    ee = function(me, Ee, Oe, Me, ze) {
                        var Ue, Xe, ht, Tt = 0,
                            ...
                            h = At.length;
                        for (ze && (Z = Ee == ce || Ee || ze); We !== h && (Ue = At[We]) != null; We++) {
                            if (de && Ue) {
                                for (Xe = 0, !Ee && Ue.ownerDocument != ce && (ne(Ue), Oe = !rt); ht = R[Xe++];)
                                    if (ht(Ue, Ee || ce, Oe)) {
                                        Me.push(Ue);
                                        break
                                    } ze && (on = c)
                        ...
                        if (Tt += We, X && We !== Tt) {
                            for (Xe = 0; ht = F[Xe++];) ht(Ht, Qt, Ee, Oe);
                            if (me) {
                                if (Tt > 0)
                                    for (; We--;) Ht[We] || Qt[We] || (Qt[We] = Mn.call(Me));
                                Qt = er(Qt)
                            }
                            Cn.apply(Me, Qt), ze && !me && Qt.length > 0 && Tt + F.length > 1 && St.uniqueSort(Me)
                        }
            ...
            return z = St.compile = function(R, F) {
                var X, de = [],
                    ...
                    me = qi[R + " "];
                if (!me) {
                    for (F || (F = T(R)), X = F.length; X--;) me = qr(F[X]), me[_t] ? de.push(me) : ee.push(me);
                    me = qi(R, Ms(ee, de)), me.selector = R
                }
                return me
            }, H = St.select = function(R, F, X, de) {
                var ee, me, Ee, Oe, Me, ze = typeof R == "function" && R,
                    Ue = !de && T(R = ze.selector || R);
                if (X = X || [], Ue.length === 1) {
                    if (me = Ue[0] = Ue[0].slice(0), me.length > 2 && (Ee = me[0]).type === "ID" && F.nodeType === 9 && rt && p.relative[me[1].type]) {
                        if (F = (p.find.ID(Ee.matches[0].replace(Tn, En), F) || [])[0], F) ze && (F = F.parentNode);
                        else return X;
                        R = R.slice(me.shift().value.length)
                    }
                    for (ee = Wi.needsContext.test(R) ? 0 : me.length; ee-- && (Ee = me[ee], !p.relative[Oe = Ee.type]);)
                        if ((Me = p.find[Oe]) && (de = Me(Ee.matches[0].replace(Tn, En), zr.test(me[0].type) && Ur(F.parentNode) || F))) {
                            if (me.splice(ee, 1), R = de.length && Ji(me), !R) return Cn.apply(X, de), X;
                            break
                        }
                }
                return (ze || z(R, Ue))(de, F, !rt, X, !F || zr.test(R) && Ur(F.parentNode) || F), X
            ...
            }) || Yi("type|href|height|width", function(R, F, X) {
                ...
                Z = {
                    ...
                    remove: function() {
                        return d.each(arguments, function(le, be) {
                            for (var ne;
                                (ne = d.inArray(be, E, ne)) > -1;) E.splice(ne, 1), ne <= z && z--
                        }), this
                    },
                    has: function(le) {
        ...
        d.extend({
            ...
            when: function(r) {
                var s = arguments.length,
                    ...
                    T = function(z) {
                        return function(H) {
                            p[z] = this, w[z] = arguments.length > 1 ? f.call(arguments) : H, --s || E.resolveWith(p, w)
                        }
                    };
        ...
        d.fn.ready = function(r) {
            return x.then(r).catch(function(s) {
                d.readyException(s)
            }), this
        }, d.extend({
            isReady: !1,
            readyWait: 1,
            ready: function(r) {
                (r === !0 ? --d.readyWait : d.isReady) || (d.isReady = !0, !(r !== !0 && --d.readyWait > 0) && x.resolveWith(P, [d]))
            }
        }), d.ready.then = x.then;
        ...
        var g = function(r, s, u, p, w, E, T) {
                ...
                return w ? r : Z ? s.call(r) : H ? s(r[0], u) : E
            },
            _ = /^-ms-/,
            O = /-([a-z])/g;
        ...
        d.extend({
            ...
            data: function(r, s) {
                var u, p, w, E = this[0],
                    T = E && E.attributes;
                if (r === void 0) {
                    if (this.length && (w = Ie.get(E), E.nodeType === 1 && !he.get(E, "hasDataAttrs"))) {
                        for (u = T.length; u--;) T[u] && (p = T[u].name, p.indexOf("data-") === 0 && (p = V(p.slice(5)), rn(E, p, w[p])));
                ...
                return typeof r == "object" ? this.each(function() {
                    ...
                    var H;
                    if (E && z === void 0) return H = Ie.get(E, r), H !== void 0 || (H = rn(E, r), H !== void 0) ? H : void 0;
                    this.each(function() {
                        Ie.set(this, r, z)
                    })
        ...
        function N(r, s, u, p) {
            ...
            if (le && le[3] !== Z) {
                for (H = H / 2, Z = Z || le[3], le = +H || 1; T--;) d.style(r, s, le + Z), (1 - E) * (1 - (E = z() / H || .5)) <= 0 && (T = 0), le = le / E;
        ...
        function G(r, s) {
            for (var u, p, w = [], E = 0, T = r.length; E < T; E++) p = r[E], p.style && (u = p.style.display, s ? (u === "none" && (w[E] = he.get(p, "display") || null, w[E] || (p.style.display = "")), p.style.display === "" && j(p) && (w[E] = M(p))) : u !== "none" && (w[E] = "none", he.set(p, "display", u)));
        ...
        function In(r, s, u, p, w) {
            for (var E, T, z, H, Z, le, be = s.createDocumentFragment(), ne = [], ce = 0, Ge = r.length; ce < Ge; ce++)
                if (E = r[ce], E || E === 0)
                    if (se(E) === "object") d.merge(ne, E.nodeType ? [E] : E);
                    else if (!Ye.test(E)) ne.push(s.createTextNode(E));
            else {
                for (T = T || be.appendChild(s.createElement("div")), z = (pe.exec(E) || ["", ""])[1].toLowerCase(), H = Ve[z] || Ve._default, T.innerHTML = H[1] + d.htmlPrefilter(E) + H[2], le = H[0]; le--;) T = T.lastChild;
                d.merge(ne, T.childNodes), T = be.firstChild, T.textContent = ""
            }
            for (be.textContent = "", ce = 0; E = ne[ce++];) {
                if (p && d.inArray(E, p) > -1) {
                    w && w.push(E);
                    continue
                }
                if (Z = Je(E), T = pt(be.appendChild(E), "script"), Z && jt(T), u)
                    for (le = 0; E = T[le++];) Pe.test(E.type || "") && u.push(E)
            }
            return be
        }
        var Pn = /^([^.]*)(?:\.(.+)|)/;
        ...
        d.event = {
            ...
            add: function(r, s, u, p, w) {
                var E, T, z, H, Z, le, be, ne, ce, Ge, rt, je = he.get(r);
                if (!!te(r))
                    for (u.handler && (E = u, u = E.handler, w = E.selector), w && d.find.matchesSelector(Jt, w), u.guid || (u.guid = d.guid++), (H = je.events) || (H = je.events = Object.create(null)), (T = je.handle) || (T = je.handle = function(zt) {
                        ...
                        namespace: Ge.join(".")
                    }, E), (ne = H[ce]) || (ne = H[ce] = [], ne.delegateCount = 0, (!be.setup || be.setup.call(r, p, Ge, T) === !1) && r.addEventListener && r.addEventListener(ce, T)), be.add && (be.add.call(r, le), le.handler.guid || (le.handler.guid = u.guid)), w ? ne.splice(ne.delegateCount++, 0, le) : ne.push(le), d.event.global[ce] = !0)
            },
            remove: function(r, s, u, p, w) {
                var E, T, z, H, Z, le, be, ne, ce, Ge, rt, je = he.hasData(r) && he.get(r);
                if (!(!je || !(H = je.events))) {
                    for (s = (s || "").match(ke) || [""], Z = s.length; Z--;) {
                        ...
                        for (be = d.event.special[ce] || {}, ce = (p ? be.delegateType : be.bindType) || ce, ne = H[ce] || [], z = z[2] && new RegExp("(^|\\.)" + Ge.join("\\.(?:.*\\.|)") + "(\\.|$)"), T = E = ne.length; E--;) le = ne[E], (w || rt === le.origType) && (!u || u.guid === le.guid) && (!z || z.test(le.namespace)) && (!p || p === le.selector || p === "**" && le.selector) && (ne.splice(E, 1), le.selector && ne.delegateCount--, be.remove && be.remove.call(r, le));
                ...
                if (H.delegateTarget = this, !(le.preDispatch && le.preDispatch.call(this, H) === !1)) {
                    for (T = d.event.handlers.call(this, H, Z), s = 0;
                        ...
                        for (H.currentTarget = w.elem, u = 0;
                            (E = w.handlers[u++]) && !H.isImmediatePropagationStopped();)(!H.rnamespace || E.namespace === !1 || H.rnamespace.test(E.namespace)) && (H.handleObj = E, H.data = E.data, p = ((d.event.special[E.origType] || {}).handle || E.handler).apply(w.elem, z), p !== void 0 && (H.result = p) === !1 && (H.preventDefault(), H.stopPropagation()));
                ...
                if (H && Z.nodeType && !(r.type === "click" && r.button >= 1)) {
                    for (; Z !== this; Z = Z.parentNode || this)
                        if (Z.nodeType === 1 && !(r.type === "click" && Z.disabled === !0)) {
                            for (E = [], T = {}, u = 0; u < H; u++) p = s[u], w = p.selector + " ", T[w] === void 0 && (T[w] = p.needsContext ? d(w, this).index(Z) > -1 : d.find(w, this, null, [Z]).length), T[w] && E.push(p);
                            E.length && z.push({
                                elem: Z,
                                handlers: E
                            })
        ...
        function $i(r, s) {
            var u, p, w, E, T, z, H;
            if (s.nodeType === 1) {
                if (he.hasData(r) && (E = he.get(r), H = E.events, H)) {
        ...
        function mn(r, s, u, p) {
            s = v(s);
            var w, E, T, z, H, Z, le = 0,
                be = r.length,
                ne = be - 1,
                ce = s[0],
                Ge = re(ce);
            if (Ge || be > 1 && typeof ce == "string" && !Y.checkClone && kr.test(ce)) return r.each(function(rt) {
                var je = r.eq(rt);
        ...
        function Fi(r, s, u) {
            for (var p, w = s ? d.filter(s, r) : r, E = 0;
                (p = w[E]) != null; E++) !u && p.nodeType === 1 && d.cleanData(pt(p)), p.parentNode && (u && Je(p) && jt(pt(p, "script")), p.parentNode.removeChild(p));
            return r
        }
        d.extend({
            ...
            clone: function(r, s, u) {
                ...
                if (s)
                    if (u)
                        for (E = E || pt(r), T = T || pt(z), p = 0, w = E.length; p < w; p++) $i(E[p], T[p]);
                    else $i(r, z);
            ...
            d.fn[r] = function(u) {
                for (var p, w = [], E = d(u), T = E.length - 1, z = 0; z <= T; z++) p = z === T ? this : this.clone(!0), d(E[z])[s](p), S.apply(w, p.get());
                return this.pushStack(w)
            }
        });
        var wi = new RegExp("^(" + lt + ")(?!px)[a-z%]+$", "i"),
            Hn = function(r) {
        ...
        (function() {
            function r() {
                if (!!Z) {
                    ...
                    u = le.top !== "1%", z = s(le.marginLeft) === 12, Z.style.right = "60%", E = s(le.right) === 36, p = s(le.width) === 36, Z.style.position = "absolute", w = s(Z.offsetWidth / 3) === 12, Jt.removeChild(H), Z = null
                }
            }
            ...
            var u, p, w, E, T, z, H = P.createElement("div"),
        ...
        function Ze(r, s, u) {
            ...
            return u = u || Hn(r), u && (T = u.getPropertyValue(s) || u[s], T === "" && !Je(r) && (T = d.style(r, s)), !Y.pixelBoxStyles() && wi.test(T) && bi.test(s) && (p = z.width, w = z.minWidth, E = z.maxWidth, z.minWidth = z.maxWidth = z.width = T, T = u.width, z.width = p, z.minWidth = w, z.maxWidth = E)), T !== void 0 ? T + "" : T
        }
        ...
        function Gn(r, s, u, p, w, E) {
            ...
            return !p && E >= 0 && (H += Math.max(0, Math.ceil(r["offset" + s[0].toUpperCase() + s.slice(1)] - E - H - z - .5)) || 0), H
        }
        ...
        function Tr(r, s, u) {
            ...
            return (!Y.boxSizingReliable() && E || !Y.reliableTrDimensions() && K(r, "tr") || z === "auto" || !parseFloat(z) && d.css(r, "display", !1, p) === "inline") && r.getClientRects().length && (E = d.css(r, "boxSizing", !1, p) === "border-box", T = H in r, T && (z = r[H])), z = parseFloat(z) || 0, z + Gn(r, s, u || (E ? "border" : "content"), T, p, z) + "px"
        }
        d.extend({
            cssHooks: {
                opacity: {
            ...
            style: function(r, s, u, p) {
                if (!(!r || r.nodeType === 3 || r.nodeType === 8 || !r.style)) {
                    ...
                    if (H || (s = Ce(z)), T = d.cssHooks[s] || d.cssHooks[z], u !== void 0) {
                        ...
                        E === "number" && !H && (u += w && w[3] || (d.cssNumber[z] ? "" : "px")), !Y.clearCloneStyle && u === "" && s.indexOf("background") === 0 && (Z[s] = "inherit"), (!T || !("set" in T) || (u = T.set(r, u, p)) !== void 0) && (H ? Z.setProperty(s, u) : Z[s] = u)
            ...
            css: function(r, s, u, p) {
                var w, E, T, z = V(s),
                    H = It.test(s);
                return H || (s = Ce(z)), T = d.cssHooks[s] || d.cssHooks[z], T && "get" in T && (w = T.get(r, !0, u)), w === void 0 && (w = Ze(r, s, p)), w === "normal" && s in Un && (w = Un[s]), u === "" || u ? (E = parseFloat(w), u === !0 || isFinite(E) ? E || 0 : w) : w
            }
        }), d.each(["height", "width"], function(r, s) {
            d.cssHooks[s] = {
                get: function(u, p, w) {
                    if (p) return qe.test(d.css(u, "display")) && (!u.getClientRects().length || !u.getBoundingClientRect().width) ? zi(u, Wt, function() {
                        return Tr(u, s, w)
                    }) : Tr(u, s, w)
                },
                set: function(u, p, w) {
                    var E, T = Hn(u),
                        ...
                        le = w ? Gn(u, s, w, Z, T) : 0;
                    return Z && z && (le -= Math.ceil(u["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(T[s]) - Gn(u, s, "border", !1, T) - .5)), le && (E = yt.exec(p)) && (E[3] || "px") !== "px" && (u.style[s] = p, p = d.css(u, s)), Nn(u, p, le)
                }
            }
            ...
            css: function(r, s) {
                return g(this, function(u, p, w) {
                    var E, T, z = {},
                        H = 0;
                    if (Array.isArray(p)) {
                        for (E = Hn(u), T = p.length; H < T; H++) z[p[H]] = d.css(u, p[H], !1, E);
                        return z
                    }
        ...
        var Ft, Hi, Co = /^(?:toggle|show|hide)$/,
            Eo = /queueHooks$/;

        function Ar() {
            Hi && (P.hidden === !1 && e.requestAnimationFrame ? e.requestAnimationFrame(Ar) : e.setTimeout(Ar, d.fx.interval), d.fx.tick())
        }
        ...
        function xo(r, s, u) {
            var p, w, E, T, z, H, Z, le, be = "width" in s || "height" in s,
                ne = this,
                ce = {},
                Ge = r.style,
                rt = r.nodeType && j(r),
            ...
            for (p in s)
                ...
                for (p in ce) H || (je ? "hidden" in je && (rt = je.hidden) : je = he.access(r, "fxshow", {
                    display: Z
                }), E && (je.hidden = !rt), rt && G([r], !0), ne.done(function() {
        ...
        function ms(r, s) {
            var u, p, w, E, T;
            for (u in r)
                if (p = V(u), w = s[p], E = r[u], Array.isArray(E) && (w = E[1], E = r[u] = E[0]), u !== p && (r[p] = E, delete r[u]), T = d.cssHooks[p], T && "expand" in T) {
        ...
        function bn(r, s, u) {
            var p, w, E = 0,
                ...
                H = function() {
                    if (w) return !1;
                    for (var be = Ft || Or(), ne = Math.max(0, Z.startTime + Z.duration - be), ce = ne / Z.duration || 0, Ge = 1 - ce, rt = 0, je = Z.tweens.length; rt < je; rt++) Z.tweens[rt].run(Ge);
                ...
                stop: function(r, s, u) {
                    ...
                    return typeof r != "string" && (u = s, s = r, r = void 0), s && this.queue(r || "fx", []), this.each(function() {
                        ...
                        if (E) z[E] && z[E].stop && p(z[E]);
                            ...
                            for (E in z) z[E] && z[E].stop && Eo.test(E) && p(z[E]);
        ...
        d.fn.extend({
            ...
            attr: function(r, s, u) {
                ...
                if (!(E === 3 || E === 8 || E === 2)) {
                    ...
                    if ((E !== 1 || !d.isXMLDoc(r)) && (w = d.attrHooks[s.toLowerCase()] || (d.expr.match.bool.test(s) ? Rr : void 0)), u !== void 0) {
                        if (u === null) {
                            d.removeAttr(r, s);
                            return
                        }
            ...
            Ci[s] = function(p, w, E) {
                ...
                return E || (z = Ci[H], Ci[H] = T, T = u(p, w, E) != null ? H : null, Ci[H] = z), T
            }
        });
        ...
        d.fn.extend({
            ...
            toggleClass: function(r, s) {
                ...
                return typeof s == "boolean" && p ? s ? this.addClass(r) : this.removeClass(r) : re(r) ? this.each(function(w) {
                    ...
                    var w, E, T, z;
                    if (p)
                        for (E = 0, T = d(this), z = Ir(r); w = z[E++];) T.hasClass(w) ? T.removeClass(w) : T.addClass(w);
                ...
                select: {
                    get: function(r) {
                        var s, u, p, w = r.options,
                            ...
                            z = T ? null : [],
                            H = T ? E + 1 : w.length;
                        for (E < 0 ? p = H : p = T ? E : 0; p < H; p++)
                            if (u = w[p], (u.selected || p === E) && !u.disabled && (!u.parentNode.disabled || !K(u.parentNode, "optgroup"))) {
            ...
            trigger: function(r, s, u, p) {
                ...
                if (E = be = T = u = u || P, !(u.nodeType === 3 || u.nodeType === 8) && !Dr.test(ce + d.event.triggered) && (ce.indexOf(".") > -1 && (Ge = ce.split("."), ce = Ge.shift(), Ge.sort()), H = ce.indexOf(":") < 0 && "on" + ce, r = r[d.expando] ? r : new d.Event(ce, typeof r == "object" && r), r.isTrigger = p ? 2 : 3, r.namespace = Ge.join("."), r.rnamespace = r.namespace ? new RegExp("(^|\\.)" + Ge.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, r.result = void 0, r.target || (r.target = u), s = s == null ? [r] : d.makeArray(s, [r]), le = d.event.special[ce] || {}, !(!p && le.trigger && le.trigger.apply(u, s) === !1))) {
                    if (!p && !le.noBubble && !m(u)) {
                        for (z = le.delegateType || ce, Dr.test(z + ce) || (E = E.parentNode); E; E = E.parentNode) ne.push(E), T = E;
                        T === (u.ownerDocument || P) && ne.push(T.defaultView || T.parentWindow || e)
                    }
                    for (w = 0;
                        (E = ne[w++]) && !r.isPropagationStopped();) be = E, r.type = w > 1 ? z : le.bindType || ce, Z = (he.get(E, "events") || Object.create(null))[r.type] && he.get(E, "handle"), Z && Z.apply(E, s), Z = H && E[H], Z && Z.apply && te(E) && (r.result = Z.apply(E, s), r.result === !1 && r.preventDefault());
...
`) : r)), s
        ...
        function Lr(r, s, u, p) {
            ...
            if (Array.isArray(s)) d.each(s, function(E, T) {
                u || To.test(r) ? p(r, T) : Lr(r + "[" + (typeof T == "object" && T != null ? E : "") + "]", T, u, p)
            });
            else if (!u && se(s) === "object")
                for (w in s) Lr(r + "[" + w + "]", s[w], u, p);
            else p(r, s)
        }
...
`)
        ...
        function Po(r, s, u) {
            for (var p, w, E, T, z = r.contents, H = r.dataTypes; H[0] === "*";) H.shift(), p === void 0 && (p = r.mimeType || s.getResponseHeader("Content-Type"));
            if (p) {
                for (w in z)
                    if (z[w] && z[w].test(p)) {
                        H.unshift(w);
            ...
            if (E) return E !== H[0] && H.unshift(E), u[E]
        }
        ...
        function No(r, s, u, p) {
            ...
            for (E = le.shift(); E;)
                if (r.responseFields[E] && (u[r.responseFields[E]] = s), !H && p && r.dataFilter && (s = r.dataFilter(s, r.dataType)), H = E, E = le.shift(), E) {
                    if (E === "*") E = H;
                    else if (H !== "*" && H !== E) {
                        if (T = Z[H + " " + E] || Z["* " + E], !T) {
                            for (w in Z)
                                if (z = w.split(" "), z[1] === E && (T = Z[H + " " + z[0]] || Z["* " + z[0]], T)) {
                        ...
                        if (T !== !0)
                            if (T && r.throws) s = T(s);
                                ...
                                return {
                                    state: "parsererror",
                                    error: T ? be : "No conversion from " + H + " to " + E
                                }
                            }
                    }
                } return {
        ...
        d.extend({
            ...
            ajax: function(r, s) {
                ...
                var u, p, w, E, T, z, H, Z, le, be, ne = d.ajaxSetup({}, s),
                    ce = ne.context || ne,
                ...
                if (rt.promise(et), ne.url = ((r || ne.url || Ei.href) + "").replace(Lo, Ei.protocol + "//"), ne.type = s.method || s.type || ne.method || ne.type, ne.dataTypes = (ne.dataType || "*").toLowerCase().match(ke) || [""], ne.crossDomain == null) {
                    z = P.createElement("a");
                    try {
                ...
                if (ne.data && ne.processData && typeof ne.data != "string" && (ne.data = d.param(ne.data, ne.traditional)), Es(ws, ne, s, et), H) return et;
                Z = d.event && ne.global, Z && d.active++ === 0 && d.event.trigger("ajaxStart"), ne.type = ne.type.toUpperCase(), ne.hasContent = !Mo.test(ne.type), p = ne.url.replace(Io, ""), ne.hasContent ? ne.data && ne.processData && (ne.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (ne.data = ne.data.replace(Ro, "+")) : (be = ne.url.slice(p.length), ne.data && (ne.processData || typeof ne.data == "string") && (p += (Gi.test(p) ? "&" : "?") + ne.data, delete ne.data), ne.cache === !1 && (p = p.replace(Do, "$1"), be = (Gi.test(p) ? "&" : "?") + "_=" + Mr.guid++ + be), ne.url = p + be), ne.ifModified && (d.lastModified[p] && et.setRequestHeader("If-Modified-Since", d.lastModified[p]), d.etag[p] && et.setRequestHeader("If-None-Match", d.etag[p])), (ne.data && ne.hasContent && ne.contentType !== !1 || s.contentType) && et.setRequestHeader("Content-Type", ne.contentType), et.setRequestHeader("Accept", ne.dataTypes[0] && ne.accepts[ne.dataTypes[0]] ? ne.accepts[ne.dataTypes[0]] + (ne.dataTypes[0] !== "*" ? ", " + bs + "; q=0.01" : "") : ne.accepts["*"]);
                ...
                if (_t = "abort", je.add(ne.complete), et.done(ne.success), et.fail(ne.error), u = Es(Pr, ne, s, et), !u) on(-1, "No Transport");
                else {
        ...
        var Vo = {
            ...
            xi = d.ajaxSettings.xhr();
        Y.cors = !!xi && "withCredentials" in xi, Y.ajax = xi = !!xi, d.ajaxTransport(function(r) {
            var s, u;
            if (Y.cors || xi && !r.crossDomain) return {
                send: function(p, w) {
                    var E, T = r.xhr();
        ...
        d.ajaxSetup({
            ...
            var p, w, E, T = r.jsonp !== !1 && ($r.test(r.url) ? "url" : typeof r.data == "string" && (r.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && $r.test(r.data) && "data");
            if (T || r.dataTypes[0] === "jsonp") return p = r.jsonpCallback = re(r.jsonpCallback) ? r.jsonpCallback() : r.jsonpCallback, T ? r[T] = r[T].replace($r, "$1" + p) : r.jsonp !== !1 && (r.url += (Gi.test(r.url) ? "&" : "?") + r.jsonp + "=" + p), r.converters["script json"] = function() {
                ...
                w === void 0 ? d(e).removeProp(p) : e[p] = w, r[p] && (r.jsonpCallback = s.jsonpCallback, Br.push(p)), E && re(w) && w(E[0]), E = w = void 0
            }), "script"
            ...
            var p, w, E;
            return s || (Y.createHTMLDocument ? (s = P.implementation.createHTMLDocument(""), p = s.createElement("base"), p.href = P.location.href, s.head.appendChild(p)) : s = P), w = Fe.exec(r), E = !u && [], w ? [s.createElement(w[1])] : (w = In([r], s, E), E && E.length && d(E).remove(), d.merge([], w.childNodes))
            ...
            return z > -1 && (p = qn(r.slice(z)), r = r.slice(0, z)), re(s) ? (u = s, s = void 0) : s && typeof s == "object" && (w = "POST"), T.length > 0 && d.ajax({
                ...
                E = arguments, T.html(p ? d("<div>").append(d.parseHTML(H)).find(p) : H)
            }).always(u && function(H, Z) {
                T.each(function() {
                    u.apply(this, E || [H.responseText, Z, H])
                })
            }), this
            ...
            setOffset: function(r, s, u) {
                var p, w, E, T, z, H, Z, le = d.css(r, "position"),
                    be = d(r),
                    ne = {};
                le === "static" && (r.style.position = "relative"), z = be.offset(), E = d.css(r, "top"), H = d.css(r, "left"), Z = (le === "absolute" || le === "fixed") && (E + H).indexOf("auto") > -1, Z ? (p = be.position(), T = p.top, w = p.left) : (T = parseFloat(E) || 0, w = parseFloat(H) || 0), re(s) && (s = s.call(r, u, d.extend({}, z))), s.top != null && (ne.top = s.top - z.top + T), s.left != null && (ne.left = s.left - z.left + w), "using" in s ? s.using.call(r, ne) : be.css(ne)
            }
        }, d.fn.extend({
            offset: function(r) {
...
(function(t) {
    (function(e) {
        ...
        var S = function(x, l, g) {
            ...
            k = function(x, l, g) {
                i.each(l, function(_, O) {
                    i[O] && (x.prototype[O] = S(_, O, g))
                })
            },
            I = function(x, l) {
                return i.isFunction(x) ? x : i.isObject(x) && !l._isModel(x) ? D(x) : i.isString(x) ? function(g) {
                    return g.get(x)
                } : x
            },
            D = function(x) {
            ...
            $ = n.Events = {},
            J = /\s+/,
            ie = function(x, l, g, _, O) {
                var L = 0,
                    V;
                if (g && typeof g == "object")
                    for (_ !== void 0 && ("context" in O) && O.context === void 0 && (O.context = _), V = i.keys(g); L < V.length; L++) l = ie(x, l, V[L], g[V[L]], O);
                else if (g && J.test(g))
                    for (V = g.split(J); L < V.length; L++) l = x(l, V[L], _, O);
                else l = x(l, g, _, O);
                return l
            };
        $.on = function(x, l, g) {
        ...
        var Y = function(x, l, g, _, O) {
            if (x._events = ie(re, x._events || {}, l, g, {
                    context: _,
                    ctx: x,
                    listening: O
                }), O) {
                var L = x._listeners || (x._listeners = {});
                L[O.id] = O
            }
            return x
        };
        $.listenTo = function(x, l, g) {
            if (!x) return this;
            var _ = x._listenId || (x._listenId = i.uniqueId("l")),
            ...
            return Y(x, l, g, this, L), this
        };
        var re = function(x, l, g, _) {
            if (g) {
                var O = x[l] || (x[l] = []),
                    L = _.context,
                    V = _.ctx,
        ...
        $.off = function(x, l, g) {
            return this._events ? (this._events = ie(m, this._events, x, l, {
                context: g,
                listeners: this._listeners
            }), this) : this
        }, $.stopListening = function(x, l, g) {
            var _ = this._listeningTo;
            if (!_) return this;
            for (var O = x ? [x._listenId] : i.keys(_), L = 0; L < O.length; L++) {
                var V = _[O[L]];
                if (!V) break;
                V.obj.off(l, g, this)
            }
        ...
        var m = function(x, l, g, _) {
            if (!!x) {
                ...
                for (var he = l ? [l] : i.keys(x); O < he.length; O++) {
                    l = he[O];
                    var Ie = x[l];
                    if (!Ie) break;
                    for (var De = [], nt = 0; nt < Ie.length; nt++) {
                        var Ct = Ie[nt];
                        g && g !== Ct.callback && g !== Ct.callback._callback || V && V !== Ct.context ? De.push(Ct) : (L = Ct.listening, L && --L.count === 0 && (delete te[L.id], delete L.listeningTo[L.objId]))
                    }
                    De.length ? x[l] = De : delete x[l]
                }
                return x
            }
        };
        $.once = function(x, l, g) {
            var _ = ie(P, {}, x, l, i.bind(this.off, this));
            return typeof x == "string" && g == null && (l = void 0), this.on(_, l, g)
        }, $.listenToOnce = function(x, l, g) {
            var _ = ie(P, {}, l, g, i.bind(this.stopListening, this, x));
            return this.listenTo(x, _)
        };
        var P = function(x, l, g, _) {
            if (g) {
                var O = x[l] = i.once(function() {
        ...
        $.trigger = function(x) {
            ...
            return ie(q, this._events, x, void 0, g), this
        };
        var q = function(x, l, g, _) {
                if (x) {
                    var O = x[l],
                        L = x.all;
            ...
            ae = function(x, l) {
                ...
                switch (l.length) {
                    case 0:
                        for (; ++_ < O;)(g = x[_]).callback.call(g.ctx);
                        return;
                    case 1:
                        for (; ++_ < O;)(g = x[_]).callback.call(g.ctx, L);
                        return;
                    case 2:
                        for (; ++_ < O;)(g = x[_]).callback.call(g.ctx, L, V);
                        return;
                    case 3:
                        for (; ++_ < O;)(g = x[_]).callback.call(g.ctx, L, V, te);
                        return;
                    default:
                        for (; ++_ < O;)(g = x[_]).callback.apply(g.ctx, l);
                        return
                }
            };
        $.bind = $.on, $.unbind = $.off, i.extend(n, $);
        var se = n.Model = function(x, l) {
            var g = x || {};
        ...
        i.extend(se.prototype, $, {
            ...
            escape: function(x) {
                return i.escape(this.get(x))
            },
            has: function(x) {
                return this.get(x) != null
            },
            matches: function(x) {
                return !!i.iteratee(x, this)(this.attributes)
            },
            set: function(x, l, g) {
                if (x == null) return this;
                var _;
                if (typeof x == "object" ? (_ = x, g = l) : (_ = {})[x] = l, g || (g = {}), !this._validate(_, g)) return !1;
                var O = g.unset,
                    L = g.silent,
                    V = [],
                    te = this._changing;
            ...
            unset: function(x, l) {
                return this.set(x, void 0, i.extend({}, l, {
                    unset: !0
                }))
            },
            clear: function(x) {
                ...
                return this.set(l, i.extend({}, x, {
                    unset: !0
                }))
            },
            hasChanged: function(x) {
                return x == null ? !i.isEmpty(this.changed) : i.has(this.changed, x)
            },
            changedAttributes: function(x) {
                if (!x) return this.hasChanged() ? i.clone(this.changed) : !1;
            ...
            previous: function(x) {
                return x == null || !this._previousAttributes ? null : this._previousAttributes[x]
            },
            ...
            fetch: function(x) {
                ...
                var l = this,
                    g = x.success;
                return x.success = function(_) {
                    var O = x.parse ? l.parse(_, x) : _;
                    if (!l.set(O, x)) return !1;
                    g && g.call(x.context, l, _, x), l.trigger("sync", l, _, x)
                }, Gt(this, x), this.sync("read", this, x)
            },
            save: function(x, l, g) {
                var _;
                x == null || typeof x == "object" ? (_ = x, g = l) : (_ = {})[x] = l, g = i.extend({
                    validate: !0,
                    parse: !0
                }, g);
                var O = g.wait;
                ...
                g.success = function(Ie) {
                    ...
                    if (O && (De = i.extend({}, _, De)), De && !L.set(De, g)) return !1;
            ...
            destroy: function(x) {
                ...
                var l = this,
                    ...
                    _ = x.wait,
                    O = function() {
                        l.stopListening(), l.trigger("destroy", l, l.collection, x)
                    };
                x.success = function(V) {
                    _ && O(), g && g.call(x.context, l, V, x), l.isNew() || l.trigger("sync", l, V, x)
                };
                var L = !1;
                return this.isNew() ? i.defer(x.success) : (Gt(this, x), L = this.sync("delete", this, x)), _ || O(), L
            },
            url: function() {
                var x = i.result(this, "urlRoot") || i.result(this.collection, "url") || Bt();
                if (this.isNew()) return x;
                var l = this.get(this.idAttribute);
                return x.replace(/[^\/]$/, "$&/") + encodeURIComponent(l)
            },
            parse: function(x, l) {
                return x
            },
            ...
            isValid: function(x) {
                return this._validate({}, i.extend({}, x, {
                    validate: !0
                }))
            },
            _validate: function(x, l) {
                if (!l.validate || !this.validate) return !0;
                x = i.extend({}, this.attributes, x);
                var g = this.validationError = this.validate(x, l) || null;
        ...
        k(se, ve, "attributes");
        var d = n.Collection = function(x, l) {
                l || (l = {}), l.model && (this.model = l.model), l.comparator !== void 0 && (this.comparator = l.comparator), this._reset(), this.initialize.apply(this, arguments), x && this.reset(x, i.extend({
                    silent: !0
                }, l))
            },
            xe = {
            ...
            Le = function(x, l, g) {
                g = Math.min(Math.max(g, 0), x.length);
                var _ = Array(x.length - g),
                    O = l.length,
                    L;
                for (L = 0; L < _.length; L++) _[L] = x[L + g];
                for (L = 0; L < O; L++) x[L + g] = l[L];
                for (L = 0; L < _.length; L++) x[L + O + g] = _[L]
            };
        i.extend(d.prototype, $, {
            ...
            set: function(x, l) {
                if (x != null) {
                    l = i.extend({}, xe, l), l.parse && !this._isModel(x) && (x = this.parse(x, l) || []);
                    var g = !i.isArray(x);
                    x = g ? [x] : x.slice();
                    var _ = l.at;
                    ...
                    var O = [],
                        ...
                        lt, yt;
                    for (yt = 0; yt < x.length; yt++) {
                        lt = x[yt];
                        var bt = this.get(lt);
                        if (bt) {
                            if (Ie && lt !== bt) {
                                var Jt = this._isModel(lt) ? lt.attributes : lt;
                                l.parse && (Jt = bt.parse(Jt, l)), bt.set(Jt, l), V.push(bt), Ct && !nt && (nt = bt.hasChanged(rn))
                            }
                            Se[bt.cid] || (Se[bt.cid] = !0, O.push(bt)), x[yt] = bt
                        } else he && (lt = x[yt] = this._prepareModel(lt, l), lt && (L.push(lt), this._addReference(lt, l), Se[lt.cid] = !0, O.push(lt)))
                    }
                    if (De) {
                        for (yt = 0; yt < this.length; yt++) lt = this.models[yt], Se[lt.cid] || te.push(lt);
                        te.length && this._removeModels(te, l)
                    }
                    var Je = !1,
                        Lt = !Ct && he && De;
                    if (O.length && Lt ? (Je = this.length !== O.length || i.some(this.models, function(j, N) {
                            return j !== O[N]
                        }), this.models.length = 0, Le(this.models, O, 0), this.length = this.models.length) : L.length && (Ct && (nt = !0), Le(this.models, L, _ == null ? this.length : _), this.length = this.models.length), nt && this.sort({
                            silent: !0
                        }), !l.silent) {
                        for (yt = 0; yt < L.length; yt++) _ != null && (l.index = _ + yt), lt = L[yt], lt.trigger("add", lt, this, l);
                        (nt || Je) && this.trigger("sort", this, l), (L.length || te.length || V.length) && (l.changes = {
                            added: L,
                            removed: te,
                            merged: V
            ...
            reset: function(x, l) {
                ...
                return l.previousModels = this.models, this._reset(), x = this.add(x, i.extend({
                    silent: !0
                }, l)), l.silent || this.trigger("reset", this, l), x
            },
            push: function(x, l) {
                return this.add(x, i.extend({
                    at: this.length
                }, l))
            },
            pop: function(x) {
                var l = this.at(this.length - 1);
                return this.remove(l, x)
            },
            unshift: function(x, l) {
                return this.add(x, i.extend({
                    at: 0
                }, l))
            },
            ...
            get: function(x) {
                if (x != null) return this._byId[x] || this._byId[this.modelId(x.attributes || x)] || x.cid && this._byId[x.cid]
            },
            has: function(x) {
                return this.get(x) != null
            },
            at: function(x) {
                return x < 0 && (x += this.length), this.models[x]
            },
            where: function(x, l) {
                return this[l ? "find" : "filter"](x)
            },
            findWhere: function(x) {
                return this.where(x, !0)
            },
            sort: function(x) {
                ...
                x || (x = {});
                var g = l.length;
                return i.isFunction(l) && (l = i.bind(l, this)), g === 1 || i.isString(l) ? this.models = this.sortBy(l) : this.models.sort(l), x.silent || this.trigger("sort", this, x), this
            },
            pluck: function(x) {
                return this.map(x + "")
            },
            fetch: function(x) {
                ...
                var l = x.success,
                    g = this;
                return x.success = function(_) {
                    var O = x.reset ? "reset" : "set";
                    g[O](_, x), l && l.call(x.context, g, _, x), g.trigger("sync", g, _, x)
                }, Gt(this, x), this.sync("read", this, x)
            },
            create: function(x, l) {
                l = l ? i.clone(l) : {};
                var g = l.wait;
                if (x = this._prepareModel(x, l), !x) return !1;
                g || this.add(x, l);
                var _ = this,
                    O = l.success;
                return l.success = function(L, V, te) {
                    g && _.add(L, te), O && O.call(te.context, L, V, te)
                }, x.save(null, l), x
            },
            parse: function(x, l) {
                return x
            ...
            modelId: function(x) {
                return x[this.model.prototype.idAttribute || "id"]
            },
            _reset: function() {
                this.length = 0, this.models = [], this._byId = {}
            },
            _prepareModel: function(x, l) {
                if (this._isModel(x)) return x.collection || (x.collection = this), x;
                l = l ? i.clone(l) : {}, l.collection = this;
                var g = new this.model(x, l);
                return g.validationError ? (this.trigger("invalid", this, g.validationError, l), !1) : g
            },
            _removeModels: function(x, l) {
                for (var g = [], _ = 0; _ < x.length; _++) {
                    var O = this.get(x[_]);
                    if (!!O) {
            ...
            _addReference: function(x, l) {
                this._byId[x.cid] = x;
                var g = this.modelId(x.attributes);
                g != null && (this._byId[g] = x), x.on("all", this._onModelEvent, this)
            },
            _removeReference: function(x, l) {
                delete this._byId[x.cid];
                var g = this.modelId(x.attributes);
                g != null && delete this._byId[g], this === x.collection && delete x.collection, x.off("all", this._onModelEvent, this)
            },
            _onModelEvent: function(x, l, g, _) {
                if (l) {
                    if ((x === "add" || x === "remove") && g !== this) return;
                    if (x === "destroy" && this.remove(l, _), x === "change") {
        ...
        k(d, at, "models");
        var Be = n.View = function(x) {
                this.cid = i.uniqueId("view"), i.extend(this, i.pick(x, Fe)), this._ensureElement(), this.initialize.apply(this, arguments)
            },
            K = /^(\S+)\s*(.*)$/,
        ...
        i.extend(Be.prototype, $, {
            ...
            setElement: function(x) {
                return this.undelegateEvents(), this._setElement(x), this.delegateEvents(), this
            },
            _setElement: function(x) {
                this.$el = x instanceof n.$ ? x : n.$(x), this.el = this.$el[0]
            },
            delegateEvents: function(x) {
                if (x || (x = i.result(this, "events")), !x) return this;
            ...
            delegate: function(x, l, g) {
                return this.$el.on(x + ".delegateEvents" + this.cid, l, g), this
            },
            undelegateEvents: function() {
                return this.$el && this.$el.off(".delegateEvents" + this.cid), this
            },
            undelegate: function(x, l, g) {
                return this.$el.off(x + ".delegateEvents" + this.cid, l, g), this
            },
            _createElement: function(x) {
                return document.createElement(x)
            },
            _ensureElement: function() {
                if (this.el) this.setElement(i.result(this, "el"));
                else {
                    var x = i.extend({}, i.result(this, "attributes"));
                    this.id && (x.id = i.result(this, "id")), this.className && (x.class = i.result(this, "className")), this.setElement(this._createElement(i.result(this, "tagName"))), this._setAttributes(x)
                }
            },
            _setAttributes: function(x) {
                this.$el.attr(x)
            }
        }), n.sync = function(x, l, g) {
            var _ = U[x];
            i.defaults(g || (g = {}), {
            ...
            if (g.url || (O.url = i.result(l, "url") || Bt()), g.data == null && l && (x === "create" || x === "update" || x === "patch") && (O.contentType = "application/json", O.data = JSON.stringify(g.attrs || l.toJSON(g))), g.emulateJSON && (O.contentType = "application/x-www-form-urlencoded", O.data = O.data ? {
                    model: O.data
        ...
        var oe = n.Router = function(x) {
                x || (x = {}), x.routes && (this.routes = x.routes), this._bindRoutes(), this.initialize.apply(this, arguments)
            },
            Te = /\((.*?)\)/g,
            we = /(\(\?)?:\w+/g,
            ye = /\*\w+/g,
        ...
        i.extend(oe.prototype, $, {
            initialize: function() {},
            route: function(x, l, g) {
                i.isRegExp(x) || (x = this._routeToRegExp(x)), i.isFunction(l) && (g = l, l = ""), g || (g = this[l]);
                var _ = this;
                return n.history.route(x, function(O) {
                    var L = _._extractParameters(x, O);
                    _.execute(g, L, l) !== !1 && (_.trigger.apply(_, ["route:" + l].concat(L)), _.trigger("route", l, L), n.history.trigger("route", _, l, L))
                }), this
            },
            execute: function(x, l, g) {
                x && x.apply(this, l)
            },
            navigate: function(x, l) {
                return n.history.navigate(x, l), this
            },
            _bindRoutes: function() {
                if (!!this.routes) {
                    this.routes = i.result(this, "routes");
                    for (var x, l = i.keys(this.routes);
                        (x = l.pop()) != null;) this.route(x, this.routes[x])
                }
            },
            _routeToRegExp: function(x) {
                return x = x.replace(ue, "\\$&").replace(Te, "(?:$1)?").replace(we, function(l, g) {
                    return g ? l : "([^/?]+)"
                }).replace(ye, "([^?]*?)"), new RegExp("^" + x + "(?:\\?([\\s\\S]*))?$")
            },
            _extractParameters: function(x, l) {
                var g = x.exec(l).slice(1);
        ...
        _e.started = !1, i.extend(_e.prototype, $, {
            interval: 50,
            atRoot: function() {
                var x = this.location.pathname.replace(/[^\/]$/, "$&/");
                return x === this.root && !this.getSearch()
            },
            matchRoot: function() {
                var x = this.decodeFragment(this.location.pathname),
                    l = x.slice(0, this.root.length - 1) + "/";
                return l === this.root
            },
            decodeFragment: function(x) {
                return decodeURI(x.replace(/%25/g, "%2525"))
            },
            getSearch: function() {
                var x = this.location.href.replace(/#.*/, "").match(/\?.+/);
                return x ? x[0] : ""
            },
            getHash: function(x) {
                var l = (x || this).location.href.match(/#(.*)$/);
                return l ? l[1] : ""
            },
            getPath: function() {
                var x = this.decodeFragment(this.location.pathname + this.getSearch()).slice(this.root.length - 1);
                return x.charAt(0) === "/" ? x.slice(1) : x
            },
            getFragment: function(x) {
                return x == null && (this._usePushState || !this._wantsHashChange ? x = this.getPath() : x = this.getHash()), x.replace(ke, "")
            },
            start: function(x) {
                if (_e.started) throw new Error("Backbone.history has already been started");
                if (_e.started = !0, this.options = i.extend({
                        root: "/"
                    }, this.options, x), this.root = this.options.root, this._wantsHashChange = this.options.hashChange !== !1, this._hasHashChange = "onhashchange" in window && (document.documentMode === void 0 || document.documentMode > 7), this._useHashChange = this._wantsHashChange && this._hasHashChange, this._wantsPushState = !!this.options.pushState, this._hasPushState = !!(this.history && this.history.pushState), this._usePushState = this._wantsPushState && this._hasPushState, this.fragment = this.getFragment(), this.root = ("/" + this.root + "/").replace($e, "/"), this._wantsHashChange && this._wantsPushState)
            ...
            stop: function() {
                var x = window.removeEventListener || function(l, g) {
                    return detachEvent("on" + l, g)
                };
                this._usePushState ? x("popstate", this.checkUrl, !1) : this._useHashChange && !this.iframe && x("hashchange", this.checkUrl, !1), this.iframe && (document.body.removeChild(this.iframe), this.iframe = null), this._checkUrlInterval && clearInterval(this._checkUrlInterval), _e.started = !1
            },
            route: function(x, l) {
            ...
            loadUrl: function(x) {
                return this.matchRoot() ? (x = this.fragment = this.getFragment(x), i.some(this.handlers, function(l) {
                    if (l.route.test(x)) return l.callback(x), !0
                })) : !1
            },
            navigate: function(x, l) {
                ...
                (!l || l === !0) && (l = {
                    trigger: !!l
                }), x = this.getFragment(x || "");
                var g = this.root;
                (x === "" || x.charAt(0) === "?") && (g = g.slice(0, -1) || "/");
                var _ = g + x;
                if (x = this.decodeFragment(x.replace(Ke, "")), this.fragment !== x) {
                    if (this.fragment = x, this._usePushState) this.history[l.replace ? "replaceState" : "pushState"]({}, document.title, _);
                    else if (this._wantsHashChange) {
                        if (this._updateHash(this.location, x, l.replace), this.iframe && x !== this.getHash(this.iframe.contentWindow)) {
                            var O = this.iframe.contentWindow;
                            l.replace || (O.document.open(), O.document.close()), this._updateHash(O.location, x, l.replace)
                        }
                    } else return this.location.assign(_);
                    if (l.trigger) return this.loadUrl(x)
                }
            },
            _updateHash: function(x, l, g) {
                if (g) {
                    var _ = x.href.replace(/(javascript:|#).*$/, "");
                    x.replace(_ + "#" + l)
                } else x.hash = "#" + l
            }
        }), n.history = new _e;
        var dt = function(x, l) {
            var g = this,
                _;
            return x && i.has(x, "constructor") ? _ = x.constructor : _ = function() {
                return g.apply(this, arguments)
            }, i.extend(_, g, l), _.prototype = i.create(g.prototype, x), _.prototype.constructor = _, _.__super__ = g.prototype, _
        };
        ...
        var Bt = function() {
            ...
            Gt = function(x, l) {
                var g = l.error;
                l.error = function(_) {
                    g && g.call(l.context, x, _, l), x.trigger("error", x, _, l)
                }
            };
        return n
    })
    ...
    return ml || (ml = 1, function(t, e) {
        (function(n, i) {
            ...
            v._eventsApi = function(m, P, q, ae) {
                ...
                if (S.test(q)) {
                    for (var xe = q.split(S), Ae = 0, Le = xe.length; Ae < Le; Ae++) se[xe[Ae]] = m[P].apply(m, [xe[Ae]].concat(ae));
                    return se
                }
                return !1
            ...
            function I(m, P, q, ae) {
                m || (m = {});
                for (var se = P ? [P] : n.keys(m), ve = !1, d = 0, xe = se.length; d < xe; d++) P = se[d], !!m[P] && k(m, P, q, ae) && (ve = !0);
                return ve
            }
            var D = {};
...
(function(t, e) {
    (function(n, i) {
        ...
        g.extend = S, i.extend(g.prototype, n.Events, Gt, x, {
            cidPrefix: "mno",
            _isDestroyed: !1,
        ...
        i.extend(ji.prototype, Se, lt, Je);
...
yr.prototype.clear = Bh;
yr.prototype.delete = $h;
yr.prototype.get = jh;
yr.prototype.has = Fh;
yr.prototype.set = zh;
var uo = yr,
...
var Jh = Kh,
    ...
    vl = Ec,
    xc = Object.prototype,
    rd = xc.hasOwnProperty,
    sd = xc.toString,
    Wr = vl ? vl.toStringTag : void 0;
...
function md(t) {
    return t == null ? t === void 0 ? gd : pd : wl && wl in Object(t) ? dd(t) : fd(t)
}
var ho = md;
...
var Md = Dd,
    ...
    Ud = RegExp("^" + zd.call(Hd).replace(Bd, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
...
br.prototype.clear = xf;
br.prototype.delete = _f;
br.prototype.get = Sf;
br.prototype.has = kf;
br.prototype.set = Tf;
var Af = br,
...
function Wp(t) {
    return typeof t.constructor == "function" && !qp(t) ? Up(Gp(t)) : {}
}
var Xp = Wp;
...
function Sg(t) {
    ...
    return typeof n == "function" && n instanceof n && Mc.call(n) == _g
}
var kg = Sg,
    Tg = ho,
    Ag = Dc,
    ...
    Mt = {};
Mt[Gg] = Mt[qg] = Mt[Wg] = Mt[Xg] = Mt[Yg] = Mt[Kg] = Mt[Jg] = Mt[Qg] = Mt[Zg] = !0;
Mt[Rg] = Mt[Ig] = Mt[Hg] = Mt[Dg] = Mt[Ug] = Mt[Mg] = Mt[Lg] = Mt[Pg] = Mt[Ng] = Mt[Vg] = Mt[Bg] = Mt[$g] = Mt[jg] = Mt[Fg] = Mt[zg] = !1;

function em(t) {
    return Og(t) && Ag(t.length) && !!Mt[Tg(t)]
}
var tm = em;
...
function mm(t, e, n, i) {
    ...
    for (var f = -1, v = e.length; ++f < v;) {
        ...
        k === void 0 && (k = t[S]), a ? gm(n, S, k) : pm(n, S, k)
    }
    return n
}
var vm = mm;
...
function Im(t, e) {
    var n = Sm(t),
        ...
        k = S.length;
    for (var I in t)(e || Rm.call(t, I)) && !(v && (I == "length" || a && (I == "offset" || I == "parent") || f && (I == "buffer" || I == "byteLength" || I == "byteOffset") || Tm(I, k))) && S.push(I);
    return S
}
var Dm = Im;
...
function av(t, e, n, i, a, f, v) {
    ...
    if ($) {
        var J = Il(k),
            ie = !J && tv(k),
            Y = !J && !ie && sv(k);
        D = k, J || ie || Y ? Il(S) ? D = S : ev(S) ? D = Qm(S) : ie ? ($ = !1, D = Km(k, !0)) : Y ? ($ = !1, D = Jm(k, !0)) : D = [] : rv(k) || Rl(k) ? (D = S, Rl(S) ? D = ov(S) : (!iv(S) || nv(S)) && (D = Zm(k))) : $ = !1
    }
    $ && (v.set(k, D), a(D, k, i, f, v), v.delete(k)), Ol(t, n, D)
}
var lv = av,
    cv = fp,
    uv = kc,
...
function Bc(t, e, n, i, a) {
    t !== e && hv(e, function(f, v) {
        if (a || (a = new cv), fv(f)) dv(t, e, v, n, Bc, i, a);
        else {
            var S = i ? i(gv(t, v), f, v + "", t, e, a) : void 0;
            S === void 0 && (S = f), uv(t, v, S)
        }
    }, pv)
}
var mv = Bc;
...
function Cv(t, e, n) {
    return e = Ml(e === void 0 ? t.length - 1 : e, 0),
        function() {
            for (var i = arguments, a = -1, f = Ml(i.length - e, 0), v = Array(f); ++a < f;) v[a] = i[e + a];
            a = -1;
            for (var S = Array(e + 1); ++a < e;) S[a] = i[a];
            return S[e] = n(v), bv(t, this, S)
        }
}
var Ev = Cv;
...
function Wv(t, e, n) {
    if (!qv(n)) return !1;
    var i = typeof e;
    return (i == "number" ? Uv(n) && Gv(e, n.length) : i == "string" && e in n) ? Hv(n[e], t) : !1
}
var Xv = Wv,
    Yv = zv,
    Kv = Xv;
...
function Jv(t) {
    return Yv(function(e, n) {
        var i = -1,
            ...
            f = a > 1 ? n[a - 1] : void 0,
            v = a > 2 ? n[2] : void 0;
        for (f = t.length > 3 && typeof f == "function" ? (a--, f) : void 0, v && Kv(n[0], n[1], v) && (f = a < 3 ? void 0 : f, a = 1), e = Object(e); ++i < a;) {
            var S = n[i];
            S && t(e, S, i, f)
        }
        return e
...
let Kt = pl;
st(Kt, "queryParams", new URLSearchParams(window.location.search)), st(Kt, "getQueryParam", e => pl.queryParams.get(e)), st(Kt, "sleep", e => new Promise(n => {
    ...
    (function(f) {
        (function(v) {
            ...
            function Ae(U, oe) {
                ...
                if (this.credentials = oe.credentials || this.credentials || "same-origin", (oe.headers || !this.headers) && (this.headers = new Y(oe.headers)), this.method = xe(oe.method || this.method || "GET"), this.mode = oe.mode || this.mode || null, this.signal = oe.signal || this.signal, this.referrer = null, (this.method === "GET" || this.method === "HEAD") && Te) throw new TypeError("Body not allowed for GET or HEAD requests");
                this._initBody(Te)
            }
...
var iy = function() {
    ...
    ry = iy,
    sy = function() {
        return typeof Pl != "function" || typeof Symbol != "function" || typeof Pl("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : ry()
    },
...
var na = function() {
    ...
    Cy = function(e) {
        ...
        var a = [];
        return Vl(e, wy, function(f, v, S, k) {
            a[a.length] = S ? Vl(k, by, "$1") : v || f
        }), a
    },
    Ey = function(e, n) {
        var i = e,
            a;
        if (Qs(Nl, i) && (a = Nl[i], i = "%" + a[0] + "%"), Qs(ur, i)) {
            var f = ur[i];
            if (f === sr && (f = gy(i)), typeof f > "u" && !n) throw new cr("intrinsic " + e + " exists, but is not available. Please file an issue!");
            return {
                alias: a,
                name: i,
                value: f
    ...
    Ha = function(e, n) {
        ...
        if (yy(/^%?[^%]*%?$/g, e) === null) throw new pr("`%` may not be present anywhere but at the beginning and end of the intrinsic name");
        var i = Cy(e),
            a = i.length > 0 ? i[0] : "",
            f = Ey("%" + a + "%", n),
            v = f.name,
        ...
        for (var D = 1, $ = !0; D < i.length; D += 1) {
            ...
            if ((J === "constructor" || !$) && (k = !0), a += "." + J, v = "%" + a + "%", Qs(ur, v)) S = ur[v];
            else if (S != null) {
                if (!(J in S)) {
...
var zc = Ha,
    Hc = Fc.exports,
    xy = Hc(zc("String.prototype.indexOf")),
    _y = function(e, n) {
        var i = zc(e, !!n);
        return typeof i == "function" && xy(e, ".prototype.") > -1 ? Hc(i) : i
    };
const Sy = {},
...
var Ua = typeof Map == "function" && Map.prototype,
    ...
    es = Ry ? WeakMap.prototype.has : null,
    Iy = typeof WeakSet == "function" && WeakSet.prototype,
    ts = Iy ? WeakSet.prototype.has : null,
    Dy = typeof WeakRef == "function" && WeakRef.prototype,
    Bl = Dy ? WeakRef.prototype.deref : null,
...
function Hl(t, e) {
    if (t === 1 / 0 || t === -1 / 0 || t !== t || t && t > -1e3 && t < 1e3 || Uc.call(/e/, e)) return e;
...
var Ta = Ty,
    ...
    $y = function t(e, n, i, a) {
        ...
        if (Wc(e)) {
            var re = gr ? hi.call(String(e), /^(Symbol\(.*\))_[^)]*$/, "$1") : ka.call(e);
            return typeof e == "object" && !gr ? Xr(re) : re
        }
        if (ew(e)) {
            for (var m = "<" + $l.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + qc(jy(P[q].value), "double", f);
            return m += ">", e.childNodes && e.childNodes.length && (m += "..."), m += "</" + $l.call(String(e.nodeName)) + ">", m
        }
        if (Aa(e)) {
            if (e.length === 0) return "[]";
            var ae = Ps(e, J);
            return $ && !nw(ae) ? "[" + Oa(ae, $) + "]" : "[ " + jn.call(ae, ", ") + " ]"
        }
        if (zy(e)) {
            var se = Ps(e, J);
            return !("cause" in Error.prototype) && "cause" in e && !Gc.call(e, "cause") ? "{ [" + String(e) + "] " + jn.call(jl.call("[cause]: " + J(e.cause), se), ", ") + " }" : se.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + jn.call(se, ", ") + " }"
        }
        ...
        if (Yy(e)) {
            var ve = [];
            return Ay.call(e, function(Fe, U) {
        ...
        if (Ky(e)) return oa("WeakMap");
        if (Zy(e)) return oa("WeakSet");
        if (Jy(e)) return oa("WeakRef");
        if (Uy(e)) return Xr(J(Number(e)));
        if (qy(e)) return Xr(J(Sa.call(e)));
        if (Gy(e)) return Xr(My.call(e));
        if (Hy(e)) return Xr(J(String(e)));
        if (!Fy(e) && !ql(e)) {
            var xe = Ps(e, J),
                Ae = zl ? zl(e) === Object.prototype : e instanceof Object || e.constructor === Object,
                Le = e instanceof Object ? "" : "null prototype",
                at = !Ae && cn && Object(e) === e && cn in e ? qa.call(pi(e), 8, -1) : Le ? "Object" : "",
                Be = Ae || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "",
                K = Be + (at || Le ? "[" + jn.call(jl.call([], at || [], Le || []), ": ") + "] " : "");
            return xe.length === 0 ? K + "{}" : $ ? K + "{" + Oa(xe, $) + "}" : K + "{ " + jn.call(xe, ", ") + " }"
        }
        return String(e)
    };
...
function Yc(t, e) {
    if (t.length > e.maxStringLength) {
        ...
        return Yc(qa.call(t, 0, e.maxStringLength), e) + i
    }
...
function Ps(t, e) {
    ...
    for (var k in t) !li(t, k) || n && String(Number(k)) === k && k < t.length || gr && v["$" + k] instanceof Symbol || (Uc.call(/[^\w$]/, k) ? i.push(e(k, t) + ": " + e(t[k], t)) : i.push(k + ": " + e(t[k], t)));
...
var Wa = Ha,
    ...
    Ns = Wa("%WeakMap%", !0),
    Vs = Wa("%Map%", !0),
    ow = xr("WeakMap.prototype.get", !0),
    aw = xr("WeakMap.prototype.set", !0),
    lw = xr("WeakMap.prototype.has", !0),
    cw = xr("Map.prototype.get", !0),
    uw = xr("Map.prototype.set", !0),
    hw = xr("Map.prototype.has", !0),
    Xa = function(t, e) {
        for (var n = t, i;
            (i = n.next) !== null; n = i)
    ...
    gw = function() {
        var e, n, i, a = {
            ...
            set: function(f, v) {
                Ns && f && (typeof f == "object" || typeof f == "function") ? (e || (e = new Ns), aw(e, f, v)) : Vs ? (n || (n = new Vs), uw(n, f, v)) : (i || (i = {
                    key: {},
                    next: null
                }), fw(i, f, v))
            }
    ...
    bw = function t(e, n, i) {
        ...
        var a = e;
        return Di(e) && !Di(n) && (a = Kc(e, i)), Di(e) && Di(n) ? (n.forEach(function(f, v) {
            if (la.call(e, v)) {
                var S = e[v];
            ...
            var S = n[v];
            return la.call(f, v) ? f[v] = t(f[v], S, i) : f[v] = S, f
        }, a)
    },
    Cw = function(e, n) {
    ...
    Lw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        ...
        if (typeof k == "function" ? P = k(n, P) : P instanceof Date ? P = $(P) : i === "comma" && ei(P) && (P = Ra.maybeMap(P, function(ue) {
        ...
        if (Mw(P) || Ra.isBuffer(P)) {
            if (S) {
                ...
                if (i === "comma" && Y) {
                    for (var xe = Rw.call(String(P), ","), Ae = "", Le = 0; Le < xe.length; ++Le) Ae += (Le === 0 ? "" : ",") + ie(S(xe[Le], nn.encoder, re, "value", J));
                    return [ie(d) + (a && ei(P) && xe.length === 1 ? "[]" : "") + "=" + Ae]
                }
        ...
        for (var Fe = a && ei(P) && P.length === 1 ? n + "[]" : n, U = 0; U < Be.length; ++U) {
            ...
            if (!(v && Te === null)) {
                ...
                m.set(e, ae);
                var ye = Qc();
                ye.set(ca, m), Zc(at, t(Te, we, i, a, f, v, S, k, I, D, $, J, ie, Y, re, ye))
            }
        }
        return at
    },
    Pw = function(e) {
        ...
        if (typeof e.format < "u") {
            if (!Ow.call(ns.formatters, e.format)) throw new TypeError("Unknown format option provided.");
            i = e.format
        }
    ...
    Nw = function(t, e) {
        ...
        for (var D = Qc(), $ = 0; $ < a.length; ++$) {
            var J = a[$];
            i.skipNulls && n[J] === null || Zc(v, Lw(n[J], J, k, I, i.strictNullHandling, i.skipNulls, i.encode ? i.encoder : null, i.filter, i.sort, i.allowDots, i.serializeDate, i.format, i.formatter, i.encodeValuesOnly, i.charset, D))
        }
    ...
    Fw = function(e, n) {
        ...
        if (n.charsetSentinel)
            for (k = 0; k < v.length; ++k) v[k].indexOf("utf8=") === 0 && (v[k] === jw ? I = "utf-8" : v[k] === $w && (I = "iso-8859-1"), S = k, k = v.length);
        for (k = 0; k < v.length; ++k)
            if (k !== S) {
                var D = v[k],
                    ...
                    J = $ === -1 ? D.indexOf("=") : $ + 1,
                    ie, Y;
                J === -1 ? (ie = n.decoder(D, Zt.decoder, I, "key"), Y = n.strictNullHandling ? null : "") : (ie = n.decoder(D.slice(0, J), Zt.decoder, I, "key"), Y = mr.maybeMap(eu(D.slice(J + 1), n), function(re) {
                    return n.decoder(re, Zt.decoder, I, "value")
                })), Y && n.interpretNumericEntities && I === "iso-8859-1" && (Y = Bw(Y)), D.indexOf("[]=") > -1 && (Y = Vw(Y) ? [Y] : Y), Ia.call(i, ie) ? i[ie] = mr.combine(i[ie], Y) : i[ie] = Y
            } return i
    },
    zw = function(t, e, n, i) {
...
var sb = or,
    ...
    Jl = hr && typeof hr.apply == "function" ? hr.apply : function(e, n, i) {
        return Function.prototype.apply.call(e, n, i)
    },
    Us;
hr && typeof hr.ownKeys == "function" ? Us = hr.ownKeys : Object.getOwnPropertySymbols ? Us = function(e) {
...
Rt.prototype.emit = function(e) {
    ...
    if (typeof k == "function") Jl(k, this, n);
        ...
        for (var I = k.length, D = lu(k, I), i = 0; i < I; ++i) Jl(D[i], this, n);
    return !0
};
...
function ru(t, e, n, i) {
    ...
    if (mo(n), f = t._events, f === void 0 ? (f = t._events = Object.create(null), t._eventsCount = 0) : (f.newListener !== void 0 && (t.emit("newListener", e, n.listener ? n.listener : n), f = t._events), v = f[e]), v === void 0) v = f[e] = n, ++t._eventsCount;
    else if (typeof v == "function" ? v = f[e] = i ? [n, v] : [v, n] : i ? v.unshift(n) : v.push(n), a = iu(t), a > 0 && v.length > a && !v.warned) {
        v.warned = !0;
        ...
        S.name = "MaxListenersExceededWarning", S.emitter = t, S.type = e, S.count = v.length, ob(S)
    }
    return t
}
...
Rt.prototype.once = function(e, n) {
    return mo(n), this.on(e, su(this, e, n)), this
};
Rt.prototype.prependOnceListener = function(e, n) {
    return mo(n), this.prependListener(e, su(this, e, n)), this
};
Rt.prototype.removeListener = function(e, n) {
    ...
    if (i === n || i.listener === n) --this._eventsCount === 0 ? this._events = Object.create(null) : (delete a[e], a.removeListener && this.emit("removeListener", e, i.listener || n));
        ...
        f === 0 ? i.shift() : lb(i, f), i.length === 1 && (a[e] = i[0]), a.removeListener !== void 0 && this.emit("removeListener", e, S || n)
    }
    return this
};
    ...
    connect() {
        ...
        return new Promise((a, f) => {
            ...
            this.conn = new tc(i, "ecast-v0"), this.conn.onmessage = D => {
                ...
                const $ = L0(D);
                if ($ instanceof I0) this.onReply($);
                else if ($ instanceof nc) {
                    if ($.result instanceof T0) S = !0, this.id = $.result.id, this.deviceId = $.result.deviceId, this.entities = $.result.entities, this.secret = $.result.secret, $.result.name && (this.name = $.result.name), k($.result);
                    else if (!v) {
                        I($.result);
                        return
                    }
...
(function(t, e) {
    (function(n, i) {
        ...
        function D(j, N) {
            ...
            for (G in j)
                if (f.call(j, G)) {
                    if (M = j[G], !M && (M === null || M === v || isNaN(M)) && (M = ""), G = k(G), M = k(M), G === null || M === null) continue;
                    W.push(G + "=" + M)
        ...
        function ve(j) {
            ...
            var M = {},
                G = typeof j,
                fe;
            if (j.protocol === "blob:") M = new Le(unescape(j.pathname), {});
            else if (G === "string") {
                M = new Le(j, {});
        ...
        function xe(j, N) {
            ...
            var W = re.exec(j),
                ...
                pe = 0,
                Pe;
            return G ? fe ? (Pe = W[2] + W[3] + W[4], pe = W[2].length + W[3].length) : (Pe = W[2] + W[4], pe = W[2].length) : fe ? (Pe = W[3] + W[4], pe = W[3].length) : Pe = W[4], M === "file:" ? pe >= 2 && (Pe = Pe.slice(2)) : d(M) ? Pe = W[4] : M ? G && (Pe = Pe.slice(2)) : pe >= 2 && d(N.protocol) && (Pe = W[4]), {
                protocol: M,
                slashes: G || d(M),
                slashesCount: pe,
                rest: Pe
        ...
        function Ae(j, N) {
            if (j === "") return N;
            for (var W = (N || "/").split("/").slice(0, -1).concat(j.split("/")), M = W.length, G = W[M - 1], fe = !1, pe = 0; M--;) W[M] === "." ? W.splice(M, 1) : W[M] === ".." ? (W.splice(M, 1), pe++) : pe && (M === 0 && (fe = !0), W.splice(M, 1), pe--);
            return fe && W.unshift(""), (G === "." || G === "..") && W.push(""), W.join("/")
        }

        function Le(j, N, W) {
            if (j = q(j), !(this instanceof Le)) return new Le(j, N, W);
            var M, G, fe, pe, Pe, Ve, pt = ae.slice(),
                jt = typeof N,
                Ye = this,
                In = 0;
            for (jt !== "object" && jt !== "string" && (W = N, N = null), W && typeof W != "function" && (W = ie.parse), N = ve(N), G = xe(j || "", N), M = !G.protocol && !G.slashes, Ye.slashes = G.slashes || M && N.slashes, Ye.protocol = G.protocol || N.protocol || "", j = G.rest, (Ye.protocol === "file:" || !G.slashes && (G.protocol || G.slashesCount < 2 || !d(Ye.protocol))) && (pt[3] = [/(.*)/, "pathname"]); In < pt.length; In++) {
                if (pe = pt[In], typeof pe == "function") {
                    j = pe(j, Ye);
                    continue
                }
                fe = pe[0], Ve = pe[1], fe !== fe ? Ye[Ve] = j : typeof fe == "string" ? ~(Pe = j.indexOf(fe)) && (typeof pe[2] == "number" ? (Ye[Ve] = j.slice(0, Pe), j = j.slice(Pe + pe[2])) : (Ye[Ve] = j.slice(Pe), j = j.slice(0, Pe))) : (Pe = fe.exec(j)) && (Ye[Ve] = Pe[1], j = j.slice(0, Pe.index)), Ye[Ve] = Ye[Ve] || M && pe[3] && N[Ve] || "", pe[4] && (Ye[Ve] = Ye[Ve].toLowerCase())
            }
        ...
        function Be(j) {
            ...
            var G = M + (W.slashes || d(W.protocol) ? "//" : "");
        ...
        Le.prototype = {
            set: at,
            toString: Be
        }, Le.extractProtocol = xe, Le.location = ve, Le.trimLeft = q, Le.qs = ie;
        var K = Le;
        ...
        var dt = function(j) {
                function N(W, M) {
                    if (M === void 0 && (M = {}), j.call(this), !W) throw new TypeError($e.EVENT_ERROR + " 1 argument required, but only 0 present.");
            ...
            Bt = function(j) {
                function N(W, M) {
                    if (M === void 0 && (M = {}), j.call(this), !W) throw new TypeError($e.EVENT.MESSAGE + " 1 argument required, but only 0 present.");
            ...
            Gt = function(j) {
                function N(W, M) {
                    if (M === void 0 && (M = {}), j.call(this), !W) throw new TypeError($e.EVENT.CLOSE + " 1 argument required, but only 0 present.");
        ...
        function _(j, N, W) {
            ...
            Fe(function() {
                _e.removeWebSocket(j, j.url), j.readyState = De.CLOSED, j.dispatchEvent(G), j.dispatchEvent(fe), M && M.dispatchEvent(G, M)
            }, j)
        }
        ...
        function O(j, N, W) {
            ...
            Fe(function() {
                _e.removeWebSocket(j, j.url), j.readyState = De.CLOSED, j.dispatchEvent(pe), j.dispatchEvent(G), j.dispatchEvent(fe), M && M.dispatchEvent(G, M)
            }, j)
        }
        ...
        var De = function(j) {
            function N(M, G) {
                j.call(this), this._onopen = null, this._onmessage = null, this._onerror = null, this._onclose = null, this.url = he(M), G = Ie(G), this.protocol = G[0] || "", this.binaryType = "blob", this.readyState = N.CONNECTING;
                var fe = te(this),
                    pe = _e.attachWebSocket(fe, this.url);
                Fe(function() {
                    if (pe)
                        if (pe.options.verifyClient && typeof pe.options.verifyClient == "function" && !pe.options.verifyClient()) this.readyState = N.CLOSED, U("error", "WebSocket connection to '" + this.url + "' failed: HTTP Authentication failed; no valid credentials available"), _e.removeWebSocket(fe, this.url), this.dispatchEvent(x({
                            type: "error",
                            target: this
                            ...
                            if (pe.options.selectProtocol && typeof pe.options.selectProtocol == "function") {
                                var Ve = pe.options.selectProtocol(G),
                                    ...
                                    jt = G.indexOf(Ve) !== -1;
                                if (pt && !jt) {
                                    this.readyState = N.CLOSED, U("error", "WebSocket connection to '" + this.url + "' failed: Invalid Sub-Protocol"), _e.removeWebSocket(fe, this.url), this.dispatchEvent(x({
                                        type: "error",
                                        target: this
                                    })), this.dispatchEvent(g({
                                        type: "close",
                            ...
                            this.readyState = N.OPEN, this.dispatchEvent(x({
                                type: "open",
                                target: this
                            })), pe.dispatchEvent(x({
                                type: "connection"
                    ...
                    else this.readyState = N.CLOSED, this.dispatchEvent(x({
                        type: "error",
                        target: this
                    })), this.dispatchEvent(g({
                        type: "close",
        ...
        var rn = {
            ...
            lt = function(j) {
                function N(W, M) {
                    ...
                    if (!fe) throw this.dispatchEvent(x({
                        type: "error"
                ...
                return j && (N.__proto__ = j), N.prototype = Object.create(j && j.prototype), N.prototype.constructor = N, N.prototype.mockWebsocket = function() {
                    ...
                    fe === void 0 && (fe = []);
                    var Pe = this,
                        Ve = nt(fe.concat(_e.websocketsLookup(this.url, M, G)));
                    return {
                        to: function(pt, jt) {
                    ...
                    M === "error" && G.forEach(function(fe) {
                        fe.readyState = De.CLOSED, fe.dispatchEvent(x({
                            type: "error"
                        }))
                    })
                }, N
        ...
        var yt = function(j) {
            function N(M, G) {
                ...
                Fe(function() {
                    Pe ? (this.readyState = N.OPEN, Pe.dispatchEvent(x({
                        type: "connection"
                    }), Pe, this), Pe.dispatchEvent(x({
                        type: "connect"
                    }), Pe, this), this.dispatchEvent(x({
                        type: "connect",
                        target: this
                    }))) : (this.readyState = N.CLOSED, this.dispatchEvent(x({
                        type: "error",
                        target: this
                    })), this.dispatchEvent(g({
                        type: "close",
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/standalone-quiplash2-international/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
    ...
    (function(e) {
        ...
        n.Stickit = i, i._handlers = [], i.addHandler = function(m) {
            ...
            addBinding: function(m, P, q) {
                ...
                if (this.unstickit(ae, P), !!d.length) {
                    ...
                    var xe = $(d, q),
                        Ae = xe.observe;
                    xe.selector = P, xe.view = this;
                    var Le = xe.bindId = e.uniqueId(),
                        at = e.extend({
                            stickitChange: xe
                        }, xe.setOptions);
                    if (xe._destroy = function() {
                            v.call(this, xe.destroy, d, ae, xe)
                        }, J(d, xe, ae, Ae), Y(d, xe, ae, Ae), ie(d, xe, ae), Ae) {
                        e.each(xe.events, function(K) {
                            var Fe = K + se,
                                U = function(Te) {
                                    var we = v.call(this, xe.getVal, d, Te, xe, a.call(arguments, 1)),
                                        ye = S(xe.updateModel, we, Te, xe);
                                    ye && I(ae, Ae, we, at, xe)
                                },
                                oe = P === ":el" ? "" : P;
                            this.$el.on(Fe, oe, e.bind(U, this))
                        }, this), e.each(e.flatten([Ae]), function(K) {
                            k(ae, "change:" + K, xe, function(Fe, U, oe) {
                    ...
                    v.call(this, xe.initialize, d, ae, xe)
                }
            }
        ...
        var a = [].slice,
            ...
            I = function(m, P, q, ae, se) {
                var ve = {},
                    d = se.view;
                se.onSet && (q = v.call(d, se.onSet, q, se)), se.set ? v.call(d, se.set, P, q, ae, se) : (ve[P] = q, e.isArray(P) && e.isArray(q) && (ve = e.reduce(P, function(xe, Ae, Le) {
                    return xe[Ae] = e.has(q, Le) ? q[Le] : null, xe
                }, {})), m.set(ve, ae))
            },
            D = function(m, P, q) {
                var ae = q.view,
                    se = function(xe) {
                        return m[q.escape ? "escape" : "get"](xe)
                    },
                    ve = function(xe) {
                        return xe == null ? "" : xe
                    },
            ...
            $ = i.getConfiguration = function(m, P) {
                var q = [{
                    updateModel: !1,
                    updateMethod: "text",
                    update: function(se, ve, d, xe) {
                        se[xe.updateMethod] && se[xe.updateMethod](ve)
                    },
            ...
            J = function(m, P, q, ae) {
                ...
                e.each(P.attributes || [], function(d) {
                    ...
                    var xe = "",
                        ...
                        Le = function() {
                            var at = e.contains(se, d.name) ? "prop" : "attr",
                                Be = D(q, Ae, d);
                            d.name === "class" ? (m.removeClass(xe).addClass(Be), xe = Be) : m[at](d.name, Be)
                        };
                    ...
                    var se = P.view,
                        ve = function() {
                            var d = P.visible,
                                ...
                                Ae = D(q, ae, P),
                                Le = !!Ae;
                            (e.isFunction(d) || e.isString(d)) && (Le = !!v.call(se, d, Ae, P)), xe ? v.call(se, xe, m, Le, P) : m.toggle(Le)
                        };
        ...
        return i.addHandler([{
            ...
            update: function(m, P, q, ae) {
                ...
                var Le = function(ue, _e, ke) {
                    e.each(ue, function($e) {
                        var Ke = n.$("<option/>"),
                            dt = $e,
                            Bt = function(_, O, L) {
                                Ke.text(_), dt = O, Ke.data("stickit-bind-val", dt), !e.isArray(dt) && !e.isObject(dt) && Ke.val(dt), L === !0 && Ke.prop("disabled", "disabled")
                            },
                            Gt, x, l;
                        $e === "__default__" ? (Gt = ke.label, x = ke.value, l = ke.disabled) : (Gt = f($e, ve.labelPath), x = f($e, ve.valuePath), l = f($e, ve.disabledPath)), Bt(Gt, x, l);
                        var g = function() {
                            return !xe && dt != null && ke != null && dt === ke ? !0 : !!(e.isObject(ke) && e.isEqual(dt, ke))
                        };
                        g() ? Ke.prop("selected", !0) : xe && e.isArray(ke) && e.each(ke, function(_) {
                ...
                if (m.find("*").remove(), e.isString(d)) {
                    var at = window;
                    d.indexOf("this.") === 0 && (at = this), d = d.replace(/^[a-z]*\.(.+)$/, "$1"), se = f(at, d)
...
var Ti, Bs, is = typeof Map == "function" ? new Map : (Ti = [], Bs = [], {
        has: function(t) {
...
const hC = `<form>\r
    ...
    Vi = xt.View.extend({
        ...
        className: "choices",
        childView(t) {
            return t.get("type") === "input" ? no : t.get("type") === "text" ? Vi : Xu
        },
...
function fC(t) {
    ...
    return Gs = Kr.getContext("2d"), Gs.imageSmoothingEnabled = !1, Ku("init"), {
        canvas: Kr,
        context: Gs
    }
}
...
function mC({
    ...
    function Y() {
        if (I = requestAnimationFrame(Y), D = ie.now(), $ = D - k, k = D, !($ > 1e3)) {
            for (Ku("tick"), a += $; a >= f;) J.update(v), a -= f;
            S(), J.render()
        }
    }
    return J = {
...
class ol {
    ...
    get(e) {
        ...
        for (; this._s.length && this._b;) {
            for (i = lc(e, this.bounds), a = 0; a < i.length; a++) this._s[i[a]].get(e).forEach(f => n.add(f));
            return Array.from(n)
        }
    ...
    (function(n, i) {
        ...
        const n = "SweetAlert2:",
            ...
            Le = c => {
                ...
                for (const h in c) d(h), c.toast && xe(h), Ae(h)
            },
            at = "swal2-",
            Be = c => {
                const h = {};
                for (const b in c) h[c[b]] = at + c[b];
                return h
            },
...
`).replace(/(^|\n)\s*/g, ""),
            ...
            vi = c => {
                ...
                b.className = K.container, h && Je(b, K["no-transition"]), nt(b, _r);
                const B = kr(c.target);
            ...
            wi = (c, h) => {
                const b = g(),
                    B = x();
                !h.showConfirmButton && !h.showDenyButton && !h.showCancelButton ? M(b) : W(b), lt(b, h, "actions"), Hn(b, B, h), nt(B, h.loaderHtml), lt(B, h, "loader")
            };
        ...
        function Hn(c, h, b) {
            const B = dt(),
                ge = Bt(),
                He = l();
            bi(B, "confirm", b), bi(ge, "deny", b), bi(He, "cancel", b), zi(B, ge, He, b), b.reverseButtons && (b.toast ? (c.insertBefore(He, B), c.insertBefore(ge, B)) : (c.insertBefore(He, h), c.insertBefore(ge, h), c.insertBefore(B, h)))
        }
        ...
        function bi(c, h, b) {
            fe(c, b["show".concat(a(h), "Button")], "inline-block"), nt(c, b["".concat(h, "ButtonText")]), c.setAttribute("aria-label", b["".concat(h, "ButtonAriaLabel")]), c.className = K[h], lt(c, b, "".concat(h, "Button")), Je(c, b["".concat(h, "ButtonClass")])
        }
        const Ze = (c, h) => {
            const b = U();
            !b || (y(b, h.backdrop), o(b, h.position), C(b, h.grow), lt(b, h, "container"))
        };
        ...
        const Q = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
            Ce = (c, h) => {
                ...
                Q.forEach(He => {
                    const Ut = j(b, K[He]);
                    Wt(He, h.inputAttributes), Ut.className = K[He], ge && M(Ut)
        ...
        const Hi = (c, h) => {
                const b = _e();
                lt(b, h, "htmlContainer"), h.html ? (yi(h.html, b), W(b, "block")) : h.text ? (b.textContent = h.text, W(b, "block")) : M(b), Ce(c, h)
            },
            Co = (c, h) => {
                const b = _();
                fe(b, h.footer), h.footer && yi(h.footer, b), lt(b, h, "footer")
            },
            Eo = (c, h) => {
                const b = L();
                nt(b, h.closeButtonHtml), lt(b, h, "closeButton"), fe(b, h.showCloseButton), b.setAttribute("aria-label", h.closeButtonAriaLabel)
            },
            Ar = (c, h) => {
                ...
                W(B), ms(B, h), Or(B, h), Je(B, h.showClass.icon)
            },
            Or = (c, h) => {
                for (const b in Fe) h.icon !== b && Lt(c, Fe[b]);
                Je(c, Fe[h.icon]), bn(c, h), Ui(), lt(c, h, "icon")
            },
            Ui = () => {
                const c = we(),
...
`,
            ms = (c, h) => {
                let b = c.innerHTML,
                    B;
                h.iconHtml ? B = Rr(h.iconHtml) : h.icon === "success" ? (B = gs, b = b.replace(/ style=".*?"/g, "")) : h.icon === "error" ? B = xo : B = Rr({
                    question: "?",
                    warning: "!",
                    info: "i"
            ...
            Ci = (c, h) => {
                ...
                W(b, ""), b.setAttribute("src", h.imageUrl), b.setAttribute("alt", h.imageAlt), N(b, "width", h.imageWidth), N(b, "height", h.imageHeight), b.className = K.image, lt(b, h, "image")
            },
            _o = (c, h) => {
                const b = $e();
            ...
            Wn = (c, h) => {
                const b = ue();
                fe(b, h.title || h.titleText, "block"), h.title && yi(h.title, b), h.titleText && (b.innerText = h.titleText), lt(b, h, "title")
            },
            Ir = (c, h) => {
                const b = U(),
                    B = we();
                h.toast ? (N(b, "width", h.width), B.style.width = "100%", B.insertBefore(x(), ye())) : N(B, "width", h.width), N(B, "padding", h.padding), h.color && (B.style.color = h.color), h.background && (B.style.background = h.background), M(Ke()), ko(B, h)
            },
            ko = (c, h) => {
                c.className = "".concat(K.popup, " ").concat(pe(c) ? h.showClass.popup : ""), h.toast ? (Je([document.documentElement, document.body], K["toast-shown"]), Je(c, K.toast)) : Je(c, K.modal), lt(c, h, "popup"), typeof h.customClass == "string" && Je(c, h.customClass), h.icon && Je(c, K["icon-".concat(h.icon)])
            },
            Dr = (c, h) => {
                Ir(c, h), Ze(c, h), _o(c, h), Ar(c, h), Ci(c, h), Wn(c, h), Eo(c, h), Hi(c, h), wi(c, h), Co(c, h), typeof h.didRender == "function" && h.didRender(we())
            },
            Xn = Object.freeze({
                cancel: "cancel",
                backdrop: "backdrop",
            ...
            To = c => {
                ...
                if (!h) return {};
                const b = h.content;
                return Do(b), Object.assign(vs(b), Ao(b), Oo(b), Lr(b), Ro(b), Io(b, Gi))
            },
            vs = c => {
                const h = {};
...
`).join("<br />")), vi(c)
        ...
        const bs = () => {
                De.previousBodyPadding === null && document.body.scrollHeight > window.innerHeight && (De.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")), document.body.style.paddingRight = "".concat(De.previousBodyPadding + Fi(), "px"))
            },
            Nr = () => {
            ...
            Cs = () => {
                if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1) && !Ct(document.body, K.iosfix)) {
                    ...
                    document.body.style.top = "".concat(h * -1, "px"), Je(document.body, K.iosfix), Vr(), Es()
                }
            },
            Es = () => {
            ...
            $r = c => {
                ...
                r(h, b, c), setTimeout(() => {
                    Bo(h, b)
                }, Br), Se() && ($o(h, c.scrollbarPadding, ge), Ei()), !he() && !it.previousActiveElement && (it.previousActiveElement = document.activeElement), typeof c.didOpen == "function" && setTimeout(() => c.didOpen(b)), Lt(h, K["no-transition"])
            },
            xs = c => {
                const h = we();
                if (c.target !== h) return;
                const b = U();
                h.removeEventListener(mn, xs), b.style.overflowY = "auto"
            },
            Bo = (c, h) => {
                mn && pt(h) ? (c.style.overflowY = "hidden", h.addEventListener(mn, xs)) : c.style.overflowY = "auto"
            },
            $o = (c, h, b) => {
            ...
            le = {
                ...
                radio: (c, h, b) => {
                    ...
                    h.forEach(He => {
                        ...
                        nt(Jo, Vn), Jo.className = K.label, tr.appendChild(pn), tr.appendChild(Jo), B.appendChild(tr)
                    });
        ...
        function ce() {
            ...
            M(h.loader), he() ? c.icon && W(ye()) : Ge(h), Lt([h.popup, h.actions], K.loading), h.popup.removeAttribute("aria-busy"), h.popup.removeAttribute("data-loading"), h.confirmButton.disabled = !1, h.denyButton.disabled = !1, h.cancelButton.disabled = !1
        }
        const Ge = c => {
        ...
        const zt = () => pe(we()),
            ...
            on = (c, h, b, B) => {
                et(h), b.toast || (h.keydownHandler = ge => qi(c, ge, B), h.keydownTarget = b.keydownListenerCapture ? window : we(), h.keydownListenerCapture = b.keydownListenerCapture, h.keydownTarget.addEventListener("keydown", h.keydownHandler, {
        ...
        function Mn(c, h, b, B) {
            he() ? ks(c, B) : (gi(b).then(() => ks(c, B)), et(it)), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (h.setAttribute("style", "display:none !important"), h.removeAttribute("class"), h.innerHTML = "") : h.remove(), Se() && (Nr(), xi(), Mr()), vn()
        }
        ...
        const gt = c => {
            ...
            Ss = (c, h, b) => {
                const B = U(),
                    ge = mn && pt(h);
                typeof b.willClose == "function" && b.willClose(h), ge ? Fr(c, h, B, b.returnFocus, b.didClose) : Mn(c, B, b.returnFocus, b.didClose)
            },
            Fr = (c, h, b, B, ge) => {
                it.swalCloseEventFinishedCallback = Mn.bind(null, c, b, B, ge), h.addEventListener(mn, function(He) {
        ...
        const Os = c => {
            ...
            Xi = (c, h, b) => {
                ...
                c.disableInput(), Promise.resolve().then(() => J(B.inputValidator(h, B.validationMessage))).then(He => {
                    c.enableButtons(), c.enableInput(), He ? c.showValidationMessage(He) : b === "deny" ? dn(c, h) : Ki(c, h)
                })
            },
            dn = (c, h) => {
            ...
            Xo = (c, h, b) => {
                A.innerParams.get(c).toast ? Yo(c, h, b) : (Ur(h), Ds(h), Ji(c, h, b))
            },
            Yo = (c, h, b) => {
                h.popup.onclick = () => {
                    const B = A.innerParams.get(c);
        ...
        class Ue {
            ...
            _main(h) {
                ...
                Le(Object.assign({}, b, h)), it.currentInstance && (it.currentInstance._destroy(), Se() && Mr()), it.currentInstance = ze;
                const B = ht(h, b);
                ws(B), Object.freeze(B), it.timeout && (it.timeout.stop(), delete it.timeout), clearTimeout(it.restoreFocusTimeout);
                const ge = Tt(ze);
                return Dr(ze, B), A.innerParams.set(ze, B), Xe(ze, ge, B)
            }
            then(h) {
        ...
        const Xe = (c, h, b) => new Promise((B, ge) => {
                ...
                je.swalPromiseResolve.set(c, B), je.swalPromiseReject.set(c, ge), h.confirmButton.onclick = () => Os(c), h.denyButton.onclick = () => Rs(c), h.cancelButton.onclick = () => Wo(c, He), h.closeButton.onclick = () => He(Xn.close), Xo(c, h, He), on(c, it, b, He), p(c, b), $r(b), We(it, b, He), Ht(h, b), setTimeout(() => {
            ...
            We = (c, h, b) => {
                ...
                }, h.timer), h.timerProgressBar && (W(B), lt(B, h, "timerProgressBar"), setTimeout(() => {
      ...
      `));
        ...
        Object.assign(Ue.prototype, Hr), Object.assign(Ue, Me), Object.keys(Hr).forEach(c => {
            Ue[c] = function() {
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/standalone/quiplash2-international/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    EC = xt.View.extend({
        ...
        onAttach() {
            ...
            this.cameraSprite = ul(CC), this.cameraSprite.width = this.model.get("width"), this.cameraSprite.height = this.model.get("height"), this.cameraSprite.mask = this.model.get("mask"), t.sprites.push(this.cameraSprite), t.gameLoop.start(), this.facingMode = "user", this.startCamera(), this.onResize()
        },
        async startCamera() {
    ...
    si = ot.Model.extend({
        defaults: {},
        set(t, e) {
            const n = ut.extend({}, this.attributes, this.defaults, t);
            return ot.Model.prototype.set.apply(this, [n, e]), this
        },
        setUpdate(t, e) {
            const n = ut.extend({}, this.defaults, this.attributes, t);
            return ot.Model.prototype.set.apply(this, [n, e]), this
        }
    }),
    xC = si.extend({
    ...
    _C = xt.View.extend({
        template: ut.template('<div id="cameraRegion" class="cameraRegion"></div>'),
        className: "Camera",
        model: new xC,
        regions: {
            camera: "#cameraRegion"
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/standalone/quiplash2-international/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
`,
    ...
    PC = xt.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new Vi({}), this.toolbarComponent = this.toolbarComponent || new OC({
                model: new ot.Model({})
...
`,
    ...
    BC = xt.View.extend({
        ...
        onChildviewInputText(t) {
            let e = t.getValue();
            e.length > this.model.get("maxLength") && (e = e.substr(0, this.model.get("maxLength")), t.setValue(e)), this.shouldSubmit = e.length > 0, this.model.get("live") && (this.throttledSend || (this.throttledSend = ut.throttle(() => {
        ...
        onChildviewChildviewButtonSuggestion() {
            const t = this.model.get("suggestions"),
                e = this.inputComponent.getSanitizedValue(),
                n = ut.without(t, e);
            return this.inputComponent.setValue(ut.shuffle(n)[0]), !1
        },
        onChildviewChildviewButtonChoose(t) {
...
const $C = `<div id="controller" class="state-controller controller-content">
    ...
    FC = xt.View.extend({
        tagName: "button",
        template: ut.template('<span class="flex-item"></span>'),
        className() {
    ...
    zC = xt.View.extend({
        ...
        update() {
            ...
            this.charactersListView.collection.set(ut.map(t, e => {
        ...
        animateAll: function(i) {
            ...
            t.forEach(function(S) {
                var k = 0,
                    ...
                    Y = S.rect,
                    re = fr(I, !0);
                re && ($.top -= re.f, $.left -= re.e), I.toRect = $, I.thisAnimationDuration && da(J, $) && !da(D, $) && (Y.top - $.top) / (Y.left - $.left) === (D.top - $.top) / (D.left - $.left) && (k = aE(Y, J, ie, a.options)), da($, D) || (I.prevFromRect = D, I.prevToRect = $, k || (k = a.options.animation), a.animate(I, Y, $, k)), k && (f = !0, v = Math.max(v, k), clearTimeout(I.animationResetTimer), I.animationResetTimer = setTimeout(function() {
        ...
        animate: function(i, a, f, v) {
            if (v) {
                ...
                var S = fr(this.el),
                    ...
                    D = (a.left - f.left) / (k || 1),
                    $ = (a.top - f.top) / (I || 1);
                i.animatingX = !!D, i.animatingY = !!$, tt(i, "transform", "translate3d(" + D + "px," + $ + "px,0)"), this.forRepaintDummy = oE(i), tt(i, "transition", "transform " + v + "ms" + (this.options.easing ? " " + this.options.easing : "")), tt(i, "transform", "translate3d(0,0,0)"), typeof i.animated == "number" && clearTimeout(i.animated), i.animated = setTimeout(function() {
...
var Re, $t, ct, Pt, Ii, Ws, Vt, ui, lr, _n, os, ci, js, tn, ar = !1,
    ro = !1,
    so = [],
    Ai, Ln, pa, ga, gc, mc, Jr, rr, as, ls = !1,
    Fs = !1,
    Xs, ln, ma = [],
    Ma = !1,
    oo = [],
    ...
    zs = Zu,
    vc = fs || oi ? "cssFloat" : "float",
    uE = bo && !eh && !Zu && "draggable" in document.createElement("div"),
    oh = function() {
        if (!!bo) {
            if (oi) return !1;
    ...
    ah = function(e, n) {
        ...
        return f && (S.display === "block" || S.display === "flex" || S.display === "table" || S.display === "grid" || I >= a && i[vc] === "none" || v && i[vc] === "none" && I + D > a) ? "vertical" : "horizontal"
    },
    hE = function(e, n, i) {
    ...
    ch = function() {
        !oh && ct && tt(ct, "display", "none")
    },
    uh = function() {
        !oh && ct && tt(ct, "display", "")
    };
bo && !eh && document.addEventListener("click", function(t) {
...
Qe.prototype = {
    ...
    _onTapStart: function(e) {
        if (!!e.cancelable) {
            var n = this,
                ...
                D = a.filter;
            if (CE(i), !Re && !(/mousedown|pointerdown/.test(v) && e.button !== 0 || a.disabled) && !I.isContentEditable && !(!this.nativeDraggable && rs && k && k.tagName.toUpperCase() === "SELECT") && (k = $n(k, a.draggable, i, !1), !(k && k.animated) && Ws !== k)) {
                if (lr = On(k), os = On(k, a.draggable), typeof D == "function") {
    ...
    _prepareDragStart: function(e, n, i) {
        ...
        if (i && !Re && i.parentNode === f) {
            var I = Yt(i);
            if (Pt = f, Re = i, $t = Re.parentNode, Ii = Re.nextSibling, Ws = i, js = v.group, Qe.dragged = Re, Ai = {
                    target: Re,
                    clientX: (n || e).clientX,
                    clientY: (n || e).clientY
                }, gc = Ai.clientX - I.left, mc = Ai.clientY - I.top, this._lastX = (n || e).clientX, this._lastY = (n || e).clientY, Re.style["will-change"] = "all", k = function() {
                    if (wn("delayEnded", a, {
                            evt: e
                        }), Qe.eventCanceled) {
                        a._onDrop();
                    ...
                    a._disableDelayedDragEvents(), !hc && a.nativeDraggable && (Re.draggable = !0), a._triggerDragStart(e, n), gn({
                        ...
                        name: "choose",
                        originalEvent: e
                    }), xn(Re, v.chosenClass, !0)
                }, v.ignore.split(",").forEach(function(D) {
                    nh(Re, D.trim(), va)
                }), Et(S, "dragover", Oi), Et(S, "mousemove", Oi), Et(S, "touchmove", Oi), Et(S, "mouseup", a._onDrop), Et(S, "touchend", a._onDrop), Et(S, "touchcancel", a._onDrop), hc && this.nativeDraggable && (this.options.touchStartThreshold = 4, Re.draggable = !0), wn("delayStart", this, {
                    evt: e
    ...
    _dragStarted: function(e, n) {
        if (ar = !1, Pt && Re) {
            wn("dragStarted", this, {
                evt: n
            }), this.nativeDraggable && Et(document, "dragover", fE);
            var i = this.options;
            !e && xn(Re, i.dragClass, !1), xn(Re, i.ghostClass, !0), Qe.active = this, e && this._appendGhost(), gn({
                sortable: this,
                name: "start",
                originalEvent: n
            })
    ...
    _emulateDragOver: function() {
        if (Ln) {
            this._lastX = Ln.clientX, this._lastY = Ln.clientY, ch();
    ...
    _onTouchMove: function(e) {
        if (Ai) {
            var n = this.options,
                ...
                k = ct && v && v.d,
                I = zs && ln && pc(ln),
                D = (f.clientX - Ai.clientX + a.x) / (S || 1) + (I ? I[0] - ma[0] : 0) / (S || 1),
                $ = (f.clientY - Ai.clientY + a.y) / (k || 1) + (I ? I[1] - ma[1] : 0) / (k || 1);
            if (!Qe.active && !ar) {
            ...
            if (ct) {
                ...
                tt(ct, "webkitTransform", J), tt(ct, "mozTransform", J), tt(ct, "msTransform", J), tt(ct, "transform", J), pa = D, ga = $, Ln = f
            }
    ...
    _appendGhost: function() {
        if (!ct) {
            ...
            ct = Re.cloneNode(!0), xn(ct, i.ghostClass, !1), xn(ct, i.fallbackClass, !0), xn(ct, i.dragClass, !0), tt(ct, "transition", ""), tt(ct, "transform", ""), tt(ct, "box-sizing", "border-box"), tt(ct, "margin", 0), tt(ct, "top", n.top), tt(ct, "left", n.left), tt(ct, "width", n.width), tt(ct, "height", n.height), tt(ct, "opacity", "0.8"), tt(ct, "position", zs ? "absolute" : "fixed"), tt(ct, "zIndex", "100000"), tt(ct, "pointerEvents", "none"), Qe.ghost = ct, e.appendChild(ct), tt(ct, "transform-origin", gc / parseInt(ct.style.width) * 100 + "% " + mc / parseInt(ct.style.height) * 100 + "%")
        }
    },
    _onDragStart: function(e, n) {
        ...
        wn("setupClone", this), Qe.eventCanceled || (Vt = sh(Re), Vt.removeAttribute("id"), Vt.draggable = !1, Vt.style["will-change"] = "", this._hideClone(), xn(Vt, this.options.chosenClass, !1), Qe.clone = Vt), i.cloneId = Ys(function() {
            wn("clone", i), !Qe.eventCanceled && (i.options.removeCloneOnHide || Pt.insertBefore(Vt, Re), i._hideClone(), gn({
                sortable: i,
                name: "clone"
            }))
        }), !n && xn(Re, f.dragClass, !0), n ? (ro = !0, i._loopId = setInterval(i._emulateDragOver, 50)) : (wt(document, "mouseup", i._onDrop), wt(document, "touchend", i._onDrop), wt(document, "touchcancel", i._onDrop), a && (a.effectAllowed = "move", f.setData && f.setData.call(i, a, Re)), Et(document, "drop", i), tt(Re, "transform", "translateZ(0)")), ar = !0, i._dragStartId = Ys(i._dragStarted.bind(i, n, e)), Et(document, "selectstart", i), Jr = !0, rs && tt(document.body, "user-select", "none")
    },
    _onDragOver: function(e) {
        ...
        function m(ye, ue) {
            wn(ye, Y, zn({
                ...
                onMove: function(ke, $e) {
                    return Hs(Pt, n, Re, a, ke, Yt(ke), e, $e)
                },
                changed: ae
            }, ue))
        }
        ...
        function q(ye) {
            return m("dragOverCompleted", {
                insertion: ye
            }), ye && (D ? I._hideClone() : I._showClone(Y), Y !== J && (xn(Re, tn ? tn.options.ghostClass : I.options.ghostClass, !1), xn(Re, S.ghostClass, !0)), tn !== Y && Y !== Qe.active ? tn = Y : Y === Qe.active && tn && (tn = null), J === Y && (Y._ignoreWhileAnimating = i), Y.animateAll(function() {
        ...
        if (ro = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : tn === this || (this.lastPutMode = js.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            ...
            if (!se || vE(e, ie, this) && !se.animated) {
                if (se === Re) return q(!1);
                ...
                f = Yt(i);
                var d = 0,
                    xe, Ae = Re.parentNode !== n,
                    Le = !hE(Re.animated && Re.toRect || a, i.animated && i.toRect || f, ie),
                    at = ie ? "top" : "left",
                    Be = fc(i, "top", "top") || fc(Re, "top", "top"),
                    K = Be ? Be.scrollTop : void 0;
                rr !== i && (xe = f[at], ls = !1, Fs = !Le && S.invertSwap || Ae), d = yE(e, i, f, ie, Le ? 1 : S.swapThreshold, S.invertedSwapThreshold == null ? S.swapThreshold : S.invertedSwapThreshold, Fs, rr === i);
                var Fe;
                if (d !== 0) {
                    var U = On(Re);
                    do U -= d, Fe = $t.children[U]; while (Fe && (tt(Fe, "display") === "none" || Fe === ct))
                }
                ...
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Ma = !0, setTimeout(gE, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), Be && rh(Be, 0, K - Be.scrollTop), $t = Re.parentNode, xe !== void 0 && !Fs && (Xs = Math.abs(xe - Yt(i)[at])), ae(), q(!0)
            }
    ...
    _onDrop: function(e) {
        ...
        ar = !1, Fs = !1, ls = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), La(this.cloneId), La(this._dragStartId), this.nativeDraggable && (wt(document, "drop", this), wt(n, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), rs && tt(document.body, "user-select", ""), tt(Re, "transform", ""), e && (Jr && (e.cancelable && e.preventDefault(), !i.dropBubble && e.stopPropagation()), ct && ct.parentNode && ct.parentNode.removeChild(ct), (Pt === $t || tn && tn.lastPutMode !== "clone") && Vt && Vt.parentNode && Vt.parentNode.removeChild(Vt), Re && (this.nativeDraggable && wt(Re, "dragend", this), va(Re), Re.style["will-change"] = "", Jr && !ar && xn(Re, tn ? tn.options.ghostClass : this.options.ghostClass, !1), xn(Re, this.options.chosenClass, !1), gn({
            sortable: this,
            name: "unchoose",
            toEl: $t,
            newIndex: null,
    ...
    _nulling: function() {
        wn("nulling", this), Pt = Re = $t = ct = Ii = Vt = Ws = ui = Ai = Ln = Jr = _n = ci = lr = os = rr = as = tn = js = Qe.dragged = Qe.ghost = Qe.clone = Qe.active = null, oo.forEach(function(e) {
            e.checked = !0
        }), oo.length = pa = ga = 0
    },
    ...
    toArray: function() {
        for (var e = [], n, i = this.el.children, a = 0, f = i.length, v = this.options; a < f; a++) n = i[a], $n(n, v.draggable, this.el, !1) && e.push(n.getAttribute(v.dataIdAttr) || bE(n));
        return e
    },
    sort: function(e, n) {
        var i = {},
...
function yE(t, e, n, i, a, f, v, S) {
    ...
    if (!v) {
        if (S && Xs < I * a) {
            if (!ls && (as === 1 ? k > D + I * f / 2 : k < $ - I * f / 2) && (ls = !0), ls) J = !0;
            else if (as === 1 ? k < D + Xs : k > $ - Xs) return -as
        } else if (k > D + I * (1 - a) / 2 && k < $ - I * (1 - a) / 2) return wE(e)
    }
...
function EE() {
    ...
    return t.prototype = {
        ...
        drop: function() {
            this.sortable.nativeDraggable ? wt(document, "dragover", this._handleAutoScroll) : (wt(document, "pointermove", this._handleFallbackAutoScroll), wt(document, "touchmove", this._handleFallbackAutoScroll), wt(document, "mousemove", this._handleFallbackAutoScroll)), yc(), Ks(), rE()
        },
        nulling: function() {
            ao = Pa = Qr = Na = Zr = ya = wa = null, qt.length = 0
        },
        ...
        _handleAutoScroll: function(n, i) {
            ...
            if (ao = n, i || this.options.forceAutoScrollFallback || fs || oi || rs) {
                ...
                var k = di(S, !0);
                Na && (!Zr || f !== ya || v !== wa) && (Zr && yc(), Zr = setInterval(function() {
                    var I = di(document.elementFromPoint(f, v), !0);
                    I !== k && (k = I, Ks()), ba(n, a.options, I, i)
                }, 10), ya = f, wa = v)
            } else {
...
var ba = ih(function(t, e, n, i) {
        if (!!e.scroll) {
            var a = (t.touches ? t.touches[0] : t).clientX,
                ...
                I = !1,
                D;
            Pa !== n && (Pa = n, Ks(), Qr = e.scroll, D = e.scrollFn, Qr === !0 && (Qr = di(n, !0)));
            var $ = 0,
                J = Qr;
            do {
                var ie = J,
                    ...
                    at = ie.scrollLeft,
                    Be = ie.scrollTop;
                ie === k ? (ve = ae < xe && (Le.overflowX === "auto" || Le.overflowX === "scroll" || Le.overflowX === "visible"), d = se < Ae && (Le.overflowY === "auto" || Le.overflowY === "scroll" || Le.overflowY === "visible")) : (ve = ae < xe && (Le.overflowX === "auto" || Le.overflowX === "scroll"), d = se < Ae && (Le.overflowY === "auto" || Le.overflowY === "scroll"));
                var K = ve && (Math.abs(q - a) <= v && at + ae < xe) - (Math.abs(P - a) <= v && !!at),
                ...
                (qt[$].vx != K || qt[$].vy != Fe || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = Fe, clearInterval(qt[$].pid), (K != 0 || Fe != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    ...
                    typeof D == "function" && D.call(Qe.dragged.parentNode[Sn], Te, oe, t, ao, qt[this.layer].el) !== "continue" || rh(qt[this.layer].el, Te, oe)
                }.bind({
                    layer: $
                }), 24))), $++
...
Qe.mount(new EE);
Qe.mount(fl, dl);
const xE = `<div id="controller" class="state-controller controller-content">\r
    ...
    SE = xt.View.extend({
        ...
        template: ut.template("<div class='text'></div>"),
        model: new ot.Model({}),
        bindings: {
            ":el": {
                attributes: [{
    ...
    TE = xt.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new Vi({
                model: new ot.Model
            }), this.sorterView = this.sorterView || new kE({}), this.listenTo(this.model, "change", this.update, this)
        },
        onAttach() {
    ...
    AE = `<div id="controller" class="state-controller controller-content">
    ...
    IE = `<svg id="range-picker" class="range-picker" viewBox="-40 -40 80 80">
    <defs>
    ...
    DE = xt.View.extend({
        ...
        getNormalizedVector() {
            const t = ut.extend({}, this.model.get("vector"));
    ...
    ME = `<div id="status-bar" class="health text">\r
...
<div id="control-panel" class="control-panel">\r
    ...
    PE = xt.View.extend({
        ...
        initialize(t) {
            this.client = t.client, this.radialComponent = new DE({
                model: new ot.Model({
                    isTouching: !1,
                    angle: 0,
                    vector: {
            ...
            }), this.throttledUpdate = ut.throttle(this.updateVector, this.model.get("throttle")), this.listenTo(this.model, "change", this.update, this), this.onResizeWithContext = this.onResize.bind(this), window.addEventListener("resize", this.onResizeWithContext), Ne(window).on("mousemove", this.move.bind(this)), Ne(window).on("mouseup", this.end.bind(this))
        },
        onBeforeDestroy() {
        ...
        update() {
            ...
            if (this.radialComponent.model.set("selector", t / e), this.radialComponent.model.set("accentColor", this.model.get("characterColor")), this.radialComponent.model.set("lockedIn", this.model.get("lockedIn")), this.radialComponent.model.set("text", ""), this.client.isRole("audience") && ((this.model.get("shotId") === void 0 || this.model.get("shotId") !== this.shotId) && (this.audienceShot = void 0), this.audienceShot && (this.model.setUpdate({
                    ...
                    x: 0,
                    y: 0
                }), this.throttledUpdate = ut.throttle(this.updateVector, this.model.get("throttle")), this.model.get("lockedIn")) this.notified = !1;
            else {
    ...
    NE = `<div id="textDescriptions" class="textDescriptions" role="log" aria-atomic="false" aria-relevant="additions" aria-live="polite"></div>
...
`;
const VE = xt.View.extend({
    client: null,
    template: ut.template(NE),
    playerTopBar: null,
    className() {
...
const jE = `<div id="content-region" class="content"></div>
    ...
    t.mask = {
        ...
        mask: function(v, S) {
            ...
            return S = t.extend({
                ...
                }).on("blur.mask", Ae).on("keydown.mask", Le).on("keypress.mask", at).on("input.mask paste.mask", function() {
                    U.prop("readonly") || setTimeout(function() {
                        var ye = Fe(!0);
                        U.caret(ye), P()
                    }, 0)
                }), a && f && U.off("input.mask").on("input.mask", xe), Fe()
            })
        }
    })
});
window.$ = Ne;
window.jQuery = Ne;
const FE = xt.View.extend({
        className: "app-root",
        template: ut.template(jE),
        regions: {
...
const HE = VE.extend({
    ...
    parseBlob(t) {
        if (t.playerInfo = t.playerInfo || {}, t.playerInfo.username = t.playerName, t.playerColor) t.playerInfo.topBarColor = t.playerColor, t.playerInfo.bgColor = Kt.adjustColor(t.playerColor, .52);
        else {
            const e = "#E4BC65",
                n = Kt.adjustColor("#E4BC65", .52);
            t.playerInfo.topBarColor = e, t.playerInfo.bgColor = n
        }
        return t.isAudience && t.state === "EnterSingleText" && (t.repeating = !0, t.locale === "fr" && (t.strings = {
            ERROR_NOTHING_ENTERED: "VOUS NE POUVEZ RIEN TAPER"
        }), t.locale === "it" && (t.strings = {
            ERROR_NOTHING_ENTERED: "DEVI PER FORZA INSERIRE QUALCOSA"
        }), t.locale === "de" && (t.strings = {
            ERROR_NOTHING_ENTERED: "DU KANNST NICHT NICHTS EINGEBEN"
        }), t.locale === "es" && (t.strings = {
    ...
    formatSessionMessage(t) {
        if (t.action === "safetyQuip") {
            t.safetyQuip = !0;
            const e = this.model.get("question") || {};
            t.questionId = e.id
        }
        return t
    }
...
//# sourceMappingURL=cb27e125.js.map