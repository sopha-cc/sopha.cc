...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp2/fibbage2/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp2/fibbage2/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
\r
		<div class="pt-page-off state-nothing fibbage-page">\r
			<div class="logo-image" style="width:100%;">\r
            	<img class="pure-img" style="margin-left:auto; margin-right:auto;"  src='jackbox/main/pp2/fibbage2/fibbage2/logo.png'>\r
            </div>\r
		</div>\r
	\r
			...
			<div class="container">\r
				...
				<form id="fibbage-defib" class="pure-form">\r
					<button type="button" data-param="defib" class="pure-input-1 fibbage-defib-button button-large pure-button button-fibbage button-fibbage-defib">\r
						<img class="defib-icon" src='jackbox/main/pp2/fibbage2/fibbage2/defib.png' />&nbsp;&nbsp;&nbsp;&nbsp;DE<font color="red">FIB</font>RILLATOR\r
					</button>\r
...
\r
		<div class="pt-page-off state-audience-join fibbage-page">\r
			<br />\r
            <img style="margin-left:auto; margin-right:auto; max-width:75%; max-height:75%;"  src='jackbox/main/pp2/fibbage2/fibbage2/logo.png'>\r
			<span>\r
				<br /><br />\r
...
\r
		<div class="pt-page-off state-audience-postgame fibbage-page">\r
			<div class="container">\r
				<br /><img style="margin-left:auto; margin-right:auto; max-width:75%; max-height:75%;"  src='jackbox/main/pp2/fibbage2/fibbage2/logo.png'>\r
