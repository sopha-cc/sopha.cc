...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp2/bombintern/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp2/bombintern/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
const qx = Et.View.extend({
    ...
    Cc = "jackbox/main/pp2/bombintern/assets/90281e38.png",
    xc = "jackbox/main/pp2/bombintern/assets/d1fcf3e5.png",
    Ec = "jackbox/main/pp2/bombintern/assets/984904cd.png",
    _c = "jackbox/main/pp2/bombintern/assets/9ee83e7e.png",
    Yx = "jackbox/main/pp2/bombintern/assets/c0eab6d1.png",
    Kx = "jackbox/main/pp2/bombintern/assets/60c1751d.png",
    Jx = "jackbox/main/pp2/bombintern/assets/d21e52bc.png",
    Qx = "jackbox/main/pp2/bombintern/assets/604e2594.png",
    Zx = "jackbox/main/pp2/bombintern/assets/43eaa9da.png",
    e1 = "jackbox/main/pp2/bombintern/assets/9385c178.png",
    t1 = "jackbox/main/pp2/bombintern/assets/797cd845.png",
    n1 = "jackbox/main/pp2/bombintern/assets/426e2086.png",
    i1 = "jackbox/main/pp2/bombintern/assets/9c269e40.png",
    r1 = "jackbox/main/pp2/bombintern/assets/e5dc1127.png",
    s1 = "jackbox/main/pp2/bombintern/assets/8c5e7663.png",
    o1 = "jackbox/main/pp2/bombintern/assets/25208ec3.png",
    a1 = "jackbox/main/pp2/bombintern/assets/5bdafb63.png",
    l1 = "jackbox/main/pp2/bombintern/assets/bfc3719e.png",
    c1 = "jackbox/main/pp2/bombintern/assets/13091a8a.png",
    u1 = "jackbox/main/pp2/bombintern/assets/99e487b3.png",
    h1 = "jackbox/main/pp2/bombintern/assets/d834aeba.png",
    d1 = "jackbox/main/pp2/bombintern/assets/67b086cf.png",
    f1 = "jackbox/main/pp2/bombintern/assets/811aefe7.png",
    p1 = "jackbox/main/pp2/bombintern/assets/be7a5962.png",
...
\r
        <div class="pt-page-off state-nothing bombintern-page">\r
            <div class="logo-image" style="width:100%;">\r
                <img class="pure-img" style="margin-left:auto; margin-right:auto;"  src='jackbox/main/pp2/bombintern/bombintern/logo.png'>\r
            </div>\r
        </div>\r
\r
        ...
        switch (Ae(".bombintern-page").css("background-color", v), n) {
            ...
            case "Puzzle":
                    ...
                    case "CopierBomb":
                        if (this.$el.find("#bombintern-copierbomb-rules").html(""), this.$el.find("#bombintern-copierbomb-triggers").html(""), this.buildRuleFolder(a, "bombintern-copierbomb-rules"), i.triggers.length > 0) {
                            for (let _ = 0; _ < i.triggers.length; ++_) {
                                ...
                                const S = i.triggers[_],
                                    O = S.text || S.name;
                                t += `<button type='button' data-param='${S.index}' class='pure-input-1 bombintern-copierbomb-button button-large pure-button button-bombintern'>`, t += `<span>${O}</span>`, S.type === "button" ? t += `<div class='copier-control-image'><img src='${new URL("jackbox/main/pp2/bombintern/assets/5bdafb63.png",self.location).href}'/></div>` : S.type === "action" ? t += `<div class='copier-control-image'><img src='${new URL("jackbox/main/pp2/bombintern/assets/8c5e7663.png",self.location).href}'/></div>` : S.type === "load" ? t += `<div class='copier-control-image'><img src='${new URL("jackbox/main/pp2/bombintern/assets/bfc3719e.png",self.location).href}'/></div>` : S.type === "panel" ? S.state === 0 ? (t += `<div class='copier-control-image'><img src='${new URL("jackbox/main/pp2/bombintern/assets/13091a8a.png",self.location).href}'/></div>`, t += "(closed)") : (t += `<div class='copier-control-image'><img src='${new URL("jackbox/main/pp2/bombintern/assets/99e487b3.png",self.location).href}'/></div>`, t += "(open)") : S.type === "setting" && (t += `<div class='copier-control-image'><img src='${new URL(Object.assign({"../images/copier-knob-1.png":Cc,"../images/copier-knob-2.png":xc,"../images/copier-knob-3.png":Ec,"../images/copier-knob-4.png":_c})[`../images/copier-knob-${S.value + 1}.png`],self.location).href}'/></div>`, t += S.options[S.value]), t += "</button>", t += "</div>"
                            }
                ...
                if ((i.rules && i.rules.length > 0 || i.sort && i.sort.length > 0) && (i.triggers && i.triggers.length > 0 || i.smasher === !0)) {
                    ...
                    const _ = new URL("jackbox/main/pp2/bombintern/assets/67b086cf.png", self.location).href,
                        S = new URL("jackbox/main/pp2/bombintern/assets/67b086cf.png", self.location).href;
