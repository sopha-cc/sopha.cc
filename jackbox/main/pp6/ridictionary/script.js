...
var ot = (t, e, n) => (ph(t, typeof e != "symbol" ? e + "" : e, n), n);
const gh = function() {
    ...
    (function() {
        ...
        m.keys = function(l) {
            ...
            var O = {},
                ...
                V, te;
            if (M == null) return O;
            m.isFunction(g) ? (te = m.allKeys(M), V = P(g, _)) : (te = Be(arguments, !1, !1, 1), V = function(it, Ct, rn) {
                return Ct in rn
            }, M = Object(M));
        ...
        m.template = function(l, g, _) {
            ...
            var O = RegExp([(g.escape || Ke).source, (g.interpolate || Ke).source, (g.evaluate || Ke).source].join("|") + "|$", "g"),
                M = 0,
                V = "__p+='";
            l.replace(O, function(Ie, De, it, Ct, rn) {
...
(function(t) {
    (function(e, n) {
        ...
        var Ae = function(r) {
            ...
            try {
                xn.apply(an = _s.call(et.childNodes), et.childNodes), an[et.childNodes.length].nodeType
            } catch {
                xn = {
            ...
            function St(R, F, X, de) {
                ...
                if (!de && (ne(F), F = F || ce, st)) {
                    if (ht !== 11 && (Le = Wo.exec(R)))
                        ...
                        if (Ue = R, Xe = F, ht === 1 && (Fo.test(R) || As.test(R))) {
                        ...
                        try {
                            return xn.apply(X, Xe.querySelectorAll(Ue)), X
                        } catch {
                            hn(R, !0)
                        } finally {
            ...
            u = St.support = {}, x = St.isXML = function(R) {
                ...
                return de == ce || de.nodeType !== 9 || !de.documentElement || (ce = de, Ge = ce.documentElement, st = !x(ce), et != ce && (X = ce.defaultView) && X.top !== X && (X.addEventListener ? X.addEventListener("unload", Rs, !1) : X.attachEvent && X.attachEvent("onunload", Rs)), u.scope = yn(function(ee) {
                    ...
                    return xe || (xe = (ee.ownerDocument || ee) == (me.ownerDocument || me) ? ee.compareDocumentPosition(me) : 1, xe & 1 || !u.sortDetached && me.compareDocumentPosition(ee) === xe ? ee == ce || ee.ownerDocument == et && un(et, ee) ? -1 : me == ce || me.ownerDocument == et && un(et, me) ? 1 : le ? Zn(le, ee) - Zn(le, me) : 0 : xe & 4 ? -1 : 1)
                } : function(ee, me) {
                    if (ee === me) return be = !0, 0;
                    var xe, Oe = 0,
                        Le = ee.parentNode,
                ...
                preFilter: {
                    ...
                    PSEUDO: function(R) {
                        var F, X = !R[6] && R[2];
                        return Xi.CHILD.test(R[0]) ? null : (R[3] ? R[2] = R[4] || R[5] || "" : X && zo.test(X) && (F = T(X, !0)) && (F = X.indexOf(")", X.length - F) - X.length) && (R[0] = R[0].slice(0, F), R[2] = X.slice(0, F)), R.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(R) {
                ...
                pseudos: {
                    ...
                    lang: dn(function(R) {
                        return Ho.test(R || "") || St.error("unsupported lang: " + R), R = R.replace(An, En).toLowerCase(),
                            function(F) {
                                var X;
                                do
            ...
            function qr(R, F, X, de, ee, me) {
                return de && !de[_t] && (de = qr(de)), ee && !ee[_t] && (ee = qr(ee, me)), dn(function(xe, Oe, Le, ze) {
                    ...
                    } else At = tr(At === Oe ? At.splice(Ht, At.length) : At), ee ? ee(null, Oe, At, ze) : xn.apply(Oe, At)
                })
            }
                ...
                var X = F.length > 0,
                    ...
                    ee = function(me, xe, Oe, Le, ze) {
                        ...
                        if (Tt += We, X && We !== Tt) {
                            ...
                            xn.apply(Le, Jt), ze && !me && Jt.length > 0 && Tt + F.length > 1 && St.uniqueSort(Le)
                        }
            ...
            return z = St.compile = function(R, F) {
                ...
                if (X = X || [], Ue.length === 1) {
                    ...
                    for (ee = Xi.needsContext.test(R) ? 0 : me.length; ee-- && (xe = me[ee], !p.relative[Oe = xe.type]);)
                        if ((Le = p.find[Oe]) && (de = Le(xe.matches[0].replace(An, En), Hr.test(me[0].type) && Gr(F.parentNode) || F))) {
                            if (me.splice(ee, 1), R = de.length && Qi(me), !R) return xn.apply(X, de), X;
                            break
                        }
                }
                return (ze || z(R, Ue))(de, F, !st, X, !F || Hr.test(R) && Gr(F.parentNode) || F), X
        ...
        d.extend({
            ...
            css: function(r, s, u, p) {
                var w, x, T, z = V(s),
                    H = It.test(s);
                return H || (s = Ce(z)), T = d.cssHooks[s] || d.cssHooks[z], T && "get" in T && (w = T.get(r, !0, u)), w === void 0 && (w = Ze(r, s, p)), w === "normal" && s in Gn && (w = Gn[s]), u === "" || u ? (x = parseFloat(w), u === !0 || isFinite(x) ? x || 0 : w) : w
            }
        ...
        function _o(r, s, u) {
            ...
            for (p in s)
                ...
                })), H = gs(st ? je[p] : 0, p, ne), p in je || (je[p] = H.start, st && (H.end = H.start, H.start = 0))
            }
        }
...
`) : r)), s
        ...
        function Pr(r, s, u, p) {
            ...
            if (Array.isArray(s)) d.each(s, function(x, T) {
                u || Ao.test(r) ? p(r, T) : Pr(r + "[" + (typeof T == "object" && T != null ? x : "") + "]", T, u, p)
            });
...
`)
        ...
        d.extend({
            ...
            ajax: function(r, s) {
                ...
                if (st.promise(et), ne.url = ((r || ne.url || xi.href) + "").replace(Po, xi.protocol + "//"), ne.type = s.method || s.type || ne.method || ne.type, ne.dataTypes = (ne.dataType || "*").toLowerCase().match(ke) || [""], ne.crossDomain == null) {
                    z = P.createElement("a");
                    try {
                ...
                Z = d.event && ne.global, Z && d.active++ === 0 && d.event.trigger("ajaxStart"), ne.type = ne.type.toUpperCase(), ne.hasContent = !Mo.test(ne.type), p = ne.url.replace(Do, ""), ne.hasContent ? ne.data && ne.processData && (ne.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (ne.data = ne.data.replace(Io, "+")) : (be = ne.url.slice(p.length), ne.data && (ne.processData || typeof ne.data == "string") && (p += (qi.test(p) ? "&" : "?") + ne.data, delete ne.data), ne.cache === !1 && (p = p.replace(Lo, "$1"), be = (qi.test(p) ? "&" : "?") + "_=" + Mr.guid++ + be), ne.url = p + be), ne.ifModified && (d.lastModified[p] && et.setRequestHeader("If-Modified-Since", d.lastModified[p]), d.etag[p] && et.setRequestHeader("If-None-Match", d.etag[p])), (ne.data && ne.hasContent && ne.contentType !== !1 || s.contentType) && et.setRequestHeader("Content-Type", ne.contentType), et.setRequestHeader("Accept", ne.dataTypes[0] && ne.accepts[ne.dataTypes[0]] ? ne.accepts[ne.dataTypes[0]] + (ne.dataTypes[0] !== "*" ? ", " + bs + "; q=0.01" : "") : ne.accepts["*"]);
                ...
                function on(ft, Dt, _i, Wi) {
                    ...
                    H || (H = !0, T && e.clearTimeout(T), u = void 0, w = Wi || "", et.readyState = ft > 0 ? 4 : 0, hn = ft >= 200 && ft < 300 || ft === 304, _i && (an = No(ne, et, _i)), !hn && d.inArray("script", ne.dataTypes) > -1 && d.inArray("json", ne.dataTypes) < 0 && (ne.converters["text script"] = function() {}), an = Vo(ne, an, et, hn), hn ? (ne.ifModified && (Ln = et.getResponseHeader("Last-Modified"), Ln && (d.lastModified[p] = Ln), Ln = et.getResponseHeader("etag"), Ln && (d.etag[p] = Ln)), ft === 204 || ne.type === "HEAD" ? vn = "nocontent" : ft === 304 ? vn = "notmodified" : (vn = an.state, Jn = an.data, Qn = an.error, hn = !Qn)) : (Qn = vn, (ft || !vn) && (vn = "error", ft < 0 && (ft = 0))), et.status = ft, et.statusText = (Dt || vn) + "", hn ? st.resolveWith(ce, [Jn, vn, et]) : st.rejectWith(ce, [et, vn, Qn]), et.statusCode(zt), zt = void 0, Z && Ge.trigger(hn ? "ajaxSuccess" : "ajaxError", [et, ne, hn ? Jn : Qn]), je.fireWith(ce, [et, vn]), Z && (Ge.trigger("ajaxComplete", [et, ne]), --d.active || d.event.trigger("ajaxStop")))
                }
                return et
            },
            ...
            if (!!E) {
                ...
                for (var he = l ? [l] : i.keys(E); O < he.length; O++) {
                    ...
                    for (var De = [], it = 0; it < Ie.length; it++) {
                        var Ct = Ie[it];
                        g && g !== Ct.callback && g !== Ct.callback._callback || V && V !== Ct.context ? De.push(Ct) : (M = Ct.listening, M && --M.count === 0 && (delete te[M.id], delete M.listeningTo[M.objId]))
                    }
            ...
            set: function(E, l) {
                if (E != null) {
                    ...
                    for (yt = 0; yt < E.length; yt++) {
                        ...
                        if (bt) {
                            if (Ie && ct !== bt) {
                                ...
                                l.parse && (Kt = bt.parse(Kt, l)), bt.set(Kt, l), V.push(bt), Ct && !it && (it = bt.hasChanged(rn))
                            }
                    ...
                    if (O.length && Mt ? (Je = this.length !== O.length || i.some(this.models, function(j, N) {
                            return j !== O[N]
                        }), this.models.length = 0, Me(this.models, O, 0), this.length = this.models.length) : M.length && (Ct && (it = !0), Me(this.models, M, _ == null ? this.length : _), this.length = this.models.length), it && this.sort({
                            silent: !0
                        }), !l.silent) {
                        for (yt = 0; yt < M.length; yt++) _ != null && (l.index = _ + yt), ct = M[yt], ct.trigger("add", ct, this, l);
                        (it || Je) && this.trigger("sort", this, l), (M.length || te.length || V.length) && (l.changes = {
                            added: M,
                            removed: te,
                            merged: V
...
function md(t) {
    return t == null ? t === void 0 ? gd : pd : bl && bl in Object(t) ? dd(t) : fd(t)
}
var fo = md;
...
var eg = Zp,
    ...
    tg = us,
    Rc = Object.prototype,
    ng = Rc.hasOwnProperty,
    ig = Rc.propertyIsEnumerable,
    rg = Tl(function() {
        return arguments
    }()) ? Tl : function(t) {
...
var kg = Sg,
    ...
    Lt = {};
Lt[Gg] = Lt[qg] = Lt[Wg] = Lt[Xg] = Lt[Yg] = Lt[Kg] = Lt[Jg] = Lt[Qg] = Lt[Zg] = !0;
Lt[Rg] = Lt[Ig] = Lt[Hg] = Lt[Dg] = Lt[Ug] = Lt[Lg] = Lt[Mg] = Lt[Pg] = Lt[Ng] = Lt[Vg] = Lt[Bg] = Lt[$g] = Lt[jg] = Lt[Fg] = Lt[zg] = !1;
...
function av(t, e, n, i, a, f, v) {
    ...
    if ($) {
        var J = Dl(k),
            ie = !J && tv(k),
            Y = !J && !ie && sv(k);
        D = k, J || ie || Y ? Dl(S) ? D = S : ev(S) ? D = Qm(S) : ie ? ($ = !1, D = Km(k, !0)) : Y ? ($ = !1, D = Jm(k, !0)) : D = [] : rv(k) || Il(k) ? (D = S, Il(S) ? D = ov(S) : (!iv(S) || nv(S)) && (D = Zm(k))) : $ = !1
    }
...
function $c(t, e, n, i, a) {
    t !== e && hv(e, function(f, v) {
        if (a || (a = new cv), fv(f)) dv(t, e, v, n, $c, i, a);
        else {
...
ot(_a, "locale"), ot(_a, "supported", ["en", "fr", "it", "de", "es", "es-XL"]);
const ml = class {
...
var iy = function() {
    ...
    ry = iy,
    sy = function() {
        return typeof Nl != "function" || typeof Symbol != "function" || typeof Nl("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : ry()
    },
...
var ia = function() {
    ...
    or = {},
    py = typeof Uint8Array > "u" ? mt : li(Uint8Array),
    hr = {
    ...
    Bl = hs.call(Function.call, String.prototype.replace),
    ...
    Cy = function(e) {
        ...
        var a = [];
        return Bl(e, wy, function(f, v, S, k) {
            a[a.length] = S ? Bl(k, by, "$1") : v || f
        }), a
    },
    xy = function(e, n) {
        var i = e,
            a;
        if (Js(Vl, i) && (a = Vl[i], i = "%" + a[0] + "%"), Js(hr, i)) {
            var f = hr[i];
...
var Hc = Ua,
    Uc = zc.exports,
    Ey = Uc(Hc("String.prototype.indexOf")),
    _y = function(e, n) {
        var i = Hc(e, !!n);
        return typeof i == "function" && Ey(e, ".prototype.") > -1 ? Uc(i) : i
    };
const Sy = {},
...
var Ga = typeof Map == "function" && Map.prototype,
    ra = Object.getOwnPropertyDescriptor && Ga ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null,
    Zs = Ga && ra && typeof ra.get == "function" ? ra.get : null,
    Ay = Ga && Map.prototype.forEach,
    qa = typeof Set == "function" && Set.prototype,
    sa = Object.getOwnPropertyDescriptor && qa ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null,
    eo = qa && sa && typeof sa.get == "function" ? sa.get : null,
    Oy = qa && Set.prototype.forEach,
    ...
    $l = Dy ? WeakRef.prototype.deref : null,
...
var Aa = Ty,
    ...
    $y = function t(e, n, i, a) {
        ...
        if (Xc(e)) {
            var re = mr ? di.call(String(e), /^(Symbol\(.*\))_[^)]*$/, "$1") : Ta.call(e);
            return typeof e == "object" && !mr ? Yr(re) : re
        }
        if (ew(e)) {
            for (var m = "<" + jl.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + Wc(jy(P[q].value), "double", f);
            return m += ">", e.childNodes && e.childNodes.length && (m += "..."), m += "</" + jl.call(String(e.nodeName)) + ">", m
        }
        if (Oa(e)) {
            if (e.length === 0) return "[]";
            var ae = Ms(e, J);
            return $ && !nw(ae) ? "[" + Ra(ae, $) + "]" : "[ " + Fn.call(ae, ", ") + " ]"
        }
        if (zy(e)) {
            var se = Ms(e, J);
            return !("cause" in Error.prototype) && "cause" in e && !qc.call(e, "cause") ? "{ [" + String(e) + "] " + Fn.call(Fl.call("[cause]: " + J(e.cause), se), ", ") + " }" : se.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + Fn.call(se, ", ") + " }"
        }
        if (typeof e == "object" && v) {
            if (ql && typeof e[ql] == "function" && Aa) return Aa(e, {
                depth: D - i
            });
        ...
        if (Ky(e)) return aa("WeakMap");
        if (Zy(e)) return aa("WeakSet");
        if (Jy(e)) return aa("WeakRef");
        if (Uy(e)) return Yr(J(Number(e)));
        if (qy(e)) return Yr(J(ka.call(e)));
        if (Gy(e)) return Yr(Ly.call(e));
        if (Hy(e)) return Yr(J(String(e)));
        if (!Fy(e) && !Wl(e)) {
            var Ee = Ms(e, J),
                ...
                K = Be + (lt || Me ? "[" + Fn.call(Fl.call([], lt || [], Me || []), ": ") + "] " : "");
            return Ee.length === 0 ? K + "{}" : $ ? K + "{" + Ra(Ee, $) + "}" : K + "{ " + Fn.call(Ee, ", ") + " }"
        }
        return String(e)
    };
...
function Kc(t, e) {
    ...
    var a = di.call(di.call(t, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, tw);
...
var Xa = Ua,
    ...
    gw = function() {
        var e, n, i, a = {
            ...
            set: function(f, v) {
                Ps && f && (typeof f == "object" || typeof f == "function") ? (e || (e = new Ps), aw(e, f, v)) : Ns ? (n || (n = new Ns), uw(n, f, v)) : (i || (i = {
                    key: {},
                    next: null
                }), fw(i, f, v))
            }
    ...
    bw = function t(e, n, i) {
        ...
        var a = e;
        return Di(e) && !Di(n) && (a = Jc(e, i)), Di(e) && Di(n) ? (n.forEach(function(f, v) {
            if (ca.call(e, v)) {
                var S = e[v];
            ...
            var S = n[v];
            return ca.call(f, v) ? f[v] = t(f[v], S, i) : f[v] = S, f
        }, a)
    },
    Cw = function(e, n) {
    ...
    ua = {},
    Mw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        for (var P = e, q = m, ae = 0, se = !1;
            (q = q.get(ua)) !== void 0 && !se;) {
            var ve = q.get(e);
            if (ae += 1, typeof ve < "u") {
                if (ve === ae) throw new RangeError("Cyclic object value");
                se = !0
            }
            typeof q.get(ua) > "u" && (ae = 0)
        }
        if (typeof k == "function" ? P = k(n, P) : P instanceof Date ? P = $(P) : i === "comma" && ti(P) && (P = Ia.maybeMap(P, function(ue) {
                return ue instanceof Date ? $(ue) : ue
            })), P === null) {
            if (f) return S && !Y ? S(n, tn.encoder, re, "key", J) : n;
            P = ""
        }
        if (Lw(P) || Ia.isBuffer(P)) {
            if (S) {
                var d = Y ? n : S(n, tn.encoder, re, "key", J);
                if (i === "comma" && Y) {
                    for (var Ee = Rw.call(String(P), ","), Ae = "", Me = 0; Me < Ee.length; ++Me) Ae += (Me === 0 ? "" : ",") + ie(S(Ee[Me], tn.encoder, re, "value", J));
        ...
        for (var Fe = a && ti(P) && P.length === 1 ? n + "[]" : n, U = 0; U < Be.length; ++U) {
            ...
            if (!(v && Te === null)) {
                ...
                m.set(e, ae);
                var ye = Zc();
                ye.set(ua, m), eu(lt, t(Te, we, i, a, f, v, S, k, I, D, $, J, ie, Y, re, ye))
            }
        }
        return lt
    },
    ...
    Nw = function(t, e) {
        ...
        for (var D = Zc(), $ = 0; $ < a.length; ++$) {
            var J = a[$];
            i.skipNulls && n[J] === null || eu(v, Mw(n[J], J, k, I, i.strictNullHandling, i.skipNulls, i.encode ? i.encoder : null, i.filter, i.sort, i.allowDots, i.serializeDate, i.format, i.formatter, i.encodeValuesOnly, i.charset, D))
        }
    ...
    Fw = function(e, n) {
        ...
        for (k = 0; k < v.length; ++k)
            if (k !== S) {
                ...
                })), Y && n.interpretNumericEntities && I === "iso-8859-1" && (Y = Bw(Y)), D.indexOf("[]=") > -1 && (Y = Vw(Y) ? [Y] : Y), Da.call(i, ie) ? i[ie] = vr.combine(i[ie], Y) : i[ie] = Y
            } return i
    },
    zw = function(t, e, n, i) {
...
var sb = ar,
    ...
    Ql = dr && typeof dr.apply == "function" ? dr.apply : function(e, n, i) {
...
Rt.prototype.emit = function(e) {
    ...
    if (typeof k == "function") Ql(k, this, n);
        ...
        for (var I = k.length, D = cu(k, I), i = 0; i < I; ++i) Ql(D[i], this, n);
    return !0
};
...
function su(t, e, n, i) {
    ...
    else if (typeof v == "function" ? v = f[e] = i ? [n, v] : [v, n] : i ? v.unshift(n) : v.push(n), a = ru(t), a > 0 && v.length > a && !v.warned) {
        v.warned = !0;
...
Rt.prototype.once = function(e, n) {
    return vo(n), this.on(e, ou(this, e, n)), this
};
Rt.prototype.prependOnceListener = function(e, n) {
    return vo(n), this.prependListener(e, ou(this, e, n)), this
};
...
function au(t, e, n) {
    ...
    if (i === void 0) return [];
    var a = i[e];
    return a === void 0 ? [] : typeof a == "function" ? n ? [a.listener || a] : [a] : n ? cb(a) : cu(a, a.length)
}
    ...
    (function(n, i) {
        ...
        function Ee(j, N) {
            ...
            var W = re.exec(j),
                ...
                pe = 0,
                Ne;
            return G ? fe ? (Ne = W[2] + W[3] + W[4], pe = W[2].length + W[3].length) : (Ne = W[2] + W[4], pe = W[2].length) : fe ? (Ne = W[3] + W[4], pe = W[3].length) : Ne = W[4], L === "file:" ? pe >= 2 && (Ne = Ne.slice(2)) : d(L) ? Ne = W[4] : L ? G && (Ne = Ne.slice(2)) : pe >= 2 && d(N.protocol) && (Ne = W[4]), {
                protocol: L,
                slashes: G || d(L),
                slashesCount: pe,
                rest: Ne
        ...
        function Me(j, N, W) {
            ...
            var L, G, fe, pe, Ne, Ve, pt = ae.slice(),
                jt = typeof N,
                Ye = this,
                In = 0;
        ...
        var De = function(j) {
            ...
            return W.onopen.get = function() {
                ...
                if (!(this.readyState === N.CLOSING || this.readyState === N.CLOSED)) {
                    var Ne = te(this);
                    this.readyState === N.CONNECTING ? O(Ne, G || ke.CLOSE_ABNORMAL, fe) : _(Ne, G || ke.CLOSE_NO_STATUS, fe)
                }
...
class ii {
    ...
    static async init(e) {
        ...
        this.bannerData = await this.loadBannerData(e), this.bannerData && (this.view = new oC({
            model: new nt.Model(this.bannerData)
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/pp6-ridictionary/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
...
const hC = `<form>\r
    ...
    no = Et.View.extend({
        ...
        onAttach() {
            this.getOption("preventAutosize") || ac(Pe("textarea"))
        },
        onSubmitClick() {
        ...
        clearInput() {
            ...
            Pe(t).val(""), this.getOption("preventAutosize") || ac.update(t), this.onInputChange()
        },
        setValue(t) {
    ...
    ri = Et.CollectionView.extend({
        tagName: "div",
        className: "choices",
        childView(t) {
            return t.get("type") === "input" ? no : t.get("type") === "text" ? Bi : to
        },
        collection: new nt.Collection([]),
        initialize(t) {
...
function fC(t) {
    ...
    return Us = Jr.getContext("2d"), Us.imageSmoothingEnabled = !1, Ku("init"), {
        canvas: Jr,
        context: Us
    }
}
...
`).replace(/(^|\n)\s*/g, ""),
            ...
            vi = c => {
                ...
                b.className = K.container, h && Je(b, K["no-transition"]), it(b, Sr);
                const B = Tr(c.target);
            ...
            wi = (c, h) => {
                const b = g(),
                    B = E();
                !h.showConfirmButton && !h.showDenyButton && !h.showCancelButton ? L(b) : W(b), ct(b, h, "actions"), Un(b, B, h), it(B, h.loaderHtml), ct(B, h, "loader")
            };
        ...
        const Ui = (c, h) => {
            ...
            Rr = (c, h) => {
                ...
                Je(c, Fe[h.icon]), Cn(c, h), Gi(), ct(c, h, "icon")
            },
            Gi = () => {
                const c = we(),
...
`,
            ms = (c, h) => {
                let b = c.innerHTML,
                    B;
                h.iconHtml ? B = Ir(h.iconHtml) : h.icon === "success" ? (B = gs, b = b.replace(/ style=".*?"/g, "")) : h.icon === "error" ? B = _o : B = Ir({
                    question: "?",
                    warning: "!",
                    info: "i"
            ...
            Dr = (c, h) => {
                const b = U(),
                    B = we();
                h.toast ? (N(b, "width", h.width), B.style.width = "100%", B.insertBefore(E(), ye())) : N(B, "width", h.width), N(B, "padding", h.padding), h.color && (B.style.color = h.color), h.background && (B.style.background = h.background), L(Ke()), To(B, h)
            },
            To = (c, h) => {
            ...
            Lr = (c, h) => {
                Dr(c, h), Ze(c, h), So(c, h), Or(c, h), Ci(c, h), Xn(c, h), Eo(c, h), Ui(c, h), wi(c, h), xo(c, h), typeof h.didRender == "function" && h.didRender(we())
            },
            Yn = Object.freeze({
                cancel: "cancel",
                backdrop: "backdrop",
            ...
            Ao = c => {
                ...
                if (!h) return {};
                const b = h.content;
                return Lo(b), Object.assign(vs(b), Oo(b), Ro(b), Pr(b), Io(b), Do(b, qi))
            },
            vs = c => {
                const h = {};
...
`).join("<br />")), vi(c)
        ...
        const bs = () => {
            ...
            jr = c => {
                ...
                r(h, b, c), setTimeout(() => {
                    $o(h, b)
                }, $r), Se() && (jo(h, c.scrollbarPadding, ge), xi()), !he() && !rt.previousActiveElement && (rt.previousActiveElement = document.activeElement), typeof c.didOpen == "function" && setTimeout(() => c.didOpen(b)), Mt(h, K["no-transition"])
            },
            Es = c => {
                const h = we();
                ...
                select: (c, h, b) => {
                    ...
                    h.forEach(He => {
                        ...
                        if (Array.isArray(Bn)) {
                            ...
                            pn.label = Ut, pn.disabled = !1, B.appendChild(pn), Bn.forEach(nr => ge(pn, nr[1], nr[0]))
                        } else ge(B, Bn, Ut)
                    }), B.focus()
                },
                radio: (c, h, b) => {
                    ...
                    h.forEach(He => {
                        ...
                        it(Qo, Bn), Qo.className = K.label, nr.appendChild(pn), nr.appendChild(Qo), B.appendChild(nr)
                    });
        ...
        function Ln(c, h, b, B) {
            he() ? ks(c, B) : (gi(b).then(() => ks(c, B)), et(rt)), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (h.setAttribute("style", "display:none !important"), h.removeAttribute("class"), h.innerHTML = "") : h.remove(), Se() && (Vr(), Ei(), Mr()), vn()
        }
        ...
        const gt = c => {
            ...
            zr = (c, h, b, B, ge) => {
                rt.swalCloseEventFinishedCallback = Ln.bind(null, c, b, B, ge), h.addEventListener(mn, function(He) {
        ...
        function Wo() {
            ...
            c.popup && rt.swalCloseEventFinishedCallback && (rt.swalCloseEventFinishedCallback(), delete rt.swalCloseEventFinishedCallback), typeof h.didDestroy == "function" && h.didDestroy(), Hr(this)
        }
        const Hr = c => {
                An(c), delete c.params, delete rt.keydownHandler, delete rt.keydownTarget, delete rt.currentInstance
            },
            An = c => {
        ...
        const Os = c => {
            ...
            Yo = (c, h, b) => {
                A.innerParams.get(c).toast ? Ko(c, h, b) : (Gr(h), Ds(h), Qi(c, h, b))
            },
            Ko = (c, h, b) => {
                h.popup.onclick = () => {
                    const B = A.innerParams.get(c);
        ...
        const Xe = (c, h, b) => new Promise((B, ge) => {
                ...
                je.swalPromiseResolve.set(c, B), je.swalPromiseReject.set(c, ge), h.confirmButton.onclick = () => Os(c), h.denyButton.onclick = () => Rs(c), h.cancelButton.onclick = () => Xo(c, He), h.closeButton.onclick = () => He(Yn.close), Yo(c, h, He), on(c, rt, b, He), p(c, b), jr(b), We(rt, b, He), Ht(h, b), setTimeout(() => {
...
class Ot {
    static get DismissReason() {
        return bn.DismissReason
    }
    static show(e, n = {}) {
        switch (bn.isVisible() && bn.close(), e instanceof Error && (n.text = e.message, e = "error"), e) {
            case "alert":
    ...
    static async showAlert(e) {
        ...
        return e.customClass = {
            ...n,
            popup: "jbgModal"
        }, e.titleText = e.titleText || "Error", bn.fire(e)
    }
    static async showError(e) {
        const n = new URL("jackbox/main/pp6/ridictionary/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
        }, e.titleText = e.titleText || "Error", n && (e.imageUrl = n), bn.fire(e)
    }
    static async showCustom(e) {
        return bn.fire(e)
    }
    static async showToast(e) {
        return e.toast = !0, e.showConfirmButton = !1, e.timer = e.timer || 2500, e.position = e.position || "bottom", bn.fire(e)
    }
}
...
<div style="display:none;">\r
    ...
    xC = Et.View.extend({
        ...
        onAttach() {
            ...
            this.cameraSprite = hl(CC), this.cameraSprite.width = this.model.get("width"), this.cameraSprite.height = this.model.get("height"), this.cameraSprite.mask = this.model.get("mask"), t.sprites.push(this.cameraSprite), t.gameLoop.start(), this.facingMode = "user", this.startCamera(), this.onResize()
        },
        async startCamera() {
    ...
    Pn = nt.Model.extend({
        ...
        set(t, e) {
            ...
            return nt.Model.prototype.set.apply(this, [n, e]), this
        },
        setUpdate(t, e) {
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp6/ridictionary/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
class RC {
    constructor(e, n = {}) {
        ...
        this.canvasSelector = e, this.canvas = Pe(this.canvasSelector)[0], this.ctx = this.canvas.getContext("2d"), this.options = Object.assign(uc, n), this.history = [], this.layerNames.forEach(i => {
    ...
    PC = Et.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new Bi({}), this.toolbarComponent = this.toolbarComponent || new OC({
                ...
                model: new nt.Model
            }), this.buttonsCollection = this.buttonsCollection || new nt.Collection([]), this.buttonsComponent = this.buttonsComponent || new ri({
                block: !1,
    ...
    dl = Et.View.extend({
        ...
        initialize() {
            this.currentEntry = null, this.shouldSubmit = !1, this.promptComponent = new Bi({
                ...
                model: new nt.Model({})
            }), this.buttonsCollection = this.buttonsCollection || new nt.Collection([{
                text: "submit"
...
Et.View.extend({
    ...
    client: null,
    initialize(t) {
        this.client = t.client, this.mergeOptions(t, ["appId", "appTag"]), this.model = new nt.Model({});
    ...
    FC = Et.View.extend({
        ...
        initialize() {
            this.titleComponent = new Bi({
                model: new nt.Model({})
            }), this.choicesListView = this.choicesListView || new ri, this.charactersListView = new Et.CollectionView({
                childView: jC,
    ...
    io = Et.View.extend({
        ...
        onChildviewChildviewButtonCensor(t) {
            ...
            if (this.model.get("censorDialog") === "confirm") t.get("isWarned") ? this.triggerMethod("client:message", {
                ...
                if (this.model.get("censorDialog") === "warning") return bn.close(), bn.fire({
                    customClass: {
                        popup: "Dialog",
                        container: "container",
                        content: "content",
...
var ai = si(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
    fs = si(/Edge/i),
    dc = si(/firefox/i),
    ss = si(/safari/i) && !si(/chrome/i) && !si(/android/i),
    Zu = si(/iP(ad|od|hone)/i),
    eh = si(/chrome/i) && si(/android/i),
    th = {
        capture: !1,
        passive: !1
    };
...
function xt(t, e, n) {
    t.addEventListener(e, n, !ai && th)
}

function wt(t, e, n) {
    t.removeEventListener(e, n, !ai && th)
}
...
function Yt(t, e, n, i, a) {
    if (!(!t.getBoundingClientRect && t !== window)) {
        var f, v, S, k, I, D, $;
        if (t !== window && t.parentNode && t !== zn() ? (f = t.getBoundingClientRect(), v = f.top, S = f.left, k = f.bottom, I = f.right, D = f.height, $ = f.width) : (v = 0, S = 0, k = window.innerHeight, I = window.innerWidth, D = window.innerHeight, $ = window.innerWidth), (e || n) && t !== window && (a = a || t.parentNode, !ai))
            do
...
function fl(t, e) {
    for (var n = t.lastElementChild; n && (n === Qe.ghost || tt(n, "display") === "none" || e && !ro(n, e));) n = n.previousElementSibling;
    return n || null
}
        ...
        animateAll: function(i) {
            ...
            t.forEach(function(S) {
                var k = 0,
                    ...
                    Y = S.rect,
                    re = pr(I, !0);
                re && ($.top -= re.f, $.left -= re.e), I.toRect = $, I.thisAnimationDuration && fa(J, $) && !fa(D, $) && (Y.top - $.top) / (Y.left - $.left) === (D.top - $.top) / (D.left - $.left) && (k = sx(Y, J, ie, a.options)), fa($, D) || (I.prevFromRect = D, I.prevToRect = $, k || (k = a.options.animation), a.animate(I, Y, $, k)), k && (f = !0, v = Math.max(v, k), clearTimeout(I.animationResetTimer), I.animationResetTimer = setTimeout(function() {
        ...
        animate: function(i, a, f, v) {
            if (v) {
                ...
                var S = pr(this.el),
                    ...
                    D = (a.left - f.left) / (k || 1),
                    $ = (a.top - f.top) / (I || 1);
                i.animatingX = !!D, i.animatingY = !!$, tt(i, "transform", "translate3d(" + D + "px," + $ + "px,0)"), this.forRepaintDummy = rx(i), tt(i, "transition", "transform " + v + "ms" + (this.options.easing ? " " + this.options.easing : "")), tt(i, "transform", "translate3d(0,0,0)"), typeof i.animated == "number" && clearTimeout(i.animated), i.animated = setTimeout(function() {
...
function ox(t) {
    ...
    if (e = e || n && n[kn], !!e) {
        ...
        var q = Hn(Hn({}, Y), ps.getEventProperties(i, e));
...
var Re, $t, ut, Pt, Ii, qs, Vt, hi, cr, Sn, as, ui, $s, en, lr = !1,
    so = !1,
    oo = [],
    Ai, Mn, ga, ma, mc, vc, Qr, sr, ls, cs = !1,
    js = !1,
    Ws, ln, va = [],
    Ma = !1,
    ao = [],
    ...
    Fs = Zu,
    yc = fs || ai ? "cssFloat" : "float",
    lx = Co && !eh && !Zu && "draggable" in document.createElement("div"),
    oh = function() {
        if (!!Co) {
            if (ai) return !1;
...
Co && !eh && document.addEventListener("click", function(t) {
...
Qe.prototype = {
    ...
    _onTapStart: function(e) {
        if (!!e.cancelable) {
            var n = this,
                ...
                D = a.filter;
            if (wx(i), !Re && !(/mousedown|pointerdown/.test(v) && e.button !== 0 || a.disabled) && !I.isContentEditable && !(!this.nativeDraggable && ss && k && k.tagName.toUpperCase() === "SELECT") && (k = jn(k, a.draggable, i, !1), !(k && k.animated) && qs !== k)) {
                if (cr = Rn(k), as = Rn(k, a.draggable), typeof D == "function") {
    ...
    _prepareDragStart: function(e, n, i) {
        ...
        if (i && !Re && i.parentNode === f) {
            ...
            if (Pt = f, Re = i, $t = Re.parentNode, Ii = Re.nextSibling, qs = i, $s = v.group, Qe.dragged = Re, Ai = {
                    ...
                    nh(Re, D.trim(), ya)
                }), xt(S, "dragover", Oi), xt(S, "mousemove", Oi), xt(S, "touchmove", Oi), xt(S, "mouseup", a._onDrop), xt(S, "touchend", a._onDrop), xt(S, "touchcancel", a._onDrop), dc && this.nativeDraggable && (this.options.touchStartThreshold = 4, Re.draggable = !0), wn("delayStart", this, {
                    evt: e
    ...
    _disableDelayedDrag: function() {
        Re && ya(Re), clearTimeout(this._dragStartTimer), this._disableDelayedDragEvents()
    },
    ...
    _triggerDragStart: function(e, n) {
        n = n || e.pointerType == "touch" && e, !this.nativeDraggable || n ? this.options.supportPointer ? xt(document, "pointermove", this._onTouchMove) : n ? xt(document, "touchmove", this._onTouchMove) : xt(document, "mousemove", this._onTouchMove) : (xt(Re, "dragend", this), xt(Pt, "dragstart", this._onDragStart));
        try {
    ...
    _dragStarted: function(e, n) {
        if (lr = !1, Pt && Re) {
            wn("dragStarted", this, {
                evt: n
            }), this.nativeDraggable && xt(document, "dragover", hx);
            var i = this.options;
            !e && _n(Re, i.dragClass, !1), _n(Re, i.ghostClass, !0), Qe.active = this, e && this._appendGhost(), gn({
                sortable: this,
                name: "start",
                originalEvent: n
            })
    ...
    _onTouchMove: function(e) {
        if (Ai) {
            var n = this.options,
                ...
                k = ut && v && v.d,
                I = Fs && ln && gc(ln),
                D = (f.clientX - Ai.clientX + a.x) / (S || 1) + (I ? I[0] - va[0] : 0) / (S || 1),
                $ = (f.clientY - Ai.clientY + a.y) / (k || 1) + (I ? I[1] - va[1] : 0) / (k || 1);
            if (!Qe.active && !lr) {
            ...
            if (ut) {
                ...
                tt(ut, "webkitTransform", J), tt(ut, "mozTransform", J), tt(ut, "msTransform", J), tt(ut, "transform", J), ga = D, ma = $, Mn = f
            }
    ...
    _appendGhost: function() {
        if (!ut) {
            ...
            if (Fs) {
                ...
                ln !== document.body && ln !== document.documentElement ? (ln === document && (ln = zn()), n.top += ln.scrollTop, n.left += ln.scrollLeft) : ln = zn(), va = gc(ln)
            }
            ut = Re.cloneNode(!0), _n(ut, i.ghostClass, !1), _n(ut, i.fallbackClass, !0), _n(ut, i.dragClass, !0), tt(ut, "transition", ""), tt(ut, "transform", ""), tt(ut, "box-sizing", "border-box"), tt(ut, "margin", 0), tt(ut, "top", n.top), tt(ut, "left", n.left), tt(ut, "width", n.width), tt(ut, "height", n.height), tt(ut, "opacity", "0.8"), tt(ut, "position", Fs ? "absolute" : "fixed"), tt(ut, "zIndex", "100000"), tt(ut, "pointerEvents", "none"), Qe.ghost = ut, e.appendChild(ut), tt(ut, "transform-origin", mc / parseInt(ut.style.width) * 100 + "% " + vc / parseInt(ut.style.height) * 100 + "%")
        }
    },
    _onDragStart: function(e, n) {
        ...
        wn("setupClone", this), Qe.eventCanceled || (Vt = sh(Re), Vt.removeAttribute("id"), Vt.draggable = !1, Vt.style["will-change"] = "", this._hideClone(), _n(Vt, this.options.chosenClass, !1), Qe.clone = Vt), i.cloneId = Xs(function() {
            wn("clone", i), !Qe.eventCanceled && (i.options.removeCloneOnHide || Pt.insertBefore(Vt, Re), i._hideClone(), gn({
                sortable: i,
                name: "clone"
            }))
        }), !n && _n(Re, f.dragClass, !0), n ? (so = !0, i._loopId = setInterval(i._emulateDragOver, 50)) : (wt(document, "mouseup", i._onDrop), wt(document, "touchend", i._onDrop), wt(document, "touchcancel", i._onDrop), a && (a.effectAllowed = "move", f.setData && f.setData.call(i, a, Re)), xt(document, "drop", i), tt(Re, "transform", "translateZ(0)")), lr = !0, i._dragStartId = Xs(i._dragStarted.bind(i, n, e)), xt(document, "selectstart", i), Qr = !0, ss && tt(document.body, "user-select", "none")
    },
    _onDragOver: function(e) {
        ...
        function q(ye) {
            return m("dragOverCompleted", {
                insertion: ye
            }), ye && (D ? I._hideClone() : I._showClone(Y), Y !== J && (_n(Re, en ? en.options.ghostClass : I.options.ghostClass, !1), _n(Re, S.ghostClass, !0)), en !== Y && Y !== Qe.active ? en = Y : Y === Qe.active && en && (en = null), J === Y && (Y._ignoreWhileAnimating = i), Y.animateAll(function() {
                m("dragOverAnimationComplete"), Y._ignoreWhileAnimating = null
            }), Y !== J && (J.animateAll(), J._ignoreWhileAnimating = null)), (i === Re && !Re.animated || i === n && !i.animated) && (sr = null), !S.dragoverBubble && !e.rootEl && i !== document && (Re.parentNode[kn]._isOutsideThisEl(e.target), !ye && Oi(e)), !S.dragoverBubble && e.stopPropagation && e.stopPropagation(), re = !0
        }

        function ae() {
            Sn = Rn(Re), ui = Rn(Re, S.draggable), gn({
                sortable: Y,
                name: "change",
                toEl: n,
                newIndex: Sn,
        ...
        if (so = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : en === this || (this.lastPutMode = $s.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            ...
            if (!se || gx(e, ie, this) && !se.animated) {
                ...
                var d = 0,
                    ...
                    Me = !cx(Re.animated && Re.toRect || a, i.animated && i.toRect || f, ie),
                    lt = ie ? "top" : "left",
                    Be = pc(i, "top", "top") || pc(Re, "top", "top"),
                    K = Be ? Be.scrollTop : void 0;
                sr !== i && (Ee = f[lt], cs = !1, js = !Me && S.invertSwap || Ae), d = mx(e, i, f, ie, Me ? 1 : S.swapThreshold, S.invertedSwapThreshold == null ? S.swapThreshold : S.invertedSwapThreshold, js, sr === i);
                var Fe;
                if (d !== 0) {
                    var U = Rn(Re);
                ...
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Ma = !0, setTimeout(fx, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), Be && rh(Be, 0, K - Be.scrollTop), $t = Re.parentNode, Ee !== void 0 && !js && (Ws = Math.abs(Ee - Yt(i)[lt])), ae(), q(!0)
            }
    ...
    _onDrop: function(e) {
        ...
        lr = !1, js = !1, cs = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), Pa(this.cloneId), Pa(this._dragStartId), this.nativeDraggable && (wt(document, "drop", this), wt(n, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), ss && tt(document.body, "user-select", ""), tt(Re, "transform", ""), e && (Qr && (e.cancelable && e.preventDefault(), !i.dropBubble && e.stopPropagation()), ut && ut.parentNode && ut.parentNode.removeChild(ut), (Pt === $t || en && en.lastPutMode !== "clone") && Vt && Vt.parentNode && Vt.parentNode.removeChild(Vt), Re && (this.nativeDraggable && wt(Re, "dragend", this), ya(Re), Re.style["will-change"] = "", Qr && !lr && _n(Re, en ? en.options.ghostClass : this.options.ghostClass, !1), _n(Re, this.options.chosenClass, !1), gn({
            ...
            toEl: $t,
            originalEvent: e
        })), Qe.active && ((Sn == null || Sn === -1) && (Sn = cr, ui = as), gn({
            sortable: this,
            name: "end",
            toEl: $t,
            originalEvent: e
    ...
    _nulling: function() {
        wn("nulling", this), Pt = Re = $t = ut = Ii = Vt = qs = hi = Ai = Mn = Qr = Sn = ui = cr = as = sr = ls = en = $s = Qe.dragged = Qe.ghost = Qe.clone = Qe.active = null, ao.forEach(function(e) {
            e.checked = !0
        }), ao.length = ga = ma = 0
    },
    ...
    toArray: function() {
        for (var e = [], n, i = this.el.children, a = 0, f = i.length, v = this.options; a < f; a++) n = i[a], jn(n, v.draggable, this.el, !1) && e.push(n.getAttribute(v.dataIdAttr) || yx(n));
        return e
    },
    sort: function(e, n) {
        var i = {},
    ...
    _showClone: function(e) {
        ...
        if (hi) {
            ...
            Re.parentNode == Pt && !this.options.group.revertClone ? Pt.insertBefore(Vt, Re) : Ii ? Pt.insertBefore(Vt, Ii) : Pt.appendChild(Vt), this.options.group.revertClone && this.animate(Re, Vt), tt(Vt, "display", ""), hi = !1
        }
    }
};
...
function mx(t, e, n, i, a, f, v, S) {
    ...
    if (!v) {
        ...
        } else if (k > D + I * (1 - a) / 2 && k < $ - I * (1 - a) / 2) return vx(e)
    }
...
Co && xt(document, "touchmove", function(t) {
...
function bx() {
    ...
    return t.prototype = {
        ...
        drop: function() {
            this.sortable.nativeDraggable ? wt(document, "dragover", this._handleAutoScroll) : (wt(document, "pointermove", this._handleFallbackAutoScroll), wt(document, "touchmove", this._handleFallbackAutoScroll), wt(document, "mousemove", this._handleFallbackAutoScroll)), wc(), Ys(), nx()
        },
        nulling: function() {
            lo = Na = Zr = Va = es = wa = ba = null, qt.length = 0
        },
        ...
        _handleAutoScroll: function(n, i) {
            ...
            if (lo = n, i || this.options.forceAutoScrollFallback || fs || ai || ss) {
                Ca(n, this.options, S, i);
                var k = fi(S, !0);
                Va && (!es || f !== wa || v !== ba) && (es && wc(), es = setInterval(function() {
                    var I = fi(document.elementFromPoint(f, v), !0);
                    I !== k && (k = I, Ys()), Ca(n, a.options, I, i)
                }, 10), wa = f, ba = v)
            } else {
                if (!this.options.bubbleScroll || fi(S, !0) === zn()) {
                    Ys();
                    return
                }
                Ca(n, this.options, fi(S, !1), !1)
            }
        }
    }, oi(t, {
        pluginName: "scroll",
        ...
        if (!!e.scroll) {
            ...
            do {
                ...
                (qt[$].vx != K || qt[$].vy != Fe || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = Fe, clearInterval(qt[$].pid), (K != 0 || Fe != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    ...
                    typeof D == "function" && D.call(Qe.dragged.parentNode[kn], Te, oe, t, lo, qt[this.layer].el) !== "continue" || rh(qt[this.layer].el, Te, oe)
                }.bind({
                    layer: $
                }), 24))), $++
...
Qe.mount(new bx);
Qe.mount(gl, pl);
const Cx = `<div id="controller" class="state-controller controller-content">\r
    ...
    `),
        ...
        initialize() {
            this.rankedCollectionView = this.rankedCollectionView || new bc({
                ...
                collection: new nt.Collection([])
            }), this.lockInView = this.lockInView || new to({
                block: !1,
                model: new nt.Model({
                    action: "lock",
                    html: "Lock In"
    ...
    Ox = `<svg id="range-picker" class="range-picker" viewBox="-40 -40 80 80">
    <defs>
    ...
    Ix = `<div id="status-bar" class="health text">\r
...
<div id="control-panel" class="control-panel">\r
    ...
    Lx = Et.View.extend({
        ...
        initialize(t) {
            this.client = t.client, this.radialComponent = new Rx({
                model: new nt.Model({
                    isTouching: !1,
                    angle: 0,
                    vector: {
    ...
    Mx = `<div id="textDescriptions" class="textDescriptions" role="log" aria-atomic="false" aria-relevant="additions" aria-live="polite"></div>
...
const $x = Et.View.extend({
    ...
    Fx = Pn.extend({
        defaults: at.extend({}, dl.prototype.model.defaults, {
            text: "",
            textOutput: "",
            word: ""
        })
    ...
    zx = dl.extend({
        ...
        onChildviewChildviewButtonPaste() {
            ...
            e = Pe("<div />").html(e).text();
            const n = t.prop("selectionStart"),
                i = t.val(),
                a = i.substring(0, n),
                f = i.substring(n, i.length);
            a.length > 0 && a[a.length - 1] !== " " && (e = ` ${e}`), f.length > 0 && f[0] !== " " && (e = `${e} `), t.val(a + e + f), t.focus(), t.prop("selectionStart", n + e.length), t.prop("selectionEnd", n + e.length), this.inputComponent.onInputChange()
        }
    }),
    Hx = Pn.extend({
        defaults: at.extend({}, io.prototype.model.defaults, {
            choiceType: ""
        })
    }),
    Ux = `
    ...
    Gx = to.extend({
        ...
        bindings: at.extend({}, to.prototype.bindings, {
            ".like-button": {
                attributes: [{
                    name: "aria-label",
                    observe: "className",
    ...
    Wx = io.extend({
        model: new Hx,
        initialize(t) {
            this.choicesList = this.choicesList || new qx({
                action: "choose",
                collection: new nt.Collection
            }), io.prototype.initialize.apply(this, [t])
        },
        onChildviewChildviewButtonCensor(t) {
            const e = t.get("index"),
                n = t.get("html");
            return bn.close(), bn.fire({
                text: n,
                customClass: {
                    popup: "ridictionary"
                },
...
const Xx = Px.extend({
    ...
    parseBlob(t) {
        ...
        return e.choiceId && e.classes.push(e.choiceId), e.state === "EnterSingleText" && e.word && (e.actions = [{
            text: "paste",
            action: "paste",
            block: !1
        }, {
...
//# sourceMappingURL=f666ae6b.js.map