...
var st = (t, e, n) => (mh(t, typeof e != "symbol" ? e + "" : e, n), n);
const vh = function() {
...
(function(t) {
    (function(e, n) {
        ...
        var Ae = function(r) {
            var s, u, p, w, x, T, z, H, Z, le, be, ne, ce, Ge, rt, Fe, zt, Nt, un, _t = "sizzle" + 1 * new Date,
                et = r.document,
                on = 0,
                ft = 0,
                Dt = Yi(),
            ...
            function St(R, j, X, de) {
                ...
                if (!de && (ne(j), j = j || ce, rt)) {
                    if (ht !== 11 && (Me = qo.exec(R)))
                        ...
                        if (Ue = R, Xe = j, ht === 1 && (Fo.test(R) || As.test(R))) {
                            for (Xe = Hr.test(R) && Gr(j.parentNode) || j, (Xe !== j || !u.scope) && ((Oe = j.getAttribute("id")) ? Oe = Oe.replace(Ur, Os) : j.setAttribute("id", Oe = _t)), ze = T(R), me = ze.length; me--;) ze[me] = (Oe ? "#" + Oe : ":scope") + " " + Qi(ze[me]);
                            Ue = ze.join(",")
                        }
                        try {
                ...
                return H(R.replace(Si, "$1"), j, X, de)
            }
            ...
            u = St.support = {}, x = St.isXML = function(R) {
                ...
                return !Ho.test(j || X && X.nodeName || "HTML")
                ...
                }), Fe = Fe.length && new RegExp(Fe.join("|")), zt = zt.length && new RegExp(zt.join("|")), j = ki.test(Ge.compareDocumentPosition), un = j || ki.test(Ge.contains) ? function(ee, me) {
                ...
                preFilter: {
                    ...
                    PSEUDO: function(R) {
                        var j, X = !R[6] && R[2];
                        return Xi.CHILD.test(R[0]) ? null : (R[3] ? R[2] = R[4] || R[5] || "" : X && jo.test(X) && (j = T(X, !0)) && (j = X.indexOf(")", X.length - j) - X.length) && (R[0] = R[0].slice(0, j), R[2] = X.slice(0, j)), R.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(R) {
                    ...
                    PSEUDO: function(R, j) {
                        ...
                        return de[_t] ? de(j) : de.length > 1 ? (X = [R, R, "", j], p.setFilters.hasOwnProperty(R.toLowerCase()) ? dn(function(ee, me) {
                            for (var xe, Oe = de(ee, j), Me = Oe.length; Me--;) xe = Qn(ee, Oe[Me]), ee[xe] = !(me[xe] = Oe[Me])
                        }) : function(ee) {
                            return de(ee, 0, X)
                        }) : de
                    }
            ...
            Ds.prototype = p.filters = p.pseudos, p.setFilters = new Ds, T = St.tokenize = function(R, j) {
                ...
                for (xe = R, Oe = [], Me = p.preFilter; xe;) {
                    ...
                    for (me in p.filter)(de = Xi[me].exec(xe)) && (!Me[me] || (de = Me[me](de))) && (X = de.shift(), ee.push({
                        value: X,
                        type: me,
                        matches: de
                    }), xe = xe.slice(X.length));
                ...
                return j ? xe.length : xe ? St.error(R) : _i(R, Oe).slice(0)
            };
            ...
            function qr(R, j, X, de, ee, me) {
                return de && !de[_t] && (de = qr(de)), ee && !ee[_t] && (ee = qr(ee, me)), dn(function(xe, Oe, Me, ze) {
                    var Ue, Xe, ht, Tt = [],
                        We = [],
                        Ht = Oe.length,
                        Jt = xe || Ko(j || "*", Me.nodeType ? [Me] : Me, []),
                        fn = R && (xe || !j) ? tr(Jt, Tt, R, Me, ze) : Jt,
                        At = X ? ee || (xe ? R : Ht || de) ? [] : Oe : fn;
                    if (X && X(fn, At, Me, ze), de)
                        for (Ue = tr(At, We), de(Ue, [], Me, ze), Xe = Ue.length; Xe--;)(ht = Ue[Xe]) && (At[We[Xe]] = !(fn[We[Xe]] = ht));
                    if (xe) {
                        if (ee || R) {
                            if (ee) {
            ...
            function Wr(R) {
                for (var j, X, de, ee = R.length, me = p.relative[R[0].type], xe = me || p.relative[" "], Oe = me ? 1 : 0, Me = Zi(function(Xe) {
                        return Xe === j
                    }, xe, !0), ze = Zi(function(Xe) {
                        return Qn(j, Xe) > -1
                    }, xe, !0), Ue = [function(Xe, ht, Tt) {
                        var We = !me && (Tt || ht !== Z) || ((j = ht).nodeType ? Me(Xe, ht, Tt) : ze(Xe, ht, Tt));
                        return j = null, We
                    }]; Oe < ee; Oe++)
            ...
            function Ms(R, j) {
                var X = j.length > 0,
                    ...
                    ee = function(me, xe, Oe, Me, ze) {
                        ...
                        if (Tt += We, X && We !== Tt) {
                            for (Xe = 0; ht = j[Xe++];) ht(Ht, Jt, xe, Oe);
                            if (me) {
                                if (Tt > 0)
                                    for (; We--;) Ht[We] || Jt[We] || (Jt[We] = Mn.call(Me));
                                Jt = tr(Jt)
                            }
                            Cn.apply(Me, Jt), ze && !me && Jt.length > 0 && Tt + j.length > 1 && St.uniqueSort(Me)
                        }
            ...
            return z = St.compile = function(R, j) {
                ...
                if (!me) {
                    ...
                    me = Wi(R, Ms(ee, de)), me.selector = R
                }
                return me
            }, H = St.select = function(R, j, X, de) {
                ...
                if (X = X || [], Ue.length === 1) {
                    ...
                    for (ee = Xi.needsContext.test(R) ? 0 : me.length; ee-- && (xe = me[ee], !p.relative[Oe = xe.type]);)
                        if ((Me = p.find[Oe]) && (de = Me(xe.matches[0].replace(Tn, xn), Hr.test(me[0].type) && Gr(j.parentNode) || j))) {
                            if (me.splice(ee, 1), R = de.length && Qi(me), !R) return Cn.apply(X, de), X;
                            break
                        }
                }
                return (ze || z(R, Ue))(de, j, !rt, X, !j || Hr.test(R) && Gr(j.parentNode) || j), X
        ...
        d.event = {
            ...
            add: function(r, s, u, p, w) {
                var x, T, z, H, Z, le, be, ne, ce, Ge, rt, Fe = he.get(r);
                if (!!te(r))
            ...
            remove: function(r, s, u, p, w) {
                var x, T, z, H, Z, le, be, ne, ce, Ge, rt, Fe = he.hasData(r) && he.get(r);
                if (!(!Fe || !(H = Fe.events))) {
                    for (s = (s || "").match(ke) || [""], Z = s.length; Z--;) {
                        ...
                        T && !ne.length && ((!be.teardown || be.teardown.call(r, Ge, Fe.handle) === !1) && d.removeEvent(r, ce, Fe.handle), delete H[ce])
                    }
        ...
        function Eo(r, s, u) {
            ...
            for (p in s)
                ...
                be && r.nodeType === 1 && (u.overflow = [Ge.overflow, Ge.overflowX, Ge.overflowY], Z = Fe && Fe.display, Z == null && (Z = he.get(r, "display")), le = d.css(r, "display"), le === "none" && (Z ? le = Z : (G([r], !0), Z = r.style.display || Z, le = d.css(r, "display"), G([r]))), (le === "inline" || le === "inline-block" && Z != null) && d.css(r, "float") === "none" && (H || (ne.done(function() {
                    Ge.display = Z
                ...
                for (p in ce) H || (Fe ? "hidden" in Fe && (rt = Fe.hidden) : Fe = he.access(r, "fxshow", {
                    display: Z
                }), x && (Fe.hidden = !rt), rt && G([r], !0), ne.done(function() {
                    rt || G([r]), he.remove(r, "fxshow");
                    for (p in ce) d.style(r, p, ce[p])
                })), H = gs(rt ? Fe[p] : 0, p, ne), p in Fe || (Fe[p] = H.start, rt && (H.end = H.start, H.start = 0))
            }
        }
        ...
        function bn(r, s, u) {
            var p, w, x = 0,
                ...
                H = function() {
                    if (w) return !1;
                    for (var be = jt || Rr(), ne = Math.max(0, Z.startTime + Z.duration - be), ce = ne / Z.duration || 0, Ge = 1 - ce, rt = 0, Fe = Z.tweens.length; rt < Fe; rt++) Z.tweens[rt].run(Ge);
...
`)
        ...
        d.extend({
            ...
            ajax: function(r, s) {
                ...
                Z = d.event && ne.global, Z && d.active++ === 0 && d.event.trigger("ajaxStart"), ne.type = ne.type.toUpperCase(), ne.hasContent = !Mo.test(ne.type), p = ne.url.replace(Io, ""), ne.hasContent ? ne.data && ne.processData && (ne.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (ne.data = ne.data.replace(Ro, "+")) : (be = ne.url.slice(p.length), ne.data && (ne.processData || typeof ne.data == "string") && (p += (qi.test(p) ? "&" : "?") + ne.data, delete ne.data), ne.cache === !1 && (p = p.replace(Do, "$1"), be = (qi.test(p) ? "&" : "?") + "_=" + Lr.guid++ + be), ne.url = p + be), ne.ifModified && (d.lastModified[p] && et.setRequestHeader("If-Modified-Since", d.lastModified[p]), d.etag[p] && et.setRequestHeader("If-None-Match", d.etag[p])), (ne.data && ne.hasContent && ne.contentType !== !1 || s.contentType) && et.setRequestHeader("Content-Type", ne.contentType), et.setRequestHeader("Accept", ne.dataTypes[0] && ne.accepts[ne.dataTypes[0]] ? ne.accepts[ne.dataTypes[0]] + (ne.dataTypes[0] !== "*" ? ", " + bs + "; q=0.01" : "") : ne.accepts["*"]);
                ...
                function on(ft, Dt, _i, Wi) {
                    ...
                    H || (H = !0, T && e.clearTimeout(T), u = void 0, w = Wi || "", et.readyState = ft > 0 ? 4 : 0, hn = ft >= 200 && ft < 300 || ft === 304, _i && (an = Po(ne, et, _i)), !hn && d.inArray("script", ne.dataTypes) > -1 && d.inArray("json", ne.dataTypes) < 0 && (ne.converters["text script"] = function() {}), an = No(ne, an, et, hn), hn ? (ne.ifModified && (Mn = et.getResponseHeader("Last-Modified"), Mn && (d.lastModified[p] = Mn), Mn = et.getResponseHeader("etag"), Mn && (d.etag[p] = Mn)), ft === 204 || ne.type === "HEAD" ? vn = "nocontent" : ft === 304 ? vn = "notmodified" : (vn = an.state, Kn = an.data, Jn = an.error, hn = !Jn)) : (Jn = vn, (ft || !vn) && (vn = "error", ft < 0 && (ft = 0))), et.status = ft, et.statusText = (Dt || vn) + "", hn ? rt.resolveWith(ce, [Kn, vn, et]) : rt.rejectWith(ce, [et, vn, Jn]), et.statusCode(zt), zt = void 0, Z && Ge.trigger(hn ? "ajaxSuccess" : "ajaxError", [et, ne, hn ? Kn : Jn]), Fe.fireWith(ce, [et, vn]), Z && (Ge.trigger("ajaxComplete", [et, ne]), --d.active || d.event.trigger("ajaxStop")))
                }
                return et
            },
                    ...
                    for (yt = 0; yt < E.length; yt++) {
                        ...
                        if (bt) {
                            if (Ie && ct !== bt) {
                                ...
                                l.parse && (Kt = bt.parse(Kt, l)), bt.set(Kt, l), V.push(bt), Ct && !nt && (nt = bt.hasChanged(rn))
                            }
...
function yd(t) {
    return t == null ? t === void 0 ? vd : md : Cl && Cl in Object(t) ? pd(t) : gd(t)
}
var ho = yd;
...
var Pd = Ld,
    ...
    qd = RegExp("^" + Ud.call(Gd).replace(Fd, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
...
var ng = tg,
    ...
    ig = us,
    Dc = Object.prototype,
    rg = Dc.hasOwnProperty,
    sg = Dc.propertyIsEnumerable,
    og = Al(function() {
        return arguments
    }()) ? Al : function(t) {
...
function Tg(t) {
    ...
    return typeof n == "function" && n instanceof n && Nc.call(n) == kg
}
var Ag = Tg,
    Og = ho,
    Rg = Pc,
...
Mt[Dg] = Mt[Mg] = Mt[Gg] = Mt[Lg] = Mt[qg] = Mt[Pg] = Mt[Ng] = Mt[Vg] = Mt[Bg] = Mt[$g] = Mt[Fg] = Mt[jg] = Mt[zg] = Mt[Hg] = Mt[Ug] = !1;
...
function cv(t, e, n, i, a, f, v) {
    ...
    if ($) {
        var J = Ml(k),
            ie = !J && iv(k),
            Y = !J && !ie && av(k);
        D = k, J || ie || Y ? Ml(S) ? D = S : nv(S) ? D = ev(S) : ie ? ($ = !1, D = Qm(k, !0)) : Y ? ($ = !1, D = Zm(k, !0)) : D = [] : ov(k) || Dl(k) ? (D = S, Dl(S) ? D = lv(S) : (!sv(S) || rv(S)) && (D = tv(k))) : $ = !1
    }
...
let nn = vl;
st(nn, "queryParams", new URLSearchParams(window.location.search)), st(nn, "getQueryParam", e => vl.queryParams.get(e)), st(nn, "sleep", e => new Promise(n => {
...
var sy = function() {
    ...
    oy = sy,
    ay = function() {
        return typeof Vl != "function" || typeof Symbol != "function" || typeof Vl("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : oy()
    },
...
var na = function() {
    ...
    or = {},
    my = typeof Uint8Array > "u" ? mt : li(Uint8Array),
    hr = {
    ...
    Ey = function(e) {
        ...
        var a = [];
        return $l(e, Cy, function(f, v, S, k) {
            a[a.length] = S ? $l(k, xy, "$1") : v || f
        }), a
    },
    _y = function(e, n) {
        var i = e,
        ...
        if (Js(Bl, i) && (a = Bl[i], i = "%" + a[0] + "%"), Js(hr, i)) {
            var f = hr[i];
            if (f === or && (f = vy(i)), typeof f > "u" && !n) throw new ur("intrinsic " + e + " exists, but is not available. Please file an issue!");
            return {
                alias: a,
                name: i,
                value: f
...
var Gc = qa,
    qc = Uc.exports,
    Sy = qc(Gc("String.prototype.indexOf")),
    ky = function(e, n) {
        var i = Gc(e, !!n);
        return typeof i == "function" && Sy(e, ".prototype.") > -1 ? qc(i) : i
    };
const Ty = {},
...
var Wa = typeof Map == "function" && Map.prototype,
    ia = Object.getOwnPropertyDescriptor && Wa ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null,
    Zs = Wa && ia && typeof ia.get == "function" ? ia.get : null,
    Ry = Wa && Map.prototype.forEach,
    Xa = typeof Set == "function" && Set.prototype,
    ra = Object.getOwnPropertyDescriptor && Xa ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null,
    eo = Xa && ra && typeof ra.get == "function" ? ra.get : null,
    Iy = Xa && Set.prototype.forEach,
    ...
    Fl = Ly ? WeakRef.prototype.deref : null,
    ...
    jy = function t(e, n, i, a) {
        ...
        function J(je, U, oe) {
            if (U && (a = Fy.call(a), a.push(U)), oe) {
                ...
                return ci(f, "quoteStyle") && (Te.quoteStyle = f.quoteStyle), t(je, Te, i + 1, a)
            }
            return t(je, f, i + 1, a)
        }
        ...
        if (nw(e)) {
            for (var m = "<" + jl.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + Yc(zy(P[q].value), "double", f);
            return m += ">", e.childNodes && e.childNodes.length && (m += "..."), m += "</" + jl.call(String(e.nodeName)) + ">", m
        }
        if (Aa(e)) {
            if (e.length === 0) return "[]";
            var ae = Ls(e, J);
            return $ && !rw(ae) ? "[" + Oa(ae, $) + "]" : "[ " + Fn.call(ae, ", ") + " ]"
        }
        if (Uy(e)) {
            var se = Ls(e, J);
            return !("cause" in Error.prototype) && "cause" in e && !Xc.call(e, "cause") ? "{ [" + String(e) + "] " + Fn.call(zl.call("[cause]: " + J(e.cause), se), ", ") + " }" : se.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + Fn.call(se, ", ") + " }"
        }
        if (typeof e == "object" && v) {
            if (Wl && typeof e[Wl] == "function" && Ta) return Ta(e, {
                depth: D - i
            });
        ...
        if (Jy(e)) {
            var ve = [];
            return Ry.call(e, function(je, U) {
                ve.push(J(U, e, !0) + " => " + J(je, e))
            }), Yl("Map", Zs.call(e), ve, $)
        }
        if (ew(e)) {
            var d = [];
            return Iy.call(e, function(je) {
                d.push(J(je, e))
            }), Yl("Set", eo.call(e), d, $)
        }
        ...
        if (!Hy(e) && !Xl(e)) {
            var Ee = Ls(e, J),
                ...
                K = Be + (lt || Le ? "[" + Fn.call(zl.call([], lt || [], Le || []), ": ") + "] " : "");
            return Ee.length === 0 ? K + "{}" : $ ? K + "{" + Oa(Ee, $) + "}" : K + "{ " + Fn.call(Ee, ", ") + " }"
        }
        return String(e)
    };
...
function Ls(t, e) {
    ...
    for (var k in t) !ci(t, k) || n && String(Number(k)) === k && k < t.length || mr && v["$" + k] instanceof Symbol || (Wc.call(/[^\w$]/, k) ? i.push(e(k, t) + ": " + e(t[k], t)) : i.push(k + ": " + e(t[k], t)));
...
var Ka = qa,
    ...
    vw = function() {
        var e, n, i, a = {
            ...
            set: function(f, v) {
                Ps && f && (typeof f == "object" || typeof f == "function") ? (e || (e = new Ps), cw(e, f, v)) : Ns ? (n || (n = new Ns), dw(n, f, v)) : (i || (i = {
                    key: {},
                    next: null
                }), gw(i, f, v))
            }
    ...
    Nw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        ...
        if (Pw(P) || Ra.isBuffer(P)) {
            if (S) {
                ...
                if (i === "comma" && Y) {
                    for (var Ee = Dw.call(String(P), ","), Ae = "", Le = 0; Le < Ee.length; ++Le) Ae += (Le === 0 ? "" : ",") + ie(S(Ee[Le], tn.encoder, re, "value", J));
        ...
        for (var je = a && ei(P) && P.length === 1 ? n + "[]" : n, U = 0; U < Be.length; ++U) {
            ...
            if (!(v && Te === null)) {
                var we = ei(P) ? typeof i == "function" ? i(je, oe) : je : je + (D ? "." + oe : "[" + oe + "]");
                m.set(e, ae);
                var ye = tu();
                ye.set(ca, m), nu(lt, t(Te, we, i, a, f, v, S, k, I, D, $, J, ie, Y, re, ye))
            }
        }
        return lt
    },
    ...
    Bw = function(t, e) {
        ...
        for (var D = tu(), $ = 0; $ < a.length; ++$) {
            var J = a[$];
            i.skipNulls && n[J] === null || nu(v, Nw(n[J], J, k, I, i.strictNullHandling, i.skipNulls, i.encode ? i.encoder : null, i.filter, i.sort, i.allowDots, i.serializeDate, i.format, i.formatter, i.encodeValuesOnly, i.charset, D))
        }
    ...
    Hw = function(e, n) {
        ...
        if (n.charsetSentinel)
            for (k = 0; k < v.length; ++k) v[k].indexOf("utf8=") === 0 && (v[k] === zw ? I = "utf-8" : v[k] === jw && (I = "iso-8859-1"), S = k, k = v.length);
        for (k = 0; k < v.length; ++k)
            if (k !== S) {
                ...
                })), Y && n.interpretNumericEntities && I === "iso-8859-1" && (Y = Fw(Y)), D.indexOf("[]=") > -1 && (Y = $w(Y) ? [Y] : Y), Ia.call(i, ie) ? i[ie] = vr.combine(i[ie], Y) : i[ie] = Y
            } return i
    },
    Uw = function(t, e, n, i) {
...
function cu(t, e, n) {
    ...
    if (i === void 0) return [];
    var a = i[e];
    return a === void 0 ? [] : typeof a == "function" ? n ? [a.listener || a] : [a] : n ? hb(a) : hu(a, a.length)
}
...
(function(t, e) {
    (function(n, i) {
        ...
        function D(F, N) {
            ...
            for (G in F)
                if (f.call(F, G)) {
                    if (M = F[G], !M && (M === null || M === v || isNaN(M)) && (M = ""), G = k(G), M = k(M), G === null || M === null) continue;
                    W.push(G + "=" + M)
        ...
        function ve(F) {
            ...
            var M = {},
                G = typeof F,
                fe;
            if (F.protocol === "blob:") M = new Le(unescape(F.pathname), {});
            else if (G === "string") {
                M = new Le(F, {});
        ...
        function Ee(F, N) {
            ...
            var W = re.exec(F),
                ...
                pe = 0,
                Ne;
            return G ? fe ? (Ne = W[2] + W[3] + W[4], pe = W[2].length + W[3].length) : (Ne = W[2] + W[4], pe = W[2].length) : fe ? (Ne = W[3] + W[4], pe = W[3].length) : Ne = W[4], M === "file:" ? pe >= 2 && (Ne = Ne.slice(2)) : d(M) ? Ne = W[4] : M ? G && (Ne = Ne.slice(2)) : pe >= 2 && d(N.protocol) && (Ne = W[4]), {
                protocol: M,
                slashes: G || d(M),
                slashesCount: pe,
                rest: Ne
        ...
        function Ae(F, N) {
            if (F === "") return N;
            for (var W = (N || "/").split("/").slice(0, -1).concat(F.split("/")), M = W.length, G = W[M - 1], fe = !1, pe = 0; M--;) W[M] === "." ? W.splice(M, 1) : W[M] === ".." ? (W.splice(M, 1), pe++) : pe && (M === 0 && (fe = !0), W.splice(M, 1), pe--);
            return fe && W.unshift(""), (G === "." || G === "..") && W.push(""), W.join("/")
        }

        function Le(F, N, W) {
            if (F = q(F), !(this instanceof Le)) return new Le(F, N, W);
            var M, G, fe, pe, Ne, Ve, pt = ae.slice(),
                Ft = typeof N,
                Ye = this,
                In = 0;
            for (Ft !== "object" && Ft !== "string" && (W = N, N = null), W && typeof W != "function" && (W = ie.parse), N = ve(N), G = Ee(F || "", N), M = !G.protocol && !G.slashes, Ye.slashes = G.slashes || M && N.slashes, Ye.protocol = G.protocol || N.protocol || "", F = G.rest, (Ye.protocol === "file:" || !G.slashes && (G.protocol || G.slashesCount < 2 || !d(Ye.protocol))) && (pt[3] = [/(.*)/, "pathname"]); In < pt.length; In++) {
        ...
        function Be(F) {
            ...
            return W.username && (G += W.username, W.password && (G += ":" + W.password), G += "@"), G += W.host + W.pathname, N = typeof W.query == "object" ? F(W.query) : W.query, N && (G += N.charAt(0) !== "?" ? "?" + N : N), W.hash && (G += W.hash), G
        }
        Le.prototype = {
            set: lt,
            toString: Be
        ...
        function _(F, N, W) {
            ...
            je(function() {
                _e.removeWebSocket(F, F.url), F.readyState = De.CLOSED, F.dispatchEvent(G), F.dispatchEvent(fe), M && M.dispatchEvent(G, M)
            }, F)
        }
        ...
        function O(F, N, W) {
            ...
            je(function() {
                _e.removeWebSocket(F, F.url), F.readyState = De.CLOSED, F.dispatchEvent(pe), F.dispatchEvent(G), F.dispatchEvent(fe), M && M.dispatchEvent(G, M)
            }, F)
        }
        ...
        var De = function(F) {
            function N(M, G) {
                F.call(this), this._onopen = null, this._onmessage = null, this._onerror = null, this._onclose = null, this.url = he(M), G = Ie(G), this.protocol = G[0] || "", this.binaryType = "blob", this.readyState = N.CONNECTING;
                var fe = te(this),
        ...
        var yt = function(F) {
            function N(M, G) {
                var fe = this;
                M === void 0 && (M = "socket.io"), G === void 0 && (G = ""), F.call(this), this.binaryType = "blob";
                var pe = new K(M);
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/pp6-jokeboat/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
...
const fC = `<form>\r
    ...
    no = Et.View.extend({
        ...
        onAttach() {
            this.getOption("preventAutosize") || lc(Pe("textarea"))
        },
        onSubmitClick() {
        ...
        clearInput() {
            ...
            Pe(t).val(""), this.getOption("preventAutosize") || lc.update(t), this.onInputChange()
        },
        setValue(t) {
...
function gC(t) {
    ...
    return Us = Jr.getContext("2d"), Us.imageSmoothingEnabled = !1, Qu("init"), {
        canvas: Jr,
        context: Us
    }
}
...
`).replace(/(^|\n)\s*/g, ""),
            ...
            wi = (c, h) => {
                const b = g(),
                    B = E();
                !h.showConfirmButton && !h.showDenyButton && !h.showCancelButton ? M(b) : W(b), ct(b, h, "actions"), Hn(b, B, h), nt(B, h.loaderHtml), ct(B, h, "loader")
            };
        ...
        const Ui = (c, h) => {
            ...
            Rr = (c, h) => {
                ...
                Je(c, je[h.icon]), bn(c, h), Gi(), ct(c, h, "icon")
            },
            Gi = () => {
                const c = we(),
...
`,
            ...
            Dr = (c, h) => {
                const b = U(),
                    B = we();
                h.toast ? (N(b, "width", h.width), B.style.width = "100%", B.insertBefore(E(), ye())) : N(B, "width", h.width), N(B, "padding", h.padding), h.color && (B.style.color = h.color), h.background && (B.style.background = h.background), M(Ke()), ko(B, h)
            },
            ko = (c, h) => {
...
`).join("<br />")), vi(c)
        ...
        const bs = () => {
            ...
            Fr = c => {
                ...
                r(h, b, c), setTimeout(() => {
                    Bo(h, b)
                }, $r), Se() && ($o(h, c.scrollbarPadding, ge), xi()), !he() && !it.previousActiveElement && (it.previousActiveElement = document.activeElement), typeof c.didOpen == "function" && setTimeout(() => c.didOpen(b)), Lt(h, K["no-transition"])
            },
            Es = c => {
                const h = we();
        ...
        function Mn(c, h, b, B) {
            he() ? ks(c, B) : (gi(b).then(() => ks(c, B)), et(it)), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (h.setAttribute("style", "display:none !important"), h.removeAttribute("class"), h.innerHTML = "") : h.remove(), Se() && (Vr(), Ei(), Lr()), vn()
        }
        ...
        const gt = c => {
            ...
            Ss = (c, h, b) => {
                const B = U(),
                    ge = mn && pt(h);
                typeof b.willClose == "function" && b.willClose(h), ge ? zr(c, h, B, b.returnFocus, b.didClose) : Mn(c, B, b.returnFocus, b.didClose)
            },
            zr = (c, h, b, B, ge) => {
        ...
        class Ue {
            ...
            _main(h) {
                ...
                Le(Object.assign({}, b, h)), it.currentInstance && (it.currentInstance._destroy(), Se() && Lr()), it.currentInstance = ze;
                const B = ht(h, b);
        ...
        const Xe = (c, h, b) => new Promise((B, ge) => {
                ...
                Fe.swalPromiseResolve.set(c, B), Fe.swalPromiseReject.set(c, ge), h.confirmButton.onclick = () => Os(c), h.denyButton.onclick = () => Rs(c), h.cancelButton.onclick = () => Wo(c, He), h.closeButton.onclick = () => He(Xn.close), Xo(c, h, He), on(c, it, b, He), p(c, b), Fr(b), We(it, b, He), Ht(h, b), setTimeout(() => {
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp6/jokeboat/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    _C = Et.View.extend({
        ...
        onAttach() {
            ...
            this.cameraSprite = fl(EC), this.cameraSprite.width = this.model.get("width"), this.cameraSprite.height = this.model.get("height"), this.cameraSprite.mask = this.model.get("mask"), t.sprites.push(this.cameraSprite), t.gameLoop.start(), this.facingMode = "user", this.startCamera(), this.onResize()
        },
        async startCamera() {
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp6/jokeboat/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
class DC {
    constructor(e, n = {}) {
        ...
        this.canvasSelector = e, this.canvas = Pe(this.canvasSelector)[0], this.ctx = this.canvas.getContext("2d"), this.options = Object.assign(hc, n), this.history = [], this.layerNames.forEach(i => {
...
`,
    ...
    VC = Et.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new Bi({}), this.toolbarComponent = this.toolbarComponent || new IC({
                model: new ot.Model({})
            }), this.sketchpadComponent = this.sketchpadComponent || new LC({
                model: new ot.Model
            }), this.buttonsCollection = this.buttonsCollection || new ot.Collection([]), this.buttonsComponent = this.buttonsComponent || new ii({
                block: !1,
...
Et.View.extend({
    ...
    onResize() {
        const t = Pe("#player").outerHeight(!0) || 0,
            e = ni.isVisible ? Pe("#slide-in-banner").outerHeight(!0) : 0,
            n = Pe(window).width(),
    ...
    HC = Et.View.extend({
        ...
        initialize() {
            this.titleComponent = new Bi({
                model: new ot.Model({})
            }), this.choicesListView = this.choicesListView || new ii, this.charactersListView = new Et.CollectionView({
                childView: zC,
        ...
        animateAll: function(i) {
            ...
            t.forEach(function(S) {
                var k = 0,
                    ...
                    Y = S.rect,
                    re = pr(I, !0);
                re && ($.top -= re.f, $.left -= re.e), I.toRect = $, I.thisAnimationDuration && da(J, $) && !da(D, $) && (Y.top - $.top) / (Y.left - $.left) === (D.top - $.top) / (D.left - $.left) && (k = ox(Y, J, ie, a.options)), da($, D) || (I.prevFromRect = D, I.prevToRect = $, k || (k = a.options.animation), a.animate(I, Y, $, k)), k && (f = !0, v = Math.max(v, k), clearTimeout(I.animationResetTimer), I.animationResetTimer = setTimeout(function() {
...
var Re, $t, ut, Pt, Ii, qs, Vt, hi, cr, _n, as, ui, $s, en, lr = !1,
    ro = !1,
    so = [],
    Ai, Ln, pa, ga, vc, yc, Qr, sr, ls, cs = !1,
    Fs = !1,
    Ws, ln, ma = [],
    Na = !1,
    oo = [],
    ...
    js = th,
    wc = fs || ai ? "cssFloat" : "float",
    cx = bo && !nh && !th && "draggable" in document.createElement("div"),
    lh = function() {
        if (!!bo) {
            if (ai) return !1;
    ...
    hh = function() {
        !lh && ut && tt(ut, "display", "none")
    },
    dh = function() {
        !lh && ut && tt(ut, "display", "")
    };
bo && !nh && document.addEventListener("click", function(t) {
...
Qe.prototype = {
    ...
    _onTapStart: function(e) {
        if (!!e.cancelable) {
            var n = this,
                ...
                D = a.filter;
            if (bx(i), !Re && !(/mousedown|pointerdown/.test(v) && e.button !== 0 || a.disabled) && !I.isContentEditable && !(!this.nativeDraggable && ss && k && k.tagName.toUpperCase() === "SELECT") && (k = $n(k, a.draggable, i, !1), !(k && k.animated) && qs !== k)) {
    ...
    _prepareDragStart: function(e, n, i) {
        ...
        if (i && !Re && i.parentNode === f) {
            ...
            if (Pt = f, Re = i, $t = Re.parentNode, Ii = Re.nextSibling, qs = i, $s = v.group, Qe.dragged = Re, Ai = {
                    ...
                    rh(Re, D.trim(), va)
                }), xt(S, "dragover", Oi), xt(S, "mousemove", Oi), xt(S, "touchmove", Oi), xt(S, "mouseup", a._onDrop), xt(S, "touchend", a._onDrop), xt(S, "touchcancel", a._onDrop), fc && this.nativeDraggable && (this.options.touchStartThreshold = 4, Re.draggable = !0), wn("delayStart", this, {
                    evt: e
    ...
    _onTouchMove: function(e) {
        if (Ai) {
            ...
            if (ut) {
                ...
                tt(ut, "webkitTransform", J), tt(ut, "mozTransform", J), tt(ut, "msTransform", J), tt(ut, "transform", J), pa = D, ga = $, Ln = f
            }
    ...
    _appendGhost: function() {
        if (!ut) {
            ...
            if (js) {
                ...
                ln !== document.body && ln !== document.documentElement ? (ln === document && (ln = jn()), n.top += ln.scrollTop, n.left += ln.scrollLeft) : ln = jn(), ma = mc(ln)
            }
            ut = Re.cloneNode(!0), En(ut, i.ghostClass, !1), En(ut, i.fallbackClass, !0), En(ut, i.dragClass, !0), tt(ut, "transition", ""), tt(ut, "transform", ""), tt(ut, "box-sizing", "border-box"), tt(ut, "margin", 0), tt(ut, "top", n.top), tt(ut, "left", n.left), tt(ut, "width", n.width), tt(ut, "height", n.height), tt(ut, "opacity", "0.8"), tt(ut, "position", js ? "absolute" : "fixed"), tt(ut, "zIndex", "100000"), tt(ut, "pointerEvents", "none"), Qe.ghost = ut, e.appendChild(ut), tt(ut, "transform-origin", vc / parseInt(ut.style.width) * 100 + "% " + yc / parseInt(ut.style.height) * 100 + "%")
        }
    },
    ...
    _onDragOver: function(e) {
        ...
        if (ro = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : en === this || (this.lastPutMode = $s.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            ...
            if (!se || mx(e, ie, this) && !se.animated) {
                ...
                var d = 0,
                    ...
                    Le = !ux(Re.animated && Re.toRect || a, i.animated && i.toRect || f, ie),
                    lt = ie ? "top" : "left",
                    Be = gc(i, "top", "top") || gc(Re, "top", "top"),
                    K = Be ? Be.scrollTop : void 0;
                sr !== i && (Ee = f[lt], cs = !1, Fs = !Le && S.invertSwap || Ae), d = vx(e, i, f, ie, Le ? 1 : S.swapThreshold, S.invertedSwapThreshold == null ? S.swapThreshold : S.invertedSwapThreshold, Fs, sr === i);
                var je;
                if (d !== 0) {
                    var U = On(Re);
                ...
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Na = !0, setTimeout(px, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), Be && oh(Be, 0, K - Be.scrollTop), $t = Re.parentNode, Ee !== void 0 && !Fs && (Ws = Math.abs(Ee - Yt(i)[lt])), ae(), q(!0)
            }
    ...
    _nulling: function() {
        wn("nulling", this), Pt = Re = $t = ut = Ii = Vt = qs = hi = Ai = Ln = Qr = _n = ui = cr = as = sr = ls = en = $s = Qe.dragged = Qe.ghost = Qe.clone = Qe.active = null, oo.forEach(function(e) {
            e.checked = !0
        }), oo.length = pa = ga = 0
    },
...
function Cx() {
    ...
    return t.prototype = {
        ...
        drop: function() {
            this.sortable.nativeDraggable ? wt(document, "dragover", this._handleAutoScroll) : (wt(document, "pointermove", this._handleFallbackAutoScroll), wt(document, "touchmove", this._handleFallbackAutoScroll), wt(document, "mousemove", this._handleFallbackAutoScroll)), bc(), Ys(), ix()
        },
        nulling: function() {
            ao = Ba = Zr = $a = es = ya = wa = null, qt.length = 0
        },
        ...
        _handleAutoScroll: function(n, i) {
            ...
            if (ao = n, i || this.options.forceAutoScrollFallback || fs || ai || ss) {
                ba(n, this.options, S, i);
                var k = fi(S, !0);
                $a && (!es || f !== ya || v !== wa) && (es && bc(), es = setInterval(function() {
...
var ba = sh(function(t, e, n, i) {
        if (!!e.scroll) {
            var a = (t.touches ? t.touches[0] : t).clientX,
                ...
                I = !1,
                D;
            Ba !== n && (Ba = n, Ys(), Zr = e.scroll, D = e.scrollFn, Zr === !0 && (Zr = fi(n, !0)));
            var $ = 0,
                J = Zr;
            do {
                var ie = J,
                ...
                (qt[$].vx != K || qt[$].vy != je || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = je, clearInterval(qt[$].pid), (K != 0 || je != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    ...
                    typeof D == "function" && D.call(Qe.dragged.parentNode[Sn], Te, oe, t, ao, qt[this.layer].el) !== "continue" || oh(qt[this.layer].el, Te, oe)
                }.bind({
                    layer: $
                }), 24))), $++
...
const $x = Et.View.extend({
    ...
    jx = to.extend({
        ...
        <button data-action="censor" class="button censor-button btn btn-lg"></button>
    `),
        bindings: Object.assign(to.prototype.bindings, {
            ".help": {
                observe: "help",
                updateMethod: "html",
                onGet(t) {
                    return t && t[t.length - 1] === "." && (t = t.slice(0, -1)), t
                }
            }
        })
    }),
    ...
    Gx = Ma.extend({
        onRender() {
            Ma.prototype.onRender.apply(this), this.$el.hasClass("topics") && this.$(".inputGroup").append(Hx), this.$(".action-jokeForMe").parent().append(Ux)
        },
    ...
    qx = La.extend({
        bindings: Object.assign(La.prototype.bindings, {
            ".logo-image": {
                observe: "message",
                visible(t) {
                    return !t || !t.html ? !0 : !t.html.includes('class="lookup"')
                }
            }
        })
    });
const Wx = xc.extend({
    ...
    isFinalRound: !1,
    onAttach() {
        xc.prototype.onAttach.apply(this);
        const t = this.model.get("blob");
        this.detectCatchphrase(t), this.detectFinalRound(t)
    },
    getGameLayout(t) {
        switch (t) {
            case "MakeSingleChoice":
    ...
    detectCatchphrase(t) {
        t.choiceId === "ChooseCatchphrase" ? Pe(".pt-page").addClass("catchphrase") : Pe(".pt-page").removeClass("catchphrase")
    },
    detectFinalRound(t) {
        t.classes && (t.classes.indexOf("round-3") !== -1 && (this.isFinalRound = !0), t.classes.indexOf("round-4") !== -1 && (this.isFinalRound = !0)), t.choiceId === "ChooseCatchphrase" && (this.isFinalRound = !1), t.choiceId === "ChoosePunchUpJoke" && (this.isFinalRound = !0), t.entryId === "PunchedUpLine" && (this.isFinalRound = !0), this.isFinalRound ? Pe(".pt-page").addClass("final-round") : Pe(".pt-page").removeClass("final-round")
    }
});
Fx({
    MainView: Wx
});
//# sourceMappingURL=b2eb6ee3.js.map