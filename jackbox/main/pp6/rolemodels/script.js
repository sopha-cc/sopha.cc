...
var mh = (t, e, n) => e in t ? gh(t, e, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
    value: n
}) : t[e] = n;
var ot = (t, e, n) => (mh(t, typeof e != "symbol" ? e + "" : e, n), n);
const vh = function() {
...
(function(t, e) {
    (function() {
        ...
        m.reduce = m.foldl = m.inject = Me(1), m.reduceRight = m.foldr = Me(-1), m.find = m.detect = function(l, g, _) {
            ...
            } else g = q(g, _), m.each(l, function(Ie, De, it) {
                te = g(Ie, De, it), (te > M || te === -1 / 0 && O === -1 / 0) && (O = Ie, M = te)
            });
            return O
        ...
        function we(l, g) {
            var _ = Te.length,
                O = l.constructor,
                M = m.isFunction(O) && O.prototype || d,
                V = "constructor";
        ...
        m.keys = function(l) {
            ...
            var O = {},
                ...
                V, te;
            if (M == null) return O;
            m.isFunction(g) ? (te = m.allKeys(M), V = P(g, _)) : (te = Be(arguments, !1, !1, 1), V = function(it, xt, rn) {
                return xt in rn
            }, M = Object(M));
        ...
        m.template = function(l, g, _) {
            ...
            var O = RegExp([(g.escape || Je).source, (g.interpolate || Je).source, (g.evaluate || Je).source].join("|") + "|$", "g"),
                M = 0,
                V = "__p+='";
            l.replace(O, function(Ie, De, it, xt, rn) {
        ...
        (function(e, n) {
            ...
            f.fn = f.prototype = {
                ...
                makeArray: function(r, s) {
                    var u = s || [];
                    return r != null && (Ee(Object(r)) ? f.merge(u, typeof r == "string" ? [r] : r) : S.call(u, r)), u
                },
            ...
            var Ae = function(r) {
                var s, u, p, w, x, T, z, U, Z, le, be, ne, ce, Ge, st, je, zt, Nt, un, _t = "sizzle" + 1 * new Date,
                    tt = r.document,
                    on = 0,
                    ft = 0,
                    Dt = Yi(),
                ...
                function St(R, F, X, de) {
                    var ee, me, xe, Oe, Le, ze, He, Xe = F && F.ownerDocument,
                        ht = F ? F.nodeType : 9;
                    if (X = X || [], typeof R != "string" || !R || ht !== 1 && ht !== 9 && ht !== 11) return X;
                    if (!de && (ne(F), F = F || ce, st)) {
                        if (ht !== 11 && (Le = Go.exec(R)))
                            if (ee = Le[1]) {
                                if (ht === 9)
                            ...
                            if (He = R, Xe = F, ht === 1 && ($o.test(R) || As.test(R))) {
                                for (Xe = Ur.test(R) && Gr(F.parentNode) || F, (Xe !== F || !u.scope) && ((Oe = F.getAttribute("id")) ? Oe = Oe.replace(Hr, Os) : F.setAttribute("id", Oe = _t)), ze = T(R), me = ze.length; me--;) ze[me] = (Oe ? "#" + Oe : ":scope") + " " + Qi(ze[me]);
                                He = ze.join(",")
                            }
                            try {
                    ...
                    return U(R.replace(ki, "$1"), F, X, de)
                }
                ...
                u = St.support = {}, x = St.isXML = function(R) {
                    ...
                    var F, X, de = R ? R.ownerDocument || R : tt;
                    return de == ce || de.nodeType !== 9 || !de.documentElement || (ce = de, Ge = ce.documentElement, st = !x(ce), tt != ce && (X = ce.defaultView) && X.top !== X && (X.addEventListener ? X.addEventListener("unload", Rs, !1) : X.attachEvent && X.attachEvent("onunload", Rs)), u.scope = yn(function(ee) {
                    ...
                    })), (u.matchesSelector = Ti.test(Nt = Ge.matches || Ge.webkitMatchesSelector || Ge.mozMatchesSelector || Ge.oMatchesSelector || Ge.msMatchesSelector)) && yn(function(ee) {
                    ...
                    if (ne(R), u.matchesSelector && st && !hn[F + " "] && (!zt || !zt.test(F)) && (!je || !je.test(F))) try {
                        var X = Nt.call(R, F);
                    ...
                    var X = p.attrHandle[F.toLowerCase()],
                        de = X && Qn.call(p.attrHandle, F.toLowerCase()) ? X(R, F, !st) : void 0;
                    return de !== void 0 ? de : u.attributes || !st ? R.getAttribute(F) : (de = R.getAttributeNode(F)) && de.specified ? de.value : null
                    ...
                    filter: {
                        ...
                        CHILD: function(R, F, X, de, ee) {
                            ...
                            return de === 1 && ee === 0 ? function(Le) {
                                ...
                                var Xe, ht, Tt, We, Ut, Jt, fn = me !== xe ? "nextSibling" : "previousSibling",
                                    At = Le.parentNode,
                                ...
                                if (At) {
                                    ...
                                    if (Jt = [xe ? At.firstChild : At.lastChild], xe && h) {
                                        for (We = At, Tt = We[_t] || (We[_t] = {}), ht = Tt[We.uniqueID] || (Tt[We.uniqueID] = {}), Xe = ht[R] || [], Ut = Xe[0] === on && Xe[1], b = Ut && Xe[2], We = Ut && At.childNodes[Ut]; We = ++Ut && We && We[fn] || (b = Ut = 0) || Jt.pop();)
                                            if (We.nodeType === 1 && ++b && We === Le) {
                                                ht[R] = [on, Ut, b];
                                                break
                                            }
                                    } else if (h && (We = Le, Tt = We[_t] || (We[_t] = {}), ht = Tt[We.uniqueID] || (Tt[We.uniqueID] = {}), Xe = ht[R] || [], Ut = Xe[0] === on && Xe[1], b = Ut), b === !1)
                                        for (;
                                            (We = ++Ut && We && We[fn] || (b = Ut = 0) || Jt.pop()) && !((Oe ? We.nodeName.toLowerCase() === c : We.nodeType === 1) && ++b && (h && (Tt = We[_t] || (We[_t] = {}), ht = Tt[We.uniqueID] || (Tt[We.uniqueID] = {}), ht[R] = [on, b]), We === Le)););
                        ...
                        lang: dn(function(R) {
                            return Fo.test(R || "") || St.error("unsupported lang: " + R), R = R.replace(Tn, xn).toLowerCase(),
                                function(F) {
                                    var X;
                                    do
                                        if (X = st ? F.lang : F.getAttribute("xml:lang") || F.getAttribute("lang")) return X = X.toLowerCase(), X === R || X.indexOf(R + "-") === 0; while ((F = F.parentNode) && F.nodeType === 1);
                                    return !1
                                }
                        }),
                        target: function(R) {
                ...
                function Zi(R, F, X) {
                    ...
                    return F.first ? function(Le, ze, He) {
                        for (; Le = Le[de];)
                            if (Le.nodeType === 1 || xe) return R(Le, ze, He);
                        return !1
                    } : function(Le, ze, He) {
                        var Xe, ht, Tt, We = [on, Oe];
                        if (He) {
                            for (; Le = Le[de];)
                                if ((Le.nodeType === 1 || xe) && R(Le, ze, He)) return !0
                        } else
                            for (; Le = Le[de];)
                                if (Le.nodeType === 1 || xe)
                                    if (Tt = Le[_t] || (Le[_t] = {}), ht = Tt[Le.uniqueID] || (Tt[Le.uniqueID] = {}), ee && ee === Le.nodeName.toLowerCase()) Le = Le[de] || Le;
                                        ...
                                        if (ht[me] = We, We[2] = R(Le, ze, He)) return !0
                                    } return !1
                    }
                }
                    ...
                    return de && !de[_t] && (de = qr(de)), ee && !ee[_t] && (ee = qr(ee, me)), dn(function(xe, Oe, Le, ze) {
                        ...
                        if (xe) {
                            if (ee || R) {
                                ...
                                for (Xe = At.length; Xe--;)(ht = At[Xe]) && (He = ee ? Zn(xe, ht) : Tt[Xe]) > -1 && (xe[He] = !(Oe[He] = ht))
                            }
                        } else At = tr(At === Oe ? At.splice(Ut, At.length) : At), ee ? ee(null, Oe, At, ze) : Cn.apply(Oe, At)
                    })
                }
                ...
                function Wr(R) {
                    for (var F, X, de, ee = R.length, me = p.relative[R[0].type], xe = me || p.relative[" "], Oe = me ? 1 : 0, Le = Zi(function(Xe) {
                        ...
                        if (X = p.relative[R[Oe].type]) He = [Zi(er(He), X)];
                        else {
                            if (X = p.filter[R[Oe].type].apply(null, R[Oe].matches), X[_t]) {
                                for (de = ++Oe; de < ee && !p.relative[R[de].type]; de++);
                                return qr(Oe > 1 && er(He), Oe > 1 && Qi(R.slice(0, Oe - 1).concat({
                                    value: R[Oe - 2].type === " " ? "*" : ""
                                })).replace(ki, "$1"), X, Oe < de && Wr(R.slice(Oe, de)), de < ee && Wr(R = R.slice(de)), de < ee && Qi(R))
                            }
                            He.push(X)
                        } return er(He)
                }
                    ...
                    var X = F.length > 0,
                        ...
                        ee = function(me, xe, Oe, Le, ze) {
                            ...
                            for (ze && (Z = xe == ce || xe || ze); We !== h && (He = At[We]) != null; We++) {
                                if (de && He) {
                                    for (Xe = 0, !xe && He.ownerDocument != ce && (ne(He), Oe = !st); ht = R[Xe++];)
                                        if (ht(He, xe || ce, Oe)) {
                                            Le.push(He);
                                            break
                                        } ze && (on = c)
                            ...
                            if (Tt += We, X && We !== Tt) {
                                for (Xe = 0; ht = F[Xe++];) ht(Ut, Jt, xe, Oe);
                                if (me) {
                                    if (Tt > 0)
                                        for (; We--;) Ut[We] || Jt[We] || (Jt[We] = Ln.call(Le));
                                    Jt = tr(Jt)
                                }
                ...
                return z = St.compile = function(R, F) {
                    ...
                    if (X = X || [], He.length === 1) {
                        if (me = He[0] = He[0].slice(0), me.length > 2 && (xe = me[0]).type === "ID" && F.nodeType === 9 && st && p.relative[me[1].type]) {
                        ...
                        for (ee = Xi.needsContext.test(R) ? 0 : me.length; ee-- && (xe = me[ee], !p.relative[Oe = xe.type]);)
                            if ((Le = p.find[Oe]) && (de = Le(xe.matches[0].replace(Tn, xn), Ur.test(me[0].type) && Gr(F.parentNode) || F))) {
                                if (me.splice(ee, 1), R = de.length && Qi(me), !R) return Cn.apply(X, de), X;
                                break
                            }
                    }
                    return (ze || z(R, He))(de, F, !st, X, !F || Ur.test(R) && Gr(F.parentNode) || F), X
                }, u.sortStable = _t.split("").sort(Jn).join("") === _t, u.detectDuplicates = !!be, ne(), u.sortDetached = yn(function(R) {
            ...
            f.filter = function(r, s, u) {
                ...
                is: function(r) {
                    return !!H(this, typeof r == "string" && Be.test(r) ? f(r) : r || [], !1).length
                }
            });
            var oe, Te = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
            ...
            f.extend({
                        ...
                        p = {
                            ...
                            then: function(x, T, z) {
                                        ...
                                        var Ge = this,
                                            ...
                                            je = function() {
                                                ...
                                                if (!(le < U)) {
                                                    ...
                                                    un = Nt && (typeof Nt == "object" || typeof Nt == "function") && Nt.then, re(un) ? ce ? un.call(Nt, Z(U, be, Je, ce), Z(U, be, dt, ce)) : (U++, un.call(Nt, Z(U, be, Je, ce), Z(U, be, dt, ce), Z(U, be, Je, be.notifyWith))) : (ne !== Je && (Ge = void 0, st = [Nt]), (ce || be.resolveWith)(Ge, st))
                                                }
                                            },
                                            zt = ce ? je : function() {
                                                try {
                                                    ...
                                                    f.Deferred.exceptionHook && f.Deferred.exceptionHook(Nt, zt.stackTrace), le + 1 >= U && (ne !== dt && (Ge = void 0, st = [Nt]), be.rejectWith(Ge, st))
                                                }
                                            };
                                ...
                                return f.Deferred(function(le) {
                                    s[0][3].add(Z(0, le, re(z) ? z : Je, le.notifyWith)), s[1][3].add(Z(0, le, re(x) ? x : Je)), s[2][3].add(Z(0, le, re(T) ? T : dt))
                                }).promise()
                            },
                            promise: function(x) {
                ...
                when: function(r) {
                    var s = arguments.length,
                        ...
                        T = function(z) {
                            return function(U) {
                                p[z] = this, w[z] = arguments.length > 1 ? d.call(arguments) : U, --s || x.resolveWith(p, w)
                            }
                        };
            ...
            Kt.getRootNode && (Qe = function(r) {
                return f.contains(r.ownerDocument, r) || r.getRootNode(Mt) === r.ownerDocument
            });
            var j = function(r, s) {
                return r = s || r, r.style.display === "none" || r.style.display === "" && Qe(r) && f.css(r, "display") === "none"
            };
            ...
            function N(r, s, u, p) {
                var w, x, T = 20,
                    ...
                    le = r.nodeType && (f.cssNumber[s] || Z !== "px" && +U) && wt.exec(f.css(r, s));
                if (le && le[3] !== Z) {
                    for (U = U / 2, Z = Z || le[3], le = +U || 1; T--;) f.style(r, s, le + Z), (1 - x) * (1 - (x = z() / U || .5)) <= 0 && (T = 0), le = le / x;
            ...
            function L(r) {
                var s, u = r.ownerDocument,
                    p = r.nodeName,
                    w = W[p];
                return w || (s = u.body.appendChild(u.createElement(p)), w = f.css(s, "display"), s.parentNode.removeChild(s), w === "none" && (w = "block"), W[p] = w, w)
            }
            ...
            function In(r, s, u, p, w) {
                for (var x, T, z, U, Z, le, be = s.createDocumentFragment(), ne = [], ce = 0, Ge = r.length; ce < Ge; ce++)
                    ...
                    for (T = T || be.appendChild(s.createElement("div")), z = (pe.exec(x) || ["", ""])[1].toLowerCase(), U = Ve[z] || Ve._default, T.innerHTML = U[1] + f.htmlPrefilter(x) + U[2], le = U[0]; le--;) T = T.lastChild;
                ...
                for (be.textContent = "", ce = 0; x = ne[ce++];) {
                    ...
                    if (Z = Qe(x), T = pt(be.appendChild(x), "script"), Z && jt(T), u)
            ...
            function kn(r, s, u, p, w, x) {
                ...
                return x === 1 && (T = w, w = function(U) {
                    return f().off(U), T.apply(this, arguments)
            ...
            f.event = {
                ...
                add: function(r, s, u, p, w) {
                    var x, T, z, U, Z, le, be, ne, ce, Ge, st, je = he.get(r);
                    if (!!te(r))
                        for (u.handler && (x = u, u = x.handler, w = x.selector), w && f.find.matchesSelector(Kt, w), u.guid || (u.guid = f.guid++), (U = je.events) || (U = je.events = Object.create(null)), (T = je.handle) || (T = je.handle = function(zt) {
                                return typeof f < "u" && f.event.triggered !== zt.type ? f.event.dispatch.apply(r, arguments) : void 0
                            }), s = (s || "").match(ke) || [""], Z = s.length; Z--;) z = Pn.exec(s[Z]) || [], ce = st = z[1], Ge = (z[2] || "").split(".").sort(), ce && (be = f.event.special[ce] || {}, ce = (w ? be.delegateType : be.bindType) || ce, be = f.event.special[ce] || {}, le = f.extend({
                            type: ce,
                            origType: st,
                            data: p,
                            handler: u,
                            ...
                            namespace: Ge.join(".")
                        }, x), (ne = U[ce]) || (ne = U[ce] = [], ne.delegateCount = 0, (!be.setup || be.setup.call(r, p, Ge, T) === !1) && r.addEventListener && r.addEventListener(ce, T)), be.add && (be.add.call(r, le), le.handler.guid || (le.handler.guid = u.guid)), w ? ne.splice(ne.delegateCount++, 0, le) : ne.push(le), f.event.global[ce] = !0)
                },
                remove: function(r, s, u, p, w) {
                    var x, T, z, U, Z, le, be, ne, ce, Ge, st, je = he.hasData(r) && he.get(r);
                    if (!(!je || !(U = je.events))) {
                        for (s = (s || "").match(ke) || [""], Z = s.length; Z--;) {
                            if (z = Pn.exec(s[Z]) || [], ce = st = z[1], Ge = (z[2] || "").split(".").sort(), !ce) {
                                for (ce in U) f.event.remove(r, ce + s[Z], u, p, !0);
                                continue
                            }
                            for (be = f.event.special[ce] || {}, ce = (p ? be.delegateType : be.bindType) || ce, ne = U[ce] || [], z = z[2] && new RegExp("(^|\\.)" + Ge.join("\\.(?:.*\\.|)") + "(\\.|$)"), T = x = ne.length; x--;) le = ne[x], (w || st === le.origType) && (!u || u.guid === le.guid) && (!z || z.test(le.namespace)) && (!p || p === le.selector || p === "**" && le.selector) && (ne.splice(x, 1), le.selector && ne.delegateCount--, be.remove && be.remove.call(r, le));
                            T && !ne.length && ((!be.teardown || be.teardown.call(r, Ge, je.handle) === !1) && f.removeEvent(r, ce, je.handle), delete U[ce])
                        }
                ...
                dispatch: function(r) {
                    ...
                    if (U.delegateTarget = this, !(le.preDispatch && le.preDispatch.call(this, U) === !1)) {
                        for (T = f.event.handlers.call(this, U, Z), s = 0;
                            (w = T[s++]) && !U.isPropagationStopped();)
                            for (U.currentTarget = w.elem, u = 0;
                                (x = w.handlers[u++]) && !U.isImmediatePropagationStopped();)(!U.rnamespace || x.namespace === !1 || U.rnamespace.test(x.namespace)) && (U.handleObj = x, U.data = x.data, p = ((f.event.special[x.origType] || {}).handle || x.handler).apply(w.elem, z), p !== void 0 && (U.result = p) === !1 && (U.preventDefault(), U.stopPropagation()));
                    ...
                    if (U && Z.nodeType && !(r.type === "click" && r.button >= 1)) {
                        for (; Z !== this; Z = Z.parentNode || this)
                            if (Z.nodeType === 1 && !(r.type === "click" && Z.disabled === !0)) {
                                for (x = [], T = {}, u = 0; u < U; u++) p = s[u], w = p.selector + " ", T[w] === void 0 && (T[w] = p.needsContext ? f(w, this).index(Z) > -1 : f.find(w, this, null, [Z]).length), T[w] && x.push(p);
                                x.length && z.push({
                                    elem: Z,
                                    handlers: x
                                })
                ...
                he.set(r, s, !1), f.event.add(r, s, {
                    ...
                    handler: function(p) {
                        ...
                        if (p.isTrigger & 1 && this[s]) {
                            ...
                            else if (T = d.call(arguments), he.set(this, s, T), w = u(this, s), this[s](), x = he.get(this, s), T !== x || w ? he.set(this, s, !1) : x = {}, T !== x) return p.stopImmediatePropagation(), p.preventDefault(), x && x.value
            ...
            function ji(r, s) {
                ...
                if (s.nodeType === 1) {
                    if (he.hasData(r) && (x = he.get(r), U = x.events, U)) {
                        ...
                        for (w in U)
                            for (u = 0, p = U[w].length; u < p; u++) f.event.add(s, w, U[w][u])
                    }
            ...
            function mn(r, s, u, p) {
                ...
                var w, x, T, z, U, Z, le = 0,
                    ...
                    ce = s[0],
                    Ge = re(ce);
                if (Ge || be > 1 && typeof ce == "string" && !Y.checkClone && Tr.test(ce)) return r.each(function(st) {
                    var je = r.eq(st);
                    Ge && (s[0] = ce.call(this, st, je.html())), mn(je, s, u, p)
                });
                if (be && (w = In(s, r[0].ownerDocument, !1, r, p), x = w.firstChild, w.childNodes.length === 1 && (w = x), x || p)) {
                    for (T = f.map(pt(w, "script"), yi), z = T.length; le < be; le++) U = w, le !== ne && (U = f.clone(U, !0, !0), z && f.merge(T, pt(U, "script"))), u.call(r[le], U, le);
                    if (z)
                        for (Z = T[T.length - 1].ownerDocument, f.map(T, wi), le = 0; le < z; le++) U = T[le], Pe.test(U.type || "") && !he.access(U, "globalEval") && f.contains(Z, U) && (U.src && (U.type || "").toLowerCase() !== "module" ? f._evalUrl && !U.noModule && f._evalUrl(U.src, {
                            nonce: U.nonce || U.getAttribute("nonce")
                        }, Z) : ae(U.textContent.replace(vi, ""), U, Z))
                }
                return r
            }
            ...
            function zi(r, s, u) {
                for (var p, w = s ? f.filter(s, r) : r, x = 0;
                    (p = w[x]) != null; x++) !u && p.nodeType === 1 && f.cleanData(pt(p)), p.parentNode && (u && Qe(p) && jt(pt(p, "script")), p.parentNode.removeChild(p));
                return r
            }
            f.extend({
                ...
                f.fn[r] = function(u) {
                    for (var p, w = [], x = f(u), T = x.length - 1, z = 0; z <= T; z++) p = z === T ? this : this.clone(!0), f(x[z])[s](p), S.apply(w, p.get());
            ...
            function et(r, s, u) {
                ...
                return u = u || Hn(r), u && (T = u.getPropertyValue(s) || u[s], T === "" && !Qe(r) && (T = f.style(r, s)), !Y.pixelBoxStyles() && bi.test(T) && Ci.test(s) && (p = z.width, w = z.minWidth, x = z.maxWidth, z.minWidth = z.maxWidth = z.width = T, T = u.width, z.width = p, z.minWidth = w, z.maxWidth = x)), T !== void 0 ? T + "" : T
            }
            ...
            function qn(r, s, u, p, w, x) {
                ...
                for (; T < 4; T += 2) u === "margin" && (U += f.css(r, u + Ct[T], !0, w)), p ? (u === "content" && (U -= f.css(r, "padding" + Ct[T], !0, w)), u !== "margin" && (U -= f.css(r, "border" + Ct[T] + "Width", !0, w))) : (U += f.css(r, "padding" + Ct[T], !0, w), u !== "padding" ? U += f.css(r, "border" + Ct[T] + "Width", !0, w) : z += f.css(r, "border" + Ct[T] + "Width", !0, w));
            ...
            function Ar(r, s, u) {
                ...
                return (!Y.boxSizingReliable() && x || !Y.reliableTrDimensions() && K(r, "tr") || z === "auto" || !parseFloat(z) && f.css(r, "display", !1, p) === "inline") && r.getClientRects().length && (x = f.css(r, "boxSizing", !1, p) === "border-box", T = U in r, T && (z = r[U])), z = parseFloat(z) || 0, z + qn(r, s, u || (x ? "border" : "content"), T, p, z) + "px"
            }
            f.extend({
                cssHooks: {
                    opacity: {
                ...
                style: function(r, s, u, p) {
                    if (!(!r || r.nodeType === 3 || r.nodeType === 8 || !r.style)) {
                        var w, x, T, z = V(s),
                            U = It.test(s),
                            Z = r.style;
                        if (U || (s = Ce(z)), T = f.cssHooks[s] || f.cssHooks[z], u !== void 0) {
                            if (x = typeof u, x === "string" && (w = wt.exec(u)) && w[1] && (u = N(r, s, w), x = "number"), u == null || u !== u) return;
                            x === "number" && !U && (u += w && w[3] || (f.cssNumber[z] ? "" : "px")), !Y.clearCloneStyle && u === "" && s.indexOf("background") === 0 && (Z[s] = "inherit"), (!T || !("set" in T) || (u = T.set(r, u, p)) !== void 0) && (U ? Z.setProperty(s, u) : Z[s] = u)
                ...
                css: function(r, s, u, p) {
                    var w, x, T, z = V(s),
                        U = It.test(s);
                    return U || (s = Ce(z)), T = f.cssHooks[s] || f.cssHooks[z], T && "get" in T && (w = T.get(r, !0, u)), w === void 0 && (w = et(r, s, p)), w === "normal" && s in Gn && (w = Gn[s]), u === "" || u ? (x = parseFloat(w), u === !0 || isFinite(x) ? x || 0 : w) : w
                }
            }), f.each(["height", "width"], function(r, s) {
                f.cssHooks[s] = {
                    get: function(u, p, w) {
                        if (p) return qe.test(f.css(u, "display")) && (!u.getClientRects().length || !u.getBoundingClientRect().width) ? Ui(u, Wt, function() {
                            return Ar(u, s, w)
                        }) : Ar(u, s, w)
                    },
                    set: function(u, p, w) {
                        var x, T = Hn(u),
                            ...
                            U = z || w,
                            Z = U && f.css(u, "boxSizing", !1, T) === "border-box",
                            le = w ? qn(u, s, w, Z, T) : 0;
                        return Z && z && (le -= Math.ceil(u["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(T[s]) - qn(u, s, "border", !1, T) - .5)), le && (x = wt.exec(p)) && (x[3] || "px") !== "px" && (u.style[s] = p, p = f.css(u, s)), Nn(u, p, le)
                    }
                }
            }), f.cssHooks.marginLeft = y(Y.reliableMarginLeft, function(r, s) {
                if (s) return (parseFloat(et(r, "marginLeft")) || r.getBoundingClientRect().left - Ui(r, {
                    marginLeft: 0
                }, function() {
                ...
                css: function(r, s) {
                    return g(this, function(u, p, w) {
                        var x, T, z = {},
                            U = 0;
                        if (Array.isArray(p)) {
                            for (x = Hn(u), T = p.length; U < T; U++) z[p[U]] = f.css(u, p[U], !1, x);
                            return z
                        }
            ...
            function xo(r, s, u) {
                ...
                for (p in s)
                    if (w = s[p], bo.test(w)) {
                        ...
                        ce[p] = je && je[p] || f.style(r, p)
                    } if (U = !f.isEmptyObject(s), !(!U && f.isEmptyObject(ce))) {
                    be && r.nodeType === 1 && (u.overflow = [Ge.overflow, Ge.overflowX, Ge.overflowY], Z = je && je.display, Z == null && (Z = he.get(r, "display")), le = f.css(r, "display"), le === "none" && (Z ? le = Z : (G([r], !0), Z = r.style.display || Z, le = f.css(r, "display"), G([r]))), (le === "inline" || le === "inline-block" && Z != null) && f.css(r, "float") === "none" && (U || (ne.done(function() {
                        Ge.display = Z
                    ...
                    for (p in ce) U || (je ? "hidden" in je && (st = je.hidden) : je = he.access(r, "fxshow", {
                        display: Z
                    }), x && (je.hidden = !st), st && G([r], !0), ne.done(function() {
                        st || G([r]), he.remove(r, "fxshow");
                        for (p in ce) f.style(r, p, ce[p])
                    })), U = gs(st ? je[p] : 0, p, ne), p in je || (je[p] = U.start, st && (U.end = U.start, U.start = 0))
                }
            }
            ...
            function bn(r, s, u) {
                var p, w, x = 0,
                    ...
                    U = function() {
                        if (w) return !1;
                        for (var be = Ft || Rr(), ne = Math.max(0, Z.startTime + Z.duration - be), ce = ne / Z.duration || 0, Ge = 1 - ce, st = 0, je = Z.tweens.length; st < je; st++) Z.tweens[st].run(Ge);
                ...
                for (ms(le, Z.opts.specialEasing); x < T; x++)
                    if (p = bn.prefilters[x].call(Z, r, le, Z.opts), p) return re(p.stop) && (f._queueHooks(Z.elem, Z.opts.queue).stop = p.stop.bind(p)), p;
                return f.map(le, gs, Z), re(Z.opts.start) && Z.opts.start.call(r, Z), Z.progress(Z.opts.progress).done(Z.opts.done, Z.opts.complete).fail(Z.opts.fail).always(Z.opts.always), f.fx.timer(f.extend(U, {
                    elem: r,
                    anim: Z,
                    queue: Z.opts.queue
                })), Z
            ...
            f.fn.extend({
                ...
                xi[s] = function(p, w, x) {
                    ...
                    return x || (z = xi[U], xi[U] = T, T = u(p, w, x) != null ? U : null, xi[U] = z), T
                }
            });
            ...
            f.fn.extend({
                ...
                toggleClass: function(r, s) {
                    ...
                    return typeof s == "boolean" && p ? s ? this.addClass(r) : this.removeClass(r) : re(r) ? this.each(function(w) {
                        f(this).toggleClass(r.call(this, w, Xn(this), s), s)
                    }) : this.each(function() {
                        var w, x, T, z;
                        if (p)
            ...
            f.extend(f.event, {
                trigger: function(r, s, u, p) {
                    ...
                    if (x = be = T = u = u || P, !(u.nodeType === 3 || u.nodeType === 8) && !Lr.test(ce + f.event.triggered) && (ce.indexOf(".") > -1 && (Ge = ce.split("."), ce = Ge.shift(), Ge.sort()), U = ce.indexOf(":") < 0 && "on" + ce, r = r[f.expando] ? r : new f.Event(ce, typeof r == "object" && r), r.isTrigger = p ? 2 : 3, r.namespace = Ge.join("."), r.rnamespace = r.namespace ? new RegExp("(^|\\.)" + Ge.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, r.result = void 0, r.target || (r.target = u), s = s == null ? [r] : f.makeArray(s, [r]), le = f.event.special[ce] || {}, !(!p && le.trigger && le.trigger.apply(u, s) === !1))) {
                        ...
                        return r.type = ce, !p && !r.isDefaultPrevented() && (!le._default || le._default.apply(ne.pop(), s) === !1) && te(u) && U && re(u[ce]) && !m(u) && (T = u[U], T && (u[U] = null), f.event.triggered = ce, r.isPropagationStopped() && be.addEventListener(ce, Yn), u[ce](), r.isPropagationStopped() && be.removeEventListener(ce, Yn), f.event.triggered = void 0, T && (u[U] = T)), r.result
                    }
                },
            ...
            f.param = function(r, s) {
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var r = this.type;
                        return this.name && !f(this).is(":disabled") && Ao.test(this.nodeName) && !To.test(r) && (this.checked || !fe.test(r))
                    }).map(function(r, s) {
                        var u = f(this).val();
...
`)
            ...
            f.extend({
                ...
                ajaxSetup: function(r, s) {
                    return s ? Br(Br(r, f.ajaxSettings), s) : Br(f.ajaxSettings, r)
                },
                ajaxPrefilter: Cs(ws),
                ajaxTransport: Cs(Nr),
                ajax: function(r, s) {
                    typeof r == "object" && (s = r, r = void 0), s = s || {};
                    var u, p, w, x, T, z, U, Z, le, be, ne = f.ajaxSetup({}, s),
                        ce = ne.context || ne,
                    ...
                    if (st.promise(tt), ne.url = ((r || ne.url || Ei.href) + "").replace(Lo, Ei.protocol + "//"), ne.type = s.method || s.type || ne.method || ne.type, ne.dataTypes = (ne.dataType || "*").toLowerCase().match(ke) || [""], ne.crossDomain == null) {
                        z = P.createElement("a");
                        try {
                    ...
                    if (ne.data && ne.processData && typeof ne.data != "string" && (ne.data = f.param(ne.data, ne.traditional)), xs(ws, ne, s, tt), U) return tt;
                    Z = f.event && ne.global, Z && f.active++ === 0 && f.event.trigger("ajaxStart"), ne.type = ne.type.toUpperCase(), ne.hasContent = !Do.test(ne.type), p = ne.url.replace(Ro, ""), ne.hasContent ? ne.data && ne.processData && (ne.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (ne.data = ne.data.replace(Oo, "+")) : (be = ne.url.slice(p.length), ne.data && (ne.processData || typeof ne.data == "string") && (p += (qi.test(p) ? "&" : "?") + ne.data, delete ne.data), ne.cache === !1 && (p = p.replace(Io, "$1"), be = (qi.test(p) ? "&" : "?") + "_=" + Mr.guid++ + be), ne.url = p + be), ne.ifModified && (f.lastModified[p] && tt.setRequestHeader("If-Modified-Since", f.lastModified[p]), f.etag[p] && tt.setRequestHeader("If-None-Match", f.etag[p])), (ne.data && ne.hasContent && ne.contentType !== !1 || s.contentType) && tt.setRequestHeader("Content-Type", ne.contentType), tt.setRequestHeader("Accept", ne.dataTypes[0] && ne.accepts[ne.dataTypes[0]] ? ne.accepts[ne.dataTypes[0]] + (ne.dataTypes[0] !== "*" ? ", " + bs + "; q=0.01" : "") : ne.accepts["*"]);
                    ...
                    if (_t = "abort", je.add(ne.complete), tt.done(ne.success), tt.fail(ne.error), u = xs(Nr, ne, s, tt), !u) on(-1, "No Transport");
                    else {
                    ...
                    function on(ft, Dt, Si, Wi) {
                        ...
                        U || (U = !0, T && e.clearTimeout(T), u = void 0, w = Wi || "", tt.readyState = ft > 0 ? 4 : 0, hn = ft >= 200 && ft < 300 || ft === 304, Si && (an = Mo(ne, tt, Si)), !hn && f.inArray("script", ne.dataTypes) > -1 && f.inArray("json", ne.dataTypes) < 0 && (ne.converters["text script"] = function() {}), an = Po(ne, an, tt, hn), hn ? (ne.ifModified && (Ln = tt.getResponseHeader("Last-Modified"), Ln && (f.lastModified[p] = Ln), Ln = tt.getResponseHeader("etag"), Ln && (f.etag[p] = Ln)), ft === 204 || ne.type === "HEAD" ? vn = "nocontent" : ft === 304 ? vn = "notmodified" : (vn = an.state, Jn = an.data, Qn = an.error, hn = !Qn)) : (Qn = vn, (ft || !vn) && (vn = "error", ft < 0 && (ft = 0))), tt.status = ft, tt.statusText = (Dt || vn) + "", hn ? st.resolveWith(ce, [Jn, vn, tt]) : st.rejectWith(ce, [tt, vn, Qn]), tt.statusCode(zt), zt = void 0, Z && Ge.trigger(hn ? "ajaxSuccess" : "ajaxError", [tt, ne, hn ? Jn : Qn]), je.fireWith(ce, [tt, vn]), Z && (Ge.trigger("ajaxComplete", [tt, ne]), --f.active || f.event.trigger("ajaxStop")))
                    }
                    return tt
                },
            ...
            Y.cors = !!_i && "withCredentials" in _i, Y.ajax = _i = !!_i, f.ajaxTransport(function(r) {
                var s, u;
            ...
            f.ajaxSetup({
                ...
                if (T || r.dataTypes[0] === "jsonp") return p = r.jsonpCallback = re(r.jsonpCallback) ? r.jsonpCallback() : r.jsonpCallback, T ? r[T] = r[T].replace(jr, "$1" + p) : r.jsonp !== !1 && (r.url += (qi.test(r.url) ? "&" : "?") + r.jsonp + "=" + p), r.converters["script json"] = function() {
                    ...
                    w === void 0 ? f(e).removeProp(p) : e[p] = w, r[p] && (r.jsonpCallback = s.jsonpCallback, $r.push(p)), x && re(w) && w(x[0]), x = w = void 0
                }), "script"
                ...
                var p, w, x;
                return s || (Y.createHTMLDocument ? (s = P.implementation.createHTMLDocument(""), p = s.createElement("base"), p.href = P.location.href, s.head.appendChild(p)) : s = P), w = Fe.exec(r), x = !u && [], w ? [s.createElement(w[1])] : (w = In([r], s, x), x && x.length && f(x).remove(), f.merge([], w.childNodes))
            }, f.fn.load = function(r, s, u) {
                var p, w, x, T = this,
                    z = r.indexOf(" ");
                return z > -1 && (p = Wn(r.slice(z)), r = r.slice(0, z)), re(s) ? (u = s, s = void 0) : s && typeof s == "object" && (w = "POST"), T.length > 0 && f.ajax({
                    url: r,
                    type: w || "GET",
                    dataType: "html",
                    data: s
                }).done(function(U) {
                    x = arguments, T.html(p ? f("<div>").append(f.parseHTML(U)).find(p) : U)
                ...
                setOffset: function(r, s, u) {
                    var p, w, x, T, z, U, Z, le = f.css(r, "position"),
                        be = f(r),
                        ne = {};
                    le === "static" && (r.style.position = "relative"), z = be.offset(), x = f.css(r, "top"), U = f.css(r, "left"), Z = (le === "absolute" || le === "fixed") && (x + U).indexOf("auto") > -1, Z ? (p = be.position(), T = p.top, w = p.left) : (T = parseFloat(x) || 0, w = parseFloat(U) || 0), re(s) && (s = s.call(r, u, f.extend({}, z))), s.top != null && (ne.top = s.top - z.top + T), s.left != null && (ne.left = s.left - z.left + w), "using" in s ? s.using.call(r, ne) : be.css(ne)
                }
            }, f.fn.extend({
                offset: function(r) {
                ...
                f.cssHooks[s] = y(Y.pixelPosition, function(u, p) {
                    if (p) return p = et(u, s), bi.test(p) ? f(u).position()[s] + "px" : p
                })
            }), f.each({
                Height: "height",
                Width: "width"
                ...
                f.each({
                    ...
                    f.fn[p] = function(w, x) {
                        ...
                        return g(this, function(U, Z, le) {
                            var be;
                            return m(U) ? p.indexOf("outer") === 0 ? U["inner" + r] : U.document.documentElement["client" + r] : U.nodeType === 9 ? (be = U.documentElement, Math.max(U.body["scroll" + r], be["scroll" + r], U.body["offset" + r], be["offset" + r], be["client" + r])) : le === void 0 ? f.css(U, Z, z) : f.style(U, Z, le, z)
                        }, s, T ? w : void 0, T)
                    }
                })
            ...
            f.proxy = function(r, s) {
                var u, p, w;
                if (typeof s == "string" && (u = r[s], s = r, r = u), !!re(r)) return p = d.call(arguments, 2), w = function() {
            ...
            }, f.isArray = Array.isArray, f.parseJSON = JSON.parse, f.nodeName = K, f.isFunction = re, f.isWindow = m, f.camelCase = V, f.type = se, f.now = Date.now, f.isNumeric = function(r) {
                var s = f.type(r);
            ...
            return f.noConflict = function(r) {
                return e.$ === f && (e.$ = Bo), r && e.jQuery === f && (e.jQuery = Vo), f
        ...
        i.extend(f.prototype, $, {
            ...
            set: function(E, l) {
                if (E != null) {
                    ...
                    for (wt = 0; wt < E.length; wt++) {
                        ...
                        if (Ct) {
                            if (Ie && ct !== Ct) {
                                ...
                                l.parse && (Kt = Ct.parse(Kt, l)), Ct.set(Kt, l), V.push(Ct), xt && !it && (it = Ct.hasChanged(rn))
                            }
                    ...
                    var Qe = !1,
                        Mt = !xt && he && De;
                    if (O.length && Mt ? (Qe = this.length !== O.length || i.some(this.models, function(j, N) {
                            return j !== O[N]
                        }), this.models.length = 0, Me(this.models, O, 0), this.length = this.models.length) : M.length && (xt && (it = !0), Me(this.models, M, _ == null ? this.length : _), this.length = this.models.length), it && this.sort({
                            silent: !0
                        }), !l.silent) {
                        for (wt = 0; wt < M.length; wt++) _ != null && (l.index = _ + wt), ct = M[wt], ct.trigger("add", ct, this, l);
                        (it || Qe) && this.trigger("sort", this, l), (M.length || te.length || V.length) && (l.changes = {
                            added: M,
                            removed: te,
                            merged: V
        ...
        (function(n, i) {
            ...
            v._eventsApi = function(m, P, q, ae) {
                ...
                if ((typeof q > "u" ? "undefined" : a(q)) === "object") {
                    for (var ve in q) {
                        var f = m[P].apply(m, [ve, q[ve]].concat(ae));
                        S.test(ve) ? n.extend(se, f) : se[ve] = f
                    }
                    return se
                }
                if (S.test(q)) {
            ...
            function I(m, P, q, ae) {
                m || (m = {});
                for (var se = P ? [P] : n.keys(m), ve = !1, f = 0, Ee = se.length; f < Ee; f++) P = se[f], !!m[P] && k(m, P, q, ae) && (ve = !0);
                return ve
            }
            var D = {};
            ...
            v.Requests = {
                request: function(P) {
                    ...
                    if (se && this._tunedIn && v.log.apply(this, [se, P].concat(q)), ve && (ve[P] || ve.default)) {
                        ...
                        return q = ve[P] ? q : arguments, v._callHandler(f.callback, f.context, q)
...
(function(t, e) {
    (function(n, i) {
                    ...
                    if (Q) this.render();
                        ...
                        var Ce = [],
                            qe = i.reduce(this.children._views, function(Wt, Gn) {
                                ...
                                return Nn === -1 ? (Ce.push(Gn.model), Wt) : (Gn._index = Nn, Wt[Nn] = Gn.el, Wt)
                            }, new Array(A.length));
        ...
        i.extend(Fi.prototype, Se, ct, Qe);
        ...
        }, et.bindEvents = v(_e), et.unbindEvents = v(ke), et.bindRequests = v(Je), et.unbindRequests = v(dt), et.mergeOptions = v(D), et.getOption = v($), et.normalizeMethods = v(J), et.extend = S, et.isNodeAttached = I, et.deprecate = k, et.triggerMethod = v(m), et.triggerMethodOn = P, et.isEnabled = it, et.setEnabled = xt, et.monitorViewEvents = oe, et.Behaviors = {}, et.Behaviors.behaviorsLookup = Ui, et.Application = zi, et.AppRouter = Hn, et.Renderer = Ye, et.TemplateCache = _, et.View = Pn, et.CollectionView = kn, et.NextCollectionView = vi, et.CompositeView = yi, et.Behavior = Fi, et.Region = pe, et.Error = we, et.Object = g, et.DEV_MODE = !1, et.FEATURES = De, et.VERSION = d, et.DomApi = N, et.setDomApi = function(y) {
            kn.setDomApi(y), yi.setDomApi(y), vi.setDomApi(y), pe.setDomApi(y), Pn.setDomApi(y)
        }, et
...
function Oh(t) {
    ...
    if (n < 0) return !1;
    var i = e.length - 1;
    return n == i ? e.pop() : Ah.call(e, n, 1), --this.size, !0
}
var Rh = Oh,
    Ih = lo;
...
wr.prototype.clear = jh;
wr.prototype.delete = Fh;
wr.prototype.get = zh;
wr.prototype.has = Uh;
wr.prototype.set = Hh;
var co = wr,
...
var Zh = Qh,
    ed = typeof yt == "object" && yt && yt.Object === Object && yt,
    xc = ed,
    td = xc,
    nd = typeof self == "object" && self && self.Object === Object && self,
    id = td || nd || Function("return this")(),
    br = id,
    rd = br,
    sd = rd.Symbol,
    Ec = sd,
...
var fd = dd,
    ...
    md = "[object Null]",
    vd = "[object Undefined]",
    wl = yl ? yl.toStringTag : void 0;

function yd(t) {
    return t == null ? t === void 0 ? vd : md : wl && wl in Object(t) ? pd(t) : gd(t)
}
var uo = yd;
...
var Pd = Md,
    ...
    Ud = Object.prototype,
    Hd = zd.toString,
    Gd = Ud.hasOwnProperty,
    qd = RegExp("^" + Hd.call(Gd).replace(jd, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");

function Wd(t) {
    if (!Bd(t) || Vd(t)) return !1;
    var e = Nd(t) ? qd : Fd;
    return e.test($d(t))
}
var Xd = Wd;
...
function wf(t) {
    var e = this.__data__;
    return mf ? e[t] !== void 0 : yf.call(e, t)
}
var bf = wf,
    Cf = ho,
...
function Ef(t, e) {
    var n = this.__data__;
    return this.size += this.has(t) ? 0 : 1, n[t] = Cf && e === void 0 ? xf : e, this
}
var _f = Ef,
    Sf = af,
    kf = cf,
...
function Bf(t, e) {
    var n = t.__data__;
    return Vf(e) ? n[typeof e == "string" ? "string" : "hash"] : n.map
}
var fo = Bf,
    $f = fo;
...
xr.prototype.clear = Jf;
xr.prototype.delete = Qf;
xr.prototype.get = Zf;
xr.prototype.has = ep;
xr.prototype.set = tp;
var np = xr,
...
function ap(t, e) {
    ...
    if (n instanceof ip) {
        var i = n.__data__;
        if (!rp || i.length < op - 1) return i.push([t, e]), this.size = ++n.size, this;
...
function Er(t) {
    var e = this.__data__ = new cp(t);
    this.size = e.size
}
Er.prototype.clear = up;
Er.prototype.delete = hp;
Er.prototype.get = dp;
Er.prototype.has = fp;
Er.prototype.set = pp;
var gp = Er,
...
function Cp(t, e, n) {
    (n !== void 0 && !bp(t[e], n) || n === void 0 && !(e in t)) && wp(t, e, n)
}
var Tc = Cp;

function xp(t) {
    return function(e, n, i) {
        for (var a = -1, d = Object(e), v = i(e), S = v.length; S--;) {
            var k = v[t ? S : ++a];
...
function Rp(t) {
    ...
    return new _l(e).set(new _l(t)), e
}
var Ip = Rp,
    Dp = Ip;

function Lp(t, e) {
    var n = e ? Dp(t.buffer) : t.buffer;
...
var Fp = jp,
    zp = Fp,
    Up = zp(Object.getPrototypeOf, Object),
    Ac = Up,
    Hp = Object.prototype;
...
function Yp(t) {
    return typeof t.constructor == "function" && !Xp(t) ? qp(Wp(t)) : {}
}
var Kp = Yp;
...
var ng = tg,
    ...
    ig = us,
    Rc = Object.prototype,
    rg = Rc.hasOwnProperty,
    sg = Rc.propertyIsEnumerable,
    og = kl(function() {
        return arguments
    }()) ? kl : function(t) {
        return ig(t) && rg.call(t, "callee") && !sg.call(t, "callee")
    },
    Ic = og,
    ag = Array.isArray,
    Dc = ag,
...
function dg(t) {
    return t != null && hg(t.length) && !ug(t)
}
var Fa = dg,
    fg = Fa,
    pg = us;
...
function Tg(t) {
    if (!Cg(t) || wg(t) != xg) return !1;
    var e = bg(t);
    if (e === null) return !0;
    var n = Sg.call(e, "constructor") && e.constructor;
    return typeof n == "function" && n instanceof n && Mc.call(n) == kg
}
var Ag = Tg,
    Og = uo,
    Rg = Lc,
    ...
    Lt = {};
Lt[Wg] = Lt[Xg] = Lt[Yg] = Lt[Kg] = Lt[Jg] = Lt[Qg] = Lt[Zg] = Lt[em] = Lt[tm] = !0;
Lt[Dg] = Lt[Lg] = Lt[Gg] = Lt[Mg] = Lt[qg] = Lt[Pg] = Lt[Ng] = Lt[Vg] = Lt[Bg] = Lt[$g] = Lt[jg] = Lt[Fg] = Lt[zg] = Lt[Ug] = Lt[Hg] = !1;

function nm(t) {
    return Ig(t) && Rg(t.length) && !!Lt[Og(t)]
}
var im = nm;
...
function pm(t, e, n) {
    var i = t[e];
    (!(fm.call(t, e) && hm(i, n)) || n === void 0 && !(e in t)) && um(t, e, n)
}
var gm = pm,
    mm = gm,
    vm = ja;
...
function ym(t, e, n, i) {
    var a = !n;
    n || (n = {});
    for (var d = -1, v = e.length; ++d < v;) {
        var S = e[d],
            k = i ? i(n[S], t[S], S, n, t) : void 0;
        k === void 0 && (k = t[S]), a ? vm(n, S, k) : mm(n, S, k)
    }
    return n
}
var wm = ym;
...
function _m(t, e) {
    var n = typeof t;
    return e = e == null ? xm : e, !!e && (n == "number" || n != "symbol" && Em.test(t)) && t > -1 && t % 1 == 0 && t < e
}
var Vc = _m,
    Sm = Cm,
    km = Ic,
...
function Lm(t, e) {
    var n = Tm(t),
        ...
        d = !n && !i && !a && Rm(t),
        v = n || i || a || d,
        S = v ? Sm(t.length, String) : [],
        k = S.length;
    for (var I in t)(e || Dm.call(t, I)) && !(v && (I == "length" || a && (I == "offset" || I == "parent") || d && (I == "buffer" || I == "byteLength" || I == "byteOffset") || Om(I, k))) && S.push(I);
    return S
}
var Mm = Lm;
...
function cv(t, e, n, i, a, d, v) {
    ...
    var D = d ? d(S, k, n + "", t, e, v) : void 0,
        $ = D === void 0;
    if ($) {
        var J = Il(k),
            ie = !J && iv(k),
            Y = !J && !ie && av(k);
        D = k, J || ie || Y ? Il(S) ? D = S : nv(S) ? D = ev(S) : ie ? ($ = !1, D = Qm(k, !0)) : Y ? ($ = !1, D = Zm(k, !0)) : D = [] : ov(k) || Rl(k) ? (D = S, Rl(S) ? D = lv(S) : (!sv(S) || rv(S)) && (D = tv(k))) : $ = !1
    }
    $ && (v.set(k, D), a(D, k, i, d, v), v.delete(k)), Ol(t, n, D)
}
var uv = cv,
    hv = gp,
    dv = Tc,
...
function $c(t, e, n, i, a) {
    t !== e && fv(e, function(d, v) {
        if (a || (a = new hv), gv(d)) pv(t, e, v, n, $c, i, a);
        else {
            var S = i ? i(vv(t, v), d, v + "", t, e, a) : void 0;
            S === void 0 && (S = d), dv(t, v, S)
        }
    }, mv)
}
var yv = $c;
...
function Ev(t, e, n) {
    return e = Ll(e === void 0 ? t.length - 1 : e, 0),
        function() {
            for (var i = arguments, a = -1, d = Ll(i.length - e, 0), v = Array(d); ++a < d;) v[a] = i[e + a];
            a = -1;
            for (var S = Array(e + 1); ++a < e;) S[a] = i[a];
            return S[e] = n(v), xv(t, this, S)
        }
}
var _v = Ev;
...
function Yv(t, e, n) {
    if (!Xv(n)) return !1;
    var i = typeof e;
    return (i == "number" ? qv(n) && Wv(e, n.length) : i == "string" && e in n) ? Gv(n[e], t) : !1
}
var Kv = Yv,
    Jv = Hv,
    Qv = Kv;
...
function Zv(t) {
    return Jv(function(e, n) {
        var i = -1,
            a = n.length,
            d = a > 1 ? n[a - 1] : void 0,
            v = a > 2 ? n[2] : void 0;
        for (d = t.length > 3 && typeof d == "function" ? (a--, d) : void 0, v && Qv(n[0], n[1], v) && (d = a < 3 ? void 0 : d, a = 1), e = Object(e); ++i < a;) {
            var S = n[i];
            S && t(e, S, i, d)
        }
        return e
...
ot(Ea, "locale"), ot(Ea, "supported", ["en", "fr", "it", "de", "es", "es-XL"]);
const pl = class {
    ...
    static adjustColor(e, n) {
        ...
        const d = parseInt(a, 16),
            v = Math.min(Math.max(0, (d >> 16) * n), 255),
            S = Math.min(Math.max(0, (d >> 8 & 255) * n), 255);
        let I = (Math.min(Math.max(0, (d & 255) * n), 255) | S << 8 | v << 16).toString(16);
...
let nn = pl;
ot(nn, "queryParams", new URLSearchParams(window.location.search)), ot(nn, "getQueryParam", e => pl.queryParams.get(e)), ot(nn, "sleep", e => new Promise(n => {
...
(function(t, e) {
    ...
    (function(d) {
        (function(v) {
            ...
            return Fe.polyfill = !0, d.fetch || (d.fetch = Fe, d.Headers = Y, d.Request = Ae, d.Response = Be), v.Headers = Y, v.Request = Ae, v.Response = Be, v.fetch = Fe, Object.defineProperty(v, "__esModule", {
                value: !0
            }), v
        })({})
...
var sy = function() {
    ...
    Pl = typeof Symbol < "u" && Symbol,
    oy = sy,
    ay = function() {
        return typeof Pl != "function" || typeof Symbol != "function" || typeof Pl("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : oy()
    },
    ...
    hy = function(e) {
        ...
        for (var i = ea.call(arguments, 1), a, d = function() {
    ...
    ta = function(t) {
        try {
            return Fc('"use strict"; return (' + t + ").constructor;")()
        } catch {}
    },
...
var na = function() {
    ...
    hr = {
        ...
        "%isFinite%": isFinite,
        "%isNaN%": isNaN,
        "%IteratorPrototype%": ir ? li(li([][Symbol.iterator]())) : vt,
        "%JSON%": typeof JSON == "object" ? JSON : vt,
        "%Map%": typeof Map > "u" ? vt : Map,
        "%MapIteratorPrototype%": typeof Map > "u" || !ir ? vt : li(new Map()[Symbol.iterator]()),
        "%Math%": Math,
        "%Number%": Number,
        "%Object%": Object,
        ...
        "%SetIteratorPrototype%": typeof Set > "u" || !ir ? vt : li(new Set()[Symbol.iterator]()),
        "%SharedArrayBuffer%": typeof SharedArrayBuffer > "u" ? vt : SharedArrayBuffer,
        "%String%": String,
        "%StringIteratorPrototype%": ir ? li("" [Symbol.iterator]()) : vt,
        "%Symbol%": ir ? Symbol : vt,
        "%SyntaxError%": gr,
        "%ThrowTypeError%": gy,
        "%TypedArray%": my,
    ...
    Ey = function(e) {
        ...
        var a = [];
        return Vl(e, Cy, function(d, v, S, k) {
            a[a.length] = S ? Vl(k, xy, "$1") : v || d
        }), a
    },
    _y = function(e, n) {
        var i = e,
            a;
        if (Js(Nl, i) && (a = Nl[i], i = "%" + a[0] + "%"), Js(hr, i)) {
            var d = hr[i];
            if (d === or && (d = vy(i)), typeof d > "u" && !n) throw new ur("intrinsic " + e + " exists, but is not available. Please file an issue!");
            return {
                alias: a,
                name: i,
                value: d
    ...
    Ua = function(e, n) {
        ...
        if (by(/^%?[^%]*%?$/g, e) === null) throw new gr("`%` may not be present anywhere but at the beginning and end of the intrinsic name");
        var i = Ey(e),
            a = i.length > 0 ? i[0] : "",
            d = _y("%" + a + "%", n),
            v = d.name,
...
var Uc = Ua,
    Hc = zc.exports,
    Sy = Hc(Uc("String.prototype.indexOf")),
    ky = function(e, n) {
        var i = Uc(e, !!n);
        return typeof i == "function" && Sy(e, ".prototype.") > -1 ? Hc(i) : i
    };
const Ty = {},
...
var Ha = typeof Map == "function" && Map.prototype,
    ia = Object.getOwnPropertyDescriptor && Ha ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null,
    Zs = Ha && ia && typeof ia.get == "function" ? ia.get : null,
    ...
    eo = Ga && ra && typeof ra.get == "function" ? ra.get : null,
    Iy = Ga && Set.prototype.forEach,
    Dy = typeof WeakMap == "function" && WeakMap.prototype,
    ts = Dy ? WeakMap.prototype.has : null,
    Ly = typeof WeakSet == "function" && WeakSet.prototype,
    ns = Ly ? WeakSet.prototype.has : null,
    My = typeof WeakRef == "function" && WeakRef.prototype,
    Bl = My ? WeakRef.prototype.deref : null,
    ...
    zl = (typeof Reflect == "function" ? Reflect.getPrototypeOf : Object.getPrototypeOf) || ([].__proto__ === Array.prototype ? function(t) {
        return t.__proto__
    } : null);
...
var Ta = Oy,
    ...
    Fy = function t(e, n, i, a) {
        ...
        var v = ci(d, "customInspect") ? d.customInspect : !0;
        ...
        if (typeof e == "string") return Kc(e, d);
        if (typeof e == "number") {
        ...
        function J(Fe, H, oe) {
            if (H && (a = jy.call(a), a.push(H)), oe) {
                var Te = {
                    depth: d.depth
                };
                return ci(d, "quoteStyle") && (Te.quoteStyle = d.quoteStyle), t(Fe, Te, i + 1, a)
            }
            return t(Fe, d, i + 1, a)
        }
        ...
        if (Xc(e)) {
            var re = mr ? di.call(String(e), /^(Symbol\(.*\))_[^)]*$/, "$1") : ka.call(e);
            return typeof e == "object" && !mr ? Yr(re) : re
        }
        if (nw(e)) {
            for (var m = "<" + $l.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + Wc(zy(P[q].value), "double", d);
            return m += ">", e.childNodes && e.childNodes.length && (m += "..."), m += "</" + $l.call(String(e.nodeName)) + ">", m
        }
        if (Aa(e)) {
            if (e.length === 0) return "[]";
            var ae = Ms(e, J);
            return $ && !rw(ae) ? "[" + Oa(ae, $) + "]" : "[ " + jn.call(ae, ", ") + " ]"
        }
        if (Hy(e)) {
            var se = Ms(e, J);
            return !("cause" in Error.prototype) && "cause" in e && !qc.call(e, "cause") ? "{ [" + String(e) + "] " + jn.call(jl.call("[cause]: " + J(e.cause), se), ", ") + " }" : se.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + jn.call(se, ", ") + " }"
        }
        if (typeof e == "object" && v) {
            if (Gl && typeof e[Gl] == "function" && Ta) return Ta(e, {
                depth: D - i
            });
        ...
        if (Jy(e)) {
            var ve = [];
            return Ry.call(e, function(Fe, H) {
                ve.push(J(H, e, !0) + " => " + J(Fe, e))
            }), Wl("Map", Zs.call(e), ve, $)
        }
        if (ew(e)) {
            var f = [];
            return Iy.call(e, function(Fe) {
                f.push(J(Fe, e))
            }), Wl("Set", eo.call(e), f, $)
        }
        if (Qy(e)) return oa("WeakMap");
        if (tw(e)) return oa("WeakSet");
        if (Zy(e)) return oa("WeakRef");
        if (qy(e)) return Yr(J(Number(e)));
        if (Xy(e)) return Yr(J(Sa.call(e)));
        if (Wy(e)) return Yr(Py.call(e));
        if (Gy(e)) return Yr(J(String(e)));
        if (!Uy(e) && !ql(e)) {
            var Ee = Ms(e, J),
                Ae = zl ? zl(e) === Object.prototype : e instanceof Object || e.constructor === Object,
                Me = e instanceof Object ? "" : "null prototype",
                lt = !Ae && cn && Object(e) === e && cn in e ? qa.call(gi(e), 8, -1) : Me ? "Object" : "",
                Be = Ae || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "",
                K = Be + (lt || Me ? "[" + jn.call(jl.call([], lt || [], Me || []), ": ") + "] " : "");
            return Ee.length === 0 ? K + "{}" : $ ? K + "{" + Oa(Ee, $) + "}" : K + "{ " + jn.call(Ee, ", ") + " }"
        }
        return String(e)
    };
...
var Yy = Object.prototype.hasOwnProperty || function(t) {
    return t in this
};
...
function Ky(t) {
    ...
    var e = By.call(Vy.call(t), /^function\s*([\w$]+)/);
    return e ? e[1] : null
}
...
function Kc(t, e) {
    if (t.length > e.maxStringLength) {
        ...
        return Kc(qa.call(t, 0, e.maxStringLength), e) + i
    }
    var a = di.call(di.call(t, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, iw);
    return Wc(a, "single", e)
}
...
function iw(t) {
    ...
    return n ? "\\" + n : "\\x" + (e < 16 ? "0" : "") + $y.call(e.toString(16))
}
...
function Ms(t, e) {
    ...
    var d = typeof sa == "function" ? sa(t) : [],
        v;
    if (mr) {
        v = {};
        for (var S = 0; S < d.length; S++) v["$" + d[S]] = d[S]
    }
    for (var k in t) !ci(t, k) || n && String(Number(k)) === k && k < t.length || mr && v["$" + k] instanceof Symbol || (Gc.call(/[^\w$]/, k) ? i.push(e(k, t) + ": " + e(t[k], t)) : i.push(k + ": " + e(t[k], t)));
    if (typeof sa == "function")
        for (var I = 0; I < d.length; I++) qc.call(t, d[I]) && i.push("[" + e(d[I]) + "]: " + e(t[d[I]], t));
    return i
}
var Wa = Ua,
    _r = ky,
    ...
    Ps = Wa("%WeakMap%", !0),
    Ns = Wa("%Map%", !0),
    lw = _r("WeakMap.prototype.get", !0),
    cw = _r("WeakMap.prototype.set", !0),
    uw = _r("WeakMap.prototype.has", !0),
    hw = _r("Map.prototype.get", !0),
    dw = _r("Map.prototype.set", !0),
    fw = _r("Map.prototype.has", !0),
    Xa = function(t, e) {
        for (var n = t, i;
            (i = n.next) !== null; n = i)
    ...
    vw = function() {
        var e, n, i, a = {
            assert: function(d) {
                if (!a.has(d)) throw new aw("Side channel does not contain " + ow(d))
            },
            get: function(d) {
            ...
            has: function(d) {
                if (Ps && d && (typeof d == "object" || typeof d == "function")) {
                    ...
                    if (n) return fw(n, d)
                } else if (i) return mw(i, d);
                return !1
            },
            set: function(d, v) {
                Ps && d && (typeof d == "object" || typeof d == "function") ? (e || (e = new Ps), cw(e, d, v)) : Ns ? (n || (n = new Ns), dw(n, d, v)) : (i || (i = {
                    key: {},
                    next: null
                }), gw(i, d, v))
            }
    ...
    xw = function t(e, n, i) {
        ...
        var a = e;
        return Li(e) && !Li(n) && (a = Jc(e, i)), Li(e) && Li(n) ? (n.forEach(function(d, v) {
            if (la.call(e, v)) {
                var S = e[v];
                S && typeof S == "object" && d && typeof d == "object" ? e[v] = t(S, d, i) : e.push(d)
            } else e[v] = d
        }), e) : Object.keys(n).reduce(function(d, v) {
            var S = n[v];
            return la.call(d, v) ? d[v] = t(d[v], S, i) : d[v] = S, d
        }, a)
    },
    Ew = function(e, n) {
    ...
    Sw = function(e, n, i, a, d) {
        ...
        for (var S = "", k = 0; k < v.length; ++k) {
            ...
            if (I === 45 || I === 46 || I === 95 || I === 126 || I >= 48 && I <= 57 || I >= 65 && I <= 90 || I >= 97 && I <= 122 || d === bw.RFC1738 && (I === 40 || I === 41)) {
                S += v.charAt(k);
                continue
            }
            if (I < 128) {
    ...
    kw = function(e) {
        for (var n = [{
            ...
            for (var d = n[a], v = d.obj[d.prop], S = Object.keys(v), k = 0; k < S.length; ++k) {
                var I = S[k],
                    D = v[I];
    ...
    ti = Array.isArray,
    Dw = String.prototype.split,
    Lw = Array.prototype.push,
    eu = function(t, e) {
        Lw.apply(t, ti(e) ? e : [e])
    },
    ...
    ca = {},
    Nw = function t(e, n, i, a, d, v, S, k, I, D, $, J, ie, Y, re, m) {
        for (var P = e, q = m, ae = 0, se = !1;
            (q = q.get(ca)) !== void 0 && !se;) {
            var ve = q.get(e);
            if (ae += 1, typeof ve < "u") {
                if (ve === ae) throw new RangeError("Cyclic object value");
                se = !0
            }
            typeof q.get(ca) > "u" && (ae = 0)
        }
        if (typeof k == "function" ? P = k(n, P) : P instanceof Date ? P = $(P) : i === "comma" && ti(P) && (P = Ra.maybeMap(P, function(ue) {
                return ue instanceof Date ? $(ue) : ue
            })), P === null) {
            if (d) return S && !Y ? S(n, tn.encoder, re, "key", J) : n;
            P = ""
        }
        if (Pw(P) || Ra.isBuffer(P)) {
            if (S) {
                var f = Y ? n : S(n, tn.encoder, re, "key", J);
                if (i === "comma" && Y) {
                    for (var Ee = Dw.call(String(P), ","), Ae = "", Me = 0; Me < Ee.length; ++Me) Ae += (Me === 0 ? "" : ",") + ie(S(Ee[Me], tn.encoder, re, "value", J));
                    return [ie(f) + (a && ti(P) && Ee.length === 1 ? "[]" : "") + "=" + Ae]
                }
                return [ie(f) + "=" + ie(S(P, tn.encoder, re, "value", J))]
            }
        ...
        for (var Fe = a && ti(P) && P.length === 1 ? n + "[]" : n, H = 0; H < Be.length; ++H) {
            var oe = Be[H],
            ...
            if (!(v && Te === null)) {
                ...
                m.set(e, ae);
                var ye = Zc();
                ye.set(ca, m), eu(lt, t(Te, we, i, a, d, v, S, k, I, D, $, J, ie, Y, re, ye))
            }
        }
        return lt
    },
    Vw = function(e) {
        ...
        if (typeof e.format < "u") {
            if (!Iw.call(is.formatters, e.format)) throw new TypeError("Unknown format option provided.");
            i = e.format
        }
        var a = is.formatters[i],
            d = tn.filter;
        return (typeof e.filter == "function" || ti(e.filter)) && (d = e.filter), {
    ...
    Bw = function(t, e) {
        var n = t,
            i = Vw(e),
            a, d;
        typeof i.filter == "function" ? (d = i.filter, n = d("", n)) : ti(i.filter) && (d = i.filter, a = d);
        var v = [];
        if (typeof n != "object" || n === null) return "";
        var S;
        e && e.arrayFormat in Xl ? S = e.arrayFormat : e && "indices" in e ? S = e.indices ? "indices" : "repeat" : S = "indices";
        var k = Xl[S];
        ...
        for (var D = Zc(), $ = 0; $ < a.length; ++$) {
            var J = a[$];
            i.skipNulls && n[J] === null || eu(v, Nw(n[J], J, k, I, i.strictNullHandling, i.skipNulls, i.encode ? i.encoder : null, i.filter, i.sort, i.allowDots, i.serializeDate, i.format, i.formatter, i.encodeValuesOnly, i.charset, D))
        }
    ...
    Uw = function(e, n) {
        var i = {},
            ...
            v = a.split(n.delimiter, d),
            S = -1,
            k, I = n.charset;
        if (n.charsetSentinel)
            for (k = 0; k < v.length; ++k) v[k].indexOf("utf8=") === 0 && (v[k] === zw ? I = "utf-8" : v[k] === Fw && (I = "iso-8859-1"), S = k, k = v.length);
        for (k = 0; k < v.length; ++k)
            if (k !== S) {
                var D = v[k],
                    ...
                    J = $ === -1 ? D.indexOf("=") : $ + 1,
                    ie, Y;
                J === -1 ? (ie = n.decoder(D, Qt.decoder, I, "key"), Y = n.strictNullHandling ? null : "") : (ie = n.decoder(D.slice(0, J), Qt.decoder, I, "key"), Y = vr.maybeMap(tu(D.slice(J + 1), n), function(re) {
                    return n.decoder(re, Qt.decoder, I, "value")
                })), Y && n.interpretNumericEntities && I === "iso-8859-1" && (Y = jw(Y)), D.indexOf("[]=") > -1 && (Y = $w(Y) ? [Y] : Y), Ia.call(i, ie) ? i[ie] = vr.combine(i[ie], Y) : i[ie] = Y
            } return i
    },
    Hw = function(t, e, n, i) {
        for (var a = i ? e : tu(e, n), d = t.length - 1; d >= 0; --d) {
            var v, S = t[d];
    ...
    Gw = function(e, n, i, a) {
        if (!!e) {
            var d = i.allowDots ? e.replace(/\.([^.[]+)/g, "[$1]") : e,
                v = /(\[[^[\]]*])/,
                S = /(\[[^[\]]*])/g,
                k = i.depth > 0 && v.exec(d),
                I = k ? d.slice(0, k.index) : d,
                D = [];
            if (I) {
                if (!i.plainObjects && Ia.call(Object.prototype, I) && !i.allowPrototypes) return;
                D.push(I)
            }
            for (var $ = 0; i.depth > 0 && (k = S.exec(d)) !== null && $ < i.depth;) {
                if ($ += 1, !i.plainObjects && Ia.call(Object.prototype, k[1].slice(1, -1)) && !i.allowPrototypes) return;
                D.push(k[1])
            }
            return k && D.push("[" + d.slice(k.index) + "]"), Hw(D, n, i, a)
        }
    },
    qw = function(e) {
        if (!e) return Qt;
    ...
    Ww = function(t, e) {
        ...
        for (var i = typeof t == "string" ? Uw(t, n) : t, a = n.plainObjects ? Object.create(null) : {}, d = Object.keys(i), v = 0; v < d.length; ++v) {
            var S = d[v],
                k = Gw(S, i[S], n, typeof t == "string");
            a = vr.merge(a, k, n)
        }
...
var ab = ar,
    ...
    Jl = dr && typeof dr.apply == "function" ? dr.apply : function(e, n, i) {
...
Rt.prototype.emit = function(e) {
    ...
    if (typeof k == "function") Jl(k, this, n);
    else
        for (var I = k.length, D = cu(k, I), i = 0; i < I; ++i) Jl(D[i], this, n);
    return !0
};

function su(t, e, n, i) {
    var a, d, v;
    if (go(n), d = t._events, d === void 0 ? (d = t._events = Object.create(null), t._eventsCount = 0) : (d.newListener !== void 0 && (t.emit("newListener", e, n.listener ? n.listener : n), d = t._events), v = d[e]), v === void 0) v = d[e] = n, ++t._eventsCount;
    else if (typeof v == "function" ? v = d[e] = i ? [n, v] : [v, n] : i ? v.unshift(n) : v.push(n), a = ru(t), a > 0 && v.length > a && !v.warned) {
        v.warned = !0;
        ...
        S.name = "MaxListenersExceededWarning", S.emitter = t, S.type = e, S.count = v.length, lb(S)
    }
    return t
}
...
Rt.prototype.once = function(e, n) {
    return go(n), this.on(e, ou(this, e, n)), this
};
Rt.prototype.prependOnceListener = function(e, n) {
    return go(n), this.prependListener(e, ou(this, e, n)), this
};
Rt.prototype.removeListener = function(e, n) {
    ...
    if (i === n || i.listener === n) --this._eventsCount === 0 ? this._events = Object.create(null) : (delete a[e], a.removeListener && this.emit("removeListener", e, i.listener || n));
        ...
        for (d = -1, v = i.length - 1; v >= 0; v--)
            if (i[v] === n || i[v].listener === n) {
                S = i[v].listener, d = v;
                break
            } if (d < 0) return this;
        d === 0 ? i.shift() : ub(i, d), i.length === 1 && (a[e] = i[0]), a.removeListener !== void 0 && this.emit("removeListener", e, S || n)
    }
    return this
};
...
Rt.prototype.removeAllListeners = function(e) {
    ...
    if (arguments.length === 0) {
        var d = Object.keys(i),
            v;
        for (a = 0; a < d.length; ++a) v = d[a], v !== "removeListener" && this.removeAllListeners(v);
...
function au(t, e, n) {
    ...
    if (i === void 0) return [];
    var a = i[e];
    return a === void 0 ? [] : typeof a == "function" ? n ? [a.listener || a] : [a] : n ? hb(a) : cu(a, a.length)
}
...
var ni = {
    ...
    EcastRoomHasEnded: $u,
    EcastEntityLocked: ju,
    EcastRateLimitExceeded: Fu,
    ObservedError: pb
};
const mb = {
    1e3: ds,
...
function Da(t, e, n) {
    switch (t) {
        ...
        case "client/welcome": {
            ...
            if (e.entities) {
                let a = {};
                Object.entries(e.entities).forEach(([d, v]) => {
                    a[d] = Da(v[0], v[1], v[2])
                }), i.entities = a
            }
            return i
...
const tc = ab,
    ...
    $0 = 1e3 + Math.floor(Math.random() * 500),
    ic = 13e3;
class j0 extends T0 {
    constructor(e) {
    ...
    connect() {
        ...
        return new Promise((a, d) => {
            ...
            this.conn = new tc(i, "ecast-v0"), this.conn.onmessage = D => {
                this.debugLog(`recv <- ${JSON.stringify(JSON.parse(D.data),null,2)}`);
                const $ = N0(D);
                if ($ instanceof L0) this.onReply($);
                else if ($ instanceof nc) {
                    if ($.result instanceof O0) S = !0, this.id = $.result.id, this.deviceId = $.result.deviceId, this.entities = $.result.entities, this.secret = $.result.secret, $.result.name && (this.name = $.result.name), k($.result);
                    else if (!v) {
                        I($.result);
                        return
                    }
    ...
    async reconnect() {
        ...
        for (;;) try {
            ...
            e += 1, this.debugLog("waiting", n), this.emit("connection", {
                status: "waiting",
                attempt: e
            }), await this.sleep(n), n = Math.min(ic, n * 2)
        }
    }
    disconnect() {
    ...
    onReply(e) {
        ...
        delete this.pending[n], e.result instanceof A0 ? i.reject(e.result) : i.resolve(e.result)
    }
    onNotification(e) {
    ...
    send(e, n = {}) {
        ...
        if (this.conn.readyState !== tc.OPEN) throw new Error(`Socket not ready to send, readyState is ${this.conn.readyState}`);
        const i = ++this.seq,
            a = new M0({
                seq: i,
                opcode: e,
            ...
            v = JSON.stringify(a);
        return this.debugLog(`send -> ${v}`), this.conn.send(v), d
    }
    lockRoom() {
    ...
    async createText(e, n, i) {
        ...
        d && (a.acl = d), v && (a.accept = v), S && (a.reject = S);
    ...
    async createDoodle(e, n) {
        ...
        a && (i.acl = a), d && (i.colors = d), i.live = v, S != null && (i.maxPoints = S), k && (i.size = k), I && (i.weights = I);
    ...
    async createTextRing(e, n) {
        ...
        a && (i.limit = a), d && (i.accept = d), v && (i.reject = v);
    ...
    (function(n, i) {
        ...
        function Ee(j, N) {
            ...
            var W = re.exec(j),
                ...
                pe = 0,
                Pe;
            return G ? fe ? (Pe = W[2] + W[3] + W[4], pe = W[2].length + W[3].length) : (Pe = W[2] + W[4], pe = W[2].length) : fe ? (Pe = W[3] + W[4], pe = W[3].length) : Pe = W[4], L === "file:" ? pe >= 2 && (Pe = Pe.slice(2)) : f(L) ? Pe = W[4] : L ? G && (Pe = Pe.slice(2)) : pe >= 2 && f(N.protocol) && (Pe = W[4]), {
                protocol: L,
                slashes: G || f(L),
                slashesCount: pe,
                rest: Pe
        ...
        function Me(j, N, W) {
            ...
            var L, G, fe, pe, Pe, Ve, pt = ae.slice(),
                ...
                Ye = this,
                In = 0;
            for (jt !== "object" && jt !== "string" && (W = N, N = null), W && typeof W != "function" && (W = ie.parse), N = ve(N), G = Ee(j || "", N), L = !G.protocol && !G.slashes, Ye.slashes = G.slashes || L && N.slashes, Ye.protocol = G.protocol || N.protocol || "", j = G.rest, (Ye.protocol === "file:" || !G.slashes && (G.protocol || G.slashesCount < 2 || !f(Ye.protocol))) && (pt[3] = [/(.*)/, "pathname"]); In < pt.length; In++) {
            ...
            W && (Ye.query = W(Ye.query)), L && N.slashes && Ye.pathname.charAt(0) !== "/" && (Ye.pathname !== "" || N.pathname !== "") && (Ye.pathname = Ae(Ye.pathname, N.pathname)), Ye.pathname.charAt(0) !== "/" && f(Ye.protocol) && (Ye.pathname = "/" + Ye.pathname), a(Ye.port, Ye.protocol) || (Ye.host = Ye.hostname, Ye.port = ""), Ye.username = Ye.password = "", Ye.auth && (pe = Ye.auth.split(":"), Ye.username = pe[0] || "", Ye.password = pe[1] || ""), Ye.origin = Ye.protocol !== "file:" && f(Ye.protocol) && Ye.host ? Ye.protocol + "//" + Ye.host : "null", Ye.href = Ye.toString()
        }
        ...
        function Be(j) {
            ...
            var G = L + (W.slashes || f(W.protocol) ? "//" : "");
        ...
        var _e = new ue,
            ...
            Je = function() {};
        Je.prototype.stopPropagation = function() {}, Je.prototype.stopImmediatePropagation = function() {}, Je.prototype.initEvent = function(N, W, L) {
        ...
        function xt() {
            return typeof window < "u" ? window : typeof process == "object" && typeof oC == "function" && typeof yt == "object" ? yt : this
        }
        var rn = {
                mock: !0,
                verifyClient: null,
            ...
            ct = function(j) {
                ...
                return j && (N.__proto__ = j), N.prototype = Object.create(j && j.prototype), N.prototype.constructor = N, N.prototype.mockWebsocket = function() {
                    ...
                    fe === void 0 && (fe = []);
                    var Pe = this,
                        Ve = it(fe.concat(_e.websocketsLookup(this.url, L, G)));
                    return {
                        to: function(pt, jt) {
        ...
        var Kt = ct,
            Qe = De,
            Mt = Ct;
        n.Server = Kt, n.WebSocket = Qe, n.SocketIO = Mt, Object.defineProperty(n, "__esModule", {
            value: !0
        })
    })
})(sc, sc.exports);
...
(function(t) {
    (function() {
        ...
        function v(S, k, I) {
            ...
            return S = I ? S : i(S, D), S = d(S, D), S
        }
        t.exports = v, t.exports.default = v
    })()
})(aC);
const lC = mt.View.extend({
    el: "#banner",
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/pp6-rolemodels/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
...
(function(t) {
    (function(e) {
            ...
            addBinding: function(m, P, q) {
                ...
                if (this.unstickit(ae, P), !!f.length) {
                    ...
                    if (Ee._destroy = function() {
                            v.call(this, Ee.destroy, f, ae, Ee)
                        }, J(f, Ee, ae, Ae), Y(f, Ee, ae, Ae), ie(f, Ee, ae), Ae) {
                        e.each(Ee.events, function(K) {
                            var Fe = K + se,
                                H = function(Te) {
                                    var we = v.call(this, Ee.getVal, f, Te, Ee, a.call(arguments, 1)),
                    ...
                    v.call(this, Ee.initialize, f, ae, Ee)
                }
            }
        ...
        var a = [].slice,
            ...
            v = function(m) {
                if (m = e.isString(m) ? d(this, m) : m, m) return m.apply(this, a.call(arguments, 1))
            },
            S = function(m, P, q) {
            ...
            I = function(m, P, q, ae, se) {
                var ve = {},
                    f = se.view;
                se.onSet && (q = v.call(f, se.onSet, q, se)), se.set ? v.call(f, se.set, P, q, ae, se) : (ve[P] = q, e.isArray(P) && e.isArray(q) && (ve = e.reduce(P, function(Ee, Ae, Me) {
            ...
            D = function(m, P, q) {
                ...
                return q.onGet && (f = v.call(ae, q.onGet, f, q)), e.isArray(f) ? e.map(f, ve) : ve(f)
            },
                    ...
                    var Ee = "",
                        ...
                        Me = function() {
                            var lt = e.contains(se, f.name) ? "prop" : "attr",
                                Be = D(q, Ae, f);
                            f.name === "class" ? (m.removeClass(Ee).addClass(Be), Ee = Be) : m[lt](f.name, Be)
                        };
                    ...
                    var se = P.view,
                        ve = function() {
                            var f = P.visible,
                                ...
                                Ae = D(q, ae, P),
                                Me = !!Ae;
                            (e.isFunction(f) || e.isString(f)) && (Me = !!v.call(se, f, Ae, P)), Ee ? v.call(se, Ee, m, Me, P) : m.toggle(Me)
                        };
        ...
        return i.addHandler([{
            ...
            update: function(m, P, q, ae) {
                if (m.length > 1) P || (P = []), m.each(function(ve, f) {
                    var Ee = n.$(f),
            ...
            update: function(m, P, q, ae) {
                ...
                if (!ve) {
                    ...
                    m.find("optgroup").length ? (f = {
                        opt_labels: []
                    }, m.find("> option").length && (f.opt_labels.push(void 0), e.each(m.find("> option"), function(ue) {
                        f[void 0] = Ae(n.$(ue))
                ...
                var Me = function(ue, _e, ke) {
                    e.each(ue, function($e) {
                        var Je = n.$("<option/>"),
                            dt = $e,
                            Bt = function(_, O, M) {
                                Je.text(_), dt = O, Je.data("stickit-bind-val", dt), !e.isArray(dt) && !e.isObject(dt) && Je.val(dt), M === !0 && Je.prop("disabled", "disabled")
                            },
                            Gt, E, l;
                        $e === "__default__" ? (Gt = ke.label, E = ke.value, l = ke.disabled) : (Gt = d($e, ve.labelPath), E = d($e, ve.valuePath), l = d($e, ve.disabledPath)), Bt(Gt, E, l);
                        var g = function() {
                            return !Ee && dt != null && ke != null && dt === ke ? !0 : !!(e.isObject(ke) && e.isEqual(dt, ke))
                        };
                        g() ? Je.prop("selected", !0) : Ee && e.isArray(ke) && e.each(ke, function(_) {
                            e.isObject(_) && (_ = d(_, ve.valuePath)), (_ === dt || e.isObject(_) && e.isEqual(dt, _)) && Je.prop("selected", !0)
                        }), _e.append(Je)
                    })
                };
                if (m.find("*").remove(), e.isString(f)) {
                    var lt = window;
                    f.indexOf("this.") === 0 && (lt = this), f = f.replace(/^[a-z]*\.(.+)$/, "$1"), se = d(lt, f)
                } else e.isFunction(f) ? se = v.call(this, f, m, ae) : se = f;
...
const uC = `<button type="button" class='button choice-button btn btn-lg'></button>
        ...
        return function(i) {
            ...
            function $() {
                if (i.scrollHeight !== 0) {
                    ...
                    i.style.height = "", i.style.height = i.scrollHeight + d + "px", v = i.clientWidth, ie.forEach(function(re) {
...
const fC = `<form>\r
    ...
    to = mt.View.extend({
        ...
        onAttach() {
            this.getOption("preventAutosize") || oc(Ne("textarea"))
        },
        onSubmitClick() {
        ...
        clearInput() {
            ...
            Ne(t).val(""), this.getOption("preventAutosize") || oc.update(t), this.onInputChange()
        },
        setValue(t) {
    ...
    pi = mt.CollectionView.extend({
        tagName: "div",
        className: "choices",
        childView(t) {
            return t.get("type") === "input" ? to : t.get("type") === "text" ? si : Yu
        },
...
function gC(t) {
    ...
    return Hs = Jr.getContext("2d"), Hs.imageSmoothingEnabled = !1, Ju("init"), {
        canvas: Jr,
        context: Hs
    }
}
class sl {
    constructor({
        ...
        this.width = d, this.height = v, this.margin = S, this._f = 0, this._a = 0
    }
    clone() {
        return yo(this)
    }
    ...
    render({
        ...
        d.drawImage(this.spriteSheet.image, S * this.width + (S * 2 + 1) * this.margin, v * this.height + (v * 2 + 1) * this.margin, this.width, this.height, e, n, i, a)
    }
}
...
function yC({
    ...
    function Y() {
        if (I = requestAnimationFrame(Y), D = ie.now(), $ = D - k, k = D, !($ > 1e3)) {
            for (Ju("tick"), a += $; a >= d;) J.update(v), a -= d;
            S(), J.render()
        }
    }
    return J = {
...
function lc(t, e) {
    ...
    return t.x < i && t.x + t.width >= e.x && (d && n.push(0), v && n.push(2)), t.x + t.width >= i && t.x < e.x + e.width && (d && n.push(1), v && n.push(3)), n
}
class ol {
    constructor({
        maxDepth: e = 3,
    ...
    get(e) {
        ...
        for (; this._s.length && this._b;) {
            for (i = lc(e, this.bounds), a = 0; a < i.length; a++) this._s[i[a]].get(e).forEach(d => n.add(d));
            return Array.from(n)
        }
    ...
    _a(e, n, i) {
        for (n = lc(e, this.bounds), i = 0; i < n.length; i++) this._s[n[i]].add(e)
    }
    _sp(e, n, i) {
...
class cl {
    ...
    init(e = {}) {
        ...
        this.position = fr(n, i), this.velocity = fr(a, d), this.acceleration = fr(v, S), this._fx = this._fy = 1, this.width = this.height = this.rotation = 0, this.ttl = 1 / 0, this.anchor = {
            x: 0,
            y: 0
        }, this.context = vo();
        for (let $ in e) this[$] = e[$];
    ...
    (function(n, i) {
        ...
        const n = "SweetAlert2:",
            ...
            Me = c => {
                ...
                for (const h in c) f(h), c.toast && Ee(h), Ae(h)
            },
            lt = "swal2-",
            Be = c => {
                const h = {};
...
`).replace(/(^|\n)\s*/g, ""),
            ...
            kr = () => {
                const c = we(),
                    ...
                    Vn = j(c, K.textarea);
                h.oninput = sn, b.onchange = sn, Ue.onchange = sn, Ht.onchange = sn, Vn.oninput = sn, B.oninput = () => {
                    sn(), ge.value = B.value
                }, B.onchange = () => {
                    sn(), ge.value = B.value
                }
            ...
            $i = c => {
                window.getComputedStyle(c).direction === "rtl" && Qe(H(), K.rtl)
            },
            yi = c => {
                const h = kn();
                if (In()) {
                ...
                b.className = K.container, h && Qe(b, K["no-transition"]), it(b, Sr);
                const B = Tr(c.target);
                B.appendChild(b), vi(c), $i(B), kr()
            },
            wi = (c, h) => {
                c instanceof HTMLElement ? h.appendChild(c) : typeof c == "object" ? ji(c, h) : c && it(h, c)
            },
            ji = (c, h) => {
            ...
            bi = (c, h) => {
                const b = g(),
                    B = E();
                !h.showConfirmButton && !h.showDenyButton && !h.showCancelButton ? L(b) : W(b), ct(b, h, "actions"), Hn(b, B, h), it(B, h.loaderHtml), ct(B, h, "loader")
            };
        ...
        function Hn(c, h, b) {
            const B = dt(),
                ge = Bt(),
                Ue = l();
            Ci(B, "confirm", b), Ci(ge, "deny", b), Ci(Ue, "cancel", b), Ui(B, ge, Ue, b), b.reverseButtons && (b.toast ? (c.insertBefore(Ue, B), c.insertBefore(ge, B)) : (c.insertBefore(Ue, h), c.insertBefore(ge, h), c.insertBefore(B, h)))
        }

        function Ui(c, h, b, B) {
            if (!B.buttonsStyling) return Mt([c, h, b], K.styled);
            Qe([c, h, b], K.styled), B.confirmButtonColor && (c.style.backgroundColor = B.confirmButtonColor, Qe(c, K["default-outline"])), B.denyButtonColor && (h.style.backgroundColor = B.denyButtonColor, Qe(h, K["default-outline"])), B.cancelButtonColor && (b.style.backgroundColor = B.cancelButtonColor, Qe(b, K["default-outline"]))
        }

        function Ci(c, h, b) {
            fe(c, b["show".concat(a(h), "Button")], "inline-block"), it(c, b["".concat(h, "ButtonText")]), c.setAttribute("aria-label", b["".concat(h, "ButtonAriaLabel")]), c.className = K[h], ct(c, b, "".concat(h, "Button")), Qe(c, b["".concat(h, "ButtonClass")])
        }
        const et = (c, h) => {
            const b = H();
        ...
        function y(c, h) {
            typeof h == "string" ? c.style.background = h : h || Qe([document.documentElement, document.body], K["no-backdrop"])
        }

        function o(c, h) {
            h in K ? Qe(c, K[h]) : (d('The "position" parameter is not valid, defaulting to "center"'), Qe(c, K.center))
        }
        ...
        const Q = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
            Ce = (c, h) => {
                ...
                Q.forEach(Ue => {
                    const Ht = j(b, K[Ue]);
                    Wt(Ue, h.inputAttributes), Ht.className = K[Ue], ge && L(Ht)
            ...
            Gn = c => {
                const h = Ar(c.input);
                typeof c.customClass == "object" && Qe(h, c.customClass.input)
            },
            Nn = (c, h) => {
            ...
            qn = (c, h, b) => {
                if (b.inputLabel) {
                    ...
                    const B = document.createElement("label"),
                        ge = K["input-label"];
                    B.setAttribute("for", c.id), B.className = ge, typeof b.customClass == "object" && Qe(B, b.customClass.inputLabel), B.innerText = b.inputLabel, h.insertAdjacentElement("beforebegin", B)
                }
            },
            ...
            Ft = {};
        Ft.text = Ft.email = Ft.password = Ft.number = Ft.tel = Ft.url = (c, h) => (Xt(c, h.inputValue), qn(c, c, h), Nn(c, h), c.type = h.input, c), Ft.file = (c, h) => (qn(c, c, h), Nn(c, h), c), Ft.range = (c, h) => {
            ...
            Xt(c, h.inputValue), Nn(c, h), qn(c, c, h);
        ...
        const Hi = (c, h) => {
            ...
            Or = (c, h) => {
                ...
                W(B), ms(B, h), Rr(B, h), Qe(B, h.showClass.icon)
            },
            Rr = (c, h) => {
                for (const b in Fe) h.icon !== b && Mt(c, Fe[b]);
                Qe(c, Fe[h.icon]), bn(c, h), Gi(), ct(c, h, "icon")
            },
            Gi = () => {
                const c = we(),
...
`,
            ...
            Eo = (c, h) => {
                ...
                W(b), b.textContent = "", h.currentProgressStep >= h.progressSteps.length && d("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), h.progressSteps.forEach((B, ge) => {
                    const Ue = _o(B);
                    if (b.appendChild(Ue), ge === h.currentProgressStep && Qe(Ue, K["active-progress-step"]), ge !== h.progressSteps.length - 1) {
                        const Ht = Wn(h);
                        b.appendChild(Ht)
                    }
                })
            ...
            _o = c => {
                ...
                return Qe(h, K["progress-step"]), it(h, c), h
            },
            Wn = c => {
                const h = document.createElement("li");
                return Qe(h, K["progress-step-line"]), c.progressStepsDistance && N(h, "width", c.progressStepsDistance), h
            },
            Xn = (c, h) => {
                const b = ue();
            ...
            Dr = (c, h) => {
                const b = H(),
                    B = we();
                h.toast ? (N(b, "width", h.width), B.style.width = "100%", B.insertBefore(E(), ye())) : N(B, "width", h.width), N(B, "padding", h.padding), h.color && (B.style.color = h.color), h.background && (B.style.background = h.background), L(Je()), So(B, h)
            },
            So = (c, h) => {
                c.className = "".concat(K.popup, " ").concat(pe(c) ? h.showClass.popup : ""), h.toast ? (Qe([document.documentElement, document.body], K["toast-shown"]), Qe(c, K.toast)) : Qe(c, K.modal), ct(c, h, "popup"), typeof h.customClass == "string" && Qe(c, h.customClass), h.icon && Qe(c, K["icon-".concat(h.icon)])
            },
            Lr = (c, h) => {
                Dr(c, h), et(c, h), Eo(c, h), Or(c, h), xi(c, h), Xn(c, h), Co(c, h), Hi(c, h), bi(c, h), bo(c, h), typeof h.didRender == "function" && h.didRender(we())
            },
            Yn = Object.freeze({
                cancel: "cancel",
                backdrop: "backdrop",
            ...
            Ro = (c, h) => {
                ...
                for (const B in h) {
                    ...
                    Ue && (Kn(Ue, []), b[ge.replace(/^swal-/, "")] = Ue.innerHTML.trim())
                }
                return b
            },
            Io = c => {
...
`).join("<br />")), yi(c)
        ...
        const bs = () => {
            ...
            Cs = () => {
                if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1) && !xt(document.body, K.iosfix)) {
                    ...
                    document.body.style.top = "".concat(h * -1, "px"), Qe(document.body, K.iosfix), Br(), xs()
                }
            },
            xs = () => {
            ...
            jr = c => {
                ...
                r(h, b, c), setTimeout(() => {
                    Vo(h, b)
                }, $r), Se() && (Bo(h, c.scrollbarPadding, ge), Ei()), !he() && !rt.previousActiveElement && (rt.previousActiveElement = document.activeElement), typeof c.didOpen == "function" && setTimeout(() => c.didOpen(b)), Mt(h, K["no-transition"])
            },
            Es = c => {
                const h = we();
            ...
            r = (c, h, b) => {
                Qe(c, b.showClass.backdrop), h.style.setProperty("opacity", "0", "important"), W(h, "grid"), setTimeout(() => {
                    Qe(h, b.showClass.popup), h.style.removeProperty("opacity")
                }, $r), Qe([document.documentElement, document.body], K.shown), b.heightAuto && b.backdrop && !b.toast && Qe([document.documentElement, document.body], K["height-auto"])
            },
            s = c => {
                let h = we();
                h || new At, h = we();
            ...
            u = (c, h) => {
                const b = g(),
                    B = E();
                !h && pe(dt()) && (h = dt()), W(b), h && (L(h), B.setAttribute("data-button-to-replace", h.className)), B.parentNode.insertBefore(B, h), Qe([c, b], K.loading)
            },
            p = (c, h) => {
                ...
                select: (c, h, b) => {
                    const B = j(c, K.select),
                        ge = (Ue, Ht, Vn) => {
                            ...
                            pn.value = Vn, it(pn, Ht), pn.selected = ne(Vn, b.inputValue), Ue.appendChild(pn)
                        };
                    h.forEach(Ue => {
                        const Ht = Ue[0],
                            Vn = Ue[1];
        ...
        const zt = () => pe(we()),
            ...
            on = (c, h, b, B) => {
                tt(h), b.toast || (h.keydownHandler = ge => Wi(c, ge, B), h.keydownTarget = b.keydownListenerCapture ? window : we(), h.keydownListenerCapture = b.keydownListenerCapture, h.keydownTarget.addEventListener("keydown", h.keydownHandler, {
        ...
        function Ln(c, h, b, B) {
            he() ? ks(c, B) : (mi(b).then(() => ks(c, B)), tt(rt)), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (h.setAttribute("style", "display:none !important"), h.removeAttribute("class"), h.innerHTML = "") : h.remove(), Se() && (Vr(), _i(), Mr()), vn()
        }
        ...
        const Zn = c => {
            ...
            Mt(h, b.showClass.popup), Qe(h, b.hideClass.popup);
            const B = H();
            return Mt(B, b.showClass.backdrop), Qe(B, b.hideClass.backdrop), Ss(c, h, b), !0
        };
        ...
        const gt = c => {
            ...
            zr = (c, h, b, B, ge) => {
                rt.swalCloseEventFinishedCallback = Ln.bind(null, c, b, B, ge), h.addEventListener(mn, function(Ue) {
                    Ue.target === h && (rt.swalCloseEventFinishedCallback(), delete rt.swalCloseEventFinishedCallback)
                })
            },
            ks = (c, h) => {
                setTimeout(() => {
        ...
        function Xi(c) {
            ...
            it(h.validationMessage, c), h.validationMessage.className = K["validation-message"], b.customClass && b.customClass.validationMessage && Qe(h.validationMessage, b.customClass.validationMessage), W(h.validationMessage);
            const B = this.getInput();
            B && (B.setAttribute("aria-invalid", !0), B.setAttribute("aria-describedby", K["validation-message"]), Ct(B), Qe(B, K.inputerror))
        }
        ...
        function Ho(c) {
            const h = we(),
                b = A.innerParams.get(this);
            if (!h || xt(h, b.hideClass.popup)) return d("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
            const B = Ti(c),
        ...
        const Ti = c => {
            ...
            return Object.keys(c).forEach(b => {
                se(b) ? h[b] = c[b] : d("Invalid parameter to update: ".concat(b))
            }), h
        };
        ...
        function Go() {
            ...
            c.popup && rt.swalCloseEventFinishedCallback && (rt.swalCloseEventFinishedCallback(), delete rt.swalCloseEventFinishedCallback), typeof h.didDestroy == "function" && h.didDestroy(), Ur(this)
        }
        const Ur = c => {
        ...
        const Os = c => {
            ...
            Yi = (c, h, b) => {
                ...
                c.disableInput(), Promise.resolve().then(() => J(B.inputValidator(h, B.validationMessage))).then(Ue => {
                    c.enableButtons(), c.enableInput(), Ue ? c.showValidationMessage(Ue) : b === "deny" ? dn(c, h) : Ji(c, h)
                })
            },
            dn = (c, h) => {
            ...
            Ji = (c, h) => {
                ...
                b.showLoaderOnConfirm && s(), b.preConfirm ? (c.resetValidationMessage(), A.awaitingPromise.set(c || void 0, !0), Promise.resolve().then(() => J(b.preConfirm(h, b.validationMessage))).then(ge => {
                    pe(Je()) || ge === !1 ? (c.hideLoading(), gt(c)) : yn(c, typeof ge > "u" ? h : ge)
        ...
        class He {
            ...
            _main(h) {
                ...
                Me(Object.assign({}, b, h)), rt.currentInstance && (rt.currentInstance._destroy(), Se() && Mr()), rt.currentInstance = ze;
                const B = ht(h, b);
        ...
        const Xe = (c, h, b) => new Promise((B, ge) => {
                ...
                je.swalPromiseResolve.set(c, B), je.swalPromiseReject.set(c, ge), h.confirmButton.onclick = () => Os(c), h.denyButton.onclick = () => Rs(c), h.cancelButton.onclick = () => qo(c, Ue), h.closeButton.onclick = () => Ue(Yn.close), Wo(c, h, Ue), on(c, rt, b, Ue), p(c, b), jr(b), We(rt, b, Ue), Ut(h, b), setTimeout(() => {
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp6/rolemodels/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    Zu = mt.View.extend({
        ...
        onAttach() {
            const t = this;
            gC("cameraCanvas"), t.sprites = [], t.gameLoop = yC({
                fps: 60,
                update(e) {
            ...
            this.cameraSprite = ul(EC), this.cameraSprite.width = this.model.get("width"), this.cameraSprite.height = this.model.get("height"), this.cameraSprite.mask = this.model.get("mask"), t.sprites.push(this.cameraSprite), t.gameLoop.start(), this.facingMode = "user", this.startCamera(), this.onResize()
        },
        async startCamera() {
        ...
        onResize() {
            ...
            if (!n || !i) return;
            const a = i.width(),
                d = Math.max(Ne(window).innerHeight(), 250),
                v = Math.min(a / t, d / e),
                S = t * v,
                k = e * v;
    ...
    La = mt.View.extend({
        ...
        initialize(t) {
            this.cameraView = this.cameraView || new Zu(t), this.listenTo(this.model, "change", this.update, this), this.update()
        },
        update() {
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp6/rolemodels/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
class RC {
    constructor(e, n = {}) {
        ...
        this.canvasSelector = e, this.canvas = Ne(this.canvasSelector)[0], this.ctx = this.canvas.getContext("2d"), this.options = Object.assign(cc, n), this.history = [], this.layerNames.forEach(i => {
            const a = new eh(this.canvas.width, this.canvas.height, this.options.sketchOptions);
            a.name = i, this[i] = a
        })
    }
    update() {
    ...
    setOptions(e) {
        const n = Object.assign(cc.sketchOptions, e);
    ...
    getDataURL(e, n) {
        ...
        return n && (v.fillStyle = n, v.fillRect(0, 0, a, d)), v.drawImage(this.highlighterSketch.canvas, 0, 0, a, d), v.drawImage(this.markerSketch.canvas, 0, 0, a, d), i.toDataURL()
    }
    resetAll() {
...
const IC = `<canvas id="fullLayer" class="sketchpad fullLayer" width='480' height='600' style=''></canvas>`,
    DC = mt.View.extend({
        ...
        getCoords(t) {
            ...
            S = Math.min(d.width - v, Math.max(v, S));
            let k = (e.clientY - a.top) * i;
            return k = Math.min(d.height - v, Math.max(v, k)), {
                x: S,
                y: k
            }
        },
...
`,
    ...
    PC = mt.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new si({}), this.toolbarComponent = this.toolbarComponent || new OC({
                model: new Ke.Model({})
            }), this.sketchpadComponent = this.sketchpadComponent || new DC({
                model: new Ke.Model
            }), this.buttonsCollection = this.buttonsCollection || new Ke.Collection([]), this.buttonsComponent = this.buttonsComponent || new pi({
                block: !1,
...
`,
    ...
    BC = mt.View.extend({
        ...
        initialize() {
            this.currentEntry = null, this.shouldSubmit = !1, this.promptComponent = new si({
                model: new Ke.Model({
                    text: "",
                    className: ""
                })
...
mt.View.extend({
    ...
    onResize() {
        const t = Ne("#player").outerHeight(!0) || 0,
            e = ii.isVisible ? Ne("#slide-in-banner").outerHeight(!0) : 0,
            n = Ne(window).width(),
...
const $C = `<div id="controller" class="state-controller controller-content">
    ...
    zC = mt.View.extend({
        ...
        strings: {},
        initialize() {
            this.titleComponent = new si({
                model: new Ke.Model({})
            }), this.choicesListView = this.choicesListView || new pi, this.charactersListView = new mt.CollectionView({
                childView: FC,
...
`,
    ...
    KC = mt.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new si({
                model: new Ke.Model
        ...
        displayAudienceChoice(t) {
            let e = "Thank you.";
            const n = t.map(a => {
                const d = this.choicesList.children.find(v => v.model.get("index") === a);
...
var ai = ri(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
    fs = ri(/Edge/i),
    hc = ri(/firefox/i),
    ss = ri(/safari/i) && !ri(/chrome/i) && !ri(/android/i),
    th = ri(/iP(ad|od|hone)/i),
    nh = ri(/chrome/i) && ri(/android/i),
    ih = {
        capture: !1,
        passive: !1
    };
...
function Et(t, e, n) {
    t.addEventListener(e, n, !ai && ih)
}

function bt(t, e, n) {
    t.removeEventListener(e, n, !ai && ih)
}
...
function Yt(t, e, n, i, a) {
    if (!(!t.getBoundingClientRect && t !== window)) {
        var d, v, S, k, I, D, $;
        if (t !== window && t.parentNode && t !== Fn() ? (d = t.getBoundingClientRect(), v = d.top, S = d.left, k = d.bottom, I = d.right, D = d.height, $ = d.width) : (v = 0, S = 0, k = window.innerHeight, I = window.innerWidth, D = window.innerHeight, $ = window.innerWidth), (e || n) && t !== window && (a = a || t.parentNode, !ai))
            do
                if (a && a.getBoundingClientRect && (nt(a, "transform") !== "none" || n && nt(a, "position") !== "static")) {
                    var J = a.getBoundingClientRect();
                    v -= J.top + parseInt(nt(a, "border-top-width")), S -= J.left + parseInt(nt(a, "border-left-width")), k = v + d.height, I = S + d.width;
                    break
...
function fc(t, e, n) {
    for (var i = fi(t, !0), a = Yt(t)[e]; i;) {
        var d = Yt(i)[n],
            v = void 0;
        if (n === "top" || n === "left" ? v = a >= d : v = a <= d, !v) return i;
        if (i === Fn()) break;
        i = fi(i, !1)
    }
    return !1
...
function yr(t, e, n, i) {
    for (var a = 0, d = 0, v = t.children; d < v.length;) {
        if (v[d].style.display !== "none" && v[d] !== Ze.ghost && (i || v[d] !== Ze.dragged) && $n(v[d], n.draggable, t, !1)) {
            if (a === e) return v[d];
            a++
        }
        d++
...
function hl(t, e) {
    for (var n = t.lastElementChild; n && (n === Ze.ghost || nt(n, "display") === "none" || e && !no(n, e));) n = n.previousElementSibling;
    return n || null
}
    ...
    if (t)
        do {
            var a = pr(t),
                d = a.a,
                v = a.d;
            e += t.scrollLeft * d, n += t.scrollTop * v
        ...
        captureAnimationState: function() {
            if (t = [], !!this.options.animation) {
                ...
                i.forEach(function(a) {
                    if (!(nt(a, "display") === "none" || a === Ze.ghost)) {
                        t.push({
                            target: a,
                            rect: Yt(a)
                        });
        ...
        animateAll: function(i) {
            ...
            t.forEach(function(S) {
                var k = 0,
                    ...
                    Y = S.rect,
                    re = pr(I, !0);
                re && ($.top -= re.f, $.left -= re.e), I.toRect = $, I.thisAnimationDuration && da(J, $) && !da(D, $) && (Y.top - $.top) / (Y.left - $.left) === (D.top - $.top) / (D.left - $.left) && (k = ax(Y, J, ie, a.options)), da($, D) || (I.prevFromRect = D, I.prevToRect = $, k || (k = a.options.animation), a.animate(I, Y, $, k)), k && (d = !0, v = Math.max(v, k), clearTimeout(I.animationResetTimer), I.animationResetTimer = setTimeout(function() {
        ...
        animate: function(i, a, d, v) {
            if (v) {
                ...
                var S = pr(this.el),
                    ...
                    D = (a.left - d.left) / (k || 1),
                    $ = (a.top - d.top) / (I || 1);
                i.animatingX = !!D, i.animatingY = !!$, nt(i, "transform", "translate3d(" + D + "px," + $ + "px,0)"), this.forRepaintDummy = ox(i), nt(i, "transition", "transform " + v + "ms" + (this.options.easing ? " " + this.options.easing : "")), nt(i, "transform", "translate3d(0,0,0)"), typeof i.animated == "number" && clearTimeout(i.animated), i.animated = setTimeout(function() {
    ...
    ps = {
        ...
        pluginEvent: function(e, n, i) {
            ...
            rr.forEach(function(v) {
                !n[v.pluginName] || (n[v.pluginName][d] && n[v.pluginName][d](zn({
                    sortable: n
        ...
        initializePlugins: function(e, n, i, a) {
            ...
            for (var d in e.options)
                if (!!e.options.hasOwnProperty(d)) {
                    var v = this.modifyOption(e, d, e.options[d]);
                    typeof v < "u" && (e.options[d] = v)
                }
        },
...
function lx(t) {
    ...
    if (e = e || n && n[Sn], !!e) {
        ...
        window.CustomEvent && !ai && !fs ? re = new CustomEvent(i, {
            bubbles: !0,
            cancelable: !0
        }) : (re = document.createEvent("Event"), re.initEvent(i, !0, !0)), re.to = v || n, re.from = S || n, re.item = a || n, re.clone = d, re.oldIndex = k, re.newIndex = I, re.oldDraggableIndex = D, re.newDraggableIndex = $, re.originalEvent = J, re.pullMode = ie ? ie.lastPutMode : void 0;
...
var Re, $t, ut, Pt, Di, qs, Vt, hi, cr, _n, as, ui, $s, en, lr = !1,
    io = !1,
    ro = [],
    Oi, Mn, pa, ga, gc, mc, Qr, sr, ls, cs = !1,
    js = !1,
    Ws, ln, ma = [],
    Ma = !1,
    so = [],
    ...
    Fs = th,
    vc = fs || ai ? "cssFloat" : "float",
    ux = wo && !nh && !th && "draggable" in document.createElement("div"),
    lh = function() {
        if (!!wo) {
            if (ai) return !1;
    ...
    ch = function(e, n) {
        var i = nt(e),
            ...
            S = d && nt(d),
            k = v && nt(v),
            I = S && parseInt(S.marginLeft) + parseInt(S.marginRight) + Yt(d).width,
        ...
        return d && (S.display === "block" || S.display === "flex" || S.display === "table" || S.display === "grid" || I >= a && i[vc] === "none" || v && i[vc] === "none" && I + D > a) ? "vertical" : "horizontal"
    },
    hx = function(e, n, i) {
    ...
    dx = function(e, n) {
        ...
        return ro.some(function(a) {
            ...
            if (!(!d || hl(a))) {
                var v = Yt(a),
                    S = e >= v.left - d && e <= v.right + d,
                    k = n >= v.top - d && n <= v.bottom + d;
                if (S && k) return i = a
            }
        }), i
    },
    uh = function(e) {
        function n(d, v) {
            return function(S, k, I, D) {
                ...
                if (d == null && (v || $)) return !0;
                if (d == null || d === !1) return !1;
                if (v && d === "clone") return d;
                if (typeof d == "function") return n(d(S, k, I, D), v)(S, k, I, D);
    ...
    hh = function() {
        !lh && ut && nt(ut, "display", "none")
    },
    dh = function() {
        !lh && ut && nt(ut, "display", "")
    };
wo && !nh && document.addEventListener("click", function(t) {
...
Ze.prototype = {
    ...
    _onTapStart: function(e) {
        if (!!e.cancelable) {
            var n = this,
                ...
                D = a.filter;
            if (Cx(i), !Re && !(/mousedown|pointerdown/.test(v) && e.button !== 0 || a.disabled) && !I.isContentEditable && !(!this.nativeDraggable && ss && k && k.tagName.toUpperCase() === "SELECT") && (k = $n(k, a.draggable, i, !1), !(k && k.animated) && qs !== k)) {
    ...
    _prepareDragStart: function(e, n, i) {
        var a = this,
            ...
            S = d.ownerDocument,
            k;
        if (i && !Re && i.parentNode === d) {
            var I = Yt(i);
            if (Pt = d, Re = i, $t = Re.parentNode, Di = Re.nextSibling, qs = i, $s = v.group, Ze.dragged = Re, Oi = {
                    target: Re,
                    clientX: (n || e).clientX,
                    clientY: (n || e).clientY
                }, gc = Oi.clientX - I.left, mc = Oi.clientY - I.top, this._lastX = (n || e).clientX, this._lastY = (n || e).clientY, Re.style["will-change"] = "all", k = function() {
                    if (wn("delayEnded", a, {
                            evt: e
                        }), Ze.eventCanceled) {
                        a._onDrop();
                    ...
                    a._disableDelayedDragEvents(), !hc && a.nativeDraggable && (Re.draggable = !0), a._triggerDragStart(e, n), gn({
                        sortable: a,
                        name: "choose",
                        originalEvent: e
                    ...
                    rh(Re, D.trim(), va)
                }), Et(S, "dragover", Ri), Et(S, "mousemove", Ri), Et(S, "touchmove", Ri), Et(S, "mouseup", a._onDrop), Et(S, "touchend", a._onDrop), Et(S, "touchcancel", a._onDrop), hc && this.nativeDraggable && (this.options.touchStartThreshold = 4, Re.draggable = !0), wn("delayStart", this, {
                    evt: e
                }), v.delay && (!v.delayOnTouchOnly || n) && (!this.nativeDraggable || !(fs || ai))) {
                if (Ze.eventCanceled) {
                    this._onDrop();
                    return
                }
    ...
    _disableDelayedDrag: function() {
        Re && va(Re), clearTimeout(this._dragStartTimer), this._disableDelayedDragEvents()
    },
    ...
    _dragStarted: function(e, n) {
        if (lr = !1, Pt && Re) {
            ...
            var i = this.options;
            !e && En(Re, i.dragClass, !1), En(Re, i.ghostClass, !0), Ze.active = this, e && this._appendGhost(), gn({
                sortable: this,
                name: "start",
                originalEvent: n
            })
    ...
    _emulateDragOver: function() {
        if (Mn) {
            this._lastX = Mn.clientX, this._lastY = Mn.clientY, hh();
    ...
    _onTouchMove: function(e) {
        if (Oi) {
            var n = this.options,
                ...
                k = ut && v && v.d,
                I = Fs && ln && pc(ln),
                D = (d.clientX - Oi.clientX + a.x) / (S || 1) + (I ? I[0] - ma[0] : 0) / (S || 1),
                $ = (d.clientY - Oi.clientY + a.y) / (k || 1) + (I ? I[1] - ma[1] : 0) / (k || 1);
            if (!Ze.active && !lr) {
                if (i && Math.max(Math.abs(d.clientX - this._lastX), Math.abs(d.clientY - this._lastY)) < i) return;
                this._onDragStart(e, !0)
            }
            if (ut) {
                v ? (v.e += D - (pa || 0), v.f += $ - (ga || 0)) : v = {
                    a: 1,
                    b: 0,
                    c: 0,
                    d: 1,
                ...
                nt(ut, "webkitTransform", J), nt(ut, "mozTransform", J), nt(ut, "msTransform", J), nt(ut, "transform", J), pa = D, ga = $, Mn = d
            }
    ...
    _appendGhost: function() {
        if (!ut) {
            ...
            if (Fs) {
                ...
                ln !== document.body && ln !== document.documentElement ? (ln === document && (ln = Fn()), n.top += ln.scrollTop, n.left += ln.scrollLeft) : ln = Fn(), ma = pc(ln)
            }
            ut = Re.cloneNode(!0), En(ut, i.ghostClass, !1), En(ut, i.fallbackClass, !0), En(ut, i.dragClass, !0), nt(ut, "transition", ""), nt(ut, "transform", ""), nt(ut, "box-sizing", "border-box"), nt(ut, "margin", 0), nt(ut, "top", n.top), nt(ut, "left", n.left), nt(ut, "width", n.width), nt(ut, "height", n.height), nt(ut, "opacity", "0.8"), nt(ut, "position", Fs ? "absolute" : "fixed"), nt(ut, "zIndex", "100000"), nt(ut, "pointerEvents", "none"), Ze.ghost = ut, e.appendChild(ut), nt(ut, "transform-origin", gc / parseInt(ut.style.width) * 100 + "% " + mc / parseInt(ut.style.height) * 100 + "%")
        }
    },
    _onDragStart: function(e, n) {
        ...
        wn("setupClone", this), Ze.eventCanceled || (Vt = ah(Re), Vt.removeAttribute("id"), Vt.draggable = !1, Vt.style["will-change"] = "", this._hideClone(), En(Vt, this.options.chosenClass, !1), Ze.clone = Vt), i.cloneId = Xs(function() {
            wn("clone", i), !Ze.eventCanceled && (i.options.removeCloneOnHide || Pt.insertBefore(Vt, Re), i._hideClone(), gn({
                sortable: i,
                name: "clone"
            }))
        }), !n && En(Re, d.dragClass, !0), n ? (io = !0, i._loopId = setInterval(i._emulateDragOver, 50)) : (bt(document, "mouseup", i._onDrop), bt(document, "touchend", i._onDrop), bt(document, "touchcancel", i._onDrop), a && (a.effectAllowed = "move", d.setData && d.setData.call(i, a, Re)), Et(document, "drop", i), nt(Re, "transform", "translateZ(0)")), lr = !0, i._dragStartId = Xs(i._dragStarted.bind(i, n, e)), Et(document, "selectstart", i), Qr = !0, ss && nt(document.body, "user-select", "none")
    },
    _onDragOver: function(e) {
        var n = this.el,
            i = e.target,
            a, d, v, S = this.options,
            k = S.group,
            I = Ze.active,
            D = $s === k,
            $ = S.sort,
        ...
        function q(ye) {
            return m("dragOverCompleted", {
                insertion: ye
            }), ye && (D ? I._hideClone() : I._showClone(Y), Y !== J && (En(Re, en ? en.options.ghostClass : I.options.ghostClass, !1), En(Re, S.ghostClass, !0)), en !== Y && Y !== Ze.active ? en = Y : Y === Ze.active && en && (en = null), J === Y && (Y._ignoreWhileAnimating = i), Y.animateAll(function() {
                m("dragOverAnimationComplete"), Y._ignoreWhileAnimating = null
            }), Y !== J && (J.animateAll(), J._ignoreWhileAnimating = null)), (i === Re && !Re.animated || i === n && !i.animated) && (sr = null), !S.dragoverBubble && !e.rootEl && i !== document && (Re.parentNode[Sn]._isOutsideThisEl(e.target), !ye && Ri(e)), !S.dragoverBubble && e.stopPropagation && e.stopPropagation(), re = !0
        }

        function ae() {
            _n = On(Re), ui = On(Re, S.draggable), gn({
                sortable: Y,
                name: "change",
                toEl: n,
                newIndex: _n,
        ...
        if (e.preventDefault !== void 0 && e.cancelable && e.preventDefault(), i = $n(i, S.draggable, n, !0), m("dragOver"), Ze.eventCanceled) return re;
        ...
        if (io = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : en === this || (this.lastPutMode = $s.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            if (ie = this._getDirection(e, i) === "vertical", a = Yt(Re), m("dragOverValid"), Ze.eventCanceled) return re;
            if (v) return $t = Pt, P(), this._hideClone(), m("revert"), Ze.eventCanceled || (Di ? Pt.insertBefore(Re, Di) : Pt.appendChild(Re)), q(!0);
            var se = hl(n, S.draggable);
            if (!se || vx(e, ie, this) && !se.animated) {
                if (se === Re) return q(!1);
                if (se && n === e.target && (i = se), i && (d = Yt(i)), zs(Pt, n, Re, a, i, d, e, !!i) !== !1) return P(), se && se.nextSibling ? n.insertBefore(Re, se.nextSibling) : n.appendChild(Re), $t = n, ae(), q(!0)
            } else if (se && mx(e, ie, this)) {
                var ve = yr(n, 0, S, !0);
                if (ve === Re) return q(!1);
                if (i = ve, d = Yt(i), zs(Pt, n, Re, a, i, d, e, !1) !== !1) return P(), n.insertBefore(Re, ve), $t = n, ae(), q(!0)
            } else if (i.parentNode === n) {
                d = Yt(i);
                var f = 0,
                    Ee, Ae = Re.parentNode !== n,
                    Me = !hx(Re.animated && Re.toRect || a, i.animated && i.toRect || d, ie),
                    lt = ie ? "top" : "left",
                    Be = fc(i, "top", "top") || fc(Re, "top", "top"),
                    K = Be ? Be.scrollTop : void 0;
                sr !== i && (Ee = d[lt], cs = !1, js = !Me && S.invertSwap || Ae), f = yx(e, i, d, ie, Me ? 1 : S.swapThreshold, S.invertedSwapThreshold == null ? S.swapThreshold : S.invertedSwapThreshold, js, sr === i);
                var Fe;
                if (f !== 0) {
                    var H = On(Re);
                    do H -= f, Fe = $t.children[H]; while (Fe && (nt(Fe, "display") === "none" || Fe === ut))
                }
                ...
                var oe = i.nextElementSibling,
                    Te = !1;
                Te = f === 1;
                var we = zs(Pt, n, Re, a, i, d, e, Te);
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Ma = !0, setTimeout(gx, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), Be && oh(Be, 0, K - Be.scrollTop), $t = Re.parentNode, Ee !== void 0 && !js && (Ws = Math.abs(Ee - Yt(i)[lt])), ae(), q(!0)
            }
    ...
    _onDrop: function(e) {
        ...
        lr = !1, js = !1, cs = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), Pa(this.cloneId), Pa(this._dragStartId), this.nativeDraggable && (bt(document, "drop", this), bt(n, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), ss && nt(document.body, "user-select", ""), nt(Re, "transform", ""), e && (Qr && (e.cancelable && e.preventDefault(), !i.dropBubble && e.stopPropagation()), ut && ut.parentNode && ut.parentNode.removeChild(ut), (Pt === $t || en && en.lastPutMode !== "clone") && Vt && Vt.parentNode && Vt.parentNode.removeChild(Vt), Re && (this.nativeDraggable && bt(Re, "dragend", this), va(Re), Re.style["will-change"] = "", Qr && !lr && En(Re, en ? en.options.ghostClass : this.options.ghostClass, !1), En(Re, this.options.chosenClass, !1), gn({
            ...
            toEl: $t,
            originalEvent: e
        })), Ze.active && ((_n == null || _n === -1) && (_n = cr, ui = as), gn({
            sortable: this,
            name: "end",
            toEl: $t,
            originalEvent: e
    ...
    _nulling: function() {
        wn("nulling", this), Pt = Re = $t = ut = Di = Vt = qs = hi = Oi = Mn = Qr = _n = ui = cr = as = sr = ls = en = $s = Ze.dragged = Ze.ghost = Ze.clone = Ze.active = null, so.forEach(function(e) {
            e.checked = !0
        }), so.length = pa = ga = 0
    },
    ...
    toArray: function() {
        for (var e = [], n, i = this.el.children, a = 0, d = i.length, v = this.options; a < d; a++) n = i[a], $n(n, v.draggable, this.el, !1) && e.push(n.getAttribute(v.dataIdAttr) || bx(n));
        return e
    },
    sort: function(e, n) {
        var i = {},
            a = this.el;
        this.toArray().forEach(function(d, v) {
            var S = a.children[v];
    ...
    option: function(e, n) {
        ...
        typeof a < "u" ? i[e] = a : i[e] = n, e === "group" && uh(i)
    },
    destroy: function() {
        wn("destroy", this);
        var e = this.el;
    ...
    _hideClone: function() {
        if (!hi) {
            if (wn("hideClone", this), Ze.eventCanceled) return;
            nt(Vt, "display", "none"), this.options.removeCloneOnHide && Vt.parentNode && Vt.parentNode.removeChild(Vt), hi = !0
        }
    },
    _showClone: function(e) {
        ...
        if (hi) {
            if (wn("showClone", this), Ze.eventCanceled) return;
            Re.parentNode == Pt && !this.options.group.revertClone ? Pt.insertBefore(Vt, Re) : Di ? Pt.insertBefore(Vt, Di) : Pt.appendChild(Vt), this.options.group.revertClone && this.animate(Re, Vt), nt(Vt, "display", ""), hi = !1
        }
    }
};
...
function zs(t, e, n, i, a, d, v, S) {
    ...
    return window.CustomEvent && !ai && !fs ? k = new CustomEvent("move", {
        bubbles: !0,
        cancelable: !0
    }) : (k = document.createEvent("Event"), k.initEvent("move", !0, !0)), k.to = e, k.from = t, k.dragged = n, k.draggedRect = i, k.related = a || e, k.relatedRect = d || Yt(e), k.willInsertAfter = S, k.originalEvent = v, t.dispatchEvent(k), D && ($ = D.call(I, k, v)), $
}
...
function yx(t, e, n, i, a, d, v, S) {
    ...
    if (!v) {
        if (S && Ws < I * a) {
            if (!cs && (ls === 1 ? k > D + I * d / 2 : k < $ - I * d / 2) && (cs = !0), cs) J = !0;
            else if (ls === 1 ? k < D + Ws : k > $ - Ws) return -ls
        } else if (k > D + I * (1 - a) / 2 && k < $ - I * (1 - a) / 2) return wx(e)
    }
    return J = J || v, J && (k < D + I * d / 2 || k > $ - I * d / 2) ? k > D + I / 2 ? 1 : -1 : 0
}
...
wo && Et(document, "touchmove", function(t) {
...
Ze.mount = function() {
    ...
    e[0].constructor === Array && (e = e[0]), e.forEach(function(i) {
        ...
        i.utils && (Ze.utils = zn(zn({}, Ze.utils), i.utils)), ps.mount(i)
    })
};
...
function xx() {
    ...
    return t.prototype = {
        ...
        drop: function() {
            this.sortable.nativeDraggable ? bt(document, "dragover", this._handleAutoScroll) : (bt(document, "pointermove", this._handleFallbackAutoScroll), bt(document, "touchmove", this._handleFallbackAutoScroll), bt(document, "mousemove", this._handleFallbackAutoScroll)), yc(), Ys(), rx()
        },
        nulling: function() {
            oo = Na = Zr = Va = es = ya = wa = null, qt.length = 0
        },
        ...
        _handleAutoScroll: function(n, i) {
            var a = this,
                ...
                S = document.elementFromPoint(d, v);
            if (oo = n, i || this.options.forceAutoScrollFallback || fs || ai || ss) {
                ba(n, this.options, S, i);
                var k = fi(S, !0);
                Va && (!es || d !== ya || v !== wa) && (es && yc(), es = setInterval(function() {
                    var I = fi(document.elementFromPoint(d, v), !0);
                    I !== k && (k = I, Ys()), ba(n, a.options, I, i)
                }, 10), ya = d, wa = v)
            } else {
...
var ba = sh(function(t, e, n, i) {
        if (!!e.scroll) {
            var a = (t.touches ? t.touches[0] : t).clientX,
                ...
                I = !1,
                D;
            Na !== n && (Na = n, Ys(), Zr = e.scroll, D = e.scrollFn, Zr === !0 && (Zr = fi(n, !0)));
            var $ = 0,
                J = Zr;
            do {
                var ie = J,
                    ...
                    lt = ie.scrollLeft,
                    Be = ie.scrollTop;
                ie === k ? (ve = ae < Ee && (Me.overflowX === "auto" || Me.overflowX === "scroll" || Me.overflowX === "visible"), f = se < Ae && (Me.overflowY === "auto" || Me.overflowY === "scroll" || Me.overflowY === "visible")) : (ve = ae < Ee && (Me.overflowX === "auto" || Me.overflowX === "scroll"), f = se < Ae && (Me.overflowY === "auto" || Me.overflowY === "scroll"));
                var K = ve && (Math.abs(q - a) <= v && lt + ae < Ee) - (Math.abs(P - a) <= v && !!lt),
                    Fe = f && (Math.abs(m - d) <= v && Be + se < Ae) - (Math.abs(re - d) <= v && !!Be);
                if (!qt[$])
                ...
                (qt[$].vx != K || qt[$].vy != Fe || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = Fe, clearInterval(qt[$].pid), (K != 0 || Fe != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    ...
                    typeof D == "function" && D.call(Ze.dragged.parentNode[Sn], Te, oe, t, oo, qt[this.layer].el) !== "continue" || oh(qt[this.layer].el, Te, oe)
                }.bind({
                    layer: $
                }), 24))), $++
...
const Ex = `<div id="controller" class="state-controller controller-content">\r
    ...
    Rx = mt.View.extend({
        ...
        initialize(t) {
            this.client = t.client, this.promptComponent = this.promptComponent || new si({
                model: new Ke.Model
    ...
    (function(e) {
        ...
        i.addListener = function(I, D) {
            ...
            var $ = this.getListenersAsObject(I),
                J = typeof D == "object",
                ie;
            for (ie in $) $.hasOwnProperty(ie) && d($[ie], D) === -1 && $[ie].push(J ? D : {
                listener: D,
                once: !1
            });
            return this
            ...
            var $ = this.getListenersAsObject(I),
                J, ie;
            for (ie in $) $.hasOwnProperty(ie) && (J = d($[ie], D), J !== -1 && $[ie].splice(J, 1));
            return this
...
class $x extends Bx {
    ...
    onText(n) {
        ...
        try {
            ...
            rc(`[Ecast Client] Unhandled text notification: ${n.key} ${a}`);
            return
        }
        const v = d;
        i === "room" ? this.emit("client:entityDidChange", i, v) : i === `player:${this.id}` ? this.emit("client:entityDidChange", "player", v) : i === "bc:room" ? this.emit("client:entityDidChange", "room", v) : i === "audiencePlayer" ? this.emit("client:entityDidChange", "audiencePlayer", v) : i === `bc:customer:${this.userId}` ? this.emit("client:entityDidChange", "player", v) : rc(`[Ecast Client] Unhandled json notification: ${i}`)
    }
    onObject(n) {
        const i = n.key,
            a = n.val;
    ...
    async send(n, i) {
        ...
        if (!!this.isReady) try {
            if (n === "SendMessageToRoomOwner") {
                const v = (d = (a = this.host) == null ? void 0 : a.id) != null ? d : "1";
            ...
            return S = t.extend({
                ...
                function lt(ye) {
                    if (!H.prop("readonly")) {
                        ...
                        if (!(ye.ctrlKey || ye.altKey || ye.metaKey || 32 > $e) && $e && $e !== 13) {
                            if (Je.end - Je.begin !== 0 && (Be(Je.begin, Je.end), ve(Je.begin, Je.end - 1)), ue = ae(Je.begin - 1), Y > ue && (_e = String.fromCharCode($e), D[ue].test(_e))) {
                                if (f(ue), oe[ue] = _e, K(), ke = ae(ue), d) {
                                    var dt = function() {
                ...
                function Fe(ye) {
                    ...
                    for (ue = 0, ke = 0; Y > ue; ue++)
                        ...
                        } else oe[ue] === $e.charAt(ke) && ke++, $ > ue && (Je = ue);
                    return ye ? K() : $ > Je + 1 ? S.autoclear || oe.join("") === Te ? (H.val() && H.val(""), Be(0, Y)) : K() : (K(), H.val(H.val().substring(0, Je + 1))), $ ? ue : J
                }
                var H = t(this),
                ...
                }), a && d && H.off("input.mask").on("input.mask", Ee), Fe()
            })
        }
    })
});
...
const Fx = mt.View.extend({
    ...
    Ux = `<div class="canvasContainer">\r
...
<div style="display:none;">\r
    <img id="Mask" src='jackbox/main/pp6/rolemodels/rolemodels/oval.png' />\r
</div>`,
    Hx = Zu.extend({
    ...
    Gx = La.extend({
        initialize(t) {
            this.cameraView = new Hx(t), La.prototype.initialize.apply(this, [t])
        }
    }),
    qx = `<div id="controller" class="state-controller controller-content">\r
    <div id="prompt" class="prompt text col-xs-12"></div>\r
        ...
        bindings: {
            ":el": {
                attributes: [{
                    ...
                    onGet(t) {
                        let e = "";
                        return t[0] && (e += " selected"), t[1] && (e += " placeholder"), e
                    }
                }, {
                    name: "style",
                    ...
                    onGet(t) {
                        const e = t[0],
                            ...
                            a = t[3];
                        let d = "";
                        return e && (n ? (d += "border: 4px solid black;", d += `background-color:${e};`) : i ? (d += `border: 4px solid ${e};`, d += "background-color: transparent;") : a ? (d += "border: 2px solid #333;", d += "background-color: #ccc;", d += "color: #333;") : d += `background-color:${e};`), d
                    }
                }]
            },
            ".name": "name"
        },
        template: at.template('<div class="name"></div>'),
        className: "nameView",
        tagName: "button",
        events: {
            click: "handleClick",
    ...
    Kx = mt.View.extend({
        ...
        bindings: {
            ...
            ":el": {
                attributes: [{
                    ...
                    onGet(t) {
                        let e = "";
                        return t[0] && (e += " hover"), t[1] && (e += " color"), e
                    }
                }, {
                    name: "style",
                    observe: "color",
                    onGet(t) {
                        let e = "";
                        return t && (e += `background: linear-gradient(180deg, #000000 0%, #000000 49%, ${t} 49%, ${t} 100%);`, e += "background-size: 100% 200%;", e += "background-position:bottom;", e += "color:black;"), e
                    }
                }]
            },
            ".doubleDown": {
        ...
        handleDoubleDown(t) {
            t.preventDefault(), this.triggerMethod("doubleDown:click", this)
        },
        onAttach() {
            this.stickit()
        }
    }),
    Jx = mt.CollectionView.extend({
        collection: new Ke.Collection([]),
        childView: Kx,
    ...
    Qx = mt.View.extend({
        ...
        bindings: {
            ".submit.button": {
                ...
                visible(t) {
                    ...
                    const e = this.namesList.children.every(n => n.model.get("used"));
                    return t && e
                }
            }
        },
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new si({
                model: new Ke.Model
            }), this.namesList = this.namesList || new Yx({
                collection: new Ke.Collection([])
            }), this.rolesList = this.rolesList || new Jx({
                collection: new Ke.Collection([])
            }), this.instructionView = this.instructionView || new si, this.listenTo(this.model, "change", this.update, this)
        },
        update() {
            this.promptComponent.model.set(this.model.get("prompt"));
            const t = this.model.get("players"),
                e = this.model.get("showDoubleDown"),
                n = this.model.get("roles").map(a => ({
                    ...a,
                    showDoubleDown: e
                }));
        ...
        assignNameToRole(t, e) {
            const n = t.model.get("name"),
                i = t.model.get("color"),
                a = t.model.get("index");
            this.removeNameFromRoles(t);
            const d = e.model.get("nameIndex");
            d !== void 0 && this.namesList.children.forEach(v => {
                v.model.get("index") === d && v.model.set("used", !1)
            }), e.model.set("name", n), e.model.set("color", i), e.model.set("nameIndex", a), e.model.set("doubleDown", !1), t.model.set("selected", !1), t.model.set("used", !0), this.sendGameUpdate(), this.model.get("isAudience") && (this.chosen = !0)
        },
        removeNameFromRoles(t) {
            const e = t.model.get("index");
            this.rolesList.children.forEach(n => {
                n.model.get("nameIndex") === e && (n.model.set("name", null), n.model.set("color", null), n.model.set("nameIndex", void 0), n.model.set("doubleDown", !1))
            }), t.model.set("used", !1)
        },
        findHoveredRole(t) {
            const e = t.changedTouches && t.changedTouches.length ? t.changedTouches[0].clientY : t.clientY,
                n = t.changedTouches && t.changedTouches.length ? t.changedTouches[0].clientX : t.clientX;
            return this.rolesList.children.find(a => {
                const d = a.el.getBoundingClientRect();
                return n > d.left && n < d.left + d.width && e > d.top && e < d.top + d.height
            })
        },
        sendGameUpdate(t) {
            const e = !!t;
            let n = -1;
            const i = this.rolesList.children.filter(a => a.model.get("nameIndex") !== void 0).map(a => {
                const d = a.model.get("nameIndex"),
                    v = a.model.get("index");
                return n = `${v},${d}`, {
                    player: d,
                    role: v,
                    doubleDown: a.model.get("doubleDown")
                }
            });
            this.model.get("isAudience") ? (this.triggerMethod("client:countGroup", {
                name: this.model.get("countGroupName"),
        ...
        onChildviewChildviewNameClick(t) {
            this.chosen || (this.selectedNameView && (this.selectedNameView.model.set("selected", !1), this.selectedNameView.model.set("placeholder", !1)), t.model.set("selected", !0), this.selectedNameView = t)
        },
        onChildviewChildviewRoleClick(t) {
            this.dragging || !this.selectedNameView || (this.assignNameToRole(this.selectedNameView, t), this.selectedNameView = null, this.stickit())
        },
        onChildviewChildviewDoubleDownClick(t) {
            this.rolesList.children.forEach(e => e.model.set("doubleDown", !1)), t.model.set("doubleDown", !0), this.sendGameUpdate()
        },
        onChildviewChildviewNameDragStart(t) {
            if (this.chosen) return;
            this.removeNameFromRoles(t);
            const e = t.el.cloneNode(!0),
                n = t.el.getBoundingClientRect(),
                i = n.width || n.right - n.left,
                a = n.height || n.bottom - n.top,
                d = document.getElementById("mirror");
            d.innerHTML = "", d.appendChild(e), d.style.display = "block", d.style.width = `${i}px`, d.style.height = `${a}px`, d.style.top = "-9999px", this.dragging = !0, this.dragSelectedNameView = t, t.model.set("placeholder", !0)
        },
        handleDragMove(t) {
            if (!this.dragging) return !0;
            t.preventDefault();
            const e = document.getElementById("mirror"),
                n = e.getBoundingClientRect();
            let i = t.touches && t.touches.length ? t.touches[0].clientY : t.clientY,
                a = t.touches && t.touches.length ? t.touches[0].clientX : t.clientX;
            i -= n.height * .5, a -= n.width * .5, e.style.top = `${i}px`, e.style.left = `${a}px`, this.rolesList.children.forEach(S => {
                S.model.set("hover", !1)
            });
            const d = this.findHoveredRole(t);
            d && d.model.set("hover", !0);
            const v = window.innerHeight;
            return i < v * .1 ? this.timedScroll(-1) : i > v * .9 ? this.timedScroll(1) : this.timedScroll(0), !0
        },
        handleDragEnd(t) {
            if (!this.dragging) return !0;
            const e = document.getElementById("mirror");
            e.style.display = "none";
            const n = this.findHoveredRole(t);
            return n && this.assignNameToRole(this.dragSelectedNameView, n), this.dragSelectedNameView.model.set("placeholder", !1), this.dragSelectedNameView = null, this.rolesList.children.forEach(i => {
                i.model.set("hover", !1)
            }), e.innerHTML = "", this.dragging = !1, this.timedScroll(0), this.stickit(), !0
        },
        timedScroll(t) {
            this.scrollDirection !== t && (clearInterval(this.scrollInterval), t !== 0 && (this.scrollInterval = setInterval(this.scrollUpdate.bind(this), 1e3 / 30)), this.scrollDirection = t)
        },
        scrollUpdate() {
            this.el.scrollTop = parseInt(this.el.scrollTop, 10) + this.scrollDirection * 5
        }
    });
const Zx = Vx.extend({
    ...
    parseBlob(t) {
        const e = t;
        return e.playerInfo = e.playerInfo || {}, e.playerInfo.classes = e.playerInfo.classes || [], e.state === "Lobby" && (e.characters = []), e.state === "Lobby" && !e.allowDrawingsIfCameraDisabled && (e.choices = e.choices || [], e.choices.find(i => i.action === "toCamera") !== void 0 || (e.choices = e.choices.filter(i => i.action !== "toDraw"))), e.state === "Draw" && (e.thicknesses = [10], e.sketchOptions = {
            minThickness: .5,
            thicknessFactor: 0,
            smoothingFactor: .55,
            thicknessSmoothingFactor: .6,
    ...
    formatSessionMessage(t) {
        const e = t;
        if (e.action === "submit" && Object.prototype.hasOwnProperty.call(e, "lines")) {
            const n = this.model.get("player");
            if (n && n.submitAsBitmap === !1) return e;
            e.action = "camera", e.lines = void 0, e.picture = this.currentLayout.sketchpadComponent.getImageData().split(",")[1]
        }
        return e
    }
});
