    ...
    (function() {
        ...
        var Be = function(l, g, _, O) {
            for (var L = [], N = 0, te = O || 0, Se = Ee(l); te < Se; te++) {
                ...
                if (Ae(he) && (m.isArray(he) || m.isArguments(he))) {
                    ...
                    var Ie = 0,
                        De = he.length;
                    for (L.length += De; Ie < De;) L[N++] = he[Ie++]
                } else _ || (L[N++] = he)
            }
            return L
        };
        ...
        m.bind = function(l, g) {
            ...
            return function() {
                ...
                var De = g - (Ie - Se);
                return O = this, L = arguments, De <= 0 || De > g ? (te && (clearTimeout(te), te = null), Se = Ie, N = l.apply(O, L), te || (O = L = null)) : !te && _.trailing !== !1 && (te = setTimeout(he, De)), N
            }
        ...
        m.keys = function(l) {
            ...
            var O = {},
                ...
                N, te;
            if (L == null) return O;
            m.isFunction(g) ? (te = m.allKeys(L), N = P(g, _)) : (te = Be(arguments, !1, !1, 1), N = function(nt, Ct, rn) {
                return Ct in rn
            }, L = Object(L));
        ...
        m.template = function(l, g, _) {
            ...
            l.replace(O, function(Ie, De, nt, Ct, rn) {
                return N += l.slice(L, rn).replace(Bt, Gt), L = rn + Ie.length, De ? N += `'+
...
(function(t) {
    (function(e, n) {
        ...
        var Ae = function(r) {
            var s, u, p, w, x, T, z, H, Z, le, be, ne, ce, Ge, rt, je, zt, Vt, un, _t = "sizzle" + 1 * new Date,
                et = r.document,
                on = 0,
                ft = 0,
                Dt = Yi(),
            ...
            u = St.support = {}, x = St.isXML = function(R) {
                ...
                })), (u.matchesSelector = ki.test(Vt = Ge.matches || Ge.webkitMatchesSelector || Ge.mozMatchesSelector || Ge.oMatchesSelector || Ge.msMatchesSelector)) && yn(function(ee) {
                    u.disconnectedMatch = Vt.call(ee, "*"), Vt.call(ee, "[s!='']:x"), zt.push("!=", zr)
            ...
            function qr(R, F, X, de, ee, me) {
                return de && !de[_t] && (de = qr(de)), ee && !ee[_t] && (ee = qr(ee, me)), dn(function(xe, Oe, Me, ze) {
                    var Ue, Xe, ht, Tt = [],
                        We = [],
                        Ht = Oe.length,
                        Jt = xe || Yo(F || "*", Me.nodeType ? [Me] : Me, []),
                        fn = R && (xe || !F) ? tr(Jt, Tt, R, Me, ze) : Jt,
            ...
            function Wr(R) {
                for (var F, X, de, ee = R.length, me = p.relative[R[0].type], xe = me || p.relative[" "], Oe = me ? 1 : 0, Me = Zi(function(Xe) {
                        return Xe === F
            ...
            return z = St.compile = function(R, F) {
                ...
                if (X = X || [], Ue.length === 1) {
                    ...
                    for (ee = Xi.needsContext.test(R) ? 0 : me.length; ee-- && (xe = me[ee], !p.relative[Oe = xe.type]);)
                        if ((Me = p.find[Oe]) && (de = Me(xe.matches[0].replace(Tn, xn), Hr.test(me[0].type) && Gr(F.parentNode) || F))) {
                                ...
                                return function() {
                                    var Ge = this,
                                        ...
                                        je = function() {
                                            var Vt, un;
                                            if (!(le < H)) {
                                                if (Vt = ne.apply(Ge, rt), Vt === be.promise()) throw new TypeError("Thenable self-resolution");
                                                un = Vt && (typeof Vt == "object" || typeof Vt == "function") && Vt.then, re(un) ? ce ? un.call(Vt, Z(H, be, Ke, ce), Z(H, be, dt, ce)) : (H++, un.call(Vt, Z(H, be, Ke, ce), Z(H, be, dt, ce), Z(H, be, Ke, be.notifyWith))) : (ne !== Ke && (Ge = void 0, rt = [Vt]), (ce || be.resolveWith)(Ge, rt))
                                            }
                                        },
                                        zt = ce ? je : function() {
                                            try {
                                                ...
                                                d.Deferred.exceptionHook && d.Deferred.exceptionHook(Vt, zt.stackTrace), le + 1 >= H && (ne !== dt && (Ge = void 0, rt = [Vt]), be.rejectWith(Ge, rt))
                                            }
                                        };
        ...
        d.extend({
            ...
            html: function(r) {
                return g(this, function(s) {
                    ...
                    if (typeof s == "string" && !kr.test(s) && !Ne[(pe.exec(s) || ["", ""])[1].toLowerCase()]) {
                        s = d.htmlPrefilter(s);
                        try {
            ...
            d.cssHooks[s] = {
                ...
                set: function(u, p, w) {
                    var x, T = Hn(u),
                        ...
                        le = w ? Gn(u, s, w, Z, T) : 0;
                    return Z && z && (le -= Math.ceil(u["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(T[s]) - Gn(u, s, "border", !1, T) - .5)), le && (x = yt.exec(p)) && (x[3] || "px") !== "px" && (u.style[s] = p, p = d.css(u, s)), Vn(u, p, le)
                }
            }
...
`)
        ...
        d.extend({
            ...
            ajax: function(r, s) {
                ...
                Z = d.event && ne.global, Z && d.active++ === 0 && d.event.trigger("ajaxStart"), ne.type = ne.type.toUpperCase(), ne.hasContent = !Do.test(ne.type), p = ne.url.replace(Ro, ""), ne.hasContent ? ne.data && ne.processData && (ne.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (ne.data = ne.data.replace(Oo, "+")) : (be = ne.url.slice(p.length), ne.data && (ne.processData || typeof ne.data == "string") && (p += (qi.test(p) ? "&" : "?") + ne.data, delete ne.data), ne.cache === !1 && (p = p.replace(Io, "$1"), be = (qi.test(p) ? "&" : "?") + "_=" + Lr.guid++ + be), ne.url = p + be), ne.ifModified && (d.lastModified[p] && et.setRequestHeader("If-Modified-Since", d.lastModified[p]), d.etag[p] && et.setRequestHeader("If-None-Match", d.etag[p])), (ne.data && ne.hasContent && ne.contentType !== !1 || s.contentType) && et.setRequestHeader("Content-Type", ne.contentType), et.setRequestHeader("Accept", ne.dataTypes[0] && ne.accepts[ne.dataTypes[0]] ? ne.accepts[ne.dataTypes[0]] + (ne.dataTypes[0] !== "*" ? ", " + bs + "; q=0.01" : "") : ne.accepts["*"]);
                ...
                if (_t = "abort", je.add(ne.complete), et.done(ne.success), et.fail(ne.error), u = xs(Vr, ne, s, et), !u) on(-1, "No Transport");
                else {
        ...
        return d.noConflict = function(r) {
            return e.$ === d && (e.$ = Bo), r && e.jQuery === d && (e.jQuery = No), d
            ...
            if (!!E) {
                ...
                for (var he = l ? [l] : i.keys(E); O < he.length; O++) {
                    ...
                    for (var De = [], nt = 0; nt < Ie.length; nt++) {
                        var Ct = Ie[nt];
                        g && g !== Ct.callback && g !== Ct.callback._callback || N && N !== Ct.context ? De.push(Ct) : (L = Ct.listening, L && --L.count === 0 && (delete te[L.id], delete L.listeningTo[L.objId]))
                    }
        ...
        i.extend(d.prototype, $, {
            ...
            set: function(E, l) {
                if (E != null) {
                    ...
                    var Je = !1,
                        Lt = !Ct && he && De;
                    if (O.length && Lt ? (Je = this.length !== O.length || i.some(this.models, function(j, V) {
                            return j !== O[V]
                        ...
                        (nt || Je) && this.trigger("sort", this, l), (L.length || te.length || N.length) && (l.changes = {
                            added: L,
                            removed: te,
                            merged: N
                    ...
                    if (Q) this.render();
                        ...
                        var Ce = [],
                            qe = i.reduce(this.children._views, function(Wt, Un) {
                                ...
                                return Vn === -1 ? (Ce.push(Un.model), Wt) : (Un._index = Vn, Wt[Vn] = Un.el, Wt)
                            }, new Array(A.length));
...
var eg = Zp,
    ...
    tg = us,
    Tc = Object.prototype,
    ng = Tc.hasOwnProperty,
    ig = Tc.propertyIsEnumerable,
    rg = _l(function() {
        return arguments
    }()) ? _l : function(t) {
...
function Sg(t) {
    ...
    return typeof n == "function" && n instanceof n && Ic.call(n) == _g
}
var kg = Sg,
    Tg = uo,
    Ag = Rc,
...
Mt[Rg] = Mt[Ig] = Mt[Hg] = Mt[Dg] = Mt[Ug] = Mt[Mg] = Mt[Lg] = Mt[Pg] = Mt[Vg] = Mt[Ng] = Mt[Bg] = Mt[$g] = Mt[jg] = Mt[Fg] = Mt[zg] = !1;
...
function av(t, e, n, i, a, f, v) {
    ...
    if ($) {
        var J = Ol(k),
            ie = !J && tv(k),
            Y = !J && !ie && sv(k);
        D = k, J || ie || Y ? Ol(S) ? D = S : ev(S) ? D = Qm(S) : ie ? ($ = !1, D = Km(k, !0)) : Y ? ($ = !1, D = Jm(k, !0)) : D = [] : rv(k) || Al(k) ? (D = S, Al(S) ? D = ov(S) : (!iv(S) || nv(S)) && (D = Zm(k))) : $ = !1
    }
...
function Vc(t, e, n, i, a) {
    t !== e && hv(e, function(f, v) {
        if (a || (a = new cv), fv(f)) dv(t, e, v, n, Vc, i, a);
        else {
...
var iy = function() {
    ...
    ry = iy,
    sy = function() {
        return typeof Ml != "function" || typeof Symbol != "function" || typeof Ml("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : ry()
    },
...
var ta = function() {
    ...
    Cy = function(e) {
        ...
        var a = [];
        return Pl(e, wy, function(f, v, S, k) {
            a[a.length] = S ? Pl(k, by, "$1") : v || f
        }), a
    },
    xy = function(e, n) {
        var i = e,
...
var jc = za,
    Fc = $c.exports,
    Ey = Fc(jc("String.prototype.indexOf")),
    _y = function(e, n) {
        var i = jc(e, !!n);
        return typeof i == "function" && Ey(e, ".prototype.") > -1 ? Fc(i) : i
    };
const Sy = {},
...
var Ha = typeof Map == "function" && Map.prototype,
    ...
    Vl = Dy ? WeakRef.prototype.deref : null,
...
var ka = Ty,
    ...
    $y = function t(e, n, i, a) {
        ...
        if (ew(e)) {
            for (var m = "<" + Nl.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + Uc(jy(P[q].value), "double", f);
            return m += ">", e.childNodes && e.childNodes.length && (m += "..."), m += "</" + Nl.call(String(e.nodeName)) + ">", m
        }
        if (Ta(e)) {
            if (e.length === 0) return "[]";
            var ae = Ls(e, J);
            return $ && !nw(ae) ? "[" + Aa(ae, $) + "]" : "[ " + jn.call(ae, ", ") + " ]"
        }
        if (zy(e)) {
            var se = Ls(e, J);
        ...
        if (qy(e)) return Yr(J(_a.call(e)));
        if (Gy(e)) return Yr(My.call(e));
        ...
        if (!Fy(e) && !Ul(e)) {
            var Ee = Ls(e, J),
                ...
                lt = !Ae && cn && Object(e) === e && cn in e ? Ga.call(pi(e), 8, -1) : Le ? "Object" : "",
                Be = Ae || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "",
                K = Be + (lt || Le ? "[" + jn.call(Bl.call([], lt || [], Le || []), ": ") + "] " : "");
...
function Xy(t) {
    ...
    var e = Vy.call(Py.call(t), /^function\s*([\w$]+)/);
    return e ? e[1] : null
}
...
var qa = za,
    ...
    gw = function() {
        var e, n, i, a = {
            ...
            set: function(f, v) {
                Ps && f && (typeof f == "object" || typeof f == "function") ? (e || (e = new Ps), aw(e, f, v)) : Vs ? (n || (n = new Vs), uw(n, f, v)) : (i || (i = {
                    key: {},
                    next: null
                }), fw(i, f, v))
            }
    ...
    Lw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        ...
        if (Mw(P) || Oa.isBuffer(P)) {
            if (S) {
                var d = Y ? n : S(n, tn.encoder, re, "key", J);
                if (i === "comma" && Y) {
                    for (var Ee = Rw.call(String(P), ","), Ae = "", Le = 0; Le < Ee.length; ++Le) Ae += (Le === 0 ? "" : ",") + ie(S(Ee[Le], tn.encoder, re, "value", J));
    ...
    Vw = function(t, e) {
        ...
        for (var D = Kc(), $ = 0; $ < a.length; ++$) {
            var J = a[$];
            i.skipNulls && n[J] === null || Jc(v, Lw(n[J], J, k, I, i.strictNullHandling, i.skipNulls, i.encode ? i.encoder : null, i.filter, i.sort, i.allowDots, i.serializeDate, i.format, i.formatter, i.encodeValuesOnly, i.charset, D))
        }
        ...
        for (k = 0; k < v.length; ++k)
            if (k !== S) {
                var D = v[k],
                    ...
                    J = $ === -1 ? D.indexOf("=") : $ + 1,
                    ie, Y;
                J === -1 ? (ie = n.decoder(D, Qt.decoder, I, "key"), Y = n.strictNullHandling ? null : "") : (ie = n.decoder(D.slice(0, J), Qt.decoder, I, "key"), Y = vr.maybeMap(Qc(D.slice(J + 1), n), function(re) {
                    return n.decoder(re, Qt.decoder, I, "value")
                })), Y && n.interpretNumericEntities && I === "iso-8859-1" && (Y = Bw(Y)), D.indexOf("[]=") > -1 && (Y = Nw(Y) ? [Y] : Y), Ra.call(i, ie) ? i[ie] = vr.combine(i[ie], Y) : i[ie] = Y
            } return i
    },
    zw = function(t, e, n, i) {
...
function ru(t, e, n) {
    ...
    if (i === void 0) return [];
    var a = i[e];
    return a === void 0 ? [] : typeof a == "function" ? n ? [a.listener || a] : [a] : n ? cb(a) : ou(a, a.length)
}
    ...
    (function(n, i) {
        ...
        function Ee(j, V) {
            ...
            var W = re.exec(j),
                ...
                pe = 0,
                Pe;
            return G ? fe ? (Pe = W[2] + W[3] + W[4], pe = W[2].length + W[3].length) : (Pe = W[2] + W[4], pe = W[2].length) : fe ? (Pe = W[3] + W[4], pe = W[3].length) : Pe = W[4], M === "file:" ? pe >= 2 && (Pe = Pe.slice(2)) : d(M) ? Pe = W[4] : M ? G && (Pe = Pe.slice(2)) : pe >= 2 && d(V.protocol) && (Pe = W[4]), {
                protocol: M,
                slashes: G || d(M),
                slashesCount: pe,
                rest: Pe
        ...
        function Ae(j, V) {
            if (j === "") return V;
            for (var W = (V || "/").split("/").slice(0, -1).concat(j.split("/")), M = W.length, G = W[M - 1], fe = !1, pe = 0; M--;) W[M] === "." ? W.splice(M, 1) : W[M] === ".." ? (W.splice(M, 1), pe++) : pe && (M === 0 && (fe = !0), W.splice(M, 1), pe--);
            return fe && W.unshift(""), (G === "." || G === "..") && W.push(""), W.join("/")
        }

        function Le(j, V, W) {
            if (j = q(j), !(this instanceof Le)) return new Le(j, V, W);
            var M, G, fe, pe, Pe, Ne, pt = ae.slice(),
                jt = typeof V,
                Ye = this,
                In = 0;
            for (jt !== "object" && jt !== "string" && (W = V, V = null), W && typeof W != "function" && (W = ie.parse), V = ve(V), G = Ee(j || "", V), M = !G.protocol && !G.slashes, Ye.slashes = G.slashes || M && V.slashes, Ye.protocol = G.protocol || V.protocol || "", j = G.rest, (Ye.protocol === "file:" || !G.slashes && (G.protocol || G.slashesCount < 2 || !d(Ye.protocol))) && (pt[3] = [/(.*)/, "pathname"]); In < pt.length; In++) {
                if (pe = pt[In], typeof pe == "function") {
                    j = pe(j, Ye);
                    continue
                }
                fe = pe[0], Ne = pe[1], fe !== fe ? Ye[Ne] = j : typeof fe == "string" ? ~(Pe = j.indexOf(fe)) && (typeof pe[2] == "number" ? (Ye[Ne] = j.slice(0, Pe), j = j.slice(Pe + pe[2])) : (Ye[Ne] = j.slice(Pe), j = j.slice(0, Pe))) : (Pe = fe.exec(j)) && (Ye[Ne] = Pe[1], j = j.slice(0, Pe.index)), Ye[Ne] = Ye[Ne] || M && pe[3] && V[Ne] || "", pe[4] && (Ye[Ne] = Ye[Ne].toLowerCase())
            }
            W && (Ye.query = W(Ye.query)), M && V.slashes && Ye.pathname.charAt(0) !== "/" && (Ye.pathname !== "" || V.pathname !== "") && (Ye.pathname = Ae(Ye.pathname, V.pathname)), Ye.pathname.charAt(0) !== "/" && d(Ye.protocol) && (Ye.pathname = "/" + Ye.pathname), a(Ye.port, Ye.protocol) || (Ye.host = Ye.hostname, Ye.port = ""), Ye.username = Ye.password = "", Ye.auth && (pe = Ye.auth.split(":"), Ye.username = pe[0] || "", Ye.password = pe[1] || ""), Ye.origin = Ye.protocol !== "file:" && d(Ye.protocol) && Ye.host ? Ye.protocol + "//" + Ye.host : "null", Ye.href = Ye.toString()
        }
        ...
        function lt(j, V, W) {
            ...
            switch (j) {
                case "query":
                    typeof V == "string" && V.length && (V = (W || ie.parse)(V)), M[j] = V;
                    break;
                case "port":
                    M[j] = V, a(V, M.protocol) ? V && (M.host = M.hostname + ":" + V) : (M.host = M.hostname, M[j] = "");
                    break;
                case "hostname":
                    M[j] = V, M.port && (V += ":" + M.port), M.host = V;
                    break;
                case "host":
                    M[j] = V, /:\d+$/.test(V) ? (V = V.split(":"), M.port = V.pop(), M.hostname = V.join(":")) : (M.hostname = V, M.port = "");
                    break;
                case "protocol":
                    M.protocol = V.toLowerCase(), M.slashes = !W;
                    break;
                case "pathname":
                case "hash":
                    if (V) {
                        var G = j === "pathname" ? "/" : "#";
                        M[j] = V.charAt(0) !== G ? G + V : V
                    } else M[j] = V;
                    break;
                default:
                    M[j] = V
        ...
        we.prototype.addEventListener = function(V, W) {
            typeof W == "function" && (Array.isArray(this.listeners[V]) || (this.listeners[V] = []), Te(this.listeners[V], function(M) {
                return M === W
            }).length === 0 && this.listeners[V].push(W))
        }, we.prototype.removeEventListener = function(V, W) {
            var M = this.listeners[V];
            this.listeners[V] = oe(M, function(G) {
                return G === W
            })
            ...
            return Array.isArray(pe) ? (pe.forEach(function(Pe) {
                M.length > 0 ? Pe.apply(W, M) : Pe.call(W, V)
            }), !0) : !1
        };
        ...
        ue.prototype.attachWebSocket = function(V, W) {
            ...
            var M = this.urlMap[ye(V.url)];
            M && M.server && M.websockets.indexOf(V) !== -1 && (M.roomMemberships[W] || (M.roomMemberships[W] = []), M.roomMemberships[W].push(V))
        ...
        }, ue.prototype.websocketsLookup = function(V, W, M) {
            var G = ye(V),
                fe, pe = this.urlMap[G];
        ...
        var _e = new ue,
            ...
            Ke = function() {};
        Ke.prototype.stopPropagation = function() {}, Ke.prototype.stopImmediatePropagation = function() {}, Ke.prototype.initEvent = function(V, W, M) {
            V === void 0 && (V = "undefined"), W === void 0 && (W = !1), M === void 0 && (M = !1), this.type = "" + V, this.bubbles = Boolean(W), this.cancelable = Boolean(M)
        };
        var dt = function(j) {
                function V(W, M) {
        ...
        function he(j) {
            ...
            if (W || (V.pathname = "/"), M === "") throw new SyntaxError($e.CONSTRUCTOR_ERROR + " The URL '" + V.toString() + "' is invalid.");
        ...
        function Ie(j) {
            ...
            var V = j.map(function(M) {
                ...
                W = Object.keys(V).filter(function(M) {
                    return V[M] > 1
                });
        ...
        var De = function(j) {
            function V(M, G) {
                j.call(this), this._onopen = null, this._onmessage = null, this._onerror = null, this._onclose = null, this.url = he(M), G = Ie(G), this.protocol = G[0] || "", this.binaryType = "blob", this.readyState = V.CONNECTING;
                var fe = te(this),
        ...
        var rn = {
            ...
            ct = function(j) {
                ...
                }, V.prototype.emit = function(M, G, fe) {
                    var pe = this;
                    fe === void 0 && (fe = {});
                ...
                }, V.prototype.to = function(M, G, fe) {
                    var pe = this;
                    fe === void 0 && (fe = []);
                    var Pe = this,
                        Ne = nt(fe.concat(_e.websocketsLookup(this.url, M, G)));
                    return {
                        to: function(pt, jt) {
                ...
                }, V.prototype.simulate = function(M) {
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/pp5-rapbattle/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
...
const hC = `<form>\r
    ...
    to = Et.View.extend({
        ...
        onAttach() {
            this.getOption("preventAutosize") || rc(Ve("textarea"))
        },
        onSubmitClick() {
        ...
        clearInput() {
            ...
            Ve(t).val(""), this.getOption("preventAutosize") || rc.update(t), this.onInputChange()
        },
        setValue(t) {
...
`).replace(/(^|\n)\s*/g, ""),
        ...
        const Q = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
            ...
            Ft = {};
        Ft.text = Ft.email = Ft.password = Ft.number = Ft.tel = Ft.url = (c, h) => (Xt(c, h.inputValue), Gn(c, c, h), Vn(c, h), c.type = h.input, c), Ft.file = (c, h) => (Gn(c, c, h), Vn(c, h), c), Ft.range = (c, h) => {
            ...
            Xt(c, h.inputValue), Vn(c, h), Gn(c, c, h);
...
`,
            ...
            qn = c => {
                const h = document.createElement("li");
                return Je(h, K["progress-step-line"]), c.progressStepsDistance && V(h, "width", c.progressStepsDistance), h
            },
            Wn = (c, h) => {
                const b = ue();
            ...
            Dr = (c, h) => {
                const b = U(),
                    B = we();
                h.toast ? (V(b, "width", h.width), B.style.width = "100%", B.insertBefore(E(), ye())) : V(B, "width", h.width), V(B, "padding", h.padding), h.color && (B.style.color = h.color), h.background && (B.style.background = h.background), M(Ke()), So(B, h)
            },
            So = (c, h) => {
            ...
            Mr = (c, h) => {
                Dr(c, h), Ze(c, h), Eo(c, h), Or(c, h), Ci(c, h), Wn(c, h), Co(c, h), Ui(c, h), wi(c, h), bo(c, h), typeof h.didRender == "function" && h.didRender(we())
            },
            Xn = Object.freeze({
                cancel: "cancel",
                backdrop: "backdrop",
...
`).join("<br />")), vi(c)
        ...
        const bs = () => {
            ...
            Lo = c => {
                const h = c.target,
                    b = U();
                return Po(c) || Vo(c) ? !1 : h === b || !Ne(b) && h.tagName !== "INPUT" && h.tagName !== "TEXTAREA" && !(Ne(_e()) && _e().contains(h))
            },
            ...
            le = {
                ...
                radio: (c, h, b) => {
                    ...
                    h.forEach(He => {
                        ...
                        nt(Ko, Nn), Ko.className = K.label, nr.appendChild(pn), nr.appendChild(Ko), B.appendChild(nr)
                    });
        ...
        function Mn(c, h, b, B) {
            he() ? ks(c, B) : (gi(b).then(() => ks(c, B)), et(it)), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (h.setAttribute("style", "display:none !important"), h.removeAttribute("class"), h.innerHTML = "") : h.remove(), Se() && (Nr(), Ei(), Lr()), vn()
        }
        ...
        const Xe = (c, h, b) => new Promise((B, ge) => {
                ...
                je.swalPromiseResolve.set(c, B), je.swalPromiseReject.set(c, ge), h.confirmButton.onclick = () => Os(c), h.denyButton.onclick = () => Rs(c), h.cancelButton.onclick = () => qo(c, He), h.closeButton.onclick = () => He(Xn.close), Wo(c, h, He), on(c, it, b, He), p(c, b), jr(b), We(it, b, He), Ht(h, b), setTimeout(() => {
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp5/rapbattle/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp5/rapbattle/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
class RC {
    constructor(e, n = {}) {
        ...
        this.canvasSelector = e, this.canvas = Ve(this.canvasSelector)[0], this.ctx = this.canvas.getContext("2d"), this.options = Object.assign(ac, n), this.history = [], this.layerNames.forEach(i => {
...
Et.View.extend({
    ...
    onResize() {
        const t = Ve("#player").outerHeight(!0) || 0,
            e = ni.isVisible ? Ve("#slide-in-banner").outerHeight(!0) : 0,
            n = Ve(window).width(),
...
const Ju = `<div id="controller" class="state-controller controller-content">
    ...
    FC = `<div id="image" class="logo logo-image"></div>
        ...
        animateAll: function(i) {
            ...
            t.forEach(function(S) {
                var k = 0,
                    ...
                    Y = S.rect,
                    re = pr(I, !0);
                re && ($.top -= re.f, $.left -= re.e), I.toRect = $, I.thisAnimationDuration && ha(J, $) && !ha(D, $) && (Y.top - $.top) / (Y.left - $.left) === (D.top - $.top) / (D.left - $.left) && (k = sx(Y, J, ie, a.options)), ha($, D) || (I.prevFromRect = D, I.prevToRect = $, k || (k = a.options.animation), a.animate(I, Y, $, k)), k && (f = !0, v = Math.max(v, k), clearTimeout(I.animationResetTimer), I.animationResetTimer = setTimeout(function() {
...
var Re, $t, ut, Pt, Ii, qs, Nt, ui, cr, _n, as, ci, $s, en, lr = !1,
    io = !1,
    ro = [],
    ...
    lx = wo && !eh && !Zu && "draggable" in document.createElement("div"),
    oh = function() {
        if (!!wo) {
            if (oi) return !1;
...
Qe.prototype = {
    ...
    _onTapStart: function(e) {
        if (!!e.cancelable) {
            var n = this,
                ...
                D = a.filter;
            if (wx(i), !Re && !(/mousedown|pointerdown/.test(v) && e.button !== 0 || a.disabled) && !I.isContentEditable && !(!this.nativeDraggable && ss && k && k.tagName.toUpperCase() === "SELECT") && (k = $n(k, a.draggable, i, !1), !(k && k.animated) && qs !== k)) {
    ...
    _prepareDragStart: function(e, n, i) {
        ...
        if (i && !Re && i.parentNode === f) {
            ...
            if (Pt = f, Re = i, $t = Re.parentNode, Ii = Re.nextSibling, qs = i, $s = v.group, Qe.dragged = Re, Ai = {
                    ...
                    clientX: (n || e).clientX,
                    clientY: (n || e).clientY
                }, fc = Ai.clientX - I.left, pc = Ai.clientY - I.top, this._lastX = (n || e).clientX, this._lastY = (n || e).clientY, Re.style["will-change"] = "all", k = function() {
                    if (wn("delayEnded", a, {
                            evt: e
                        }), Qe.eventCanceled) {
                        a._onDrop();
                    ...
                    a._disableDelayedDragEvents(), !cc && a.nativeDraggable && (Re.draggable = !0), a._triggerDragStart(e, n), gn({
                        sortable: a,
                        name: "choose",
                        originalEvent: e
                    ...
                    nh(Re, D.trim(), ma)
                }), xt(S, "dragover", Oi), xt(S, "mousemove", Oi), xt(S, "touchmove", Oi), xt(S, "mouseup", a._onDrop), xt(S, "touchend", a._onDrop), xt(S, "touchcancel", a._onDrop), cc && this.nativeDraggable && (this.options.touchStartThreshold = 4, Re.draggable = !0), wn("delayStart", this, {
                    evt: e
    ...
    _disableDelayedDrag: function() {
        Re && ma(Re), clearTimeout(this._dragStartTimer), this._disableDelayedDragEvents()
    },
    ...
    _onDragStart: function(e, n) {
        ...
        wn("setupClone", this), Qe.eventCanceled || (Nt = sh(Re), Nt.removeAttribute("id"), Nt.draggable = !1, Nt.style["will-change"] = "", this._hideClone(), En(Nt, this.options.chosenClass, !1), Qe.clone = Nt), i.cloneId = Xs(function() {
            wn("clone", i), !Qe.eventCanceled && (i.options.removeCloneOnHide || Pt.insertBefore(Nt, Re), i._hideClone(), gn({
                sortable: i,
                name: "clone"
            }))
        ...
        if (io = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : en === this || (this.lastPutMode = $s.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            ...
            if (!se || gx(e, ie, this) && !se.animated) {
                ...
                var d = 0,
                    ...
                    Le = !cx(Re.animated && Re.toRect || a, i.animated && i.toRect || f, ie),
                    lt = ie ? "top" : "left",
                    Be = hc(i, "top", "top") || hc(Re, "top", "top"),
                    K = Be ? Be.scrollTop : void 0;
                sr !== i && (Ee = f[lt], cs = !1, js = !Le && S.invertSwap || Ae), d = mx(e, i, f, ie, Le ? 1 : S.swapThreshold, S.invertedSwapThreshold == null ? S.swapThreshold : S.invertedSwapThreshold, js, sr === i);
                var Fe;
                if (d !== 0) {
                    var U = On(Re);
                ...
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Da = !0, setTimeout(fx, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), Be && rh(Be, 0, K - Be.scrollTop), $t = Re.parentNode, Ee !== void 0 && !js && (Ws = Math.abs(Ee - Yt(i)[lt])), ae(), q(!0)
            }
    ...
    _nulling: function() {
        wn("nulling", this), Pt = Re = $t = ut = Ii = Nt = qs = ui = Ai = Ln = Qr = _n = ci = cr = as = sr = ls = en = $s = Qe.dragged = Qe.ghost = Qe.clone = Qe.active = null, so.forEach(function(e) {
            e.checked = !0
        }), so.length = fa = pa = 0
    },
    ...
    toArray: function() {
        for (var e = [], n, i = this.el.children, a = 0, f = i.length, v = this.options; a < f; a++) n = i[a], $n(n, v.draggable, this.el, !1) && e.push(n.getAttribute(v.dataIdAttr) || yx(n));
        return e
    },
    sort: function(e, n) {
        var i = {},
    ...
    _showClone: function(e) {
        ...
        if (ui) {
            ...
            Re.parentNode == Pt && !this.options.group.revertClone ? Pt.insertBefore(Nt, Re) : Ii ? Pt.insertBefore(Nt, Ii) : Pt.appendChild(Nt), this.options.group.revertClone && this.animate(Re, Nt), tt(Nt, "display", ""), ui = !1
        }
    }
};
...
function bx() {
    ...
    return t.prototype = {
        ...
        drop: function() {
            this.sortable.nativeDraggable ? wt(document, "dragover", this._handleAutoScroll) : (wt(document, "pointermove", this._handleFallbackAutoScroll), wt(document, "touchmove", this._handleFallbackAutoScroll), wt(document, "mousemove", this._handleFallbackAutoScroll)), mc(), Ys(), nx()
        },
        nulling: function() {
        ...
        if (!!e.scroll) {
            ...
            do {
                ...
                (qt[$].vx != K || qt[$].vy != Fe || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = Fe, clearInterval(qt[$].pid), (K != 0 || Fe != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    ...
                    typeof D == "function" && D.call(Qe.dragged.parentNode[Sn], Te, oe, t, oo, qt[this.layer].el) !== "continue" || rh(qt[this.layer].el, Te, oe)
                }.bind({
                    layer: $
                }), 24))), $++
...
<div id="control-panel" class="control-panel">\r
    ...
    Mx = Et.View.extend({
        ...
        initialize(t) {
            ...
            }), this.throttledUpdate = at.throttle(this.updateVector, this.model.get("throttle")), this.listenTo(this.model, "change", this.update, this), this.onResizeWithContext = this.onResize.bind(this), window.addEventListener("resize", this.onResizeWithContext), Ve(window).on("mousemove", this.move.bind(this)), Ve(window).on("mouseup", this.end.bind(this))
        },
        onBeforeDestroy() {
    ...
    Lx = `<div id="textDescriptions" class="textDescriptions" role="log" aria-atomic="false" aria-relevant="additions" aria-live="polite"></div>
...
const $x = Et.View.extend({
    ...
    Fx = Qu.extend({
        template: at.template(`${Ju}<div class="mech"></div>`)
    });
const zx = Px.extend({
...
//# sourceMappingURL=932ac320.js.map