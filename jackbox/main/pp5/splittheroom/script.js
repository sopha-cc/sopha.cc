            ...
            set: function(E, l) {
                if (E != null) {
                    ...
                    for (yt = 0; yt < E.length; yt++) {
                        ...
                        if (bt) {
                            if (Ie && lt !== bt) {
                                var Kt = this._isModel(lt) ? lt.attributes : lt;
                                l.parse && (Kt = bt.parse(Kt, l)), bt.set(Kt, l), V.push(bt), Ct && !nt && (nt = bt.hasChanged(rn))
                            }
                            Se[bt.cid] || (Se[bt.cid] = !0, O.push(bt)), E[yt] = bt
                        } else he && (lt = E[yt] = this._prepareModel(lt, l), lt && (L.push(lt), this._addReference(lt, l), Se[lt.cid] = !0, O.push(lt)))
                    }
                    if (De) {
...
(function(t, e) {
    (function(n, i) {
        ...
        i.extend(Fi.prototype, Se, lt, Je);
...
var Dd = Id,
    ...
    Hd = RegExp("^" + Fd.call(zd).replace(Vd, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
...
var Zp = Qp,
    ...
    eg = us,
    Tc = Object.prototype,
    tg = Tc.hasOwnProperty,
    ng = Tc.propertyIsEnumerable,
    ig = _l(function() {
        return arguments
    }()) ? _l : function(t) {
...
function _g(t) {
    ...
    return typeof n == "function" && n instanceof n && Ic.call(n) == Eg
}
var Sg = _g,
    kg = uo,
    Tg = Rc,
    ...
    Mt = {};
Mt[Ug] = Mt[Gg] = Mt[qg] = Mt[Wg] = Mt[Xg] = Mt[Yg] = Mt[Kg] = Mt[Jg] = Mt[Qg] = !0;
Mt[Og] = Mt[Rg] = Mt[zg] = Mt[Ig] = Mt[Hg] = Mt[Dg] = Mt[Mg] = Mt[Lg] = Mt[Pg] = Mt[Ng] = Mt[Vg] = Mt[Bg] = Mt[$g] = Mt[jg] = Mt[Fg] = !1;
...
var jc = za,
    Fc = $c.exports,
    xy = Fc(jc("String.prototype.indexOf")),
    Ey = function(e, n) {
        var i = jc(e, !!n);
        return typeof i == "function" && xy(e, ".prototype.") > -1 ? Fc(i) : i
    };
const _y = {},
...
var ka = ky,
    ...
    By = function t(e, n, i, a) {
        ...
        if (Zy(e)) {
            for (var m = "<" + Vl.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + Uc($y(P[q].value), "double", f);
        ...
        if (!jy(e) && !Ul(e)) {
            var Ee = Ls(e, J),
                ...
                at = !Ae && cn && Object(e) === e && cn in e ? Ga.call(pi(e), 8, -1) : Le ? "Object" : "",
                Be = Ae || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "",
                K = Be + (at || Le ? "[" + jn.call(Bl.call([], at || [], Le || []), ": ") + "] " : "");
...
var qa = za,
    ...
    Mw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        ...
        if (Dw(P) || Oa.isBuffer(P)) {
            if (S) {
                ...
                if (i === "comma" && Y) {
                    for (var Ee = Ow.call(String(P), ","), Ae = "", Le = 0; Le < Ee.length; ++Le) Ae += (Le === 0 ? "" : ",") + ie(S(Ee[Le], tn.encoder, re, "value", J));
        ...
        for (var Fe = a && ei(P) && P.length === 1 ? n + "[]" : n, U = 0; U < Be.length; ++U) {
            ...
            if (!(v && Te === null)) {
                ...
                m.set(e, ae);
                var ye = Kc();
                ye.set(la, m), Jc(at, t(Te, we, i, a, f, v, S, k, I, D, $, J, ie, Y, re, ye))
            }
        }
        return at
    },
    ...
    Pw = function(t, e) {
        ...
        for (var D = Kc(), $ = 0; $ < a.length; ++$) {
            var J = a[$];
            i.skipNulls && n[J] === null || Jc(v, Mw(n[J], J, k, I, i.strictNullHandling, i.skipNulls, i.encode ? i.encoder : null, i.filter, i.sort, i.allowDots, i.serializeDate, i.format, i.formatter, i.encodeValuesOnly, i.charset, D))
        }
    ...
    jw = function(e, n) {
        ...
        if (n.charsetSentinel)
            for (k = 0; k < v.length; ++k) v[k].indexOf("utf8=") === 0 && (v[k] === $w ? I = "utf-8" : v[k] === Bw && (I = "iso-8859-1"), S = k, k = v.length);
...
function ru(t, e, n) {
    ...
    if (i === void 0) return [];
    var a = i[e];
    return a === void 0 ? [] : typeof a == "function" ? n ? [a.listener || a] : [a] : n ? lb(a) : ou(a, a.length)
}
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/pp5-splittheroom/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
                    ...
                    var Ee = "",
                        ...
                        Le = function() {
                            var at = e.contains(se, d.name) ? "prop" : "attr",
                                Be = D(q, Ae, d);
                            d.name === "class" ? (m.removeClass(Ee).addClass(Be), Ee = Be) : m[at](d.name, Be)
                        };
...
const uC = `<form>\r
    ...
    to = Et.View.extend({
        ...
        onAttach() {
            this.getOption("preventAutosize") || rc(Ne("textarea"))
        },
        onSubmitClick() {
        ...
        clearInput() {
            ...
            Ne(t).val(""), this.getOption("preventAutosize") || rc.update(t), this.onInputChange()
        },
        setValue(t) {
...
`).replace(/(^|\n)\s*/g, ""),
        ...
        const Ui = (c, h) => {
            ...
            Rr = (c, h) => {
                ...
                Je(c, Fe[h.icon]), bn(c, h), Gi(), lt(c, h, "icon")
            },
            Gi = () => {
                const c = we(),
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp5/splittheroom/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp5/splittheroom/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
class OC {
    constructor(e, n = {}) {
        ...
        this.canvasSelector = e, this.canvas = Ne(this.canvasSelector)[0], this.ctx = this.canvas.getContext("2d"), this.options = Object.assign(ac, n), this.history = [], this.layerNames.forEach(i => {
...
var Re, $t, ct, Pt, Ii, qs, Vt, ui, cr, _n, as, ci, $s, en, lr = !1,
    io = !1,
    ro = [],
    ...
    lx = wo && !Zu && !Qu && "draggable" in document.createElement("div"),
    sh = function() {
        if (!!wo) {
            if (oi) return !1;
...
Qe.prototype = {
    ...
    _onTouchMove: function(e) {
        if (Ai) {
            ...
            if (ct) {
                ...
                tt(ct, "webkitTransform", J), tt(ct, "mozTransform", J), tt(ct, "msTransform", J), tt(ct, "transform", J), fa = D, pa = $, Ln = f
            }
    ...
    _appendGhost: function() {
        if (!ct) {
            ...
            ct = Re.cloneNode(!0), En(ct, i.ghostClass, !1), En(ct, i.fallbackClass, !0), En(ct, i.dragClass, !0), tt(ct, "transition", ""), tt(ct, "transform", ""), tt(ct, "box-sizing", "border-box"), tt(ct, "margin", 0), tt(ct, "top", n.top), tt(ct, "left", n.left), tt(ct, "width", n.width), tt(ct, "height", n.height), tt(ct, "opacity", "0.8"), tt(ct, "position", Fs ? "absolute" : "fixed"), tt(ct, "zIndex", "100000"), tt(ct, "pointerEvents", "none"), Qe.ghost = ct, e.appendChild(ct), tt(ct, "transform-origin", fc / parseInt(ct.style.width) * 100 + "% " + pc / parseInt(ct.style.height) * 100 + "%")
        }
    },
    _onDragStart: function(e, n) {
        ...
        wn("setupClone", this), Qe.eventCanceled || (Vt = rh(Re), Vt.removeAttribute("id"), Vt.draggable = !1, Vt.style["will-change"] = "", this._hideClone(), En(Vt, this.options.chosenClass, !1), Qe.clone = Vt), i.cloneId = Xs(function() {
    ...
    _onDragOver: function(e) {
        ...
        if (io = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : en === this || (this.lastPutMode = $s.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            ...
            if (!se || gx(e, ie, this) && !se.animated) {
                ...
                sr !== i && (Ee = f[at], cs = !1, js = !Le && S.invertSwap || Ae), d = mx(e, i, f, ie, Le ? 1 : S.swapThreshold, S.invertedSwapThreshold == null ? S.swapThreshold : S.invertedSwapThreshold, js, sr === i);
                var Fe;
                if (d !== 0) {
                    var U = On(Re);
                ...
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Da = !0, setTimeout(fx, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), Be && ih(Be, 0, K - Be.scrollTop), $t = Re.parentNode, Ee !== void 0 && !js && (Ws = Math.abs(Ee - Yt(i)[at])), ae(), q(!0)
            }
    ...
    _nulling: function() {
        wn("nulling", this), Pt = Re = $t = ct = Ii = Vt = qs = ui = Ai = Ln = Qr = _n = ci = cr = as = sr = ls = en = $s = Qe.dragged = Qe.ghost = Qe.clone = Qe.active = null, so.forEach(function(e) {
            e.checked = !0
        }), so.length = fa = pa = 0
    },
...
var wa = nh(function(t, e, n, i) {
        if (!!e.scroll) {
            ...
            do {
                ...
                var K = ve && (Math.abs(q - a) <= v && at + ae < Ee) - (Math.abs(P - a) <= v && !!at),
                ...
                (qt[$].vx != K || qt[$].vy != Fe || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = Fe, clearInterval(qt[$].pid), (K != 0 || Fe != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    ...
                    typeof D == "function" && D.call(Qe.dragged.parentNode[Sn], Te, oe, t, oo, qt[this.layer].el) !== "continue" || ih(qt[this.layer].el, Te, oe)
                }.bind({
                    layer: $
                }), 24))), $++
...
const $x = Et.View.extend({
    ...
    Fx = Ju.extend({
        onChildviewChildviewButtonLike(t) {
            const e = t.get("index");
            return this.triggerMethod("client:message", {
                action: "like",
                choice: e
        ...
        if (t.state === "EnterSingleText" && (t.placeholder || (t.placeholder = "Fill in the blank here..."), Object.prototype.hasOwnProperty.call(t, "counter") || (t.counter = !0), t.maxLength || (t.maxLength = 45)), t.state === "MakeSingleChoice") {
            if (t.scenario) {
                ...
                const e = Ne("<div />").html(t.scenario.html).text() || "",
                    n = btoa(e.replace(/\W/g, ""));
                t.textDescriptions.push({
                    id: n,
                    category: "Reveal",
                    text: e
                })
...
//# sourceMappingURL=4a870950.js.map