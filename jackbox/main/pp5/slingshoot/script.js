        ...
        var Ae = function(r) {
            ...
            u = St.support = {}, x = St.isXML = function(R) {
                ...
                var X = p.attrHandle[F.toLowerCase()],
                    de = X && Qn.call(p.attrHandle, F.toLowerCase()) ? X(R, F, !rt) : void 0;
        ...
        d.extend({
            ...
            ajax: function(r, s) {
                ...
                function on(ft, Dt, _i, Wi) {
                    ...
                    H || (H = !0, T && e.clearTimeout(T), u = void 0, w = Wi || "", et.readyState = ft > 0 ? 4 : 0, hn = ft >= 200 && ft < 300 || ft === 304, _i && (an = Po(ne, et, _i)), !hn && d.inArray("script", ne.dataTypes) > -1 && d.inArray("json", ne.dataTypes) < 0 && (ne.converters["text script"] = function() {}), an = No(ne, an, et, hn), hn ? (ne.ifModified && (Ln = et.getResponseHeader("Last-Modified"), Ln && (d.lastModified[p] = Ln), Ln = et.getResponseHeader("etag"), Ln && (d.etag[p] = Ln)), ft === 204 || ne.type === "HEAD" ? vn = "nocontent" : ft === 304 ? vn = "notmodified" : (vn = an.state, Jn = an.data, Qn = an.error, hn = !Qn)) : (Qn = vn, (ft || !vn) && (vn = "error", ft < 0 && (ft = 0))), et.status = ft, et.statusText = (Dt || vn) + "", hn ? rt.resolveWith(ce, [Jn, vn, et]) : rt.rejectWith(ce, [et, vn, Qn]), et.statusCode(zt), zt = void 0, Z && Ge.trigger(hn ? "ajaxSuccess" : "ajaxError", [et, ne, hn ? Jn : Qn]), je.fireWith(ce, [et, vn]), Z && (Ge.trigger("ajaxComplete", [et, ne]), --d.active || d.event.trigger("ajaxStop")))
                }
                return et
            },
            ...
            set: function(E, l) {
                if (E != null) {
                    ...
                    if (O.length && Mt ? (Je = this.length !== O.length || i.some(this.models, function(j, N) {
                            return j !== O[N]
                        }), this.models.length = 0, Me(this.models, O, 0), this.length = this.models.length) : M.length && (Ct && (nt = !0), Me(this.models, M, _ == null ? this.length : _), this.length = this.models.length), nt && this.sort({
                            silent: !0
                        }), !l.silent) {
...
Lt[Dg] = Lt[Lg] = Lt[Gg] = Lt[Mg] = Lt[qg] = Lt[Pg] = Lt[Ng] = Lt[Vg] = Lt[Bg] = Lt[$g] = Lt[jg] = Lt[Fg] = Lt[zg] = Lt[Hg] = Lt[Ug] = !1;
...
function $c(t, e, n, i, a) {
    t !== e && fv(e, function(f, v) {
        if (a || (a = new hv), gv(f)) pv(t, e, v, n, $c, i, a);
        else {
...
var na = function() {
    ...
    Ey = function(e) {
        ...
        var a = [];
        return Vl(e, Cy, function(f, v, S, k) {
            a[a.length] = S ? Vl(k, xy, "$1") : v || f
        }), a
    },
    _y = function(e, n) {
        var i = e,
...
var Hc = Ua,
    Uc = zc.exports,
    Sy = Uc(Hc("String.prototype.indexOf")),
    ky = function(e, n) {
        var i = Hc(e, !!n);
        return typeof i == "function" && Sy(e, ".prototype.") > -1 ? Uc(i) : i
    };
const Ty = {},
...
var Ga = typeof Map == "function" && Map.prototype,
    ia = Object.getOwnPropertyDescriptor && Ga ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null,
    Zs = Ga && ia && typeof ia.get == "function" ? ia.get : null,
    Ry = Ga && Map.prototype.forEach,
    qa = typeof Set == "function" && Set.prototype,
    ra = Object.getOwnPropertyDescriptor && qa ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null,
    eo = qa && ra && typeof ra.get == "function" ? ra.get : null,
...
var Ta = Oy,
    ...
    Fy = function t(e, n, i, a) {
        ...
        if (Xc(e)) {
            var re = mr ? hi.call(String(e), /^(Symbol\(.*\))_[^)]*$/, "$1") : ka.call(e);
            return typeof e == "object" && !mr ? Yr(re) : re
        }
        if (nw(e)) {
            for (var m = "<" + $l.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + Wc(zy(P[q].value), "double", f);
    ...
    Nw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        ...
        for (var Fe = a && ti(P) && P.length === 1 ? n + "[]" : n, U = 0; U < Be.length; ++U) {
            ...
            if (!(v && Te === null)) {
                ...
                m.set(e, ae);
                var ye = Zc();
                ye.set(ca, m), eu(lt, t(Te, we, i, a, f, v, S, k, I, D, $, J, ie, Y, re, ye))
            }
        }
        return lt
    },
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/pp5-slingshoot/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
...
st(ii, "view", null), st(ii, "isInitialized", !1), st(ii, "bannerConfig", null);
var cC = {};
(function(t) {
    (function(e) {
        e(Pi.exports, ot, t)
...
const fC = `<form>\r
    ...
    Bi = Et.View.extend({
        ...
        className: "choices",
        childView(t) {
            return t.get("type") === "input" ? to : t.get("type") === "text" ? Bi : Yu
        },
...
function yC({
    ...
    function Y() {
        if (I = requestAnimationFrame(Y), D = ie.now(), $ = D - k, k = D, !($ > 1e3)) {
            for (Ju("tick"), a += $; a >= f;) J.update(v), a -= f;
            S(), J.render()
        }
    }
    return J = {
...
`).replace(/(^|\n)\s*/g, ""),
            ...
            wi = (c, h) => {
                const b = g(),
                    B = E();
                !h.showConfirmButton && !h.showDenyButton && !h.showCancelButton ? L(b) : W(b), ct(b, h, "actions"), Un(b, B, h), nt(B, h.loaderHtml), ct(B, h, "loader")
            };
...
`,
            ...
            Lr = (c, h) => {
                Dr(c, h), Ze(c, h), _o(c, h), Or(c, h), Ci(c, h), Xn(c, h), xo(c, h), Ui(c, h), wi(c, h), Co(c, h), typeof h.didRender == "function" && h.didRender(we())
            },
            Yn = Object.freeze({
                cancel: "cancel",
                backdrop: "backdrop",
...
`).join("<br />")), vi(c)
        ...
        const Xe = (c, h, b) => new Promise((B, ge) => {
                ...
                je.swalPromiseResolve.set(c, B), je.swalPromiseReject.set(c, ge), h.confirmButton.onclick = () => Os(c), h.denyButton.onclick = () => Rs(c), h.cancelButton.onclick = () => Wo(c, He), h.closeButton.onclick = () => He(Yn.close), Xo(c, h, He), on(c, it, b, He), p(c, b), jr(b), We(it, b, He), Ht(h, b), setTimeout(() => {
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp5/slingshoot/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp5/slingshoot/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
    ...
    VC = Et.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new Bi({}), this.toolbarComponent = this.toolbarComponent || new IC({
                model: new ot.Model({})
            }), this.sketchpadComponent = this.sketchpadComponent || new MC({
                model: new ot.Model
...
const eh = `<div id="controller" class="state-controller controller-content">
...
var Re, $t, ut, Pt, Ii, qs, Vt, ui, cr, _n, as, ci, $s, en, lr = !1,
    ro = !1,
    so = [],
    Ai, Mn, pa, ga, gc, mc, Qr, sr, ls, cs = !1,
    js = !1,
    Ws, ln, ma = [],
    Ma = !1,
    oo = [],
...
Qe.prototype = {
    ...
    _prepareDragStart: function(e, n, i) {
        ...
        if (i && !Re && i.parentNode === f) {
            ...
            if (Pt = f, Re = i, $t = Re.parentNode, Ii = Re.nextSibling, qs = i, $s = v.group, Qe.dragged = Re, Ai = {
                    ...
                    rh(Re, D.trim(), va)
                }), xt(S, "dragover", Oi), xt(S, "mousemove", Oi), xt(S, "touchmove", Oi), xt(S, "mouseup", a._onDrop), xt(S, "touchend", a._onDrop), xt(S, "touchcancel", a._onDrop), hc && this.nativeDraggable && (this.options.touchStartThreshold = 4, Re.draggable = !0), wn("delayStart", this, {
                    evt: e
    ...
    _onTouchMove: function(e) {
        if (Ai) {
            ...
            if (ut) {
                ...
                tt(ut, "webkitTransform", J), tt(ut, "mozTransform", J), tt(ut, "msTransform", J), tt(ut, "transform", J), pa = D, ga = $, Mn = f
            }
        ...
        if (ro = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : en === this || (this.lastPutMode = $s.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            ...
            if (!se || mx(e, ie, this) && !se.animated) {
                ...
                var d = 0,
                    ...
                    Me = !ux(Re.animated && Re.toRect || a, i.animated && i.toRect || f, ie),
                    lt = ie ? "top" : "left",
                    Be = fc(i, "top", "top") || fc(Re, "top", "top"),
                    K = Be ? Be.scrollTop : void 0;
                sr !== i && (Ee = f[lt], cs = !1, js = !Me && S.invertSwap || Ae), d = vx(e, i, f, ie, Me ? 1 : S.swapThreshold, S.invertedSwapThreshold == null ? S.swapThreshold : S.invertedSwapThreshold, js, sr === i);
                var Fe;
                if (d !== 0) {
                    var U = On(Re);
                ...
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Ma = !0, setTimeout(px, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), Be && oh(Be, 0, K - Be.scrollTop), $t = Re.parentNode, Ee !== void 0 && !js && (Ws = Math.abs(Ee - Yt(i)[lt])), ae(), q(!0)
            }
    ...
    _nulling: function() {
        wn("nulling", this), Pt = Re = $t = ut = Ii = Vt = qs = ui = Ai = Mn = Qr = _n = ci = cr = as = sr = ls = en = $s = Qe.dragged = Qe.ghost = Qe.clone = Qe.active = null, oo.forEach(function(e) {
            e.checked = !0
        }), oo.length = pa = ga = 0
    },
...
function Cx() {
    ...
    return t.prototype = {
        ...
        drop: function() {
            this.sortable.nativeDraggable ? wt(document, "dragover", this._handleAutoScroll) : (wt(document, "pointermove", this._handleFallbackAutoScroll), wt(document, "touchmove", this._handleFallbackAutoScroll), wt(document, "mousemove", this._handleFallbackAutoScroll)), yc(), Ys(), ix()
        },
        nulling: function() {
            ao = Na = Zr = Va = es = ya = wa = null, qt.length = 0
        },
        ...
        _handleAutoScroll: function(n, i) {
            ...
            if (ao = n, i || this.options.forceAutoScrollFallback || fs || oi || ss) {
                ba(n, this.options, S, i);
                var k = di(S, !0);
                Va && (!es || f !== ya || v !== wa) && (es && yc(), es = setInterval(function() {
...
var ba = sh(function(t, e, n, i) {
        if (!!e.scroll) {
            var a = (t.touches ? t.touches[0] : t).clientX,
                ...
                I = !1,
                D;
            Na !== n && (Na = n, Ys(), Zr = e.scroll, D = e.scrollFn, Zr === !0 && (Zr = di(n, !0)));
            var $ = 0,
                J = Zr;
            do {
                var ie = J,
...
const $x = Et.View.extend({
    ...
    Fx = Hn.extend({
        defaults: at.extend({}, no.prototype.model.defaults, {
            gameCanContinue: !1
        })
    }),
    zx = no.extend({
        ...
        update() {
            this.strings = this.model.get("strings"), this.model.get("gameCanContinue") ? (this.strings.button_sameplayers = "Start Next Gauntlet", this.strings.button_newplayers = "Quit") : (this.strings.button_sameplayers = "Same Players", this.strings.button_newplayers = "New Players"), no.prototype.update.apply(this)
        }
    });
const Hx = La.extend({
        bindings: at.extend(La.prototype.bindings, {
            ".playerName": {
                attributes: [{
                    name: "style",
    ...
    Ux = bc.extend({
        ...
        lacksAudience: !0,
        initialize(t) {
            this.playerTopBar = new Hx({
                isPlayer: t.client.isRole("player")
            }), bc.prototype.initialize.apply(this, [t])
        },
        getGameLayout(t) {
            switch (t) {
                case "Lobby":
        ...
        parseBlob(t) {
            return t.playerInfo && (t.playerInfo.characterColor = t.characterColor ? t.characterColor : "#000000"), t.artifact && (t.artifact.artifactId !== this.artifactId && (this.shouldHideArtifact = !1, this.artifactId = t.artifact.artifactId), t.state !== "Lobby" && t.state !== "Logo" && (this.shouldHideArtifact = !0), this.shouldHideArtifact && delete t.artifact), t.censorablePlayers && delete t.censorablePlayers, t
        }
    });
jx({
    MainView: Ux
});
//# sourceMappingURL=54445497.js.map