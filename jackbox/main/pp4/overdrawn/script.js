...
var Sh = (t, e, n) => e in t ? _h(t, e, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
    value: n
}) : t[e] = n;
var at = (t, e, n) => (Sh(t, typeof e != "symbol" ? e + "" : e, n), n);
const kh = function() {
...
(function(t, e) {
    (function() {
        ...
        m.reduce = m.foldl = m.inject = De(1), m.reduceRight = m.foldr = De(-1), m.find = m.detect = function(l, g, _) {
            ...
            } else g = q(g, _), m.each(l, function(Ie, Le, rt) {
                te = g(Ie, Le, rt), (te > D || te === -1 / 0 && O === -1 / 0) && (O = Ie, D = te)
            });
            return O
        ...
        m.indexOf = ze(1, m.findIndex, m.sortedIndex), m.lastIndexOf = ze(-1, m.findLastIndex), m.range = function(l, g, _) {
        ...
        m.keys = function(l) {
            ...
            var O = {},
                ...
                V, te;
            if (D == null) return O;
            m.isFunction(g) ? (te = m.allKeys(D), V = P(g, _)) : (te = $e(arguments, !1, !1, 1), V = function(rt, xt, sn) {
                return xt in sn
            }, D = Object(D));
        ...
        m.template = function(l, g, _) {
            ...
            var O = RegExp([(g.escape || Qe).source, (g.interpolate || Qe).source, (g.evaluate || Qe).source].join("|") + "|$", "g"),
                D = 0,
                V = "__p+='";
            l.replace(O, function(Ie, Le, rt, xt, sn) {
                return V += l.slice(D, sn).replace(Bt, Ut), D = sn + Ie.length, Le ? V += `'+
...
function Oc() {
    return xl || (xl = 1, function(t) {
        (function(e, n) {
            ...
            var Ae = function(r) {
                var s, u, p, w, x, T, z, G, Z, le, be, ne, ce, qe, ot, Fe, zt, Nt, hn, _t = "sizzle" + 1 * new Date,
                    nt = r.document,
                    an = 0,
                    ft = 0,
                    Lt = Ji(),
                ...
                function St(R, F, X, de) {
                    var ee, me, xe, Oe, Me, Ge, Ue, Ke = F && F.ownerDocument,
                        ht = F ? F.nodeType : 9;
                    ...
                    if (!de && (ne(F), F = F || ce, ot)) {
                        if (ht !== 11 && (Me = Yo.exec(R)))
                            if (ee = Me[1]) {
                                ...
                                else if (Ke && (xe = Ke.getElementById(ee)) && hn(F, xe) && xe.id === ee) return X.push(xe), X
                            } else {
                                if (Me[2]) return xn.apply(X, F.getElementsByTagName(R)), X;
                                if ((ee = Me[3]) && u.getElementsByClassName && F.getElementsByClassName) return xn.apply(X, F.getElementsByClassName(ee)), X
                            } if (u.qsa && !dn[R + " "] && (!Fe || !Fe.test(R)) && (ht !== 1 || F.nodeName.toLowerCase() !== "object")) {
                            if (Ue = R, Ke = F, ht === 1 && (Go.test(R) || Rs.test(R))) {
                                for (Ke = Ur.test(R) && Wr(F.parentNode) || F, (Ke !== F || !u.scope) && ((Oe = F.getAttribute("id")) ? Oe = Oe.replace(qr, Is) : F.setAttribute("id", Oe = _t)), Ge = T(R), me = Ge.length; me--;) Ge[me] = (Oe ? "#" + Oe : ":scope") + " " + er(Ge[me]);
                                Ue = Ge.join(",")
                            }
                            try {
                                return xn.apply(X, Ke.querySelectorAll(Ue)), X
                            } catch {
                                dn(R, !0)
                            } finally {
                    ...
                    return G(R.replace(ki, "$1"), F, X, de)
                }
                ...
                u = St.support = {}, x = St.isXML = function(R) {
                    ...
                    return de == ce || de.nodeType !== 9 || !de.documentElement || (ce = de, qe = ce.documentElement, ot = !x(ce), nt != ce && (X = ce.defaultView) && X.top !== X && (X.addEventListener ? X.addEventListener("unload", Ls, !1) : X.attachEvent && X.attachEvent("onunload", Ls)), u.scope = wn(function(ee) {
                        ...
                        return qe.appendChild(ee).id = _t, !ce.getElementsByName || !ce.getElementsByName(_t).length
                        ...
                        if (typeof me.getElementById < "u" && ot) {
                            var xe, Oe, Me, Ge = me.getElementById(ee);
                            if (Ge) {
                                if (xe = Ge.getAttributeNode("id"), xe && xe.value === ee) return [Ge];
                                for (Me = me.getElementsByName(ee), Oe = 0; Ge = Me[Oe++];)
                                    if (xe = Ge.getAttributeNode("id"), xe && xe.value === ee) return [Ge]
                            }
                            return []
                        }
                        ...
                        var xe, Oe = [],
                            Me = 0,
                            Ge = me.getElementsByTagName(ee);
                        if (ee === "*") {
                            for (; xe = Ge[Me++];) xe.nodeType === 1 && Oe.push(xe);
                            return Oe
                        }
                        return Ge
                    ...
                    }, zt = [], Fe = [], (u.qsa = Ti.test(ce.querySelectorAll)) && (wn(function(ee) {
                        var me;
                        qe.appendChild(ee).innerHTML = "<a id='" + _t + "'></a><select id='" + _t + "-\r\\' msallowcapture=''><option selected=''></option></select>", ee.querySelectorAll("[msallowcapture^='']").length && Fe.push("[*^$]=" + gt + `*(?:''|"")`), ee.querySelectorAll("[selected]").length || Fe.push("\\[" + gt + "*(?:value|" + Gr + ")"), ee.querySelectorAll("[id~=" + _t + "-]").length || Fe.push("~="), me = ce.createElement("input"), me.setAttribute("name", ""), ee.appendChild(me), ee.querySelectorAll("[name='']").length || Fe.push("\\[" + gt + "*name" + gt + "*=" + gt + `*(?:''|"")`), ee.querySelectorAll(":checked").length || Fe.push(":checked"), ee.querySelectorAll("a#" + _t + "+*").length || Fe.push(".#.+[+~]"), ee.querySelectorAll("\\\f"), Fe.push("[\\r\\n\\f]")
                    }), wn(function(ee) {
                        ee.innerHTML = "<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
                        var me = ce.createElement("input");
                        me.setAttribute("type", "hidden"), ee.appendChild(me).setAttribute("name", "D"), ee.querySelectorAll("[name=d]").length && Fe.push("name" + gt + "*[*^$|!~]?="), ee.querySelectorAll(":enabled").length !== 2 && Fe.push(":enabled", ":disabled"), qe.appendChild(ee).disabled = !0, ee.querySelectorAll(":disabled").length !== 2 && Fe.push(":enabled", ":disabled"), ee.querySelectorAll("*,:x"), Fe.push(",.*:")
                    })), (u.matchesSelector = Ti.test(Nt = qe.matches || qe.webkitMatchesSelector || qe.mozMatchesSelector || qe.oMatchesSelector || qe.msMatchesSelector)) && wn(function(ee) {
                        u.disconnectedMatch = Nt.call(ee, "*"), Nt.call(ee, "[s!='']:x"), zt.push("!=", Hr)
                    }), Fe = Fe.length && new RegExp(Fe.join("|")), zt = zt.length && new RegExp(zt.join("|")), F = Ti.test(qe.compareDocumentPosition), hn = F || Ti.test(qe.contains) ? function(ee, me) {
                        ...
                        return xe || (xe = (ee.ownerDocument || ee) == (me.ownerDocument || me) ? ee.compareDocumentPosition(me) : 1, xe & 1 || !u.sortDetached && me.compareDocumentPosition(ee) === xe ? ee == ce || ee.ownerDocument == nt && hn(nt, ee) ? -1 : me == ce || me.ownerDocument == nt && hn(nt, me) ? 1 : le ? ei(le, ee) - ei(le, me) : 0 : xe & 4 ? -1 : 1)
                    } : function(ee, me) {
                        if (ee === me) return be = !0, 0;
                        var xe, Oe = 0,
                            Me = ee.parentNode,
                            ...
                            Ue = [ee],
                            Ke = [me];
                        if (!Me || !Ge) return ee == ce ? -1 : me == ce ? 1 : Me ? -1 : Ge ? 1 : le ? ei(le, ee) - ei(le, me) : 0;
                        if (Me === Ge) return Zi(ee, me);
                        for (xe = ee; xe = xe.parentNode;) Ue.unshift(xe);
                        for (xe = me; xe = xe.parentNode;) Ke.unshift(xe);
                        for (; Ue[Oe] === Ke[Oe];) Oe++;
                        return Oe ? Zi(Ue[Oe], Ke[Oe]) : Ue[Oe] == nt ? -1 : Ke[Oe] == nt ? 1 : 0
                    }), ce
                }, St.matches = function(R, F) {
                    return St(R, null, null, F)
                }, St.matchesSelector = function(R, F) {
                    if (ne(R), u.matchesSelector && ot && !dn[F + " "] && (!zt || !zt.test(F)) && (!Fe || !Fe.test(F))) try {
                        var X = Nt.call(R, F);
                    ...
                    var X = p.attrHandle[F.toLowerCase()],
                        de = X && Zn.call(p.attrHandle, F.toLowerCase()) ? X(R, F, !ot) : void 0;
                    ...
                    var F, X = [],
                        de = 0,
                        ee = 0;
                    if (be = !u.detectDuplicates, le = !u.sortStable && R.slice(0), R.sort(Qn), be) {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function(R) {
                            var F, X = !R[6] && R[2];
                            return Ki.CHILD.test(R[0]) ? null : (R[3] ? R[2] = R[4] || R[5] || "" : X && Ho.test(X) && (F = T(X, !0)) && (F = X.indexOf(")", X.length - F) - X.length) && (R[0] = R[0].slice(0, F), R[2] = X.slice(0, F)), R.slice(0, 3))
                        }
                    },
                    filter: {
                        TAG: function(R) {
                        ...
                        CLASS: function(R) {
                            var F = Lt[R + " "];
                            return F || (F = new RegExp("(^|" + gt + ")" + R + "(" + gt + "|$)")) && Lt(R, function(X) {
                        ...
                        CHILD: function(R, F, X, de, ee) {
                            ...
                            return de === 1 && ee === 0 ? function(Me) {
                                ...
                                var Ke, ht, Tt, Ye, Gt, Jt, pn = me !== xe ? "nextSibling" : "previousSibling",
                                    At = Me.parentNode,
                                ...
                                if (At) {
                                    if (me) {
                                        for (; pn;) {
                                            ...
                                            Jt = pn = R === "only" && !Jt && "nextSibling"
                                        }
                                        return !0
                                    }
                                    if (Jt = [xe ? At.firstChild : At.lastChild], xe && h) {
                                        for (Ye = At, Tt = Ye[_t] || (Ye[_t] = {}), ht = Tt[Ye.uniqueID] || (Tt[Ye.uniqueID] = {}), Ke = ht[R] || [], Gt = Ke[0] === an && Ke[1], b = Gt && Ke[2], Ye = Gt && At.childNodes[Gt]; Ye = ++Gt && Ye && Ye[pn] || (b = Gt = 0) || Jt.pop();)
                                            if (Ye.nodeType === 1 && ++b && Ye === Me) {
                                                ht[R] = [an, Gt, b];
                                                break
                                            }
                                    } else if (h && (Ye = Me, Tt = Ye[_t] || (Ye[_t] = {}), ht = Tt[Ye.uniqueID] || (Tt[Ye.uniqueID] = {}), Ke = ht[R] || [], Gt = Ke[0] === an && Ke[1], b = Gt), b === !1)
                                        for (;
                                            (Ye = ++Gt && Ye && Ye[pn] || (b = Gt = 0) || Jt.pop()) && !((Oe ? Ye.nodeName.toLowerCase() === c : Ye.nodeType === 1) && ++b && (h && (Tt = Ye[_t] || (Ye[_t] = {}), ht = Tt[Ye.uniqueID] || (Tt[Ye.uniqueID] = {}), ht[R] = [an, b]), Ye === Me)););
                        ...
                        PSEUDO: function(R, F) {
                            ...
                            return de[_t] ? de(F) : de.length > 1 ? (X = [R, R, "", F], p.setFilters.hasOwnProperty(R.toLowerCase()) ? fn(function(ee, me) {
                                for (var xe, Oe = de(ee, F), Me = Oe.length; Me--;) xe = ei(ee, Oe[Me]), ee[xe] = !(me[xe] = Oe[Me])
                            }) : function(ee) {
                                return de(ee, 0, X)
                            }) : de
                        }
                    ...
                    pseudos: {
                        not: fn(function(R) {
                            ...
                            return de[_t] ? fn(function(ee, me, xe, Oe) {
                                for (var Me, Ge = de(ee, null, Oe, []), Ue = ee.length; Ue--;)(Me = Ge[Ue]) && (ee[Ue] = !(me[Ue] = Me))
                            }) : function(ee, me, xe) {
                ...
                Ds.prototype = p.filters = p.pseudos, p.setFilters = new Ds, T = St.tokenize = function(R, F) {
                    var X, de, ee, me, xe, Oe, Me, Ge = Si[R + " "];
                    if (Ge) return F ? 0 : Ge.slice(0);
                    for (xe = R, Oe = [], Me = p.preFilter; xe;) {
                        ...
                        for (me in p.filter)(de = Ki[me].exec(xe)) && (!Me[me] || (de = Me[me](de))) && (X = de.shift(), ee.push({
                            value: X,
                            type: me,
                            matches: de
                        }), xe = xe.slice(X.length));
                    ...
                    return F ? xe.length : xe ? St.error(R) : Si(R, Oe).slice(0)
                };
                ...
                function tr(R, F, X) {
                    var de = F.dir,
                        ...
                        xe = X && me === "parentNode",
                        Oe = ft++;
                    return F.first ? function(Me, Ge, Ue) {
                        for (; Me = Me[de];)
                            if (Me.nodeType === 1 || xe) return R(Me, Ge, Ue);
                        return !1
                    } : function(Me, Ge, Ue) {
                        var Ke, ht, Tt, Ye = [an, Oe];
                        if (Ue) {
                            for (; Me = Me[de];)
                                if ((Me.nodeType === 1 || xe) && R(Me, Ge, Ue)) return !0
                        } else
                            for (; Me = Me[de];)
                                if (Me.nodeType === 1 || xe)
                                    if (Tt = Me[_t] || (Me[_t] = {}), ht = Tt[Me.uniqueID] || (Tt[Me.uniqueID] = {}), ee && ee === Me.nodeName.toLowerCase()) Me = Me[de] || Me;
                                    else {
                                        if ((Ke = ht[me]) && Ke[0] === an && Ke[1] === Oe) return Ye[2] = Ke[2];
                                        if (ht[me] = Ye, Ye[2] = R(Me, Ge, Ue)) return !0
                                    } return !1
                    }
                }
                ...
                function ir(R, F, X, de, ee) {
                    for (var me, xe = [], Oe = 0, Me = R.length, Ge = F != null; Oe < Me; Oe++)(me = R[Oe]) && (!X || X(me, de, ee)) && (xe.push(me), Ge && F.push(Oe));
                    return xe
                }

                function Xr(R, F, X, de, ee, me) {
                    return de && !de[_t] && (de = Xr(de)), ee && !ee[_t] && (ee = Xr(ee, me)), fn(function(xe, Oe, Me, Ge) {
                        var Ue, Ke, ht, Tt = [],
                            Ye = [],
                            Gt = Oe.length,
                            Jt = xe || Zo(F || "*", Me.nodeType ? [Me] : Me, []),
                            pn = R && (xe || !F) ? ir(Jt, Tt, R, Me, Ge) : Jt,
                            At = X ? ee || (xe ? R : Gt || de) ? [] : Oe : pn;
                        if (X && X(pn, At, Me, Ge), de)
                            for (Ue = ir(At, Ye), de(Ue, [], Me, Ge), Ke = Ue.length; Ke--;)(ht = Ue[Ke]) && (At[Ye[Ke]] = !(pn[Ye[Ke]] = ht));
                        if (xe) {
                            if (ee || R) {
                                if (ee) {
                                    for (Ue = [], Ke = At.length; Ke--;)(ht = At[Ke]) && Ue.push(pn[Ke] = ht);
                                    ee(null, At = [], Ue, Ge)
                                }
                                for (Ke = At.length; Ke--;)(ht = At[Ke]) && (Ue = ee ? ei(xe, ht) : Tt[Ke]) > -1 && (xe[Ue] = !(Oe[Ue] = ht))
                            }
                        } else At = ir(At === Oe ? At.splice(Gt, At.length) : At), ee ? ee(null, Oe, At, Ge) : xn.apply(Oe, At)
                    })
                }

                function Yr(R) {
                    for (var F, X, de, ee = R.length, me = p.relative[R[0].type], xe = me || p.relative[" "], Oe = me ? 1 : 0, Me = tr(function(Ke) {
                            return Ke === F
                        }, xe, !0), Ge = tr(function(Ke) {
                            return ei(F, Ke) > -1
                        }, xe, !0), Ue = [function(Ke, ht, Tt) {
                            var Ye = !me && (Tt || ht !== Z) || ((F = ht).nodeType ? Me(Ke, ht, Tt) : Ge(Ke, ht, Tt));
                            return F = null, Ye
                        }]; Oe < ee; Oe++)
                        if (X = p.relative[R[Oe].type]) Ue = [tr(nr(Ue), X)];
                        else {
                            if (X = p.filter[R[Oe].type].apply(null, R[Oe].matches), X[_t]) {
                                for (de = ++Oe; de < ee && !p.relative[R[de].type]; de++);
                                return Xr(Oe > 1 && nr(Ue), Oe > 1 && er(R.slice(0, Oe - 1).concat({
                                    value: R[Oe - 2].type === " " ? "*" : ""
                                })).replace(ki, "$1"), X, Oe < de && Yr(R.slice(Oe, de)), de < ee && Yr(R = R.slice(de)), de < ee && er(R))
                            }
                            Ue.push(X)
                        } return nr(Ue)
                }
                ...
                function Ps(R, F) {
                    var X = F.length > 0,
                        de = R.length > 0,
                        ee = function(me, xe, Oe, Me, Ge) {
                            var Ue, Ke, ht, Tt = 0,
                                Ye = "0",
                                Gt = me && [],
                                Jt = [],
                                pn = Z,
                                At = me || de && p.find.TAG("*", Ge),
                                c = an += pn == null ? 1 : Math.random() || .1,
                                h = At.length;
                            for (Ge && (Z = xe == ce || xe || Ge); Ye !== h && (Ue = At[Ye]) != null; Ye++) {
                                if (de && Ue) {
                                    for (Ke = 0, !xe && Ue.ownerDocument != ce && (ne(Ue), Oe = !ot); ht = R[Ke++];)
                                        if (ht(Ue, xe || ce, Oe)) {
                                            Me.push(Ue);
                                            break
                                        } Ge && (an = c)
                                }
                                X && ((Ue = !ht && Ue) && Tt--, me && Gt.push(Ue))
                            }
                            if (Tt += Ye, X && Ye !== Tt) {
                                for (Ke = 0; ht = F[Ke++];) ht(Gt, Jt, xe, Oe);
                                if (me) {
                                    if (Tt > 0)
                                        for (; Ye--;) Gt[Ye] || Jt[Ye] || (Jt[Ye] = Mn.call(Me));
                                    Jt = ir(Jt)
                                }
                                xn.apply(Me, Jt), Ge && !me && Jt.length > 0 && Tt + F.length > 1 && St.uniqueSort(Me)
                            }
                            return Ge && (an = c, Z = pn), Gt
                        };
                    return X ? fn(ee) : ee
                }
                return z = St.compile = function(R, F) {
                    var X, de = [],
                        ...
                        me = Yi[R + " "];
                    if (!me) {
                        for (F || (F = T(R)), X = F.length; X--;) me = Yr(F[X]), me[_t] ? de.push(me) : ee.push(me);
                        me = Yi(R, Ps(ee, de)), me.selector = R
                    }
                    return me
                }, G = St.select = function(R, F, X, de) {
                    var ee, me, xe, Oe, Me, Ge = typeof R == "function" && R,
                        Ue = !de && T(R = Ge.selector || R);
                    if (X = X || [], Ue.length === 1) {
                        if (me = Ue[0] = Ue[0].slice(0), me.length > 2 && (xe = me[0]).type === "ID" && F.nodeType === 9 && ot && p.relative[me[1].type]) {
                            if (F = (p.find.ID(xe.matches[0].replace(An, En), F) || [])[0], F) Ge && (F = F.parentNode);
                            else return X;
                            R = R.slice(me.shift().value.length)
                        }
                        for (ee = Ki.needsContext.test(R) ? 0 : me.length; ee-- && (xe = me[ee], !p.relative[Oe = xe.type]);)
                            if ((Me = p.find[Oe]) && (de = Me(xe.matches[0].replace(An, En), Ur.test(me[0].type) && Wr(F.parentNode) || F))) {
                                if (me.splice(ee, 1), R = de.length && er(me), !R) return xn.apply(X, de), X;
                                break
                            }
                    }
                    return (Ge || z(R, Ue))(de, F, !ot, X, !F || Ur.test(R) && Wr(F.parentNode) || F), X
                }, u.sortStable = _t.split("").sort(Qn).join("") === _t, u.detectDuplicates = !!be, ne(), u.sortDetached = wn(function(R) {
                ...
                we = d.fn.init = function(r, s, u) {
                    ...
                    if (u = u || oe, typeof r == "string")
                        if (r[0] === "<" && r[r.length - 1] === ">" && r.length >= 3 ? p = [null, r, null] : p = Te.exec(r), p && (p[1] || !s))
                            if (p[1]) {
                                if (s = s instanceof d ? s[0] : s, d.merge(this, d.parseHTML(p[1], s && s.nodeType ? s.ownerDocument || s : P, !0)), ze.test(p[1]) && d.isPlainObject(s))
                                    ...
                                    return function() {
                                        var qe = this,
                                            ...
                                            Fe = function() {
                                                var Nt, hn;
                                                if (!(le < G)) {
                                                    if (Nt = ne.apply(qe, ot), Nt === be.promise()) throw new TypeError("Thenable self-resolution");
                                                    hn = Nt && (typeof Nt == "object" || typeof Nt == "function") && Nt.then, re(hn) ? ce ? hn.call(Nt, Z(G, be, Qe, ce), Z(G, be, dt, ce)) : (G++, hn.call(Nt, Z(G, be, Qe, ce), Z(G, be, dt, ce), Z(G, be, Qe, be.notifyWith))) : (ne !== Qe && (qe = void 0, ot = [Nt]), (ce || be.resolveWith)(qe, ot))
                                                }
                                            },
                                            zt = ce ? Fe : function() {
                                                try {
                                                    ...
                                                    d.Deferred.exceptionHook && d.Deferred.exceptionHook(Nt, zt.stackTrace), le + 1 >= G && (ne !== dt && (qe = void 0, ot = [Nt]), be.rejectWith(qe, ot))
                                                }
                                            };
                ...
                data: function(r, s) {
                    ...
                    if (r === void 0) {
                        if (this.length && (w = Ie.get(x), x.nodeType === 1 && !he.get(x, "hasDataAttrs"))) {
                            for (u = T.length; u--;) T[u] && (p = T[u].name, p.indexOf("data-") === 0 && (p = V(p.slice(5)), sn(x, p, w[p])));
                    ...
                    return typeof r == "object" ? this.each(function() {
                        ...
                        var G;
                        if (x && z === void 0) return G = Ie.get(x, r), G !== void 0 || (G = sn(x, r), G !== void 0) ? G : void 0;
                        this.each(function() {
                            Ie.set(this, r, z)
                        })
            ...
            function U(r, s) {
                for (var u, p, w = [], x = 0, T = r.length; x < T; x++) p = r[x], p.style && (u = p.style.display, s ? (u === "none" && (w[x] = he.get(p, "display") || null, w[x] || (p.style.display = "")), p.style.display === "" && j(p) && (w[x] = M(p))) : u !== "none" && (w[x] = "none", he.set(p, "display", u)));
            ...
            function In(r, s, u, p, w) {
                for (var x, T, z, G, Z, le, be = s.createDocumentFragment(), ne = [], ce = 0, qe = r.length; ce < qe; ce++)
                    if (x = r[ce], x || x === 0)
                        if (se(x) === "object") d.merge(ne, x.nodeType ? [x] : x);
                        else if (!Je.test(x)) ne.push(s.createTextNode(x));
                else {
                    for (T = T || be.appendChild(s.createElement("div")), z = (pe.exec(x) || ["", ""])[1].toLowerCase(), G = Be[z] || Be._default, T.innerHTML = G[1] + d.htmlPrefilter(x) + G[2], le = G[0]; le--;) T = T.lastChild;
            ...
            d.event = {
                ...
                add: function(r, s, u, p, w) {
                    var x, T, z, G, Z, le, be, ne, ce, qe, ot, Fe = he.get(r);
                    if (!!te(r))
                        for (u.handler && (x = u, u = x.handler, w = x.selector), w && d.find.matchesSelector(Kt, w), u.guid || (u.guid = d.guid++), (G = Fe.events) || (G = Fe.events = Object.create(null)), (T = Fe.handle) || (T = Fe.handle = function(zt) {
                                return typeof d < "u" && d.event.triggered !== zt.type ? d.event.dispatch.apply(r, arguments) : void 0
                            }), s = (s || "").match(ke) || [""], Z = s.length; Z--;) z = Nn.exec(s[Z]) || [], ce = ot = z[1], qe = (z[2] || "").split(".").sort(), ce && (be = d.event.special[ce] || {}, ce = (w ? be.delegateType : be.bindType) || ce, be = d.event.special[ce] || {}, le = d.extend({
                            type: ce,
                            origType: ot,
                            data: p,
                            handler: u,
                            ...
                            namespace: qe.join(".")
                        }, x), (ne = G[ce]) || (ne = G[ce] = [], ne.delegateCount = 0, (!be.setup || be.setup.call(r, p, qe, T) === !1) && r.addEventListener && r.addEventListener(ce, T)), be.add && (be.add.call(r, le), le.handler.guid || (le.handler.guid = u.guid)), w ? ne.splice(ne.delegateCount++, 0, le) : ne.push(le), d.event.global[ce] = !0)
                },
                remove: function(r, s, u, p, w) {
                    var x, T, z, G, Z, le, be, ne, ce, qe, ot, Fe = he.hasData(r) && he.get(r);
                    if (!(!Fe || !(G = Fe.events))) {
                        for (s = (s || "").match(ke) || [""], Z = s.length; Z--;) {
                            if (z = Nn.exec(s[Z]) || [], ce = ot = z[1], qe = (z[2] || "").split(".").sort(), !ce) {
                                for (ce in G) d.event.remove(r, ce + s[Z], u, p, !0);
                                continue
                            }
                            for (be = d.event.special[ce] || {}, ce = (p ? be.delegateType : be.bindType) || ce, ne = G[ce] || [], z = z[2] && new RegExp("(^|\\.)" + qe.join("\\.(?:.*\\.|)") + "(\\.|$)"), T = x = ne.length; x--;) le = ne[x], (w || ot === le.origType) && (!u || u.guid === le.guid) && (!z || z.test(le.namespace)) && (!p || p === le.selector || p === "**" && le.selector) && (ne.splice(x, 1), le.selector && ne.delegateCount--, be.remove && be.remove.call(r, le));
                            T && !ne.length && ((!be.teardown || be.teardown.call(r, qe, Fe.handle) === !1) && d.removeEvent(r, ce, Fe.handle), delete G[ce])
                        }
            ...
            d.removeEvent = function(r, s, u) {
                ...
                r && r.type ? (this.originalEvent = r, this.type = r.type, this.isDefaultPrevented = r.defaultPrevented || r.defaultPrevented === void 0 && r.returnValue === !1 ? st : Ln, this.target = r.target && r.target.nodeType === 3 ? r.target.parentNode : r.target, this.currentTarget = r.currentTarget, this.relatedTarget = r.relatedTarget) : this.type = r, s && d.extend(this, s), this.timeStamp = r && r.timeStamp || Date.now(), this[d.expando] = !0
            }, d.Event.prototype = {
                constructor: d.Event,
            ...
            function vn(r, s, u, p) {
                ...
                var w, x, T, z, G, Z, le = 0,
                    ...
                    ce = s[0],
                    qe = re(ce);
                if (qe || be > 1 && typeof ce == "string" && !Y.checkClone && Or.test(ce)) return r.each(function(ot) {
                    var Fe = r.eq(ot);
                    qe && (s[0] = ce.call(this, ot, Fe.html())), vn(Fe, s, u, p)
                });
                if (be && (w = In(s, r[0].ownerDocument, !1, r, p), x = w.firstChild, w.childNodes.length === 1 && (w = x), x || p)) {
                    for (T = d.map(pt(w, "script"), yi), z = T.length; le < be; le++) G = w, le !== ne && (G = d.clone(G, !0, !0), z && d.merge(T, pt(G, "script"))), u.call(r[le], G, le);
                    if (z)
                        for (Z = T[T.length - 1].ownerDocument, d.map(T, wi), le = 0; le < z; le++) G = T[le], Pe.test(G.type || "") && !he.access(G, "globalEval") && d.contains(Z, G) && (G.src && (G.type || "").toLowerCase() !== "module" ? d._evalUrl && !G.noModule && d._evalUrl(G.src, {
            ...
            d.extend({
                ...
                clone: function(r, s, u) {
                    ...
                    if (!Y.noCloneChecked && (r.nodeType === 1 || r.nodeType === 11) && !d.isXMLDoc(r))
                        for (T = pt(z), x = pt(r), p = 0, w = x.length; p < w; p++) Gi(x[p], T[p]);
                    if (s)
                        if (u)
                            for (x = x || pt(r), T = T || pt(z), p = 0, w = x.length; p < w; p++) zi(x[p], T[p]);
                        else zi(r, z);
                    return T = pt(z, "script"), T.length > 0 && jt(T, !G && pt(r, "script")), z
                },
                ...
                html: function(r) {
                    return g(this, function(s) {
                        ...
                        if (typeof s == "string" && !Ar.test(s) && !Be[(pe.exec(s) || ["", ""])[1].toLowerCase()]) {
                            s = d.htmlPrefilter(s);
                            try {
            ...
            (function() {
                function r() {
                    if (!!Z) {
                        ...
                        u = le.top !== "1%", z = s(le.marginLeft) === 12, Z.style.right = "60%", x = s(le.right) === 36, p = s(le.width) === 36, Z.style.position = "absolute", w = s(Z.offsetWidth / 3) === 12, Kt.removeChild(G), Z = null
                    }
                }
            ...
            function Rr(r, s, u) {
                ...
                return (!Y.boxSizingReliable() && x || !Y.reliableTrDimensions() && K(r, "tr") || z === "auto" || !parseFloat(z) && d.css(r, "display", !1, p) === "inline") && r.getClientRects().length && (x = d.css(r, "boxSizing", !1, p) === "border-box", T = G in r, T && (z = r[G])), z = parseFloat(z) || 0, z + Wn(r, s, u || (x ? "border" : "content"), T, p, z) + "px"
            }
            d.extend({
                cssHooks: {
                    opacity: {
                ...
                css: function(r, s, u, p) {
                    var w, x, T, z = V(s),
                        G = It.test(s);
                    return G || (s = Ce(z)), T = d.cssHooks[s] || d.cssHooks[z], T && "get" in T && (w = T.get(r, !0, u)), w === void 0 && (w = tt(r, s, p)), w === "normal" && s in qn && (w = qn[s]), u === "" || u ? (x = parseFloat(w), u === !0 || isFinite(x) ? x || 0 : w) : w
                }
            }), d.each(["height", "width"], function(r, s) {
                d.cssHooks[s] = {
                    get: function(u, p, w) {
                        if (p) return We.test(d.css(u, "display")) && (!u.getClientRects().length || !u.getBoundingClientRect().width) ? Ui(u, Wt, function() {
                            return Rr(u, s, w)
                        }) : Rr(u, s, w)
                    },
                    set: function(u, p, w) {
                        var x, T = Un(u),
                            ...
                            le = w ? Wn(u, s, w, Z, T) : 0;
                        return Z && z && (le -= Math.ceil(u["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(T[s]) - Wn(u, s, "border", !1, T) - .5)), le && (x = wt.exec(p)) && (x[3] || "px") !== "px" && (u.style[s] = p, p = d.css(u, s)), Vn(u, p, le)
                    }
                }
            }), d.cssHooks.marginLeft = y(Y.reliableMarginLeft, function(r, s) {
                if (s) return (parseFloat(tt(r, "marginLeft")) || r.getBoundingClientRect().left - Ui(r, {
                    marginLeft: 0
                }, function() {
            ...
            function ko(r, s, u) {
                ...
                for (p in s)
                    ...
                    be && r.nodeType === 1 && (u.overflow = [qe.overflow, qe.overflowX, qe.overflowY], Z = Fe && Fe.display, Z == null && (Z = he.get(r, "display")), le = d.css(r, "display"), le === "none" && (Z ? le = Z : (U([r], !0), Z = r.style.display || Z, le = d.css(r, "display"), U([r]))), (le === "inline" || le === "inline-block" && Z != null) && d.css(r, "float") === "none" && (G || (ne.done(function() {
                        qe.display = Z
                    ...
                    for (p in ce) G || (Fe ? "hidden" in Fe && (ot = Fe.hidden) : Fe = he.access(r, "fxshow", {
                        display: Z
                    }), x && (Fe.hidden = !ot), ot && U([r], !0), ne.done(function() {
                        ot || U([r]), he.remove(r, "fxshow");
                        for (p in ce) d.style(r, p, ce[p])
                    })), G = vs(ot ? Fe[p] : 0, p, ne), p in Fe || (Fe[p] = G.start, ot && (G.end = G.start, G.start = 0))
                }
            }
            ...
            function Cn(r, s, u) {
                var p, w, x = 0,
                    ...
                    G = function() {
                        if (w) return !1;
                        for (var be = Ft || Lr(), ne = Math.max(0, Z.startTime + Z.duration - be), ce = ne / Z.duration || 0, qe = 1 - ce, ot = 0, Fe = Z.tweens.length; ot < Fe; ot++) Z.tweens[ot].run(qe);
                        return z.notifyWith(r, [Z, qe, ne]), qe < 1 && Fe ? ne : (Fe || z.notifyWith(r, [Z, 1, 0]), z.resolveWith(r, [Z]), !1)
                    },
                    Z = z.promise({
                        elem: r,
                        props: d.extend({}, s),
                ...
                return d.map(le, vs, Z), re(Z.opts.start) && Z.opts.start.call(r, Z), Z.progress(Z.opts.progress).done(Z.opts.done, Z.opts.complete).fail(Z.opts.fail).always(Z.opts.always), d.fx.timer(d.extend(G, {
                    elem: r,
                    anim: Z,
                    queue: Z.opts.queue
                })), Z
            ...
            d.fn.extend({
                ...
                xi[s] = function(p, w, x) {
                    ...
                    return x || (z = xi[G], xi[G] = T, T = u(p, w, x) != null ? G : null, xi[G] = z), T
                }
            });
            ...
            d.extend(d.event, {
                trigger: function(r, s, u, p) {
                    ...
                    if (x = be = T = u = u || P, !(u.nodeType === 3 || u.nodeType === 8) && !Pr.test(ce + d.event.triggered) && (ce.indexOf(".") > -1 && (qe = ce.split("."), ce = qe.shift(), qe.sort()), G = ce.indexOf(":") < 0 && "on" + ce, r = r[d.expando] ? r : new d.Event(ce, typeof r == "object" && r), r.isTrigger = p ? 2 : 3, r.namespace = qe.join("."), r.rnamespace = r.namespace ? new RegExp("(^|\\.)" + qe.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, r.result = void 0, r.target || (r.target = u), s = s == null ? [r] : d.makeArray(s, [r]), le = d.event.special[ce] || {}, !(!p && le.trigger && le.trigger.apply(u, s) === !1))) {
                        ...
                        return r.type = ce, !p && !r.isDefaultPrevented() && (!le._default || le._default.apply(ne.pop(), s) === !1) && te(u) && G && re(u[ce]) && !m(u) && (T = u[G], T && (u[G] = null), d.event.triggered = ce, r.isPropagationStopped() && be.addEventListener(ce, Kn), u[ce](), r.isPropagationStopped() && be.removeEventListener(ce, Kn), d.event.triggered = void 0, T && (u[G] = T)), r.result
                    }
                },
...
`)
            ...
            d.extend({
                ...
                ajax: function(r, s) {
                    ...
                    var u, p, w, x, T, z, G, Z, le, be, ne = d.ajaxSetup({}, s),
                        ...
                        nt = {
                            ...
                            getResponseHeader: function(ft) {
                                ...
                                if (G) {
                                    if (!x)
                                        for (x = {}; Lt = Jn.exec(w);) x[Lt[1].toLowerCase() + " "] = (x[Lt[1].toLowerCase() + " "] || []).concat(Lt[2]);
                                    Lt = x[ft.toLowerCase() + " "]
                                }
                            ...
                            setRequestHeader: function(ft, Lt) {
                                return G == null && (ft = hn[ft.toLowerCase()] = hn[ft.toLowerCase()] || ft, Nt[ft] = Lt), this
                            },
                            ...
                            abort: function(ft) {
                                var Lt = ft || _t;
                                return u && u.abort(Lt), an(0, Lt), this
                            }
                        };
                    ...
                    if (ne.data && ne.processData && typeof ne.data != "string" && (ne.data = d.param(ne.data, ne.traditional)), _s(Cs, ne, s, nt), G) return nt;
                    Z = d.event && ne.global, Z && d.active++ === 0 && d.event.trigger("ajaxStart"), ne.type = ne.type.toUpperCase(), ne.hasContent = !No.test(ne.type), p = ne.url.replace(Do, ""), ne.hasContent ? ne.data && ne.processData && (ne.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (ne.data = ne.data.replace(Mo, "+")) : (be = ne.url.slice(p.length), ne.data && (ne.processData || typeof ne.data == "string") && (p += (Xi.test(p) ? "&" : "?") + ne.data, delete ne.data), ne.cache === !1 && (p = p.replace(Po, "$1"), be = (Xi.test(p) ? "&" : "?") + "_=" + Nr.guid++ + be), ne.url = p + be), ne.ifModified && (d.lastModified[p] && nt.setRequestHeader("If-Modified-Since", d.lastModified[p]), d.etag[p] && nt.setRequestHeader("If-None-Match", d.etag[p])), (ne.data && ne.hasContent && ne.contentType !== !1 || s.contentType) && nt.setRequestHeader("Content-Type", ne.contentType), nt.setRequestHeader("Accept", ne.dataTypes[0] && ne.accepts[ne.dataTypes[0]] ? ne.accepts[ne.dataTypes[0]] + (ne.dataTypes[0] !== "*" ? ", " + xs + "; q=0.01" : "") : ne.accepts["*"]);
                    for (le in ne.headers) nt.setRequestHeader(le, ne.headers[le]);
                    if (ne.beforeSend && (ne.beforeSend.call(ce, nt, ne) === !1 || G)) return nt.abort();
                    if (_t = "abort", Fe.add(ne.complete), nt.done(ne.success), nt.fail(ne.error), u = _s(Br, ne, s, nt), !u) an(-1, "No Transport");
                    else {
                        if (nt.readyState = 1, Z && qe.trigger("ajaxSend", [nt, ne]), G) return nt;
                    ...
                    function an(ft, Lt, Si, Yi) {
                        var dn, Qn, Zn, ln, Mn, yn = Lt;
                        G || (G = !0, T && e.clearTimeout(T), u = void 0, w = Yi || "", nt.readyState = ft > 0 ? 4 : 0, dn = ft >= 200 && ft < 300 || ft === 304, Si && (ln = Bo(ne, nt, Si)), !dn && d.inArray("script", ne.dataTypes) > -1 && d.inArray("json", ne.dataTypes) < 0 && (ne.converters["text script"] = function() {}), ln = $o(ne, ln, nt, dn), dn ? (ne.ifModified && (Mn = nt.getResponseHeader("Last-Modified"), Mn && (d.lastModified[p] = Mn), Mn = nt.getResponseHeader("etag"), Mn && (d.etag[p] = Mn)), ft === 204 || ne.type === "HEAD" ? yn = "nocontent" : ft === 304 ? yn = "notmodified" : (yn = ln.state, Qn = ln.data, Zn = ln.error, dn = !Zn)) : (Zn = yn, (ft || !yn) && (yn = "error", ft < 0 && (ft = 0))), nt.status = ft, nt.statusText = (Lt || yn) + "", dn ? ot.resolveWith(ce, [Qn, yn, nt]) : ot.rejectWith(ce, [nt, yn, Zn]), nt.statusCode(zt), zt = void 0, Z && qe.trigger(dn ? "ajaxSuccess" : "ajaxError", [nt, ne, dn ? Qn : Zn]), Fe.fireWith(ce, [nt, yn]), Z && (qe.trigger("ajaxComplete", [nt, ne]), --d.active || d.event.trigger("ajaxStop")))
                    }
                    return nt
                },
            ...
            d.ajaxSetup({
                ...
                jsonpCallback: function() {
                    var r = Fr.pop() || d.expando + "_" + Nr.guid++;
                    return this[r] = !0, r
                }
                ...
                var p, w, x;
                return s || (Y.createHTMLDocument ? (s = P.implementation.createHTMLDocument(""), p = s.createElement("base"), p.href = P.location.href, s.head.appendChild(p)) : s = P), w = ze.exec(r), x = !u && [], w ? [s.createElement(w[1])] : (w = In([r], s, x), x && x.length && d(x).remove(), d.merge([], w.childNodes))
...
(function(t) {
    (function(e) {
        ...
        var m = function(E, l, g, _) {
            if (!!E) {
                ...
                for (var he = l ? [l] : i.keys(E); O < he.length; O++) {
                    ...
                    var Ie = E[l];
                    if (!Ie) break;
                    for (var Le = [], rt = 0; rt < Ie.length; rt++) {
                        var xt = Ie[rt];
                        g && g !== xt.callback && g !== xt.callback._callback || V && V !== xt.context ? Le.push(xt) : (D = xt.listening, D && --D.count === 0 && (delete te[D.id], delete D.listeningTo[D.objId]))
                    }
        ...
        i.extend(se.prototype, $, {
            ...
            set: function(E, l, g) {
                ...
                if (this.idAttribute in _ && (this.id = this.get(this.idAttribute)), !D) {
                    ...
                    for (var rt = 0; rt < V.length; rt++) this.trigger("change:" + V[rt], this, Se[V[rt]], g)
                }
                if (te) return this;
                if (!D)
        ...
        i.extend(d.prototype, $, {
            ...
            set: function(E, l) {
                if (E != null) {
                    ...
                    for (wt = 0; wt < E.length; wt++) {
                        ...
                        if (Ct) {
                            if (Ie && ct !== Ct) {
                                ...
                                l.parse && (Kt = Ct.parse(Kt, l)), Ct.set(Kt, l), V.push(Ct), xt && !rt && (rt = Ct.hasChanged(sn))
                            }
                            Se[Ct.cid] || (Se[Ct.cid] = !0, O.push(Ct)), E[wt] = Ct
                        } else he && (ct = E[wt] = this._prepareModel(ct, l), ct && (D.push(ct), this._addReference(ct, l), Se[ct.cid] = !0, O.push(ct)))
                    }
                    if (Le) {
                    ...
                    var Ze = !1,
                        Dt = !xt && he && Le;
                    if (O.length && Dt ? (Ze = this.length !== O.length || i.some(this.models, function(j, N) {
                            return j !== O[N]
                        }), this.models.length = 0, De(this.models, O, 0), this.length = this.models.length) : D.length && (xt && (rt = !0), De(this.models, D, _ == null ? this.length : _), this.length = this.models.length), rt && this.sort({
                            silent: !0
                        }), !l.silent) {
                        for (wt = 0; wt < D.length; wt++) _ != null && (l.index = _ + wt), ct = D[wt], ct.trigger("add", ct, this, l);
                        (rt || Ze) && this.trigger("sort", this, l), (D.length || te.length || V.length) && (l.changes = {
                            added: D,
                            removed: te,
                            merged: V
        ...
        var $e = n.View = function(E) {
                this.cid = i.uniqueId("view"), i.extend(this, i.pick(E, ze)), this._ensureElement(), this.initialize.apply(this, arguments)
            },
            K = /^(\S+)\s*(.*)$/,
            ze = ["model", "collection", "el", "id", "attributes", "className", "tagName", "events"];
        ...
        se.extend = d.extend = oe.extend = $e.extend = _e.extend = dt;
        var Bt = function() {
...
(function(t, e) {
    (function(n, i) {
            ...
            Tn = n.View.extend({
                ...
                reorder: function() {
                    ...
                    if (Q) this.render();
                        ...
                        var Ce = [],
                            We = i.reduce(this.children._views, function(Wt, qn) {
                                var Vn = i.indexOf(A, qn.model);
                                return Vn === -1 ? (Ce.push(qn.model), Wt) : (qn._index = Vn, Wt[Vn] = qn.el, Wt)
                            }, new Array(A.length));
        ...
        var Fi = ["childViewContainer", "template", "templateContext"],
            ...
            wi = i.pick(Nn.prototype, "serializeModel", "getTemplate", "_renderTemplate", "_renderHtml", "mixinTemplateContext", "attachElContent");
        ...
        }, tt.bindEvents = v(_e), tt.unbindEvents = v(ke), tt.bindRequests = v(Qe), tt.unbindRequests = v(dt), tt.mergeOptions = v(L), tt.getOption = v($), tt.normalizeMethods = v(J), tt.extend = S, tt.isNodeAttached = I, tt.deprecate = k, tt.triggerMethod = v(m), tt.triggerMethodOn = P, tt.isEnabled = rt, tt.setEnabled = xt, tt.monitorViewEvents = oe, tt.Behaviors = {}, tt.Behaviors.behaviorsLookup = Ui, tt.Application = Hi, tt.AppRouter = Un, tt.Renderer = Je, tt.TemplateCache = _, tt.View = Nn, tt.CollectionView = Tn, tt.NextCollectionView = vi, tt.CompositeView = yi, tt.Behavior = Gi, tt.Region = pe, tt.Error = we, tt.Object = g, tt.DEV_MODE = !1, tt.FEATURES = Le, tt.VERSION = f, tt.DomApi = N, tt.setDomApi = function(y) {
            Tn.setDomApi(y), yi.setDomApi(y), vi.setDomApi(y), pe.setDomApi(y), Nn.setDomApi(y)
        }, tt
...
function Bh(t) {
    ...
    if (n < 0) return !1;
    var i = e.length - 1;
    return n == i ? e.pop() : Vh.call(e, n, 1), --this.size, !0
}
var $h = Bh,
    jh = fo;
...
Cr.prototype.clear = Yh;
Cr.prototype.delete = Kh;
Cr.prototype.get = Jh;
Cr.prototype.has = Qh;
Cr.prototype.set = Zh;
var po = Cr,
...
var ld = ad,
    cd = typeof yt == "object" && yt && yt.Object === Object && yt,
    Ic = cd,
    ud = Ic,
    hd = typeof self == "object" && self && self.Object === Object && self,
    dd = ud || hd || Function("return this")(),
    xr = dd,
    fd = xr,
    pd = fd.Symbol,
    Lc = pd,
    _l = Lc,
    Mc = Object.prototype,
    gd = Mc.hasOwnProperty,
    md = Mc.toString,
    Kr = _l ? _l.toStringTag : void 0;
...
function vd(t) {
    ...
    var a = md.call(t);
    return i && (e ? t[Kr] = n : delete t[Kr]), a
}
var yd = vd,
    wd = Object.prototype,
    bd = wd.toString;
...
function Td(t) {
    return t == null ? t === void 0 ? kd : Sd : kl && kl in Object(t) ? Ed(t) : _d(t)
}
var go = Td;
...
function Pd(t) {
    if (!Rd(t)) return !1;
    var e = Od(t);
    return e == Ld || e == Md || e == Id || e == Dd
}
var Ga = Pd,
    Nd = xr,
    Vd = Nd["__core-js_shared__"],
    Bd = Vd,
    ia = Bd,
    Tl = function() {
...
var Hd = Gd,
    ...
    Qd = Object.prototype,
    Zd = Jd.toString,
    ef = Qd.hasOwnProperty,
    tf = RegExp("^" + Zd.call(ef).replace(Yd, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");

function nf(t) {
    if (!Wd(t) || qd(t)) return !1;
    var e = Ud(t) ? tf : Kd;
    return e.test(Xd(t))
}
var rf = nf;
...
function Af(t) {
    var e = this.__data__;
    return Sf ? e[t] !== void 0 : Tf.call(e, t)
}
var Of = Af,
    Rf = mo,
...
function Lf(t, e) {
    var n = this.__data__;
    return this.size += this.has(t) ? 0 : 1, n[t] = Rf && e === void 0 ? If : e, this
}
var Mf = Lf,
    Df = mf,
    Pf = yf,
...
_r.prototype.clear = op;
_r.prototype.delete = ap;
_r.prototype.get = lp;
_r.prototype.has = cp;
_r.prototype.set = up;
var hp = _r,
...
function mp(t, e) {
    ...
    if (n instanceof dp) {
        var i = n.__data__;
        if (!fp || i.length < gp - 1) return i.push([t, e]), this.size = ++n.size, this;
        n = this.__data__ = new pp(i)
    }
...
function Sr(t) {
    var e = this.__data__ = new yp(t);
    this.size = e.size
}
Sr.prototype.clear = wp;
Sr.prototype.delete = bp;
Sr.prototype.get = Cp;
Sr.prototype.has = xp;
Sr.prototype.set = Ep;
var _p = Sr,
    ...
    kp = function() {
        try {
            var t = Sp(Object, "defineProperty");
            return t({}, "", {}), t
        } catch {}
    }(),
    Pc = kp,
...
function Rp(t, e, n) {
    (n !== void 0 && !Op(t[e], n) || n === void 0 && !(e in t)) && Ap(t, e, n)
}
var Nc = Rp;
...
function $p(t) {
    ...
    return new Il(e).set(new Il(t)), e
}
var jp = $p,
    Fp = jp;

function zp(t, e) {
    var n = e ? Fp(t.buffer) : t.buffer;
...
var Kp = Yp,
    Jp = Kp,
    Qp = Jp(Object.getPrototypeOf, Object),
    Vc = Qp,
    Zp = Object.prototype;
...
function rg(t) {
    return typeof t.constructor == "function" && !ig(t) ? tg(ng(t)) : {}
}
var sg = rg;
...
var hg = ug,
    ...
    $c = Object.prototype,
    fg = $c.hasOwnProperty,
    pg = $c.propertyIsEnumerable,
    gg = Ml(function() {
        return arguments
    }()) ? Ml : function(t) {
        return dg(t) && fg.call(t, "callee") && !pg.call(t, "callee")
    },
    jc = gg,
    mg = Array.isArray,
    Fc = mg,
...
function Cg(t) {
    return t != null && bg(t.length) && !wg(t)
}
var qa = Cg,
    xg = qa,
    Eg = ds;
...
function Ng(t) {
    if (!Rg(t) || Ag(t) != Ig) return !1;
    var e = Og(t);
    if (e === null) return !0;
    var n = Dg.call(e, "constructor") && e.constructor;
    return typeof n == "function" && n instanceof n && Gc.call(n) == Pg
}
var Vg = Ng,
    Bg = go,
    $g = zc,
    ...
    Mt = {};
Mt[nm] = Mt[im] = Mt[rm] = Mt[sm] = Mt[om] = Mt[am] = Mt[lm] = Mt[cm] = Mt[um] = !0;
Mt[Fg] = Mt[zg] = Mt[em] = Mt[Gg] = Mt[tm] = Mt[Hg] = Mt[Ug] = Mt[qg] = Mt[Wg] = Mt[Xg] = Mt[Yg] = Mt[Kg] = Mt[Jg] = Mt[Qg] = Mt[Zg] = !1;

function hm(t) {
    return jg(t) && $g(t.length) && !!Mt[Bg(t)]
}
var dm = hm;
...
function Em(t, e, n) {
    var i = t[e];
    (!(xm.call(t, e) && bm(i, n)) || n === void 0 && !(e in t)) && wm(t, e, n)
}
var _m = Em,
    Sm = _m,
    km = Ua;
...
function Tm(t, e, n, i) {
    ...
    for (var f = -1, v = e.length; ++f < v;) {
        ...
        k === void 0 && (k = t[S]), a ? km(n, S, k) : Sm(n, S, k)
    }
    return n
}
var Am = Tm;
...
function Mm(t, e) {
    var n = typeof t;
    return e = e == null ? Im : e, !!e && (n == "number" || n != "symbol" && Lm.test(t)) && t > -1 && t % 1 == 0 && t < e
}
var qc = Mm,
    Dm = Rm,
    Pm = jc,
...
function zm(t, e) {
    var n = Nm(t),
        ...
        f = !n && !i && !a && $m(t),
        v = n || i || a || f,
        S = v ? Dm(t.length, String) : [],
        k = S.length;
    for (var I in t)(e || Fm.call(t, I)) && !(v && (I == "length" || a && (I == "offset" || I == "parent") || f && (I == "buffer" || I == "byteLength" || I == "byteOffset") || Bm(I, k))) && S.push(I);
    return S
}
var Gm = zm;
...
function Jm(t) {
    ...
    var e = Wm(t),
        n = [];
    for (var i in t) i == "constructor" && (e || !Km.call(t, i)) || n.push(i);
    return n
}
var Qm = Jm,
    Zm = Gm,
...
function yv(t, e, n, i, a, f, v) {
    ...
    if ($) {
        var J = Bl(k),
            ie = !J && dv(k),
            Y = !J && !ie && mv(k);
        L = k, J || ie || Y ? Bl(S) ? L = S : hv(S) ? L = cv(S) : ie ? ($ = !1, L = av(k, !0)) : Y ? ($ = !1, L = lv(k, !0)) : L = [] : gv(k) || Vl(k) ? (L = S, Vl(S) ? L = vv(S) : (!pv(S) || fv(S)) && (L = uv(k))) : $ = !1
    }
    $ && (v.set(k, L), a(L, k, i, f, v), v.delete(k)), Nl(t, n, L)
}
var wv = yv,
    bv = _p,
    Cv = Nc,
...
function Xc(t, e, n, i, a) {
    t !== e && xv(e, function(f, v) {
        if (a || (a = new bv), _v(f)) Ev(t, e, v, n, Xc, i, a);
        else {
            var S = i ? i(kv(t, v), f, v + "", t, e, a) : void 0;
...
function Lv(t, e, n) {
    return e = jl(e === void 0 ? t.length - 1 : e, 0),
        function() {
            for (var i = arguments, a = -1, f = jl(i.length - e, 0), v = Array(f); ++a < f;) v[a] = i[e + a];
            a = -1;
            for (var S = Array(e + 1); ++a < e;) S[a] = i[a];
            return S[e] = n(v), Iv(t, this, S)
        }
}
var Mv = Lv;
...
function ry(t, e, n) {
    if (!iy(n)) return !1;
    var i = typeof e;
    return (i == "number" ? ty(n) && ny(e, n.length) : i == "string" && e in n) ? ey(n[e], t) : !1
}
var sy = ry,
    oy = Zv,
    ay = sy;
...
function ly(t) {
    return oy(function(e, n) {
        var i = -1,
            a = n.length,
            f = a > 1 ? n[a - 1] : void 0,
            v = a > 2 ? n[2] : void 0;
        for (f = t.length > 3 && typeof f == "function" ? (a--, f) : void 0, v && ay(n[0], n[1], v) && (f = a < 3 ? void 0 : f, a = 1), e = Object(e); ++i < a;) {
            var S = n[i];
            S && t(e, S, i, f)
        }
        return e
...
let rn = Cl;
at(rn, "queryParams", new URLSearchParams(window.location.search)), at(rn, "getQueryParam", e => Cl.queryParams.get(e)), at(rn, "sleep", e => new Promise(n => {
...
class Zt {
    ...
    static setup(e, n) {
        ...
        delete window.tv.storage, window.tv.storage = {
            namespace: (a = (i = rn.getQueryParam("namespace")) != null ? i : rn.getQueryParam("ns")) != null ? a : this.defaultNamespace,
            isDisabled: rn.queryParams.has("incognito") || rn.queryParams.has("nc")
...
(function(t, e) {
    ...
    (function(f) {
        (function(v) {
            ...
            return ze.polyfill = !0, f.fetch || (f.fetch = ze, f.Headers = Y, f.Request = Ae, f.Response = $e), v.Headers = Y, v.Request = Ae, v.Response = $e, v.fetch = ze, Object.defineProperty(v, "__esModule", {
                value: !0
            }), v
        })({})
...
var py = function() {
    ...
    gy = py,
    my = function() {
        return typeof zl != "function" || typeof Symbol != "function" || typeof zl("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : gy()
    },
    vy = "Function.prototype.bind called on incompatible ",
    ra = Array.prototype.slice,
    yy = Object.prototype.toString,
    wy = "[object Function]",
    by = function(e) {
        var n = this;
        if (typeof n != "function" || yy.call(n) !== wy) throw new TypeError(vy + n);
    ...
    Cy = by,
    Wa = Function.prototype.bind || Cy,
    xy = Wa,
    Ey = xy.call(Function.call, Object.prototype.hasOwnProperty),
    vt, vr = SyntaxError,
    Kc = Function,
    dr = TypeError,
    sa = function(t) {
        try {
            return Kc('"use strict"; return (' + t + ").constructor;")()
        } catch {}
    },
...
var oa = function() {
    ...
    fr = {
        ...
        "%isFinite%": isFinite,
        "%isNaN%": isNaN,
        "%IteratorPrototype%": sr ? li(li([][Symbol.iterator]())) : vt,
        "%JSON%": typeof JSON == "object" ? JSON : vt,
        "%Map%": typeof Map > "u" ? vt : Map,
        "%MapIteratorPrototype%": typeof Map > "u" || !sr ? vt : li(new Map()[Symbol.iterator]()),
        "%Math%": Math,
        "%Number%": Number,
        "%Object%": Object,
        ...
        "%SetIteratorPrototype%": typeof Set > "u" || !sr ? vt : li(new Set()[Symbol.iterator]()),
        "%SharedArrayBuffer%": typeof SharedArrayBuffer > "u" ? vt : SharedArrayBuffer,
        "%String%": String,
        "%StringIteratorPrototype%": sr ? li("" [Symbol.iterator]()) : vt,
        "%Symbol%": sr ? Symbol : vt,
        "%SyntaxError%": vr,
        "%ThrowTypeError%": _y,
        "%TypedArray%": Sy,
    ...
    fs = Wa,
    eo = Ey,
    Ty = fs.call(Function.call, Array.prototype.concat),
    Ay = fs.call(Function.apply, Array.prototype.splice),
    Hl = fs.call(Function.call, String.prototype.replace),
    to = fs.call(Function.call, String.prototype.slice),
    Oy = fs.call(Function.call, RegExp.prototype.exec),
    Ry = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
    Iy = /\\(\\)?/g,
    Ly = function(e) {
        var n = to(e, 0, 1),
        ...
        var a = [];
        return Hl(e, Ry, function(f, v, S, k) {
            a[a.length] = S ? Hl(k, Iy, "$1") : v || f
        }), a
    },
    My = function(e, n) {
        var i = e,
            a;
        if (eo(Gl, i) && (a = Gl[i], i = "%" + a[0] + "%"), eo(fr, i)) {
            var f = fr[i];
            if (f === lr && (f = ky(i)), typeof f > "u" && !n) throw new dr("intrinsic " + e + " exists, but is not available. Please file an issue!");
            return {
                alias: a,
                name: i,
                value: f
    ...
    Xa = function(e, n) {
        ...
        if (Oy(/^%?[^%]*%?$/g, e) === null) throw new vr("`%` may not be present anywhere but at the beginning and end of the intrinsic name");
        var i = Ly(e),
            a = i.length > 0 ? i[0] : "",
            f = My("%" + a + "%", n),
            v = f.name,
            ...
            k = !1,
            I = f.alias;
        I && (a = I[0], Ay(i, Ty([0, 1], I)));
        for (var L = 1, $ = !0; L < i.length; L += 1) {
            var J = i[L],
                ie = to(J, 0, 1),
                Y = to(J, -1);
            if ((ie === '"' || ie === "'" || ie === "`" || Y === '"' || Y === "'" || Y === "`") && ie !== Y) throw new vr("property names with quotes must have matching quotes");
            if ((J === "constructor" || !$) && (k = !0), a += "." + J, v = "%" + a + "%", eo(fr, v)) S = fr[v];
            else if (S != null) {
                if (!(J in S)) {
...
var Qc = Xa,
    Zc = Jc.exports,
    Dy = Zc(Qc("String.prototype.indexOf")),
    Py = function(e, n) {
        var i = Qc(e, !!n);
        return typeof i == "function" && Dy(e, ".prototype.") > -1 ? Zc(i) : i
    };
const Ny = {},
    Vy = Object.freeze(Object.defineProperty({
        __proto__: null,
        default: Ny
    }, Symbol.toStringTag, {
        value: "Module"
...
var Ya = typeof Map == "function" && Map.prototype,
    aa = Object.getOwnPropertyDescriptor && Ya ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null,
    no = Ya && aa && typeof aa.get == "function" ? aa.get : null,
    $y = Ya && Map.prototype.forEach,
    Ka = typeof Set == "function" && Set.prototype,
    la = Object.getOwnPropertyDescriptor && Ka ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null,
    io = Ka && la && typeof la.get == "function" ? la.get : null,
    jy = Ka && Set.prototype.forEach,
    Fy = typeof WeakMap == "function" && WeakMap.prototype,
    is = Fy ? WeakMap.prototype.has : null,
    zy = typeof WeakSet == "function" && WeakSet.prototype,
    rs = zy ? WeakSet.prototype.has : null,
    Gy = typeof WeakRef == "function" && WeakRef.prototype,
    Ul = Gy ? WeakRef.prototype.deref : null,
    Hy = Boolean.prototype.valueOf,
    Uy = Object.prototype.toString,
    qy = Function.prototype.toString,
    Wy = String.prototype.match,
    Ja = String.prototype.slice,
    fi = String.prototype.replace,
    Xy = String.prototype.toUpperCase,
    ql = String.prototype.toLowerCase,
    eu = RegExp.prototype.test,
    Wl = Array.prototype.concat,
    Fn = Array.prototype.join,
    Yy = Array.prototype.slice,
    Xl = Math.floor,
    ...
    Yl = (typeof Reflect == "function" ? Reflect.getPrototypeOf : Object.getPrototypeOf) || ([].__proto__ === Array.prototype ? function(t) {
        return t.__proto__
    } : null);

function Kl(t, e) {
    if (t === 1 / 0 || t === -1 / 0 || t !== t || t && t > -1e3 && t < 1e3 || eu.call(/e/, e)) return e;
...
var Ia = By,
    ...
    Ky = function t(e, n, i, a) {
        ...
        if (typeof e == "string") return su(e, f);
        if (typeof e == "number") {
        ...
        if (typeof i > "u" && (i = 0), i >= L && L > 0 && typeof e == "object") return La(e) ? "[Array]" : "[Object]";
        var $ = pw(f, i);
        if (typeof a > "u") a = [];
        else if (ru(a, e) >= 0) return "[Circular]";

        function J(ze, H, oe) {
            if (H && (a = Yy.call(a), a.push(H)), oe) {
                var Te = {
                    depth: f.depth
                };
                return ci(f, "quoteStyle") && (Te.quoteStyle = f.quoteStyle), t(ze, Te, i + 1, a)
            }
            return t(ze, f, i + 1, a)
        }
        ...
        if (iu(e)) {
            var re = yr ? fi.call(String(e), /^(Symbol\(.*\))_[^)]*$/, "$1") : Ra.call(e);
            return typeof e == "object" && !yr ? Jr(re) : re
        }
        if (hw(e)) {
            for (var m = "<" + ql.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + nu(Jy(P[q].value), "double", f);
            return m += ">", e.childNodes && e.childNodes.length && (m += "..."), m += "</" + ql.call(String(e.nodeName)) + ">", m
        }
        if (La(e)) {
            if (e.length === 0) return "[]";
            var ae = Ns(e, J);
            return $ && !fw(ae) ? "[" + Ma(ae, $) + "]" : "[ " + Fn.call(ae, ", ") + " ]"
        }
        if (Zy(e)) {
            var se = Ns(e, J);
            return !("cause" in Error.prototype) && "cause" in e && !tu.call(e, "cause") ? "{ [" + String(e) + "] " + Fn.call(Wl.call("[cause]: " + J(e.cause), se), ", ") + " }" : se.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + Fn.call(se, ", ") + " }"
        }
        if (typeof e == "object" && v) {
            if (Ql && typeof e[Ql] == "function" && Ia) return Ia(e, {
                depth: L - i
            });
        ...
        if (ow(e)) {
            var ve = [];
            return $y.call(e, function(ze, H) {
                ve.push(J(H, e, !0) + " => " + J(ze, e))
            }), ec("Map", no.call(e), ve, $)
        }
        if (cw(e)) {
            var d = [];
            return jy.call(e, function(ze) {
                d.push(J(ze, e))
            }), ec("Set", io.call(e), d, $)
        }
        if (aw(e)) return ua("WeakMap");
        if (uw(e)) return ua("WeakSet");
        if (lw(e)) return ua("WeakRef");
        if (tw(e)) return Jr(J(Number(e)));
        if (iw(e)) return Jr(J(Oa.call(e)));
        if (nw(e)) return Jr(Hy.call(e));
        if (ew(e)) return Jr(J(String(e)));
        if (!Qy(e) && !Zl(e)) {
            var Ee = Ns(e, J),
                Ae = Yl ? Yl(e) === Object.prototype : e instanceof Object || e.constructor === Object,
                De = e instanceof Object ? "" : "null prototype",
                lt = !Ae && un && Object(e) === e && un in e ? Ja.call(gi(e), 8, -1) : De ? "Object" : "",
                $e = Ae || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "",
                K = $e + (lt || De ? "[" + Fn.call(Wl.call([], lt || [], De || []), ": ") + "] " : "");
            return Ee.length === 0 ? K + "{}" : $ ? K + "{" + Ma(Ee, $) + "}" : K + "{ " + Fn.call(Ee, ", ") + " }"
        }
        return String(e)
    };
...
var rw = Object.prototype.hasOwnProperty || function(t) {
    return t in this
};
...
function sw(t) {
    ...
    var e = Wy.call(qy.call(t), /^function\s*([\w$]+)/);
    return e ? e[1] : null
}
...
function su(t, e) {
    if (t.length > e.maxStringLength) {
        ...
        return su(Ja.call(t, 0, e.maxStringLength), e) + i
    }
    var a = fi.call(fi.call(t, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, dw);
    return nu(a, "single", e)
}
...
function dw(t) {
    ...
    return n ? "\\" + n : "\\x" + (e < 16 ? "0" : "") + Xy.call(e.toString(16))
}
...
function Ns(t, e) {
    ...
    for (var k in t) !ci(t, k) || n && String(Number(k)) === k && k < t.length || yr && v["$" + k] instanceof Symbol || (eu.call(/[^\w$]/, k) ? i.push(e(k, t) + ": " + e(t[k], t)) : i.push(k + ": " + e(t[k], t)));
    if (typeof ca == "function")
        for (var I = 0; I < f.length; I++) tu.call(t, f[I]) && i.push("[" + e(f[I]) + "]: " + e(t[f[I]], t));
    return i
}
var Qa = Xa,
    kr = Py,
    ...
    Vs = Qa("%WeakMap%", !0),
    Bs = Qa("%Map%", !0),
    vw = kr("WeakMap.prototype.get", !0),
    yw = kr("WeakMap.prototype.set", !0),
    ww = kr("WeakMap.prototype.has", !0),
    bw = kr("Map.prototype.get", !0),
    Cw = kr("Map.prototype.set", !0),
    xw = kr("Map.prototype.has", !0),
    Za = function(t, e) {
        for (var n = t, i;
            (i = n.next) !== null; n = i)
    ...
    kw = function() {
        var e, n, i, a = {
            assert: function(f) {
                if (!a.has(f)) throw new mw("Side channel does not contain " + gw(f))
            },
            get: function(f) {
            ...
            has: function(f) {
                if (Vs && f && (typeof f == "object" || typeof f == "function")) {
                    ...
                    if (n) return xw(n, f)
                } else if (i) return Sw(i, f);
                return !1
            },
            set: function(f, v) {
                Vs && f && (typeof f == "object" || typeof f == "function") ? (e || (e = new Vs), yw(e, f, v)) : Bs ? (n || (n = new Bs), Cw(n, f, v)) : (i || (i = {
                    key: {},
                    next: null
                }), _w(i, f, v))
            }
    ...
    Iw = function t(e, n, i) {
        ...
        var a = e;
        return Mi(e) && !Mi(n) && (a = ou(e, i)), Mi(e) && Mi(n) ? (n.forEach(function(f, v) {
            if (da.call(e, v)) {
                var S = e[v];
    ...
    Dw = function(e, n, i, a, f) {
        ...
        for (var S = "", k = 0; k < v.length; ++k) {
            ...
            if (I === 45 || I === 46 || I === 95 || I === 126 || I >= 48 && I <= 57 || I >= 65 && I <= 90 || I >= 97 && I <= 122 || f === Ow.RFC1738 && (I === 40 || I === 41)) {
                S += v.charAt(k);
                continue
            }
            if (I < 128) {
    ...
    zw = Array.prototype.push,
    cu = function(t, e) {
        zw.apply(t, ni(e) ? e : [e])
    },
    Gw = Date.prototype.toISOString,
    nc = ss.default,
    nn = {
        addQueryPrefix: !1,
        allowDots: !1,
    ...
    fa = {},
    Uw = function t(e, n, i, a, f, v, S, k, I, L, $, J, ie, Y, re, m) {
        ...
        if (typeof k == "function" ? P = k(n, P) : P instanceof Date ? P = $(P) : i === "comma" && ni(P) && (P = Da.maybeMap(P, function(ue) {
                return ue instanceof Date ? $(ue) : ue
            })), P === null) {
            if (f) return S && !Y ? S(n, nn.encoder, re, "key", J) : n;
            P = ""
        }
        if (Hw(P) || Da.isBuffer(P)) {
            if (S) {
                var d = Y ? n : S(n, nn.encoder, re, "key", J);
                if (i === "comma" && Y) {
                    for (var Ee = Fw.call(String(P), ","), Ae = "", De = 0; De < Ee.length; ++De) Ae += (De === 0 ? "" : ",") + ie(S(Ee[De], nn.encoder, re, "value", J));
                    return [ie(d) + (a && ni(P) && Ee.length === 1 ? "[]" : "") + "=" + Ae]
                }
        ...
        for (var ze = a && ni(P) && P.length === 1 ? n + "[]" : n, H = 0; H < $e.length; ++H) {
            var oe = $e[H],
                Te = typeof oe == "object" && typeof oe.value < "u" ? oe.value : P[oe];
            if (!(v && Te === null)) {
                var we = ni(P) ? typeof i == "function" ? i(ze, oe) : ze : ze + (L ? "." + oe : "[" + oe + "]");
                m.set(e, ae);
                var ye = lu();
                ye.set(fa, m), cu(lt, t(Te, we, i, a, f, v, S, k, I, L, $, J, ie, Y, re, ye))
            }
        }
        return lt
    },
    qw = function(e) {
        ...
        if (typeof e.format < "u") {
            if (!jw.call(ss.formatters, e.format)) throw new TypeError("Unknown format option provided.");
            i = e.format
        }
    ...
    Ww = function(t, e) {
        ...
        var S;
        e && e.arrayFormat in tc ? S = e.arrayFormat : e && "indices" in e ? S = e.indices ? "indices" : "repeat" : S = "indices";
        var k = tc[S];
        ...
        for (var L = lu(), $ = 0; $ < a.length; ++$) {
            var J = a[$];
            i.skipNulls && n[J] === null || cu(v, Uw(n[J], J, k, I, i.strictNullHandling, i.skipNulls, i.encode ? i.encoder : null, i.filter, i.sort, i.allowDots, i.serializeDate, i.format, i.formatter, i.encodeValuesOnly, i.charset, L))
        }
    ...
    Qw = function(e, n) {
        ...
        if (n.charsetSentinel)
            for (k = 0; k < v.length; ++k) v[k].indexOf("utf8=") === 0 && (v[k] === Jw ? I = "utf-8" : v[k] === Kw && (I = "iso-8859-1"), S = k, k = v.length);
        for (k = 0; k < v.length; ++k)
            if (k !== S) {
                var L = v[k],
                    ...
                    J = $ === -1 ? L.indexOf("=") : $ + 1,
                    ie, Y;
                J === -1 ? (ie = n.decoder(L, Qt.decoder, I, "key"), Y = n.strictNullHandling ? null : "") : (ie = n.decoder(L.slice(0, J), Qt.decoder, I, "key"), Y = wr.maybeMap(uu(L.slice(J + 1), n), function(re) {
                    return n.decoder(re, Qt.decoder, I, "value")
                })), Y && n.interpretNumericEntities && I === "iso-8859-1" && (Y = Yw(Y)), L.indexOf("[]=") > -1 && (Y = Xw(Y) ? [Y] : Y), Pa.call(i, ie) ? i[ie] = wr.combine(i[ie], Y) : i[ie] = Y
            } return i
    },
    Zw = function(t, e, n, i) {
        for (var a = i ? e : uu(e, n), f = t.length - 1; f >= 0; --f) {
            var v, S = t[f];
    ...
    eb = function(e, n, i, a) {
        if (!!e) {
            ...
            return k && L.push("[" + f.slice(k.index) + "]"), Zw(L, n, i, a)
        }
    },
    tb = function(e) {
        if (!e) return Qt;
        ...
        return {
            ...
            delimiter: typeof e.delimiter == "string" || wr.isRegExp(e.delimiter) ? e.delimiter : Qt.delimiter,
...
var gb = {
    ...
    cr = null;
typeof WebSocket < "u" ? cr = WebSocket : typeof MozWebSocket < "u" ? cr = MozWebSocket : typeof yt < "u" ? cr = yt.WebSocket || yt.MozWebSocket : typeof window < "u" ? cr = window.WebSocket || window.MozWebSocket : typeof self < "u" && (cr = self.WebSocket || self.MozWebSocket);
var mb = cr,
    tl = {
        exports: {}
    },
    pr = typeof Reflect == "object" ? Reflect : null,
    rc = pr && typeof pr.apply == "function" ? pr.apply : function(e, n, i) {
        return Function.prototype.apply.call(e, n, i)
    },
    Us;
pr && typeof pr.ownKeys == "function" ? Us = pr.ownKeys : Object.getOwnPropertySymbols ? Us = function(e) {
...
Object.defineProperty(Rt, "defaultMaxListeners", {
    ...
    set: function(t) {
        if (typeof t != "number" || t < 0 || du(t)) throw new RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' + t + ".");
        sc = t
    }
});
Rt.init = function() {
...
Rt.prototype.setMaxListeners = function(e) {
    if (typeof e != "number" || e < 0 || du(e)) throw new RangeError('The value of "n" is out of range. It must be a non-negative number. Received ' + e + ".");
...
Rt.prototype.emit = function(e) {
    ...
    if (typeof k == "function") rc(k, this, n);
        ...
        for (var I = k.length, L = yu(k, I), i = 0; i < I; ++i) rc(L[i], this, n);
    return !0
};
...
function pu(t, e, n, i) {
    ...
    else if (typeof v == "function" ? v = f[e] = i ? [n, v] : [v, n] : i ? v.unshift(n) : v.push(n), a = fu(t), a > 0 && v.length > a && !v.warned) {
        v.warned = !0;
...
Rt.prototype.once = function(e, n) {
    return wo(n), this.on(e, gu(this, e, n)), this
};
Rt.prototype.prependOnceListener = function(e, n) {
    return wo(n), this.prependListener(e, gu(this, e, n)), this
};
Rt.prototype.removeListener = function(e, n) {
    ...
    if (i === n || i.listener === n) --this._eventsCount === 0 ? this._events = Object.create(null) : (delete a[e], a.removeListener && this.emit("removeListener", e, i.listener || n));
        ...
        f === 0 ? i.shift() : wb(i, f), i.length === 1 && (a[e] = i[0]), a.removeListener !== void 0 && this.emit("removeListener", e, S || n)
    }
    return this
};
...
function mu(t, e, n) {
    ...
    if (i === void 0) return [];
    var a = i[e];
    return a === void 0 ? [] : typeof a == "function" ? n ? [a.listener || a] : [a] : n ? bb(a) : yu(a, a.length)
}
...
Rt.listenerCount = function(t, e) {
    return typeof t.listenerCount == "function" ? t.listenerCount(e) : vu.call(t, e)
};
Rt.prototype.listenerCount = vu;
...
function xb(t, e, n) {
    typeof t.on == "function" && wu(t, "error", e, n)
}
...
var ii = {
    ...
    CallError: bo,
    EcastServerError: ps,
    EcastCreateRoomFailed: bu,
    EcastDialRoomFailed: Cu,
    EcastServerIsShuttingDown: xu,
    EcastClientError: kt,
    EcastParseError: Eu,
    EcastRequestIsMissingOpcode: _u,
    EcastRequestHasInvalidOpcode: Su,
    EcastRequestHasInvalidArguments: ku,
    EcastEntityNotFound: Tu,
    EcastEntityAlreadyExists: Au,
    EcastEntityTypeError: Ou,
    EcastNoSuchClient: Ru,
    EcastRoomIsLocked: Iu,
    EcastRoomIsFull: Lu,
    EcastLicenseNotFound: Mu,
    EcastLicenseCheckFailed: Du,
    EcastRoomNotFound: Pu,
    EcastInvalidRole: Nu,
    EcastTwitchLoginRequired: Vu,
    EcastInvalidOption: Bu,
    EcastPasswordRequired: $u,
    EcastInvalidPassword: ju,
    EcastNameRequired: Fu,
    EcastFilterError: zu,
    EcastNoSuchFilter: Gu,
    EcastPermissionDenied: Hu,
    EcastNotConnected: Uu,
    EcastIllegalOperation: qu,
    EcastACLChangeDenied: Wu,
    EcastRoomHasEnded: Xu,
    EcastEntityLocked: Yu,
    EcastRateLimitExceeded: Ku,
    ObservedError: Eb
};
const Sb = {
    1e3: ps,
...
const lc = mb,
    ...
    X0 = 1e3 + Math.floor(Math.random() * 500),
    uc = 13e3;
class Y0 extends N0 {
    constructor(e) {
    ...
    connect() {
        ...
        return new Promise((a, f) => {
            ...
            this.conn = new lc(i, "ecast-v0"), this.conn.onmessage = L => {
                ...
                const $ = U0(L);
                if ($ instanceof z0) this.onReply($);
                else if ($ instanceof cc) {
                    if ($.result instanceof B0) S = !0, this.id = $.result.id, this.deviceId = $.result.deviceId, this.entities = $.result.entities, this.secret = $.result.secret, $.result.name && (this.name = $.result.name), k($.result);
                    else if (!v) {
                        I($.result);
                        return
                    }
    ...
    onReply(e) {
        ...
        delete this.pending[n], e.result instanceof V0 ? i.reject(e.result) : i.resolve(e.result)
    }
    onNotification(e) {
...
(function(t, e) {
    (function(n, i) {
        ...
        function L(j, N) {
            ...
            for (U in j)
                if (f.call(j, U)) {
                    if (M = j[U], !M && (M === null || M === v || isNaN(M)) && (M = ""), U = k(U), M = k(M), U === null || M === null) continue;
                    W.push(U + "=" + M)
        ...
        function ve(j) {
            ...
            var M = {},
                U = typeof j,
                fe;
            if (j.protocol === "blob:") M = new De(unescape(j.pathname), {});
            else if (U === "string") {
                M = new De(j, {});
        ...
        function Ee(j, N) {
            ...
            var W = re.exec(j),
                ...
                pe = 0,
                Pe;
            return U ? fe ? (Pe = W[2] + W[3] + W[4], pe = W[2].length + W[3].length) : (Pe = W[2] + W[4], pe = W[2].length) : fe ? (Pe = W[3] + W[4], pe = W[3].length) : Pe = W[4], M === "file:" ? pe >= 2 && (Pe = Pe.slice(2)) : d(M) ? Pe = W[4] : M ? U && (Pe = Pe.slice(2)) : pe >= 2 && d(N.protocol) && (Pe = W[4]), {
                protocol: M,
                slashes: U || d(M),
                slashesCount: pe,
                rest: Pe
        ...
        function Ae(j, N) {
            if (j === "") return N;
            for (var W = (N || "/").split("/").slice(0, -1).concat(j.split("/")), M = W.length, U = W[M - 1], fe = !1, pe = 0; M--;) W[M] === "." ? W.splice(M, 1) : W[M] === ".." ? (W.splice(M, 1), pe++) : pe && (M === 0 && (fe = !0), W.splice(M, 1), pe--);
            return fe && W.unshift(""), (U === "." || U === "..") && W.push(""), W.join("/")
        }

        function De(j, N, W) {
            if (j = q(j), !(this instanceof De)) return new De(j, N, W);
            var M, U, fe, pe, Pe, Be, pt = ae.slice(),
                jt = typeof N,
                Je = this,
                In = 0;
            for (jt !== "object" && jt !== "string" && (W = N, N = null), W && typeof W != "function" && (W = ie.parse), N = ve(N), U = Ee(j || "", N), M = !U.protocol && !U.slashes, Je.slashes = U.slashes || M && N.slashes, Je.protocol = U.protocol || N.protocol || "", j = U.rest, (Je.protocol === "file:" || !U.slashes && (U.protocol || U.slashesCount < 2 || !d(Je.protocol))) && (pt[3] = [/(.*)/, "pathname"]); In < pt.length; In++) {
                if (pe = pt[In], typeof pe == "function") {
                    j = pe(j, Je);
                    continue
                }
                fe = pe[0], Be = pe[1], fe !== fe ? Je[Be] = j : typeof fe == "string" ? ~(Pe = j.indexOf(fe)) && (typeof pe[2] == "number" ? (Je[Be] = j.slice(0, Pe), j = j.slice(Pe + pe[2])) : (Je[Be] = j.slice(Pe), j = j.slice(0, Pe))) : (Pe = fe.exec(j)) && (Je[Be] = Pe[1], j = j.slice(0, Pe.index)), Je[Be] = Je[Be] || M && pe[3] && N[Be] || "", pe[4] && (Je[Be] = Je[Be].toLowerCase())
            }
            W && (Je.query = W(Je.query)), M && N.slashes && Je.pathname.charAt(0) !== "/" && (Je.pathname !== "" || N.pathname !== "") && (Je.pathname = Ae(Je.pathname, N.pathname)), Je.pathname.charAt(0) !== "/" && d(Je.protocol) && (Je.pathname = "/" + Je.pathname), a(Je.port, Je.protocol) || (Je.host = Je.hostname, Je.port = ""), Je.username = Je.password = "", Je.auth && (pe = Je.auth.split(":"), Je.username = pe[0] || "", Je.password = pe[1] || ""), Je.origin = Je.protocol !== "file:" && d(Je.protocol) && Je.host ? Je.protocol + "//" + Je.host : "null", Je.href = Je.toString()
        }
        ...
        function lt(j, N, W) {
            ...
            switch (j) {
                case "query":
                    typeof N == "string" && N.length && (N = (W || ie.parse)(N)), M[j] = N;
                    break;
                case "port":
        ...
        function $e(j) {
            ...
            var U = M + (W.slashes || d(W.protocol) ? "//" : "");
        ...
        we.prototype.addEventListener = function(N, W) {
            ...
            this.listeners[N] = oe(M, function(U) {
                return U === W
            })
        }, we.prototype.dispatchEvent = function(N) {
            for (var W = this, M = [], U = arguments.length - 1; U-- > 0;) M[U] = arguments[U + 1];
            var fe = N.type,
                pe = this.listeners[fe];
            return Array.isArray(pe) ? (pe.forEach(function(Pe) {
                M.length > 0 ? Pe.apply(W, M) : Pe.call(W, N)
            }), !0) : !1
        };
        ...
        ue.prototype.attachWebSocket = function(N, W) {
            ...
            var M = this.urlMap[ye(N.url)],
                U = M.roomMemberships[W];
            M && U !== null && (M.roomMemberships[W] = oe(U, function(fe) {
                return fe === N
            }))
        };
        var _e = new ue,
            ...
            Qe = function() {};
        Qe.prototype.stopPropagation = function() {}, Qe.prototype.stopImmediatePropagation = function() {}, Qe.prototype.initEvent = function(N, W, M) {
            N === void 0 && (N = "undefined"), W === void 0 && (W = !1), M === void 0 && (M = !1), this.type = "" + N, this.bubbles = Boolean(W), this.cancelable = Boolean(M)
        };
        var dt = function(j) {
                function N(W, M) {
                    if (M === void 0 && (M = {}), j.call(this), !W) throw new TypeError(je.EVENT_ERROR + " 1 argument required, but only 0 present.");
                    if (typeof M != "object") throw new TypeError(je.EVENT_ERROR + " parameter 2 ('eventInitDict') is not an object.");
                    var U = M.bubbles,
                        fe = M.cancelable;
            ...
            Bt = function(j) {
                function N(W, M) {
                    if (M === void 0 && (M = {}), j.call(this), !W) throw new TypeError(je.EVENT.MESSAGE + " 1 argument required, but only 0 present.");
                    if (typeof M != "object") throw new TypeError(je.EVENT.MESSAGE + " parameter 2 ('eventInitDict') is not an object");
                    var U = M.bubbles,
                        fe = M.cancelable,
                        pe = M.data,
                        Pe = M.origin,
                        Be = M.lastEventId,
                        pt = M.ports;
                    this.type = "" + W, this.timeStamp = Date.now(), this.target = null, this.srcElement = null, this.returnValue = !0, this.isTrusted = !1, this.eventPhase = 0, this.defaultPrevented = !1, this.currentTarget = null, this.cancelable = fe ? Boolean(fe) : !1, this.canncelBubble = !1, this.bubbles = U ? Boolean(U) : !1, this.origin = "" + Pe, this.ports = typeof pt > "u" ? null : pt, this.data = typeof pe > "u" ? null : pe, this.lastEventId = "" + (Be || "")
                }
                return j && (N.__proto__ = j), N.prototype = Object.create(j && j.prototype), N.prototype.constructor = N, N
            }(Qe),
            Ut = function(j) {
                function N(W, M) {
                    if (M === void 0 && (M = {}), j.call(this), !W) throw new TypeError(je.EVENT.CLOSE + " 1 argument required, but only 0 present.");
                    if (typeof M != "object") throw new TypeError(je.EVENT.CLOSE + " parameter 2 ('eventInitDict') is not an object");
                    var U = M.bubbles,
                        fe = M.cancelable,
                        pe = M.code,
                        Pe = M.reason,
                        Be = M.wasClean;
                    this.type = "" + W, this.timeStamp = Date.now(), this.target = null, this.srcElement = null, this.returnValue = !0, this.isTrusted = !1, this.eventPhase = 0, this.defaultPrevented = !1, this.currentTarget = null, this.cancelable = fe ? Boolean(fe) : !1, this.cancelBubble = !1, this.bubbles = U ? Boolean(U) : !1, this.code = typeof pe == "number" ? parseInt(pe, 10) : 0, this.reason = "" + (Pe || ""), this.wasClean = Be ? Boolean(Be) : !1
                }
                return j && (N.__proto__ = j), N.prototype = Object.create(j && j.prototype), N.prototype.constructor = N, N
            }(Qe);
        ...
        function _(j, N, W) {
            ...
            ze(function() {
                _e.removeWebSocket(j, j.url), j.readyState = Le.CLOSED, j.dispatchEvent(U), j.dispatchEvent(fe), M && M.dispatchEvent(U, M)
            }, j)
        }
        ...
        function O(j, N, W) {
            ...
            ze(function() {
                _e.removeWebSocket(j, j.url), j.readyState = Le.CLOSED, j.dispatchEvent(pe), j.dispatchEvent(U), j.dispatchEvent(fe), M && M.dispatchEvent(U, M)
            }, j)
        }
        ...
        function he(j) {
            ...
            if (W || (N.pathname = "/"), M === "") throw new SyntaxError(je.CONSTRUCTOR_ERROR + " The URL '" + N.toString() + "' is invalid.");
            if (M !== "ws:" && M !== "wss:") throw new SyntaxError(je.CONSTRUCTOR_ERROR + " The URL's scheme must be either 'ws' or 'wss'. '" + M + "' is not allowed.");
        ...
        function Ie(j) {
            ...
            var N = j.map(function(M) {
                    ...
                    return M[U.protocol] = (M[U.protocol] || 0) + U.count, M
                }, {}),
        ...
        var Le = function(j) {
            function N(M, U) {
                j.call(this), this._onopen = null, this._onmessage = null, this._onerror = null, this._onclose = null, this.url = he(M), U = Ie(U), this.protocol = U[0] || "", this.binaryType = "blob", this.readyState = N.CONNECTING;
                var fe = te(this),
                    ...
                    if (pe)
                        if (pe.options.verifyClient && typeof pe.options.verifyClient == "function" && !pe.options.verifyClient()) this.readyState = N.CLOSED, H("error", "WebSocket connection to '" + this.url + "' failed: HTTP Authentication failed; no valid credentials available"), _e.removeWebSocket(fe, this.url), this.dispatchEvent(E({
                            ...
                            if (pe.options.selectProtocol && typeof pe.options.selectProtocol == "function") {
                                var Be = pe.options.selectProtocol(U),
                                    pt = Be !== "",
                                    jt = U.indexOf(Be) !== -1;
                                if (pt && !jt) {
            ...
            return W.onopen.get = function() {
                ...
                if (!(this.readyState === N.CLOSING || this.readyState === N.CLOSED)) {
                    var Pe = te(this);
                    this.readyState === N.CONNECTING ? O(Pe, U || ke.CLOSE_ABNORMAL, fe) : _(Pe, U || ke.CLOSE_NO_STATUS, fe)
                }
        ...
        function xt() {
            return typeof window < "u" ? window : typeof process == "object" && typeof gC == "function" && typeof yt == "object" ? yt : this
        }
        var sn = {
                mock: !0,
                verifyClient: null,
            ...
            ct = function(j) {
                function N(W, M) {
                    ...
                    this.options = Object.assign({}, sn, M), this.options.mock && this.mockWebsocket()
                }
                return j && (N.__proto__ = j), N.prototype = Object.create(j && j.prototype), N.prototype.constructor = N, N.prototype.mockWebsocket = function() {
                ...
                }, N.prototype.on = function(M, U) {
                    this.addEventListener(M, U)
                    ...
                    _e.removeServer(this.url), Pe.forEach(function(Be) {
                        Be.readyState = Le.CLOSED, Be.dispatchEvent(g({
                            type: "close",
                            target: Be.target,
                ...
                }, N.prototype.emit = function(M, U, fe) {
                    var pe = this;
                    fe === void 0 && (fe = {});
                    var Pe = fe.websockets;
                    Pe || (Pe = _e.websocketsLookup(this.url)), typeof fe != "object" || arguments.length > 3 ? (U = Array.prototype.slice.call(arguments, 1, arguments.length), U = U.map(function(Be) {
                        return D(Be)
                    })) : U = D(U), Pe.forEach(function(Be) {
                ...
                }, N.prototype.to = function(M, U, fe) {
                    var pe = this;
                    fe === void 0 && (fe = []);
                    var Pe = this,
                        Be = rt(fe.concat(_e.websocketsLookup(this.url, M, U)));
                    return {
                        to: function(pt, jt) {
        ...
        var wt = function(j) {
            function N(M, U) {
                var fe = this;
                M === void 0 && (M = "socket.io"), U === void 0 && (U = ""), j.call(this), this.binaryType = "blob";
                var pe = new K(M);
            ...
            return N.prototype.close = function() {
                ...
                return Be && Be.dispatchEvent.apply(Be, [Pe].concat(fe)), this
            }, N.prototype.send = function(U) {
...
const vC = mt.View.extend({
    ...
    onBannerClick() {
        Oh.bannerClick(this.getCampaign(), "post_game"), this.model.get("url") && window.open(this.model.get("url"), "_blank")
    },
    onRender() {
        this.stickit()
    },
...
class ri {
    ...
    static async init(e) {
        ...
        this.bannerData = await this.loadBannerData(e), this.bannerData && (this.view = new vC({
...
at(ri, "view", null), at(ri, "isInitialized", !1), at(ri, "bannerConfig", null);
var yC = {};
(function(t) {
    (function(e) {
        e(Vi.exports, Xe, t)
        ...
        n.Stickit = i, i._handlers = [], i.addHandler = function(m) {
            ...
            addBinding: function(m, P, q) {
                ...
                if (q = q || {}, e.isObject(P)) {
                    var ve = P;
                    e.each(ve, function(K, ze) {
                        this.addBinding(ae, ze, K)
                    }, this);
                    return
                }
                    ...
                    if (Ee._destroy = function() {
                        ...
                        e.each(Ee.events, function(K) {
                            var ze = K + se,
                                ...
                                oe = P === ":el" ? "" : P;
                            this.$el.on(ze, oe, e.bind(H, this))
                        }, this), e.each(e.flatten([Ae]), function(K) {
                            k(ae, "change:" + K, Ee, function(ze, H, oe) {
            ...
            update: function(m, P, q, ae) {
                ...
                var De = function(ue, _e, ke) {
                    e.each(ue, function(je) {
                        var Qe = n.$("<option/>"),
                            dt = je,
                            Bt = function(_, O, D) {
                                Qe.text(_), dt = O, Qe.data("stickit-bind-val", dt), !e.isArray(dt) && !e.isObject(dt) && Qe.val(dt), D === !0 && Qe.prop("disabled", "disabled")
                            },
                            Ut, E, l;
                ...
                if (se instanceof n.Collection) {
                    var $e = se,
                        ...
                        H = function() {
                            ze(), $e.off("stickit:selectRefresh"), q.off("stickit:selectRefresh")
                        };
                    $e.trigger("stickit:selectRefresh"), $e.once("stickit:selectRefresh", ze, this), $e.on("add remove reset sort", K, this), q.trigger("stickit:selectRefresh"), q.once("stickit:selectRefresh", function() {
...
const wC = `<button type="button" class='button choice-button btn btn-lg'></button>
<button data-action='censor' class='button censor-button btn btn-lg'></button>`,
    rh = mt.View.extend({
        template: Ve.template(wC),
        model: new Xe.Model({}),
        className() {
    ...
    return t && Array.prototype.forEach.call(t.length ? t : [t], function(n) {
        return function(i) {
            if (i && i.nodeName && i.nodeName === "TEXTAREA" && !os.has(i)) {
                ...
                i.addEventListener("autosize:destroy", I, !1), "onpropertychange" in i && "oninput" in i && i.addEventListener("keyup", J, !1), window.addEventListener("resize", k, !1), i.addEventListener("input", J, !1), i.addEventListener("autosize:update", J, !1), i.style.overflowX = "hidden", i.style.wordWrap = "break-word", os.set(i, {
                    destroy: I,
                    update: J
...
const xC = `<form>\r
    ...
    ro = mt.View.extend({
        ...
        onAttach() {
            this.getOption("preventAutosize") || fc(Ne("textarea"))
        },
        onSubmitClick() {
        ...
        clearInput() {
            ...
            Ne(t).val(""), this.getOption("preventAutosize") || fc.update(t), this.onInputChange()
        },
        setValue(t) {
        ...
        getSanitizedValue() {
            return rn.sanitize(this.getValue())
        },
        sanitize(t) {
            return rn.sanitize(t)
        },
        sanitizeInput(t) {
            return rn.sanitizeInput(t)
        }
    }),
    EC = '<div class="text"></div>',
    ji = mt.View.extend({
        tagName: "div",
        template: Ve.template(EC),
        model: new Xe.Model({
            text: "",
            className: ""
        }),
    ...
    zn = mt.CollectionView.extend({
        tagName: "div",
        className: "choices",
        childView(t) {
            return t.get("type") === "input" ? ro : t.get("type") === "text" ? ji : rh
        },
...
function _C(t) {
    ...
    return qs = Zr.getContext("2d"), qs.imageSmoothingEnabled = !1, oh("init"), {
        canvas: Zr,
        context: qs
    }
}
...
function TC({
    ...
    function Y() {
        if (I = requestAnimationFrame(Y), L = ie.now(), $ = L - k, k = L, !($ > 1e3)) {
            for (oh("tick"), a += $; a >= f;) J.update(v), a -= f;
            S(), J.render()
        }
    }
    return J = {
...
class hl {
    ...
    get(e) {
        ...
        for (; this._s.length && this._b;) {
            for (i = gc(e, this.bounds), a = 0; a < i.length; a++) this._s[i[a]].get(e).forEach(f => n.add(f));
            return Array.from(n)
        }
    ...
    _a(e, n, i) {
        for (n = gc(e, this.bounds), i = 0; i < n.length; i++) this._s[n[i]].add(e)
    }
    _sp(e, n, i) {
...
(function(t, e) {
    (function(n, i) {
        ...
        const n = "SweetAlert2:",
            ...
            ze = $e(["success", "warning", "info", "question", "error"]),
...
`,
            ...
            sn = (c, h) => {
                Array.from(c.classList).forEach(b => {
                    !Object.values(K).includes(b) && !Object.values(ze).includes(b) && !Object.values(h.showClass).includes(b) && c.classList.remove(b)
                })
            },
            ct = (c, h, b) => {
...
`).replace(/(^|\n)\s*/g, ""),
            ...
            Ar = () => {
                const c = we(),
                    ...
                    Bn = j(c, K.textarea);
                h.oninput = on, b.onchange = on, He.onchange = on, Ht.onchange = on, Bn.oninput = on, B.oninput = () => {
                    on(), ge.value = B.value
                }, B.onchange = () => {
                    on(), ge.value = B.value
                }
            ...
            yi = c => {
                ...
                b.className = K.container, h && Ze(b, K["no-transition"]), rt(b, Tr);
                const B = Or(c.target);
                B.appendChild(b), vi(c), Fi(B), Ar()
            },
            wi = (c, h) => {
            ...
            bi = (c, h) => {
                const b = g(),
                    B = E();
                !h.showConfirmButton && !h.showDenyButton && !h.showCancelButton ? M(b) : W(b), ct(b, h, "actions"), Un(b, B, h), rt(B, h.loaderHtml), ct(B, h, "loader")
            };
        ...
        function Un(c, h, b) {
            const B = dt(),
                ge = Bt(),
                He = l();
            Ci(B, "confirm", b), Ci(ge, "deny", b), Ci(He, "cancel", b), Ui(B, ge, He, b), b.reverseButtons && (b.toast ? (c.insertBefore(He, B), c.insertBefore(ge, B)) : (c.insertBefore(He, h), c.insertBefore(ge, h), c.insertBefore(B, h)))
        }
        ...
        const Q = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
            Ce = (c, h) => {
                ...
                Q.forEach(He => {
                    const Ht = j(b, K[He]);
                    Wt(He, h.inputAttributes), Ht.className = K[He], ge && M(Ht)
                }), h.input && (ge && We(h), qn(h))
            },
            We = c => {
            ...
            Ft = {};
        Ft.text = Ft.email = Ft.password = Ft.number = Ft.tel = Ft.url = (c, h) => (Xt(c, h.inputValue), Wn(c, c, h), Vn(c, h), c.type = h.input, c), Ft.file = (c, h) => (Wn(c, c, h), Vn(c, h), c), Ft.range = (c, h) => {
            const b = c.querySelector("input"),
                B = c.querySelector("output");
            return Xt(b, h.inputValue), b.type = h.input, Xt(B, h.inputValue), Wn(b, c, h), c
        }, Ft.select = (c, h) => {
            ...
            Xt(c, h.inputValue), Vn(c, h), Wn(c, c, h);
        ...
        const qi = (c, h) => {
                const b = _e();
                ct(b, h, "htmlContainer"), h.html ? (wi(h.html, b), W(b, "block")) : h.text ? (b.textContent = h.text, W(b, "block")) : M(b), Ce(c, h)
            },
            _o = (c, h) => {
                const b = _();
            ...
            Ir = (c, h) => {
                ...
                if (h.icon && Object.keys(ze).indexOf(h.icon) === -1) {
                    v('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(h.icon, '"')), M(B);
                    return
                }
                W(B), ys(B, h), Lr(B, h), Ze(B, h.showClass.icon)
            },
            Lr = (c, h) => {
                for (const b in ze) h.icon !== b && Dt(c, ze[b]);
                Ze(c, ze[h.icon]), Cn(c, h), Wi(), ct(c, h, "icon")
            },
            Wi = () => {
                const c = we(),
...
`,
            ys = (c, h) => {
                let b = c.innerHTML,
                    B;
                h.iconHtml ? B = Mr(h.iconHtml) : h.icon === "success" ? (B = vs, b = b.replace(/ style=".*?"/g, "")) : h.icon === "error" ? B = ko : B = Mr({
                    question: "?",
                    warning: "!",
                    info: "i"
            ...
            Xn = c => {
                const h = document.createElement("li");
                return Ze(h, K["progress-step-line"]), c.progressStepsDistance && N(h, "width", c.progressStepsDistance), h
            },
            Yn = (c, h) => {
                const b = ue();
            ...
            Dr = (c, h) => {
                const b = H(),
                    B = we();
                h.toast ? (N(b, "width", h.width), B.style.width = "100%", B.insertBefore(E(), ye())) : N(B, "width", h.width), N(B, "padding", h.padding), h.color && (B.style.color = h.color), h.background && (B.style.background = h.background), M(Qe()), Oo(B, h)
            },
            Oo = (c, h) => {
            ...
            Pr = (c, h) => {
                Dr(c, h), tt(c, h), To(c, h), Ir(c, h), xi(c, h), Yn(c, h), So(c, h), qi(c, h), bi(c, h), _o(c, h), typeof h.didRender == "function" && h.didRender(we())
            },
            Kn = Object.freeze({
                cancel: "cancel",
                backdrop: "backdrop",
            ...
            Ro = c => {
                ...
                if (!h) return {};
                const b = h.content;
                return Po(b), Object.assign(ws(b), Io(b), Lo(b), Vr(b), Mo(b), Do(b, Xi))
            },
            ws = c => {
                const h = {};
            ...
            Lo = c => {
                ...
                return b && (Jn(b, ["src", "width", "height", "alt"]), b.hasAttribute("src") && (h.imageUrl = b.getAttribute("src")), b.hasAttribute("width") && (h.imageWidth = b.getAttribute("width")), b.hasAttribute("height") && (h.imageHeight = b.getAttribute("height")), b.hasAttribute("alt") && (h.imageAlt = b.getAttribute("alt"))), h
            },
            Vr = c => {
                const h = {},
                    b = c.querySelector("swal-icon");
                return b && (Jn(b, ["type", "color"]), b.hasAttribute("type") && (h.icon = b.getAttribute("type")), b.hasAttribute("color") && (h.iconColor = b.getAttribute("color")), h.iconHtml = b.innerHTML), h
            },
            Mo = c => {
                const h = {},
                    b = c.querySelector("swal-input");
                b && (Jn(b, ["type", "label", "placeholder", "value"]), h.input = b.getAttribute("type") || "text", b.hasAttribute("label") && (h.inputLabel = b.getAttribute("label")), b.hasAttribute("placeholder") && (h.inputPlaceholder = b.getAttribute("placeholder")), b.hasAttribute("value") && (h.inputValue = b.getAttribute("value")));
            ...
            Do = (c, h) => {
                ...
                for (const B in h) {
                    ...
                    He && (Jn(He, []), b[ge.replace(/^swal-/, "")] = He.innerHTML.trim())
                }
                return b
            },
            Po = c => {
...
`).join("<br />")), yi(c)
        ...
        const xs = () => {
            ...
            Es = () => {
                if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1) && !xt(document.body, K.iosfix)) {
                    ...
                    document.body.style.top = "".concat(h * -1, "px"), Ze(document.body, K.iosfix), jr(), _s()
                }
            },
            _s = () => {
            ...
            Bo = c => {
                const h = c.target,
                    b = H();
                return $o(c) || jo(c) ? !1 : h === b || !Be(b) && h.tagName !== "INPUT" && h.tagName !== "TEXTAREA" && !(Be(_e()) && _e().contains(h))
            },
            ...
            zr = c => {
                ...
                r(h, b, c), setTimeout(() => {
                    Fo(h, b)
                }, Fr), Se() && (zo(h, c.scrollbarPadding, ge), Ei()), !he() && !st.previousActiveElement && (st.previousActiveElement = document.activeElement), typeof c.didOpen == "function" && setTimeout(() => c.didOpen(b)), Dt(h, K["no-transition"])
            },
            Ss = c => {
                const h = we();
            ...
            Fo = (c, h) => {
                vn && pt(h) ? (c.style.overflowY = "hidden", h.addEventListener(vn, Ss)) : c.style.overflowY = "auto"
            },
            zo = (c, h, b) => {
            ...
            u = (c, h) => {
                const b = g(),
                    B = E();
                !h && pe(dt()) && (h = dt()), W(b), h && (M(h), B.setAttribute("data-button-to-replace", h.className)), B.parentNode.insertBefore(B, h), Ze([c, b], K.loading)
            },
            p = (c, h) => {
                ...
                select: (c, h, b) => {
                    const B = j(c, K.select),
                        ge = (He, Ht, Bn) => {
                            ...
                            gn.value = Bn, rt(gn, Ht), gn.selected = ne(Bn, b.inputValue), He.appendChild(gn)
                        };
                    h.forEach(He => {
                        const Ht = He[0],
                            Bn = He[1];
                        if (Array.isArray(Bn)) {
                            ...
                            gn.label = Ht, gn.disabled = !1, B.appendChild(gn), Bn.forEach(rr => ge(gn, rr[1], rr[0]))
                        } else ge(B, Bn, Ht)
                    }), B.focus()
                },
                radio: (c, h, b) => {
                    ...
                    h.forEach(He => {
                        ...
                        gn.type = "radio", gn.name = K.radio, gn.value = Ht, ne(Ht, b.inputValue) && (gn.checked = !0);
                        const ea = document.createElement("span");
                        rt(ea, Bn), ea.className = K.label, rr.appendChild(gn), rr.appendChild(ea), B.appendChild(rr)
                    });
        ...
        function ce() {
            ...
            M(h.loader), he() ? c.icon && W(ye()) : qe(h), Dt([h.popup, h.actions], K.loading), h.popup.removeAttribute("aria-busy"), h.popup.removeAttribute("data-loading"), h.confirmButton.disabled = !1, h.denyButton.disabled = !1, h.cancelButton.disabled = !1
        }
        const qe = c => {
            const h = c.popup.getElementsByClassName(c.loader.getAttribute("data-button-to-replace"));
            h.length ? W(h[0], "inline-block") : Pe() && M(c.actions)
        };
        ...
        const zt = () => pe(we()),
            ...
            an = (c, h, b, B) => {
                nt(h), b.toast || (h.keydownHandler = ge => Yi(c, ge, B), h.keydownTarget = b.keydownListenerCapture ? window : we(), h.keydownListenerCapture = b.keydownListenerCapture, h.keydownTarget.addEventListener("keydown", h.keydownHandler, {
            ...
            Yi = (c, h, b) => {
                const B = A.innerParams.get(c);
                !B || h.isComposing || h.keyCode === 229 || (B.stopKeydownPropagation && h.stopPropagation(), h.key === "Enter" ? dn(c, h, B) : h.key === "Tab" ? Qn(h, B) : [...Lt, ...Si].includes(h.key) ? Zn(h.key) : h.key === "Escape" && ln(h, B, b))
            },
            dn = (c, h, b) => {
            ...
            ln = (c, h, b) => {
                L(h.allowEscapeKey) && (c.preventDefault(), b(Kn.esc))
            };

        function Mn(c, h, b, B) {
            he() ? As(c, B) : (mi(b).then(() => As(c, B)), nt(st)), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (h.setAttribute("style", "display:none !important"), h.removeAttribute("class"), h.innerHTML = "") : h.remove(), Se() && ($r(), _i(), Nr()), yn()
        }
        ...
        const ei = c => {
            ...
            const B = H();
            return Dt(B, b.showClass.backdrop), Ze(B, b.hideClass.backdrop), Ts(c, h, b), !0
        };
        ...
        const gt = c => {
            ...
            Ts = (c, h, b) => {
                const B = H(),
                    ge = vn && pt(h);
                typeof b.willClose == "function" && b.willClose(h), ge ? Hr(c, h, B, b.returnFocus, b.didClose) : Mn(c, B, b.returnFocus, b.didClose)
            },
            Hr = (c, h, b, B, ge) => {
                st.swalCloseEventFinishedCallback = Mn.bind(null, c, b, B, ge), h.addEventListener(vn, function(He) {
        ...
        const Is = c => {
            ...
            Ji = (c, h, b) => {
                ...
                c.disableInput(), Promise.resolve().then(() => J(B.inputValidator(h, B.validationMessage))).then(He => {
                    c.enableButtons(), c.enableInput(), He ? c.showValidationMessage(He) : b === "deny" ? fn(c, h) : Zi(c, h)
                })
            },
            fn = (c, h) => {
            ...
            Jo = (c, h, b) => {
                A.innerParams.get(c).toast ? Qo(c, h, b) : (Wr(h), Ds(h), er(c, h, b))
            },
            Qo = (c, h, b) => {
                h.popup.onclick = () => {
                    const B = A.innerParams.get(c);
                    B && (Ms(B) || B.timer || B.input) || b(Kn.close)
                }
            },
        ...
        const Wr = c => {
            ...
            er = (c, h, b) => {
                h.container.onclick = B => {
                    ...
                    B.target === h.container && L(ge.allowOutsideClick) && b(Kn.backdrop)
                }
            },
        ...
        class Ue {
            constructor() {
                ...
                const He = Ge._main(Ge.params);
                A.promise.set(this, He)
            }
            _main(h) {
                let b = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                De(Object.assign({}, b, h)), st.currentInstance && (st.currentInstance._destroy(), Se() && Nr()), st.currentInstance = Ge;
                const B = ht(h, b);
                Cs(B), Object.freeze(B), st.timeout && (st.timeout.stop(), delete st.timeout), clearTimeout(st.restoreFocusTimeout);
                const ge = Tt(Ge);
                return Pr(Ge, B), A.innerParams.set(Ge, B), Ke(Ge, ge, B)
            }
            then(h) {
        ...
        const Ke = (c, h, b) => new Promise((B, ge) => {
                ...
                Fe.swalPromiseResolve.set(c, B), Fe.swalPromiseReject.set(c, ge), h.confirmButton.onclick = () => Is(c), h.denyButton.onclick = () => Ls(c), h.cancelButton.onclick = () => Ko(c, He), h.closeButton.onclick = () => He(Kn.close), Jo(c, h, He), an(c, st, b, He), p(c, b), zr(b), Ye(st, b, He), Gt(h, b), setTimeout(() => {
            ...
            Gt = (c, h) => {
                if (!h.toast) {
                    if (!L(h.allowEnterKey)) return pn();
                    Jt(c, h) || ft(h, -1, 1)
                }
            },
      ...
      `));
        ...
        Object.assign(Ue.prototype, qr), Object.assign(Ue, Me), Object.keys(qr).forEach(c => {
            Ue[c] = function() {
                if (Ge) return Ge[c](...arguments)
            }
        }), Ue.DismissReason = Kn, Ue.version = "11.4.26";
        const At = Ue;
...
class Ot {
    static get DismissReason() {
        return en.DismissReason
    }
    static show(e, n = {}) {
        switch (en.isVisible() && en.close(), e instanceof Error && (n.text = e.message, e = "error"), e) {
            case "alert":
    ...
    static async showAlert(e) {
        ...
        return e.customClass = {
            ...n,
            popup: "jbgModal"
        }, e.titleText = e.titleText || "Error", en.fire(e)
    }
    static async showError(e) {
        const n = new URL("jackbox/main/pp4/overdrawn/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
        }, e.titleText = e.titleText || "Error", n && (e.imageUrl = n), en.fire(e)
    }
    static async showCustom(e) {
        return en.fire(e)
    }
    static async showToast(e) {
        return e.toast = !0, e.showConfirmButton = !1, e.timer = e.timer || 2500, e.position = e.position || "bottom", en.fire(e)
    }
}
const IC = `<div class="canvasContainer">\r
...
<div style="display:none;">\r
    ...
    MC = mt.View.extend({
        ...
        onAttach() {
            const t = this;
            _C("cameraCanvas"), t.sprites = [], t.gameLoop = TC({
                fps: 60,
                update(e) {
            ...
            this.cameraSprite = gl(LC), this.cameraSprite.width = this.model.get("width"), this.cameraSprite.height = this.model.get("height"), this.cameraSprite.mask = this.model.get("mask"), t.sprites.push(this.cameraSprite), t.gameLoop.start(), this.facingMode = "user", this.startCamera(), this.onResize()
        },
        async startCamera() {
    ...
    Pn = Xe.Model.extend({
        defaults: {},
        set(t, e) {
            const n = Ve.extend({}, this.attributes, this.defaults, t);
            return Xe.Model.prototype.set.apply(this, [n, e]), this
        },
        setUpdate(t, e) {
            const n = Ve.extend({}, this.defaults, this.attributes, t);
            return Xe.Model.prototype.set.apply(this, [n, e]), this
        }
    }),
    DC = Pn.extend({
    ...
    PC = mt.View.extend({
        ...
        initialize(t) {
            this.cameraView = this.cameraView || new MC(t), this.listenTo(this.model, "change", this.update, this), this.update()
        },
        update() {
    ...
    NC = '<a class="change-color button-color btn"></a>',
    VC = mt.View.extend({
        tagName: "div",
    ...
    $C = `<ul class="nav nav-colors">\r
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp4/overdrawn/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
`,
    jC = mt.View.extend({
        ...
        initialize() {
            this.colorPaletteComponent = this.colorPaletteComponent || new BC({
                collection: new Xe.Collection
...
class FC {
    constructor(e, n = {}) {
        ...
        this.canvasSelector = e, this.canvas = Ne(this.canvasSelector)[0], this.ctx = this.canvas.getContext("2d"), this.options = Object.assign(mc, n), this.history = [], this.layerNames.forEach(i => {
            const a = new lh(this.canvas.width, this.canvas.height, this.options.sketchOptions);
            a.name = i, this[i] = a
        })
    }
    update() {
    ...
    setOptions(e) {
        const n = Object.assign(mc.sketchOptions, e);
...
const zC = `<canvas id="fullLayer" class="sketchpad fullLayer" width='480' height='600' style=''></canvas>`,
    so = mt.View.extend({
        ...
        onAttach() {
            ...
            this.$("#fullLayer").addClass(t), this.sketchpad = new FC(`#fullLayer.${t}`), this.model.get("thicknesses") ? this.model.get("thicknesses").length === 1 && this.sketchpad.setThickness(this.model.get("thicknesses")[0]) : this.sketchpad.setThickness(1), this.triggerMethod("sketchpad:ready")
        },
        getCoords(t) {
            let e = t;
    ...
    GC = `<div class="controller-content">\r
...
`,
    ...
    Ws = mt.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new ji({}), this.toolbarComponent = this.toolbarComponent || new jC({
                model: new Xe.Model({})
            }), this.sketchpadComponent = this.sketchpadComponent || new so({
                model: new Xe.Model
            }), this.buttonsCollection = this.buttonsCollection || new Xe.Collection([]), this.buttonsComponent = this.buttonsComponent || new zn({
                block: !1,
...
`,
    ...
    Va = mt.View.extend({
        ...
        initialize() {
            this.currentEntry = null, this.shouldSubmit = !1, this.promptComponent = new ji({
                model: new Xe.Model({
                    text: "",
                    className: ""
                })
                ...
                text: "submit"
            }]), this.buttonsComponent = this.buttonsComponent || new zn({
                block: !0,
                collection: this.buttonsCollection
            }), this.listenTo(this.model, "change", this.update, this)
        },
        ...
        onChildviewInputText(t) {
            let e = t.getValue();
            e.length > this.model.get("maxLength") && (e = e.substr(0, this.model.get("maxLength")), t.setValue(e)), this.shouldSubmit = e.length > 0, this.model.get("live") && (this.throttledSend || (this.throttledSend = Ve.throttle(() => {
...
mt.View.extend({
    ...
    render() {
        this.model.set("username", rn.safeText(this.client.name), {
            silent: !0
    ...
    controllerUpdate() {
        ...
        !n && e.indexOf("_") !== -1 && (n = t.state.split("_")[1]), n === "PostGame" || e === "Credits" || e === "GameOver" || e === "PostGame" || e === "DayEnd" || t.gameResults ? ri.isInitialized ? ri.show() : ri.init(this.getOption("appTag")).then(() => {
            ri.show()
        }) : ri.hide(), t.platformId && Zt.setTag(`platform-${t.platformId}`)
    },
    async update() {
        return null
    },
    ...
    onResize() {
        const t = Ne("#player").outerHeight(!0) || 0,
            e = ri.isVisible ? Ne("#slide-in-banner").outerHeight(!0) : 0,
            n = Ne(window).width(),
...
const WC = `<div id="controller" class="state-controller controller-content">
    ...
    ui = mt.View.extend({
        ...
        strings: {},
        initialize() {
            this.titleComponent = new ji({
                model: new Xe.Model({})
            }), this.choicesListView = this.choicesListView || new zn, this.charactersListView = new mt.CollectionView({
                childView: YC,
        ...
        update() {
            if (this.strings = this.model.get("strings"), this.choicesListView.collection.reset(), this.titleComponent.model.set("html", this.getOption("strings").wait), this.model.get("playerIsVIP") && (this.model.get("gameCanStart") ? this.model.get("playerCanStartGame") && (this.model.get("gameIsStarting") ? (this.titleComponent.model.set("html", this.getOption("strings").vip_cancel), this.choicesListView.collection.add({
                ...
                if (this.model.get("activeContentId")) {
                    const n = this.model.get("activeContentId"),
                        ...
                        a = i && i.metadata ? rn.htmlUnescape(i.metadata.title) : null;
            ...
            this.charactersListView.collection.set(Ve.map(t, e => {
...
`,
    ...
    ZC = `<div id="controller" class="state-controller controller-content">
    ...
    Ni = mt.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new ji({
                model: new Xe.Model
            }), this.choicesList = this.choicesList || new zn({
                action: "choose",
                collection: new Xe.Collection
        ...
        update() {
            this.promptComponent.model.clear({
                silent: !0
            }).set(this.model.get("prompt")), this.choicesList.options.block = this.model.get("block"), this.choicesList.collection.set(this.model.get("choices")), this.model.get("type") === "multiple" && Ve.all(this.model.get("choices"), t => !t.disabled) && this.choicesList.collection.push({
                text: "Submit",
                action: "submit",
                block: !1
        ...
        onChildviewChildviewButtonCensor(t) {
            ...
            if (this.model.get("censorDialog") === "confirm") t.get("isWarned") ? this.triggerMethod("client:message", {
                ...
                if (this.model.get("censorDialog") === "warning") return en.close(), en.fire({
                    customClass: {
                        popup: "Dialog",
                        container: "container",
                        content: "content",
...
function Hn(t) {
    for (var e = 1; e < arguments.length; e++) {
        ...
        e % 2 ? vc(Object(n), !0).forEach(function(i) {
            tx(t, i, n[i])
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : vc(Object(n)).forEach(function(i) {
...
var ai = si(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
    gs = si(/Edge/i),
    yc = si(/firefox/i),
    as = si(/safari/i) && !si(/chrome/i) && !si(/android/i),
    uh = si(/iP(ad|od|hone)/i),
    hh = si(/chrome/i) && si(/android/i),
    dh = {
        capture: !1,
        passive: !1
    };
...
function Et(t, e, n) {
    t.addEventListener(e, n, !ai && dh)
}

function bt(t, e, n) {
    t.removeEventListener(e, n, !ai && dh)
}
...
function _n(t, e, n) {
    if (t && e)
        if (t.classList) t.classList[n ? "add" : "remove"](e);
            ...
            var i = (" " + t.className + " ").replace(wc, " ").replace(" " + e + " ", " ");
            t.className = (i + (n ? " " + e : "")).replace(wc, " ")
        }
}
...
function Yt(t, e, n, i, a) {
    if (!(!t.getBoundingClientRect && t !== window)) {
        var f, v, S, k, I, L, $;
        if (t !== window && t.parentNode && t !== Gn() ? (f = t.getBoundingClientRect(), v = f.top, S = f.left, k = f.bottom, I = f.right, L = f.height, $ = f.width) : (v = 0, S = 0, k = window.innerHeight, I = window.innerWidth, L = window.innerHeight, $ = window.innerWidth), (e || n) && t !== window && (a = a || t.parentNode, !ai))
            do
...
function br(t, e, n, i) {
    for (var a = 0, f = 0, v = t.children; f < v.length;) {
        if (v[f].style.display !== "none" && v[f] !== et.ghost && (i || v[f] !== et.dragged) && jn(v[f], n.draggable, t, !1)) {
            if (a === e) return v[f];
            a++
        }
        f++
        ...
        animateAll: function(i) {
            ...
            t.forEach(function(S) {
                var k = 0,
                    ...
                    Y = S.rect,
                    re = mr(I, !0);
                re && ($.top -= re.f, $.left -= re.e), I.toRect = $, I.thisAnimationDuration && ma(J, $) && !ma(L, $) && (Y.top - $.top) / (Y.left - $.left) === (L.top - $.top) / (L.left - $.left) && (k = hx(Y, J, ie, a.options)), ma($, L) || (I.prevFromRect = L, I.prevToRect = $, k || (k = a.options.animation), a.animate(I, Y, $, k)), k && (f = !0, v = Math.max(v, k), clearTimeout(I.animationResetTimer), I.animationResetTimer = setTimeout(function() {
        ...
        animate: function(i, a, f, v) {
            if (v) {
                ...
                var S = mr(this.el),
                    ...
                    L = (a.left - f.left) / (k || 1),
                    $ = (a.top - f.top) / (I || 1);
                i.animatingX = !!L, i.animatingY = !!$, it(i, "transform", "translate3d(" + L + "px," + $ + "px,0)"), this.forRepaintDummy = ux(i), it(i, "transition", "transform " + v + "ms" + (this.options.easing ? " " + this.options.easing : "")), it(i, "transform", "translate3d(0,0,0)"), typeof i.animated == "number" && clearTimeout(i.animated), i.animated = setTimeout(function() {
    ...
    ms = {
        ...
        pluginEvent: function(e, n, i) {
            ...
            or.forEach(function(v) {
                !n[v.pluginName] || (n[v.pluginName][f] && n[v.pluginName][f](Hn({
                    sortable: n
                }, i)), n.options[v.pluginName] && n[v.pluginName][e] && n[v.pluginName][e](Hn({
                    sortable: n
                }, i)))
            })
        },
...
function dx(t) {
    ...
    if (e = e || n && n[kn], !!e) {
        ...
        var q = Hn(Hn({}, Y), ms.getEventProperties(i, e));
...
var Re, $t, ut, Pt, Li, Ys, Vt, di, hr, Sn, cs, hi, Fs, tn, ur = !1,
    ao = !1,
    lo = [],
    Oi, Dn, ya, wa, xc, Ec, es, ar, us, hs = !1,
    zs = !1,
    Ks, cn, ba = [],
    $a = !1,
    co = [],
    ...
    Gs = uh,
    _c = gs || ai ? "cssFloat" : "float",
    px = Eo && !hh && !uh && "draggable" in document.createElement("div"),
    vh = function() {
        if (!!Eo) {
            if (ai) return !1;
    ...
    yh = function(e, n) {
        var i = it(e),
            ...
            L = k && parseInt(k.marginLeft) + parseInt(k.marginRight) + Yt(v).width;
        ...
        return f && (S.display === "block" || S.display === "flex" || S.display === "table" || S.display === "grid" || I >= a && i[_c] === "none" || v && i[_c] === "none" && I + L > a) ? "vertical" : "horizontal"
    },
    gx = function(e, n, i) {
    ...
    bh = function() {
        !vh && ut && it(ut, "display", "none")
    },
    Ch = function() {
        !vh && ut && it(ut, "display", "")
    };
Eo && !hh && document.addEventListener("click", function(t) {
...
et.prototype = {
    ...
    _onTapStart: function(e) {
        if (!!e.cancelable) {
            var n = this,
                ...
                L = a.filter;
            if (Sx(i), !Re && !(/mousedown|pointerdown/.test(v) && e.button !== 0 || a.disabled) && !I.isContentEditable && !(!this.nativeDraggable && as && k && k.tagName.toUpperCase() === "SELECT") && (k = jn(k, a.draggable, i, !1), !(k && k.animated) && Ys !== k)) {
                if (hr = Rn(k), cs = Rn(k, a.draggable), typeof L == "function") {
                ...
                a.handle && !jn(I, a.handle, i, !1) || this._prepareDragStart(e, S, k)
            }
        }
    },
    _prepareDragStart: function(e, n, i) {
        ...
        if (i && !Re && i.parentNode === f) {
            ...
            if (Pt = f, Re = i, $t = Re.parentNode, Li = Re.nextSibling, Ys = i, Fs = v.group, et.dragged = Re, Oi = {
                    ...
                    clientX: (n || e).clientX,
                    clientY: (n || e).clientY
                }, xc = Oi.clientX - I.left, Ec = Oi.clientY - I.top, this._lastX = (n || e).clientX, this._lastY = (n || e).clientY, Re.style["will-change"] = "all", k = function() {
                    if (bn("delayEnded", a, {
                            evt: e
                        }), et.eventCanceled) {
                        a._onDrop();
                    ...
                    a._disableDelayedDragEvents(), !yc && a.nativeDraggable && (Re.draggable = !0), a._triggerDragStart(e, n), mn({
                        sortable: a,
                        name: "choose",
                        originalEvent: e
                    ...
                    fh(Re, L.trim(), Ca)
                }), Et(S, "dragover", Ri), Et(S, "mousemove", Ri), Et(S, "touchmove", Ri), Et(S, "mouseup", a._onDrop), Et(S, "touchend", a._onDrop), Et(S, "touchcancel", a._onDrop), yc && this.nativeDraggable && (this.options.touchStartThreshold = 4, Re.draggable = !0), bn("delayStart", this, {
                    evt: e
    ...
    _dragStarted: function(e, n) {
        if (ur = !1, Pt && Re) {
            bn("dragStarted", this, {
                evt: n
            }), this.nativeDraggable && Et(document, "dragover", vx);
            var i = this.options;
    ...
    _emulateDragOver: function() {
        if (Dn) {
            this._lastX = Dn.clientX, this._lastY = Dn.clientY, bh();
    ...
    _onTouchMove: function(e) {
        if (Oi) {
            var n = this.options,
                ...
                k = ut && v && v.d,
                I = Gs && cn && Cc(cn),
                L = (f.clientX - Oi.clientX + a.x) / (S || 1) + (I ? I[0] - ba[0] : 0) / (S || 1),
                $ = (f.clientY - Oi.clientY + a.y) / (k || 1) + (I ? I[1] - ba[1] : 0) / (k || 1);
            if (!et.active && !ur) {
                if (i && Math.max(Math.abs(f.clientX - this._lastX), Math.abs(f.clientY - this._lastY)) < i) return;
                this._onDragStart(e, !0)
            }
            if (ut) {
                v ? (v.e += L - (ya || 0), v.f += $ - (wa || 0)) : v = {
                    a: 1,
                    b: 0,
                    c: 0,
                    d: 1,
                ...
                it(ut, "webkitTransform", J), it(ut, "mozTransform", J), it(ut, "msTransform", J), it(ut, "transform", J), ya = L, wa = $, Dn = f
            }
    ...
    _appendGhost: function() {
        if (!ut) {
            ...
            if (Gs) {
                ...
                cn !== document.body && cn !== document.documentElement ? (cn === document && (cn = Gn()), n.top += cn.scrollTop, n.left += cn.scrollLeft) : cn = Gn(), ba = Cc(cn)
            }
            ut = Re.cloneNode(!0), _n(ut, i.ghostClass, !1), _n(ut, i.fallbackClass, !0), _n(ut, i.dragClass, !0), it(ut, "transition", ""), it(ut, "transform", ""), it(ut, "box-sizing", "border-box"), it(ut, "margin", 0), it(ut, "top", n.top), it(ut, "left", n.left), it(ut, "width", n.width), it(ut, "height", n.height), it(ut, "opacity", "0.8"), it(ut, "position", Gs ? "absolute" : "fixed"), it(ut, "zIndex", "100000"), it(ut, "pointerEvents", "none"), et.ghost = ut, e.appendChild(ut), it(ut, "transform-origin", xc / parseInt(ut.style.width) * 100 + "% " + Ec / parseInt(ut.style.height) * 100 + "%")
        }
    },
    _onDragStart: function(e, n) {
        ...
        bn("setupClone", this), et.eventCanceled || (Vt = mh(Re), Vt.removeAttribute("id"), Vt.draggable = !1, Vt.style["will-change"] = "", this._hideClone(), _n(Vt, this.options.chosenClass, !1), et.clone = Vt), i.cloneId = Js(function() {
            bn("clone", i), !et.eventCanceled && (i.options.removeCloneOnHide || Pt.insertBefore(Vt, Re), i._hideClone(), mn({
                sortable: i,
                name: "clone"
            }))
        }), !n && _n(Re, f.dragClass, !0), n ? (ao = !0, i._loopId = setInterval(i._emulateDragOver, 50)) : (bt(document, "mouseup", i._onDrop), bt(document, "touchend", i._onDrop), bt(document, "touchcancel", i._onDrop), a && (a.effectAllowed = "move", f.setData && f.setData.call(i, a, Re)), Et(document, "drop", i), it(Re, "transform", "translateZ(0)")), ur = !0, i._dragStartId = Js(i._dragStarted.bind(i, n, e)), Et(document, "selectstart", i), es = !0, as && it(document.body, "user-select", "none")
    },
    _onDragOver: function(e) {
        ...
        function q(ye) {
            return m("dragOverCompleted", {
                insertion: ye
            }), ye && (L ? I._hideClone() : I._showClone(Y), Y !== J && (_n(Re, tn ? tn.options.ghostClass : I.options.ghostClass, !1), _n(Re, S.ghostClass, !0)), tn !== Y && Y !== et.active ? tn = Y : Y === et.active && tn && (tn = null), J === Y && (Y._ignoreWhileAnimating = i), Y.animateAll(function() {
                m("dragOverAnimationComplete"), Y._ignoreWhileAnimating = null
            }), Y !== J && (J.animateAll(), J._ignoreWhileAnimating = null)), (i === Re && !Re.animated || i === n && !i.animated) && (ar = null), !S.dragoverBubble && !e.rootEl && i !== document && (Re.parentNode[kn]._isOutsideThisEl(e.target), !ye && Ri(e)), !S.dragoverBubble && e.stopPropagation && e.stopPropagation(), re = !0
        }

        function ae() {
            Sn = Rn(Re), hi = Rn(Re, S.draggable), mn({
                sortable: Y,
                name: "change",
                toEl: n,
                newIndex: Sn,
        ...
        if (e.preventDefault !== void 0 && e.cancelable && e.preventDefault(), i = jn(i, S.draggable, n, !0), m("dragOver"), et.eventCanceled) return re;
        if (Re.contains(e.target) || i.animated && i.animatingX && i.animatingY || Y._ignoreWhileAnimating === i) return q(!1);
        if (ao = !1, I && !S.disabled && (L ? $ || (v = $t !== Pt) : tn === this || (this.lastPutMode = Fs.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            ...
            var se = ml(n, S.draggable);
            if (!se || Cx(e, ie, this) && !se.animated) {
                if (se === Re) return q(!1);
                ...
                var d = 0,
                    ...
                    De = !gx(Re.animated && Re.toRect || a, i.animated && i.toRect || f, ie),
                    lt = ie ? "top" : "left",
                    $e = bc(i, "top", "top") || bc(Re, "top", "top"),
                    K = $e ? $e.scrollTop : void 0;
                ar !== i && (Ee = f[lt], hs = !1, zs = !De && S.invertSwap || Ae), d = xx(e, i, f, ie, De ? 1 : S.swapThreshold, S.invertedSwapThreshold == null ? S.swapThreshold : S.invertedSwapThreshold, zs, ar === i);
                var ze;
                if (d !== 0) {
                    var H = Rn(Re);
                    do H -= d, ze = $t.children[H]; while (ze && (it(ze, "display") === "none" || ze === ut))
                }
                if (d === 0 || ze === i) return q(!1);
                ar = i, us = d;
                var oe = i.nextElementSibling,
                    Te = !1;
                Te = d === 1;
                var we = Hs(Pt, n, Re, a, i, f, e, Te);
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), $a = !0, setTimeout(wx, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), $e && gh($e, 0, K - $e.scrollTop), $t = Re.parentNode, Ee !== void 0 && !zs && (Ks = Math.abs(Ee - Yt(i)[lt])), ae(), q(!0)
            }
    ...
    _onDrop: function(e) {
        ...
        ur = !1, zs = !1, hs = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), ja(this.cloneId), ja(this._dragStartId), this.nativeDraggable && (bt(document, "drop", this), bt(n, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), as && it(document.body, "user-select", ""), it(Re, "transform", ""), e && (es && (e.cancelable && e.preventDefault(), !i.dropBubble && e.stopPropagation()), ut && ut.parentNode && ut.parentNode.removeChild(ut), (Pt === $t || tn && tn.lastPutMode !== "clone") && Vt && Vt.parentNode && Vt.parentNode.removeChild(Vt), Re && (this.nativeDraggable && bt(Re, "dragend", this), Ca(Re), Re.style["will-change"] = "", es && !ur && _n(Re, tn ? tn.options.ghostClass : this.options.ghostClass, !1), _n(Re, this.options.chosenClass, !1), mn({
            sortable: this,
            name: "unchoose",
            toEl: $t,
            newIndex: null,
            ...
            toEl: $t,
            originalEvent: e
        })), et.active && ((Sn == null || Sn === -1) && (Sn = hr, hi = cs), mn({
            sortable: this,
            name: "end",
            toEl: $t,
            originalEvent: e
    ...
    _nulling: function() {
        bn("nulling", this), Pt = Re = $t = ut = Li = Vt = Ys = di = Oi = Dn = es = Sn = hi = hr = cs = ar = us = tn = Fs = et.dragged = et.ghost = et.clone = et.active = null, co.forEach(function(e) {
            e.checked = !0
        }), co.length = ya = wa = 0
    },
    ...
    toArray: function() {
        for (var e = [], n, i = this.el.children, a = 0, f = i.length, v = this.options; a < f; a++) n = i[a], jn(n, v.draggable, this.el, !1) && e.push(n.getAttribute(v.dataIdAttr) || _x(n));
        return e
    },
    sort: function(e, n) {
        var i = {},
        ...
        this.toArray().forEach(function(f, v) {
            var S = a.children[v];
            jn(S, this.options.draggable, a, !1) && (i[f] = S)
    ...
    option: function(e, n) {
        ...
        typeof a < "u" ? i[e] = a : i[e] = n, e === "group" && wh(i)
    },
    destroy: function() {
        bn("destroy", this);
        var e = this.el;
    ...
    _hideClone: function() {
        if (!di) {
            ...
            it(Vt, "display", "none"), this.options.removeCloneOnHide && Vt.parentNode && Vt.parentNode.removeChild(Vt), di = !0
        }
    },
    _showClone: function(e) {
        ...
        if (di) {
            ...
            Re.parentNode == Pt && !this.options.group.revertClone ? Pt.insertBefore(Vt, Re) : Li ? Pt.insertBefore(Vt, Li) : Pt.appendChild(Vt), this.options.group.revertClone && this.animate(Re, Vt), it(Vt, "display", ""), di = !1
        }
    }
};
...
function Hs(t, e, n, i, a, f, v, S) {
    ...
    return window.CustomEvent && !ai && !gs ? k = new CustomEvent("move", {
        bubbles: !0,
        cancelable: !0
    }) : (k = document.createEvent("Event"), k.initEvent("move", !0, !0)), k.to = e, k.from = t, k.dragged = n, k.draggedRect = i, k.related = a || e, k.relatedRect = f || Yt(e), k.willInsertAfter = S, k.originalEvent = v, t.dispatchEvent(k), L && ($ = L.call(I, k, v)), $
}
...
function xx(t, e, n, i, a, f, v, S) {
    ...
    if (!v) {
        if (S && Ks < I * a) {
            if (!hs && (us === 1 ? k > L + I * f / 2 : k < $ - I * f / 2) && (hs = !0), hs) J = !0;
            else if (us === 1 ? k < L + Ks : k > $ - Ks) return -us
        } else if (k > L + I * (1 - a) / 2 && k < $ - I * (1 - a) / 2) return Ex(e)
    }
...
et.mount = function() {
    ...
    e[0].constructor === Array && (e = e[0]), e.forEach(function(i) {
        ...
        i.utils && (et.utils = Hn(Hn({}, et.utils), i.utils)), ms.mount(i)
    })
};
...
function kx() {
    ...
    return t.prototype = {
        ...
        drop: function() {
            this.sortable.nativeDraggable ? bt(document, "dragover", this._handleAutoScroll) : (bt(document, "pointermove", this._handleFallbackAutoScroll), bt(document, "touchmove", this._handleFallbackAutoScroll), bt(document, "mousemove", this._handleFallbackAutoScroll)), Sc(), Qs(), lx()
        },
        nulling: function() {
            uo = Fa = ts = za = ns = xa = Ea = null, qt.length = 0
        },
        ...
        _handleAutoScroll: function(n, i) {
            ...
            if (uo = n, i || this.options.forceAutoScrollFallback || gs || ai || as) {
                _a(n, this.options, S, i);
                var k = pi(S, !0);
                za && (!ns || f !== xa || v !== Ea) && (ns && Sc(), ns = setInterval(function() {
                    var I = pi(document.elementFromPoint(f, v), !0);
                    I !== k && (k = I, Qs()), _a(n, a.options, I, i)
                }, 10), xa = f, Ea = v)
            } else {
                if (!this.options.bubbleScroll || pi(S, !0) === Gn()) {
                    Qs();
                    return
                }
                _a(n, this.options, pi(S, !1), !1)
            }
        }
    }, oi(t, {
        pluginName: "scroll",
...
var _a = ph(function(t, e, n, i) {
        if (!!e.scroll) {
            var a = (t.touches ? t.touches[0] : t).clientX,
                ...
                I = !1,
                L;
            Fa !== n && (Fa = n, Qs(), ts = e.scroll, L = e.scrollFn, ts === !0 && (ts = pi(n, !0)));
            var $ = 0,
                J = ts;
            do {
                var ie = J,
                ...
                var K = ve && (Math.abs(q - a) <= v && lt + ae < Ee) - (Math.abs(P - a) <= v && !!lt),
                    ze = d && (Math.abs(m - f) <= v && $e + se < Ae) - (Math.abs(re - f) <= v && !!$e);
                if (!qt[$])
                    for (var H = 0; H <= $; H++) qt[H] || (qt[H] = {});
                (qt[$].vx != K || qt[$].vy != ze || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = ze, clearInterval(qt[$].pid), (K != 0 || ze != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    ...
                    typeof L == "function" && L.call(et.dragged.parentNode[kn], Te, oe, t, uo, qt[this.layer].el) !== "continue" || gh(qt[this.layer].el, Te, oe)
                }.bind({
                    layer: $
                }), 24))), $++
            } while (e.bubbleScroll && J !== k && (J = pi(J, !1)));
            za = I
        }
    }, 30),
    xh = function(e) {
...
et.mount(new kx);
et.mount(yl, vl);
const Tx = `<div id="controller" class="state-controller controller-content">\r
    ...
    `),
        ...
        initialize() {
            this.rankedCollectionView = this.rankedCollectionView || new kc({
                collection: new Xe.Collection([])
            }), this.unrankedCollectionView = this.unrankedCollectionView || new kc({
                className: "sortable-collection unranked",
                collection: new Xe.Collection([])
            }), this.lockInView = this.lockInView || new rh({
                block: !1,
                model: new Xe.Model({
                    action: "lock",
                    html: "Lock In"
    ...
    Ix = mt.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new ji({
                model: new Xe.Model
            }), this.sorterView = this.sorterView || new Rx({}), this.listenTo(this.model, "change", this.update, this)
        },
        onAttach() {
    ...
    Lx = `<div id="controller" class="state-controller controller-content">
    ...
    Dx = mt.View.extend({
        ...
        initialize(t) {
            this.client = t.client, this.promptComponent = this.promptComponent || new ji({
                model: new Xe.Model
            }), this.episodesList = this.episodesList || new zn({
                action: "load",
                collection: new Xe.Collection
            }), this.inputComponent = this.inputComponent || new ro({
                model: new Xe.Model({
            ...
            }), this.promptsList = this.promptsList || new zn({
                action: "remove",
                collection: new Xe.Collection
            }), this.selected = [], this.listenTo(this.model, "change", this.update, this)
        },
        ...
        update() {
            ...
            const e = this.model.get("episodes").map(n => {
                const i = rn.htmlUnescape(n.metadata.title);
                let a = rn.safeText(i);
    ...
    Px = `<svg id="range-picker" class="range-picker" viewBox="-40 -40 80 80">
    <defs>
    ...
    Nx = mt.View.extend({
        ...
        getNormalizedVector() {
            const t = Ve.extend({}, this.model.get("vector"));
...
<div id="control-panel" class="control-panel">\r
    ...
    $x = mt.View.extend({
        ...
        initialize(t) {
            this.client = t.client, this.radialComponent = new Nx({
                model: new Xe.Model({
                    isTouching: !1,
                    angle: 0,
                    vector: {
            ...
            }), this.throttledUpdate = Ve.throttle(this.updateVector, this.model.get("throttle")), this.listenTo(this.model, "change", this.update, this), this.onResizeWithContext = this.onResize.bind(this), window.addEventListener("resize", this.onResizeWithContext), Ne(window).on("mousemove", this.move.bind(this)), Ne(window).on("mouseup", this.end.bind(this))
        },
        onBeforeDestroy() {
    ...
    jx = `<div id="textDescriptions" class="textDescriptions" role="log" aria-atomic="false" aria-relevant="additions" aria-live="polite"></div>
...
`;
const Tc = mt.View.extend({
    client: null,
    template: Ve.template(jx),
    playerTopBar: null,
    className() {
    ...
    updateLayout() {
        ...
        switch (e) {
            ...
            case "Lobby":
                return this.setLayout(ui);
            case "Logo":
                return this.setLayout(Ba);
            case "MakeSingleChoice":
                return this.setLayout(Ni);
            case "Shoot":
...
class zx extends Fx {
    ...
    onText(n) {
        ...
        const v = f;
        i === "room" ? this.emit("client:entityDidChange", i, v) : i === `player:${this.id}` ? this.emit("client:entityDidChange", "player", v) : i === "bc:room" ? this.emit("client:entityDidChange", "room", v) : i === "audiencePlayer" ? this.emit("client:entityDidChange", "audiencePlayer", v) : i === `bc:customer:${this.userId}` ? this.emit("client:entityDidChange", "player", v) : hc(`[Ecast Client] Unhandled json notification: ${i}`)
    }
    onObject(n) {
        const i = n.key,
            a = n.val;
            ...
            return S = t.extend({
                ...
                function d(ye) {
                    ...
                    for (ue = ye, _e = q(ye); Y > ue; ue++)
                        if (L[ue]) {
                            if (ke = ae(ue), je = oe[ue], oe[ue] = _e, !(Y > ke && L[ke].test(je))) break;
                            _e = je
                        }
                }
                ...
                function Ee() {
                    ...
                    if (re && re.length && re.length > ye.length) {
                        for (ze(!0); ue.begin > 0 && !L[ue.begin - 1];) ue.begin--;
                        if (ue.begin === 0)
                            for (; ue.begin < J && !L[ue.begin];) ue.begin++;
                        H.caret(ue.begin, ue.begin)
                    } else {
                        for (ze(!0); ue.begin < Y && !L[ue.begin];) ue.begin++;
                        H.caret(ue.begin, ue.begin)
                    }
                    P()
                }
                ...
                function Ae() {
                    ze(), H.val() != we && H.change()
                }

                function De(ye) {
                    if (!H.prop("readonly")) {
                        var ue, _e, ke, je = ye.which || ye.keyCode;
                        re = H.val(), je === 8 || je === 46 || i && je === 127 ? (ue = H.caret(), _e = ue.begin, ke = ue.end, ke - _e === 0 && (_e = je !== 46 ? se(_e) : ke = ae(_e - 1), ke = je === 46 ? ae(ke) : ke), $e(_e, ke), ve(_e, ke - 1), ye.preventDefault()) : je === 13 ? Ae.call(this, ye) : je === 27 && (H.val(we), H.caret(0, ze()), ye.preventDefault())
                    }
                }
                ...
                function lt(ye) {
                    if (!H.prop("readonly")) {
                        ...
                        if (!(ye.ctrlKey || ye.altKey || ye.metaKey || 32 > je) && je && je !== 13) {
                            if (Qe.end - Qe.begin !== 0 && ($e(Qe.begin, Qe.end), ve(Qe.begin, Qe.end - 1)), ue = ae(Qe.begin - 1), Y > ue && (_e = String.fromCharCode(je), L[ue].test(_e))) {
                    ...
                    for (ue = 0, ke = 0; Y > ue; ue++)
                        if (L[ue]) {
                            for (oe[ue] = q(ue); ke++ < je.length;)
                                if (_e = je.charAt(ke - 1), L[ue].test(_e)) {
                                    oe[ue] = _e, Qe = ue;
                                    break
                                } if (ke > je.length) {
                                $e(ue + 1, Y);
                        ...
                        } else oe[ue] === je.charAt(ke) && ke++, $ > ue && (Qe = ue);
                ...
                H.data(t.mask.dataName, function() {
                    ...
                    if (!H.prop("readonly")) {
                        clearTimeout(e);
                        var ye;
                        we = H.val(), ye = ze(), e = setTimeout(function() {
                ...
                }), a && f && H.off("input.mask").on("input.mask", Ee), ze()
            })
        }
    })
});
...
<div id="vipWarning" class="text">You must draw your name and click submit to proceed.</div>`,
    ...
    Xx = mt.View.extend({
        ...
        bindings: {
            ":el": {
                attributes: [{
                    ...
                    observe: "playerInfo",
                    onGet(t) {
                        return !t || !t.color || !t.color.veryLight ? null : `background-color:${t.color.veryLight.hexString}`
                    }
                }]
            },
            ".nametag": {
                attributes: [{
                    ...
                    observe: "playerInfo",
                    onGet(t) {
                        return !t || !t.color || !t.color.dark ? null : `background-color:${t.color.dark.hexString}`
                    }
                }]
            },
            "#vipWarning": {
        ...
        initialize() {
            this.sketchpadComponent = new so({
                model: new Xe.Model({
                    live: !0,
                    thicknesses: [1],
                    size: {
        ...
        onLine(t) {
            if (this.model.get("live")) {
                const e = this.sketchpadComponent.getThumbnailImage();
                this.triggerMethod("client:message", {
                    action: "line2",
                    line: t,
                    thumbnail: e
    ...
    Yx = `<div class="text">Free-for-all drawing mode</div>
<div id="canvasContainer" class="canvasContainer">
    <canvas id="fullLayer" class="sketchpad fullLayer" width='480' height='600' style=''> 
    </canvas>
</div>
<ul id="pre-sketchpad" class="nav nav-colors pre-sketchpad">
    <li class="pull-right button-pad">
        <button id="resetall" class="button">Reset All</button>
    </li>
...
`,
    Jx = "jackbox/main/pp4/overdrawn/assets/adbdaad0.png",
    Qx = Pn.extend({
        defaults: Ve.extend({}, ui.prototype.model.defaults, {
            resetAll: !1,
            sketchpad: null
        })
    }),
    Zx = ui.extend({
        model: new Qx({}),
        template: Ve.template(Kx),
        bindings: Ve.extend({}, ui.prototype.bindings, {
            ":el": {
                attributes: [{
                    name: "style",
                    observe: "playerInfo",
                    onGet(t) {
                        return !t || !t || !t.color || !t.color.veryLight ? null : `background-color:${t.color.veryLight.hexString}`
                    }
                }]
            },
            ".charactersContainer": {
        ...
        events: Ve.extend({}, ui.prototype.events, {
            "click #resetall": "onResetAll"
        }),
        initialize(t) {
            this.sketchpadComponent = new so({
                images: {
                    "images/overdrawn/thankyou.png": Jx
                },
                template: Ve.template(Yx),
                model: new Xe.Model({}),
                bindings: Ve.extend(so.prototype.bindings, {
                    "#resetall": {
                        observe: "canCensor",
                        visible: !0
                    }
                })
            }), this.sketchpadComponent.setThickness(1), this.listenTo(this.sketchpadComponent, "sketchpad:line", this.onLine), ui.prototype.initialize.apply(this, [t])
        },
        update() {
            if (ui.prototype.update.apply(this), this.sketchpadComponent.model.set("canCensor", this.model.get("canCensor")), this.model.get("resetAll") && this.sketchpadComponent) {
                const t = this.model.get("sketchpad");
                this.sketchpadComponent.resetAll(), this.sketchpadComponent.setImage(t.image), this.model.setUpdate({
                    resetAll: !1
                })
            }
        },
        onChildviewSketchpadReady() {
            if (this.model.get("isPlayer") && this.model.get("sketchpad")) {
                const t = this.model.get("sketchpad");
                this.sketchpadComponent.setImage(t.image), this.sketchpadComponent.setColor(this.model.get("playerInfo").color.dark.hexString), this.sketchpadComponent.model.set("size", this.model.get("sketchpad").size)
            }
        },
        onRender() {
            ui.prototype.onRender.apply(this);
            const t = this.getRegion("characters");
            this.model.get("isPlayer") && t.show(this.sketchpadComponent)
        },
        onLine(t) {
    ...
    e1 = Ba.extend({
        bindings: Ve.extend({}, Ba.prototype.bindings, {
            ":el": {
                attributes: [{
                    name: "style",
                    observe: "playerInfo",
                    onGet(t) {
                        return !t || !t.color || !t.color.veryLight ? "" : `background-color:${t.color.veryLight.hexString}`
                    }
                }]
            }
        }),
    ...
    t1 = `<div id="prompt" class="prompt">prompt</div>
...
`,
    ...
    r1 = mt.View.extend({
        template: Ve.template("<button class='button choice-button btn btn-lg'></div>"),
        tagName: "div",
        className: "Murals",
        events: {
            click: "onClick"
    ...
    wl = mt.View.extend({
        ...
        update() {
            let t = this.model.get("choices");
            t && t.length > 0 && (t = Ve.map(t, (e, n) => (e.choice = n, e.class = `mural-${n1[t.length][n]} mural-${i1[t.length]}`, e))), this.choicesList.collection.set(t)
        }
    }),
    ...
    s1 = Ws.extend({
        events: Ve.extend({}, Ws.prototype.events, {
            "click #censorOptions": "showCensorOptions"
        }),
        bindings: Ve.extend({}, Ws.prototype.bindings, {
            ":el": {
                attributes: [{
                    name: "style",
                    observe: "playerInfo",
            ...
            "#playername": {
                ...
                updateMethod: "html",
                onGet(t) {
                    const e = Ve.template(bl);
                    let n = "audience";
                    const i = t && t.color && t.color.dark ? t.color.dark.hexString : "";
                    return t && t.thumbnail ? n = `<img src='${t.thumbnail}' class='playerThumbnail'/>` : t && t.username && (n = t.username.toLowerCase()), e({
                        playerName: n,
                        color: i
                    })
                }
        ...
        showCensorOptions() {
            ...
            en.fire({
                html: "player",
                padding: 0,
                background: t.model.get("playerInfo").color.dark.hexString,
                ...
                buttonsStyling: !1,
                didOpen: () => {
                    this.censorView = new wl({
                        el: ".overdrawn.censorOptions",
                        model: new Xe.Model({
                            text: "Choose someone to censor",
                            choices: t.model.get("censorChoices")
                        }),
                        onChildviewChildviewDrawingCensor(e) {
    ...
    o1 = `<div id="controller" class="state-controller controller-content">
    <div id="prompt" class="prompt col-xs-12">prompt</div>
    <div id="chosen" class="chosen col-xs-12">asdf</div>
    <div class="error text-danger"></div>
    <div class="col-xs-6">
    ...
    Ac = mt.CollectionView.extend({
        className: "reactionCollection",
        childView: a1
    }),
    l1 = Ni.extend({
        template: Ve.template(o1),
        events: {
        ...
        bindings: Ve.extend({}, Ni.prototype.bindings, {
            ":el": {
                attributes: [{
                    name: "style",
                    observe: "playerInfo",
            ...
            "#playername": {
                ...
                onGet(t) {
                    ...
                    let n = "audience";
                    const i = t && t.color && t.color.dark ? t.color.dark.hexString : "";
                    return t && t.thumbnail ? n = `<img src='${t.thumbnail}' class='playerThumbnail'/>` : t && t.playerName && (n = t.playerName.toLowerCase()), e({
                        playerName: n,
                        color: i
                    })
                }
            ...
            "#next-up-span": {
                attributes: [{
                    ...
                    observe: "playerInfo",
                    onGet(t) {
                        return !t || !t.color ? "" : `background-color:${t.color.dark.hexString};border:5px solid ${t.color.dark.hexString};`
                    }
                }]
            },
            "#censorOptions": {
        ...
        initialize(t) {
            this.leftChoices = new Ac({
                collection: new Xe.Collection
            }), this.rightChoices = new Ac({
                collection: new Xe.Collection
            }), Ni.prototype.initialize.apply(this, [t]), this.listenTo(this.leftChoices, "childview:reaction:click", this.sendReaction), this.listenTo(this.rightChoices, "childview:reaction:click", this.sendReaction), this.delayReaction = !1
        },
        onRender() {
            const t = this.getRegion("prompt"),
                e = this.getRegion("leftChoices"),
                n = this.getRegion("rightChoices");
            t.show(this.promptComponent), e.show(this.leftChoices), n.show(this.rightChoices), this.stickit()
        },
        update() {
            ...
            t && t.length > 0 && (t = Ve.map(t, n => (typeof n == "string" && (n = {
                text: n
            }), n.censorable = this.blob.canCensor, n.action = n.action || "choose", n.mural = n.mural || "0", n.block = !0, n)));
            const e = Ve.groupBy(t, "mural");
            this.leftChoices.collection.set(e[0]), this.rightChoices.collection.set(e[1])
        },
        sendReaction(t) {
            if (this.model.get("isPlayer")) this.delayReaction || (this.triggerMethod("client:message", {
                ...
                if (t.get("mural") > 0) {
                    ...
                    e += " Right", this.rightChoices.$el.addClass("clicked"), t.set("clicked", "true")
                } else {
                    if (this.leftChoices.$el.hasClass("clicked")) return;
                    this.leftChoices.$el.addClass("clicked"), t.set("clicked", "true")
                }
                this.sessionName = e, this.triggerMethod("client:countGroup", {
                    name: this.model.get("countGroupName"),
                    vote: t.get("index")
                })
            }
    ...
    c1 = `<div id="controller" class="state-controller controller-content">
    <div id="prompt" class="prompt col-xs-12">prompt</div>
    <div id="chosen" class="chosen col-xs-12"></div>
    <div class="error text-danger"></div>
...
`,
    ...
    d1 = Ni.extend({
        ...
        initialize(t) {
            Ni.prototype.initialize.apply(this, [t]), this.choicesList = new zn({
        ...
        update() {
            ...
            const t = this.promptComponent.model.get("text") && this.promptComponent.model.get("text").indexOf("addition") !== -1;
            let e = this.blob.choices;
            e && e.length > 0 && (e = Ve.map(e, (n, i) => (typeof n == "string" && (n = {
                text: n
            }), n.censorable = this.blob.canCensor && !t, n.action = n.action || "choose", t && (n.className = `Murals mural-${u1[e.length][i]} mural-${h1[e.length]}`), n.block = !t, n))), this.blob.chosen !== null ? this.choicesList.collection.reset() : this.choicesList.collection.set(e)
        },
        buttonClick(t) {
            const e = Ne(t.currentTarget),
                n = e.data("index");
            let i = e.data("action");
    ...
    f1 = Va.extend({
        bindings: Ve.extend({}, Va.prototype.bindings, {
            ":el": {
                attributes: [{
                    name: "style",
                    observe: "playerInfo",
    ...
    p1 = `<div id="player" class="playerTopBar">
    <div id="playericon" class="playerIcon"></div>
            ...
            bindings: {
                ":el": {
                    ...
                    attributes: [{
                        ...
                        observe: "color",
                        onGet(n) {
                            return !n || !n.veryLight ? "" : `background-color:${n.veryLight.hexString}`
                        }
                    }]
                },
                ".nametag": {
                    attributes: [{
                        ...
                        observe: "color",
                        onGet(n) {
                            return n && n.dark && n.dark.hexString ? `background-color:${n.dark.hexString}` : ""
                        }
                    }]
                },
                ".nametagBody": {
                    ...
                    updateMethod: "html",
                    onGet(n) {
                        return n[1] ? `<img src='${n[1]}' class='playerThumbnail'/>` : n[0]
                    }
                }
            }
        });
        this.playerTopBar = new e, Tc.prototype.initialize.apply(this, [t])
    },
    parseBlob(t) {
...
//# sourceMappingURL=9bdac96a.js.map