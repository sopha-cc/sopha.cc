        ...
        var Ae = function(r) {
            ...
            u = St.support = {}, x = St.isXML = function(R) {
                ...
                pseudos: {
                    ...
                    lang: dn(function(R) {
                        return Fo.test(R || "") || St.error("unsupported lang: " + R), R = R.replace(An, En).toLowerCase(),
                            function(F) {
                                var X;
                                do
                ...
                var X = F.length > 0,
                    ...
                    ee = function(me, xe, Oe, Me, ze) {
                        ...
                        if (Tt += We, X && We !== Tt) {
                            ...
                            xn.apply(Me, Jt), ze && !me && Jt.length > 0 && Tt + F.length > 1 && St.uniqueSort(Me)
                        }
            ...
            return z = St.compile = function(R, F) {
                ...
                if (X = X || [], Ue.length === 1) {
                    ...
                    for (ee = Xi.needsContext.test(R) ? 0 : me.length; ee-- && (xe = me[ee], !p.relative[Oe = xe.type]);)
                        if ((Me = p.find[Oe]) && (de = Me(xe.matches[0].replace(An, En), Hr.test(me[0].type) && Gr(F.parentNode) || F))) {
...
function gd(t) {
    return t == null ? t === void 0 ? pd : fd : yl && yl in Object(t) ? hd(t) : dd(t)
}
var uo = gd;
...
function ov(t, e, n, i, a, f, v) {
    ...
    if ($) {
        var J = Rl(k),
            ie = !J && ev(k),
            Y = !J && !ie && rv(k);
        D = k, J || ie || Y ? Rl(S) ? D = S : Zm(S) ? D = Jm(S) : ie ? ($ = !1, D = Ym(k, !0)) : Y ? ($ = !1, D = Km(k, !0)) : D = [] : iv(k) || Ol(k) ? (D = S, Ol(S) ? D = sv(S) : (!nv(S) || tv(S)) && (D = Qm(k))) : $ = !1
    }
    $ && (v.set(k, D), a(D, k, i, f, v), v.delete(k)), Al(t, n, D)
}
var av = ov,
    lv = dp,
    cv = Sc,
...
function bv(t, e, n) {
    return e = Dl(e === void 0 ? t.length - 1 : e, 0),
        function() {
            for (var i = arguments, a = -1, f = Dl(i.length - e, 0), v = Array(f); ++a < f;) v[a] = i[e + a];
            a = -1;
...
var ta = function() {
    ...
    Nl = hs.call(Function.call, String.prototype.replace),
    ...
    by = function(e) {
        ...
        var a = [];
        return Nl(e, yy, function(f, v, S, k) {
            a[a.length] = S ? Nl(k, wy, "$1") : v || f
        }), a
    },
    Cy = function(e, n) {
        var i = e,
            a;
        if (Js(Pl, i) && (a = Pl[i], i = "%" + a[0] + "%"), Js(hr, i)) {
            var f = hr[i];
...
var Ua = typeof Map == "function" && Map.prototype,
    ...
    Vl = Iy ? WeakRef.prototype.deref : null,
...
var ka = ky,
    ...
    By = function t(e, n, i, a) {
        ...
        if (Zy(e)) {
            for (var m = "<" + Bl.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + Gc($y(P[q].value), "double", f);
            return m += ">", e.childNodes && e.childNodes.length && (m += "..."), m += "</" + Bl.call(String(e.nodeName)) + ">", m
        }
        if (Ta(e)) {
        ...
        if (Fy(e)) {
            var se = Ls(e, J);
            return !("cause" in Error.prototype) && "cause" in e && !Uc.call(e, "cause") ? "{ [" + String(e) + "] " + jn.call($l.call("[cause]: " + J(e.cause), se), ", ") + " }" : se.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + jn.call(se, ", ") + " }"
        }
        ...
        if (!jy(e) && !Gl(e)) {
            var Ee = Ls(e, J),
                Ae = Fl ? Fl(e) === Object.prototype : e instanceof Object || e.constructor === Object,
                Le = e instanceof Object ? "" : "null prototype",
                lt = !Ae && cn && Object(e) === e && cn in e ? qa.call(pi(e), 8, -1) : Le ? "Object" : "",
                Be = Ae || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "",
                K = Be + (lt || Le ? "[" + jn.call($l.call([], lt || [], Le || []), ": ") + "] " : "");
...
function Xc(t, e) {
    if (t.length > e.maxStringLength) {
        ...
        return Xc(qa.call(t, 0, e.maxStringLength), e) + i
    }
...
var Wa = Ha,
    ...
    Mw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        ...
        for (var Fe = a && ei(P) && P.length === 1 ? n + "[]" : n, U = 0; U < Be.length; ++U) {
            ...
            if (!(v && Te === null)) {
                ...
                m.set(e, ae);
                var ye = Jc();
                ye.set(la, m), Qc(lt, t(Te, we, i, a, f, v, S, k, I, D, $, J, ie, Y, re, ye))
            }
        }
        return lt
    },
    ...
    Pw = function(t, e) {
        ...
        for (var D = Jc(), $ = 0; $ < a.length; ++$) {
            var J = a[$];
            i.skipNulls && n[J] === null || Qc(v, Mw(n[J], J, k, I, i.strictNullHandling, i.skipNulls, i.encode ? i.encoder : null, i.filter, i.sort, i.allowDots, i.serializeDate, i.format, i.formatter, i.encodeValuesOnly, i.charset, D))
        }
...
Rt.prototype.emit = function(e) {
    ...
    if (typeof k == "function") Kl(k, this, n);
        ...
        for (var I = k.length, D = au(k, I), i = 0; i < I; ++i) Kl(D[i], this, n);
    return !0
};
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/pp4-bracketeering/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
...
const uC = `<form>\r
    ...
    to = Et.View.extend({
        ...
        onAttach() {
            this.getOption("preventAutosize") || sc(Pe("textarea"))
        },
        onSubmitClick() {
        ...
        clearInput() {
            ...
            Pe(t).val(""), this.getOption("preventAutosize") || sc.update(t), this.onInputChange()
        },
        setValue(t) {
...
`).join("<br />")), vi(c)
        ...
        const Hr = c => {
                An(c), delete c.params, delete it.keydownHandler, delete it.keydownTarget, delete it.currentInstance
            },
            An = c => {
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp4/bracketeering/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    CC = Et.View.extend({
        ...
        onAttach() {
            ...
            this.cameraSprite = ul(bC), this.cameraSprite.width = this.model.get("width"), this.cameraSprite.height = this.model.get("height"), this.cameraSprite.mask = this.model.get("mask"), t.sprites.push(this.cameraSprite), t.gameLoop.start(), this.facingMode = "user", this.startCamera(), this.onResize()
        },
        async startCamera() {
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp4/bracketeering/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
class OC {
    constructor(e, n = {}) {
        ...
        this.canvasSelector = e, this.canvas = Pe(this.canvasSelector)[0], this.ctx = this.canvas.getContext("2d"), this.options = Object.assign(lc, n), this.history = [], this.layerNames.forEach(i => {
...
var Re, $t, ut, Pt, Ii, qs, Vt, ui, cr, Sn, as, ci, $s, en, lr = !1,
    io = !1,
    ro = [],
...
function Qe(t, e) {
    ...
    this.el = t, this.options = e = ri({}, e), t[kn] = this;
    var n = {
        group: null,
        sort: !0,
        disabled: !1,
...
Qe.prototype = {
    ...
    _prepareDragStart: function(e, n, i) {
        ...
        if (i && !Re && i.parentNode === f) {
            ...
            if (Pt = f, Re = i, $t = Re.parentNode, Ii = Re.nextSibling, qs = i, $s = v.group, Qe.dragged = Re, Ai = {
                    ...
                    clientX: (n || e).clientX,
                    clientY: (n || e).clientY
                }, pc = Ai.clientX - I.left, gc = Ai.clientY - I.top, this._lastX = (n || e).clientX, this._lastY = (n || e).clientY, Re.style["will-change"] = "all", k = function() {
                    if (wn("delayEnded", a, {
                            evt: e
                        }), Qe.eventCanceled) {
                        a._onDrop();
                    ...
                    a._disableDelayedDragEvents(), !uc && a.nativeDraggable && (Re.draggable = !0), a._triggerDragStart(e, n), gn({
                        sortable: a,
                        name: "choose",
                        originalEvent: e
                    ...
                    th(Re, D.trim(), ma)
                }), xt(S, "dragover", Oi), xt(S, "mousemove", Oi), xt(S, "touchmove", Oi), xt(S, "mouseup", a._onDrop), xt(S, "touchend", a._onDrop), xt(S, "touchcancel", a._onDrop), uc && this.nativeDraggable && (this.options.touchStartThreshold = 4, Re.draggable = !0), wn("delayStart", this, {
                    evt: e
    ...
    _onDragOver: function(e) {
        ...
        function ae() {
            Sn = Rn(Re), ci = Rn(Re, S.draggable), gn({
                sortable: Y,
                name: "change",
                toEl: n,
                newIndex: Sn,
        ...
        if (io = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : en === this || (this.lastPutMode = $s.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            ...
            if (!se || gx(e, ie, this) && !se.animated) {
                ...
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Ma = !0, setTimeout(fx, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), Be && ih(Be, 0, K - Be.scrollTop), $t = Re.parentNode, Ee !== void 0 && !js && (Ws = Math.abs(Ee - Yt(i)[lt])), ae(), q(!0)
            }
    ...
    _onDrop: function(e) {
        var n = this.el,
            i = this.options;
        if (Sn = Rn(Re), ci = Rn(Re, i.draggable), wn("drop", this, {
                evt: e
            }), $t = Re && Re.parentNode, Sn = Rn(Re), ci = Rn(Re, i.draggable), Qe.eventCanceled) {
            this._nulling();
            return
        }
    ...
    _nulling: function() {
        wn("nulling", this), Pt = Re = $t = ut = Ii = Vt = qs = ui = Ai = Ln = Qr = Sn = ci = cr = as = sr = ls = en = $s = Qe.dragged = Qe.ghost = Qe.clone = Qe.active = null, so.forEach(function(e) {
            e.checked = !0
        }), so.length = fa = pa = 0
    },
...
function bx() {
    ...
    return t.prototype = {
        ...
        drop: function() {
            this.sortable.nativeDraggable ? wt(document, "dragover", this._handleAutoScroll) : (wt(document, "pointermove", this._handleFallbackAutoScroll), wt(document, "touchmove", this._handleFallbackAutoScroll), wt(document, "mousemove", this._handleFallbackAutoScroll)), vc(), Ys(), nx()
        },
        nulling: function() {
            oo = Pa = Zr = Na = es = va = ya = null, qt.length = 0
        },
        ...
        _handleAutoScroll: function(n, i) {
            ...
            if (oo = n, i || this.options.forceAutoScrollFallback || fs || oi || ss) {
                ...
                var k = di(S, !0);
                Na && (!es || f !== va || v !== ya) && (es && vc(), es = setInterval(function() {
...
var wa = nh(function(t, e, n, i) {
        if (!!e.scroll) {
            var a = (t.touches ? t.touches[0] : t).clientX,
                ...
                I = !1,
                D;
            Pa !== n && (Pa = n, Ys(), Zr = e.scroll, D = e.scrollFn, Zr === !0 && (Zr = di(n, !0)));
            var $ = 0,
                J = Zr;
            do {
                var ie = J,
                ...
                (qt[$].vx != K || qt[$].vy != Fe || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = Fe, clearInterval(qt[$].pid), (K != 0 || Fe != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    ...
                    typeof D == "function" && D.call(Qe.dragged.parentNode[kn], Te, oe, t, oo, qt[this.layer].el) !== "continue" || ih(qt[this.layer].el, Te, oe)
                }.bind({
                    layer: $
                }), 24))), $++
...
class Vx extends Nx {
    ...
    onText(n) {
        ...
        const v = f;
        i === "room" ? this.emit("client:entityDidChange", i, v) : i === `player:${this.id}` ? this.emit("client:entityDidChange", "player", v) : i === "bc:room" ? this.emit("client:entityDidChange", "room", v) : i === "audiencePlayer" ? this.emit("client:entityDidChange", "audiencePlayer", v) : i === `bc:customer:${this.userId}` ? this.emit("client:entityDidChange", "player", v) : ic(`[Ecast Client] Unhandled json notification: ${i}`)
    }
    onObject(n) {
        const i = n.key,
            a = n.val;
...
const $x = Et.View.extend({
    ...
    Fx = `<div id="controller" class="state-controller controller-content">
    <div id="prompt" class="prompt text col-xs-12"></div>
    <div id="chosen" class="chosen col-xs-12"></div>
    <div class="error text-danger"></div>
    <div id="choicesRegion"></div>
    <div id="instructions" class="text"></div>
    <div class="makeSingleChoiceDone">
        <span class="doneText"></span>
    </div>
</div>`,
    zx = Da.extend({
        ...
        bindings: at.extend({}, Da.prototype.bindings, {
            ".chosen": {},
            "#instructions": {
                observe: "text",
                updateMethod: "html",
                onGet(t) {
                    return t ? t.split("<BR>").length > 1 ? t.split("<BR>")[1] : null : ""
                }
            }
        }),
        events: {
        ...
        update() {
            ...
            let n = this.choicesList.collection.models.length !== this.model.get("choices").length;
            n || at.each(this.choicesList.collection.models, (i, a) => {
                n = n || i.get("html") !== this.model.get("choices")[a].html
            }), n && this.choicesList.collection.set(this.model.get("choices"))
        },
        buttonClick(t) {
            const e = this,
                n = Pe(t.currentTarget),
                i = n.data("index");
            let a = n.data("action");
            return Pe("button").removeClass("active"), n.addClass("active"), a || (a = "choose"), this.model.get("isPlayer") ? a === "censor" ? (Pe("button").removeClass("active"), bn.close(), bn.fire({
                title: `Censor ${this.model.get("choices")[i].text}?`,
...
const Hx = Px.extend({
    ...
    parseBlob(t) {
        ...
        }))), t.censorablePlayers && delete t.censorablePlayers, t
    },
    formatSessionMessage(t) {
...
//# sourceMappingURL=fdc9b4aa.js.map