        ...
        (function() {
            ...
            m.reduce = m.foldl = m.inject = Le(1), m.reduceRight = m.foldr = Le(-1), m.find = m.detect = function(l, g, _) {
                ...
                if (g == null && l != null) {
                    ...
                    te = g(Ie, De, rt), (te > L || te === -1 / 0 && O === -1 / 0) && (O = Ie, L = te)
                });
                return O
            ...
            var Be = function(l, g, _, O) {
                for (var L = [], V = 0, te = O || 0, Se = Ee(l); te < Se; te++) {
                    var he = l[te];
            ...
            m.findIndex = K(1), m.findLastIndex = K(-1), m.sortedIndex = function(l, g, _, O) {
                _ = q(_, O, 1);
                for (var L = _(g), V = 0, te = Ee(l); V < te;) {
            ...
            m.keys = function(l) {
                ...
                var O = {},
                    ...
                    V, te;
                if (L == null) return O;
                m.isFunction(g) ? (te = m.allKeys(L), V = P(g, _)) : (te = Be(arguments, !1, !1, 1), V = function(rt, xt, rn) {
                    return xt in rn
                }, L = Object(L));
            ...
            m.template = function(l, g, _) {
                ...
                var O = RegExp([(g.escape || Ke).source, (g.interpolate || Ke).source, (g.evaluate || Ke).source].join("|") + "|$", "g"),
                    L = 0,
                    V = "__p+='";
                l.replace(O, function(Ie, De, rt, xt, rn) {
                    return V += l.slice(L, rn).replace(Bt, Ut), L = rn + Ie.length, De ? V += `'+
...
function Sc() {
    return bl || (bl = 1, function(t) {
        (function(e, n) {
            ...
            var Ae = function(r) {
                var s, u, p, w, x, T, z, G, Z, le, be, ne, ce, Ue, ot, je, zt, Nt, un, _t = "sizzle" + 1 * new Date,
                    tt = r.document,
                    on = 0,
                    ft = 0,
                    Dt = Xi(),
                ...
                function St(R, F, X, de) {
                    ...
                    if (!de && (ne(F), F = F || ce, ot)) {
                        if (ht !== 11 && (Me = Wo.exec(R)))
                            ...
                            if (He = R, Xe = F, ht === 1 && (Fo.test(R) || As.test(R))) {
                                for (Xe = zr.test(R) && Hr(F.parentNode) || F, (Xe !== F || !u.scope) && ((Oe = F.getAttribute("id")) ? Oe = Oe.replace(Gr, Os) : F.setAttribute("id", Oe = _t)), ze = T(R), me = ze.length; me--;) ze[me] = (Oe ? "#" + Oe : ":scope") + " " + Ji(ze[me]);
                                He = ze.join(",")
                            }
                            try {
                    ...
                    return G(R.replace(Si, "$1"), F, X, de)
                }
                ...
                function Is(R) {
                    return function(F) {
                        return "form" in F ? F.parentNode && F.disabled === !1 ? "label" in F ? "label" in F.parentNode ? F.parentNode.disabled === R : F.disabled === R : F.isDisabled === R || F.isDisabled !== !R && Xo(F) === R : F.disabled === R : "label" in F ? F.disabled === R : !1
                    }
                }
                ...
                u = St.support = {}, x = St.isXML = function(R) {
                    ...
                    return de == ce || de.nodeType !== 9 || !de.documentElement || (ce = de, Ue = ce.documentElement, ot = !x(ce), tt != ce && (X = ce.defaultView) && X.top !== X && (X.addEventListener ? X.addEventListener("unload", Rs, !1) : X.attachEvent && X.attachEvent("onunload", Rs)), u.scope = yn(function(ee) {
                        ...
                        me.setAttribute("type", "hidden"), ee.appendChild(me).setAttribute("name", "D"), ee.querySelectorAll("[name=d]").length && je.push("name" + gt + "*[*^$|!~]?="), ee.querySelectorAll(":enabled").length !== 2 && je.push(":enabled", ":disabled"), Ue.appendChild(ee).disabled = !0, ee.querySelectorAll(":disabled").length !== 2 && je.push(":enabled", ":disabled"), ee.querySelectorAll("*,:x"), je.push(",.*:")
                    ...
                    }), je = je.length && new RegExp(je.join("|")), zt = zt.length && new RegExp(zt.join("|")), F = ki.test(Ue.compareDocumentPosition), un = F || ki.test(Ue.contains) ? function(ee, me) {
                        ...
                        return xe || (xe = (ee.ownerDocument || ee) == (me.ownerDocument || me) ? ee.compareDocumentPosition(me) : 1, xe & 1 || !u.sortDetached && me.compareDocumentPosition(ee) === xe ? ee == ce || ee.ownerDocument == tt && un(tt, ee) ? -1 : me == ce || me.ownerDocument == tt && un(tt, me) ? 1 : le ? Qn(le, ee) - Qn(le, me) : 0 : xe & 4 ? -1 : 1)
                    } : function(ee, me) {
                        if (ee === me) return be = !0, 0;
                        var xe, Oe = 0,
                            Me = ee.parentNode,
                        ...
                        for (; He[Oe] === Xe[Oe];) Oe++;
                        return Oe ? Ki(He[Oe], Xe[Oe]) : He[Oe] == tt ? -1 : Xe[Oe] == tt ? 1 : 0
                    }), ce
                    ...
                    var X = p.attrHandle[F.toLowerCase()],
                        de = X && Jn.call(p.attrHandle, F.toLowerCase()) ? X(R, F, !ot) : void 0;
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function(R) {
                            var F, X = !R[6] && R[2];
                            return Wi.CHILD.test(R[0]) ? null : (R[3] ? R[2] = R[4] || R[5] || "" : X && zo.test(X) && (F = T(X, !0)) && (F = X.indexOf(")", X.length - F) - X.length) && (R[0] = R[0].slice(0, F), R[2] = X.slice(0, F)), R.slice(0, 3))
                        }
                    },
                    filter: {
                        TAG: function(R) {
                            ...
                            return de === 1 && ee === 0 ? function(Me) {
                                ...
                                if (At) {
                                    ...
                                    if (Jt = [xe ? At.firstChild : At.lastChild], xe && h) {
                                        for (We = At, Tt = We[_t] || (We[_t] = {}), ht = Tt[We.uniqueID] || (Tt[We.uniqueID] = {}), Xe = ht[R] || [], Gt = Xe[0] === on && Xe[1], b = Gt && Xe[2], We = Gt && At.childNodes[Gt]; We = ++Gt && We && We[fn] || (b = Gt = 0) || Jt.pop();)
                                            if (We.nodeType === 1 && ++b && We === Me) {
                                                ht[R] = [on, Gt, b];
                                                break
                                            }
                                    } else if (h && (We = Me, Tt = We[_t] || (We[_t] = {}), ht = Tt[We.uniqueID] || (Tt[We.uniqueID] = {}), Xe = ht[R] || [], Gt = Xe[0] === on && Xe[1], b = Gt), b === !1)
                                        for (;
                                            (We = ++Gt && We && We[fn] || (b = Gt = 0) || Jt.pop()) && !((Oe ? We.nodeName.toLowerCase() === c : We.nodeType === 1) && ++b && (h && (Tt = We[_t] || (We[_t] = {}), ht = Tt[We.uniqueID] || (Tt[We.uniqueID] = {}), ht[R] = [on, b]), We === Me)););
                        ...
                        PSEUDO: function(R, F) {
                            ...
                            return de[_t] ? de(F) : de.length > 1 ? (X = [R, R, "", F], p.setFilters.hasOwnProperty(R.toLowerCase()) ? dn(function(ee, me) {
                                for (var xe, Oe = de(ee, F), Me = Oe.length; Me--;) xe = Qn(ee, Oe[Me]), ee[xe] = !(me[xe] = Oe[Me])
                            }) : function(ee) {
                                return de(ee, 0, X)
                            }) : de
                        }
                    ...
                    pseudos: {
                        not: dn(function(R) {
                            ...
                            return de[_t] ? dn(function(ee, me, xe, Oe) {
                                for (var Me, ze = de(ee, null, Oe, []), He = ee.length; He--;)(Me = ze[He]) && (ee[He] = !(me[He] = Me))
                            }) : function(ee, me, xe) {
                        ...
                        lang: dn(function(R) {
                            return Go.test(R || "") || St.error("unsupported lang: " + R), R = R.replace(Tn, xn).toLowerCase(),
                                function(F) {
                                    var X;
                                    do
                ...
                function Qi(R, F, X) {
                    ...
                    return F.first ? function(Me, ze, He) {
                        for (; Me = Me[de];)
                            if (Me.nodeType === 1 || xe) return R(Me, ze, He);
                        return !1
                    } : function(Me, ze, He) {
                        var Xe, ht, Tt, We = [on, Oe];
                        if (He) {
                            for (; Me = Me[de];)
                                if ((Me.nodeType === 1 || xe) && R(Me, ze, He)) return !0
                        } else
                            for (; Me = Me[de];)
                                if (Me.nodeType === 1 || xe)
                ...
                function er(R, F, X, de, ee) {
                    for (var me, xe = [], Oe = 0, Me = R.length, ze = F != null; Oe < Me; Oe++)(me = R[Oe]) && (!X || X(me, de, ee)) && (xe.push(me), ze && F.push(Oe));
                    return xe
                }

                function Ur(R, F, X, de, ee, me) {
                    return de && !de[_t] && (de = Ur(de)), ee && !ee[_t] && (ee = Ur(ee, me)), dn(function(xe, Oe, Me, ze) {
                        var He, Xe, ht, Tt = [],
                            We = [],
                            Gt = Oe.length,
                            Jt = xe || Jo(F || "*", Me.nodeType ? [Me] : Me, []),
                            fn = R && (xe || !F) ? er(Jt, Tt, R, Me, ze) : Jt,
                            At = X ? ee || (xe ? R : Gt || de) ? [] : Oe : fn;
                        if (X && X(fn, At, Me, ze), de)
                            for (He = er(At, We), de(He, [], Me, ze), Xe = He.length; Xe--;)(ht = He[Xe]) && (At[We[Xe]] = !(fn[We[Xe]] = ht));
                        if (xe) {
                            if (ee || R) {
                                if (ee) {
                                ...
                                for (Xe = At.length; Xe--;)(ht = At[Xe]) && (He = ee ? Qn(xe, ht) : Tt[Xe]) > -1 && (xe[He] = !(Oe[He] = ht))
                            }
                        } else At = er(At === Oe ? At.splice(Gt, At.length) : At), ee ? ee(null, Oe, At, ze) : Cn.apply(Oe, At)
                    })
                }

                function qr(R) {
                    for (var F, X, de, ee = R.length, me = p.relative[R[0].type], xe = me || p.relative[" "], Oe = me ? 1 : 0, Me = Qi(function(Xe) {
                            return Xe === F
                    ...
                    var X = F.length > 0,
                        ...
                        ee = function(me, xe, Oe, Me, ze) {
                            ...
                            for (ze && (Z = xe == ce || xe || ze); We !== h && (He = At[We]) != null; We++) {
                                if (de && He) {
                                    for (Xe = 0, !xe && He.ownerDocument != ce && (ne(He), Oe = !ot); ht = R[Xe++];)
                                        if (ht(He, xe || ce, Oe)) {
                                            Me.push(He);
                                            break
                                        } ze && (on = c)
                                }
                                X && ((He = !ht && He) && Tt--, me && Gt.push(He))
                            }
                            if (Tt += We, X && We !== Tt) {
                                for (Xe = 0; ht = F[Xe++];) ht(Gt, Jt, xe, Oe);
                                if (me) {
                                    if (Tt > 0)
                                        for (; We--;) Gt[We] || Jt[We] || (Jt[We] = Mn.call(Me));
                                    Jt = er(Jt)
                                }
                                Cn.apply(Me, Jt), ze && !me && Jt.length > 0 && Tt + F.length > 1 && St.uniqueSort(Me)
                            }
                ...
                return z = St.compile = function(R, F) {
                    ...
                    if (X = X || [], He.length === 1) {
                        ...
                        for (ee = Wi.needsContext.test(R) ? 0 : me.length; ee-- && (xe = me[ee], !p.relative[Oe = xe.type]);)
                            if ((Me = p.find[Oe]) && (de = Me(xe.matches[0].replace(Tn, xn), zr.test(me[0].type) && Hr(F.parentNode) || F))) {
                                if (me.splice(ee, 1), R = de.length && Ji(me), !R) return Cn.apply(X, de), X;
                                break
                            }
                    }
                    return (ze || z(R, He))(de, F, !ot, X, !F || zr.test(R) && Hr(F.parentNode) || F), X
                                    ...
                                    return function() {
                                        var Ue = this,
                                            ...
                                            je = function() {
                                                var Nt, un;
                                                if (!(le < G)) {
                                                    if (Nt = ne.apply(Ue, ot), Nt === be.promise()) throw new TypeError("Thenable self-resolution");
                                                    un = Nt && (typeof Nt == "object" || typeof Nt == "function") && Nt.then, re(un) ? ce ? un.call(Nt, Z(G, be, Ke, ce), Z(G, be, dt, ce)) : (G++, un.call(Nt, Z(G, be, Ke, ce), Z(G, be, dt, ce), Z(G, be, Ke, be.notifyWith))) : (ne !== Ke && (Ue = void 0, ot = [Nt]), (ce || be.resolveWith)(Ue, ot))
                                                }
                                            },
                                            zt = ce ? je : function() {
                                                try {
                                                    ...
                                                    d.Deferred.exceptionHook && d.Deferred.exceptionHook(Nt, zt.stackTrace), le + 1 >= G && (ne !== dt && (Ue = void 0, ot = [Nt]), be.rejectWith(Ue, ot))
                                                }
                                            };
            ...
            function In(r, s, u, p, w) {
                for (var x, T, z, G, Z, le, be = s.createDocumentFragment(), ne = [], ce = 0, Ue = r.length; ce < Ue; ce++)
                    if (x = r[ce], x || x === 0)
            ...
            d.event = {
                ...
                add: function(r, s, u, p, w) {
                    var x, T, z, G, Z, le, be, ne, ce, Ue, ot, je = he.get(r);
                    if (!!te(r))
                        for (u.handler && (x = u, u = x.handler, w = x.selector), w && d.find.matchesSelector(Kt, w), u.guid || (u.guid = d.guid++), (G = je.events) || (G = je.events = Object.create(null)), (T = je.handle) || (T = je.handle = function(zt) {
                                return typeof d < "u" && d.event.triggered !== zt.type ? d.event.dispatch.apply(r, arguments) : void 0
                            }), s = (s || "").match(ke) || [""], Z = s.length; Z--;) z = Pn.exec(s[Z]) || [], ce = ot = z[1], Ue = (z[2] || "").split(".").sort(), ce && (be = d.event.special[ce] || {}, ce = (w ? be.delegateType : be.bindType) || ce, be = d.event.special[ce] || {}, le = d.extend({
                            type: ce,
                            origType: ot,
                            data: p,
                            handler: u,
                            ...
                            namespace: Ue.join(".")
                        }, x), (ne = G[ce]) || (ne = G[ce] = [], ne.delegateCount = 0, (!be.setup || be.setup.call(r, p, Ue, T) === !1) && r.addEventListener && r.addEventListener(ce, T)), be.add && (be.add.call(r, le), le.handler.guid || (le.handler.guid = u.guid)), w ? ne.splice(ne.delegateCount++, 0, le) : ne.push(le), d.event.global[ce] = !0)
                },
                remove: function(r, s, u, p, w) {
                    var x, T, z, G, Z, le, be, ne, ce, Ue, ot, je = he.hasData(r) && he.get(r);
                    if (!(!je || !(G = je.events))) {
                        for (s = (s || "").match(ke) || [""], Z = s.length; Z--;) {
                            if (z = Pn.exec(s[Z]) || [], ce = ot = z[1], Ue = (z[2] || "").split(".").sort(), !ce) {
                                for (ce in G) d.event.remove(r, ce + s[Z], u, p, !0);
                                continue
                            }
                            for (be = d.event.special[ce] || {}, ce = (p ? be.delegateType : be.bindType) || ce, ne = G[ce] || [], z = z[2] && new RegExp("(^|\\.)" + Ue.join("\\.(?:.*\\.|)") + "(\\.|$)"), T = x = ne.length; x--;) le = ne[x], (w || ot === le.origType) && (!u || u.guid === le.guid) && (!z || z.test(le.namespace)) && (!p || p === le.selector || p === "**" && le.selector) && (ne.splice(x, 1), le.selector && ne.delegateCount--, be.remove && be.remove.call(r, le));
                            T && !ne.length && ((!be.teardown || be.teardown.call(r, Ue, je.handle) === !1) && d.removeEvent(r, ce, je.handle), delete G[ce])
                        }
            ...
            function mn(r, s, u, p) {
                ...
                var w, x, T, z, G, Z, le = 0,
                    ...
                    ce = s[0],
                    Ue = re(ce);
                if (Ue || be > 1 && typeof ce == "string" && !Y.checkClone && kr.test(ce)) return r.each(function(ot) {
                    var je = r.eq(ot);
                    Ue && (s[0] = ce.call(this, ot, je.html())), mn(je, s, u, p)
                });
                if (be && (w = In(s, r[0].ownerDocument, !1, r, p), x = w.firstChild, w.childNodes.length === 1 && (w = x), x || p)) {
                    ...
                    if (z)
                        for (Z = T[T.length - 1].ownerDocument, d.map(T, yi), le = 0; le < z; le++) G = T[le], Pe.test(G.type || "") && !he.access(G, "globalEval") && d.contains(Z, G) && (G.src && (G.type || "").toLowerCase() !== "module" ? d._evalUrl && !G.noModule && d._evalUrl(G.src, {
            ...
            function _o(r, s, u) {
                ...
                for (p in s)
                    ...
                    be && r.nodeType === 1 && (u.overflow = [Ue.overflow, Ue.overflowX, Ue.overflowY], Z = je && je.display, Z == null && (Z = he.get(r, "display")), le = d.css(r, "display"), le === "none" && (Z ? le = Z : (U([r], !0), Z = r.style.display || Z, le = d.css(r, "display"), U([r]))), (le === "inline" || le === "inline-block" && Z != null) && d.css(r, "float") === "none" && (G || (ne.done(function() {
                        Ue.display = Z
                    ...
                    for (p in ce) G || (je ? "hidden" in je && (ot = je.hidden) : je = he.access(r, "fxshow", {
                        display: Z
                    }), x && (je.hidden = !ot), ot && U([r], !0), ne.done(function() {
                        ot || U([r]), he.remove(r, "fxshow");
                        for (p in ce) d.style(r, p, ce[p])
                    })), G = gs(ot ? je[p] : 0, p, ne), p in je || (je[p] = G.start, ot && (G.end = G.start, G.start = 0))
                }
            }
            ...
            function bn(r, s, u) {
                var p, w, x = 0,
                    ...
                    G = function() {
                        if (w) return !1;
                        for (var be = Ft || Or(), ne = Math.max(0, Z.startTime + Z.duration - be), ce = ne / Z.duration || 0, Ue = 1 - ce, ot = 0, je = Z.tweens.length; ot < je; ot++) Z.tweens[ot].run(Ue);
                    ...
                    stop: function(r, s, u) {
                        ...
                        return typeof r != "string" && (u = s, s = r, r = void 0), s && this.queue(r || "fx", []), this.each(function() {
                            ...
                            if (x) z[x] && z[x].stop && p(z[x]);
                                ...
                                for (x in z) z[x] && z[x].stop && Eo.test(x) && p(z[x]);
                ...
                propHooks: {
                    tabIndex: {
                        get: function(r) {
                            ...
                            return s ? parseInt(s, 10) : So.test(r.nodeName) || ko.test(r.nodeName) && r.href ? 0 : -1
                        }
                    }
                },
                propFix: {
            ...
            d.fn.extend({
                val: function(r) {
                    ...
                    })) : w ? (s = d.valHooks[w.type] || d.valHooks[w.nodeName.toLowerCase()], s && "get" in s && (u = s.get(w, "value")) !== void 0 ? u : (u = w.value, typeof u == "string" ? u.replace(To, "") : u == null ? "" : u)) : void 0
                }
            }), d.extend({
                valHooks: {
                    option: {
            ...
            d.extend(d.event, {
                trigger: function(r, s, u, p) {
                    ...
                    if (x = be = T = u = u || P, !(u.nodeType === 3 || u.nodeType === 8) && !Dr.test(ce + d.event.triggered) && (ce.indexOf(".") > -1 && (Ue = ce.split("."), ce = Ue.shift(), Ue.sort()), G = ce.indexOf(":") < 0 && "on" + ce, r = r[d.expando] ? r : new d.Event(ce, typeof r == "object" && r), r.isTrigger = p ? 2 : 3, r.namespace = Ue.join("."), r.rnamespace = r.namespace ? new RegExp("(^|\\.)" + Ue.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, r.result = void 0, r.target || (r.target = u), s = s == null ? [r] : d.makeArray(s, [r]), le = d.event.special[ce] || {}, !(!p && le.trigger && le.trigger.apply(u, s) === !1))) {
                        ...
                        return r.type = ce, !p && !r.isDefaultPrevented() && (!le._default || le._default.apply(ne.pop(), s) === !1) && te(u) && G && re(u[ce]) && !m(u) && (T = u[G], T && (u[G] = null), d.event.triggered = ce, r.isPropagationStopped() && be.addEventListener(ce, Xn), u[ce](), r.isPropagationStopped() && be.removeEventListener(ce, Xn), d.event.triggered = void 0, T && (u[G] = T)), r.result
                    }
                },
...
`) : r)), s
            ...
            function Lr(r, s, u, p) {
                ...
                if (Array.isArray(s)) d.each(s, function(x, T) {
                    u || Ao.test(r) ? p(r, T) : Lr(r + "[" + (typeof T == "object" && T != null ? x : "") + "]", T, u, p)
                });
            ...
            d.param = function(r, s) {
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var r = this.type;
                        return this.name && !d(this).is(":disabled") && Ro.test(this.nodeName) && !Oo.test(r) && (this.checked || !fe.test(r))
                    }).map(function(r, s) {
                        var u = d(this).val();
...
`)
            ...
            d.extend({
                ...
                ajax: function(r, s) {
                    ...
                    if (ot.promise(tt), ne.url = ((r || ne.url || xi.href) + "").replace(Po, xi.protocol + "//"), ne.type = s.method || s.type || ne.method || ne.type, ne.dataTypes = (ne.dataType || "*").toLowerCase().match(ke) || [""], ne.crossDomain == null) {
                        z = P.createElement("a");
                        try {
                    ...
                    if (ne.data && ne.processData && typeof ne.data != "string" && (ne.data = d.param(ne.data, ne.traditional)), xs(ws, ne, s, tt), G) return tt;
                    Z = d.event && ne.global, Z && d.active++ === 0 && d.event.trigger("ajaxStart"), ne.type = ne.type.toUpperCase(), ne.hasContent = !Lo.test(ne.type), p = ne.url.replace(Do, ""), ne.hasContent ? ne.data && ne.processData && (ne.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (ne.data = ne.data.replace(Io, "+")) : (be = ne.url.slice(p.length), ne.data && (ne.processData || typeof ne.data == "string") && (p += (Ui.test(p) ? "&" : "?") + ne.data, delete ne.data), ne.cache === !1 && (p = p.replace(Mo, "$1"), be = (Ui.test(p) ? "&" : "?") + "_=" + Mr.guid++ + be), ne.url = p + be), ne.ifModified && (d.lastModified[p] && tt.setRequestHeader("If-Modified-Since", d.lastModified[p]), d.etag[p] && tt.setRequestHeader("If-None-Match", d.etag[p])), (ne.data && ne.hasContent && ne.contentType !== !1 || s.contentType) && tt.setRequestHeader("Content-Type", ne.contentType), tt.setRequestHeader("Accept", ne.dataTypes[0] && ne.accepts[ne.dataTypes[0]] ? ne.accepts[ne.dataTypes[0]] + (ne.dataTypes[0] !== "*" ? ", " + bs + "; q=0.01" : "") : ne.accepts["*"]);
                    ...
                    if (_t = "abort", je.add(ne.complete), tt.done(ne.success), tt.fail(ne.error), u = xs(Pr, ne, s, tt), !u) on(-1, "No Transport");
                    else {
                        if (tt.readyState = 1, Z && Ue.trigger("ajaxSend", [tt, ne]), G) return tt;
                    ...
                    function on(ft, Dt, _i, qi) {
                        ...
                        G || (G = !0, T && e.clearTimeout(T), u = void 0, w = qi || "", tt.readyState = ft > 0 ? 4 : 0, hn = ft >= 200 && ft < 300 || ft === 304, _i && (an = No(ne, tt, _i)), !hn && d.inArray("script", ne.dataTypes) > -1 && d.inArray("json", ne.dataTypes) < 0 && (ne.converters["text script"] = function() {}), an = Vo(ne, an, tt, hn), hn ? (ne.ifModified && (Mn = tt.getResponseHeader("Last-Modified"), Mn && (d.lastModified[p] = Mn), Mn = tt.getResponseHeader("etag"), Mn && (d.etag[p] = Mn)), ft === 204 || ne.type === "HEAD" ? vn = "nocontent" : ft === 304 ? vn = "notmodified" : (vn = an.state, Kn = an.data, Jn = an.error, hn = !Jn)) : (Jn = vn, (ft || !vn) && (vn = "error", ft < 0 && (ft = 0))), tt.status = ft, tt.statusText = (Dt || vn) + "", hn ? ot.resolveWith(ce, [Kn, vn, tt]) : ot.rejectWith(ce, [tt, vn, Jn]), tt.statusCode(zt), zt = void 0, Z && Ue.trigger(hn ? "ajaxSuccess" : "ajaxError", [tt, ne, hn ? Kn : Jn]), je.fireWith(ce, [tt, vn]), Z && (Ue.trigger("ajaxComplete", [tt, ne]), --d.active || d.event.trigger("ajaxStop")))
                    }
                    return tt
                },
            ...
            d.ajaxSetup({
                ...
                if (T || r.dataTypes[0] === "jsonp") return p = r.jsonpCallback = re(r.jsonpCallback) ? r.jsonpCallback() : r.jsonpCallback, T ? r[T] = r[T].replace($r, "$1" + p) : r.jsonp !== !1 && (r.url += (Ui.test(r.url) ? "&" : "?") + r.jsonp + "=" + p), r.converters["script json"] = function() {
            ...
            return d.noConflict = function(r) {
                return e.$ === d && (e.$ = jo), r && e.jQuery === d && (e.jQuery = $o), d
    ...
    (function(e) {
        ...
        var S = function(E, l, g) {
            ...
            ie = function(E, l, g, _, O) {
                ...
                if (g && typeof g == "object")
                    for (_ !== void 0 && ("context" in O) && O.context === void 0 && (O.context = _), V = i.keys(g); L < V.length; L++) l = ie(E, l, V[L], g[V[L]], O);
                else if (g && J.test(g))
                    for (V = g.split(J); L < V.length; L++) l = E(l, V[L], _, O);
                else l = E(l, g, _, O);
                return l
            };
        $.on = function(E, l, g) {
            ...
            ae = function(E, l) {
                ...
                switch (l.length) {
                    ...
                    case 1:
                        ...
                        return;
                    case 2:
                        for (; ++_ < O;)(g = E[_]).callback.call(g.ctx, L, V);
                        return;
                    case 3:
                        for (; ++_ < O;)(g = E[_]).callback.call(g.ctx, L, V, te);
                        return;
                    default:
        ...
        i.extend(se.prototype, $, {
            ...
            destroy: function(E) {
                ...
                var L = !1;
                return this.isNew() ? i.defer(E.success) : (Ut(this, E), L = this.sync("delete", this, E)), _ || O(), L
            },
            url: function() {
            ...
            set: function(E, l) {
                if (E != null) {
                    ...
                    for (yt = 0; yt < E.length; yt++) {
                        ...
                        if (bt) {
                            if (Ie && ct !== bt) {
                                ...
                                l.parse && (Kt = bt.parse(Kt, l)), bt.set(Kt, l), V.push(bt), xt && !rt && (rt = bt.hasChanged(rn))
                            }
                    ...
                    if (O.length && Lt ? (Je = this.length !== O.length || i.some(this.models, function(j, N) {
                        ...
                        (rt || Je) && this.trigger("sort", this, l), (L.length || te.length || V.length) && (l.changes = {
                            added: L,
                            removed: te,
                            merged: V
...
(function(t, e) {
    (function(n, i) {
            ...
            kn = n.View.extend({
                ...
                reorder: function() {
                    ...
                    if (Q) this.render();
                        ...
                        var Ce = [],
                            qe = i.reduce(this.children._views, function(Wt, Hn) {
                                var Nn = i.indexOf(A, Hn.model);
                                return Nn === -1 ? (Ce.push(Hn.model), Wt) : (Hn._index = Nn, Wt[Nn] = Hn.el, Wt)
                            }, new Array(A.length));
        ...
        }, et.bindEvents = v(_e), et.unbindEvents = v(ke), et.bindRequests = v(Ke), et.unbindRequests = v(dt), et.mergeOptions = v(D), et.getOption = v($), et.normalizeMethods = v(J), et.extend = S, et.isNodeAttached = I, et.deprecate = k, et.triggerMethod = v(m), et.triggerMethodOn = P, et.isEnabled = rt, et.setEnabled = xt, et.monitorViewEvents = oe, et.Behaviors = {}, et.Behaviors.behaviorsLookup = zi, et.Application = Fi, et.AppRouter = Gn, et.Renderer = Ye, et.TemplateCache = _, et.View = Pn, et.CollectionView = kn, et.NextCollectionView = mi, et.CompositeView = vi, et.Behavior = ji, et.Region = pe, et.Error = we, et.Object = g, et.DEV_MODE = !1, et.FEATURES = De, et.VERSION = f, et.DomApi = N, et.setDomApi = function(y) {
...
var vd = md,
    ...
    bd = "[object Null]",
    Cd = "[object Undefined]",
    _l = El ? El.toStringTag : void 0;

function xd(t) {
    return t == null ? t === void 0 ? Cd : bd : _l && _l in Object(t) ? yd(t) : wd(t)
}
var fo = xd;
...
Mt[Ng] = Mt[Vg] = Mt[Yg] = Mt[Bg] = Mt[Kg] = Mt[$g] = Mt[jg] = Mt[Fg] = Mt[zg] = Mt[Gg] = Mt[Hg] = Mt[Ug] = Mt[qg] = Mt[Wg] = Mt[Xg] = !1;
...
function fv(t, e, n, i, a, f, v) {
    ...
    if ($) {
        var J = Nl(k),
            ie = !J && av(k),
            Y = !J && !ie && hv(k);
        D = k, J || ie || Y ? Nl(S) ? D = S : ov(S) ? D = rv(S) : ie ? ($ = !1, D = nv(k, !0)) : Y ? ($ = !1, D = iv(k, !0)) : D = [] : uv(k) || Pl(k) ? (D = S, Pl(S) ? D = dv(S) : (!cv(S) || lv(S)) && (D = sv(k))) : $ = !1
    }
...
function Tv(t, e, n) {
    return e = Bl(e === void 0 ? t.length - 1 : e, 0),
        function() {
            for (var i = arguments, a = -1, f = Bl(i.length - e, 0), v = Array(f); ++a < f;) v[a] = i[e + a];
            a = -1;
...
at(Sa, "locale"), at(Sa, "supported", ["en", "fr", "it", "de", "es", "es-XL"]);
const yl = class {
...
var cy = function() {
    ...
    uy = cy,
    hy = function() {
        return typeof jl != "function" || typeof Symbol != "function" || typeof jl("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : uy()
    },
...
var ra = function() {
    ...
    ur = {
        ...
        "%isFinite%": isFinite,
        "%isNaN%": isNaN,
        "%IteratorPrototype%": nr ? li(li([][Symbol.iterator]())) : mt,
        "%JSON%": typeof JSON == "object" ? JSON : mt,
        "%Map%": typeof Map > "u" ? mt : Map,
        "%MapIteratorPrototype%": typeof Map > "u" || !nr ? mt : li(new Map()[Symbol.iterator]()),
        "%Math%": Math,
        "%Number%": Number,
        "%Object%": Object,
        ...
        "%SetIteratorPrototype%": typeof Set > "u" || !nr ? mt : li(new Set()[Symbol.iterator]()),
        "%SharedArrayBuffer%": typeof SharedArrayBuffer > "u" ? mt : SharedArrayBuffer,
        "%String%": String,
        "%StringIteratorPrototype%": nr ? li("" [Symbol.iterator]()) : mt,
        "%Symbol%": nr ? Symbol : mt,
        "%SyntaxError%": pr,
        "%ThrowTypeError%": wy,
        "%TypedArray%": by,
    ...
    zl = hs.call(Function.call, String.prototype.replace),
    eo = hs.call(Function.call, String.prototype.slice),
    ...
    Ay = function(e, n) {
        var i = e,
            a;
        if (Zs(Fl, i) && (a = Fl[i], i = "%" + a[0] + "%"), Zs(ur, i)) {
            var f = ur[i];
    ...
    qa = function(e, n) {
        ...
        for (var D = 1, $ = !0; D < i.length; D += 1) {
            ...
            if ((J === "constructor" || !$) && (k = !0), a += "." + J, v = "%" + a + "%", Zs(ur, v)) S = ur[v];
            else if (S != null) {
                if (!(J in S)) {
...
var Wa = typeof Map == "function" && Map.prototype,
    sa = Object.getOwnPropertyDescriptor && Wa ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null,
    to = Wa && sa && typeof sa.get == "function" ? sa.get : null,
    Ly = Wa && Map.prototype.forEach,
    Xa = typeof Set == "function" && Set.prototype,
    oa = Object.getOwnPropertyDescriptor && Xa ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null,
    no = Xa && oa && typeof oa.get == "function" ? oa.get : null,
    Py = Xa && Set.prototype.forEach,
    ...
    Gl = By ? WeakRef.prototype.deref : null,
    ...
    Wl = (typeof Reflect == "function" ? Reflect.getPrototypeOf : Object.getPrototypeOf) || ([].__proto__ === Array.prototype ? function(t) {
        return t.__proto__
    } : null);
...
var Oa = My,
    ...
    Uy = function t(e, n, i, a) {
        ...
        if (typeof e == "function" && !Jl(e)) {
            var ie = ew(e),
                Y = Ps(e, J);
            return "[Function" + (ie ? ": " + ie : " (anonymous)") + "]" + (Y.length > 0 ? " { " + jn.call(Y, ", ") + " }" : "")
        }
        if (Zc(e)) {
            var re = gr ? di.call(String(e), /^(Symbol\(.*\))_[^)]*$/, "$1") : Aa.call(e);
            return typeof e == "object" && !gr ? Xr(re) : re
        }
        if (ow(e)) {
            for (var m = "<" + Hl.call(String(e.nodeName)), P = e.attributes || [], q = 0; q < P.length; q++) m += " " + P[q].name + "=" + Qc(qy(P[q].value), "double", f);
            return m += ">", e.childNodes && e.childNodes.length && (m += "..."), m += "</" + Hl.call(String(e.nodeName)) + ">", m
        }
        if (Ra(e)) {
            if (e.length === 0) return "[]";
            var ae = Ps(e, J);
            return $ && !lw(ae) ? "[" + Ia(ae, $) + "]" : "[ " + jn.call(ae, ", ") + " ]"
        }
        if (Xy(e)) {
            var se = Ps(e, J);
            return !("cause" in Error.prototype) && "cause" in e && !Jc.call(e, "cause") ? "{ [" + String(e) + "] " + jn.call(Ul.call("[cause]: " + J(e.cause), se), ", ") + " }" : se.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + jn.call(se, ", ") + " }"
        }
        if (typeof e == "object" && v) {
            if (Kl && typeof e[Kl] == "function" && Oa) return Oa(e, {
                depth: D - i
            });
        ...
        if (Qy(e)) return Xr(J(Ta.call(e)));
        if (Jy(e)) return Xr($y.call(e));
        if (Yy(e)) return Xr(J(String(e)));
        if (!Wy(e) && !Jl(e)) {
            var Ee = Ps(e, J),
                Ae = Wl ? Wl(e) === Object.prototype : e instanceof Object || e.constructor === Object,
                Le = e instanceof Object ? "" : "null prototype",
                lt = !Ae && cn && Object(e) === e && cn in e ? Ya.call(pi(e), 8, -1) : Le ? "Object" : "",
                Be = Ae || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "",
                K = Be + (lt || Le ? "[" + jn.call(Ul.call([], lt || [], Le || []), ": ") + "] " : "");
...
function tu(t, e) {
    if (t.length > e.maxStringLength) {
        ...
        return tu(Ya.call(t, 0, e.maxStringLength), e) + i
    }
    var a = di.call(di.call(t, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, aw);
...
function Ps(t, e) {
    ...
    for (var k in t) !ci(t, k) || n && String(Number(k)) === k && k < t.length || gr && v["$" + k] instanceof Symbol || (Kc.call(/[^\w$]/, k) ? i.push(e(k, t) + ": " + e(t[k], t)) : i.push(k + ": " + e(t[k], t)));
...
var Ka = qa,
    ...
    Cw = function() {
        var e, n, i, a = {
            ...
            set: function(f, v) {
                Ns && f && (typeof f == "object" || typeof f == "function") ? (e || (e = new Ns), fw(e, f, v)) : Vs ? (n || (n = new Vs), mw(n, f, v)) : (i || (i = {
                    key: {},
                    next: null
                }), ww(i, f, v))
            }
    ...
    ha = {},
    jw = function t(e, n, i, a, f, v, S, k, I, D, $, J, ie, Y, re, m) {
        ...
        if ($w(P) || Da.isBuffer(P)) {
            if (S) {
                var d = Y ? n : S(n, tn.encoder, re, "key", J);
                if (i === "comma" && Y) {
                    for (var Ee = Nw.call(String(P), ","), Ae = "", Le = 0; Le < Ee.length; ++Le) Ae += (Le === 0 ? "" : ",") + ie(S(Ee[Le], tn.encoder, re, "value", J));
        ...
        for (var Fe = a && ei(P) && P.length === 1 ? n + "[]" : n, H = 0; H < Be.length; ++H) {
            var oe = Be[H],
            ...
            if (!(v && Te === null)) {
                ...
                m.set(e, ae);
                var ye = ru();
                ye.set(ha, m), su(lt, t(Te, we, i, a, f, v, S, k, I, D, $, J, ie, Y, re, ye))
            }
        }
        return lt
    },
    ...
    zw = function(t, e) {
        ...
        var S;
        e && e.arrayFormat in Zl ? S = e.arrayFormat : e && "indices" in e ? S = e.indices ? "indices" : "repeat" : S = "indices";
        var k = Zl[S];
        ...
        for (var D = ru(), $ = 0; $ < a.length; ++$) {
            var J = a[$];
            i.skipNulls && n[J] === null || su(v, jw(n[J], J, k, I, i.strictNullHandling, i.skipNulls, i.encode ? i.encoder : null, i.filter, i.sort, i.allowDots, i.serializeDate, i.format, i.formatter, i.encodeValuesOnly, i.charset, D))
        }
        ...
        for (k = 0; k < v.length; ++k)
            if (k !== S) {
                var D = v[k],
                    ...
                    J = $ === -1 ? D.indexOf("=") : $ + 1,
                    ie, Y;
                J === -1 ? (ie = n.decoder(D, Qt.decoder, I, "key"), Y = n.strictNullHandling ? null : "") : (ie = n.decoder(D.slice(0, J), Qt.decoder, I, "key"), Y = mr.maybeMap(ou(D.slice(J + 1), n), function(re) {
                    return n.decoder(re, Qt.decoder, I, "value")
                })), Y && n.interpretNumericEntities && I === "iso-8859-1" && (Y = Hw(Y)), D.indexOf("[]=") > -1 && (Y = Gw(Y) ? [Y] : Y), Ma.call(i, ie) ? i[ie] = mr.combine(i[ie], Y) : i[ie] = Y
            } return i
    },
    Xw = function(t, e, n, i) {
    ...
    Yw = function(e, n, i, a) {
        if (!!e) {
            ...
            return k && D.push("[" + f.slice(k.index) + "]"), Xw(D, n, i, a)
        }
    },
    Kw = function(e) {
        if (!e) return Qt;
...
var hb = or,
    ...
    nc = hr && typeof hr.apply == "function" ? hr.apply : function(e, n, i) {
...
Rt.prototype.emit = function(e) {
    ...
    if (typeof k == "function") nc(k, this, n);
    else
        for (var I = k.length, D = pu(k, I), i = 0; i < I; ++i) nc(D[i], this, n);
    return !0
};

function uu(t, e, n, i) {
    var a, f, v;
    if (vo(n), f = t._events, f === void 0 ? (f = t._events = Object.create(null), t._eventsCount = 0) : (f.newListener !== void 0 && (t.emit("newListener", e, n.listener ? n.listener : n), f = t._events), v = f[e]), v === void 0) v = f[e] = n, ++t._eventsCount;
...
Rt.prototype.once = function(e, n) {
    return vo(n), this.on(e, hu(this, e, n)), this
};
Rt.prototype.prependOnceListener = function(e, n) {
    return vo(n), this.prependListener(e, hu(this, e, n)), this
};
Rt.prototype.removeListener = function(e, n) {
    var i, a, f, v, S;
    if (vo(n), a = this._events, a === void 0) return this;
...
class H0 extends I0 {
    ...
    async reconnect() {
        ...
        for (;;) try {
            ...
            e += 1, this.debugLog("waiting", n), this.emit("connection", {
                status: "waiting",
                attempt: e
            }), await this.sleep(n), n = Math.min(lc, n * 2)
        }
    }
    disconnect() {
    ...
    send(e, n = {}) {
        ...
        if (this.conn.readyState !== oc.OPEN) throw new Error(`Socket not ready to send, readyState is ${this.conn.readyState}`);
        const i = ++this.seq,
            a = new B0({
                seq: i,
                opcode: e,
...
(function(t, e) {
    (function(n, i) {
        ...
        function Le(j, N, W) {
            ...
            var M, U, fe, pe, Pe, Ve, pt = ae.slice(),
                jt = typeof N,
                Ye = this,
                In = 0;
            for (jt !== "object" && jt !== "string" && (W = N, N = null), W && typeof W != "function" && (W = ie.parse), N = ve(N), U = Ee(j || "", N), M = !U.protocol && !U.slashes, Ye.slashes = U.slashes || M && N.slashes, Ye.protocol = U.protocol || N.protocol || "", j = U.rest, (Ye.protocol === "file:" || !U.slashes && (U.protocol || U.slashesCount < 2 || !d(Ye.protocol))) && (pt[3] = [/(.*)/, "pathname"]); In < pt.length; In++) {
            ...
            Ut = function(j) {
                function N(W, M) {
                    ...
                    var U = M.bubbles,
                        ...
                        Pe = M.reason,
                        Ve = M.wasClean;
                    this.type = "" + W, this.timeStamp = Date.now(), this.target = null, this.srcElement = null, this.returnValue = !0, this.isTrusted = !1, this.eventPhase = 0, this.defaultPrevented = !1, this.currentTarget = null, this.cancelable = fe ? Boolean(fe) : !1, this.cancelBubble = !1, this.bubbles = U ? Boolean(U) : !1, this.code = typeof pe == "number" ? parseInt(pe, 10) : 0, this.reason = "" + (Pe || ""), this.wasClean = Ve ? Boolean(Ve) : !1
                }
                return j && (N.__proto__ = j), N.prototype = Object.create(j && j.prototype), N.prototype.constructor = N, N
            }(Ke);
        ...
        function _(j, N, W) {
            ...
            Fe(function() {
                _e.removeWebSocket(j, j.url), j.readyState = De.CLOSED, j.dispatchEvent(U), j.dispatchEvent(fe), M && M.dispatchEvent(U, M)
            }, j)
        }
        ...
        function O(j, N, W) {
            ...
            Fe(function() {
                _e.removeWebSocket(j, j.url), j.readyState = De.CLOSED, j.dispatchEvent(pe), j.dispatchEvent(U), j.dispatchEvent(fe), M && M.dispatchEvent(U, M)
            }, j)
        }
        ...
        var rn = {
            ...
            ct = function(j) {
                ...
                return j && (N.__proto__ = j), N.prototype = Object.create(j && j.prototype), N.prototype.constructor = N, N.prototype.mockWebsocket = function() {
                    ...
                    Pe || (Pe = _e.websocketsLookup(this.url)), typeof fe != "object" || arguments.length > 3 ? (U = Array.prototype.slice.call(arguments, 1, arguments.length), U = U.map(function(Ve) {
                        return L(Ve)
                    })) : U = L(U), Pe.forEach(function(Ve) {
                    ...
                    fe === void 0 && (fe = []);
                    var Pe = this,
                        Ve = rt(fe.concat(_e.websocketsLookup(this.url, M, U)));
                    return {
                        to: function(pt, jt) {
    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                BASE_URL: "https://bundles.jackbox.tv/main/pp4-survivetheinternet/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
                ...
                var Le = function(ue, _e, ke) {
                    e.each(ue, function($e) {
                        var Ke = n.$("<option/>"),
                            ...
                            Ut, E, l;
                        $e === "__default__" ? (Ut = ke.label, E = ke.value, l = ke.disabled) : (Ut = f($e, ve.labelPath), E = f($e, ve.valuePath), l = f($e, ve.disabledPath)), Bt(Ut, E, l);
                        var g = function() {
...
const vC = `<form>\r
    ...
    io = Ct.View.extend({
        ...
        onAttach() {
            this.getOption("preventAutosize") || hc(Ne("textarea"))
        },
        onSubmitClick() {
        ...
        clearInput() {
            ...
            Ne(t).val(""), this.getOption("preventAutosize") || hc.update(t), this.onInputChange()
        },
        setValue(t) {
    ...
    ii = Ct.CollectionView.extend({
        tagName: "div",
        className: "choices",
        childView(t) {
            return t.get("type") === "input" ? io : t.get("type") === "text" ? Vi : ll
        },
...
function wC(t) {
    ...
    return Us = Kr.getContext("2d"), Us.imageSmoothingEnabled = !1, th("init"), {
        canvas: Kr,
        context: Us
    }
}
...
bo.prototype = cl.prototype;
bo.class = cl;
const bC = () => {};

function CC() {
    let t = Mi();
    wo().clearRect(0, 0, t.width, t.height)
}
...
function xC({
    ...
    function Y() {
        if (I = requestAnimationFrame(Y), D = ie.now(), $ = D - k, k = D, !($ > 1e3)) {
            for (th("tick"), a += $; a >= f;) J.update(v), a -= f;
            S(), J.render()
        }
    }
    return J = {
...
class ul {
    ...
    get(e) {
        ...
        for (; this._s.length && this._b;) {
            for (i = fc(e, this.bounds), a = 0; a < i.length; a++) this._s[i[a]].get(e).forEach(f => n.add(f));
            return Array.from(n)
        }
    ...
    _a(e, n, i) {
        for (n = fc(e, this.bounds), i = 0; i < n.length; i++) this._s[n[i]].add(e)
    }
    _sp(e, n, i) {
...
`).replace(/(^|\n)\s*/g, ""),
            ...
            vi = c => {
                ...
                b.className = K.container, h && Je(b, K["no-transition"]), rt(b, _r);
                const B = kr(c.target);
                B.appendChild(b), mi(c), Bi(B), Sr()
            },
            yi = (c, h) => {
                c instanceof HTMLElement ? h.appendChild(c) : typeof c == "object" ? $i(c, h) : c && rt(h, c)
            },
            $i = (c, h) => {
                c.jquery ? ji(h, c) : rt(h, c.toString())
            },
            ji = (c, h) => {
            ...
            wi = (c, h) => {
                const b = g(),
                    B = E();
                !h.showConfirmButton && !h.showDenyButton && !h.showCancelButton ? M(b) : W(b), ct(b, h, "actions"), Gn(b, B, h), rt(B, h.loaderHtml), ct(B, h, "loader")
            };
        ...
        function bi(c, h, b) {
            fe(c, b["show".concat(a(h), "Button")], "inline-block"), rt(c, b["".concat(h, "ButtonText")]), c.setAttribute("aria-label", b["".concat(h, "ButtonAriaLabel")]), c.className = K[h], ct(c, b, "".concat(h, "Button")), Je(c, b["".concat(h, "ButtonClass")])
        }
        const et = (c, h) => {
            const b = H();
        ...
        const Q = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
            Ce = (c, h) => {
                ...
                Q.forEach(Ge => {
                    const Ht = j(b, K[Ge]);
                    Wt(Ge, h.inputAttributes), Ht.className = K[Ge], ge && M(Ht)
...
`,
            ms = (c, h) => {
                let b = c.innerHTML,
                    B;
                h.iconHtml ? B = Rr(h.iconHtml) : h.icon === "success" ? (B = gs, b = b.replace(/ style=".*?"/g, "")) : h.icon === "error" ? B = _o : B = Rr({
                    question: "?",
                    warning: "!",
                    info: "i"
            ...
            ko = c => {
                ...
                return Je(h, K["progress-step"]), rt(h, c), h
            },
            qn = c => {
                const h = document.createElement("li");
            ...
            Ir = (c, h) => {
                const b = H(),
                    B = we();
                h.toast ? (N(b, "width", h.width), B.style.width = "100%", B.insertBefore(E(), ye())) : N(B, "width", h.width), N(B, "padding", h.padding), h.color && (B.style.color = h.color), h.background && (B.style.background = h.background), M(Ke()), To(B, h)
            },
            To = (c, h) => {
            ...
            Dr = (c, h) => {
                Ir(c, h), et(c, h), So(c, h), Ar(c, h), Ci(c, h), Wn(c, h), Eo(c, h), Gi(c, h), wi(c, h), xo(c, h), typeof h.didRender == "function" && h.didRender(we())
            },
            Xn = Object.freeze({
                cancel: "cancel",
                backdrop: "backdrop",
            ...
            Ao = c => {
                ...
                if (!h) return {};
                const b = h.content;
                return Mo(b), Object.assign(vs(b), Oo(b), Ro(b), Lr(b), Io(b), Do(b, Ui))
            },
            vs = c => {
                const h = {};
...
https://sweetalert2.github.io/#ajax-request`), Po(c), typeof c.title == "string" && (c.title = c.title.split(`
`).join("<br />")), vi(c)
        }
        class Pr {
            constructor(h, b) {
        ...
        const bs = () => {
            ...
            No = c => {
                const h = c.target,
                    b = H();
                return Vo(c) || Bo(c) ? !1 : h === b || !Ve(b) && h.tagName !== "INPUT" && h.tagName !== "TEXTAREA" && !(Ve(_e()) && _e().contains(h))
            },
            Vo = c => c.touches && c.touches.length && c.touches[0].touchType === "stylus",
            ...
            $r = c => {
                ...
                r(h, b, c), setTimeout(() => {
                    $o(h, b)
                }, Br), Se() && (jo(h, c.scrollbarPadding, ge), xi()), !he() && !st.previousActiveElement && (st.previousActiveElement = document.activeElement), typeof c.didOpen == "function" && setTimeout(() => c.didOpen(b)), Lt(h, K["no-transition"])
            },
            Es = c => {
                const h = we();
                ...
                select: (c, h, b) => {
                    const B = j(c, K.select),
                        ge = (Ge, Ht, Vn) => {
                            ...
                            pn.value = Vn, rt(pn, Ht), pn.selected = ne(Vn, b.inputValue), Ge.appendChild(pn)
                        };
                    h.forEach(Ge => {
                        const Ht = Ge[0],
                            Vn = Ge[1];
                        if (Array.isArray(Vn)) {
                            ...
                            pn.label = Ht, pn.disabled = !1, B.appendChild(pn), Vn.forEach(tr => ge(pn, tr[1], tr[0]))
                        } else ge(B, Vn, Ht)
                    }), B.focus()
                },
                radio: (c, h, b) => {
                    ...
                    h.forEach(Ge => {
                        ...
                        const Qo = document.createElement("span");
                        rt(Qo, Vn), Qo.className = K.label, tr.appendChild(pn), tr.appendChild(Qo), B.appendChild(tr)
                    });
        ...
        function ce() {
            ...
            M(h.loader), he() ? c.icon && W(ye()) : Ue(h), Lt([h.popup, h.actions], K.loading), h.popup.removeAttribute("aria-busy"), h.popup.removeAttribute("data-loading"), h.confirmButton.disabled = !1, h.denyButton.disabled = !1, h.cancelButton.disabled = !1
        }
        const Ue = c => {
        ...
        function Mn(c, h, b, B) {
            he() ? ks(c, B) : (gi(b).then(() => ks(c, B)), tt(st)), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (h.setAttribute("style", "display:none !important"), h.removeAttribute("class"), h.innerHTML = "") : h.remove(), Se() && (Nr(), Ei(), Mr()), vn()
        }
        ...
        const gt = c => {
            ...
            Fr = (c, h, b, B, ge) => {
                st.swalCloseEventFinishedCallback = Mn.bind(null, c, b, B, ge), h.addEventListener(mn, function(Ge) {
                    Ge.target === h && (st.swalCloseEventFinishedCallback(), delete st.swalCloseEventFinishedCallback)
                })
            },
            ks = (c, h) => {
                setTimeout(() => {
        ...
        function Wi(c) {
            ...
            rt(h.validationMessage, c), h.validationMessage.className = K["validation-message"], b.customClass && b.customClass.validationMessage && Je(h.validationMessage, b.customClass.validationMessage), W(h.validationMessage);
        ...
        function Wo() {
            ...
            c.popup && st.swalCloseEventFinishedCallback && (st.swalCloseEventFinishedCallback(), delete st.swalCloseEventFinishedCallback), typeof h.didDestroy == "function" && h.didDestroy(), zr(this)
        }
        const zr = c => {
        ...
        const Os = c => {
            ...
            Yo = (c, h, b) => {
                A.innerParams.get(c).toast ? Ko(c, h, b) : (Hr(h), Ds(h), Ji(c, h, b))
            },
            Ko = (c, h, b) => {
                h.popup.onclick = () => {
                    const B = A.innerParams.get(c);
        ...
        class He {
            ...
            _main(h) {
                ...
                Le(Object.assign({}, b, h)), st.currentInstance && (st.currentInstance._destroy(), Se() && Mr()), st.currentInstance = ze;
                const B = ht(h, b);
                ws(B), Object.freeze(B), st.timeout && (st.timeout.stop(), delete st.timeout), clearTimeout(st.restoreFocusTimeout);
                const ge = Tt(ze);
        ...
        const Xe = (c, h, b) => new Promise((B, ge) => {
                ...
                je.swalPromiseResolve.set(c, B), je.swalPromiseReject.set(c, ge), h.confirmButton.onclick = () => Os(c), h.denyButton.onclick = () => Rs(c), h.cancelButton.onclick = () => Xo(c, Ge), h.closeButton.onclick = () => Ge(Xn.close), Yo(c, h, Ge), on(c, st, b, Ge), p(c, b), $r(b), We(st, b, Ge), Gt(h, b), setTimeout(() => {
      ...
      `));
        ...
        Object.assign(He.prototype, Gr), Object.assign(He, Me), Object.keys(Gr).forEach(c => {
            He[c] = function() {
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp4/survivetheinternet/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    oi = Ze.Model.extend({
        defaults: {},
        set(t, e) {
            const n = it.extend({}, this.attributes, this.defaults, t);
            return Ze.Model.prototype.set.apply(this, [n, e]), this
        },
        setUpdate(t, e) {
            const n = it.extend({}, this.defaults, this.attributes, t);
            return Ze.Model.prototype.set.apply(this, [n, e]), this
        }
    }),
    OC = oi.extend({
    ...
    RC = Ct.View.extend({
        template: it.template('<div id="cameraRegion" class="cameraRegion"></div>'),
        className: "Camera",
        model: new OC,
        regions: {
            camera: "#cameraRegion"
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp4/survivetheinternet/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
class NC {
    constructor(e, n = {}) {
        ...
        this.canvasSelector = e, this.canvas = Ne(this.canvasSelector)[0], this.ctx = this.canvas.getContext("2d"), this.options = Object.assign(pc, n), this.history = [], this.layerNames.forEach(i => {
    ...
    setOptions(e) {
        const n = Object.assign(pc.sketchOptions, e);
    ...
    FC = Ct.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new Vi({}), this.toolbarComponent = this.toolbarComponent || new PC({
                ...
                model: new Ze.Model
            }), this.buttonsCollection = this.buttonsCollection || new Ze.Collection([]), this.buttonsComponent = this.buttonsComponent || new ii({
                block: !1,
    ...
    Pa = Ct.View.extend({
        ...
        initialize() {
            this.currentEntry = null, this.shouldSubmit = !1, this.promptComponent = new Vi({
                ...
                text: "submit"
            }]), this.buttonsComponent = this.buttonsComponent || new ii({
                block: !0,
                collection: this.buttonsCollection
            }), this.listenTo(this.model, "change", this.update, this)
        },
        ...
        onChildviewInputText(t) {
            let e = t.getValue();
            e.length > this.model.get("maxLength") && (e = e.substr(0, this.model.get("maxLength")), t.setValue(e)), this.shouldSubmit = e.length > 0, this.model.get("live") && (this.throttledSend || (this.throttledSend = it.throttle(() => {
        ...
        onChildviewChildviewButtonSuggestion() {
            const t = this.model.get("suggestions"),
                e = this.inputComponent.getSanitizedValue(),
                n = it.without(t, e);
            return this.inputComponent.setValue(it.shuffle(n)[0]), !1
        },
        onChildviewChildviewButtonChoose(t) {
...
const HC = `<div id="controller" class="state-controller controller-content">
    ...
    qC = Ct.View.extend({
        tagName: "button",
        template: it.template('<span class="flex-item"></span>'),
        className() {
    ...
    WC = Ct.View.extend({
        ...
        initialize() {
            this.titleComponent = new Vi({
                model: new Ze.Model({})
            }), this.choicesListView = this.choicesListView || new ii, this.charactersListView = new Ct.CollectionView({
                childView: qC,
        ...
        update() {
            ...
            this.charactersListView.collection.set(it.map(t, e => {
    ...
    Na = Ct.View.extend({
        ...
        initialize() {
            this.promptComponent = this.promptComponent || new Vi({
                model: new Ze.Model
            }), this.choicesList = this.choicesList || new ii({
                action: "choose",
                collection: new Ze.Collection
...
function zn(t) {
    for (var e = 1; e < arguments.length; e++) {
        ...
        e % 2 ? gc(Object(n), !0).forEach(function(i) {
            tx(t, i, n[i])
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : gc(Object(n)).forEach(function(i) {
...
var ai = ri(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
    fs = ri(/Edge/i),
    mc = ri(/firefox/i),
    rs = ri(/safari/i) && !ri(/chrome/i) && !ri(/android/i),
...
function Et(t, e, n) {
    t.addEventListener(e, n, !ai && oh)
}

function wt(t, e, n) {
    t.removeEventListener(e, n, !ai && oh)
}
...
function $n(t, e, n, i) {
    if (t) {
        n = n || document;
        do {
            if (e != null && (e[0] === ">" ? t.parentNode === n && ro(t, e) : ro(t, e)) || i && t === n) return t;
            if (t === n) break
        } while (t = sx(t))
    }
    return null
...
function En(t, e, n) {
    if (t && e)
        if (t.classList) t.classList[n ? "add" : "remove"](e);
            ...
            var i = (" " + t.className + " ").replace(vc, " ").replace(" " + e + " ", " ");
            t.className = (i + (n ? " " + e : "")).replace(vc, " ")
        }
}
...
function Yt(t, e, n, i, a) {
    if (!(!t.getBoundingClientRect && t !== window)) {
        var f, v, S, k, I, D, $;
        if (t !== window && t.parentNode && t !== Fn() ? (f = t.getBoundingClientRect(), v = f.top, S = f.left, k = f.bottom, I = f.right, D = f.height, $ = f.width) : (v = 0, S = 0, k = window.innerHeight, I = window.innerWidth, D = window.innerHeight, $ = window.innerWidth), (e || n) && t !== window && (a = a || t.parentNode, !ai))
            do
...
function gl(t, e) {
    for (var n = t.lastElementChild; n && (n === Qe.ghost || nt(n, "display") === "none" || e && !ro(n, e));) n = n.previousElementSibling;
    return n || null
}
...
function On(t, e) {
    ...
    for (; t = t.previousElementSibling;) t.nodeName.toUpperCase() !== "TEMPLATE" && t !== Qe.clone && (!e || ro(t, e)) && n++;
    return n
}
        ...
        animateAll: function(i) {
            ...
            t.forEach(function(S) {
                var k = 0,
                    ...
                    Y = S.rect,
                    re = fr(I, !0);
                re && ($.top -= re.f, $.left -= re.e), I.toRect = $, I.thisAnimationDuration && pa(J, $) && !pa(D, $) && (Y.top - $.top) / (Y.left - $.left) === (D.top - $.top) / (D.left - $.left) && (k = hx(Y, J, ie, a.options)), pa($, D) || (I.prevFromRect = D, I.prevToRect = $, k || (k = a.options.animation), a.animate(I, Y, $, k)), k && (f = !0, v = Math.max(v, k), clearTimeout(I.animationResetTimer), I.animationResetTimer = setTimeout(function() {
        ...
        animate: function(i, a, f, v) {
            if (v) {
                ...
                var S = fr(this.el),
                    ...
                    D = (a.left - f.left) / (k || 1),
                    $ = (a.top - f.top) / (I || 1);
                i.animatingX = !!D, i.animatingY = !!$, nt(i, "transform", "translate3d(" + D + "px," + $ + "px,0)"), this.forRepaintDummy = ux(i), nt(i, "transition", "transform " + v + "ms" + (this.options.easing ? " " + this.options.easing : "")), nt(i, "transform", "translate3d(0,0,0)"), typeof i.animated == "number" && clearTimeout(i.animated), i.animated = setTimeout(function() {
...
var Re, $t, ut, Pt, Ii, Ws, Vt, hi, lr, _n, os, ui, js, en, ar = !1,
    so = !1,
    oo = [],
    Ai, Ln, ma, va, bc, Cc, Jr, rr, as, ls = !1,
    Fs = !1,
    Xs, ln, ya = [],
    Va = !1,
    ao = [],
    Co = typeof document < "u",
    zs = rh,
    xc = fs || ai ? "cssFloat" : "float",
    px = Co && !sh && !rh && "draggable" in document.createElement("div"),
    hh = function() {
        if (!!Co) {
            if (ai) return !1;
    ...
    dh = function(e, n) {
        ...
        return f && (S.display === "block" || S.display === "flex" || S.display === "table" || S.display === "grid" || I >= a && i[xc] === "none" || v && i[xc] === "none" && I + D > a) ? "vertical" : "horizontal"
    },
    gx = function(e, n, i) {
...
Co && !sh && document.addEventListener("click", function(t) {
    if (so) return t.preventDefault(), t.stopPropagation && t.stopPropagation(), t.stopImmediatePropagation && t.stopImmediatePropagation(), so = !1, !1
}, !0);
var Oi = function(e) {
        if (Re) {
...
Qe.prototype = {
    ...
    _onTapStart: function(e) {
        if (!!e.cancelable) {
            var n = this,
                ...
                D = a.filter;
            if (Sx(i), !Re && !(/mousedown|pointerdown/.test(v) && e.button !== 0 || a.disabled) && !I.isContentEditable && !(!this.nativeDraggable && rs && k && k.tagName.toUpperCase() === "SELECT") && (k = $n(k, a.draggable, i, !1), !(k && k.animated) && Ws !== k)) {
    ...
    _prepareDragStart: function(e, n, i) {
        ...
        if (i && !Re && i.parentNode === f) {
            ...
            if (Pt = f, Re = i, $t = Re.parentNode, Ii = Re.nextSibling, Ws = i, js = v.group, Qe.dragged = Re, Ai = {
                    ...
                    clientX: (n || e).clientX,
                    clientY: (n || e).clientY
                }, bc = Ai.clientX - I.left, Cc = Ai.clientY - I.top, this._lastX = (n || e).clientX, this._lastY = (n || e).clientY, Re.style["will-change"] = "all", k = function() {
                    if (wn("delayEnded", a, {
                            evt: e
                        }), Qe.eventCanceled) {
                        a._onDrop();
                    ...
                    a._disableDelayedDragEvents(), !mc && a.nativeDraggable && (Re.draggable = !0), a._triggerDragStart(e, n), gn({
                        sortable: a,
                        name: "choose",
                        originalEvent: e
                    ...
                    ah(Re, D.trim(), wa)
                }), Et(S, "dragover", Oi), Et(S, "mousemove", Oi), Et(S, "touchmove", Oi), Et(S, "mouseup", a._onDrop), Et(S, "touchend", a._onDrop), Et(S, "touchcancel", a._onDrop), mc && this.nativeDraggable && (this.options.touchStartThreshold = 4, Re.draggable = !0), wn("delayStart", this, {
                    evt: e
    ...
    _onTouchMove: function(e) {
        if (Ai) {
            ...
            if (ut) {
                ...
                nt(ut, "webkitTransform", J), nt(ut, "mozTransform", J), nt(ut, "msTransform", J), nt(ut, "transform", J), ma = D, va = $, Ln = f
            }
    ...
    _appendGhost: function() {
        if (!ut) {
            ...
            if (zs) {
                ...
                ln !== document.body && ln !== document.documentElement ? (ln === document && (ln = Fn()), n.top += ln.scrollTop, n.left += ln.scrollLeft) : ln = Fn(), ya = wc(ln)
            }
            ut = Re.cloneNode(!0), En(ut, i.ghostClass, !1), En(ut, i.fallbackClass, !0), En(ut, i.dragClass, !0), nt(ut, "transition", ""), nt(ut, "transform", ""), nt(ut, "box-sizing", "border-box"), nt(ut, "margin", 0), nt(ut, "top", n.top), nt(ut, "left", n.left), nt(ut, "width", n.width), nt(ut, "height", n.height), nt(ut, "opacity", "0.8"), nt(ut, "position", zs ? "absolute" : "fixed"), nt(ut, "zIndex", "100000"), nt(ut, "pointerEvents", "none"), Qe.ghost = ut, e.appendChild(ut), nt(ut, "transform-origin", bc / parseInt(ut.style.width) * 100 + "% " + Cc / parseInt(ut.style.height) * 100 + "%")
        }
    },
    _onDragStart: function(e, n) {
        ...
        wn("setupClone", this), Qe.eventCanceled || (Vt = uh(Re), Vt.removeAttribute("id"), Vt.draggable = !1, Vt.style["will-change"] = "", this._hideClone(), En(Vt, this.options.chosenClass, !1), Qe.clone = Vt), i.cloneId = Ys(function() {
            wn("clone", i), !Qe.eventCanceled && (i.options.removeCloneOnHide || Pt.insertBefore(Vt, Re), i._hideClone(), gn({
                sortable: i,
                name: "clone"
            }))
        }), !n && En(Re, f.dragClass, !0), n ? (so = !0, i._loopId = setInterval(i._emulateDragOver, 50)) : (wt(document, "mouseup", i._onDrop), wt(document, "touchend", i._onDrop), wt(document, "touchcancel", i._onDrop), a && (a.effectAllowed = "move", f.setData && f.setData.call(i, a, Re)), Et(document, "drop", i), nt(Re, "transform", "translateZ(0)")), ar = !0, i._dragStartId = Ys(i._dragStarted.bind(i, n, e)), Et(document, "selectstart", i), Jr = !0, rs && nt(document.body, "user-select", "none")
    },
    _onDragOver: function(e) {
        ...
        function m(ye, ue) {
            wn(ye, Y, zn({
                ...
                onMove: function(ke, $e) {
                    return Gs(Pt, n, Re, a, ke, Yt(ke), e, $e)
                },
                changed: ae
            }, ue))
        }
        ...
        if (so = !1, I && !S.disabled && (D ? $ || (v = $t !== Pt) : en === this || (this.lastPutMode = js.checkPull(this, I, Re, e)) && k.checkPut(this, I, Re, e))) {
            ...
            if (!se || Cx(e, ie, this) && !se.animated) {
                if (se === Re) return q(!1);
                if (se && n === e.target && (i = se), i && (f = Yt(i)), Gs(Pt, n, Re, a, i, f, e, !!i) !== !1) return P(), se && se.nextSibling ? n.insertBefore(Re, se.nextSibling) : n.appendChild(Re), $t = n, ae(), q(!0)
            } else if (se && bx(e, ie, this)) {
                var ve = vr(n, 0, S, !0);
                if (ve === Re) return q(!1);
                if (i = ve, f = Yt(i), Gs(Pt, n, Re, a, i, f, e, !1) !== !1) return P(), n.insertBefore(Re, ve), $t = n, ae(), q(!0)
            } else if (i.parentNode === n) {
                f = Yt(i);
                var d = 0,
                    Ee, Ae = Re.parentNode !== n,
                    Le = !gx(Re.animated && Re.toRect || a, i.animated && i.toRect || f, ie),
                    lt = ie ? "top" : "left",
                    Be = yc(i, "top", "top") || yc(Re, "top", "top"),
                    K = Be ? Be.scrollTop : void 0;
                rr !== i && (Ee = f[lt], ls = !1, Fs = !Le && S.invertSwap || Ae), d = xx(e, i, f, ie, Le ? 1 : S.swapThreshold, S.invertedSwapThreshold == null ? S.swapThreshold : S.invertedSwapThreshold, Fs, rr === i);
                var Fe;
                if (d !== 0) {
                    var H = On(Re);
                    do H -= d, Fe = $t.children[H]; while (Fe && (nt(Fe, "display") === "none" || Fe === ut))
                }
                ...
                if (we !== !1) return (we === 1 || we === -1) && (Te = we === 1), Va = !0, setTimeout(wx, 30), P(), Te && !oe ? n.appendChild(Re) : i.parentNode.insertBefore(Re, Te ? oe : i), Be && ch(Be, 0, K - Be.scrollTop), $t = Re.parentNode, Ee !== void 0 && !Fs && (Xs = Math.abs(Ee - Yt(i)[lt])), ae(), q(!0)
            }
    ...
    _onDrop: function(e) {
        ...
        ar = !1, Fs = !1, ls = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), Ba(this.cloneId), Ba(this._dragStartId), this.nativeDraggable && (wt(document, "drop", this), wt(n, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), rs && nt(document.body, "user-select", ""), nt(Re, "transform", ""), e && (Jr && (e.cancelable && e.preventDefault(), !i.dropBubble && e.stopPropagation()), ut && ut.parentNode && ut.parentNode.removeChild(ut), (Pt === $t || en && en.lastPutMode !== "clone") && Vt && Vt.parentNode && Vt.parentNode.removeChild(Vt), Re && (this.nativeDraggable && wt(Re, "dragend", this), wa(Re), Re.style["will-change"] = "", Jr && !ar && En(Re, en ? en.options.ghostClass : this.options.ghostClass, !1), En(Re, this.options.chosenClass, !1), gn({
            ...
            toEl: $t,
            originalEvent: e
        })), Qe.active && ((_n == null || _n === -1) && (_n = lr, ui = os), gn({
            sortable: this,
            name: "end",
            toEl: $t,
            originalEvent: e
    ...
    _nulling: function() {
        wn("nulling", this), Pt = Re = $t = ut = Ii = Vt = Ws = hi = Ai = Ln = Jr = _n = ui = lr = os = rr = as = en = js = Qe.dragged = Qe.ghost = Qe.clone = Qe.active = null, ao.forEach(function(e) {
            e.checked = !0
        }), ao.length = ma = va = 0
    },
    ...
    toArray: function() {
        for (var e = [], n, i = this.el.children, a = 0, f = i.length, v = this.options; a < f; a++) n = i[a], $n(n, v.draggable, this.el, !1) && e.push(n.getAttribute(v.dataIdAttr) || _x(n));
        return e
    },
    sort: function(e, n) {
        var i = {},
    ...
    _showClone: function(e) {
        ...
        if (hi) {
            ...
            Re.parentNode == Pt && !this.options.group.revertClone ? Pt.insertBefore(Vt, Re) : Ii ? Pt.insertBefore(Vt, Ii) : Pt.appendChild(Vt), this.options.group.revertClone && this.animate(Re, Vt), nt(Vt, "display", ""), hi = !1
        }
    }
};
...
function xx(t, e, n, i, a, f, v, S) {
    ...
    if (!v) {
        ...
        } else if (k > D + I * (1 - a) / 2 && k < $ - I * (1 - a) / 2) return Ex(e)
    }
...
Co && Et(document, "touchmove", function(t) {
...
function kx() {
    ...
    return t.prototype = {
        ...
        drop: function() {
            this.sortable.nativeDraggable ? wt(document, "dragover", this._handleAutoScroll) : (wt(document, "pointermove", this._handleFallbackAutoScroll), wt(document, "touchmove", this._handleFallbackAutoScroll), wt(document, "mousemove", this._handleFallbackAutoScroll)), Ec(), Ks(), lx()
        },
        nulling: function() {
            lo = $a = Qr = ja = Zr = ba = Ca = null, qt.length = 0
        },
        ...
        _handleAutoScroll: function(n, i) {
            ...
            if (lo = n, i || this.options.forceAutoScrollFallback || fs || ai || rs) {
                xa(n, this.options, S, i);
                var k = fi(S, !0);
                ja && (!Zr || f !== ba || v !== Ca) && (Zr && Ec(), Zr = setInterval(function() {
                    var I = fi(document.elementFromPoint(f, v), !0);
                    I !== k && (k = I, Ks()), xa(n, a.options, I, i)
                }, 10), ba = f, Ca = v)
            } else {
...
var xa = lh(function(t, e, n, i) {
        if (!!e.scroll) {
            var a = (t.touches ? t.touches[0] : t).clientX,
                ...
                I = !1,
                D;
            $a !== n && ($a = n, Ks(), Qr = e.scroll, D = e.scrollFn, Qr === !0 && (Qr = fi(n, !0)));
            var $ = 0,
                J = Qr;
            do {
                var ie = J,
                ...
                (qt[$].vx != K || qt[$].vy != Fe || qt[$].el !== ie) && (qt[$].el = ie, qt[$].vx = K, qt[$].vy = Fe, clearInterval(qt[$].pid), (K != 0 || Fe != 0) && (I = !0, qt[$].pid = setInterval(function() {
                    i && this.layer === 0 && Qe.active._onTouchMove(lo);
                    var oe = qt[this.layer].vy ? qt[this.layer].vy * S : 0,
                        Te = qt[this.layer].vx ? qt[this.layer].vx * S : 0;
                    typeof D == "function" && D.call(Qe.dragged.parentNode[Sn], Te, oe, t, lo, qt[this.layer].el) !== "continue" || ch(qt[this.layer].el, Te, oe)
                }.bind({
                    layer: $
                }), 24))), $++
...
const Tx = `<div id="controller" class="state-controller controller-content">\r
    ...
    Ox = Ct.View.extend({
        ...
        template: it.template("<div class='text'></div>"),
        model: new Ze.Model({}),
        bindings: {
            ":el": {
                attributes: [{
    ...
    `),
        ...
        initialize() {
            this.rankedCollectionView = this.rankedCollectionView || new _c({
                collection: new Ze.Collection([])
            }), this.unrankedCollectionView = this.unrankedCollectionView || new _c({
    ...
    Dx = `<div id="controller" class="state-controller controller-content">
    ...
    Lx = Ct.View.extend({
        ...
        initialize(t) {
            this.client = t.client, this.promptComponent = this.promptComponent || new Vi({
                model: new Ze.Model
            }), this.episodesList = this.episodesList || new ii({
                action: "load",
                collection: new Ze.Collection
            }), this.inputComponent = this.inputComponent || new io({
                model: new Ze.Model({
            ...
            }), this.promptsList = this.promptsList || new ii({
                action: "remove",
                collection: new Ze.Collection
            }), this.selected = [], this.listenTo(this.model, "change", this.update, this)
        },
    ...
    Nx = Ct.View.extend({
        ...
        getNormalizedVector() {
            const t = it.extend({}, this.model.get("vector"));
...
<div id="control-panel" class="control-panel">\r
    ...
    $x = Ct.View.extend({
        ...
        initialize(t) {
            ...
            }), this.throttledUpdate = it.throttle(this.updateVector, this.model.get("throttle")), this.listenTo(this.model, "change", this.update, this), this.onResizeWithContext = this.onResize.bind(this), window.addEventListener("resize", this.onResizeWithContext), Ne(window).on("mousemove", this.move.bind(this)), Ne(window).on("mouseup", this.end.bind(this))
        },
        onBeforeDestroy() {
        ...
        update() {
            ...
            if (this.radialComponent.model.set("selector", t / e), this.radialComponent.model.set("accentColor", this.model.get("characterColor")), this.radialComponent.model.set("lockedIn", this.model.get("lockedIn")), this.radialComponent.model.set("text", ""), this.client.isRole("audience") && ((this.model.get("shotId") === void 0 || this.model.get("shotId") !== this.shotId) && (this.audienceShot = void 0), this.audienceShot && (this.model.setUpdate({
                    ...
                    x: 0,
                    y: 0
                }), this.throttledUpdate = it.throttle(this.updateVector, this.model.get("throttle")), this.model.get("lockedIn")) this.notified = !1;
            else {
...
class Gx extends zx {
    ...
    onText(n) {
        ...
        try {
            ...
            cc(`[Ecast Client] Unhandled text notification: ${n.key} ${a}`);
            return
        }
        const v = f;
        i === "room" ? this.emit("client:entityDidChange", i, v) : i === `player:${this.id}` ? this.emit("client:entityDidChange", "player", v) : i === "bc:room" ? this.emit("client:entityDidChange", "room", v) : i === "audiencePlayer" ? this.emit("client:entityDidChange", "audiencePlayer", v) : i === `bc:customer:${this.userId}` ? this.emit("client:entityDidChange", "player", v) : cc(`[Ecast Client] Unhandled json notification: ${i}`)
    }
    onObject(n) {
        const i = n.key,
            a = n.val;
        ...
        mask: function(v, S) {
            ...
            return S = t.extend({
                ...
                function Fe(ye) {
                    ...
                    return ye ? K() : $ > Ke + 1 ? S.autoclear || oe.join("") === Te ? (H.val() && H.val(""), Be(0, Y)) : K() : (K(), H.val(H.val().substring(0, Ke + 1))), $ ? ue : J
                }
                var H = t(this),
...
window.$ = Ne;
window.jQuery = Ne;
const Ux = Ct.View.extend({
        className: "app-root",
        template: it.template(Hx),
        regions: {
    ...
    Wx = `<div class="aboveBlackBox"></div>
<div class="blackBox triangle-isosceles"></div>
<div class="belowBlackBox"></div>`,
    yh = Ct.View.extend({
        template: it.template(Wx),
        tagName: "div",
    ...
    Xx = Pa.extend({
        initialize(t) {
            Pa.prototype.initialize.apply(this, [t]), this.promptComponent = new yh({
                model: new Ze.Model
            })
        },
        update() {
    ...
    Js = Na.extend({
        initialize() {
            Na.prototype.initialize.apply(this), this.promptComponent = new yh({
                model: new Ze.Model
            })
        },
        update() {
            this.promptComponent.model.set(this.model.get("text")), this.choicesList.options.className = "choiceButton", this.choices = it.map(this.model.get("choices"), t => (t.className = "choiceButton", t)), this.choicesList.collection.set(this.choices), this.stickit()
        }
    }),
    Yx = `
<button type="button" style='flex-grow:2;' class='voteButton button btn btn-lg'>
    <div class="voteTwistHeader text-left">Twist</div>
    <div class="voteThumbnail pull-left"></div>
    <div class="voteIcon pull-left"></div>
    <div class="votePlayer text-left">Player Name</div>
    <div class="voteText text-left">Text</div>
    <div class="voteResponse text-left">Response</div>
    <div class="voteTwistFooter text-left">Twist</div>

</button>
    <button data-action='censor' data-index class='button censor-button btn btn-lg'></button>`,
    Kx = ll.extend({
        template: it.template(Yx),
        bindings: {
            ":el": {
                observe: "visible",
                visible(t) {
    ...
    Jx = Js.extend({
        bindings: it.extend(Js.prototype.bindings, {
            ".chosen": {
                observe: "chosen",
                onGet(t) {
                    return t ? !this.model.get("choices") || !this.model.get("choices")[t] ? "" : this.model.get("choices")[t].text : null
                }
            }
        }),
        initialize(t) {
            Js.prototype.initialize.apply(this, [t]), this.choicesList = new ii({
        ...
        update() {
            this.prompt = this.model.get("text"), this.choices = it.map(this.model.get("choices"), t => (t.censorable = this.model.get("canCensor"), t.action = t.action || "choose", t)), this.promptComponent.model.set(this.prompt), this.model.get("chosen") && this.model.get("chosen").toString().length > 0 ? this.choicesList.collection.reset() : this.choicesList.collection.set(this.choices)
        }
    });
const Qx = Fx.extend({
...
//# sourceMappingURL=0decf411.js.map