...
class kt {
    ...
    static async showError(e) {
        const n = new URL("jackbox/main/pp4/monstermingle/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="jackbox/main/pp4/monstermingle/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
`,
    ri = "jackbox/main/pp4/monstermingle/assets/edb79482.svg",
    qx = ht.View.extend({
...
<div id="bottom" class="double-nav-bottom"></div>`,
    sE = "jackbox/main/pp4/monstermingle/assets/a16e5118.wav",
    oE = t => t.replace(/[\n]/gi, ""),
    aE = ht.View.extend({
        model: new Ue.Model({}),
